...
void DriverGL::InitializeStaticBindings() {
  ...
  fn.glDebugMessageCallbackKHRFn = 0;
  fn.glDebugMessageControlKHRFn = 0;
  fn.glDebugMessageInsertKHRFn = 0;
  ...
  fn.glGetDebugMessageLogKHRFn = 0;
  fn.glGetErrorFn =
...
void DriverGL::InitializeDynamicBindings(GLContext* context) {
  ...
  debug_fn.glDebugMessageCallbackKHRFn = 0;
...
static void GL_BINDING_CALL
Debug_glDebugMessageCallbackKHR(GLDEBUGPROCKHR callback,
                                const void* userparam) {
  GL_SERVICE_LOG("glDebugMessageCallbackKHR"
                 << "(" << callback << ", "
                 << static_cast<const void*>(userparam) << ")");
  g_driver_gl.debug_fn.glDebugMessageCallbackKHRFn(callback, userparam);
}

static void GL_BINDING_CALL Debug_glDebugMessageControlKHR(GLenum source,
                                                           GLenum type,
                                                           GLenum severity,
                                                           GLsizei count,
                                                           const GLuint* ids,
  ...
  g_driver_gl.debug_fn.glDebugMessageControlKHRFn(source, type, severity, count,
                                                  ids, enabled);
}

static void GL_BINDING_CALL Debug_glDebugMessageInsertKHR(GLenum source,
                                                          GLenum type,
                                                          GLuint id,
                                                          GLenum severity,
                                                          GLsizei length,
  ...
  g_driver_gl.debug_fn.glDebugMessageInsertKHRFn(source, type, id, severity,
                                                 length, buf);
}
...
Debug_glGetDebugMessageLogKHR(GLuint count,
                              GLsizei bufSize,
                              GLenum* sources,
                              GLenum* types,
                              GLuint* ids,
  ...
  GLuint result = g_driver_gl.debug_fn.glGetDebugMessageLogKHRFn(
...
static void GL_BINDING_CALL Debug_glObjectLabelKHR(GLenum identifier,
                                                   GLuint name,
                                                   GLsizei length,
                                                   const GLchar* label) {
  GL_SERVICE_LOG("glObjectLabelKHR"
                 << "(" << GLEnums::GetStringEnum(identifier) << ", " << name
                 << ", " << length << ", " << static_cast<const void*>(label)
                 << ")");
  g_driver_gl.debug_fn.glObjectLabelKHRFn(identifier, name, length, label);
}
...
static void GL_BINDING_CALL Debug_glPopDebugGroupKHR(void) {
  GL_SERVICE_LOG("glPopDebugGroupKHR"
                 << "("
                 << ")");
  g_driver_gl.debug_fn.glPopDebugGroupKHRFn();
}
...
static void GL_BINDING_CALL Debug_glPushDebugGroupKHR(GLenum source,
                                                      GLuint id,
                                                      GLsizei length,
                                                      const GLchar* message) {
  GL_SERVICE_LOG("glPushDebugGroupKHR"
                 << "(" << GLEnums::GetStringEnum(source) << ", " << id << ", "
                 << length << ", " << static_cast<const void*>(message) << ")");
  g_driver_gl.debug_fn.glPushDebugGroupKHRFn(source, id, length, message);
}
...
void DriverGL::InitializeDebugBindings() {
  ...
  if (!debug_fn.glDebugMessageCallbackKHRFn) {
    debug_fn.glDebugMessageCallbackKHRFn = fn.glDebugMessageCallbackKHRFn;
    fn.glDebugMessageCallbackKHRFn = Debug_glDebugMessageCallbackKHR;
  }
  if (!debug_fn.glDebugMessageControlKHRFn) {
    debug_fn.glDebugMessageControlKHRFn = fn.glDebugMessageControlKHRFn;
    fn.glDebugMessageControlKHRFn = Debug_glDebugMessageControlKHR;
  }
  if (!debug_fn.glDebugMessageInsertKHRFn) {
    debug_fn.glDebugMessageInsertKHRFn = fn.glDebugMessageInsertKHRFn;
    fn.glDebugMessageInsertKHRFn = Debug_glDebugMessageInsertKHR;
  }
  ...
  if (!debug_fn.glGetDebugMessageLogKHRFn) {
    debug_fn.glGetDebugMessageLogKHRFn = fn.glGetDebugMessageLogKHRFn;
    fn.glGetDebugMessageLogKHRFn = Debug_glGetDebugMessageLogKHR;
  }
  ...
  if (!debug_fn.glObjectLabelKHRFn) {
    debug_fn.glObjectLabelKHRFn = fn.glObjectLabelKHRFn;
    fn.glObjectLabelKHRFn = Debug_glObjectLabelKHR;
  }
  ...
  if (!debug_fn.glPopDebugGroupKHRFn) {
    debug_fn.glPopDebugGroupKHRFn = fn.glPopDebugGroupKHRFn;
    fn.glPopDebugGroupKHRFn = Debug_glPopDebugGroupKHR;
  }
  ...
  if (!debug_fn.glPushDebugGroupKHRFn) {
    debug_fn.glPushDebugGroupKHRFn = fn.glPushDebugGroupKHRFn;
    fn.glPushDebugGroupKHRFn = Debug_glPushDebugGroupKHR;
  }
...
void GLApiBase::glDebugMessageCallbackKHRFn(GLDEBUGPROCKHR callback,
                                            const void* userparam) {
...
void GLApiBase::glPopDebugGroupKHRFn(void) {
...
void TraceGLApi::glDebugMessageCallbackKHRFn(GLDEBUGPROCKHR callback,
                                             const void* userparam) {
...
void TraceGLApi::glPopDebugGroupKHRFn(void) {
...
void NoContextGLApi::glDebugMessageCallbackKHRFn(GLDEBUGPROCKHR callback,
                                                 const void* userparam) {
  NOTREACHED() << "Trying to call glDebugMessageCallbackKHR() without current "
                  "GL context";
  LOG(ERROR) << "Trying to call glDebugMessageCallbackKHR() without current GL "
                "context";
}
...
void NoContextGLApi::glDebugMessageControlKHRFn(GLenum source,
                                                ...
                                                GLboolean enabled) {
  NOTREACHED()
      << "Trying to call glDebugMessageControlKHR() without current GL context";
  LOG(ERROR)
      << "Trying to call glDebugMessageControlKHR() without current GL context";
}
...
void NoContextGLApi::glDebugMessageInsertKHRFn(GLenum source,
                                               ...
                                               const GLchar* buf) {
  NOTREACHED()
      << "Trying to call glDebugMessageInsertKHR() without current GL context";
  LOG(ERROR)
      << "Trying to call glDebugMessageInsertKHR() without current GL context";
}
...
GLuint NoContextGLApi::glGetDebugMessageLogKHRFn(GLuint count,
                                                 ...
                                                 GLchar* messageLog) {
  NOTREACHED()
      << "Trying to call glGetDebugMessageLogKHR() without current GL context";
  LOG(ERROR)
      << "Trying to call glGetDebugMessageLogKHR() without current GL context";
  return 0U;
}
...
void NoContextGLApi::glObjectLabelKHRFn(GLenum identifier,
                                        ...
                                        const GLchar* label) {
  NOTREACHED()
      << "Trying to call glObjectLabelKHR() without current GL context";
  LOG(ERROR) << "Trying to call glObjectLabelKHR() without current GL context";
}
...
void NoContextGLApi::glPopDebugGroupKHRFn(void) {
  NOTREACHED()
      << "Trying to call glPopDebugGroupKHR() without current GL context";
  LOG(ERROR)
      << "Trying to call glPopDebugGroupKHR() without current GL context";
}
...
void NoContextGLApi::glPushDebugGroupKHRFn(GLenum source,
                                           ...
                                           const GLchar* message) {
  NOTREACHED()
      << "Trying to call glPushDebugGroupKHR() without current GL context";
  LOG(ERROR)
      << "Trying to call glPushDebugGroupKHR() without current GL context";
}
