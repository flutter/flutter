...
// Includes the platform independent and platform dependent GL headers.  Only
// include this in cc files. It pulls in system headers which define all kinds
// of macros that are liable to cause conflicts.
