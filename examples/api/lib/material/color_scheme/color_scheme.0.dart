...
class _ColorSchemeExampleState extends State<ColorSchemeExample> {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      home: Scaffold(
        appBar: AppBar(title: const Text('ColorScheme'), actions: <Widget>[
          SettingsButton(
        ...
        child: Padding(
          ...
          child: ListView(children: <Widget>[
            ...
            Row(children: <Widget>[
              ...
              Switch(value: selectedBrightness == Brightness.light, onChanged: (
                bool value,
              ) {
                setState(() {
                  selectedBrightness =
...
class SettingsButton extends StatelessWidget {
  ...
  @override
  Widget build(BuildContext context) {
    return IconButton(icon: const Icon(Icons.settings), onPressed: () {
