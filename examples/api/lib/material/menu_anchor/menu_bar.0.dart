...
class MenuEntry {
  ...
  static List<Widget> build(List<MenuEntry> selections, [Duration hoverOpenDelay = Duration.zero]) {
    Widget buildSelection(MenuEntry selection) {
      if (selection.menuChildren != null) {
        return SubmenuButton(
          menuChildren: MenuEntry.build(selection.menuChildren!, const Duration(milliseconds: 150)),
