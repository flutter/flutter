...
class _MyHomePageState extends State<MyHomePage> {
  ...
  final Map<int, SelectionDetails> selectionDetailsMap = <int, SelectionDetails>{};
  ...
  List<Widget> _initWidgets(String text) {
    ...
    while (currentPosition < text.length) {
      ...
      final int currentSelectableId = selectableId;
      ...
      paragraphWidgets.add(
        SelectionListener(
          onSelectionChanged: (SelectionDetails selectionDetails) {
            selectionDetailsMap[currentSelectableId] = selectionDetails;
          },
          child: Text.rich(
  ...
  void _insertContent(List<SelectedContentRange> ranges, String plainText, int indexOfText, int rangeIndex) {
    ...
    for (int index = 0; index < ranges.length; index += 1) {
      ...
      final TextSpan rawSpan = dataSourceMap[indexOfText]!;
      ...
      dataSourceMap[indexOfText] = TextSpan(
        style: dataSourceMap[indexOfText]!.style,
        children: <InlineSpan>[
          ...beforeSelection,
          ...insideSelection,
          ...afterSelection,
                    ...
                    buttonItems: <ContextMenuButtonItem>[
                      ContextMenuButtonItem(
                        onPressed: () {
                          ...
                          int rangeIndex = 0;
                          for (final MapEntry<int, SelectionDetails> entry in selectionDetailsMap.entries) {
                            _insertContent(entry.value.ranges, 'Inserted Content', entry.key, rangeIndex);
                            rangeIndex += 1;
                          }
