...
/// network errors, empty state and loading state.
    ...
    return Column(
      ...
      children: <Widget>[
        ...
        Autocomplete<String>(
          ...
          loadingStateBuilder:(BuildContext context, Iterable<String> lastOptions) {
            return const Text('Loading');
          },
          emptyStateBuilder: (BuildContext context, String text) {
            if (text.isEmpty) {
