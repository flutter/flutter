...
class _RenderSelectableAdapter extends RenderProxyBox with Selectable, SelectionRegistrant {
  _RenderSelectableAdapter(this._selectionColor, SelectionRegistrar registrar) {
  ...
  final ValueNotifier<SelectionGeometry> _geometry = ValueNotifier<SelectionGeometry>(_noSelection);
