      ...
      body: Center(
        child: Stack(
          children: <Widget>[
            Positioned.fill(
              child: Theme(
                data: Theme.of(context).copyWith(floatingActionButtonTheme: const FloatingActionButtonThemeData(backgroundColor: Colors.redAccent)),
                child: Column(
                  ...
                  children: <Widget>[
                    ...
                    Row(
                      ...
                      children: <Widget>[
                        ...
                        FloatingActionButtonOld.extended(
                          onPressed: () {
                            // Add your onPressed code here!
                          },
            ...
            Opacity(
              opacity: 0.5,
              child: Theme(
                data: Theme.of(context).copyWith(floatingActionButtonTheme: const FloatingActionButtonThemeData(backgroundColor: Colors.lightBlue)),
                child: Column(
                  mainAxisAlignment: MainAxisAlignment.spaceEvenly,
                  children: <Widget>[
                    Row(
