...
void main() {
  ...
  testWidgets('Drag on nav bar triggers drag only', (WidgetTester tester) async {
    await tester.pumpWidget(const example.CupertinoSheetApp());
    ...
    final RenderBox box = tester.renderObject(find.text('Scrollable Sheet')) as RenderBox;
