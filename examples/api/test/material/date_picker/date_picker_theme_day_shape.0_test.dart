...
void main() {
  testWidgets('DatePickerThemeData.dayShape updates day selection shape decoration', (
    ...
    ShapeDecoration dayShapeDecoration =
        tester
                .widget<DecoratedBox>(
                  find.ancestor(of: find.text('15'), matching: find.byType(DecoratedBox)),
                )
                .decoration
            as ShapeDecoration;
    ...
    dayShapeDecoration =
        tester
                .widget<DecoratedBox>(
                  find.ancestor(of: find.text('20'), matching: find.byType(DecoratedBox)),
                )
                .decoration
            as ShapeDecoration;
