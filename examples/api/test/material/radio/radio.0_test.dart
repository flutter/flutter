...
void main() {
  testWidgets('Radio Smoke Test', (WidgetTester tester) async {
    ...
    final Finder radioButton1 =
        find.byType(Radio<example.SingingCharacter>).first;
    final Finder radioButton2 =
        find.byType(Radio<example.SingingCharacter>).last;
    ...
    expect(
        ...
        isNot(tester
            .widget<Radio<example.SingingCharacter>>(radioButton2)
            .value));
    ...
    expect(
        tester.widget<Radio<example.SingingCharacter>>(radioButton1).groupValue,
        isNot(tester
            .widget<Radio<example.SingingCharacter>>(radioButton1)
            .value));
    expect(
        tester.widget<Radio<example.SingingCharacter>>(radioButton2).groupValue,
