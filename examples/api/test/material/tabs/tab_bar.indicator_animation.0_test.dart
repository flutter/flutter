...
import 'package:flutter_api_samples/material/tabs/tab_bar.indicator_animation.0.dart'
    as example;
import 'package:flutter_test/flutter_test.dart';

void main() {
  testWidgets(
    'TabBar.indicatorAnimation can customize tab indicator animation',
    (WidgetTester tester) async {
      await tester.pumpWidget(const example.IndicatorAnimationExampleApp());

      final RenderBox tabBarBox = tester.firstRenderObject<RenderBox>(
        find.byType(TabBar),
      );
