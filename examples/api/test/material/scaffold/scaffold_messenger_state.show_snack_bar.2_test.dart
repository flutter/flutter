...
void main() {
  testWidgets(
    ...
    await tester.pump();
    await tester.pump(
        const Duration(milliseconds: 250)); // Advance the animation by 250ms.
    ...
    await tester.pump();
    await tester.pump(
        const Duration(milliseconds: 1500)); // Advance the animation by 125ms.
    ...
    await tester.pump();
    await tester
        .pump(const Duration(seconds: 1)); // Advance the animation by 1sec.
