...
import 'package:flutter_api_samples/material/selection_container/selection_container.0.dart' as example;
import 'package:flutter_test/flutter_test.dart';

void main() {
  testWidgets('The SelectionContainer should transform the partial selection into an all selection', (WidgetTester tester) async {
    await tester.pumpWidget(
      const example.SelectionContainerExampleApp(),
    );
