...
void main() {
  ...
  group('DraggableExampleApp', () {
    testWidgets(
      'correctly displays initial state',
    ...
    testWidgets(
      'correctly displays different Draggable states',
      (WidgetTester tester) async {
        await tester.pumpWidget(
          const example.DraggableExampleApp(),
        );
    ...
    testWidgets(
      'updates the counter when Draggable is dropped over the DragTarget',
      (WidgetTester tester) async {
        await tester.pumpWidget(
          const example.DraggableExampleApp(),
        );
