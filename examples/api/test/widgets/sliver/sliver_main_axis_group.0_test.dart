...
void main() {
  testWidgets('SliverMainAxisGroup example', (WidgetTester tester) async {
    ...
    final RenderSliverMainAxisGroup renderSliverGroup =
    ...
    final RenderSliverList renderSliverList =
        tester.renderObject<RenderSliverList>(find.byType(SliverList));
    final RenderSliverToBoxAdapter renderSliverAdapter =
        tester.renderObject<RenderSliverToBoxAdapter>(
    ...
    expect(renderSliverGroup.geometry!.scrollExtent,
        equals(70.0 + 100.0 * 5 + 100.0));
  });
}
