...
void main() {
  testWidgets('Hero flight animation with default rect tween', (final WidgetTester tester) async {
  ...
  testWidgets('Hero flight animation with custom rect tween', (final WidgetTester tester) async {
    await tester.pumpWidget(
      const example.HeroApp(),
    );
