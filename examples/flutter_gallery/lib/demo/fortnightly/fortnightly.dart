...
class FruitPage extends StatelessWidget {
  final String paragraph1 = '''Have you ever held a quince? It\'s strange;
...
'''.replaceAll('\n', '');
  ...
  final String paragraph2 = '''Pomegranates on the other hand have become almost
 ubiquitous. You can find its juice in any bodega, Walmart, and even some gas
 stations. But at what cost? The pomegranate juice craze of the aughts made
