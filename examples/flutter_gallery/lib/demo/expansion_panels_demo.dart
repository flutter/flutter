  ...
  void initState() {
    ...
    _demoItems = <DemoItem<dynamic>>[
      new DemoItem<String>(
        ...
        builder: (DemoItem<String> item) { // ignore: argument_type_not_assignable, #5771
          void close() {
            setState(() {
      ...
      new DemoItem<_Location>(
        ...
        builder: (DemoItem<_Location> item) { // ignore: argument_type_not_assignable, #5771
          void close() {
            setState(() {
              item.isExpanded = false;
            });
      ...
      new DemoItem<double>(
        ...
        builder: (DemoItem<double> item) { // ignore: argument_type_not_assignable, #5771
          void close() {
            setState(() {
              item.isExpanded = false;
            });
