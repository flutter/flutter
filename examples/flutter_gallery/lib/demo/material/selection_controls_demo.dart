  ...
  Widget build(BuildContext context) {
    final List<ComponentDemoTabData> demos = <ComponentDemoTabData>[
      ComponentDemoTabData(
        ...
        documentationUrl: 'https://docs.flutter.dev/flutter/material/Checkbox-class.html',
      ),
      ComponentDemoTabData(
        tabName: 'RADIO',
        ...
        documentationUrl: 'https://docs.flutter.dev/flutter/material/Radio-class.html',
      ),
      ComponentDemoTabData(
        tabName: 'SWITCH',
        ...
        documentationUrl: 'https://docs.flutter.dev/flutter/material/Switch-class.html',
      ),
    ];
