            ...
            columns: <DataColumn>[
              DataColumn(
                ...
                onSort: (int columnIndex, bool ascending) {
                  return _sort<String>((Dessert d) => d.name, columnIndex, ascending);
                },
              ),
              DataColumn(
                ...
                numeric: true,
                onSort: (int columnIndex, bool ascending) {
                  return _sort<num>((Dessert d) => d.calories, columnIndex, ascending);
                },
              ),
              DataColumn(
                ...
                numeric: true,
                onSort: (int columnIndex, bool ascending) {
                  return _sort<num>((Dessert d) => d.fat, columnIndex, ascending);
                },
              ),
              DataColumn(
                ...
                numeric: true,
                onSort: (int columnIndex, bool ascending) {
                  return _sort<num>((Dessert d) => d.carbs, columnIndex, ascending);
                },
              ),
              DataColumn(
                ...
                numeric: true,
                onSort: (int columnIndex, bool ascending) {
                  return _sort<num>((Dessert d) => d.protein, columnIndex, ascending);
                },
              ),
              DataColumn(
                ...
                numeric: true,
                onSort: (int columnIndex, bool ascending) {
                  return _sort<num>((Dessert d) => d.sodium, columnIndex, ascending);
                },
              ),
              DataColumn(
                ...
                numeric: true,
                onSort: (int columnIndex, bool ascending) {
                  return _sort<num>((Dessert d) => d.calcium, columnIndex, ascending);
                },
              ),
              DataColumn(
                ...
                numeric: true,
                onSort: (int columnIndex, bool ascending) {
                  return _sort<num>((Dessert d) => d.iron, columnIndex, ascending);
                },
              ),
            ],
