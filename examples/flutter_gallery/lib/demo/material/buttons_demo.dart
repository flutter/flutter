  ...
  Widget build(BuildContext context) {
    ...
    final List<ComponentDemoTabData> demos = <ComponentDemoTabData>[
      ComponentDemoTabData(
        ...
        documentationUrl: 'https://api.flutter.dev/flutter/material/RaisedButton-class.html',
      ),
      ComponentDemoTabData(
        tabName: 'FLAT',
        ...
        documentationUrl: 'https://api.flutter.dev/flutter/material/FlatButton-class.html',
      ),
      ComponentDemoTabData(
        tabName: 'OUTLINE',
        ...
        documentationUrl: 'https://api.flutter.dev/flutter/material/OutlineButton-class.html',
      ),
      ComponentDemoTabData(
        tabName: 'DROPDOWN',
