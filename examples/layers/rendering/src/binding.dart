...
/// [renderView].
///
/// Unlike [RenderingFlutterBinding], this binding also creates a [renderView]
/// to simplify bootstrapping for apps that have a dedicated main view.
class ViewRenderingFlutterBinding extends RenderingFlutterBinding {
  /// Creates a binding for the rendering layer.
  ///
  /// The `root` render box is attached directly to the [renderView] and is
  /// given constraints that require it to fill the window. The [renderView] is
  /// attached to the [rootPipelineOwner] and rendered into the provided `view`.
  ///
