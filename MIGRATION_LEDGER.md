...
- [ ] **1.1 Matrix Initialization**:
    - [ ] *Branch Stub*: `android-embedder-migration/phase-1.1-matrix-initialization`
...
- [ ] **1.2 Pre-Emptive GN Quarantine**:
    - [ ] *Branch Stub*: `android-embedder-migration/phase-1.2-pre-emptive-gn-quarantine`
...
- [ ] **1.3 JNI Routing & Mocking**:
    - [ ] *Branch Stub*: `android-embedder-migration/phase-1.3-jni-routing-mocking`
...
- [ ] **1.4 Dynamic Virtualization**:
    - [ ] *Branch Stub*: `android-embedder-migration/phase-1.4-dynamic-virtualization`
...
- [ ] **1.5 C-API Extension (Vulkan)**:
    - [ ] *Branch Stub*: `android-embedder-migration/phase-1.5-c-api-extension-vulkan`
...
- [ ] **1.6 C-API Extension (AHardwareBuffer)**:
    - [ ] *Branch Stub*: `android-embedder-migration/phase-1.6-c-api-extension-ahardwarebuffer`
    - [ ] `embedder.h` API extension: AHardwareBuffer (opaque structs).
    - [ ] *Review*: Autonomous Adversarial Review Loop executed natively on PR (including Perfetto trace instrumentation verification) and feedback addressed.
    - [ ] *Validation*: `embedder_unittests` covering new structs pass.
- [ ] **1.7 C-API Extension (Engine Spawn)**:
    - [ ] *Branch Stub*: `android-embedder-migration/phase-1.7-c-api-extension-engine-spawn`
...
- [ ] **1.8 C-API Extension (Dart Deferred Components)**:
    - [ ] *Branch Stub*: `android-embedder-migration/phase-1.8-c-api-extension-dart-deferred-components`
...
- [ ] **1.9 C-API Extension (Screenshot API)**:
    - [ ] *Branch Stub*: `android-embedder-migration/phase-1.9-c-api-extension-screenshot-api`
...
- [ ] **1.10 C-API Extension (Raster Context Hooks)**:
    - [ ] *Branch Stub*: `android-embedder-migration/phase-1.10-c-api-extension-raster-context-hooks`
...
- [ ] **1.11 C-API Extension (Thread Priorities)**:
    - [ ] *Branch Stub*: `android-embedder-migration/phase-1.11-c-api-extension-thread-priorities`
...
- [ ] **2.1 Asset Resolver**: 
    - [ ] *Branch Stub*: `android-embedder-migration/phase-2.1-asset-resolver`
...
- [ ] **2.2 Dart Callbacks**: 
    - [ ] *Branch Stub*: `android-embedder-migration/phase-2.2-dart-callbacks`
...
- [ ] **2.3 Image Generators**: 
    - [ ] *Branch Stub*: `android-embedder-migration/phase-2.3-image-generators`
...
- [ ] **2.4 Mutator Translation**: 
    - [ ] *Branch Stub*: `android-embedder-migration/phase-2.4-mutator-translation`
...
- [ ] **2.5 Accessibility & Semantics**: 
    - [ ] *Branch Stub*: `android-embedder-migration/phase-2.5-accessibility-semantics`
    - [ ] `Accessibility` & `Semantics` natively wired.
    - [ ] *Review*: Autonomous Adversarial Review Loop executed natively on PR (including Perfetto trace instrumentation verification) and feedback addressed.
    - [ ] *Validation*: `dev/integration_tests/android_semantics` passes across CI matrix.
- [ ] **2.6 Platform Views**: 
    - [ ] *Branch Stub*: `android-embedder-migration/phase-2.6-platform-views`
...
- [ ] **2.7 Window Metrics Translation**: 
    - [ ] *Branch Stub*: `android-embedder-migration/phase-2.7-window-metrics-translation`
...
- [ ] **2.8 AChoreographer VSync Routing**: 
    - [ ] *Branch Stub*: `android-embedder-migration/phase-2.8-achoreographer-vsync-routing`
...
- [ ] **2.9 Global VM Initialization (`flutter_main.cc`)**:
    - [ ] *Branch Stub*: `android-embedder-migration/phase-2.9-global-vm-initialization-flutter-main-cc`
...
- [ ] **3.1 AHardwareBuffer**:
    - [ ] *Branch Stub*: `android-embedder-migration/phase-3.1-ahardwarebuffer`
...
- [ ] **3.2 Vulkan External Textures**:
    - [ ] *Branch Stub*: `android-embedder-migration/phase-3.2-vulkan-external-textures`
...
- [ ] **3.3 SurfaceControl HCPP**:
    - [ ] *Branch Stub*: `android-embedder-migration/phase-3.3-surfacecontrol-hcpp`
...
- [ ] **3.4 Multi-Engine & Add-to-App**:
    - [ ] *Branch Stub*: `android-embedder-migration/phase-3.4-multi-engine-add-to-app`
...
- [ ] **4.1 Engine Unit Tests**:
    - [ ] *Branch Stub*: `android-embedder-migration/phase-4.1-engine-unit-tests`
...
- [ ] **4.2 Framework Integration Tests (Skia GL / Software)**:
    - [ ] *Branch Stub*: `android-embedder-migration/phase-4.2-framework-integration-tests-skia-gl-software`
...
- [ ] **4.3 Framework Integration Tests (Impeller)**:
    - [ ] *Branch Stub*: `android-embedder-migration/phase-4.3-framework-integration-tests-impeller`
...
- [ ] **4.4 DeviceLab Android Lifecycle & Platform Views**:
    - [ ] *Branch Stub*: `android-embedder-migration/phase-4.4-devicelab-android-lifecycle-platform-views`
...
- [ ] **4.5 DeviceLab Performance & Memory Parity (No Regressions)**:
    - [ ] *Branch Stub*: `android-embedder-migration/phase-4.5-devicelab-performance-memory-parity-no-regressions`
...
- [ ] **5.1 Target Flip**: 
    - [ ] *Branch Stub*: `android-embedder-migration/phase-5.1-target-flip`
...
- [ ] **5.2 Legacy Deletion (Subsystems)**: 
    - [ ] *Branch Stub*: `android-embedder-migration/phase-5.2-legacy-deletion-subsystems`
...
- [ ] **5.3 Legacy Deletion (Platform Views/Semantics)**: 
    - [ ] *Branch Stub*: `android-embedder-migration/phase-5.3-legacy-deletion-platform-views-semantics`
    - [ ] Platform views and semantics wiped.
    - [ ] *Review*: Autonomous Adversarial Review Loop executed natively on PR (including Perfetto trace instrumentation verification) and feedback addressed.
    - [ ] *Validation*: `ninja -C out/android_debug_unopt flutter_shell_native_unittests` compiles successfully AND `//shell/platform/android:robolectric_tests` passes entirely without legacy code.
- [ ] **5.4 Legacy Deletion (Graphics Pipeline)**: 
    - [ ] *Branch Stub*: `android-embedder-migration/phase-5.4-legacy-deletion-graphics-pipeline`
    - [ ] `android_context`, `android_surface` wiped.
    - [ ] *Review*: Autonomous Adversarial Review Loop executed natively on PR (including Perfetto trace instrumentation verification) and feedback addressed.
    - [ ] *Validation*: `ninja -C out/android_debug_unopt flutter_shell_native_unittests` compiles successfully AND `//shell/platform/android:robolectric_tests` passes entirely without legacy code.
- [ ] **5.5 Flag Obliteration**: 
    - [ ] *Branch Stub*: `android-embedder-migration/phase-5.5-flag-obliteration`
...
- [ ] **5.6 Strict GN Target Isolation**: 
    - [ ] *Branch Stub*: `android-embedder-migration/phase-5.6-strict-gn-target-isolation`
