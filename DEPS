...
vars = {
  ...
  'skia_revision': 'b2cdcf07b2b58c798adada361f30fdac90dde6ea',
  ...
  'dart_revision': '11dedad2d062cf28188cd280816693c914e06bbc',

  # WARNING: DO NOT EDIT MANUALLY
  # The lines between blank lines above and below are generated by a script. See create_updated_flutter_deps.py
  'dart_ai_rev': 'bc90433664d502b69cc85f05ae2bc51df51a27a2',
...
deps = {
  ...
  'engine/src/flutter/third_party/dart/third_party/pkg/dartdoc':
   Var('dart_git') + '/dartdoc.git@49fc272d40c4d782a643a0d131da4963292f0da7',
     ...
     'packages': [
       {
        ...
        'version': 'last_updated:2025-09-12T11:50:56-0700'
       }
     ],
     'condition': 'download_android_deps',
     'dep_type': 'cipd',
     ...
     'packages': [
       {
        ...
        'version': 'b1AYfAFOnvBMHSsYL_lJxYq8iUjqEMksawr-LEvzfKQC'
       }
     ],
