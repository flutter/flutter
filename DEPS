...
vars = {
  ...
  'dart_revision': 'b43ca793d4bfa5f433803d4cdac10cd971085f61',

  # WARNING: DO NOT EDIT MANUALLY
  # The lines between blank lines above and below are generated by a script. See create_updated_flutter_deps.py
  'dart_ai_rev': '5f9c50fc93c978e059a3ab2a071faeca6f81fd68',
  ...
  'dart_tools_rev': '1e110fcf8da4fbd423e22ae7d14f04c908d7c139',
...
deps = {
  ...
  'engine/src/flutter/third_party/dart/third_party/pkg/dart_style':
   Var('dart_git') + '/dart_style.git@2a6c97b7e05234f3bd16b08dbd3150e63c8bb4ca',

  'engine/src/flutter/third_party/dart/third_party/pkg/dartdoc':
   Var('dart_git') + '/dartdoc.git@f1fe17752b1193ad52d69271ceb686cc3e4712b0',
     ...
     'packages': [
       {
        ...
        'version': 'oHcDYWodx5QjLZVeVVGg0ZoD0rvcBGK7Oegyvtxr-QAC'
       }
     ],
