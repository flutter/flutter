...
vars = {
  ...
  'skia_revision': '9cda1a2050c4773e9956ba2dcf5a57e2ee286f63',
  ...
  'dart_revision': '0009748aed5088a399c1e1929d7a440f96c2164c',

  # WARNING: DO NOT EDIT MANUALLY
  # The lines between blank lines above and below are generated by a script. See create_updated_flutter_deps.py
  'dart_ai_rev': 'ec5d6aa38c8a6a9e687cc5223e2592ac91f2d5fe',
  'dart_binaryen_rev': '1d2e23d5e55788091a51420ba3a9889d4efe7509',
  'dart_boringssl_rev': 'db638238d29708a20b991af3b2488e45a8bbcf71',
  ...
  'dart_webdev_rev': '0b2a408f6f64a29cd0d18ac7d2d407a4e1db8e0f',
...
deps = {
  ...
  'engine/src/flutter/third_party/dart/third_party/pkg/test':
   Var('dart_git') + '/test.git@a16f14975c5625ef99abc71f7e91bca5d8e55054',
     ...
     'packages': [
       {
        ...
        'version': 'HUhTcRn-LUXa2Salu3L5Y7tBlXgCO-PziyhhTArrFxkC'
       }
     ],
