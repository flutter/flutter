...
vars = {
  ...
  'skia_revision': '433cf532e67ff3edd48c3251202ebfbd393daad9',
  ...
  'dart_revision': 'cc1280f98154b487696f7fd9122aaa9be5704a0d',
  ...
  'dart_devtools_rev': 'ed7cd142204fa3854594200e6ae85816e9537a85',
  'dart_ecosystem_rev': '9589e304b10069b51742b68e94d42a6874a1c9bb',
  ...
  'dart_tools_rev': '06493ded8ca27996d979f9f903d2bc24a1215064',
...
deps = {
  ...
  'engine/src/flutter/third_party/dart/third_party/devtools':
   {'dep_type': 'cipd', 'packages': [{'package': 'dart/third_party/flutter/devtools', 'version': 'git_revision:ed7cd142204fa3854594200e6ae85816e9537a85'}]},
  ...
  'engine/src/flutter/third_party/dart/third_party/pkg/test':
   Var('dart_git') + '/test.git@0d5fe4dcb20b4b601b4350398d32e3c47321f841',
     ...
     'packages': [
       {
        ...
        'version': '8ay15_eQOEgPHCypmui9O8jRkWEYMFH8jmoa-Voh5YMC'
       }
     ],
