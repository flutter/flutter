...
vars = {
  ...
  'skia_revision': 'e4bd0a355e6868eeaaecd6cc458a131ffeaa9f39',
  ...
  'dart_revision': 'e82d7ad1855ef1f48c6ecafbadda202c27445f31',
  ...
  'dart_boringssl_rev': 'c2d23258fc0dfdbd6bcca66a87d31b3209eb9fa3',
...
deps = {
  ...
  'engine/src/flutter/third_party/dart/third_party/pkg/dart_style':
   Var('dart_git') + '/dart_style.git@bdae98cead73a436920f890626aa81cf3f2f8904',
     ...
     'packages': [
       {
        ...
        'version': 'n7NohL9DPpEuPjNt9DpgQme-_7a_iRcMKbB5B23B-o8C'
       }
     ],
