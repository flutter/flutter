...
vars = {
  ...
  'skia_revision': 'd7b961c5f305fbb328ff3d6322b78b5db921fd20',
  ...
  'dart_revision': '5b21f8a7d5d3d0afd8db2ca757453fdbd2b86854',

  # WARNING: DO NOT EDIT MANUALLY
  # The lines between blank lines above and below are generated by a script. See create_updated_flutter_deps.py
  'dart_ai_rev': '058f8f571b0ab74784d218d43de23d95803e2877',
  'dart_binaryen_rev': 'fc3374548433eafaab08985ef0754d19273391d2',
     ...
     'packages': [
       {
        ...
        'version': 'Y-cMdgKy3d6EnibWRFgDPYYHIiD81lMxlZYa1vILsfoC'
       }
     ],
