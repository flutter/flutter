...
vars = {
  ...
  'dart_revision': '5f5efede7b3047a16e9a4ae8b70bf849c8de5e1f',
...
deps = {
  ...
  'engine/src/flutter/third_party/dart/third_party/pkg/test':
   Var('dart_git') + '/test.git@18ef597883dc6bc61f763e3600a7179975b490dd',
     ...
     'packages': [
       {
        ...
        'version': 'p8hHkUi8uWT9R3N4zn0UyxcH0MnBBvONrzoLk5KVt58C'
       }
     ],
