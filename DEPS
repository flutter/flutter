...
vars = {
  ...
  'skia_revision': 'fef0c5a8cdb131303701f5b31d24068cb604cd4e',
     ...
     'packages': [
       {
        ...
        'version': 'evOcilNU5vxsBmRd76GJmsc242eCvpreR2laiQqcyWEC'
       }
     ],
     ...
     'packages': [
       {
        ...
        'version': 'O69VeGryOb6EViFsMEkeU7N55-TySLesPbOiWxqYvt8C'
       }
     ],
