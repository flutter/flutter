...
vars = {
  ...
  'skia_revision': '191ef95dbe5483104ef6aaf8842b77fc97af8ae3',
  ...
  'dart_revision': 'b999c900f37abab66c04cabd9cd67560d8d5bfef',

  # WARNING: DO NOT EDIT MANUALLY
  # The lines between blank lines above and below are generated by a script. See create_updated_flutter_deps.py
  'dart_ai_rev': 'cf7d67f1e653cc9d8988ff0dc549eb7c357c3ef9',
  ...
  'dart_tools_rev': 'a0dda7e50bcd99fd3be8512cf546d872ba39e046',
...
deps = {
  ...
  'engine/src/flutter/third_party/dart/third_party/pkg/dartdoc':
   Var('dart_git') + '/dartdoc.git@8e6a95c4aba8def4ef01ccc600b3a3cfb8f3cb9e',
     ...
     'packages': [
       {
        ...
        'version': 'WvRLeTv2ocKsPOdrq6vLJD4yrP7nK7ElT9ieuFnvumUC'
       }
     ],
