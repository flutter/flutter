...
vars = {
  ...
  'skia_revision': '356185490a755eab4fa1b78446952533c2a0733b',
  ...
  'dart_revision': '3f8dbb5c6de3bec3c676aa86bd7d9d6b8b2bfe9f',
  ...
  'dart_boringssl_rev': 'f928215954536205fdae395ace4c9d671eef089a',
...
deps = {
  ...
  'engine/src/flutter/third_party/dart/third_party/pkg/native':
   Var('dart_git') + '/native.git@dfc75136655b780f5bc2a99a7413b73ec495fecd',
     ...
     'packages': [
       {
        ...
        'version': '6T6BY9PTftoG3vP_1Ddi1_Nqi1xca8qO67NMoHBC7ZUC'
       }
     ],
