...
vars = {
  ...
  'skia_revision': '4c8bedd3c932563c2e640a1ded37e36ea063bbb8',
  ...
  'dart_revision': '70665fc3fd2e1443e622be0f6e0512d7716942da',
  ...
  'dart_boringssl_rev': '2382739958b60b0f3c274a1e5fbd60dc17033681',
...
deps = {
  ...
  'engine/src/flutter/third_party/dart/third_party/pkg/dart_style':
   Var('dart_git') + '/dart_style.git@c9975c66895011079bb3a98dc2271f4e038d45e8',
     ...
     'packages': [
       {
        ...
        'version': 'j3UCWZhWx7zSl9AsyVtPlXxX4P6AWRkZQ3UjP0xepoQC'
       }
     ],
