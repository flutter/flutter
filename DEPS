...
vars = {
  ...
  'skia_revision': 'b8bda91f02dbaa7870a3649bd5130babbb24a5d3',
  ...
  'dart_revision': 'f653e9fc715d5ea627344089dd996736a25ba194',
  ...
  'dart_tools_rev': '0fc3b0e7eb79cd6dd5605e9ed2aa01a6d46f332a',
...
deps = {
  ...
  'engine/src/flutter/third_party/dart/third_party/pkg/dartdoc':
   Var('dart_git') + '/dartdoc.git@c771ad2a1809bc43fafaf3518986d159290bf0a4',
  ...
  'engine/src/flutter/third_party/dart/third_party/pkg/test':
   Var('dart_git') + '/test.git@5fcd6f405cc4a9c503f0eafa476d675f63a91bb8',
  ...
  'engine/src/flutter/third_party/dart/tools/sdks/dart-sdk':
   {'dep_type': 'cipd', 'packages': [{'package': 'dart/dart-sdk/${{platform}}', 'version': 'version:3.13.0-272.0.dev'}]},
     ...
     'packages': [
       {
        ...
        'version': 'J8rVTlBnjnUpuHYk3GUV56K4jK0m7uFmr1Q0qKsZnrgC'
       }
     ],
