...
vars = {
  ...
  'skia_revision': '391cdbe3ffe91cedc1a80950b7dee4170380093a',
  ...
  'dart_revision': 'fbddcbe0cd96c8b8f79e852c5bb67bedaf773d70',
  ...
  'dart_boringssl_rev': 'f175cb106c8c3a445968e8ba1dbf768e0f0ff04a',
...
deps = {
  ...
  'engine/src/flutter/third_party/dart/third_party/pkg/test':
   Var('dart_git') + '/test.git@17efdc2f8316c71cc9c8630274ae05e284b74595',
     ...
     'packages': [
       {
        ...
        'version': 'IdBT8fSMYrYSip65jW-4pEfhme3X3s0ls_CHk4a2usEC'
       }
     ],
