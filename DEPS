...
vars = {
  ...
  'skia_revision': 'f9db7748563e6bc60508a0453d5829f2b368c746',
  ...
  'dart_revision': '7dcea971af6bf51c9926379a3ee7ddbc40fae836',
  ...
  'dart_boringssl_rev': 'beddb582d9e8786a07d79f1cf054d4792b3dd81f',
...
deps = {
  ...
  'engine/src/flutter/third_party/dart/third_party/pkg/native':
   Var('dart_git') + '/native.git@77bd486568a6989a5c0a1c896793e99a21e71df7',
     ...
     'packages': [
       {
        ...
        'version': 'k9EizfEGJO4WwQN9-N9c2ts871cqWGC0c9kqHUp3MtAC'
       }
     ],
