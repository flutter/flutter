...
vars = {
  ...
  'skia_revision': '3872c989512c203a3966fd2ab40251c6af581750',
     ...
     'packages': [
       {
        ...
        'version': 'Z0aq5SyVCueXepauNtdROhIdP9Ur8XmjZHtWmWxvbJYC'
       }
     ],
     ...
     'packages': [
       {
        ...
        'version': 'UAi35C_0e3P3HVizCMW9FWHx-tvD82XH93L21nMMbqUC'
       }
     ],
