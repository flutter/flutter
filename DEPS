...
vars = {
  ...
  'dart_revision': '7d037943647b5a51c37bdbb552f52d2e9fb2f9fc',
...
deps = {
  ...
  'engine/src/flutter/third_party/dart/third_party/pkg/native':
   Var('dart_git') + '/native.git@0819678f481c1e69d9c62ecf8b0449978ae21c0a',
     ...
     'packages': [
       {
        ...
        'version': '7BGf7mPQvgLi7Axb6VX5ZdW0OJSXS_Gbsc5wWRmHvNQC'
       }
     ],
