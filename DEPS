...
vars = {
  ...
  'skia_revision': '7e45515fa34f0f12c870d5595685446cb51902f2',
     ...
     'packages': [
       {
        ...
        'version': 'Rf30gbsK-qLIRczcI5mNdX0EZsJw_kKwcEoldyzaAjoC'
       }
     ],
     ...
     'packages': [
       {
        ...
        'version': '9FJtglbv5CDboO0zmkxiO9R1vtrrTQg7EFp2-7huM1cC'
       }
     ],
