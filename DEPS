...
vars = {
  ...
  'dart_revision': 'b172bea4f008a2def7044c3b47671a2c89829c02',
  ...
  'dart_boringssl_rev': '4d969991f61733b4cab1ae871b136fd4dd6c6005',
  'dart_core_rev': '1ce6453c52f498e24fe769b1eba10565a3a61c6b',
  'dart_devtools_rev': 'be1d7ba3dddc84a6c6b0d4dca9ab62b8b3b24d29',
  ...
  'dart_webdev_rev': '1e47b492c0d364020615128573d12fec928aac07',
...
deps = {
  ...
  'engine/src/flutter/third_party/icu':
   Var('chromium_git') + '/chromium/deps/icu.git' + '@' + '8143382a77ef4b99c28a07edc744ad18986c5ae2',
  ...
  'engine/src/flutter/third_party/dart/third_party/pkg/native':
   Var('dart_git') + '/native.git@7d803f16c4d5a34844b3572962c78715c4ddcecf',
  ...
  'engine/src/flutter/third_party/dart/third_party/pkg/test':
   Var('dart_git') + '/test.git@36b9d8291803520b969b9ee623edf276fcc5d5e0',
     ...
     'packages': [
       {
        ...
        'version': 'x9x76ERXhrt0Q3zKfNO9bUG3eZiq0xT5ASfAnHaPBQUC'
       }
     ],
