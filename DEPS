...
vars = {
  ...
  'skia_revision': 'ca102ecb5833e1394a8c4dcdb01be4a6e6d5f229',
  ...
  'dart_revision': 'ebaf52c13799a47d5cebca8b83ee94132168891d',
  ...
  # environment.
  'fuchsia_test_scripts_version': '74yRDW9d1w02T5mA9NVTBgH-BTb-wqX8g9TIuPo6OZEC',
     ...
     'packages': [
       {
        ...
        'version': 'vTYb37OeUqZRxpiiPaBU-CXL0vSVAoLWpOJnffVIBs8C'
       }
     ],
