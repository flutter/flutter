...
vars = {
  ...
  'dart_revision': 'c929e6d3d08f1f679d884638c89c70e5fb8196d1',
...
deps = {
  ...
  'engine/src/flutter/third_party/libcxx':
   Var('llvm_git') + '/llvm-project/libcxx' + '@' + '14842c535134fcdbc3f749344b95072408880d91',
  ...
  'engine/src/flutter/third_party/dart/third_party/pkg/native':
   Var('dart_git') + '/native.git@8663dfa953ac4eb8713f9f4057355e7718500442',
