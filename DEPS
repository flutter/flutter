...
vars = {
  ...
  'skia_revision': '244a6a0f8f92fcf17e5d6cdb134b0174893d6b9f',
  ...
  'dart_revision': '7739e8602bc1ff45ebc74961c49b01d7fdbe37ca',
     ...
     'packages': [
       {
        ...
        'version': 'MstTWE1RDOT-RnrtHICNgexLpLNxObOtfAObTQVkz5MC'
       }
     ],
