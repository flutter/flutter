...
vars = {
  ...
  'skia_revision': 'ab1b10547461cfa7dc67bbbaf5d16f07d43e993b',
  ...
  'dart_revision': 'de5dd0f1530f292ad73fcd2a23eb6ae86cf0d5be',
  ...
  'dart_tools_rev': '4254267d4aa8e4e9c2fa4e0113975d21857aa9e4',
  'dart_vector_math_rev': '3939545edc38ed657381381d33acde02c49ff827',
  'dart_web_rev': '25a0b5b0a4a126788c06738331c5c4af8225f6f8',
...
deps = {
  ...
  'engine/src/flutter/third_party/dart/third_party/pkg/native':
   Var('dart_git') + '/native.git@445cb0af620328ff04aeed028a60065ec6e5c7ce',
     ...
     'packages': [
       {
        ...
        'version': '0_jKqLGnkILvQ5C8aRrrHQg0vjLYDoUgZd5M_bVmpkYC'
       }
     ],
