...
vars = {
  ...
  'skia_revision': 'cc2b574346514202c61176272644fd6c3138888c',
  ...
  'dart_revision': 'b1eb743f97f5615db73e418b9ef5beea392a2a2e',
     ...
     'packages': [
       {
        ...
        'version': 'm8Aln7fTF_8zy1V9NZfD1vpUEoV2MluzsQUsHELpaPcC'
       }
     ],
