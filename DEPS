...
vars = {
  ...
  'skia_revision': '4703976a4daee1b35b7f865c9791047688c6c4c6',
  ...
  'dart_revision': 'aecf86b2d4410d2fd55788427adaf873183315cd',
     ...
     'packages': [
       {
        ...
        'version': 'L5zGzsIWIS8N36AFQxlnDPvZKN83RooJwpTS9NlfYJYC'
       }
     ],
