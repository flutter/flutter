...
vars = {
  ...
  'dart_revision': '9c035c8c422f837a3108c601656f7a1ee3f1cace',
...
deps = {
  ...
  'engine/src/flutter/third_party/dart/third_party/pkg/native':
   Var('dart_git') + '/native.git@2d4b07ae9a11ede9d434dbef5cded0ad08e22e3f',
  ...
  'engine/src/flutter/third_party/dart/third_party/pkg/test':
   Var('dart_git') + '/test.git@5ffcb36fd6c82843f25ed96585a4b9e96022e7f9',
     ...
     'packages': [
       {
        ...
        'version': 'XtPp9bBW49iDJ0wbA1UG0dPvdkv-qvqx-nv85QSCJDUC'
       }
     ],
