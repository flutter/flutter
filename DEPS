...
vars = {
  ...
  'skia_revision': 'c46f2def39045c8c5263c124204685b03922a884',
  ...
  'dart_revision': '9e605f706cdfde5ab298d073f8639f18c7c99d2e',
  ...
  'dart_tools_rev': '37f82420f5060ca70af79b8a3ee98c91b66d250b',
...
deps = {
  ...
  'engine/src/flutter/third_party/dart/third_party/pkg/native':
   Var('dart_git') + '/native.git@43a691c2152dd9b699259e29356d10edab17ec14',
     ...
     'packages': [
       {
        ...
        'version': 'nzuAxCJGeJbkZCTkrdI6DyknYW9g6jZ2N1Q8nIGO3EUC'
       }
     ],
