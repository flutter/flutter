...
vars = {
  ...
  'skia_revision': 'efccaeb08b8d4febfa3901b9d13335a1b64524cf',
  ...
  # environment.
  'fuchsia_test_scripts_version': 'm6LxGKnUnAWW9p1s1Mcrsco6Rq6t0AmO-bkosZkpOZMC',
     ...
     'packages': [
       {
        ...
        'version': 'mqhX1OP8ezmialgqAc3eZJcppXbNCUuwaAG2g02tFcoC'
       }
     ],
