...
class BaseMessageChannel<T> {
  /// Creates a [BaseMessageChannel] with the specified [name] and [codec].
  ///
...
/// A [BaseMethodChannel] that ignores missing platform plugins.
///
/// When [invokeMethod] fails to find the platform plugin, it returns null
/// instead of throwing an exception.
class BaseOptionalMethodChannel extends BaseMethodChannel {
  /// Creates a [BaseMethodChannel] that ignores missing platform plugins.
  const BaseOptionalMethodChannel(String name, BinaryMessenger binaryMessenger,
      [MethodCodec codec = const StandardMethodCodec()])
      : super(name, binaryMessenger, codec);
