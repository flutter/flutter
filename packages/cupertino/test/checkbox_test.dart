...
void main() {
  ...
  testWidgets('Checkbox can configure a semantic label', (
    WidgetTester tester,
  ) async {
    final SemanticsHandle handle = tester.ensureSemantics();
  ...
  testWidgets('Checkbox default colors, and size in light mode', (
    WidgetTester tester,
  ) async {
  ...
  testWidgets('Checkbox default colors, and size in dark mode', (
    WidgetTester tester,
  ) async {
    Widget buildCheckbox({bool value = true}) {
      return CupertinoApp(
  ...
  testWidgets('Disabled checkbox default colors, and size in light mode', (
    ...
    Widget buildCheckbox({bool value = true}) {
      return CupertinoApp(
        home: Center(
          child: RepaintBoundary(
            child: CupertinoCheckbox(value: value, onChanged: null),
          ),
        ),
      );
    }
  ...
  testWidgets('Checkbox fill color resolves in enabled/disabled states', (
    ...
    final WidgetStateProperty<Color> fillColor = WidgetStateColor.resolveWith(
      getFillColor,
    );
  ...
  testWidgets(
    'Checkbox fill color take precedence over active/inactive colors',
  ...
  testWidgets('Checkbox configures focus color', (WidgetTester tester) async {
    ...
    await tester.pumpWidget(
      buildApp(focusColor: testFocusColor, focusNode: node, autofocus: true),
    );
    await tester.pump();
    expect(node.hasPrimaryFocus, isTrue);
    expect(
  ...
  testWidgets('Checkbox is darkened when pressed in light mode', (
    WidgetTester tester,
  ) async {
    const Color defaultCheckColor = Color(0xffffffff);
    const Color defaultActiveFillColor = Color(0xff007aff);
  ...
  testWidgets('Checkbox is lightened when pressed in dark mode', (
    WidgetTester tester,
  ) async {
