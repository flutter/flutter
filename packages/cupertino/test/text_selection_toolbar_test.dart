...
void main() {
  ...
  testWidgets(
    'correctly sizes large toolbar buttons',
    (WidgetTester tester) async {
  ...
  testWidgets('Arrow points upwards if toolbar is below the anchor', (
    WidgetTester tester,
  ) async {
    await tester.pumpWidget(
      CupertinoApp(
        home: Builder(
          builder: (BuildContext context) {
            return MediaQuery(
              data: MediaQuery.of(
                context,
              ).copyWith(padding: const EdgeInsets.only(top: 59.0)),
              child: Padding(
      ...
      paints
        ...
        ..clipPath(
          pathMatcher: isPathThat(
            includes: <Offset>[
              const Offset(18.0, 49.0),
              const Offset(25.0, 42.0),
            ],
            excludes: <Offset>[
              const Offset(18.0, 0.0),
              const Offset(25.0, 7.0),
            ],
          ),
        ),
    );
