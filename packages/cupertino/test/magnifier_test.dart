  ...
  group('CupertinoTextEditingMagnifier', () {
    ...
    group('position', () {
      ...
      testWidgets(
        ...
        (WidgetTester tester) async {
          ...
          // Magnifier should be positioned directly over the red square.
          final RenderBox tapPointRenderBox =
              tester.firstRenderObject(find.byKey(fakeTextFieldKey))
                  as RenderBox;
          final Rect fakeTextFieldRect =
    ...
    group('magnificationScale', () {
      testWidgets('Throws assertion error when magnificationScale is zero', (
        ...
        expect(
          () => MaterialApp(
            home: Scaffold(body: CupertinoMagnifier(magnificationScale: 0)),
          ),
      ...
      testWidgets(
        'Throws assertion error when magnificationScale is negative',
        (WidgetTester tester) async {
          expect(
            () => MaterialApp(
              home: Scaffold(body: CupertinoMagnifier(magnificationScale: -1)),
            ),
            throwsAssertionError,
          );
        },
      ...
      testWidgets('CupertinoMagnifier magnification scale defaults to 1', (
        ...
        await tester.pumpWidget(
          const MaterialApp(home: Scaffold(body: CupertinoMagnifier())),
        );
      ...
      testWidgets(
        'Magnification scale argument is passed to the RawMagnifier',
        (WidgetTester tester) async {
          await tester.pumpWidget(
            const MaterialApp(
              home: Scaffold(body: CupertinoMagnifier(magnificationScale: 2)),
            ),
          );
