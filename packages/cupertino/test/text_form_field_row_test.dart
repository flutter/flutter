...
import '../../flutter/test/widgets/editable_text_utils.dart';
...
void main() {
  ...
  testWidgets(
    'Passes spellCheckConfiguration to underlying CupertinoTextField',
  ...
  testWidgets('Passes scrollPhysics to underlying TextField', (
    ...
    await tester.pumpWidget(
      CupertinoApp(
        home: Center(
          child: CupertinoTextFormFieldRow(scrollPhysics: scrollPhysics),
        ),
      ),
    );
  ...
  testWidgets(
    ...
    (WidgetTester tester) async {
      ...
      final EditableTextState editableTextState = tester.firstState(
  ...
  testWidgets('reset resets the text fields value to the initialValue', (
    ...
    await tester.pumpWidget(
      CupertinoApp(
        home: Center(
          child: CupertinoTextFormFieldRow(initialValue: 'initialValue'),
        ),
      ),
    );
  ...
  testWidgets('onChanged callbacks value and FormFieldState.value are sync', (
    ...
    state = tester.state<FormFieldState<String>>(
      find.byType(CupertinoTextFormFieldRow),
    );
  ...
  testWidgets('autofillHints is passed to super', (WidgetTester tester) async {
    ...
    final CupertinoTextField widget = tester.widget(
  ...
  testWidgets('Shows prefix', (WidgetTester tester) async {
    await tester.pumpWidget(
      CupertinoApp(
        home: Center(
          child: CupertinoTextFormFieldRow(prefix: const Text('Enter Value')),
        ),
      ),
    );
  ...
  testWidgets('Passes textDirection to underlying CupertinoTextField', (
    ...
    await tester.pumpWidget(
      CupertinoApp(
        home: Center(
          child: CupertinoTextFormFieldRow(textDirection: TextDirection.ltr),
        ),
      ),
    );
    ...
    final CupertinoTextField ltrTextFieldWidget = tester.widget(
      ltrTextFieldFinder,
    );
    ...
    await tester.pumpWidget(
      CupertinoApp(
        home: Center(
          child: CupertinoTextFormFieldRow(textDirection: TextDirection.rtl),
        ),
      ),
    );
    ...
    final CupertinoTextField rtlTextFieldWidget = tester.widget(
      rtlTextFieldFinder,
    );
