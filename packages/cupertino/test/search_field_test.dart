...
void main() {
  ...
  testWidgets('decoration overrides default background color', (
    WidgetTester tester,
  ) async {
    await tester.pumpWidget(
      const CupertinoApp(
  ...
  testWidgets('decoration overrides default border radius', (
    WidgetTester tester,
  ) async {
    await tester.pumpWidget(
      const CupertinoApp(
  ...
  testWidgets('text entries are padded by default', (
    WidgetTester tester,
  ) async {
  ...
  testWidgets('can control text content via controller', (
    WidgetTester tester,
  ) async {
    final TextEditingController controller = TextEditingController();
    addTearDown(controller.dispose);
  ...
  testWidgets('prefix widget is in front of the text', (
    WidgetTester tester,
  ) async {
    final TextEditingController controller = TextEditingController(
      text: 'input',
  ...
  testWidgets('Default prefix and suffix insets are aligned', (
    WidgetTester tester,
  ) async {
    await tester.pumpWidget(
      const CupertinoApp(home: Center(child: CupertinoSearchTextField())),
    ...
    expect(
      tester.getTopLeft(find.byIcon(CupertinoIcons.search)),
      const Offset(6.0, 290.0),
    );
    expect(
    ...
    expect(
      tester.getBottomRight(find.byIcon(CupertinoIcons.search)),
      const Offset(26.0, 310.0),
    );
    expect(
  ...
  testWidgets('RTL puts attachments to the right places', (
    WidgetTester tester,
  ) async {
    await tester.pumpWidget(
      const CupertinoApp(
  ...
  testWidgets('Can modify prefix and suffix insets', (
    WidgetTester tester,
  ) async {
    await tester.pumpWidget(
      const CupertinoApp(
  ...
  testWidgets('cursorWidth is properly forwarded to the inner text field', (
    ...
    await tester.pumpWidget(
      const CupertinoApp(
        home: Center(child: CupertinoSearchTextField(cursorWidth: 1)),
      ),
    );
  ...
  testWidgets('cursorHeight is properly forwarded to the inner text field', (
    ...
    await tester.pumpWidget(
      const CupertinoApp(
        home: Center(child: CupertinoSearchTextField(cursorHeight: 10)),
      ),
    );
  ...
  testWidgets('cursorRadius is properly forwarded to the inner text field', (
    ...
    await tester.pumpWidget(
      const CupertinoApp(
        home: Center(
          child: CupertinoSearchTextField(cursorRadius: Radius.circular(1.0)),
        ),
      ),
    );
  ...
  testWidgets(
    'cursorOpacityAnimates is properly forwarded to the inner text field',
    (WidgetTester tester) async {
      await tester.pumpWidget(
        const CupertinoApp(
          home: Center(
            child: CupertinoSearchTextField(cursorOpacityAnimates: false),
          ),
        ),
      );
  ...
  testWidgets('Icons and placeholder fade while resizing on scroll', (
    WidgetTester tester,
  ) async {
    await tester.pumpWidget(
      const CupertinoApp(
    ...
    expect(
      tester
          .widget<Opacity>(
            find.ancestor(of: suffixIconFinder, matching: find.byType(Opacity)),
          )
          .opacity,
      equals(1.0),
    );
    ...
    final double searchTextFieldHeight = tester
        .getSize(searchTextFieldFinder)
        .height;
  ...
  testWidgets('Top padding animates while resizing on scroll', (
    WidgetTester tester,
  ) async {
  ...
  testWidgets(
    'Fades and animates insets on scroll if search field starts out collapsed',
    (WidgetTester tester) async {
      const TextDirection direction = TextDirection.ltr;
      ...
      final Finder searchTextFieldFinder = find.byType(
      ...
      await scrollGesture2.moveBy(
        Offset(0, scrollOffset - searchTextFieldHeight / 2),
      );
      await scrollGesture2.up();
      await tester.pump();
