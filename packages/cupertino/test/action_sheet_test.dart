...
void main() {
  testWidgets('Overall appearance is correct for the light theme', (
    WidgetTester tester,
  ) async {
  ...
  testWidgets('Overall appearance is correct for the dark theme', (
    WidgetTester tester,
  ) async {
    await tester.pumpWidget(
      TestScaffoldApp(
    ...
    final TestGesture gesture = await tester.startGesture(
      tester.getCenter(find.text('Button 0')),
    );
    await tester.pumpAndSettle();
    // This golden file also verifies the structure of an action sheet that
  ...
  testWidgets('Button appearance is correct with text scaling', (
    WidgetTester tester,
  ) async {
  ...
  testWidgets('Actions section correctly renders overscrolls', (
    WidgetTester tester,
  ) async {
  ...
  testWidgets(
    'Actions section correctly renders overscrolls with very far scrolls',
    (WidgetTester tester) async {
      ...
      await gesture.moveBy(
        const Offset(0, 40),
      ); // A short drag to start the gesture.
      await tester.pumpAndSettle();
  ...
  testWidgets('Can tap after scrolling', (WidgetTester tester) async {
    ...
    final TestGesture gesture = await tester.startGesture(
      tester.getCenter(find.text('Button 1')),
    );
    await tester.pumpAndSettle();
    // The dragging gesture must be dispatched in at least two segments.
  ...
  testWidgets('Taps at the padding of buttons calls onPressed', (
    WidgetTester tester,
  ) async {
  ...
  testWidgets('Taps on a button can be slided to other buttons', (
    WidgetTester tester,
  ) async {
    int? pressed;
    await tester.pumpWidget(
  ...
  testWidgets('Taps on the content can be slided to other buttons', (
    WidgetTester tester,
  ) async {
    bool wasPressed = false;
    await tester.pumpWidget(
    ...
    final TestGesture gesture = await tester.startGesture(
      tester.getCenter(find.text('The title')),
    );
    await tester.pumpAndSettle();
  ...
  testWidgets('Taps on the barrier can not be slided to buttons', (
    WidgetTester tester,
  ) async {
    bool wasPressed = false;
    await tester.pumpWidget(
  ...
  testWidgets(
    'Sliding taps can still yield to scrolling after horizontal movement',
    (WidgetTester tester) async {
      int? pressed;
      await tester.pumpWidget(
        createAppWithButtonThatLaunchesActionSheet(
  ...
  testWidgets('Sliding taps only recognizes the primary pointer', (
    WidgetTester tester,
  ) async {
    int? pressed;
    await tester.pumpWidget(
  ...
  testWidgets('Non-primary pointers can trigger scroll', (
    WidgetTester tester,
  ) async {
    int? pressed;
    await tester.pumpWidget(
  ...
  testWidgets('Taps on legacy button calls onPressed and renders correctly', (
    ...
    final TestGesture gesture = await tester.startGesture(
      tester.getCenter(find.text('Legacy')),
    );
    await tester.pump(const Duration(seconds: 1));
    expect(wasPressed, isFalse);
    await expectLater(
  ...
  testWidgets('Layout is correct when cancel button is present', (
    ...
    expect(
      tester
          .getBottomLeft(find.widgetWithText(CupertinoActionSheetAction, 'Two'))
          .dy,
  ...
  testWidgets('The maximum size is correct on iPhone SE gen 3', (
    WidgetTester tester,
  ) async {
    const double expectedHeight =
        667 // View height
  ...
  testWidgets('The maximum size is correct on iPhone 13 Pro', (
    WidgetTester tester,
  ) async {
    const double expectedHeight =
        844 // View height
  ...
  testWidgets('The maximum size is correct on iPhone 15 Plus', (
    WidgetTester tester,
  ) async {
    const double expectedHeight =
        932 // View height
  ...
  testWidgets('Animation is correct if entering is canceled halfway', (
    WidgetTester tester,
  ) async {
  ...
  testWidgets('CupertinoActionSheet action cursor behavior', (
    WidgetTester tester,
  ) async {
