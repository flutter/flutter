...
void main() {
  ...
  testWidgets('Middle auto-populates with title', (WidgetTester tester) async {
    ...
    expect(
      find.widgetWithText(CupertinoNavigationBar, 'An iPod'),
      findsOneWidget,
    );
  ...
  testWidgets('Large title auto-populates with title', (
            ...
            builder: (BuildContext context) {
              return const CupertinoPageScaffold(
                child: CustomScrollView(
                  slivers: <Widget>[CupertinoSliverNavigationBar()],
                ),
              );
            },
          ),
    ...
    final List<Element> titles =
        tester.elementList(find.text('An iPod')).toList()..sort((
          Element a,
          Element b,
        ) {
  ...
  testWidgets('Leading auto-populates with back button with previous title', (
    ...
    expect(
      find.widgetWithText(CupertinoNavigationBar, 'A Phone'),
      findsOneWidget,
    );
  ...
  testWidgets('Fullscreen route animates correct transform values over time', (
    ...
    expect(
      tester.getTopLeft(find.byType(Placeholder)).dy,
  ...
  Future<void> testParallax(
    WidgetTester tester, {
    required bool fromFullscreenDialog,
  }) async {
    await tester.pumpWidget(
      CupertinoApp(
  ...
  testWidgets('Dragged pop gesture is linear', (WidgetTester tester) async {
    ...
    final TestGesture swipeGesture = await tester.startGesture(
      const Offset(5, 100),
    );
  ...
  testWidgets('Pop gesture snapping is not linear', (
    ...
    expect(
      tester.getTopLeft(find.text('1')).dx,
      moreOrLessEquals(-61, epsilon: 1),
    );
    expect(
      tester.getTopLeft(find.text('2')).dx,
      moreOrLessEquals(614, epsilon: 1),
    );
    ...
    expect(
      tester.getTopLeft(find.text('1')).dx,
      moreOrLessEquals(-26, epsilon: 1),
    );
    expect(
      tester.getTopLeft(find.text('2')).dx,
      moreOrLessEquals(721, epsilon: 1),
    );
  ...
  testWidgets(
    ...
    (WidgetTester tester) async {
      ...
      await tester.pumpAndSettle();
      expect(
        navigatorObserver.invocations.removeLast(),
  ...
  For a rect with an expected left-side position: $dx (drawn at ${rect.left}):
        ...
        final RenderBox box = tester.firstRenderObject<RenderBox>(
        ...
        expect(
          box,
          paintsShadowRect(dx: 795, color: CupertinoColors.transparent),
        );
        expect(
          box,
          paintsShadowRect(dx: 785, color: CupertinoColors.transparent),
        );
        expect(
          box,
          paintsShadowRect(dx: 775, color: CupertinoColors.transparent),
        );
        expect(
          box,
          paintsShadowRect(dx: 765, color: CupertinoColors.transparent),
        );
        expect(
          box,
          paintsShadowRect(dx: 755, color: CupertinoColors.transparent),
        );
        ...
        expect(
          box,
          paintsShadowRect(dx: 266, color: CupertinoColors.transparent),
        );
        expect(
          box,
          paintsShadowRect(dx: 266, color: CupertinoColors.transparent),
        ...
        expect(
          box,
          paintsShadowRect(dx: -40, color: CupertinoColors.transparent),
        );
        ...
        expect(
          box,
          paintsShadowRect(dx: 458, color: CupertinoColors.transparent),
        );
        ...
        expect(
          box,
          paintsShadowRect(dx: 784, color: CupertinoColors.transparent),
        );
        expect(
          box,
          paintsShadowRect(dx: 774, color: CupertinoColors.transparent),
        );
        expect(
          box,
          paintsShadowRect(dx: 764, color: CupertinoColors.transparent),
        );
        expect(
          box,
          paintsShadowRect(dx: 754, color: CupertinoColors.transparent),
        );
      },
    );
  ...
  testWidgets('During back swipe the route ignores input', (
    ...
    await tester.pump();
    expect(
      tester.getTopLeft(find.byKey(pageScaffoldKey)),
      const Offset(400, 0),
    );
  ...
  testWidgets('CupertinoPage works', (WidgetTester tester) async {
    ...
    expect(
      find.widgetWithText(CupertinoNavigationBar, 'title one'),
      findsOneWidget,
    );
    ...
    expect(
      find.widgetWithText(CupertinoNavigationBar, 'title two'),
      findsOneWidget,
    );
  });
  ...
  testWidgets('CupertinoModalPopupRoute is state restorable', (
    ...
    final TestRestorationData restorationData = await tester
        .getRestorationData();
  ...
  group('showCupertinoDialog avoids overlapping display features', () {
    testWidgets('positioning with anchorPoint', (WidgetTester tester) async {
      ...
      expect(
        tester.getTopLeft(find.byType(Placeholder)),
  ...
  testWidgets('fullscreen routes do not transition previous route', (
    WidgetTester tester,
  ) async {
    await tester.pumpWidget(
      CupertinoApp(
  ...
  testWidgets(
    ...
    (WidgetTester tester) async {
      ...
      ); // Advance route transition animation.
  ...
  testWidgets('requestFocus works correctly in showCupertinoDialog.', (
    WidgetTester tester,
  ) async {
    final GlobalKey<NavigatorState> navigatorKey = GlobalKey<NavigatorState>();
    final FocusNode focusNode = FocusNode();
