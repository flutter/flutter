...
void main() {
  ...
  group('canSelectAll', () {
    ...
    testWidgets('should return false when there is no text', (
      ...
      expect(
        cupertinoTextSelectionControls.canSelectAll(key.currentState!),
        false,
      );
    });
  ...
  group('Text selection menu overflow (iOS)', () {
    ...
    testWidgets(
      ...
      (WidgetTester tester) async {
        ...
        expect(
          find.text(_longLocalizations.selectAllButtonLabel),
          findsNothing,
        );
        expect(findOverflowBackButton(), findsNothing);
        expect(findOverflowNextButton(), findsNothing);
  ...
  testWidgets(
    ...
    (WidgetTester tester) async {
      ...
      final EditableText editableTextWidget = tester.widget(
        find.byType(EditableText),
      );
      final EditableTextState editableTextState = tester.state(
        find.byType(EditableText),
      );
