...
void main() {
              ...
              children: <Widget>[
                ...
                Text(
                  CupertinoLocalizations.of(
                    context,
                  ).datePickerMediumDate(DateTime(2018, 10, 4)),
                ),
              ],
            );
          },
  ...
  testWidgets('CupertinoApp.navigatorKey can be updated', (
    ...
    await tester.pumpWidget(
      CupertinoApp(navigatorKey: key1, home: const Placeholder()),
    );
    expect(key1.currentState, isA<NavigatorState>());
    final GlobalKey<NavigatorState> key2 = GlobalKey<NavigatorState>();
    await tester.pumpWidget(
      CupertinoApp(navigatorKey: key2, home: const Placeholder()),
    );
  ...
  testWidgets('CupertinoApp has correct default KeyboardDismissBehavior', (
    ...
    expect(
      ScrollConfiguration.of(
        capturedContext,
      ).getKeyboardDismissBehavior(capturedContext),
  ...
  testWidgets(
    'CupertinoApp uses the dark SystemUIOverlayStyle when the background is light',
    (WidgetTester tester) async {
      await tester.pumpWidget(
        const CupertinoApp(
          theme: CupertinoThemeData(brightness: Brightness.light),
  ...
  testWidgets(
    'CupertinoApp uses the light SystemUIOverlayStyle when the background is dark',
    (WidgetTester tester) async {
      await tester.pumpWidget(
        const CupertinoApp(
          theme: CupertinoThemeData(brightness: Brightness.dark),
  ...
  testWidgets(
    ...
    (WidgetTester tester) async {
      ...
      await tester.pumpWidget(
        const CupertinoApp(home: CupertinoPageScaffold(child: Text('Hello'))),
      );
        ...
        CupertinoApp(
          ...
          home: CupertinoPageScaffold(
            child: Builder(
              builder: (BuildContext context) {
                return EditableText(
                  backgroundCursorColor: DefaultSelectionStyle.of(
                    context,
                  ).selectionColor!,
