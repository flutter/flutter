...
Future<CupertinoThemeData> testTheme(
  ...
  await tester.pumpWidget(
    CupertinoTheme(data: theme, child: singletonThemeSubtree),
  );
  return actualTheme!;
}
...
void main() {
  ...
  testWidgets(
    ...
    (WidgetTester tester) async {
      ...
      final IconThemeData resultingIconTheme = await testIconTheme(
        tester,
        themeData,
      );
  ...
  testWidgets('CupertinoThemeData equality', (WidgetTester tester) async {
    const CupertinoThemeData a = CupertinoThemeData(
      brightness: Brightness.dark,
    );
