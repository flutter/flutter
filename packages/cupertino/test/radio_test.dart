...
void main() {
  ...
  testWidgets('Radio semantics', (WidgetTester tester) async {
    ...
    await tester.pumpWidget(
      const CupertinoApp(
        home: Center(
          child: CupertinoRadio<int>(value: 1, groupValue: 2, onChanged: null),
        ),
      ),
    );
    ...
    await tester.pumpWidget(
      const CupertinoApp(
        home: Center(
          child: CupertinoRadio<int>(value: 2, groupValue: 2, onChanged: null),
        ),
      ),
    );
  ...
  testWidgets(
    'Radio has correct default active/inactive/fill/border colors in light mode',
    (WidgetTester tester) async {
  ...
  testWidgets(
    'Radio has correct default active/inactive/fill/border colors in dark mode',
    (WidgetTester tester) async {
      Widget buildRadio({
        required int value,
  ...
  testWidgets('Radio can set inactive/active/fill colors', (
    WidgetTester tester,
  ) async {
  ...
  testWidgets('Radio is slightly darkened when pressed in light mode', (
    WidgetTester tester,
  ) async {
  ...
  testWidgets('Radio is slightly lightened when pressed in dark mode', (
    WidgetTester tester,
  ) async {
    const Color activeInnerColor = Color(0xffffffff);
    const Color activeOuterColor = Color(0xff007aff);
  ...
  testWidgets('Radio is focusable and has correct focus colors', (
    WidgetTester tester,
  ) async {
    const Color activeInnerColor = Color(0xffffffff);
    const Color activeOuterColor = Color(0xff007aff);
  ...
  testWidgets('Radio configures mouse cursor', (WidgetTester tester) async {
    ...
    await gesture.addPointer(
      location: tester.getCenter(find.byType(CupertinoRadio<int>)),
    );
    await tester.pump();
