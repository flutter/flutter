...
void main() {
  ...
  testWidgets('Pressing on disabled buttons does not trigger highlight', (
    ...
    await expectLater(
      find.byType(CupertinoAlertDialog),
      matchesGoldenFile(
        'cupertinoAlertDialog.press_disabled_slide_to_enabled.png',
      ),
    );
  ...
  testWidgets(
    'Action buttons shows pressed highlight as soon as the pointer is down',
    (WidgetTester tester) async {
  ...
  testWidgets('showCupertinoDialog - custom barrierColor', (
    WidgetTester tester,
  ) async {
    await tester.pumpWidget(
      CupertinoApp(
  ...
  testWidgets(
    'CupertinoAlertDialog divider spans full width and applies color',
    (WidgetTester tester) async {
