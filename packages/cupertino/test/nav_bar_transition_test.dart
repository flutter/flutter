...
void main() {
  ...
  testWidgets('Bottom middle and top back label transitions their font', (
    ...
    expect(
      bottomMiddle.text.style!.color,
      isSameColorAs(const Color(0xff000306)),
    );
    ...
    expect(
      bottomMiddle.text.style!.color,
      isSameColorAs(const Color(0xff005ec5)),
    );
  ...
  testWidgets('Font transitions respect themes', (WidgetTester tester) async {
    ...
    expect(
      bottomMiddle.text.style!.color,
      isSameColorAs(const Color(0xfff8fbff)),
    );
    expect(bottomMiddle.text.style!.fontWeight, FontWeight.w600);
    expect(bottomMiddle.text.style!.fontFamily, 'CupertinoSystemText');
    expect(bottomMiddle.text.style!.letterSpacing, -0.41);
    ...
    expect(
      bottomMiddle.text.style!.color,
      isSameColorAs(const Color(0xff409fff)),
    );
    expect(bottomMiddle.text.style!.fontWeight, FontWeight.w400);
    expect(bottomMiddle.text.style!.fontFamily, 'CupertinoSystemText');
    expect(bottomMiddle.text.style!.letterSpacing, -0.41);
  ...
  testWidgets(
    'Navigation bars in a CupertinoSheetRoute have no hero transitions',
          ...
          .push(
            CupertinoSheetRoute<void>(
              builder: (BuildContext context) => scaffoldForNavBar(
                const CupertinoNavigationBar(middle: Text('Page 1')),
              )!,
            ),
          );
    ...
    expect(
      flying(
        ...
        find.byWidgetPredicate(
          (Widget widget) => widget.key != null && widget.key is GlobalKey,
        ),
      ),
      findsNothing,
    );
  ...
  testWidgets('Bottom nav bar transition background box', (
    WidgetTester tester,
  ) async {
    await startTransitionBetween(
      tester,
  ...
  testWidgets('Top nav bar transition background box', (
    WidgetTester tester,
  ) async {
    await startTransitionBetween(
      tester,
  ...
  testWidgets(
    'Extended large title removes bottom nav bar transition background box ',
    (WidgetTester tester) async {
  ...
  testWidgets('First appearance of back chevron fades in from the right', (
    ...
    expect(
      tester.getTopLeft(backChevron).dx,
      moreOrLessEquals(80.54, epsilon: 0.01),
    );
    expect(
      tester.getTopLeft(backChevron).dy,
      moreOrLessEquals(14.5, epsilon: 0.01),
    );
    ...
    expect(
      tester.getTopLeft(backChevron).dx,
      moreOrLessEquals(14.0, epsilon: 0.01),
    );
    expect(
      tester.getTopLeft(backChevron).dy,
  ...
  testWidgets('First appearance of back chevron fades in from the left in RTL', (
    ...
    checkOpacity(tester, backChevron, 0.0);
    expect(
      tester.getTopRight(backChevron).dx,
      moreOrLessEquals(706.66, epsilon: 0.01),
    );
    expect(
      tester.getTopRight(backChevron).dy,
      moreOrLessEquals(14.5, epsilon: 0.01),
    );
    ...
    expect(
      tester.getTopRight(backChevron).dx,
      moreOrLessEquals(760.41, epsilon: 0.01),
    );
    expect(
      tester.getTopRight(backChevron).dy,
      moreOrLessEquals(7.0, epsilon: 0.01),
  ...
  testWidgets(
    'Bottom CupertinoSliverNavigationBar.bottom fades and slides out from the left',
    (WidgetTester tester) async {
      setWindowToPortrait(tester);
      await startTransitionBetween(
        tester,
  ...
  testWidgets(
    'Bottom CupertinoNavigationBar.bottom fades and slides out from the left',
    (WidgetTester tester) async {
      setWindowToPortrait(tester);
      await startTransitionBetween(
        tester,
  ...
  testWidgets('Long title turns into the word back mid transition', (
    ...
    expect(
      tester
          .getTopLeft(flying(tester, find.text('A title too long to fit')))
          .dx,
      moreOrLessEquals(17.3, epsilon: 0.01),
    );
    expect(
  ...
  testWidgets('Bottom large title and top back label transitions their font', (
    ...
    expect(
      bottomLargeTitle.text.style!.color,
      isSameColorAs(const Color(0xff000306)),
    );
  ...
  testWidgets(
    'Top CupertinoSliverNavigationBar.bottom is aligned with top large title animation',
    (WidgetTester tester) async {
      ...
      checkOpacity(
        tester,
        flying(tester, find.byType(Placeholder)),
        largeTitleOpacity,
      );

      Offset largeTitleOffset = tester.getTopLeft(
        flying(tester, find.text('Page 2')),
      );
  ...
  testWidgets(
    'Top CupertinoNavigationBar.bottom fades and slides in to the right',
    (WidgetTester tester) async {
      await startTransitionBetween(
        tester,
        toTitle: 'Page 2',
  ...
  testWidgets('Searchable-to-searchable transition does not fade', (
    WidgetTester tester,
  ) async {
    await startTransitionBetween(
      tester,
    ...
    expect(
      flying(tester, find.byType(CupertinoSearchTextField)),
      findsNWidgets(2),
    );
    ...
    checkOpacity(
      tester,
      flying(tester, find.byType(CupertinoSearchTextField).last),
      1.0,
    );
  ...
  testWidgets('textScaleFactor is set to 1.0 on transition', (
    ...
    final TextScaler scaler = tester
        ...
        .textScaler;
    final List<double> fontSizes = List<double>.generate(
      100,
      (int index) => index / 3 + 1,
    );
  ...
  testWidgets('Back label is not clipped mid-transition', (
    WidgetTester tester,
  ) async {
