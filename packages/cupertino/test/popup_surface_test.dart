...
void main() {
  ...
  // displayed.
  testWidgets(
    'Setting debugIsVibrancePainted to false removes the color filter',
    (WidgetTester tester) async {
  ...
  testWidgets(
    ...
    (WidgetTester tester) async {
      ...
      await tester.pumpWidget(
        const _FilterTest(
          CupertinoPopupSurface(isSurfacePainted: false, child: SizedBox()),
        ),
      );
  ...
  testWidgets('Setting blurSigma to zero removes blur', (
    WidgetTester tester,
  ) async {
    disableVibranceForTest();
    await tester.pumpWidget(
  ...
  testWidgets('Setting a blurSigma to a negative number throws', (
    WidgetTester tester,
  ) async {
    try {
      disableVibranceForTest();
      ...
      fail(
        'CupertinoPopupSurface did not throw when provided a negative blur sigma.',
      );
  ...
  testWidgets('Saturation is applied before blur', (WidgetTester tester) async {
    await tester.pumpWidget(
      const _FilterTest(CupertinoPopupSurface(child: SizedBox())),
    );
