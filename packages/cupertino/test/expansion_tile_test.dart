...
void main() {
  ...
  testWidgets('Can be controlled by ExpansibleController', (
    WidgetTester tester,
  ) async {
  ...
  testWidgets('Controller can set the tile to be initially expanded', (
    WidgetTester tester,
  ) async {
    final ExpansibleController controller = ExpansibleController();
    await tester.pumpWidget(
  ...
  testWidgets('Default expansion animation and icon rotation', (
    WidgetTester tester,
  ) async {
    await tester.pumpWidget(
      const CupertinoApp(
  ...
  testWidgets('Expansion animation in scroll mode', (
    WidgetTester tester,
  ) async {
    await tester.pumpWidget(
      const CupertinoApp(
