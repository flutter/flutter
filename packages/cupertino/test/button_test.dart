...
void main() {
  ...
  testWidgets('Minimum size minimumSize parameter', (
    WidgetTester tester,
  ) async {
  ...
  */
  ...
  testWidgets('Button size changes depending on size property', (
    WidgetTester tester,
  ) async {
  ...
  testWidgets("Disabled button doesn't animate", (WidgetTester tester) async {
    await tester.pumpWidget(
      boilerplate(
        child: const CupertinoButton(onPressed: null, child: Text('Tap me')),
      ),
    );
    expect(SchedulerBinding.instance.transientCallbackCount, equals(0));
    await tester.tap(find.byType(CupertinoButton));
  ...
  testWidgets('Button respects themes', (WidgetTester tester) async {
    ...
    expect(
      decoration.color,
      isSameColorAs(CupertinoColors.activeBlue.withOpacity(0.12)),
    );
    ...
    expect(
      decoration.color,
      isSameColorAs(CupertinoColors.activeBlue.darkColor.withOpacity(0.26)),
    );
  ...
  testWidgets(
    "All CupertinoButton const maps keys' match the available style sizes",
    (WidgetTester tester) async {
  ...
  testWidgets('Button can be focused and has default colors', (
    WidgetTester tester,
  ) async {
  ...
  testWidgets('CupertinoButton.onFocusChange callback', (
    WidgetTester tester,
  ) async {
  ...
  testWidgets(
    'IconThemeData falls back to default value when the TextStyle has a null size',
    (WidgetTester tester) async {
      const IconThemeData defaultIconTheme = IconThemeData(
        size: kCupertinoButtonDefaultIconSize,
      );
  ...
  testWidgets('Button can be activated by keyboard shortcuts', (
    WidgetTester tester,
  ) async {
    tester.binding.focusManager.highlightStrategy =
        FocusHighlightStrategy.alwaysTraditional;
  ...
  testWidgets(
    'Press and move on button and animation works',
    (WidgetTester tester) async {
      await tester.pumpWidget(
        boilerplate(
  ...
  testWidgets(
    'Drag outside button within ListView does not leave the button pressed',
    (WidgetTester tester) async {
      await tester.pumpWidget(
        boilerplate(
          child: ListView(
  ...
  testWidgets('onPressed trigger takes into account MoveSlop.', (
    WidgetTester tester,
  ) async {
    bool value = false;
    await tester.pumpWidget(
    ...
    TestGesture gesture = await tester.startGesture(
      tester.getCenter(find.byType(CupertinoButton)),
    );
  ...
  testWidgets(
    'Mouse cursor resolves in enabled/disabled/pressed/focused states',
    (WidgetTester tester) async {
      final FocusNode focusNode = FocusNode(debugLabel: 'Button');
      tester.binding.focusManager.highlightStrategy =
          FocusHighlightStrategy.alwaysTraditional;
      ...
      addTearDown(gesture.removePointer);
      await tester.pumpWidget(
        buildButton(enabled: true, cursor: const _ButtonMouseCursor()),
      );
      await gesture.addPointer(
        location: tester.getCenter(find.byType(CupertinoButton)),
      );
      await tester.pump();
      ...
      await tester.pumpWidget(
        buildButton(enabled: false, cursor: const _ButtonMouseCursor()),
      );
      await gesture.moveTo(tester.getCenter(find.byType(CupertinoButton)));
      expect(
        RendererBinding.instance.mouseTracker.debugDeviceActiveCursor(1),
