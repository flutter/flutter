...
void main() {
  ...
  testWidgets(
    'Haptic vibration triggers on drag',
    (WidgetTester tester) async {
      bool value = false;
      final List<MethodCall> log = <MethodCall>[];
  ...
  testWidgets('Switch can set active/inactive thumb colors', (
    WidgetTester tester,
  ) async {
    bool value = false;
  ...
  PaintPattern offLabelPaintPattern({
    ...
    ..circle(
      ...
      y: 19.5,
      radius: 5.0,
      color: (highContrast ? const Color(0xffffffff) : const Color(0xffb3b3b3))
          .withAlpha(alpha),
      strokeWidth: 1.0,
  ...
  testWidgets(
    ...
    (WidgetTester tester) async {
      ...
      expect(
        switchRenderObject,
        offLabelPaintPattern(highContrast: true, alpha: 0),
      );
    },
  );
  ...
  testWidgets('Switch configures mouse cursor', (WidgetTester tester) async {
    ...
    await gesture.addPointer(
      location: tester.getCenter(find.byType(CupertinoSwitch)) + switchSize,
    );
    await tester.pump();
    expect(
      RendererBinding.instance.mouseTracker.debugDeviceActiveCursor(1),
  ...
  testWidgets('Track outline color resolves in active/enabled states', (
    ...
    final WidgetStateProperty<Color> trackOutlineColor =
        WidgetStateColor.resolveWith(getTrackOutlineColor);
  ...
  testWidgets('Track outline width resolves in active/enabled states', (
    ...
    final WidgetStateProperty<double> trackOutlineWidth =
        WidgetStateProperty.resolveWith(getTrackOutlineWidth);
    const WidgetStateProperty<Color> trackOutlineColor =
  ...
  group('with image', () {
    ...
    testWidgets(
      'Does not crash when imageProvider completes after switch is disposed',
      (WidgetTester tester) async {
    ...
    testWidgets(
      'Does not crash when previous imageProvider completes after switch is disposed',
      (WidgetTester tester) async {
    ...
    testWidgets('Switch uses inactive track color when set', (
      WidgetTester tester,
    ) async {
      ...
      expect(
        find.byType(CupertinoSwitch),
        paints..rrect(color: inactiveTrackColor),
      );
    });

    testWidgets('Switch uses active track color when set', (
      WidgetTester tester,
    ) async {
      ...
      expect(
        find.byType(CupertinoSwitch),
        paints..rrect(color: activeTrackColor),
      );
    });
  });
}
