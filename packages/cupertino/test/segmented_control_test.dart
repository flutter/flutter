...
void main() {
  ...
  testWidgets('Segmented controls respects themes', (
    WidgetTester tester,
  ) async {
    final Map<int, Widget> children = <int, Widget>{};
    children[0] = const Text('Child 1');
  ...
  testWidgets('Animation is correct when the selected segment changes', (
    ...
    expect(
      ...
      isSameColorAs(CupertinoColors.activeBlue),
    );
    expect(
      getBackgroundColor(tester, 1),
      isSameColorAs(const Color(0x33007aff)),
    );

    await tester.pump(const Duration(milliseconds: 40));
    expect(
      getBackgroundColor(tester, 0),
      isSameColorAs(const Color(0xff3d9aff)),
    );
    expect(
      getBackgroundColor(tester, 1),
      isSameColorAs(const Color(0x64007aff)),
    );

    await tester.pump(const Duration(milliseconds: 40));
    expect(
      getBackgroundColor(tester, 0),
      isSameColorAs(const Color(0xff7bbaff)),
    );
    expect(
      getBackgroundColor(tester, 1),
      isSameColorAs(const Color(0x95007aff)),
    );

    await tester.pump(const Duration(milliseconds: 40));
    expect(
      getBackgroundColor(tester, 0),
      isSameColorAs(const Color(0xffb9daff)),
    );
    expect(
      getBackgroundColor(tester, 1),
      isSameColorAs(const Color(0xc7007aff)),
    );

    await tester.pump(const Duration(milliseconds: 40));
    expect(
      getBackgroundColor(tester, 0),
      isSameColorAs(const Color(0xfff7faff)),
    );
    expect(
      getBackgroundColor(tester, 1),
      isSameColorAs(const Color(0xf8007aff)),
    );
  ...
  testWidgets(
    ...
    (WidgetTester tester) async {
      ...
      expect(
        getBackgroundColor(tester, 1),
        isSameColorAs(const Color(0xffc1deff)),
      );
      expect(
        getBackgroundColor(tester, 2),
        isSameColorAs(const Color(0x33007aff)),
      );
      ...
      expect(
        getBackgroundColor(tester, 2),
        isSameColorAs(const Color(0xe0007aff)),
      );
  ...
  testWidgets(
    ...
    (WidgetTester tester) async {
      ...
      expect(
        getBackgroundColor(tester, 0),
        isSameColorAs(const Color(0xcd007aff)),
      );
      expect(
        getBackgroundColor(tester, 1),
        isSameColorAs(const Color(0xffc1deff)),
  ...
  testWidgets("Quick double tap doesn't break the internal state", (
    ...
    final TestGesture secondTap = await tester.startGesture(
      tester.getCenter(find.text('B')),
    );
    await tester.pump();
  ...
  testWidgets('Tap on disabled segment should not change its state', (
    WidgetTester tester,
  ) async {
    final Map<int, Widget> children = <int, Widget>{
  ...
  testWidgets(
    'Background color of disabled segment should be different than enabled segment',
    (WidgetTester tester) async {
      final Map<int, Widget> children = <int, Widget>{
        0: const Text('Child 1'),
        1: const Text('Child 2'),
  ...
  testWidgets(
    'Custom disabled color of disabled segment is showing as desired',
    (WidgetTester tester) async {
      final Map<int, Widget> children = <int, Widget>{
        0: const Text('Child 1'),
        1: const Text('Child 2'),
