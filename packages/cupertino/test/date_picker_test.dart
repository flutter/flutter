...
void main() {
  group('Countdown timer picker', () {
    ...
    testWidgets('background color default value', (WidgetTester tester) async {
      ...
      final Iterable<CupertinoPicker> pickers = tester.allWidgets
          .whereType<CupertinoPicker>();
      expect(
  ...
  testWidgets('showDayOfWeek is only supported in date mode', (
    WidgetTester tester,
  ) async {
    expect(
      () => CupertinoDatePicker(
  ...
  testWidgets(
    'CupertinoDatePicker selectionOverlayBuilder with monthYear mode',
    (WidgetTester tester) async {
  ...
  testWidgets(
    'CupertinoDatePicker selectionOverlayBuilder with dateAndTime mode',
    (WidgetTester tester) async {
      final Widget selectionOverlay = Container(color: const Color(0x12345678));
  ...
  testWidgets(
    'CupertinoTimerPicker selectionOverlayBuilder is explicitly passed null',
    (WidgetTester tester) async {
      await tester.pumpWidget(
        CupertinoApp(
          home: Center(
  ...
  testWidgets(
    'CupertinoDatePicker selectionOverlayBuilder is explicitly passed null',
    (WidgetTester tester) async {
      await tester.pumpWidget(
        CupertinoApp(
          home: Center(
  ...
  testWidgets(
    'CupertinoDatePicker accommodates widest text using table codepoints',
    (WidgetTester tester) async {
      // |---------|
  ...
  test(
    'showTimeSeparator is only supported in time or dateAndTime mode',
    () async {
      expect(
        () => CupertinoDatePicker(
          mode: CupertinoDatePickerMode.time,
  ...
  testWidgets(
    'Time separator widget should be rendered when flag is set to true',
    (WidgetTester tester) async {
      await tester.pumpWidget(
        CupertinoApp(
          home: Center(
  ...
  testWidgets(
    'Time separator widget should not be rendered when flag is set to false',
    (WidgetTester tester) async {
      await tester.pumpWidget(
        CupertinoApp(
          home: Center(
  ...
  testWidgets('CupertinoDatePicker date value baseline alignment', (
    WidgetTester tester,
  ) async {
    await tester.pumpWidget(
      CupertinoApp(
