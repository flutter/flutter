...
void main() {
    ...
    return find.descendant(
      ...
      matching: find.byWidgetPredicate(
        (Widget widget) =>
            ...
            widget.color != CupertinoColors.activeOrange,
      ),
    );
  }
  ...
  group('CupertinoContextMenu before and during opening', () {
    ...
    testWidgets('_DecoyChild preserves the child color', (
      WidgetTester tester,
    ) async {
      final Widget child = getChild();
      await tester.pumpWidget(
      ...
      final BoxDecoration? boxDecoration =
          (tester.firstWidget(decoyChildDescendant) as Container).decoration
              as BoxDecoration?;
    ...
    testWidgets('CupertinoContextMenu with a builder can change the animation', (
      ...
      final BoxDecoration? decoyDecoration =
          decoyContainer.decoration as BoxDecoration?;
      ...
      final Container decoyLaterContainer =
          tester.firstElement(findBuilderDecoyChild()).widget as Container;
      final BoxDecoration? decoyLaterDecoration =
          decoyLaterContainer.decoration as BoxDecoration?;
      expect(
        decoyLaterDecoration?.borderRadius,
        isNot(equals(BorderRadius.circular(0))),
      );
  ...
  group('CupertinoContextMenu when open', () {
    testWidgets('Last action does not have border', (
      WidgetTester tester,
    ) async {
      final Widget child = getChild();
      await tester.pumpWidget(
    ...
    testWidgets('Can close CupertinoContextMenu by background tap', (
      WidgetTester tester,
    ) async {
      final Widget child = getChild();
      await tester.pumpWidget(getContextMenu(child: child));
    ...
    testWidgets('Can close CupertinoContextMenu by dragging down', (
      WidgetTester tester,
    ) async {
      final Widget child = getChild();
      await tester.pumpWidget(getContextMenu(child: child));
      ...
      await tester.pump();
      expect(
        tester.getCenter(findStaticChild(child)).dy,
        greaterThan(staticChildCenter.dy),
      );
      await tester.pumpAndSettle();
      expect(
        tester.getCenter(findStaticChild(child)),
        equals(staticChildCenter),
      );
      expect(findStatic(), findsOneWidget);
    ...
    testWidgets('Preview widget should have the correct border radius', (
      ...
      final ClipRRect previewWidget =
          tester.firstWidget(findStaticDefaultPreview()) as ClipRRect;
      expect(previewWidget.borderRadius, equals(BorderRadius.circular(12.0)));
    });

    testWidgets('CupertinoContextMenu width is correct', (
      WidgetTester tester,
    ) async {
      final Widget child = getChild();
      await tester.pumpWidget(getContextMenu(child: child));
      ...
      final CupertinoContextMenu widget = tester.widget(
    ...
    testWidgets('CupertinoContextMenu minimizes scaling offscreen', (
      WidgetTester tester,
    ) async {
      final Widget child = getChild();
      ...
      await tester.pumpWidget(
        getContextMenu(alignment: Alignment.topLeft, child: child),
      );
      await tester.pump();
      ...
      await tester.pumpWidget(
        getContextMenu(alignment: Alignment.bottomRight, child: child),
      );
      await tester.pump();
    ...
    testWidgets(
      "ContextMenu route animation doesn't throw exception on dismiss",
      (WidgetTester tester) async {
  ...
  group("Open layout differs depending on child's position on screen", () {
    testWidgets('Portrait', (WidgetTester tester) async {
      ...
      final Widget child = getChild();
      await tester.pumpWidget(
        getContextMenu(screenSize: portraitScreenSize, child: child),
      );
      ...
      final Offset center = tester.getTopLeft(
      ...
      expect(find.byType(CupertinoContextMenuAction), findsOneWidget);
      final Offset left = tester.getTopLeft(
        find.byType(CupertinoContextMenuAction),
      );
      ...
      expect(find.byType(CupertinoContextMenuAction), findsOneWidget);
      final Offset right = tester.getTopLeft(
        find.byType(CupertinoContextMenuAction),
      );
    ...
    testWidgets('Landscape', (WidgetTester tester) async {
      ...
      // Pump a CupertinoContextMenu on the left of the screen and open it.
      await tester.pumpWidget(
        getContextMenu(alignment: Alignment.centerLeft, child: child),
      );
      expect(find.byType(CupertinoContextMenuAction), findsNothing);
      childRect = tester.getRect(find.byWidget(child));
      gesture = await tester.startGesture(childRect.center);
      ...
      // Pump a CupertinoContextMenu on the right of the screen and open it.
      await tester.pumpWidget(
        getContextMenu(alignment: Alignment.centerRight, child: child),
      );
      expect(find.byType(CupertinoContextMenuAction), findsNothing);
      childRect = tester.getRect(find.byWidget(child));
      gesture = await tester.startGesture(childRect.center);
  ...
  testWidgets('CupertinoContextMenu scrolls correctly', (
    WidgetTester tester,
  ) async {
      ...
      CupertinoApp(
        home: CupertinoPageScaffold(
          child: MediaQuery(
            ...
            child: CupertinoContextMenu(
              actions: List<CupertinoContextMenuAction>.generate(numMenuItems, (
                int index,
              ) {
