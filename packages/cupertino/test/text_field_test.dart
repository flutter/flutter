...
import 'dart:ui'
    as ui
    show BoxHeightStyle, BoxWidthStyle, Color, SemanticsInputType;
...
void main() {
  ...
  testWidgets('multi-lined text fields are intrinsically taller', (
    WidgetTester tester,
  ) async {
    await tester.pumpWidget(
      CupertinoApp(
  ...
  testWidgets('prefix widget respects visibility mode', (
    WidgetTester tester,
  ) async {
    await tester.pumpWidget(
      const CupertinoApp(
  ...
  testWidgets('padding is in between prefix and suffix no-strut', (
    WidgetTester tester,
  ) async {
    await tester.pumpWidget(
      const CupertinoApp(
  ...
  testWidgets('padding is in between prefix and suffix', (
    WidgetTester tester,
  ) async {
    await tester.pumpWidget(
      const CupertinoApp(
  ...
  testWidgets('clear button yields precedence to suffix', (
    WidgetTester tester,
  ) async {
    final TextEditingController controller = TextEditingController();
    addTearDown(controller.dispose);
  ...
  testWidgets('font style controls intrinsic height no-strut', (
    ...
    await tester.pumpWidget(
      const CupertinoApp(
        home: Center(
          child: CupertinoTextField(strutStyle: StrutStyle.disabled),
        ),
      ),
    );
  ...
  testWidgets('font style controls intrinsic height', (
    WidgetTester tester,
  ) async {
    await tester.pumpWidget(
      const CupertinoApp(home: Center(child: CupertinoTextField())),
  ...
  testWidgets('text fields with no max lines can grow no-strut', (
    WidgetTester tester,
  ) async {
    await tester.pumpWidget(
      const CupertinoApp(
  ...
  testWidgets('text fields with no max lines can grow', (
    WidgetTester tester,
  ) async {
    await tester.pumpWidget(
      const CupertinoApp(
  ...
  testWidgets(
    ...
    (WidgetTester tester) async {
      ...
      final CupertinoTextField cupertinoTextField = tester
          .widget<CupertinoTextField>(find.byType(CupertinoTextField));

      expect(
        find.widgetWithIcon(CupertinoTextField, CupertinoIcons.clear),
        findsOneWidget,
      );
      expect(
        find.widgetWithIcon(CupertinoTextField, CupertinoIcons.add),
        findsOneWidget,
      );
      ...
      final double prefixDy = tester
          .getTopLeft(find.byIcon(CupertinoIcons.add))
          .dy;
      final double suffixDy = tester
          .getTopLeft(find.byIcon(CupertinoIcons.clear))
          .dy;
  ...
  testWidgets('still gets disabled background color when decoration is null', (
    ...
    await tester.pumpWidget(
      const CupertinoApp(
        home: Center(
          child: CupertinoTextField(decoration: null, enabled: false),
        ),
      ),
    );
  ...
  testWidgets('textDirection is passed to EditableText', (
    ...
    await tester.pumpWidget(
      const CupertinoApp(
        home: Center(
          child: CupertinoTextField(textDirection: TextDirection.ltr),
        ),
      ),
    );
    ...
    await tester.pumpWidget(
      const CupertinoApp(
        home: Center(
          child: CupertinoTextField(textDirection: TextDirection.rtl),
        ),
      ),
    );
  ...
  testWidgets(
    ...
    (WidgetTester tester) async {
      ...
      final Rect rectWithPlaceholder = tester.getRect(
        find.byType(CupertinoTextField),
      );
  ...
  testWidgets('Placeholder is baseline aligned with text', (
          ...
          child: StatefulBuilder(
            builder: (BuildContext context, StateSetter setter) {
              ...
              return CupertinoTextField(
                ...
                placeholderStyle: TextStyle(
                  fontSize: currentPlaceholderFontSize,
                ),
    ...
    Future<void> performBaselineAlignmentCheck(
      ...
      final double placeholderHeightAboveBaseline =
          placeholderSize * ahemBaselineRatio;
      final double textHeightAboveBaseline = textSize * ahemBaselineRatio;
      final double placeholderTopDy = tester
          .getTopLeft(find.text(placeholderTextContent))
          .dy;
      final double textTopDy = tester
          .getTopLeft(find.text(actualTextContent))
          .dy;
      ...
      expect(
        ...
        closeTo(
          placeholderTopDy +
              placeholderHeightAboveBaseline -
  ...
  testWidgets(
    ...
    (WidgetTester tester) async {
      ...
      // Wait for autofocus.
      await tester.pumpAndSettle();
      final Offset textFieldCenter = tester.getCenter(
        find.byType(CupertinoTextField),
      );
