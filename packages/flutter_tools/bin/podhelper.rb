...
def flutter_additional_ios_build_settings(target)
  ...
  target.build_configurations.each do |build_configuration|
    ...
    build_configuration.build_settings['ONLY_ACTIVE_ARCH'] = 'YES' if build_configuration.type == :debug
    ...
    configuration_engine_dir = "/Users/vashworth/Development/flutter/engine/src/out/ios_debug_sim_unopt_arm64/Flutter.xcframework"
