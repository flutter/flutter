...
gradlePlugin {
    plugins {
        ...
        // The "flutterSettingsPlugin" name isn't used anywhere
        create("flutterSettingsPlugin") {
            id = "dev.flutter.flutter-app-plugin-loader-gradle-plugin"
            implementationClass = "FlutterSettingsPlugin"
        }
    }
}
