...
require(flutterRoot.isDirectory) { "Flutter root directory not found." }

val engineRealmPath = Paths.get(flutterRoot.absolutePath, "bin", "internal", "engine.realm").toFile()
var engineRealm = engineRealmPath.readText().trim()
if (engineRealm.isNotEmpty()) {
    engineRealm += "/"
}

val engineVersionPath = Paths.get(flutterRoot.absolutePath, "bin", "internal", "engine.version").toFile()
val engineVersion = engineVersionPath.readText().trim()
