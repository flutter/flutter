...
class BaseFlutterTaskHelperTest {
    ...
    private val targetPlatformValuesList = listOf("android", "linux")
    private val targetPlatformValuesJoinedList = "android linux"
    ...
    fun `createSpecActionFromTask creates the correct build configurations when properties are non-null`() {
        ...
        val joinTestList = targetPlatformValuesList.joinToString(" ")
        ...
        verify { mockExecSpec.args("-dAndroidArchs=$targetPlatformValuesJoinedList") }
