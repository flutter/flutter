...
/**
 * Constants used by the Flutter Gradle plugin.
 *
 * Kept intentionally simple and defensive so the plugin remains compatible
 * across a range of Gradle/AGP/Kotlin versions.
 */
object FlutterPluginConstants {
    ...
    const val INTERMEDIATES_DIR: String = "intermediates"
    const val FLUTTER_STORAGE_BASE_URL: String = "FLUTTER_STORAGE_BASE_URL"
    const val DEFAULT_MAVEN_HOST: String = "https://storage.googleapis.com"

    /** Maps platforms to ABI architectures. */
    @JvmStatic
    val PLATFORM_ARCH_MAP: Map<String, String> = mapOf(
     ...
     */
    @JvmStatic
    val ABI_VERSION: Map<String, Int> = mapOf(
        ARCH_ARM32 to 1,
        ARCH_ARM64 to 2,
    ...
    @JvmStatic
    val DEFAULT_PLATFORMS: List<String> = listOf(
        PLATFORM_ARM32,
        PLATFORM_ARM64,
        PLATFORM_X86_64
    )
     ...
     */
    @JvmStatic
    val PLATFORM_ABI_LIST: List<String> =
