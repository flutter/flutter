...
class FlutterPlugin implements Plugin<Project> {
    ...
    // TODO(/issues/54566, /issues/48918): Can remove once the issues are resolved.
    ...
    // TODO(/issues/54566): Can remove this function and its call sites once resolved.
    /**
    ...
    private void configurePluginProject(Map<String, Object> pluginObject) {
        ...
        pluginProject.afterEvaluate {
            ...
            if (pluginProject.android.compileSdkVersion > project.android.compileSdkVersion) {
                project.logger.quiet("Warning: The plugin ${pluginObject.name} requires Android SDK version ${getCompileSdkFromProject(pluginProject)}.")
    ...
    // TODO(/issues/54566, /issues/48918): Remove in favor of [getPluginList] only, see also
