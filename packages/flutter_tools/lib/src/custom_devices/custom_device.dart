...
class CustomDevicePortForwarder extends DevicePortForwarder {
  ...
  Future<ForwardedPort?> tryForward(int devicePort, int hostPort) async {
    final List<String> interpolated = interpolateCommand(_forwardPortCommand,
        <String, String>{'devicePort': '$devicePort', 'hostPort': '$hostPort'},
...
class CustomDevice extends Device {
  ...
  CustomDeviceAppSession _getOrCreateAppSession(
