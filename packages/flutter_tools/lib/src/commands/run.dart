  ...
  Future<DebuggingOptions> createDebuggingOptions(bool webMode) async {
    ...
    if (buildInfo.mode.isRelease) {
      return DebuggingOptions.disabled(
        ...
        tlsCertPath: featureFlags.isWebEnabled ? stringArgDeprecated('web-tls-cert-path') : null,
        tlsCertKeyPath: featureFlags.isWebEnabled ? stringArgDeprecated('web-tls-cert-key-path') : null,
