...
const Map<String, String> kManuallyPinnedDependencies = <String, String>{
  ...
  'archive':
      '3.1.11', // Breaking changes in 3.2.0, see https://github.com/flutter/flutter/issues/98536
  'flutter_gallery_assets': '1.0.2', // Tests depend on the exact version.
  'flutter_template_images':
      '4.0.0', // Must always exactly match flutter_tools template.
...
class UpdatePackagesCommand extends FlutterCommand {
  ...
  Future<PackageConfig> _generateFakePackage({
    ...
    try {
      ...
      final String packageConfigString = await tempDir
  ...
  bool _upgradePubspecs({
    ...
    for (final PubspecYaml pubspec in pubspecs) {
      ...
      if (tree._dependencyTree.containsKey(package)) {
        globals.printError('Dependency tree already contains $package!'); // TODO what?
      }
...
class PubspecDependency extends PubspecLine {
  ...
  void describeForFakePubspec(StringBuffer dependencies, StringBuffer overrides,
      {bool useAnyVersion = true}) {
    final String versionToUse =
        useAnyVersion || version.isEmpty ? 'any' : version;
    switch (kind) {
