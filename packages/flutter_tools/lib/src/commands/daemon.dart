...
abstract class Domain {
  ...
  void handleCommand(String command, dynamic id, Map<String, dynamic> args, Stream<List<int>> binary) {
    Future<dynamic>.sync(() {
      ...
      throw DaemonError('command not understood: $name.$command');
  ...
  String _getStringArg(Map<String, dynamic> args, String name, { bool required = false }) {
    if (required && !args.containsKey(name)) {
      throw DaemonError('$name is required');
    }
    final dynamic val = args[name];
    if (val != null && val is! String) {
      throw DaemonError('$name is not a String');
    }
  ...
  bool _getBoolArg(Map<String, dynamic> args, String name, { bool required = false }) {
    ...
    if (val != null && val is! bool) {
      throw DaemonError('$name is not a bool');
    }
    return val as bool;
  }
  ...
  int _getIntArg(Map<String, dynamic> args, String name, { bool required = false }) {
    ...
    if (val != null && val is! int) {
      throw DaemonError('$name is not an int');
    }
    return val as int;
  }
...
class AppDomain extends Domain {
  ...
  Future<OperationResult> restart(Map<String, dynamic> args) async {
    ...
    if (app == null) {
      throw DaemonError("app '$appId' not found");
    }
  ...
  Future<Map<String, dynamic>> callServiceExtension(Map<String, dynamic> args) async {
    ...
    if (result == null) {
      throw DaemonError('method not available: $methodName');
    }
...
class DeviceDomain extends Domain {
  ...
  Future<Map<String, dynamic>> forward(Map<String, dynamic> args) async {
    ...
    if (device == null) {
      throw DaemonError("device '$deviceId' not found");
    }
...
class EmulatorDomain extends Domain {
  ...
  Future<void> launch(Map<String, dynamic> args) async {
    ...
    if (matches.isEmpty) {
      throw DaemonError("emulator '$emulatorId' not found");
    } else if (matches.length > 1) {
      throw DaemonError("multiple emulators match '$emulatorId'");
    } else {
