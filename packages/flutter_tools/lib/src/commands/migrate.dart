...
Future<bool> checkGitRepoExists(String projectDirectory, Logger logger) async {
...
Future<bool> checkUncommittedChanges(String projectDirectory, Logger logger) async {
