...
class MakeHostAppEditableCommand extends FlutterCommand {
  ...
  @override
  final String description = 'Converts generated host apps to editable, non-generated host apps.\n\n'
  ...
  Future<Null> runCommand() async {
    ...
    final bool isAndroidRequested = argResults.arguments.contains('android');
    final bool isIOSRequested = argResults.arguments.contains('ios');
    ...
    if (isAndroidRequested) {
      ...
      // No flags provided. Make Android and iOS host apps editable.
      await _project.android.makeHostAppEditable();
      await _project.ios.makeHostAppEditable();
    }
  }
