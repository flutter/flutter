...
class BuildWebCommand extends BuildSubCommand {
  BuildWebCommand({
    ...
    argParser.addOption(
      'static-assets-url',
      help: 'Used when serving the static assets from a different domain the application is hosted on. '
  ...
  $kWasmMoreInfo''');
    ...
    if (staticAssetsUrl != null && !(staticAssetsUrl.startsWith('http') && staticAssetsUrl.endsWith('/'))) {
      throwToolExit(
