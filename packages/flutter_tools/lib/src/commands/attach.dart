...
class AttachCommand extends FlutterCommand {
  ...
  @override
  final String description = '''There are three ways for the attach command to 
  discover a running app:
  ...
  before attaching.
  3. If the app or module is already running and the specific observatory port
  is known, it can be explicitly provided to attach via the command-line, e.g.
  `\$ flutter attach --debug-port 12345`''';
