...
class GenerateLocalizationsCommand extends FlutterCommand {
  ...
  Future<FlutterCommandResult> runCommand() async {
    ...
    final String inputPathString =
        stringArg('arb-dir')!; // Has default value, cannot be null.
    final String? outputPathString = stringArg('output-dir');
    final String outputFileString = stringArg(
        'output-localization-file')!; // Has default value, cannot be null.
    final String templateArbFileName =
        stringArg('template-arb-file')!; // Has default value, cannot be null.
    final String? untranslatedMessagesFile =
        stringArg('untranslated-messages-file');
    final String classNameString =
        stringArg('output-class')!; // Has default value, cannot be null.
    ...
    final String? inputsAndOutputsListPath =
        stringArg('gen-inputs-and-outputs-list');
    ...
    final bool areResourceAttributesRequired =
        boolArg('required-resource-attributes');
