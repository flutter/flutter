...
class CreateCommand extends FlutterCommand {
  ...
  final String description = 'Configure the IDE to use in the Flutter repo.\n\n'
    ...
    'recreating any files that are missing, and resetting the module list and other '
  ...
  Future<Null> runCommand() async {
    if (argResults.rest.toLower() != 'intellij')
    ...
    final Directory projectDir = Cache.flutterRoot;
