...
class DoctorCommand extends FlutterCommand {
  ...
  Future<FlutterCommandResult> runCommand() async {
    if (args.wasParsed('check-for-remote-artifacts')) {
      final String engineRevision = args.readOption('check-for-remote-artifacts');
    ...
    final bool success = await doctor.diagnose(androidLicenses: args.readFlag('android-licenses'), verbose: verbose);
