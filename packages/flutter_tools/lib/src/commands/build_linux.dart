...
class BuildLinuxCommand extends BuildSubCommand {
  BuildLinuxCommand({
    ...
    final String defaultTargetPlatform =
        (_operatingSystemUtils.hostPlatform == HostPlatform.linux_arm64) ? 'linux-arm64' : 'linux-x64';
    argParser.addOption(
      'target-platform',
  ...
  Future<FlutterCommandResult> runCommand() async {
    ...
    final bool needCrossBuild =
        getNameForHostPlatformArch(_operatingSystemUtils.hostPlatform) != getNameForTargetPlatformArch(targetPlatform);
    ...
    if (_operatingSystemUtils.hostPlatform != HostPlatform.linux_x64 && targetPlatform != TargetPlatform.linux_arm64) {
