...
class AssembleCommand extends FlutterCommand {
  ...
  Future<FlutterCommandResult> runCommand() async {
    ...
    try {
      ...
      throwToolExit('Error parsing assemble command: your generated configuration may be out of date. '
    ...
    final BuildResult result = await _buildSystem.build(
      ...
      buildSystemConfig: BuildSystemConfig(
        resourcePoolSize:
            argumentResults.wasParsed('resource-pool-size') ? int.tryParse(stringArg('resource-pool-size')!) : null,
      ),
    );
    if (!result.success) {
