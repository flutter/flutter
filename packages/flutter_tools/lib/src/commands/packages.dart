...
class PackagesCommand extends FlutterCommand {
  PackagesCommand() {
    ...
    addSubcommand(
        PackagesInteractiveGetCommand('upgrade', "Upgrade the current package's dependencies to latest versions."));
    ...
    addSubcommand(
        PackagesForwardCommand('publish', 'Publish the current package to pub.dartlang.org', requiresPubspec: true));
    addSubcommand(
    ...
    addSubcommand(PackagesForwardCommand(
        'deps', 'Print package dependencies')); // path to package can be specified with --directory argument
    ...
    addSubcommand(PackagesForwardCommand('outdated', 'Analyze dependencies to find which ones can be upgraded',
...
class PackagesForwardCommand extends FlutterCommand {
  ...
  @override
  Future<FlutterCommandResult> runCommand() async {
    final List<String> subArgs = argResults!.rest.toList()..removeWhere((String arg) => arg == '--');
