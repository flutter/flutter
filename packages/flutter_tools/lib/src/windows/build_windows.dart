...
Future<void> buildWindows(final WindowsProject windowsProject, final BuildInfo buildInfo, {
  final String? target,
  final VisualStudio? visualStudioOverride,
  ...
  final bool badPath = _kBadCharacters.runes
      .any((final int i) => projectPath.contains(String.fromCharCode(i)));
  if (badPath) {
    throwToolExit(
...
Future<void> _runCmakeGeneration({
  required final String cmakePath,
  required final String generator,
  required final Directory buildDir,
...
void _writeGeneratedFlutterConfig(
  final WindowsProject windowsProject,
...
void _fixBrokenCmakeGeneration(final Directory buildDirectory) {
