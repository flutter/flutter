  ...
  try {
    ...
    result = await globals.processUtils.stream(
      <String>[
        ...
        if (buildInfo.bundleSkSLPath != null) '-dBundleSkSLPath=${buildInfo.bundleSkSLPath}',
        if (buildInfo.codeSizeDirectory != null) '-dCodeSizeDirectory=${buildInfo.codeSizeDirectory}',
        if (buildInfo.splitDebugInfoPath != null) '-dSplitDebugInfo=${buildInfo.splitDebugInfoPath}',
...
void _fixBrokenCmakeGeneration(Directory buildDirectory) {
  ...
  if (assembleProject.existsSync()) {
    ...
    final RegExp commandRegex =
        RegExp(r'<Command Condition=.*\(Configuration\)\|\$\(Platform\).==.(Debug|Profile|Release)\|');
