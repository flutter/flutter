...
abstract class XcodeBasedProject extends FlutterProjectPlatform  {
  ...
  bool get usesSwiftPackageManager {
    ...
    // The Swift Package Manager migration feature is required if the project
    // hasn't been migrated to add Swift Package Manager integration yet.
    if (!featureFlags.isSwiftPackageManagerMigrationEnabled && !flutterPluginSwiftPackageInProjectSettings) {
      return false;
    }
