...
// /// The JSON-schema for the pubspec.yaml and flutter manifest.
// const Map<String, Object> kPubspecJsonSchema = <String, Object>{
...
//       'properties': <String, Object>{
//         'uses-material-design': <String, String>{'type': 'boolean'},
...
//                   'additionalProperties': false,
//                   'properties': <String, Object>{
//                     'asset': <String, Object>{'type': 'string'},
//                     'weight': <String, Object>{
//                       'enum': <int>[100, 200, 300, 400, 500, 600, 700, 800, 900]
//                     },
//                     'style': <String, Object>{
...
//           'additionalProperties': false,
//           'properties': <String, Object>{
//             'androidX': <String, String>{'type': 'boolean'},
//             'androidPackage': <String, String>{'type': 'string'},
//             'iosBundleIdentifier': <String, String>{'type': 'string'}
//           }
//         },
...
//                   'additionalProperties': false,
//                   'properties': <String, Object>{
//                     'package': <String, String>{'type': 'string'},
//                     'pluginClass': <String, String>{'type': 'string'}
//                   }
//                 },
//                 'ios': <String, Object>{
//                   'type': 'object',
...
//                   'properties': <String, Object>{
//                     'pluginClass': <String, String>{'type': 'string'},
//                     'dartPluginClass': <String, String>{'type': 'string'}
//                   }
//                 },
//                 'macos': <String, Object>{
//                   'type': 'object',
...
//             },
//             'androidPackage': <String, String>{'type': 'string'},
//             'iosPrefix': <String, String>{'type': 'string'},
//             'macosPrefix': <String, String>{'type': 'string'},
//             'pluginClass': <String, String>{'type': 'string'}
//           }
//         }
//       }
