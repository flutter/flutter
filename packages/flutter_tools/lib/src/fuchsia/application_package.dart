...
abstract class FuchsiaApp extends ApplicationPackage {
  FuchsiaApp({required final String projectBundleId}) : super(id: projectBundleId);

  /// Creates a new [FuchsiaApp] from a fuchsia sub project.
  static FuchsiaApp? fromFuchsiaProject(final FuchsiaProject project) {
  ...
  static FuchsiaApp? fromPrebuiltApp(final FileSystemEntity applicationBinary) {
  ...
  File farArchive(final BuildMode buildMode);
}
...
class PrebuiltFuchsiaApp extends FuchsiaApp implements PrebuiltApplicationPackage {
  ...
  @override
  File farArchive(final BuildMode buildMode) => globals.fs.file(applicationPackage);
