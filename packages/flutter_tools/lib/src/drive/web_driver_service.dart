...
class WebDriverService extends DriverService {
  ...
  Future<void> start(
    ...
    if (_runResult != null) {
      throw ToolExit('Application exited before the test started. Check web driver logs '
  ...
  Future<void> stop({File writeSkslOnExit, String userIdentifier}) async {
    ...
    if (appDidFinishPrematurely) {
      throw ToolExit('Application exited before the test finished. Check web driver logs '
          'for possible application-side errors.');
    }
  }
  ...
  Map<String, String> _additionalDriverEnvironment(
    ...
    return <String, String>{
      ...
      'ANDROID_CHROME_ON_EMULATOR':
          (_browserNameToEnum(browserName) == Browser.androidChrome && androidEmulator).toString(),
    };
  }
...
Map<String, dynamic> getDesiredCapabilities(Browser browser, bool headless, [String chromeBinary]) {
  switch (browser) {
    ...
    case Browser.iosSafari:
      return <String, dynamic>{'platformName': 'ios', 'browserName': 'safari', 'safari:useSimulator': true};
