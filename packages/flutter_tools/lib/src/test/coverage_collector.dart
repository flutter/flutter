  ...
  Future<bool> collectCoverageData(String coveragePath,
    ...
    if (mergeCoverageData) {
      ...
      if (os.which('lcov') == null) {
        ...
        else if (platform.isMacOS) installMessage = 'Consider running "brew install lcov".';
...
Future<Map<String, dynamic>> _getAllCoverage(VMService service, bool Function(String) libraryPredicate) async {
  ...
  for (Isolate isolateRef in service.vm.isolates) {
    ...
    for (Map<String, dynamic> script in scriptList['scripts']) {
      ...
      futures.add(isolateRef.invokeRpcRaw('getSourceReport', params: <String, dynamic>{
        'forceCompile': true,
        'scriptId': scriptId,
      ...
      futures.add(isolateRef.invokeRpcRaw('getObject', params: <String, dynamic>{
        'isolateId': isolateRef.id,
        'objectId': scriptId,
