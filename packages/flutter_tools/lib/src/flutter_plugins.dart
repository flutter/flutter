...
/// re-run.
///
/// contentsChanged is true if [newJson] has changes that should be written to
/// disk.
({bool pluginsChanged, bool contentsChanged}) _detectFlutterPluginsListChanges(
  ...
  try {
    ...
    // Create a copy the JSON so that the input isn't mutated when we drop
    // properties that should be ignored.
    final Map<String, Object?> newJsonCopy = <String, Object?>{...newJson};

    // The 'info' property is a common that doesn't affect functionality.
