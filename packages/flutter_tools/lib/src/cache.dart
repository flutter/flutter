...
class Cache {
  ...
  ///   3. Platform script is package URI scheme, returning the 4th parent directory
  ///      of the package config file location from `packages/flutter_tools/.dart_tool/package_config.json`.
