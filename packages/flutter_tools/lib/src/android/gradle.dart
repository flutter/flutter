...
Future<Null> buildGradleProject(BuildMode buildMode, String target, bool isKernelMode) async {
  ...
  switch (flutterPluginVersion) {
    ...
    case FlutterPluginVersion.v2:
      return _buildGradleProjectV2(gradle, buildModeName, target, isKernelMode);
  }
}
...
Future<Null> _buildGradleProjectV2(String gradle, String buildModeName, String target, bool isKernelMode) async {
  ...
  if (isKernelMode)
    command.add('-Pis-kernel-mode=true');
