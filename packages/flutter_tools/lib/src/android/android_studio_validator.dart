...
class AndroidStudioValidator extends DoctorValidator {
  ...
  static List<DoctorValidator> allValidators(
      Config config, Platform platform, FileSystem fileSystem, UserMessages userMessages) {
    ...
    return <DoctorValidator>[
      if (studios.isEmpty)
        ...
        ...studios
            .map<DoctorValidator>((AndroidStudio studio) => AndroidStudioValidator(studio, fileSystem: fileSystem)),
    ];
  }
