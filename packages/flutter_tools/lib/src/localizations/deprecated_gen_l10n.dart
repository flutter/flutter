...
import 'deprecated_gen_l10n_templates.dart';
import 'deprecated_gen_l10n_types.dart';
...
String _generateSelectMethod(Message message, String translationForMessage) {
  ...
  final RegExpMatch? selectMatch = DeprecatedLocalizationsGenerator._selectRE.firstMatch(easyMessage);
  String? choice;
...
class DeprecatedLocalizationsGenerator {
  ...
  /// by [DeprecatedLocalizationsGenerator].
  ///
  /// Throws a [FileSystemException] when a file operation necessary for setting
  /// up the [DeprecatedLocalizationsGenerator] cannot be completed.
  factory DeprecatedLocalizationsGenerator({
    ...
    return DeprecatedLocalizationsGenerator._(
      fileSystem,
  ...
  DeprecatedLocalizationsGenerator._(this._fs, {
