...
abstract class ResidentRunner {
  ...
  ///
  /// Returns the exit code that we should use for the flutter tool process;
  /// 0 for success, other (positive) values for failure.
  Future<int> run({
  ...
  /// will be registered.
  //
  // Failures should be indicated by completing the future with a string, which
  // will be used by the caller (attach()) to display an error message.
