...
class VerboseLogger extends DelegatingLogger {
  VerboseLogger(super.parent, {this._stopwatchFactory = const StopwatchFactory()})
    : _stopwatch = _stopwatchFactory.createStopwatch() {
    _stopwatch.start();
  }
...
class AnonymousSpinnerStatus extends Status {
  AnonymousSpinnerStatus({
    ...
    this._warningColor,
    super.timeout,
  }) : _animation = _selectAnimation(_terminal);
