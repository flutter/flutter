...
class JITSnapshotter {
  ...
  Future<int> build({
    ...
    final String engineVmSnapshotData = artifacts.getHostArtifactPath(Artifact.vmSnapshotData, targetPlatform, buildMode);
    final String engineIsolateSnapshotData = artifacts.getHostArtifactPath(Artifact.isolateSnapshotData, targetPlatform, buildMode);
    final String isolateSnapshotData = fs.path.join(outputDir.path, 'isolate_snapshot_data');
    final String isolateSnapshotInstructions = fs.path.join(outputDir.path, 'isolate_snapshot_instr');
