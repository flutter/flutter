...
class JITSnapshotter {
  ...
  Future<int> build({
    ...
    // IA32 instructions generated by Dart VM can't be serialized yet,
    // so for now let's create a snapshot with only the data section.
    final bool supportsAppJit = (platform != TargetPlatform.android_x86);
