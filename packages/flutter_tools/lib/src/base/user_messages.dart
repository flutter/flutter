...
class UserMessages {
  ...
  String flutterStatusInfo(final String? channel, final String? version, final String os, final String locale) =>
      'Channel ${channel ?? 'unknown'}, ${version ?? 'Unknown'}, on $os, locale $locale';
  String flutterVersion(final String version, final String channel, final String flutterRoot) =>
  ...
  String flutterRevision(final String revision, final String age, final String date) =>
    'Framework revision $revision ($age), $date';
  String flutterUpstreamRepositoryUrl(final String url) => 'Upstream repository $url';
  String get flutterUpstreamRepositoryUnknown =>
    'Unknown upstream repository.\n'
    'Reinstall Flutter by following instructions at https://flutter.dev/docs/get-started/install.';
  String flutterUpstreamRepositoryUrlEnvMismatch(final String url) => 'Upstream repository $url is not the same as FLUTTER_GIT_URL';
  String flutterUpstreamRepositoryUrlNonStandard(final String url) =>
    'Upstream repository $url is not a standard remote.\n'
    'Set environment variable "FLUTTER_GIT_URL" to $url to dismiss this error.';
  String flutterGitUrl(final String url) => 'FLUTTER_GIT_URL = $url';
  String engineRevision(final String revision) => 'Engine revision $revision';
  String dartRevision(final String revision) => 'Dart version $revision';
  String devToolsVersion(final String version) => 'DevTools version $version';
  String pubMirrorURL(final String url) => 'Pub download mirror $url';
  String flutterMirrorURL(final String url) => 'Flutter download mirror $url';
  ...
  String intellijStatusInfo(final String version) => 'version $version';
  String get intellijPluginInfo =>
      'For information about installing plugins, see\n'
      'https://flutter.dev/intellij-setup/#installing-the-plugins';
  String intellijMinimumVersion(final String minVersion) =>
      'This install is older than the minimum recommended version of $minVersion.';
  String intellijLocation(final String installPath) => 'IntelliJ at $installPath';
  ...
  String devicesAvailable(final int devices) => '$devices available';

  // Messages used in AndroidValidator
  String androidCantRunJavaBinary(final String javaBinary) => 'Cannot execute $javaBinary to determine the version';
  String get androidUnknownJavaVersion => 'Could not determine java version';
  String androidJavaVersion(final String javaVersion) => 'Java version $javaVersion';
  String androidJavaMinimumVersion(final String javaVersion) => 'Java version $javaVersion is older than the minimum recommended version of 1.8';
  String androidSdkLicenseOnly(final String envKey) =>
  ...
  String androidBadSdkDir(final String envKey, final String homeDir) =>
      '$envKey = $homeDir\n'
      'but Android SDK not found at this location.';
  String androidMissingSdkInstructions(final Platform platform) =>
  ...
  String androidSdkLocation(final String directory) => 'Android SDK at $directory';
  String androidSdkPlatformToolsVersion(final String platform, final String tools) =>
      'Platform $platform, build-tools $tools';
  String androidSdkInstallHelp(final Platform platform) =>
      'Try re-installing or updating your Android SDK,\n'
      'visit ${_androidSdkInstallUrl(platform)} for detailed instructions.';
  // Also occurs in AndroidLicenseValidator
  String androidStatusInfo(final String version) => 'Android SDK version $version';
  ...
  String androidJdkLocation(final String location) => 'Java binary at: $location';
  ...
  String androidLicensesUnknown(final Platform platform) =>
      'Android license status unknown.\n'
      'Run `flutter doctor --android-licenses` to accept the SDK licenses.\n'
      'See ${_androidSdkInstallUrl(platform)} for more details.';
  String androidSdkManagerOutdated(final String managerPath) =>
      'A newer version of the Android SDK is required. To update, run:\n'
      '$managerPath --update\n';
  String androidLicensesTimeout(final String managerPath) => 'Intentionally killing $managerPath';
  String get androidSdkShort => 'Unable to locate Android SDK.';
  String androidMissingSdkManager(final String sdkManagerPath, final Platform platform) =>
      'Android sdkmanager tool not found ($sdkManagerPath).\n'
      'Try re-installing or updating your Android SDK,\n'
      'visit ${_androidSdkInstallUrl(platform)} for detailed instructions.';
  String androidCannotRunSdkManager(final String sdkManagerPath, final String error, final Platform platform) =>
      'Android sdkmanager tool was found, but failed to run ($sdkManagerPath): "$error".\n'
      'Try re-installing or updating your Android SDK,\n'
      'visit ${_androidSdkInstallUrl(platform)} for detailed instructions.';
  String androidSdkBuildToolsOutdated(final int sdkMinVersion, final String buildToolsMinVersion, final Platform platform) =>
  ...
  String androidStudioVersion(final String version) => 'version $version';
  String androidStudioLocation(final String location) => 'Android Studio at $location';
  ...
  String androidStudioMissing(final String location) =>
      'android-studio-dir = $location\n'
      'but Android Studio not found at this location.';
  String androidStudioInstallation(final Platform platform) =>
      'Android Studio not found; download from https://developer.android.com/studio/index.html\n'
      '(or visit ${_androidSdkInstallUrl(platform)} for detailed instructions).';

  // Messages used in XcodeValidator
  String xcodeLocation(final String location) => 'Xcode at $location';

  String xcodeOutdated(final String requiredVersion) =>
      'Flutter requires Xcode $requiredVersion or higher.\n'
      'Download the latest version or update via the Mac App Store.';

  String xcodeRecommended(final String recommendedVersion) =>
  ...
  String cocoaPodsVersion(final String version) => 'CocoaPods version $version';
  String cocoaPodsMissing(final String consequence, final String installInstructions) =>
      'CocoaPods not installed.\n'
      '$consequence\n'
      'To install $installInstructions';
  String cocoaPodsUnknownVersion(final String consequence, final String upgradeInstructions) =>
      'Unknown CocoaPods version installed.\n'
      '$consequence\n'
      'To upgrade $upgradeInstructions';
  String cocoaPodsOutdated(final String currentVersion, final String recVersion, final String consequence, final String upgradeInstructions) =>
      'CocoaPods $currentVersion out of date ($recVersion is recommended).\n'
      '$consequence\n'
      'To upgrade $upgradeInstructions';
  String cocoaPodsBrokenInstall(final String consequence, final String reinstallInstructions) =>
      'CocoaPods installed but not working.\n'
      '$consequence\n'
      'To re-install $reinstallInstructions';

  // Messages used in VsCodeValidator
  String vsCodeVersion(final String version) => 'version $version';
  String vsCodeLocation(final String location) => 'VS Code at $location';
  String vsCodeFlutterExtensionMissing(final String url) => 'Flutter extension not installed; install from\n$url';

  // Messages used in VisualStudioValidator
  String visualStudioVersion(final String name, final String version) => '$name version $version';
  String visualStudioLocation(final String location) => 'Visual Studio at $location';
  String windows10SdkVersion(final String version) => 'Windows 10 SDK version $version';
  String visualStudioMissingComponents(final String workload, final List<String> components) =>
  ...
  String visualStudioMissing(final String workload) =>
      'Visual Studio not installed; this is necessary for Windows development.\n'
      'Download at https://visualstudio.microsoft.com/downloads/.\n'
      'Please install the "$workload" workload, including all of its default components';
  String visualStudioTooOld(final String minimumVersion, final String workload) =>
  ...
  String clangTooOld(final String minimumVersion) => 'clang++ $minimumVersion or later is required.';
  ...
  String cmakeTooOld(final String minimumVersion) => 'cmake $minimumVersion or later is required.';
  String ninjaVersion(final String version) => 'ninja version $version';
  ...
  String ninjaTooOld(final String minimumVersion) => 'ninja $minimumVersion or later is required.';
  String pkgConfigVersion(final String version) => 'pkg-config version $version';
  ...
  String pkgConfigTooOld(final String minimumVersion) => 'pkg-config $minimumVersion or later is required.';
  ...
  String flutterElapsedTime(final String name, final String elapsedTime) => '"flutter $name" took $elapsedTime.';
  String get flutterNoDevelopmentDevice =>
      "Unable to locate a development device; please run 'flutter doctor' "
      'for information about installing additional components.';
  String flutterNoMatchingDevice(final String deviceId) => 'No supported devices found with name or id '
      "matching '$deviceId'.";
  String get flutterNoDevicesFound => 'No devices found.';
  String get flutterNoSupportedDevices => 'No supported devices connected.';
  String flutterMissPlatformProjects(final List<String> unsupportedDevicesType) =>
  ...
  String flutterFoundSpecifiedDevices(final int count, final String deviceId) =>
      'Found $count devices with name or id matching $deviceId:';
  String flutterChooseDevice(final int option, final String name, final String deviceId) => '[$option]: $name ($deviceId)';
  ...
  String flutterTargetFileMissing(final String path) => 'Target file "$path" not found.';
  ...
  String runnerNoRoot(final String error) => 'Unable to locate flutter root: $error';
  String runnerWrapColumnInvalid(final dynamic value) =>
      'Argument to --wrap-column must be a positive integer. You supplied $value.';
  String runnerWrapColumnParseError(final dynamic value) =>
      'Unable to parse argument --wrap-column=$value. Must be a positive integer.';
  String runnerBugReportFinished(final String zipFileName) =>
  ...
  String runnerNoEngineSrcDir(final String enginePackageName, final String engineEnvVar) =>
  ...
  String runnerNoEngineBuildDirInPath(final String engineSourcePath) =>
  ...
  String runnerNoEngineBuild(final String engineBuildPath) =>
      'No Flutter engine build found at $engineBuildPath.';
  String runnerNoWebSdk(final String webSdkPath) =>
      'No Flutter web sdk found at $webSdkPath.';
  String runnerWrongFlutterInstance(final String flutterRoot, final String currentDir) =>
  ...
  String runnerRemovedFlutterRepo(final String flutterRoot, final String flutterPath) =>
  ...
  String runnerChangedFlutterRepo(final String flutterRoot, final String flutterPath) =>
  ...
  String invalidVersionSettingHintMessage(final String invalidVersion) =>
  ...
  String _androidSdkInstallUrl(final Platform platform) {
