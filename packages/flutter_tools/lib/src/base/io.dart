...
class ProcessSignal implements io.ProcessSignal {
  ...
  static const ProcessSignal SIGWINCH = _PosixProcessSignal._(io.ProcessSignal.SIGWINCH); // ignore: deprecated_member_use
  static const ProcessSignal SIGTERM = _PosixProcessSignal._(io.ProcessSignal.SIGTERM); // ignore: deprecated_member_use
  static const ProcessSignal SIGUSR1 = _PosixProcessSignal._(io.ProcessSignal.SIGUSR1); // ignore: deprecated_member_use
  static const ProcessSignal SIGUSR2 = _PosixProcessSignal._(io.ProcessSignal.SIGUSR2); // ignore: deprecated_member_use
  static const ProcessSignal SIGINT =  ProcessSignal(io.ProcessSignal.SIGINT); // ignore: deprecated_member_use
