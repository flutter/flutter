...
class BuildDaemonCreator {
  ...
  Future<BuildDaemonClient> _connectClient(
    ...
    { bool release, bool profile, bool hasPlugins, List<String> targets }
  ) {
    ...
    return BuildDaemonClient.connect(
      ...
      <String>[
        ...
        '--define', 'flutter_tools:entrypoint=targets=${targets?.join(',')}',
        '--define', 'flutter_tools:entrypoint=profile=$profile',
        '--define', 'flutter_tools:test_entrypoint=targets=${targets?.join(',')}',
