...
void fl_register_plugins(FlPluginRegistry* registry) {
{{#plugins}}
  g_autoptr(FlPluginRegistrar) {{name}}_registrar = fl_plugin_registry_get_registrar_for_plugin(registry, "{{class}}");
  {{name}}_plugin_register_with_registrar({{name}}_registrar);
{{/plugins}}
}
''';
