...
class Plugin {
  ...
  factory Plugin._fromMultiPlatformYaml(
    ...
    for (final String platform in sharedHandlingPlatforms) {
        ...
        final DartPluginClassAndFilePair? dartPair = _getPluginDartClassForPlatform(platformsYaml, platform, name);
        if (dartPair != null) {
  ...
  static DartPluginClassAndFilePair? _getPluginDartClassForPlatform(YamlMap platformsYaml, String platformKey, String name) {
    if (!_supportsPlatform(platformsYaml, platformKey)) {
      return null;
    }
    if ((platformsYaml[platformKey] as YamlMap).containsKey(kDartPluginClass)) {
      ...
      final String dartFileName = (platformsYaml[platformKey] as YamlMap)[kDartFileName] as String? ?? '$name.dart';
...
class DartPluginClassAndFilePair {
  ...
  bool operator ==(Object other) {
    ...
    return other is DartPluginClassAndFilePair && dartClass == other.dartClass && dartFileName == other.dartFileName;
  }
  @override
