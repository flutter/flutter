...
Future<void> main(List<String> args) async {
  ...
  await runner.run(
    ...
    () {
      ...
      return generateCommands(verboseHelp: verboseHelp, verbose: verbose, git: git);
    },
    verbose: verbose,
...
List<FlutterCommand> generateCommands({
  ...
  ChannelCommand(git: git, verboseHelp: verboseHelp),
  ...
  DowngradeCommand(git: git, verboseHelp: verboseHelp, logger: globals.logger),
  DriveCommand(
    verboseHelp: verboseHelp,
    fileSystem: globals.fs,
    logger: globals.logger,
  ...
  UpgradeCommand(git: git, verboseHelp: verboseHelp),
