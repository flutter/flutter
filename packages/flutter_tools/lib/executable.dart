...
List<FlutterCommand> generateCommands({required bool verboseHelp, required bool verbose}) {
  // Retrieve Xcode using the transitional bootstrapping mechanism.
  // This should be removed when other globals are migrated.
  ...
  return <FlutterCommand>[
    ...
    AssembleCommand(verboseHelp: verboseHelp, buildSystem: globals.buildSystem, xcode: xcode),
    AttachCommand(
      verboseHelp: verboseHelp,
      stdio: globals.stdio,
      logger: globals.logger,
    ...
    CleanCommand(xcode: xcode, verbose: verbose),
    ...
    DaemonCommand(xcode: xcode, hidden: !verboseHelp),
    ...
    RunCommand(xcode: xcode, verboseHelp: verboseHelp),
