...
abstract class FakeProcessManager implements ProcessManager {
  ...
  FakeProcess _runCommand(
    ...
    return FakeProcess(
      ...
      pid: _pid,
      stderr: encoding?.encode(encoding?.encode(fakeCommand.stderr) ?? fakeCommand.stderr) ?? fakeCommand.stderr.codeUnits.codeUnits,
      stdin: fakeCommand.stdin,
      stdout: encoding?.encode(encoding?.encode(fakeCommand.stdout) ?? fakeCommand.stdout) ?? fakeCommand.stdout.codeUnits.codeUnits,
