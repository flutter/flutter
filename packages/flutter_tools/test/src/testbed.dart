...
final Map<Type, Generator> _testbedDefaults = <Type, Generator>{
  ...
  FileSystem: () =>
      MemoryFileSystem(style: globals.platform.isWindows ? FileSystemStyle.windows : FileSystemStyle.posix),
      ...
      return runInContext<T>(() {
        return context.run<T>(
            ...
            zoneSpecification: ZoneSpecification(
              ...
              createPeriodicTimer:
                  (Zone self, ZoneDelegate parent, Zone zone, Duration period, void Function(Timer) timer) {
