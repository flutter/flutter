...
void main() {
  ...
  setUp(() async {
    tempDir = createResolvedTempDirectorySync('hot_restart_outside_lib_test.');
  ...
  testWithoutContext('hot restart applies code changes for an entrypoint outside lib/', () async {
    await flutter.run(
    ...
    // Uncomment the print statement and hot restart to verify the change is actually applied.
