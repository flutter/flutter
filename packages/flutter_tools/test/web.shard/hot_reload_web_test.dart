...
void main() async {
  ...
  await _testProject(HotReloadProject(constApp: true),
      name: 'Default) (with `const MyApp()`)'); // runApp(const MyApp());
  ...
  await _testProject(HotReloadProject(indexHtml: indexHtmlFlutterJsLoad),
