...
void main() {
  ...
  testUsingContext('cannot create a project if non-empty non-project directory exists with .metadata', () async {
    ...
    expect(
        () async => await _createAndAnalyzeProject(
            dir: projectDir,
            createArgs: <String>[],
            expectedPaths: <String>[],
            unexpectedPaths: <String>[
  ...
  testUsingContext('kotlin app project', () async {
    print('Temp dir: ${tempDir.path}');
    return _createProject(
      dir: projectDir,
      createArgs: <String>['--no-pub', '--template=app', '--android-language=kotlin'],
      expectedPaths: <String>[
  ...
  // TODO(dnfield): update module template to pass this test
  testUsingContext('swift app project', () async {
    print('Temp dir: ${tempDir.path}');
    return _createProject(
      dir: projectDir,
      createArgs: <String>['--no-pub', '--template=app', '--ios-language=swift'],
      expectedPaths: <String>[
  ...
  testUsingContext('kotlin legacy app project', () async {
    return _createProject(
      dir: projectDir,
      createArgs: <String>['--no-pub', '--template=legacy_app_v1', '--android-language=kotlin'],
      expectedPaths: <String>[
        'android/app/src/main/kotlin/com/example/flutterproject/MainActivity.kt',
        'lib/main.dart',
      ],
  ...
  testUsingContext('swift legacy app project', () async {
    return _createProject(
      dir: projectDir,
      createArgs: <String>['--no-pub', '--template=legacy_app_v1', '--ios-language=swift'],
      expectedPaths: <String>[
        'ios/Runner/AppDelegate.swift',
        'ios/Runner/Runner-Bridging-Header.h',
        'lib/main.dart',
  ...
  testUsingContext('can create a package project', () async {
    await _createAndAnalyzeProject(
      dir: projectDir,
      createArgs: <String>['--template=package'],
      expectedPaths: <String>[
  ...
  testUsingContext('can create a plugin project', () async {
    ...
    await _createAndAnalyzeProject(
      dir: projectDir,
      createArgs: <String>['--template=plugin'],
      expectedPaths: <String>[
        'android/src/main/java/com/example/flutterproject/FlutterProjectPlugin.java',
        'example/android/app/src/main/java/com/example/flutterprojectexample/MainActivity.java',
        'example/ios/Runner/AppDelegate.h',
  ...
  testUsingContext('kotlin/swift plugin project', () async {
    return _createProject(
      dir: projectDir,
      createArgs: <String>['--no-pub', '--template=plugin', '-a', 'kotlin', '--ios-language', 'swift'],
      expectedPaths: <String>[
  ...
  testUsingContext('plugin project with custom org', () async {
    return _createProject(
      dir: projectDir,
      createArgs: <String>['--no-pub', '--template=plugin', '--org', 'com.bar.foo'],
      expectedPaths: <String>[
  ...
  testUsingContext('legacy app project with-driver-test', () async {
    return _createAndAnalyzeProject(
      dir: projectDir,
      createArgs: <String>['--with-driver-test', '--template=app'],
      expectedPaths: <String>['lib/main.dart'],
    );
  }, timeout: allowForRemotePubInvocation);
  ...
  testUsingContext('app has correct content and formatting with app template', () async {
    Cache.flutterRoot = '../..';
    when(mockFlutterVersion.frameworkRevision).thenReturn(frameworkRevision);
    when(mockFlutterVersion.channel).thenReturn(frameworkChannel);
    ...
    void expectExists(String relPath) {
      final String expectedPath = '${projectDir.path}/$relPath';
      print('Expecting to find dir: $expectedPath');
      expect(fs.isFileSync('${projectDir.path}/$relPath'), true);
    }
  ...
  testUsingContext('legacy app v1 has correct content and formatting with app template', () async {
    Cache.flutterRoot = '../..';
    when(mockFlutterVersion.frameworkRevision).thenReturn(frameworkRevision);
    when(mockFlutterVersion.channel).thenReturn(frameworkChannel);
    ...
    await runner.run(<String>['create', '--template=legacy_app_v1', '--no-pub', '--org', 'com.foo.bar', projectDir.path]);
