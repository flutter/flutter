  ...
  group('Project', () {
    ...
    group('ensure ready for platform-specific tooling', () {
      ...
      _testInMemory('Android project no pubspec continues', () async {
        ...
        project.checkForDeprecation(deprecationBehavior: DeprecationBehavior.ignore);
        expect(testLogger.statusText, isNot(contains('https://github.com/flutter/flutter/blob/master/docs/platforms/android/Upgrading-pre-1.12-Android-projects.md')));
      });
