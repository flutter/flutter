...
void main() {
  ...
  testUsingContext('GitTagVersion', () {
    ...
    expect(GitTagVersion.parse('1.2.3-dev.0.0-4-g$hash').frameworkVersionFor(hash), '1.2.4-pre.4');
    ...
    expect(GitTagVersion.parse('1.2.3+hotfix.1-4-g$hash').frameworkVersionFor(hash), '1.2.3+hotfix.2-pre.4');
    expect(GitTagVersion.parse('7.2.4+hotfix.8-0-g$hash').frameworkVersionFor(hash), '7.2.4+hotfix.8');
