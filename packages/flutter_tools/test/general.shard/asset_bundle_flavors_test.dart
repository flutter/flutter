...
''');
    ...
    expect(
        bundle.entries.keys, isNot(contains('assets/vanilla/ice-cream.png')));
    expect(bundle.entries.keys,
        isNot(contains('assets/strawberry/ice-cream.png')));
  ...
  testWithoutContext(
    ...
    fileSystem.file('.packages').createSync();
    fileSystem
        .file(fileSystem.path.join('assets', 'unflavored.png'))
        .createSync(recursive: true);
    fileSystem
...
''');
    ...
    expect(
      ...
      throwsToolExit(
          message: 'Multiple assets entries include the file '
  ...
  testWithoutContext(
    ...
    fileSystem.file('.packages').createSync();
    fileSystem
        .file(fileSystem.path.join('vanilla', 'vanilla.png'))
        .createSync(recursive: true);
    fileSystem
