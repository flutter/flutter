...
void main() {
  group('CachedArtifacts', () {
    ...
    testWithoutContext('getArtifactPath', () {
      ...
      expect(
        ...
        anyOf(expectedArm64ReleaseFrameworkArtifact,
    ...
    testWithoutContext('precompiled web artifact paths are correct', () {
      ...
      expect(
        artifacts
            .getHostArtifact(HostArtifact.webPrecompiledSdkSourcemaps)
            .path,
      ...
      expect(
        artifacts
            .getHostArtifact(HostArtifact.webPrecompiledCanvaskitSdkSourcemaps)
            .path,
      ...
      expect(
        artifacts
            .getHostArtifact(HostArtifact.webPrecompiledSoundSdkSourcemaps)
            .path,
        'root/bin/cache/flutter_web_sdk/kernel/amd-sound/dart_sdk.js.map',
      );
      expect(
        artifacts
            .getHostArtifact(HostArtifact.webPrecompiledCanvaskitSoundSdk)
            .path,
      ...
      expect(
        artifacts
            .getHostArtifact(
                HostArtifact.webPrecompiledCanvaskitSoundSdkSourcemaps)
            .path,
  ...
  group('LocalEngineArtifacts', () {
    ...
    testWithoutContext('uses prebuilt dart sdk for web platform', () {
      ...
      expect(
        artifacts.getArtifactPath(Artifact.wasmOptBinary,
            platform: TargetPlatform.web_javascript),
        fileSystem.path.join('/flutter', 'prebuilts', 'linux-x64', 'dart-sdk',
            'bin', 'utils', 'wasm-opt'),
      );
