...
import 'package:flutter_tools/src/isolated/native_assets/dart_hook_result.dart' show DartHookResult;
import 'package:flutter_tools/src/isolated/native_assets/native_assets.dart'
    show DataAsset, runFlutterSpecificHooks;

import '../../src/common.dart' show expect, setUp, throwsToolExit;
...
void main() {
  ...
  testUsingContext(
    ...
    () async {
      ...
      expect(result.dataAssets.map((DataAsset c) => c.file.toString()).toList()..sort(), <String>[
        imageFile.uri.toString(),
        textFile2.uri.toString(),
      ]);
    },
  );
}
