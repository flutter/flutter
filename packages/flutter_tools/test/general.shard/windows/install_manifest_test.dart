...
void main() {
  ...
  testUsingContext('Generates install manifest for a debug build', () async {
    ...
    final Directory buildDirectory = fileSystem.currentDirectory.childDirectory('build').childDirectory('winuwp');
...
''');
    fileSystem.currentDirectory.childDirectory('assets').childFile('foo.png').createSync(recursive: true);
