...
void main() {
  testWithoutContext('correctly parses source, source map, metadata, manifest files', () {
    ...
    expect(utf8.decode(webMemoryFS.getFile('foo.js')!), 'main() {}');
    expect(utf8.decode(webMemoryFS.sourceMap('foo.js.map')!), '{}');
    expect(utf8.decode(webMemoryFS.metadataFile('foo.js.metadata')!), '{}');
