...
void main() {
  ...
  test(
      ...
      () => testbed.run(() async {
            ...
            final Response response =
                await webAssetServer.handleRequest(Request('GET', Uri.parse('http://foobar/foo.js')));
  ...
  test(
      ...
      () => testbed.run(() async {
            ...
            final Response cachedResponse = await webAssetServer.handleRequest(Request(
                'GET', Uri.parse('http://foobar/foo.js'),
  ...
  test(
      ...
      () => testbed.run(() async {
            ...
            final Response response =
                await webAssetServer.handleRequest(Request('GET', Uri.parse('http://foobar/bar/baz')));
  ...
  test(
      ...
      () => testbed.run(() async {
            ...
            final Response response = await webAssetServer.handleRequest(Request(
                'GET', Uri.parse('http://foobar/assets/abcd%25E8%25B1%25A1%25E5%25BD%25A2%25E5%25AD%2597.png')));
  ...
  test(
      ...
      () => testbed.run(() async {
            ...
            final Response response =
                await webAssetServer.handleRequest(Request('GET', Uri.parse('http://foobar/foo.dart')));
  ...
  test(
      ...
      () => testbed.run(() async {
            ...
            final String webPrecompiledSdk =
                globals.artifacts.getHostArtifact(HostArtifact.webPrecompiledSoundSdk).path;
            final String webPrecompiledSdkSourcemaps =
  ...
  test(
      ...
      () => testbed.run(() async {
            ...
            final WebDevFS webDevFS = WebDevFS(
              ...
              nullAssertions: true,
              nativeNullAssertions: true,
              buildInfo: const BuildInfo(BuildMode.debug, '', treeShakeIcons: false, dartDefines: <String>[
