...
void main() {
  ...
  group('generateLocalizations', () {
    testWithoutContext('works even if CWD does not have a pubspec.yaml',
        () async {
      final Directory projectDir = fs.currentDirectory.childDirectory('project')
        ..createSync(recursive: true);
      final Directory l10nDirectory = projectDir
          .childDirectory('lib')
          .childDirectory('l10n')
        ..createSync(recursive: true);
      l10nDirectory
      ...
      const String secondMessageArbFileString = '''
{
  ...
  "@market": {
    ...
    testWithoutContext(
        'AppResourceBundle throws if file contains non-string value', () {
      ...
      expect(
        ...
        throwsToolExit(
            message: 'Localized message for key "helloWorld" in '
