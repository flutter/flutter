...
const FakeVmServiceRequest setAssetBundlePath =
    FakeVmServiceRequest(method: '_flutter.setAssetBundlePath', args: <String, Object>{
  'viewId': 'a',
  'assetDirectory': 'build/flutter_assets',
  'isolateId': '1',
});

const FakeVmServiceRequest evict = FakeVmServiceRequest(method: 'ext.flutter.evict', args: <String, Object>{
  'value': 'asset',
  'isolateId': '1',
});
  ...
  testUsingContext(
      ...
      () => testbed.run(() async {
            fakeVmServiceHost = FakeVmServiceHost(requests: <VmServiceExpectation>[
              ...
              FakeVmServiceRequest(method: kRunInViewMethod, args: <String, Object>{
  ...
  testUsingContext(
      ...
      () => testbed.run(() async {
            ...
            expect(result.message,
                contains('Reload rejected: Failed to hot reload')); // contains error message from reload report.
            expect(result.code, 1);
  ...
  testUsingContext(
      ...
      () => testbed.run(() async {
            fakeVmServiceHost = FakeVmServiceHost(requests: <VmServiceExpectation>[
              ...
              const FakeVmServiceRequest(method: 'setIsolatePauseMode', args: <String, String>{
                'isolateId': '1',
                'exceptionPauseMode': 'None',
              }),
              const FakeVmServiceRequest(method: 'removeBreakpoint', args: <String, String>{
                'isolateId': '1',
                'breakpointId': 'test-breakpoint',
              }),
              const FakeVmServiceRequest(method: 'resume', args: <String, String>{
                'isolateId': '1',
              }),
              listViews,
              const FakeVmServiceRequest(
...
''');
            ...
            final File generatedMain =
                globals.fs.directory('.dart_tool').childDirectory('flutter_build').childFile('generated_main.dart');
            ...
            arbFile.writeAsStringSync('''
{
  ...
  testUsingContext(
      ...
      () => testbed.run(() async {
            fakeVmServiceHost = FakeVmServiceHost(requests: <VmServiceExpectation>[
              listViews,
              FakeVmServiceRequest(method: kGetSkSLsMethod, args: <String, Object>{
                'viewId': fakeFlutterView.id,
              }, jsonResponse: <String, Object>{
                'SkSLs': <String, Object>{}
              }),
  ...
  testUsingContext(
      ...
      () => testbed.run(() async {
            ...
            residentRunner = HotRunner(
              ...
              stayResident: false,
              debuggingOptions: DebuggingOptions.enabled(const BuildInfo(BuildMode.debug, '',
                  treeShakeIcons: false, extraFrontEndOptions: <String>['--enable-experiment=non-nullable'])),
              target: 'main.dart',
              devtoolsHandler: createNoOpHandler,
            );
            residentRunner.artifactDirectory.childFile('app.dill').writeAsStringSync('ABC');
  ...
  testUsingContext('FlutterDevice uses dartdevc configuration when targeting web with null-safety autodetected',
      () async {
    fakeVmServiceHost = FakeVmServiceHost(requests: <VmServiceExpectation>[]);
    final FakeDevice device = FakeDevice(targetPlatform: TargetPlatform.web_javascript);
...
class TestFlutterDevice extends FlutterDevice {
  TestFlutterDevice(Device device, {Stream<Uri> observatoryUris}) : super(device, buildInfo: BuildInfo.debug) {
...
class FakeProjectFileInvalidator extends Fake implements ProjectFileInvalidator {
  ...
  Future<InvalidationResult> findInvalidated({
    ...
    return InvalidationResult(packageConfig: packageConfig ?? PackageConfig.empty, uris: <Uri>[
