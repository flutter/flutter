...
''');
            ...
            expect(
                generatedMain.readAsStringSync(), contains('custom_main.dart'));
            expect(testLogger.errorText, isEmpty);
            expect(testLogger.statusText, isEmpty);
          }));
            ...
            arbFile.writeAsStringSync('''
{
  ...
  testUsingContext(
    ...
    expect(residentCompiler.platformDill,
        'file:///HostArtifact.webPlatformKernelDill');
  }, overrides: <Type, Generator>{
  ...
  testUsingContext(
    ...
    expect(residentCompiler.sdkRoot,
        '${globals.artifacts.getHostArtifact(HostArtifact.flutterWebSdk).path}/');
    expect(residentCompiler.platformDill,
        'file:///HostArtifact.webPlatformSoundKernelDill');
  }, overrides: <Type, Generator>{
    Artifacts: () => Artifacts.test(),
    FileSystem: () => MemoryFileSystem.test(),
    ProcessManager: () => FakeProcessManager.any(),
  ...
  testUsingContext(
      ...
      () => testbed.run(() async {
            ...
            ddsLauncherCallback =
                (Uri uri, {bool enableAuthCodes, bool ipv6, Uri serviceUri}) {
  ...
  testUsingContext(
      ...
      () => testbed.run(() async {
            ...
            ddsLauncherCallback = (Uri uri,
                {bool enableAuthCodes, bool ipv6, Uri serviceUri}) async {
              expect(uri, Uri(scheme: 'foo', host: 'bar'));
