...
void main() {
  ...
  group('FlutterPlatform', () {
    ...
    test('generateTestBootstrap contains test URI import with "test" prefix', () {
      final String bootstrapContent = generateTestBootstrap(
        testUrl: Uri.parse('file:///absolute/path/to/test/my_test.dart'),
