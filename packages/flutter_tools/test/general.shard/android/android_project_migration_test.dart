...
'''));
    ...
    group(
        'migrate min sdk versions less than 21 to flutter.minSdkVersion '
      ...
      testWithoutContext('replace when api 20', () {
        ...
        project.appGradleFile
            .writeAsStringSync(sampleModuleGradleBuildFile(minSdkVersion20));
        migration.migrate();
        expect(project.appGradleFile.readAsStringSync(),
            sampleModuleGradleBuildFile(replacementMinSdkText));
      });
      ...
      testWithoutContext('do nothing when >=api 21', () {
        ...
        project.appGradleFile
            .writeAsStringSync(sampleModuleGradleBuildFile(minSdkVersion21));
        migration.migrate();
        expect(project.appGradleFile.readAsStringSync(),
