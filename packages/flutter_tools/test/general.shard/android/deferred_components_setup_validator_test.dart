...
''', flush: true, mode: FileMode.append);
  ...
  testWithoutContext('androidRootSetup exists passes', () async {
    final DeferredComponentsSetupValidator validator = DeferredComponentsSetupValidator(
      env,
      exitOnFail: false,
      title: 'test check',
...
''', flush: true, mode: FileMode.append);
  ...
  testWithoutContext('androidRootSetup missing adds to file', () async {
    final DeferredComponentsSetupValidator validator = DeferredComponentsSetupValidator(
      env,
      exitOnFail: false,
      title: 'test check',
...
''', flush: true, mode: FileMode.append);
  ...
  testWithoutContext('androidRootSetup multiline missing', () async {
    final DeferredComponentsSetupValidator validator = DeferredComponentsSetupValidator(
      env,
      exitOnFail: false,
      title: 'test check',
