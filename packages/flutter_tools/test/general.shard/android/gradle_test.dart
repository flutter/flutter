...
void main() {
  ...
  group('gradle tasks', () {
    test('assemble release', () {
      ...
      expect(
        getAssembleTaskFor(const BuildInfo(BuildMode.release, 'flavorFoo', fontSubset: false)),
    ...
    test('assemble debug', () {
      expect(
        getAssembleTaskFor(const BuildInfo(BuildMode.debug, null, fontSubset: false)),
        equals('assembleDebug'),
      );
      expect(
        getAssembleTaskFor(const BuildInfo(BuildMode.debug, 'flavorFoo', fontSubset: false)),
    ...
    test('assemble profile', () {
      expect(
        getAssembleTaskFor(const BuildInfo(BuildMode.profile, null, fontSubset: false)),
        equals('assembleProfile'),
      );
      expect(
        getAssembleTaskFor(const BuildInfo(BuildMode.profile, 'flavorFoo', fontSubset: false)),
  ...
  group('findBundleFile', () {
    ...
    testUsingContext('Finds app bundle when flavor contains underscores in release mode', () {
      ...
      final File bundle = findBundleFile(project, const BuildInfo(BuildMode.release, 'foo_bar', fontSubset: false));
    ...
    testUsingContext('Finds app bundle when flavor doesn\'t contain underscores in release mode', () {
      ...
      final File bundle = findBundleFile(project, const BuildInfo(BuildMode.release, 'foo', fontSubset: false));
      expect(bundle, isNotNull);
    ...
    testUsingContext('Finds app bundle when no flavor is used in release mode', () {
      ...
      final File bundle = findBundleFile(project, const BuildInfo(BuildMode.release, null, fontSubset: false));
      expect(bundle, isNotNull);
    ...
    testUsingContext('Finds app bundle when flavor contains underscores in debug mode', () {
      ...
      final File bundle = findBundleFile(project, const BuildInfo(BuildMode.debug, 'foo_bar', fontSubset: false));
      expect(bundle, isNotNull);
    ...
    testUsingContext('Finds app bundle when flavor doesn\'t contain underscores in debug mode', () {
      ...
      final File bundle = findBundleFile(project, const BuildInfo(BuildMode.debug, 'foo', fontSubset: false));
      expect(bundle, isNotNull);
    ...
    testUsingContext('Finds app bundle when no flavor is used in debug mode', () {
      ...
      final File bundle = findBundleFile(project, const BuildInfo(BuildMode.debug, null, fontSubset: false));
      expect(bundle, isNotNull);
    ...
    testUsingContext('Finds app bundle when flavor contains underscores in profile mode', () {
      ...
      final File bundle = findBundleFile(project, const BuildInfo(BuildMode.profile, 'foo_bar', fontSubset: false));
      expect(bundle, isNotNull);
    ...
    testUsingContext('Finds app bundle when flavor doesn\'t contain underscores in profile mode', () {
      ...
      final File bundle = findBundleFile(project, const BuildInfo(BuildMode.profile, 'foo', fontSubset: false));
      expect(bundle, isNotNull);
    ...
    testUsingContext('Finds app bundle when no flavor is used in profile mode', () {
      ...
      final File bundle = findBundleFile(project, const BuildInfo(BuildMode.profile, null, fontSubset: false));
      expect(bundle, isNotNull);
    ...
    testUsingContext('aab not found', () {
      ...
      expect(
        () {
          findBundleFile(project, const BuildInfo(BuildMode.debug, 'foo_bar', fontSubset: false));
        },
        throwsToolExit(
          message:
  ...
  group('findApkFiles', () {
    ...
    testUsingContext('Finds APK without flavor in release', () {
      ...
      final Iterable<File> apks = findApkFiles(
        project,
        const AndroidBuildInfo(BuildInfo(BuildMode.release, '', fontSubset: false)),
      );
    ...
    testUsingContext('Finds APK with flavor in release mode', () {
      ...
      final Iterable<File> apks = findApkFiles(
        project,
        const AndroidBuildInfo(BuildInfo(BuildMode.release, 'flavor1', fontSubset: false)),
      );
      expect(apks.isNotEmpty, isTrue);
    ...
    testUsingContext('apk not found', () {
      ...
      expect(
        () {
          findApkFiles(
            project,
            const AndroidBuildInfo(BuildInfo(BuildMode.debug, 'foo_bar', fontSubset: false)),
          );
        },
        throwsToolExit(
          message:
...
''';
      ...
      const BuildInfo buildInfo = BuildInfo(BuildMode.release, null, fontSubset: false);
...
flutter:
''';
      const BuildInfo buildInfo = BuildInfo(BuildMode.release, null, buildName: '1.0.2', fontSubset: false);
      await checkBuildVersion(
        manifest: manifest,
        buildInfo: buildInfo,
...
flutter:
''';
      const BuildInfo buildInfo = BuildInfo(BuildMode.release, null, buildNumber: '3', fontSubset: false);
      await checkBuildVersion(
        manifest: manifest,
        buildInfo: buildInfo,
        expectedBuildName: '1.0.0',
...
flutter:
''';
      const BuildInfo buildInfo = BuildInfo(BuildMode.release, null, buildName: '1.0.2', buildNumber: '3', fontSubset: false);
      await checkBuildVersion(
        manifest: manifest,
        buildInfo: buildInfo,
        expectedBuildName: '1.0.2',
...
''';
      await checkBuildVersion(
        manifest: manifest,
        buildInfo: const BuildInfo(BuildMode.release, null, buildName: null, buildNumber: null, fontSubset: false),
        expectedBuildName: null,
        expectedBuildNumber: null,
      );
      await checkBuildVersion(
        manifest: manifest,
        buildInfo: const BuildInfo(BuildMode.release, null, buildName: '1.0.2', buildNumber: '3', fontSubset: false),
        expectedBuildName: '1.0.2',
        expectedBuildNumber: '3',
      );
      await checkBuildVersion(
        manifest: manifest,
        buildInfo: const BuildInfo(BuildMode.release, null, buildName: '1.0.3', buildNumber: '4', fontSubset: false),
  ...
  group('gradle build', () {
    ...
    testUsingContext('doesn\'t indicate how to consume an AAR when printHowToConsumeAaar is false', () async {
      ...
      await buildGradleAar(
        androidBuildInfo: const AndroidBuildInfo(BuildInfo(BuildMode.release, null, fontSubset: false)),
        project: FlutterProject.current(),
