...
void main() {
  ...
  testWithoutContext(
    'AndroidDevice.startApp forwards an explicitly disabled HCPP flag, so that it wins over '
    'the manifest',
    () async {
      final device = AndroidDevice(
        '1234',
  ...
  testWithoutContext(
    'AndroidDevice.startApp sends no HCPP flag when it was not passed explicitly',
    () async {
      final device = AndroidDevice(
        '1234',
        modelID: 'TestModel',
  ...
  group('release mode engine shell arguments:', () {
    ...
    testWithoutContext('AndroidDevice.startApp passes debugging options via Intent when --use-application-binary is used in release mode', () async {
      final device = AndroidDevice(
        '1234',
        modelID: 'TestModel',
        fileSystem: fileSystem,
