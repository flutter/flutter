...
''');
      ...
      () => testbed.run(() async {
            ...
            expect(
                ...
                isNot(contains(
                    "import 'package:foo/generated_plugin_registrant.dart';")));
            expect(generated,
                isNot(contains('registerPlugins(webPluginRegistrar);')));
            // Main
            expect(generated, contains('entrypoint.main();'));
          }));
  ...
  test(
      ...
      () => testbed.run(() async {
            ...
            final Depfile depfile = depfileService
  ...
  test('Generated service worker includes core files', () {
    final String result = generateServiceWorker(
        <String, String>{'/foo': 'abcd'}, <String>['foo', 'bar'],
        serviceWorkerStrategy: ServiceWorkerStrategy.offlineFirst);
  ...
  test(
      ...
      () => testbed.run(() async {
            environment.outputDir.childDirectory('a').childFile('a.txt')
              ..createSync(recursive: true)
              ..writeAsStringSync('A');
            await WebServiceWorker(globals.fs, globals.cache)
                .build(environment);
