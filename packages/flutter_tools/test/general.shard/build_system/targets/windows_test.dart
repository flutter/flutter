...
void main() {
  ...
  testUsingContext('DebugBundleWindowsAssets creates correct bundle structure',
    ...
    await const DebugBundleWindowsAssets(TargetPlatform.windows_x64)
        .build(environment);
  ...
  testUsingContext(
    ...
    await const WindowsAotBundle(AotElfProfile(TargetPlatform.windows_x64))
        .build(environment);
    await const ProfileBundleWindowsAssets(TargetPlatform.windows_x64)
        .build(environment);
  ...
  testUsingContext(
    ...
    await const WindowsAotBundle(AotElfRelease(TargetPlatform.windows_x64))
        .build(environment);
    await const ReleaseBundleWindowsAssets(TargetPlatform.windows_x64)
        .build(environment);
