...
void main() {
  ...
  testWithoutContext(
      'UnpackWindowsUwp copies files to the correct winuwp/ cache directory',
      () async {
    final Artifacts artifacts = Artifacts.test();
    final FileSystem fileSystem =
        MemoryFileSystem.test(style: FileSystemStyle.windows);
    ...
    // Output files are copied correctly.
    expect(fileSystem.file(r'C:\winuwp\flutter\ephemeral\flutter_export.h'),
        exists);
    expect(fileSystem.file(r'C:\winuwp\flutter\ephemeral\flutter_messenger.h'),
        exists);
    expect(
        fileSystem
            .file(r'C:\winuwp\flutter\ephemeral\flutter_windows_winuwp.dll'),
        exists);
    expect(
        fileSystem.file(
    ...
    expect(
        fileSystem
            .file(r'C:\winuwp\flutter\ephemeral\flutter_plugin_registrar.h'),
        exists);
    expect(
        fileSystem
            .file(r'C:\winuwp\flutter\ephemeral\flutter_texture_registrar.h'),
        exists);
    expect(fileSystem.file(r'C:\winuwp\flutter\ephemeral\flutter_windows.h'),
        exists);
    ...
    final File outputDepfile =
        environment.buildDir.childFile('windows_uwp_engine_sources.d');
