...
''');
  ...
  testUsingContext(
    ...
    () async {
      ...
      await const WindowsAotBundle(AotSnapshotProfile(TargetPlatform.windows_x64)).build(environment);
  ...
  testUsingContext(
    ...
    () async {
      ...
      await const WindowsAotBundle(AotSnapshotRelease(TargetPlatform.windows_x64)).build(environment);
