...
''';
    ...
    testUsingContext(
      'includes assets only for matching platform',
      () async {
    ...
    testUsingContext(
      'skips assets for non-matching platform',
      () async {
        for (final platform in kValidPluginPlatforms) {
    ...
    testUsingContext(
      'includes assets for all platforms when no restriction is set',
      () async {
        for (final platform in kValidPluginPlatforms) {
          final TargetPlatform targetPlatform = targetFor(platform);
    ...
    testUsingContext(
      'includes assets only for declared multiple platforms',
      () async {
