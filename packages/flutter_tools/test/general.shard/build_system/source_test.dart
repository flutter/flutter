...
void main() {
  ...
  test(
      ...
      () => testbed.run(() {
            ...
            const Source fizzSource =
                Source.artifact(Artifact.windowsDesktopPath, platform: TargetPlatform.windows_x64);
  ...
  test(
      ...
      () => testbed.run(() {
            ...
            final Environment environment = Environment.test(globals.fs.currentDirectory,
                artifacts: artifacts,
                processManager: FakeProcessManager.any(),
                fileSystem: globals.fs,
                logger: globals.logger,
