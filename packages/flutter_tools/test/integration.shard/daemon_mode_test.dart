...
void main() {
  ...
  testWithoutContext('device.getDevices', () async {
    ...
    transformToLines(daemonProcess.stdout)
    ...
    response = (await stream
        .firstWhere((Map<String, Object?>? json) => json!['id'] == 1))!;
    ...
    response = (await stream.firstWhere((Map<String, Object?>? response) =>
        response!['event'] != 'device.added'))!;
