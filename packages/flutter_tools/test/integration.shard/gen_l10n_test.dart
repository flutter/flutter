...
void main() {
  ...
  test('generated l10n classes produce expected localized strings', () async {
    ...
    expect(stdout.toString(),
      ...
      '#l10n 19 (你好世界)\n'
      '#l10n 20 (你好2个其他世界)\n'
      '#l10n 21 (--- scriptCode: zh_Hans ---)\n'
      '#l10n 22 (简体你好世界)\n'
      '#l10n 23 (--- scriptCode - zh_Hant ---)\n'
      '#l10n 24 (繁體你好世界)\n'
      '#l10n 25 (--- scriptCode - zh_Hant_TW ---)\n'
      '#l10n 26 (台灣繁體你好世界)\n'
      '#l10n 27 (--- General formatting tests ---)\n'
      '#l10n 28 (Hello World)\n'
      '#l10n 29 (Hello _NEWLINE_ World)\n'
      '#l10n 30 (Hello World)\n'
      '#l10n 31 (Hello World)\n'
      '#l10n 32 (Hello World on Friday, January 1, 1960)\n'
      '#l10n 33 (Hello world argument on 1/1/1960 at 00:00)\n'
      '#l10n 34 (Hello World from 1960 to 2020)\n'
      '#l10n 35 (Hello for 123)\n'
      '#l10n 36 (Hello for price USD123.00)\n'
      '#l10n 37 (Hello)\n'
      '#l10n 38 (Hello World)\n'
      '#l10n 39 (Hello two worlds)\n'
      '#l10n 40 (Hello)\n'
      '#l10n 41 (Hello new World)\n'
      '#l10n 42 (Hello two new worlds)\n'
      '#l10n 43 (Hello on Friday, January 1, 1960)\n'
      '#l10n 44 (Hello World, on Friday, January 1, 1960)\n'
      '#l10n 45 (Hello two worlds, on Friday, January 1, 1960)\n'
      '#l10n 46 (Hello other 0 worlds, with a total of 100 citizens)\n'
      '#l10n 47 (Hello World of 101 citizens)\n'
      '#l10n 48 (Hello two worlds with 102 total citizens)\n'
      '#l10n 49 ([Hello] -World- #123#)\n'
      '#l10n 50 (\$!)\n'
      '#l10n 51 (One \$)\n'
      '#l10n 52 (Flutter\'s amazing!)\n'
      '#l10n 53 (Flutter\'s amazing, times 2!)\n'
      '#l10n 54 (Flutter is "amazing"!)\n'
      '#l10n 55 (Flutter is "amazing", times 2!)\n'
      '#l10n 56 (--- es ---)\n'
      '#l10n 57 (ES - Hello world)\n'
      '#l10n 58 (ES - Hello _NEWLINE_ World)\n'
      '#l10n 59 (ES - Hello Mundo)\n'
      '#l10n 60 (ES - Hola Mundo)\n'
      '#l10n 61 (ES - Hello World on viernes, 1 de enero de 1960)\n'
      '#l10n 62 (ES - Hello world argument on 1/1/1960 at 0:00)\n'
      '#l10n 63 (ES - Hello World from 1960 to 2020)\n'
      '#l10n 64 (ES - Hello for 123)\n'
      // Note that the space between "123.00" and "EUR" is a
      // non-breaking space (U+00A0) and not a regular space(U+0020)
      '#l10n 65 (ES - Hello for el precio 123,00 EUR)\n'
      '#l10n 66 (ES - Hello)\n'
      '#l10n 67 (ES - Hello World)\n'
      '#l10n 68 (ES - Hello two worlds)\n'
      '#l10n 69 (ES - Hello)\n'
      '#l10n 70 (ES - Hello nuevo World)\n'
      '#l10n 71 (ES - Hello two nuevo worlds)\n'
      '#l10n 72 (ES - Hello on viernes, 1 de enero de 1960)\n'
      '#l10n 73 (ES - Hello World, on viernes, 1 de enero de 1960)\n'
      '#l10n 74 (ES - Hello two worlds, on viernes, 1 de enero de 1960)\n'
      '#l10n 75 (ES - Hello other 0 worlds, with a total of 100 citizens)\n'
      '#l10n 76 (ES - Hello World of 101 citizens)\n'
      '#l10n 77 (ES - Hello two worlds with 102 total citizens)\n'
      '#l10n 78 (ES - [Hola] -Mundo- #123#)\n'
      '#l10n 79 (ES - \$!)\n'
      '#l10n 80 (ES - One \$)\n'
      '#l10n 81 (ES - Flutter\'s amazing!)\n'
      '#l10n 82 (ES - Flutter\'s amazing, times 2!)\n'
      '#l10n 83 (ES - Flutter is "amazing"!)\n'
      '#l10n 84 (ES - Flutter is "amazing", times 2!)\n'
      '#l10n 85 (--- es_419 ---)\n'
      '#l10n 86 (ES 419 - Hello World)\n'
      '#l10n 87 (ES 419 - Hello)\n'
      '#l10n 88 (ES 419 - Hello World)\n'
      '#l10n 89 (ES 419 - Hello two worlds)\n'
      '#l10n END\n'
    );
  });
}
