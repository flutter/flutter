...
final GenL10nProject project = GenL10nProject(
  useNamedArgument: false,
);
final GenL10nProject projectWithNamedArgument = GenL10nProject(
  useNamedArgument: true,
);
...
void main() {
  ...
  testWithoutContext('generated l10n classes produce expected localized strings when named argument is used', () async {
    await projectWithNamedArgument.setUpIn(tempDir);
    flutter = FlutterRunTestDriver(tempDir);
    final StringBuffer stdout = await runApp();
    expectOutput(stdout);
  });
