...
void main() {
  ...
  test('generated l10n classes produce expected localized strings', () async {
    ...
    expect(stdout.toString(),
      ...
      '#l10n 7 (Hello World)\n'
      '#l10n 8 (Hello World)\n'
      '#l10n 9 (Hello World on Friday, January 1, 1960)\n'
      '#l10n 10 (Hello world argument on 1/1/1960 at 00:00)\n'
      '#l10n 11 (Hello World from 1960 to 2020)\n'
      '#l10n 12 (Hello for 123)\n'
      '#l10n 13 (Hello for price USD123.00)\n'
      '#l10n 14 (Hello)\n'
      '#l10n 15 (Hello World)\n'
      '#l10n 16 (Hello two worlds)\n'
      '#l10n 17 (Hello)\n'
      '#l10n 18 (Hello new World)\n'
      '#l10n 19 (Hello two new worlds)\n'
      '#l10n 20 (Hello on Friday, January 1, 1960)\n'
      '#l10n 21 (Hello World, on Friday, January 1, 1960)\n'
      '#l10n 22 (Hello two worlds, on Friday, January 1, 1960)\n'
      '#l10n 23 (Hello other 0 worlds, with a total of 100 citizens)\n'
      '#l10n 24 (Hello World of 101 citizens)\n'
      '#l10n 25 (Hello two worlds with 102 total citizens)\n'
      '#l10n 26 ([Hello] -World- #123#)\n'
      '#l10n 27 (Flutter\'s amazing!)\n'
      '#l10n 28 (Flutter is "amazing"!)\n'
      '#l10n END\n'
    );
  });
}
