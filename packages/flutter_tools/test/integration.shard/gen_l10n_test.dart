...
void main() {
  ...
  test('generated l10n classes produce expected localized strings', () async {
    ...
    expect(stdout.toString(),
      ...
      '#l10n 5 (supportedLocales[4]: languageCode: zh, countryCode: null, scriptCode: null)\n'
      '#l10n 6 (supportedLocales[5]: languageCode: zh, countryCode: null, scriptCode: Hans)\n'
      '#l10n 7 (supportedLocales[6]: languageCode: zh, countryCode: null, scriptCode: Hant)\n'
      '#l10n 8 (supportedLocales[7]: languageCode: zh, countryCode: TW, scriptCode: Hant)\n'
      '#l10n 9 (--- countryCode (en_CA) tests ---)\n'
      '#l10n 10 (CA Hello World)\n'
      '#l10n 11 (Hello CA fallback World)\n'
      '#l10n 12 (--- countryCode (en_GB) tests ---)\n'
      '#l10n 13 (GB Hello World)\n'
      '#l10n 14 (Hello GB fallback World)\n'
      '#l10n 15 (--- zh ---)\n'
      '#l10n 16 (你好世界)\n'
      '#l10n 17 (你好)\n'
      '#l10n 18 (你好世界)\n'
      ...
      '#l10n 55 (--- es ---)\n'
      '#l10n 56 (ES - Hello world)\n'
      '#l10n 57 (ES - Hello _NEWLINE_ World)\n'
      '#l10n 58 (ES - Hello Mundo)\n'
      '#l10n 59 (ES - Hola Mundo)\n'
      '#l10n 60 (ES - Hello World on viernes, 1 de enero de 1960)\n'
      '#l10n 61 (ES - Hello world argument on 1/1/1960 at 0:00)\n'
      '#l10n 62 (ES - Hello World from 1960 to 2020)\n'
      '#l10n 63 (ES - Hello for 123)\n'
      // Note that the space between "123.00" and "EUR" is a
      // non-breaking space (U+00A0) and not a regular space(U+0020)
      '#l10n 64 (ES - Hello for el precio 123,00 EUR)\n'
      '#l10n 65 (ES - Hello)\n'
      '#l10n 66 (ES - Hello World)\n'
      '#l10n 67 (ES - Hello two worlds)\n'
      '#l10n 68 (ES - Hello)\n'
      '#l10n 69 (ES - Hello nuevo World)\n'
      '#l10n 70 (ES - Hello two nuevo worlds)\n'
      '#l10n 71 (ES - Hello on viernes, 1 de enero de 1960)\n'
      '#l10n 72 (ES - Hello World, on viernes, 1 de enero de 1960)\n'
      '#l10n 73 (ES - Hello two worlds, on viernes, 1 de enero de 1960)\n'
      '#l10n 74 (ES - Hello other 0 worlds, with a total of 100 citizens)\n'
      '#l10n 75 (ES - Hello World of 101 citizens)\n'
      '#l10n 76 (ES - Hello two worlds with 102 total citizens)\n'
      '#l10n 77 (ES - [Hola] -Mundo- #123#)\n'
      '#l10n 78 (ES - \$!)\n'
      '#l10n 79 (ES - One \$)\n'
      '#l10n 80 (ES - Flutter\'s amazing!)\n'
      '#l10n 81 (ES - Flutter\'s amazing, times 2!)\n'
      '#l10n 82 (ES - Flutter is "amazing"!)\n'
      '#l10n 83 (ES - Flutter is "amazing", times 2!)\n'
      '#l10n END\n'
    );
  });
}
