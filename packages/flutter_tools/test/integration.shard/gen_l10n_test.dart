...
void main() {
  ...
  test('generated l10n classes produce expected localized strings', () async {
    ...
    expect(stdout.toString(),
      ...
      '#l10n 6 (supportedLocales[5]: languageCode: zh, countryCode: TW, scriptCode: null)\n'
      ...
      '#l10n 17 (简体你好世界)\n'
      '#l10n 18 (--- countryCode - zh_TW ---)\n'
      '#l10n 19 (台灣繁體你好世界)\n'
      '#l10n 20 (--- scriptCode - zh_Hant ---)\n'
      '#l10n 21 (繁體你好世界)\n'
      '#l10n 22 (--- scriptCode - zh_TW_Hant ---)\n'
      '#l10n 23 (台灣繁體你好世界)\n'
      '#l10n 24 (--- General formatting tests ---)\n'
      '#l10n 25 (Hello World)\n'
      '#l10n 26 (Hello _NEWLINE_ World)\n'
      '#l10n 27 (Hello World)\n'
      '#l10n 28 (Hello World)\n'
      '#l10n 29 (Hello World on Friday, January 1, 1960)\n'
      '#l10n 30 (Hello world argument on 1/1/1960 at 00:00)\n'
      '#l10n 31 (Hello World from 1960 to 2020)\n'
      '#l10n 32 (Hello for 123)\n'
      '#l10n 33 (Hello for price USD123.00)\n'
      '#l10n 34 (Hello)\n'
      '#l10n 35 (Hello World)\n'
      '#l10n 36 (Hello two worlds)\n'
      '#l10n 37 (Hello)\n'
      '#l10n 38 (Hello new World)\n'
      '#l10n 39 (Hello two new worlds)\n'
      '#l10n 40 (Hello on Friday, January 1, 1960)\n'
      '#l10n 41 (Hello World, on Friday, January 1, 1960)\n'
      '#l10n 42 (Hello two worlds, on Friday, January 1, 1960)\n'
      '#l10n 43 (Hello other 0 worlds, with a total of 100 citizens)\n'
      '#l10n 44 (Hello World of 101 citizens)\n'
      '#l10n 45 (Hello two worlds with 102 total citizens)\n'
      '#l10n 46 ([Hello] -World- #123#)\n'
      '#l10n 47 (Flutter\'s amazing!)\n'
      '#l10n 48 (Flutter is "amazing"!)\n'
      '#l10n END\n'
    );
  });
}
