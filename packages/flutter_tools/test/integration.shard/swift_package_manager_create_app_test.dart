...
void main() {
  ...
  for (final String platformName in platforms) {
    ...
    for (final String iosLanguage in iosLanguages) {
      test('Create app with Swift Package Manager disabled', () async {
        final Directory workingDirectory = fileSystem.systemTempDirectory
            .createTempSync('swift_package_manager_create_disabled.');
      ...
      test('Create app with Swift Package Manager enabled', () async {
        final Directory workingDirectory = fileSystem.systemTempDirectory
