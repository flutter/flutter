...
void main() {
  test(
    'ensure that there can be two flutter modules in a single gradle project',
    () async {
      await inTempDir((Directory tempDirectory) async {
        ...
        final IOSink ioSink = projectDirectory.childFile('settings.gradle.kts').openWrite(mode: FileMode.append)
