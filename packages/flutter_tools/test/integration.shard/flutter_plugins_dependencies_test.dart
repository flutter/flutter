...
void main() {
  test('.flutter-plugins-dependencies correctly denotes project dev dependencies on all default platforms', () async {
    final Directory tempDir = createResolvedTempDirectorySync('flutter_plugins_dependencies_test.');
