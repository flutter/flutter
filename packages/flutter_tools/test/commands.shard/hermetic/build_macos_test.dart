...
final FakePlatform macosPlatformCustomEnv = FakePlatform(operatingSystem: 'macos', environment: <String, String>{
  'FLUTTER_ROOT': '/',
  'HOME': '/',
});
...
void main() {
  ...
  testUsingContext('macOS build fails on non-macOS platform', () async {
    ...
    expect(createTestCommandRunner(command).run(const <String>['build', 'macos', '--no-pub']),
  ...
  testUsingContext('build settings contains Flutter Xcode environment variables', () async {
    macosPlatformCustomEnv.environment = Map<String, String>.unmodifiable(
        <String, String>{'FLUTTER_XCODE_ASSETCATALOG_COMPILER_APPICON_NAME': 'AppIcon.special'});
  ...
  testUsingContext('macOS build supports build-name and build-number', () async {
    ...
    final String contents = fileSystem.file('./macos/Flutter/ephemeral/Flutter-Generated.xcconfig').readAsStringSync();
