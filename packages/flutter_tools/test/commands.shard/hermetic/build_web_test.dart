    ...
    overrides: <Type, Generator>{
      ...
      BuildSystem: () => TestBuildSystem.all(BuildResult(success: true), (
        ...
        expect(environment.defines, <String, String>{
          ...
          'BuildMode': 'release',
          'DartDefines':
              'Zm9vPWE=,RkxVVFRFUl9WRVJTSU9OPTAuMC4w,RkxVVFRFUl9DSEFOTkVMPW1hc3Rlcg==,RkxVVFRFUl9HSVRfVVJMPWh0dHBzOi8vZ2l0aHViLmNvbS9mbHV0dGVyL2ZsdXR0ZXIuZ2l0,RkxVVFRFUl9GUkFNRVdPUktfUkVWSVNJT049MTExMTE=,RkxVVFRFUl9FTkdJTkVfUkVWSVNJT049YWJjZGU=,RkxVVFRFUl9DT05URU5UX0hBU0g9MTIzNDU=,RkxVVFRFUl9EQVJUX1ZFUlNJT049MTI=',
