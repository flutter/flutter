...
''');
  ...
  testUsingContext(
    'Validate liquid glass icon still using the template',
    () async {
      const projectIconContentsJsonPath =
          'ios/Runner/Assets.xcassets/AppIcon.appiconset/Contents.json';
      const projectIconImagePath =
      ...
      const liquidGlassIconContentsJson = '''
{
  "fill" : {
    "automatic-gradient" : "display-p3:0.98656,1.00000,0.99250,1.00000"
  }
}
''';
      const liquidGlassIconSvg =
          '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 300 371.43"></svg>';
      final templateLiquidGlassIconDir =
          '${Cache.flutterRoot!}/packages/flutter_tools/templates/app/ios.tmpl/Runner/liquidGlassIcon.icon.tmpl';
      const projectLiquidGlassIconDir = 'ios/Runner/liquidGlassIcon.icon';
...
''');
            ...
            fileSystem.file('$templateLiquidGlassIconDir/icon.json')
              ..createSync(recursive: true)
              ..writeAsStringSync(liquidGlassIconContentsJson);
            fileSystem.file(
                '$templateLiquidGlassIconDir/Assets/icon_flutter.817b4a56b047d0d36b338dd9ffd44dbd.svg',
              )
              ..createSync(recursive: true)
              ..writeAsStringSync(liquidGlassIconSvg);

            fileSystem.file('$projectLiquidGlassIconDir/icon.json')
              ..createSync(recursive: true)
              ..writeAsStringSync(liquidGlassIconContentsJson);
            fileSystem.file(
                '$projectLiquidGlassIconDir/Assets/icon_flutter.817b4a56b047d0d36b338dd9ffd44dbd.svg',
              )
              ..createSync(recursive: true)
              ..writeAsStringSync(liquidGlassIconSvg);
            // Extra files generated by the OS or editor should not affect the
            // template detection.
            fileSystem.file('$projectLiquidGlassIconDir/.DS_Store')
              ..createSync(recursive: true)
              ..writeAsBytesSync(<int>[1, 2, 3]);
            fileSystem.file('$projectLiquidGlassIconDir/icon.json.bak')
              ..createSync(recursive: true)
  ...
  testUsingContext(
    'Validate liquid glass icon not using the template',
    () async {
      const projectIconContentsJsonPath =
          'ios/Runner/Assets.xcassets/AppIcon.appiconset/Contents.json';
      const projectIconImagePath =
      ...
      const templateLiquidGlassIconContentsJson = '''
{
  "fill" : {
    "automatic-gradient" : "display-p3:0.98656,1.00000,0.99250,1.00000"
  }
...
''';
      const templateLiquidGlassIconSvg =
          '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 300 371.43"></svg>';
      final templateLiquidGlassIconDir =
          '${Cache.flutterRoot!}/packages/flutter_tools/templates/app/ios.tmpl/Runner/liquidGlassIcon.icon.tmpl';
      const projectLiquidGlassIconDir = 'ios/Runner/liquidGlassIcon.icon';
...
''');
            ...
            fileSystem.file('$templateLiquidGlassIconDir/icon.json')
              ..createSync(recursive: true)
              ..writeAsStringSync(templateLiquidGlassIconContentsJson);
            fileSystem.file(
                '$templateLiquidGlassIconDir/Assets/icon_flutter.817b4a56b047d0d36b338dd9ffd44dbd.svg',
              )
              ..createSync(recursive: true)
              ..writeAsStringSync(templateLiquidGlassIconSvg);

            fileSystem.file('$projectLiquidGlassIconDir/icon.json')
              ..createSync(recursive: true)
              ..writeAsStringSync(
                '{\n  "fill" : {\n    "automatic-gradient" : "display-p3:0.00000,1.00000,0.99250,1.00000"\n  }\n}\n',
              );
            fileSystem.file(
                '$projectLiquidGlassIconDir/Assets/icon_flutter.817b4a56b047d0d36b338dd9ffd44dbd.svg',
              )
              ..createSync(recursive: true)
              ..writeAsStringSync('<svg xmlns="http://www.w3.org/2000/svg"></svg>');
          },
        ),
        exportArchiveCommand(exportOptionsPlist: _exportOptionsPlist),
      ]);
