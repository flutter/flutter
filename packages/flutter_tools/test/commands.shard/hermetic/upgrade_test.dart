...
void main() {
  ...
  testUsingContext('can push people from stable to beta', () async {
    final Completer<void> reEntryCompleter = Completer<void>();
    ...
    expect(logger.statusText,
      ...
      '\n'
      'As an experienced Flutter developer, you may be interested in moving from the "stable" channel to the "beta" channel. The Flutter "beta" channel enjoys all the same thorough testing as the "stable" channel, but is updated roughly once a month instead of once a quarter.\n'
      'To change channel, run the "flutter channel beta" command.\n'
    );
  }, overrides: <Type, Generator>{
    FileSystem: () => fileSystem,
    FlutterVersion: () => FakeFlutterVersion(channel: 'stable', frameworkVersion: startingTag, engineRevision: 'engine'),
    Logger: () => logger,
    ProcessManager: () => processManager,
  });
