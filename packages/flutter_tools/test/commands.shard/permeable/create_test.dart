...
1) 86f7e437faa5a7fce15d1ddcb9eaeaea377667b8 "iPhone Developer: Profile 1 (1111AAAA11)"
  ...
  testUsingContext('newly created iOS plugins has correct min iOS version',
      () async {
    Cache.flutterRoot = '../..';
  ...
  testUsingContext('default app uses flutter default versions', () async {
    ...
    expect(
        buildContent.contains('compileSdk = flutter.compileSdkVersion'), true);
  ...
  testUsingContext('Android Java plugin contains namespace', () async {
    ...
    expect(
        buildGradleContent
            .contains('namespace = "com.bar.foo.flutter_project"'),
        true);
  ...
  testUsingContext('Flutter module Android project contains namespace',
    ...
    const String expectedNameSpace =
        'namespace = "com.bar.foo.flutter_project"';
