...
class ThemeData with Diagnosticable {
  ...
  ThemeData _overrideWithSystemColors() {
    ...
    final bool overrideInputDecoration =
        systemColors.field.value != null ||
        systemColors.fieldText.value != null;
      ...
      theme = theme.copyWith(
        inputDecorationTheme: inputDecorationTheme.copyWith(
          ...
          hintStyle:
              ...
              TextStyle(color: systemColors.fieldText.value),
          helperStyle:
              inputDecorationTheme.helperStyle?.copyWith(
                color: systemColors.fieldText.value,
              ) ??
              TextStyle(color: systemColors.fieldText.value),
          prefixStyle:
              inputDecorationTheme.prefixStyle?.copyWith(
                color: systemColors.fieldText.value,
              ) ??
              TextStyle(color: systemColors.fieldText.value),
          suffixStyle:
              inputDecorationTheme.suffixStyle?.copyWith(
                color: systemColors.fieldText.value,
              ) ??
              TextStyle(color: systemColors.fieldText.value),
          counterStyle:
              inputDecorationTheme.counterStyle?.copyWith(
                color: systemColors.fieldText.value,
              ) ??
              TextStyle(color: systemColors.fieldText.value),
        ),
  ...
  static ThemeData lerp(ThemeData a, ThemeData b, double t) {
    ...
    return ThemeData.raw(
      ...
      primaryIconTheme: IconThemeData.lerp(
        a.primaryIconTheme,
        b.primaryIconTheme,
        t,
      ),
  ...
  void debugFillProperties(DiagnosticPropertiesBuilder properties) {
    ...
    properties.add(
      DiagnosticsProperty<CardThemeData>(
        'cardTheme',
        cardTheme,
        level: DiagnosticLevel.debug,
      ),
    ...
    properties.add(
      DiagnosticsProperty<ChipThemeData>(
        'chipTheme',
        chipTheme,
        level: DiagnosticLevel.debug,
      ),
...
class MaterialBasedCupertinoThemeData extends CupertinoThemeData {
  ...
  CupertinoThemeData resolveFrom(BuildContext context) {
    ...
    final NoDefaultCupertinoThemeData cupertinoOverrideThemeWithTextTheme =
