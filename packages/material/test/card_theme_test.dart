...
void main() {
  test('CardThemeData copyWith, ==, hashCode basics', () {
    ...
    expect(
      const CardThemeData().hashCode,
      const CardThemeData().copyWith().hashCode,
    );
  });
  ...
  testWidgets('Default CardThemeData debugFillProperties', (
    WidgetTester tester,
  ) async {
  ...
  testWidgets('CardThemeData implements debugFillProperties', (
    WidgetTester tester,
  ) async {
    final DiagnosticPropertiesBuilder builder = DiagnosticPropertiesBuilder();
    const CardThemeData(
    ...
    expect(
      description[1],
      'color: MaterialColor(primary value: ${const Color(0xffffc107)})',
    );
    expect(
      description[2],
      'shadowColor: MaterialColor(primary value: ${const Color(0xff4caf50)})',
    );
    expect(
      description[3],
  ...
  testWidgets('Card properties are taken over the theme values', (
    WidgetTester tester,
  ) async {
  ...
  testWidgets('Local CardTheme can override global CardTheme', (
    WidgetTester tester,
  ) async {
