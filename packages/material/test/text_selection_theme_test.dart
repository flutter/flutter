...
void main() {
  ...
  testWidgets('Default TextSelectionThemeData debugFillProperties', (
    WidgetTester tester,
  ) async {
  ...
  testWidgets('TextSelectionThemeData implements debugFillProperties', (
    WidgetTester tester,
  ) async {
    final DiagnosticPropertiesBuilder builder = DiagnosticPropertiesBuilder();
    const TextSelectionThemeData(
  ...
  testWidgets('Material2 - Empty textSelectionTheme will use defaults', (
    ...
    await tester.pumpAndSettle();
    final RenderBox handle = tester.firstRenderObject<RenderBox>(
  ...
  testWidgets('Material3 - Empty textSelectionTheme will use defaults', (
    ...
    final Color defaultSelectionColor = theme.colorScheme.primary.withOpacity(
      0.40,
    );
  ...
  testWidgets('ThemeData.textSelectionTheme will be used if provided', (
    WidgetTester tester,
  ) async {
    ...
    expect(
      handle,
      paints..path(color: textSelectionTheme.selectionHandleColor),
    );
  });
  ...
  testWidgets(
    ...
    (WidgetTester tester) async {
      ...
      expect(
        renderEditable.selectionColor,
        widgetTextSelectionTheme.selectionColor,
      );
  ...
  testWidgets('TextField parameters will override theme settings', (
    WidgetTester tester,
  ) async {
    const TextSelectionThemeData defaultTextSelectionTheme =
        TextSelectionThemeData(
    ...
    await tester.pumpAndSettle();
    final EditableTextState selectableTextState = tester.firstState(
      find.byType(EditableText),
    );
  ...
  testWidgets('TextSelectionThem overrides DefaultSelectionStyle', (
    WidgetTester tester,
  ) async {
    ...
    DefaultSelectionStyle style = DefaultSelectionStyle.of(
      defaultSelectionStyleContext,
    );
    expect(style.selectionColor, defaultSelectionColor);
    expect(style.cursorColor, defaultCursorColor);

    final BuildContext themeStyleContext = tester.element(
      find.byKey(themeStyle),
    );
