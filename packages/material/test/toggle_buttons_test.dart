...
void main() {
  ...
  testWidgets('onPressed that is null disables buttons', (
    WidgetTester tester,
  ) async {
    TextStyle buttonTextStyle(String text) {
      return tester
  ...
  testWidgets('Material2 - ToggleButtons text baseline alignment', (
    ...
    final double firstToggleButtonDy = tester
        .getBottomLeft(find.text('First child'))
        .dy;
    final double secondToggleButtonDy = tester
        .getBottomLeft(find.text('Second child'))
        .dy;
    final double elevatedButtonDy = tester
        .getBottomLeft(find.text('Elevated Button'))
        .dy;
  ...
  testWidgets('Properly draws borders based on state', (
    WidgetTester tester,
  ) async {
    final ThemeData theme = ThemeData();
    await tester.pumpWidget(
  ...
  testWidgets(
    ...
    (WidgetTester tester) async {
      ...
      final List<RenderObject> toggleButtonRenderObject = tester
          .allRenderObjects
          .where((RenderObject object) {
            return object.runtimeType.toString() ==
                '_SelectToggleButtonRenderObject';
  ...
  testWidgets('VerticalDirection test when direction is vertical.', (
    WidgetTester tester,
  ) async {
    await tester.pumpWidget(
      boilerplate(
