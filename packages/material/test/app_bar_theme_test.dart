...
void main() {
  ...
  test('AppBarTheme copyWith, ==, hashCode basics', () {
    ...
    expect(
      const AppBarTheme().hashCode,
      const AppBarTheme().copyWith().hashCode,
    );
  });
  ...
  testWidgets('Material2 - Passing no AppBarTheme returns defaults', (
    WidgetTester tester,
  ) async {
  ...
  testWidgets('Material3 - Passing no AppBarTheme returns defaults', (
    WidgetTester tester,
  ) async {
    ...
    expect(
      actionIconText.text.style!.color,
  ...
  testWidgets('AppBar uses values from AppBarTheme', (
    WidgetTester tester,
  ) async {
  ...
  testWidgets('AppBar widget properties take priority over theme', (
    WidgetTester tester,
  ) async {
    ...
    const IconThemeData actionsIconThemeData = IconThemeData(
  ...
  testWidgets('AppBar icon color takes priority over everything', (
    WidgetTester tester,
  ) async {
  ...
  testWidgets('AppBar.centerTitle takes priority over AppBarTheme.centerTitle', (
    ...
    await tester.pumpWidget(
      MaterialApp(
        theme: ThemeData(appBarTheme: const AppBarTheme(centerTitle: true)),
        home: Scaffold(
          appBar: AppBar(title: const Text('Title'), centerTitle: false),
        ),
      ),
    );
  ...
  testWidgets('AppBar.shadowColor takes priority over AppBarTheme.shadowColor', (
    ...
    await tester.pumpWidget(
      MaterialApp(
        theme: ThemeData(
          appBarTheme: const AppBarTheme(shadowColor: Colors.red),
        ),
        home: Scaffold(
          appBar: AppBar(
  ...
  testWidgets(
    ...
    (WidgetTester tester) async {
      const IconThemeData overallIconTheme = IconThemeData(
        color: Colors.yellow,
      );
      await tester.pumpWidget(
        MaterialApp(
      ...
      final Color? leadingIconButtonColor = _iconStyle(
        tester,
        Icons.menu,
      )?.color;
  ...
  testWidgets(
    ...
    (WidgetTester tester) async {
      ...
      final double? leadingIconButtonSize = _iconStyle(
        tester,
        Icons.menu,
      )?.fontSize;
      final double? actionIconButtonSize = _iconStyle(
        tester,
        Icons.add,
      )?.fontSize;
  ...
  testWidgets(
    ...
    (WidgetTester tester) async {
      const IconThemeData actionsIconTheme = IconThemeData(
        color: Colors.yellow,
      );
      ...
      expect(
        leadingIconButtonColor,
        Colors.red,
      ); // leading color should come from iconButtonTheme
  ...
  testWidgets('AppBar uses AppBarTheme.titleSpacing', (
    WidgetTester tester,
  ) async {
    ...
    (WidgetTester tester) async {
      ...
      await tester.pumpWidget(
        MaterialApp(
          ...
          home: Scaffold(
            appBar: AppBar(title: const Text('Title'), titleSpacing: 40),
          ),
        ),
      );
  ...
  testWidgets('AppBar uses AppBarTheme.leadingWidth', (
    WidgetTester tester,
  ) async {
    ...
    await tester.pumpWidget(
      MaterialApp(
        theme: ThemeData(
          appBarTheme: const AppBarTheme(leadingWidth: kLeadingWidth),
        ),
    ...
    final BoxConstraints leadingConstraints =
        (navToolBar.leading! as ConstrainedBox).constraints;
    expect(leadingConstraints.maxWidth, kLeadingWidth);
    expect(leadingConstraints.minWidth, kLeadingWidth);
  });

  testWidgets(
    'AppBar.leadingWidth takes priority over AppBarTheme.leadingWidth',
    (WidgetTester tester) async {
      const double kLeadingWidth = 80;
      await tester.pumpWidget(
        MaterialApp(
  ...
  testWidgets('SliverAppBar uses AppBarTheme.titleSpacing', (
    WidgetTester tester,
  ) async {
    const double kTitleSpacing = 10;
    await tester.pumpWidget(
    ...
    (WidgetTester tester) async {
      ...
      await tester.pumpWidget(
        MaterialApp(
          ...
          home: const CustomScrollView(
            slivers: <Widget>[
              SliverAppBar(title: Text('Title'), titleSpacing: 40),
            ],
          ),
        ),
      );
  ...
  testWidgets('SliverAppBar uses AppBarTheme.leadingWidth', (
    WidgetTester tester,
  ) async {
    const double kLeadingWidth = 80;
    await tester.pumpWidget(
  ...
  testWidgets(
    'SliverAppBar.leadingWidth takes priority over AppBarTheme.leadingWidth ',
    (WidgetTester tester) async {
      const double kLeadingWidth = 80;
      await tester.pumpWidget(
        MaterialApp(
          ...
          home: const CustomScrollView(
            slivers: <Widget>[
              SliverAppBar(leading: Icon(Icons.chevron_left), leadingWidth: 40),
            ],
          ),
        ),
      );
  ...
  testWidgets('SliverAppBar.medium uses AppBarTheme properties', (
    WidgetTester tester,
  ) async {
    ...
    expect(
      titleText.text.style!.fontSize,
      appBarTheme.titleTextStyle!.fontSize,
    );
    expect(
      titleText.text.style!.fontStyle,
      appBarTheme.titleTextStyle!.fontStyle,
    );
  ...
  testWidgets('SliverAppBar.large uses AppBarTheme properties', (
    WidgetTester tester,
  ) async {
  ...
  testWidgets('SliverAppBar medium & large supports foregroundColor', (
    WidgetTester tester,
  ) async {
    const String title = 'AppBar title';
    const AppBarTheme appBarTheme = AppBarTheme(
      foregroundColor: Color(0xff00ff20),
    );
  ...
  testWidgets('Default AppBarTheme debugFillProperties', (
    WidgetTester tester,
  ) async {
  ...
  testWidgets('AppBarTheme implements debugFillProperties', (
    WidgetTester tester,
  ) async {
    final DiagnosticPropertiesBuilder builder = DiagnosticPropertiesBuilder();
    const AppBarTheme(
...
IconTheme _getAppBarIconTheme(WidgetTester tester) {
  return tester.widget<IconTheme>(
    find
        .descendant(of: find.byType(AppBar), matching: find.byType(IconTheme))
        .first,
  );
}
