...
void main() {
  ...
  testWidgets('Large Badge textStyle and colors', (WidgetTester tester) async {
    ...
    final TextStyle textStyle = tester
        .renderObject<RenderParagraph>(find.text('0'))
        .text
        .style!;
  ...
  testWidgets('Large Badge alignment', (WidgetTester tester) async {
    ...
    expect(
      box,
      paints..rrect(rrect: RRect.fromLTRBR(0, 100, 16, 100 + 16, badgeRadius)),
    );
    ...
    expect(
      box,
      paints..rrect(rrect: RRect.fromLTRBR(0, 200, 16, 200 + 16, badgeRadius)),
    );
    ...
    expect(
      box,
      paints..rrect(
        rrect: RRect.fromLTRBR(100 - 8, 200, 100 + 8, 200 + 16, badgeRadius),
      ),
    );
    ...
    expect(
      box,
      paints..rrect(
        rrect: RRect.fromLTRBR(200 - 16, 0, 200, 16, badgeRadius).shift(offset),
      ),
    );
    ...
    expect(
      box,
      paints..rrect(
        rrect: RRect.fromLTRBR(0, 100, 16, 100 + 16, badgeRadius).shift(offset),
      ),
    );
    ...
    expect(
      box,
      paints..rrect(
        rrect: RRect.fromLTRBR(0, 200, 16, 200 + 16, badgeRadius).shift(offset),
      ),
    );
  ...
  testWidgets('Small Badge alignment', (WidgetTester tester) async {
    ...
    expect(
      box,
      paints..rrect(
        rrect: RRect.fromLTRBR(100 - 3, 200, 100 + 3, 200 + 6, badgeRadius),
      ),
    );
