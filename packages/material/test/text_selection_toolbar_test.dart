...
void main() {
  ...
  for (final ColorScheme colorScheme in <ColorScheme>[
    ...
    testWidgets('default background color', (WidgetTester tester) async {
      ...
      final Material toolbarContainer = tester.widget(
        findToolbarContainer().first,
      );
      expect(
    ...
    testWidgets('custom background color', (WidgetTester tester) async {
      ...
      await tester.pumpWidget(
        MaterialApp(
          theme: ThemeData(
            colorScheme: colorScheme.copyWith(surface: customBackgroundColor),
          ),
          home: Scaffold(
            body: Center(
              child: TextSelectionToolbar(
  ...
  testWidgets('Overflowed menu expands children horizontally', (
    ...
    final double overflowMenuWidth = tester
        .getRect(findToolbarContainer())
        .width;
