...
void main() {
  ...
  testWidgets('PaginatedDataTable custom row height', (
    ...
    expect(
      tester
          .renderObject<RenderBox>(find.widgetWithText(Container, 'Name').first)
          .size
          .height,
      56.0,
    ...
    await tester.pumpWidget(
      MaterialApp(
        home: Material(
          child: buildCustomHeightPaginatedTable(dataRowHeight: 30.0),
        ),
      ),
    );
    expect(
    ...
    await tester.pumpWidget(
      MaterialApp(
        home: Material(
          child: buildCustomHeightPaginatedTable(dataRowHeight: 56.0),
        ),
      ),
    );
    expect(
  ...
  testWidgets(
    ...
    (WidgetTester tester) async {
      ...
      checkbox = find.byType(Checkbox).first;
      padding = find
          .ancestor(of: checkbox, matching: find.byType(Padding))
          .first;
      expect(
        tester.getRect(checkbox).left - tester.getRect(padding).left,
  ...
  testWidgets('PaginatedDataTable arrowHeadColor set properly', (
    ...
    final Iterable<IconButton> icons = tester.widgetList(
  ...
  testWidgets('PaginatedDataTable custom heading row color', (
    ...
    expect(
      tableRowBoxDecoration.color,
      headingRowColor.resolve(<MaterialState>{}),
    );
  });

  testWidgets('PaginatedDataTable respects custom dividerThickness', (
    WidgetTester tester,
  ) async {
  ...
  testWidgets('PaginatedDataTable respects default dividerThickness', (
    WidgetTester tester,
  ) async {
