...
void main() {
  testWidgets('Material2 - FilterChip defaults', (WidgetTester tester) async {
    ...
    await tester.pumpWidget(
      MaterialApp(
        theme: theme,
        home: const Material(
          child: FilterChip(onSelected: null, label: Text(label)),
        ),
      ),
    );
  ...
  testWidgets('Material3 - FilterChip.elevated defaults', (
    ...
    await tester.pumpWidget(
      MaterialApp(
        theme: theme,
        home: const Material(
          child: FilterChip.elevated(onSelected: null, label: Text(label)),
        ),
      ),
    );
    await tester.pumpAndSettle();
  ...
  testWidgets('Customize FilterChip delete button', (
    ...
    await tester.pumpWidget(
      buildChip(deleteButtonTooltipMessage: 'Delete FilterChip'),
    );
    await tester.pumpAndSettle();
