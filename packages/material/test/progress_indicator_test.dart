...
void main() {
  ...
  testWidgets('CircularProgressIndicator.adaptive stroke width', (
    WidgetTester tester,
  ) async {
    ...
    expect(
      find.byType(CircularProgressIndicator),
      paints..arc(strokeWidth: 10.0),
    );

    await tester.pumpWidget(
      Theme(
        data: themeData,
        child: const CircularProgressIndicator.adaptive(strokeWidth: 16.0),
      ),
    );
  ...
  testWidgets('Material3 - Default size of CircularProgressIndicator', (
    WidgetTester tester,
  ) async {
    await tester.pumpWidget(
      const MaterialApp(
  ...
  testWidgets(
    'Material3 - Default size of CircularProgressIndicator when year2023 is false',
    (WidgetTester tester) async {
      await tester.pumpWidget(
        const MaterialApp(
          home: Scaffold(
            body: Material(child: CircularProgressIndicator(year2023: false)),
          ),
        ),
      );
  ...
  testWidgets(
    'LinearProgressIndicator default stop indicator when year2023 is false',
    (WidgetTester tester) async {
  ...
  testWidgets(
    'Can customise LinearProgressIndicator stop indicator when year2023 is false',
    (WidgetTester tester) async {
      ...
      await tester.pumpWidget(
        buildIndicator(stopIndicatorColor: const Color(0x00000000)),
      );
      expect(
        find.byType(LinearProgressIndicator),
        // Stop indicator.
  ...
  testWidgets(
    'Stop indicator size cannot be larger than the progress indicator',
    (WidgetTester tester) async {
      ...
      await tester.pumpWidget(
        buildIndicator(stopIndicatorRadius: 10.0, minHeight: 20.0),
      );
      expect(
        find.byType(LinearProgressIndicator),
        paints..circle(
      ...
      await tester.pumpWidget(
        buildIndicator(stopIndicatorRadius: 30.0, minHeight: 20.0),
      );
      expect(
        find.byType(LinearProgressIndicator),
  ...
  testWidgets(
    'LinearProgressIndicator default track gap when year2023 is false',
    (WidgetTester tester) async {
  ...
  testWidgets(
    'Can customise LinearProgressIndicator track gap when year2023 is false',
    (WidgetTester tester) async {
  ...
  testWidgets(
    'Default determinate CircularProgressIndicator when year2023 is false',
    (WidgetTester tester) async {
      ...
      await tester.pumpWidget(
        MaterialApp(
          theme: theme,
          home: const Center(
            child: CircularProgressIndicator(year2023: false, value: 0.5),
          ),
        ),
      );
      ...
      await expectLater(
        find.byType(CircularProgressIndicator),
        matchesGoldenFile(
          'circular_progress_indicator_determinate_year2023_false.png',
        ),
      );
    },
  );
  ...
  testWidgets(
    'Default indeterminate CircularProgressIndicator when year2023 is false',
    (WidgetTester tester) async {
      const EdgeInsetsGeometry padding = EdgeInsets.all(4.0);
      await tester.pumpWidget(
        MaterialApp(
      ...
      await expectLater(
        find.byType(CircularProgressIndicator),
        matchesGoldenFile(
          'circular_progress_indicator_indeterminate_year2023_false.png',
        ),
      );
    },
  );
  ...
  testWidgets(
    'CircularProgressIndicator track gap can be adjusted when year2023 is false',
    (WidgetTester tester) async {
      Widget buildIndicator({double? trackGap}) {
        return MaterialApp(
          home: Center(
      ...
      await expectLater(
        find.byType(CircularProgressIndicator),
        matchesGoldenFile(
          'circular_progress_indicator_default_track_gap_year2023_false.png',
        ),
      );
      ...
      await expectLater(
        find.byType(CircularProgressIndicator),
        matchesGoldenFile(
          'circular_progress_indicator_custom_track_gap_year2023_false.png',
        ),
      );
      ...
      await expectLater(
        find.byType(CircularProgressIndicator),
        matchesGoldenFile(
          'circular_progress_indicator_no_track_gap_year2023_false.png',
        ),
      );
    },
  );
  ...
  testWidgets(
    'Can override CircularProgressIndicator stroke cap when year2023 is false',
    (WidgetTester tester) async {
      ...
      await expectLater(
        find.byType(CircularProgressIndicator),
        matchesGoldenFile(
          'circular_progress_indicator_custom_stroke_cap_year2023_false.png',
        ),
      );
    },
  );
  ...
  testWidgets(
    'CircularProgressIndicator.constraints can override default size',
    (WidgetTester tester) async {
  ...
  testWidgets('CircularProgressIndicator padding can be customized', (
    WidgetTester tester,
  ) async {
