...
void main() {
  test('CarouselViewThemeData copyWith, ==, hashCode basics', () {
    expect(
      ...
      const CarouselViewThemeData().copyWith(),
    );
    expect(
  ...
  testWidgets('Default CarouselViewThemeData debugFillProperties', (
    WidgetTester tester,
  ) async {
  ...
  testWidgets('CarouselViewThemeData implements debugFillProperties', (
    WidgetTester tester,
  ) async {
    final DiagnosticPropertiesBuilder builder = DiagnosticPropertiesBuilder();
    const CarouselViewThemeData(
  ...
  testWidgets('Uses value from CarouselViewThemeData', (
    WidgetTester tester,
  ) async {
