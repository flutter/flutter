...
import '../../flutter/test/widgets/feedback_tester.dart';
import '../../flutter/test/widgets/semantics_tester.dart';
...
void main() {
  testWidgets('M3 Chip defaults', (WidgetTester tester) async {
    ...
    expect(
      labelStyle.leadingDistribution,
  ...
  testWidgets(
    ...
    (WidgetTester tester) async {
        ...
        return MaterialApp(
          home: Scaffold(
            body: SizedBox(
              ...
              child: Column(
                children: <Widget>[
                  Chip(avatar: avatar, label: Text(text), onDeleted: onDeleted),
                ],
              ),
            ),
          ),
      ...
      await tester.pumpWidget(
        chipBuilder(text, avatar: const CircleAvatar(child: Text('A'))),
      );
  ...
  testWidgets('Chip elements are ordered horizontally for locale', (
    ...
    await tester.pumpWidget(
      wrapForChip(child: test, textDirection: TextDirection.rtl),
    );
  ...
  testWidgets('Chip padding - LTR', (WidgetTester tester) async {
    ...
    expect(
      tester.getBottomRight(find.byType(Icon)),
      const Offset(457.0, 309.0),
    );
  });
  ...
  testWidgets('Material2 - Avatar drawer works as expected on RawChip', (
    ...
    expect(
      tester.getSize(find.byKey(avatarKey)),
    ...
    expect(
      tester.getTopLeft(find.byKey(labelKey)),
    ...
    expect(
      tester.getSize(find.byType(RawChip)).width,
    ...
    expect(
      tester.getTopLeft(find.byKey(avatarKey)).dx,
  ...
  testWidgets('Material2 - Delete button drawer works as expected on RawChip', (
    ...
    expect(
      tester.getSize(find.byKey(deleteButtonKey)),
      equals(const Size(24.0, 24.0)),
    );
    expect(
    ...
    expect(
      tester.getTopLeft(find.byKey(deleteButtonKey)).dx,
  ...
  testWidgets('Delete button takes up at most half of the chip', (
    ...
    await tester.tapAt(
      tester.getCenter(find.byKey(chipKey)) + const Offset(1.0, 0.0),
    );
    await tester.pump();
  ...
  testWidgets(
    ...
    (WidgetTester tester) async {
      ...
      final Offset centerOfDeleteButton = tester.getCenter(
  ...
  testWidgets(
    ...
    (WidgetTester tester) async {
      ...
      await expectLater(
        find.byType(RawChip),
        matchesGoldenFile(
          'chip.delete_button_tapped.disabled.ink_sparkle.0.png',
        ),
      );
      ...
      await expectLater(
        find.byType(RawChip),
        matchesGoldenFile(
          'chip.delete_button_tapped.disabled.ink_sparkle.1.png',
        ),
      );
  ...
  testWidgets('RTL delete button responds to tap on the left of the chip', (
    ...
    final Offset topLeftOfInkWell = tester.getTopLeft(
  ...
  testWidgets('Material2 - Chip without delete button creates correct ripple', (
    ...
    final Offset bottomRightOfInkWell = tester.getBottomRight(
      find.byType(InkWell),
    );
  ...
  testWidgets(
    'Material3 - Chip without delete button creates correct sparkle',
    (WidgetTester tester) async {
      // Creates a chip with a delete button.
      final UniqueKey labelKey = UniqueKey();

      await tester.pumpWidget(
        chipWithOptionalDeleteButton(labelKey: labelKey, deletable: false),
      );
  ...
  testWidgets(
    'Material2 - Selection with avatar works as expected on RawChip',
    (WidgetTester tester) async {
      bool selected = false;
      final UniqueKey labelKey = UniqueKey();
  ...
  testWidgets(
    'Material3 - Selection with avatar works as expected on RawChip',
    (WidgetTester tester) async {
      bool selected = false;
      final UniqueKey labelKey = UniqueKey();
      Future<void> pushChip({Widget? avatar, bool selectable = false}) async {
  ...
  testWidgets(
    ...
    (WidgetTester tester) async {
      ...
      expect(getSelectProgress(tester), moreOrLessEquals(0.002, epsilon: 0.01));
      expect(
        getAvatarDrawerProgress(tester),
      ...
      expect(
        getAvatarDrawerProgress(tester),
        moreOrLessEquals(0.92, epsilon: 0.01),
      );
      expect(getDeleteDrawerProgress(tester), equals(0.0));
      await tester.pump(const Duration(milliseconds: 100));
      expect(getSelectProgress(tester), equals(1.0));
      ...
      expect(
        getAvatarDrawerProgress(tester),
        moreOrLessEquals(0.96, epsilon: 0.01),
      );
      expect(getDeleteDrawerProgress(tester), equals(0.0));
      await tester.pump(const Duration(milliseconds: 20));
      expect(getSelectProgress(tester), moreOrLessEquals(0.13, epsilon: 0.01));
  ...
  testWidgets(
    ...
    (WidgetTester tester) async {
      ...
      expect(
        tester.getSize(find.byKey(key1)).width,
        moreOrLessEquals(90.4, epsilon: 0.1),
      );
      ...
      expect(
        tester.getSize(find.byKey(key2)).width,
        moreOrLessEquals(90.4, epsilon: 0.1),
      );
  ...
  testWidgets('Chip uses the right theme colors for the right components', (
    ...
    await tester.pumpWidget(
      buildApp(chipTheme: customTheme, isSelectable: false),
    );
    await tester.pumpAndSettle();
    materialBox = getMaterialBox(tester);
    labelStyle = getLabelStyle(tester, 'false');
  ...
  group('Chip semantics', () {
    ...
    testWidgets('tapEnabled explicitly false', (WidgetTester tester) async {
      ...
      await tester.pumpWidget(
        const MaterialApp(
          home: Material(
            child: RawChip(tapEnabled: false, label: Text('test')),
          ),
        ),
      );
  ...
  testWidgets(
    ...
    (WidgetTester tester) async {
      ...
      const BorderSide selectedBorderSide = BorderSide(
        color: Color(0x00000002),
      );
  ...
  testWidgets(
    'Triggering delete button tooltip does not trigger Chip tooltip',
    (WidgetTester tester) async {
      final UniqueKey deleteButtonKey = UniqueKey();
      await tester.pumpWidget(
        chipWithOptionalDeleteButton(
  ...
  testWidgets('Chip delete icon layout constraints can be customized', (
    ...
    Offset chipTopRight = tester.getTopRight(
      find.byWidget(getMaterial(tester)),
    );
    ...
    expect(
      labelTopRight.dx,
      deleteIconCenter.dx - (iconSize / 2) - labelPadding,
    );
  });
  ...
  group('Material 2', () {
    ...
    testWidgets('Chip uses the right theme colors for the right components', (
      ...
      expect(
        materialBox,
        paints..rrect(color: defaultChipTheme.backgroundColor),
      );
      expect(iconData.color, equals(const Color(0xde000000)));
      expect(labelStyle.style.color, equals(Colors.black.withAlpha(0xde)));
  ...
  testWidgets('ChipThemeData.iconTheme updates avatar and delete icons', (
    ...
    final RenderBox avatarIconBox = tester.renderObject(
      find.byIcon(avatarIcon),
    );
    final RenderBox deleteIconBox = tester.renderObject(
  ...
  testWidgets('RawChip.deleteIconColor overrides iconTheme color', (
    ...
    await tester.pumpWidget(
      buildChip(deleteIconColor: deleteIconColor, iconColor: iconColor),
    );
                  ...
                  return Column(
                    ...
                    children: <Widget>[
                      ...
                      ElevatedButton(
                        ...
                        child: Text(
                          '${showDeleteIcon ? 'Hide' : 'Show'} delete icon',
                        ),
                      ),
                    ],
                  );
  ...
  testWidgets('Chip.chipAnimationStyle is passed to RawChip', (
    ...
    expect(
      tester.widget<RawChip>(find.byType(RawChip)).chipAnimationStyle,
      chipAnimationStyle,
    );
  });
  ...
  testWidgets(
    'Chip does not glitch on hover when providing ThemeData.hoverColor',
    (WidgetTester tester) async {
  ...
  testWidgets('Mouse cursor resolves in disabled states', (
    WidgetTester tester,
  ) async {
    tester.binding.focusManager.highlightStrategy =
        FocusHighlightStrategy.alwaysTraditional;
  ...
  testWidgets(
    'Delete button semantic tap target complies with Material guideline',
    (WidgetTester tester) async {
  ...
  testWidgets(
    'Delete button semantic tap target is 32x32 on desktop',
    (WidgetTester tester) async {
      final SemanticsHandle handle = tester.ensureSemantics();
      final UniqueKey deleteKey = UniqueKey();
      await tester.pumpWidget(
          ...
          child: Column(
            children: <Widget>[
              Chip(
                label: const Text(
                  'Label',
                  style: TextStyle(fontSize: iconHeight),
                ),
                deleteIcon: Icon(
                  Icons.delete,
                  key: deleteKey,
