...
void main() {
  ...
  testWidgets('Default ElevatedButton icon alignment', (
    WidgetTester tester,
  ) async {
  ...
  testWidgets('ElevatedButton icon alignment can be customized', (
    WidgetTester tester,
  ) async {
    Widget buildWidget({
  ...
  testWidgets(
    'ElevatedButton icon alignment respects ButtonStyle.iconAlignment',
    (WidgetTester tester) async {
  ...
  testWidgets(
    'ElevatedButton icon uses provided foregroundColor over default icon color',
    (WidgetTester tester) async {
