...
void main() {
  ...
  testWidgets('SwitchThemeData implements debugFillProperties', (
    ...
    expect(
      description[0],
      'thumbColor: WidgetStatePropertyAll(${const Color(0xfffffff0)})',
    );
    expect(
      description[1],
      'trackColor: WidgetStatePropertyAll(${const Color(0xfffffff1)})',
    );
    expect(
      description[2],
      'trackOutlineColor: WidgetStatePropertyAll(${const Color(0xfffffff3)})',
    );
    ...
    expect(
      description[8],
      'thumbIcon: WidgetStatePropertyAll(Icon(IconData(U+0007B)))',
    );
    ...
    final ThemeData themeData = ThemeData(
      ...
      switchTheme: const SwitchThemeData(
        ...
        trackOutlineColor: MaterialStatePropertyAll<Color>(
          globalThemeOutlineColor,
        ),
        trackOutlineWidth: MaterialStatePropertyAll<double>(
          globalThemeOutlineWidth,
        ),
      ),
    );
    Widget buildSwitch({bool selected = false, bool autofocus = false}) {
        ...
        home: Scaffold(
          body: SwitchTheme(
            data: const SwitchThemeData(
              ...
              trackOutlineColor: MaterialStatePropertyAll<Color>(
                localThemeOutlineColor,
              ),
              trackOutlineWidth: MaterialStatePropertyAll<double>(
                localThemeOutlineWidth,
              ),
            ),
            child: Switch(
              value: selected,
