...
void main() {
  ...
  testWidgets('Drawer barrier is dismissible by default', (
    WidgetTester tester,
  ) async {
    await tester.pumpWidget(
      MaterialApp(
        ...
        home: Scaffold(
          appBar: AppBar(
            title: Semantics(
              headingLevel: 1,
              child: const Text('Drawer Dismissible'),
            ),
          ),
    ...
    final RenderBox modalBarrierRenderBox =
        tester.renderObject(modalBarrierFinder) as RenderBox;
    ...
    final Offset tapPosition = modalBarrierRenderBox.localToGlobal(
      modalBarrierCenter,
    );
  ...
  testWidgets('Drawer can be configured as not dismissible', (
    WidgetTester tester,
  ) async {
    await tester.pumpWidget(
      MaterialApp(
