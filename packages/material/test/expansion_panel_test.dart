...
void main() {
  testWidgets('ExpansionPanelList test', (WidgetTester tester) async {
    ...
    box = tester.renderObject(find.byType(ExpansionPanelList));
    expect(
      box.size.height - oldHeight,
      greaterThanOrEqualTo(100.0),
    ); // 100 + some margin
  });

  testWidgets(
    'Material2 - ExpansionPanelList does not merge header when canTapOnHeader is false',
    (WidgetTester tester) async {
      ...
      expect(
        ...
        matchesSemantics(label: 'head1', hasTapAction: true),
      );
  ...
  testWidgets(
    'Material3 - ExpansionPanelList does not merge header when canTapOnHeader is false',
    (WidgetTester tester) async {
      final SemanticsHandle handle = tester.ensureSemantics();
      final Key headerKey = UniqueKey();
      await tester.pumpWidget(
  ...
  testWidgets('Open/close animations', (WidgetTester tester) async {
    ...
    expect(
      ...
      const Rect.fromLTWH(
        0.0,
        48.0 + 1.0 + 48.0 + 16.0 + 16.0 + 48.0 + 16.0,
        800.0,
        100.0,
      ),
    );
  ...
  testWidgets('Radio mode has max of one panel open at a time', (
    WidgetTester tester,
  ) async {
    ...
    await tester.pumpWidget(
      MaterialApp(home: SingleChildScrollView(child: expansionListRadio)),
    );
    ...
    await tester.pumpWidget(
      MaterialApp(home: SingleChildScrollView(child: expansionList)),
    );
  ...
  testWidgets(
    ...
    (WidgetTester tester) async {
      ...
      final List<Map<String, dynamic>> callbackHistory =
          <Map<String, dynamic>>[];
      final ExpansionPanelList expansionListRadio = ExpansionPanelList.radio(
        expansionCallback: (int index, bool isExpanded) {
  ...
  testWidgets('No duplicate global keys at layout/build time', (
    WidgetTester tester,
  ) async {
  ...
  testWidgets(
    'Material2 - Panel header has semantics, canTapOnHeader = false',
    (WidgetTester tester) async {
      ...
      expect(
        ...
        matchesSemantics(label: 'Expanded'),
      );
      ...
      expect(
        ...
        matchesSemantics(label: 'Collapsed'),
      );
  ...
  testWidgets(
    'Material3 - Panel header has semantics, canTapOnHeader = false',
    (WidgetTester tester) async {
      const Key expandedKey = Key('expanded');
      const Key collapsedKey = Key('collapsed');
      const DefaultMaterialLocalizations localizations =
  ...
  testWidgets('Panel header has semantics, canTapOnHeader = true', (
    WidgetTester tester,
  ) async {
    const Key expandedKey = Key('expanded');
    const Key collapsedKey = Key('collapsed');
  ...
  testWidgets('Ensure canTapOnHeader is false by default', (
    WidgetTester tester,
  ) async {
  ...
  testWidgets(
    ...
    (WidgetTester tester) async {
      ...
      final RenderBox boxOfIconButton = tester.renderObject(
  ...
  testWidgets('ExpansionPanelList respects dividerColor', (
    WidgetTester tester,
  ) async {
  ...
  testWidgets('ExpansionPanelList.radio respects DividerColor', (
    WidgetTester tester,
  ) async {
    const Color dividerColor = Colors.red;
    await tester.pumpWidget(
  ...
  testWidgets('ExpansionPanelList respects expandIconColor', (
    WidgetTester tester,
  ) async {
  ...
  testWidgets('ExpansionPanelList.radio respects expandIconColor', (
    WidgetTester tester,
  ) async {
    const Color expandIconColor = Colors.blue;
    await tester.pumpWidget(
  ...
  testWidgets('elevation is propagated properly to MergeableMaterial', (
    WidgetTester tester,
  ) async {
  ...
  testWidgets('Using a value non defined value throws assertion error', (
    ...
    await tester.pumpWidget(
      const MaterialApp(
        home: SingleChildScrollView(
          child: SimpleExpansionPanelListTestWidget(elevation: 19),
        ),
      ),
    );
  ...
  testWidgets('ExpansionPanel.panelColor test', (WidgetTester tester) async {
    ...
    expect(
      (mergeableMaterial.children.first as MaterialSlice).color,
      firstPanelColor,
    );
    expect(
      (mergeableMaterial.children.last as MaterialSlice).color,
      secondPanelColor,
    );
  });

  testWidgets('ExpansionPanelRadio.backgroundColor test', (
    WidgetTester tester,
  ) async {
    const Color firstPanelColor = Colors.red;
    const Color secondPanelColor = Colors.brown;
  ...
  testWidgets('ExpansionPanelList.materialGapSize defaults to 16.0', (
    WidgetTester tester,
  ) async {
    await tester.pumpWidget(
      MaterialApp(
    ...
    final ExpansionPanelList expansionPanelList = tester.widget(
      find.byType(ExpansionPanelList),
    );
    expect(expansionPanelList.materialGapSize, 16);
  });

  testWidgets('ExpansionPanelList respects materialGapSize', (
    WidgetTester tester,
  ) async {
    ...
    await tester.pumpAndSettle();
    final MergeableMaterial mergeableMaterial2 = tester.widget(
      find.byType(MergeableMaterial),
    );
    ...
    await tester.pumpAndSettle();
    final MergeableMaterial mergeableMaterial3 = tester.widget(
      find.byType(MergeableMaterial),
    );
  ...
  testWidgets(
    ...
    (WidgetTester tester) async {
      ...
      final IconButton iconButton = tester.widget(
        find.byType(IconButton).first,
      );
  ...
  testWidgets(
    'ExpandIcon ignores pointer/tap events when canTapOnHeader is true',
    (WidgetTester tester) async {
      ...
      final IgnorePointer ignorePointerFalse = tester.widget(
        ignorePointerFinder,
      );
      ...
      final IgnorePointer ignorePointerTrue = tester.widget(
        ignorePointerFinder,
      );
