...
Widget buildDropdown({
  ...
  final List<DropdownMenuItem<String>>? listItems = items
...
void main() {
                  ...
                  return SafeArea(
                    child: Container(
                      ...
                      child: DropdownButton<int>(
                        ...
                        items: List<DropdownMenuItem<int>>.generate(100, (
                          int i,
                        ) {
            ...
            child: StatefulBuilder(
              builder: (BuildContext context, StateSetter setState) {
                return DropdownButton<double>(
                  ...
                  value: dropdownValue,
                  itemHeight: null,
                  items: itemHeights.map<DropdownMenuItem<double>>((
                    double value,
                  ) {
  ...
  testWidgets('DropdownButtonFormField can be hovered', (
    WidgetTester tester,
  ) async {
    tester.binding.focusManager.highlightStrategy =
        FocusHighlightStrategy.alwaysTraditional;
  ...
  testWidgets('DropdownButtonFormField has hover color', (
    WidgetTester tester,
  ) async {
    tester.binding.focusManager.highlightStrategy =
        FocusHighlightStrategy.alwaysTraditional;
  ...
  testWidgets('Selected element is focused when dropdown is opened', (
    ...
    expect(
      Focus.of(
        tester.element(find.byKey(const ValueKey<String>('one')).last),
      ).hasPrimaryFocus,
      isTrue,
    );
  ...
  testWidgets(
    ...
    (WidgetTester tester) async {
      ...
      expect(
        Focus.of(
          tester.element(find.byKey(const ValueKey<int>(1)).last),
        ).hasPrimaryFocus,
        isTrue,
      );
  ...
  testWidgets(
    ...
    (WidgetTester tester) async {
      ...
      expect(
        Focus.of(
          tester.element(find.byKey(const ValueKey<int>(91)).last),
        ).hasPrimaryFocus,
        isTrue,
      );
  ...
  testWidgets('DropdownButton onTap callback is called when defined', (
    ...
    Widget build() =>
        buildFrame(value: value, onChanged: onChanged, onTap: onTap);
    await tester.pumpWidget(build());
  ...
  testWidgets("specifying itemHeight affects popup menu items' height", (
    ...
    final List<DropdownMenuItem<String>> menuItems =
        <String>[value, 'Two', 'Free', 'Four'].map<DropdownMenuItem<String>>((
          String value,
        ) {
          return DropdownMenuItem<String>(value: value, child: Text(value));
        }).toList();
  ...
  testWidgets('Do not throw due to the double precision', (
    ...
    final List<DropdownMenuItem<String>> menuItems =
        <String>[value, 'Two', 'Free'].map<DropdownMenuItem<String>>((
          String value,
        ) {
          return DropdownMenuItem<String>(value: value, child: Text(value));
        }).toList();
  ...
  group('DropdownButtonFormField decoration hintText', () {
    ...
    testWidgets('does not override DropdownButtonFormField.hint', (
      WidgetTester tester,
    ) async {
      await tester.pumpWidget(
        buildFrame(
    ...
    testWidgets(
      'is the fallback value for DropdownButtonFormField.disabledHint',
      (WidgetTester tester) async {
    ...
    testWidgets(
      'is not used for disabledHint if DropdownButtonFormField.hint is provided',
      (WidgetTester tester) async {
        // The Dropdown is disabled because onChanged is not defined.
        await tester.pumpWidget(
          buildFrame(
        ...
        expect(find.text(hintText, skipOffstage: false), findsOne);
        expect(
          find.text(decorationHintText, skipOffstage: false),
          findsNothing,
        );
      },
    );
  ...
  testWidgets('BorderRadius property clips dropdown menu', (
    WidgetTester tester,
  ) async {
    const double radius = 20.0;
  ...
  testWidgets(
    ...
    (WidgetTester tester) async {
      ...
      final BoxDecoration decoration =
          selectedItemInk.decoration! as BoxDecoration;
