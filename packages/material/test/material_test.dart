...
import '../../flutter/test/widgets/multi_view_testing.dart';
import '../../flutter/test/widgets/test_border.dart' show TestBorder;
...
void main() {
  ...
  testWidgets('Shadow color defaults', (WidgetTester tester) async {
    ...
    await tester.pumpWidget(
      Theme(data: ThemeData(), child: buildWithShadow(null)),
    );
    await tester.pumpAndSettle();
    ...
    await tester.pumpWidget(
      Theme(data: ThemeData(), child: buildWithShadow(Colors.transparent)),
    );
    await tester.pumpAndSettle();
  ...
  testWidgets(
    'Material uses the dark SystemUIOverlayStyle when the background is light',
  ...
  testWidgets(
    'Material uses the light SystemUIOverlayStyle when the background is dark',
    (WidgetTester tester) async {
  ...
  group('Transparency clipping', () {
    testWidgets('No clip by default', (WidgetTester tester) async {
      ...
      final RenderClipPath renderClip = tester.allRenderObjects
          .whereType<RenderClipPath>()
          .first;
  ...
  testWidgets('$InkFeature dispatches memory events', (
    ...
    await tester.pumpWidget(
      const Material(child: SizedBox(width: 20, height: 20)),
    );
  ...
  testWidgets('Material is not visible from sub-views', (
    WidgetTester tester,
  ) async {
