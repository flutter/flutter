...
void main() {
  ...
  testWidgets('Material3 - TextButton repsects Theme shadowColor', (
    WidgetTester tester,
  ) async {
    const ColorScheme colorScheme = ColorScheme.light();
          ...
          body: Center(
            child: TextButtonTheme(
              data: TextButtonThemeData(
                style: TextButton.styleFrom(shadowColor: themeShadowColor),
              ),
              child: Builder(
                builder: (BuildContext context) {
                  return TextButton(
    ...
    await tester.pumpWidget(
      buildFrame(
        overallShadowColor: overriddenColor,
        themeShadowColor: shadowColor,
      ),
    );
    await tester.pumpAndSettle(); // theme animation
    material = tester.widget<Material>(buttonMaterialFinder);
  ...
  testWidgets('Material2 - TextButton repsects Theme shadowColor', (
    WidgetTester tester,
  ) async {
    const ColorScheme colorScheme = ColorScheme.light();
    const Color shadowColor = Color(0xff000001);
  ...
  testWidgets(
    'TextButton.icon respects TextButtonTheme ButtonStyle.iconAlignment',
    (WidgetTester tester) async {
