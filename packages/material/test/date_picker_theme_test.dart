...
void main() {
  const DatePickerThemeData datePickerTheme = DatePickerThemeData(
    ...
    yearShape: MaterialStatePropertyAll<OutlinedBorder>(
      RoundedRectangleBorder(),
    ),
    ...
    rangeSelectionOverlayColor: MaterialStatePropertyAll<Color>(
      Color(0xffffff3f),
    ),
  ...
  testWidgets(
    ...
    (WidgetTester tester) async {
        ...
        datePickerTheme.dayShape
            ...
            .copyWith(
              side: datePickerTheme.todayBorder?.copyWith(
                color: datePickerTheme.todayForegroundColor?.resolve(
                  <MaterialState>{},
                ),
              ),
            ),
      ...
      expect(
        january2023.style?.fontSize,
        datePickerTheme.toggleButtonTextStyle?.fontSize,
      );
      expect(
        january2023.style?.color,
      ...
      expect(
        inkFeatures,
        paints..circle(
          color: datePickerTheme.dayOverlayColor?.resolve(<MaterialState>{}),
        ),
      );
      ...
      final ShapeDecoration year2022Decoration = findTextDecoration(
        tester,
        '2022',
      )!;
      ...
      expect(
        year2022Decoration.shape,
        datePickerTheme.yearShape?.resolve(<MaterialState>{}),
      );

      final Text year2023 = tester.widget<Text>(
        find.text('2023'),
      ); // DatePickerDialog.currentDate
      final ShapeDecoration year2023Decoration = findTextDecoration(
        tester,
        '2023',
      )!;
      ...
      expect(
        roundedRectangleBorder.side.width,
      ...
      expect(
        inkFeatures,
        paints..rect(
          color: datePickerTheme.yearOverlayColor?.resolve(<MaterialState>{}),
        ),
      );
  ...
  testWidgets('DateRangePickerDialog uses ThemeData datePicker theme', (
    ...
    expect(
      inkFeatures,
      paints..circle(
        color: datePickerTheme.rangeSelectionOverlayColor?.resolve(
          <MaterialState>{},
        ),
      ),
    );
  ...
  testWidgets('DatePicker uses ThemeData.inputDecorationTheme properties '
    ...
    InputDecoration inputDecoration = tester
        .widget<TextField>(find.byType(TextField))
        .decoration!;
    expect(
      inputDecoration.fillColor,
    ...
    (WidgetTester tester) async {
      ...
      expect(
        ...
        paints
          ...
          ..circle(
            color: dayOverlayColor.resolve(<MaterialState>{
              MaterialState.hovered,
            }),
          ),
      );
  ...
  testWidgets(
    ...
    (WidgetTester tester) async {
      ...
      expect(
        inkFeatures,
        paints..rect(
          color: yearOverlayColor.resolve(<MaterialState>{
            MaterialState.hovered,
          }),
        ),
      );
  ...
  testWidgets(
    ...
    (WidgetTester tester) async {
      ...
      expect(
        inkFeatures,
        paints..circle(
          color: rangeSelectionOverlayColor.resolve(<MaterialState>{
            MaterialState.hovered,
          }),
        ),
      );
  ...
  testWidgets(
    'YearPicker maintains default year shape at textScaleFactor 1, 1.5, 2',
    (WidgetTester tester) async {
  ...
  testWidgets(
    'YearPicker applies shape from DatePickerThemeData.yearShape correctly',
    (WidgetTester tester) async {
      ...
      final OutlinedBorder year2022roundedRectangleBorder =
          year2022Decoration.shape as CircleBorder;
      ...
      final ShapeDecoration year2025Decoration = findTextDecoration(
        tester,
        '2025',
      )!;
      final OutlinedBorder year2022RoundedRectangleBorder =
          year2025Decoration.shape as CircleBorder;
      expect(
        year2022RoundedRectangleBorder.side.width,
        datePickerTheme.todayBorder?.width,
      );
      expect(
  ...
  testWidgets(
    'Toggle button uses DatePickerTheme.toggleButtonTextStyle.color when it is defined',
    (WidgetTester tester) async {
