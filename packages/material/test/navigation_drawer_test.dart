...
void main() {
  ...
  testWidgets('NavigationDestinationDrawer background color is customizable', (
    ...
    final BoxDecoration destinationDecoration =
        tester.firstWidget<Ink>(findDestinationInk('Alarm')).decoration!
            as BoxDecoration;
  ...
  testWidgets(
    ...
    (WidgetTester tester) async {
      ...
      expect(
        _labelStyle(tester, 'AC')?.color,
        theme.colorScheme.onSecondaryContainer,
      );
      expect(
        _labelStyle(tester, 'Alarm')?.color,
        theme.colorScheme.onSurfaceVariant,
      );
  ...
  testWidgets(
    ...
    (WidgetTester tester) async {
      ...
      scaffoldKey.currentState?.openDrawer();
      await tester.pump();
      final NavigationDrawer drawer = tester.widget(
