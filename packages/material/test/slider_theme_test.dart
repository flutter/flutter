...
void main() {
  test('SliderThemeData copyWith, ==, hashCode basics', () {
    ...
    expect(
      const SliderThemeData().hashCode,
  ...
  testWidgets('Slider defaults', (WidgetTester tester) async {
    ...
    final Color secondaryActiveTrackColor = colorScheme.primary.withOpacity(
      0.54,
    );
    final Color disabledActiveTrackColor = colorScheme.onSurface.withOpacity(
      0.38,
    );
    final Color disabledInactiveTrackColor = colorScheme.onSurface.withOpacity(
      0.12,
    );
    final Color disabledSecondaryActiveTrackColor = colorScheme.onSurface
        .withOpacity(0.12);
    ...
    final Color inactiveTickMarkColor = colorScheme.onSurfaceVariant
        .withOpacity(0.38);
    final Color disabledActiveTickMarkColor = colorScheme.onSurface.withOpacity(
      0.38,
    );
  ...
  testWidgets('Slider uses the right theme colors for the right components', (
    ...
    try {
      ...
      final RenderBox valueIndicatorBox = tester.renderObject(
        find.byType(Overlay),
      );
      ...
      expect(
        material,
        isNot(
          paints..rrect(color: sliderTheme.disabledSecondaryActiveTrackColor),
        ),
      );
      expect(
        material,
  ...
  testWidgets(
    ...
    (WidgetTester tester) async {
      ...
      final SliderThemeData sliderTheme = SliderThemeData.fromPrimaryColors(
        ...
        valueIndicatorTextStyle: ThemeData.fallback().textTheme.bodyLarge!
      ...
      expect(
        ...
        equals(customColor3.withAlpha(0x8a)),
      );
      expect(
  ...
  testWidgets(
    'SliderThemeData generates correct shapes for fromPrimaryColors',
    (WidgetTester tester) async {
      const Color customColor1 = Color(0xcafefeed);
      const Color customColor2 = Color(0xdeadbeef);
      const Color customColor3 = Color(0xdecaface);
  ...
  testWidgets('SliderThemeData lerps correctly', (WidgetTester tester) async {
    ...
    final SliderThemeData lerp = SliderThemeData.lerp(
      sliderThemeBlack,
      sliderThemeWhite,
      0.5,
    );
    ...
    expect(
      lerp.secondaryActiveTrackColor,
      isSameColorAs(middleGrey.withAlpha(0x8a)),
    );
    expect(
      lerp.disabledActiveTrackColor,
      isSameColorAs(middleGrey.withAlpha(0x52)),
    );
    expect(
      lerp.disabledInactiveTrackColor,
      isSameColorAs(middleGrey.withAlpha(0x1f)),
    );
    expect(
      lerp.disabledSecondaryActiveTrackColor,
      isSameColorAs(middleGrey.withAlpha(0x1f)),
    );
    expect(lerp.activeTickMarkColor, isSameColorAs(middleGrey.withAlpha(0x8a)));
    expect(
      lerp.inactiveTickMarkColor,
      isSameColorAs(middleGrey.withAlpha(0x8a)),
    );
    expect(
      lerp.disabledActiveTickMarkColor,
      isSameColorAs(middleGrey.withAlpha(0x1f)),
    );
    expect(
      lerp.disabledInactiveTickMarkColor,
      isSameColorAs(middleGrey.withAlpha(0x1f)),
    );
    ...
    expect(
      lerp.valueIndicatorStrokeColor,
      isSameColorAs(middleGrey.withAlpha(0xff)),
    );
    expect(
      lerp.valueIndicatorTextStyle!.color,
      isSameColorAs(middleGrey.withAlpha(0xff)),
    );
  });
  ...
  testWidgets('Default slider ticker and thumb shape draw correctly', (
    ...
    expect(
      material,
      paints..circle(color: sliderTheme.thumbColor, radius: 10.0),
    );

    await tester.pumpWidget(
      _buildApp(sliderTheme, value: 0.45, enabled: false),
    );
    await tester.pumpAndSettle(); // wait for disable animation
  ...
  testWidgets('The slider track height can be overridden', (
    ...
    await tester.pumpWidget(
      _buildApp(sliderTheme, value: 0.25, enabled: false),
    );
    await tester.pumpAndSettle(); // wait for disable animation
  ...
  testWidgets(
    ...
    (WidgetTester tester) async {
      ...
      expect(
        material,
        paints
          ..circle(x: 212, y: 300, radius: 9, color: sliderTheme.thumbColor),
      );
  ...
  group('RoundedRectSliderTrackShape', () {
    testWidgets(
      ...
      (WidgetTester tester) async {
        ...
        MaterialInkController material = Material.of(
          tester.element(find.byType(Slider)),
        );
        expect(
          material,
  ...
  testWidgets(
    'SliderThemeData.padding can override the default Slider padding',
    (WidgetTester tester) async {
      ...
      RenderBox sliderRenderBox() {
        return tester.allRenderObjects.firstWhere(
              (RenderObject object) =>
                  object.runtimeType.toString() == '_RenderSlider',
            )
            as RenderBox;
      }
      ...
      expect(
        sliderRenderBox().size,
        const Size(800 - startPadding - endPadding, 20),
      );
      expect(
        find.byType(Slider),
        paints
  ...
  testWidgets(
    'SliderThemeData.padding can override the default RangeSlider padding',
    (WidgetTester tester) async {
      ...
      RenderBox sliderRenderBox() {
        return tester.allRenderObjects.firstWhere(
              (RenderObject object) =>
                  object.runtimeType.toString() == '_RenderRangeSlider',
            )
            as RenderBox;
      }
  ...
  testWidgets('Can customize Slider track gap when year2023 is false', (
    WidgetTester tester,
  ) async {
  ...
  testWidgets('Can customize Slider thumb size when year2023 is false', (
    ...
    await tester.pumpWidget(
      buildSlider(
        thumbSize: const WidgetStateProperty<Size?>.fromMap(
  ...
  testWidgets('Can customize RangeSlider thumbs size when year2023 is false', (
    ...
    await tester.pumpWidget(
      buildRangeSlider(
        thumbSize: const WidgetStatePropertyAll<Size>(Size(20, 20)),
      ),
    );
  ...
  testWidgets('Slider.year2023 overrides SliderThemeData.year2023', (
    WidgetTester tester,
  ) async {
    final ThemeData theme = ThemeData(
      sliderTheme: const SliderThemeData(year2023: false),
  ...
  group('Material 2', () {
    ...
    testWidgets('Slider defaults', (WidgetTester tester) async {
      ...
      final Color disabledInactiveTrackColor = colorScheme.onSurface
          .withOpacity(0.12);
      final Color disabledSecondaryActiveTrackColor = colorScheme.onSurface
          .withOpacity(0.12);
      final Color shadowColor = colorScheme.shadow;
      ...
      final Color disabledActiveTickMarkColor = colorScheme.onPrimary
          .withOpacity(0.12);
      final Color disabledInactiveTickMarkColor = colorScheme.onSurface
          .withOpacity(0.12);
      ...
      try {
        ...
        expect(
          material,
          isNot(paints..rrect(color: disabledInactiveTrackColor)),
        );
        expect(
          material,
          isNot(paints..rrect(color: disabledSecondaryActiveTrackColor)),
        ...
        expect(
          material,
          isNot(paints..rrect(color: secondaryActiveTrackColor)),
        );
