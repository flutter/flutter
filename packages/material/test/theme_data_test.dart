...
void main() {
    ...
    () {
      ...
      expect(
        ...
        skip: !SystemColor
            .light
            .accentColor
            .isSupported, // Color not always supported.
      ...
      expect(
        ...
        skip: !SystemColor
            ...
            .isSupported, // Color not always supported.
        reason:
            'Theme onSecondary color did not match system accent color text',
      );
      expect(
      ...
      expect(
        ...
        skip: !SystemColor
            ...
            .isSupported, // Color not always supported.
        reason:
            'TextTheme headlineMedium color did not match system text color',
      );
      expect(
      ...
      expect(
        ...
        skip: !SystemColor
            ...
            .isSupported, // Color not always supported.
        reason:
            'ElevatedButtonTheme foregroundColor did not match system button text color',
      );
      expect(
        ...
        skip: !SystemColor
            ...
            .isSupported, // Color not always supported.
        reason:
            'ElevatedButtonTheme backgroundColor did not match system button face color',
      );
      ...
      expect(
        ...
        skip: !SystemColor
            ...
            .isSupported, // Color not always supported.
        reason:
            'TextButtonTheme foregroundColor did not match system button text color',
      );
      expect(
        theme.textButtonTheme.style?.backgroundColor?.resolve(<WidgetState>{
          WidgetState.pressed,
        }),
        SystemColor.light.buttonFace.value,
        skip: !SystemColor
            ...
            .isSupported, // Color not always supported.
        reason:
            'TextButtonTheme backgroundColor did not match system button face color',
      );
      ...
      expect(
        ...
        skip: !SystemColor
            ...
            .isSupported, // Color not always supported.
        reason:
            'OutlinedButtonTheme foregroundColor did not match system button text color',
      );
      expect(
        ...
        skip: !SystemColor
            ...
            .isSupported, // Color not always supported.
        reason:
            'OutlinedButtonTheme backgroundColor did not match system button face color',
      );
      ...
      expect(
        ...
        skip: !SystemColor
            ...
            .isSupported, // Color not always supported.
        reason:
            'FilledButtonTheme foregroundColor did not match system button text color',
      );
      expect(
        ...
        skip: !SystemColor
            ...
            .isSupported, // Color not always supported.
        reason:
            'FilledButtonTheme backgroundColor did not match system button face color',
      );
      ...
      expect(
        ...
        skip: !SystemColor
            ...
            .isSupported, // Color not always supported.
        reason:
            'FloatingActionButtonTheme foregroundColor did not match system button text color',
      );
      expect(
        ...
        skip: !SystemColor
            ...
            .isSupported, // Color not always supported.
        reason:
            'FloatingActionButtonTheme backgroundColor did not match system button face color',
      );
    },
  ...
  test(
    ...
    () {
      ...
      expect(
        ...
        skip:
            !SystemColor.dark.canvas.isSupported, // Color not always supported.
        reason: 'Theme surface color did not match system canvas color',
      );
      expect(
        theme.colorScheme.onSurface,
  ...
  testWidgets('Ensure Visual Density effective constraints are clamped', (
    ...
    contracted = const VisualDensity(
      horizontal: -4.0,
      vertical: -4.0,
    ).effectiveConstraints(small);
  ...
  group('Theme extensions', () {
    ...
    testWidgets('can lerp', (WidgetTester tester) async {
      ...
      expect(
        ...
        isSameColorAs(const Color(0xff7f7f7f)),
      );
      expect(
        lerped.extension<MyThemeExtensionA>()!.color2,
        isSameColorAs(const Color(0xff90ab7d)),
      );
      expect(
  ...
  group('Theme adaptationMap', () {
    ...
    testWidgets('can be obtained', (WidgetTester tester) async {
      ...
      final String adaptiveString = theme.getAdaptation<String>()!.adapt(
        theme,
        'Default theme',
      );
