...
void main() {
  ...
  testWidgets(
    ...
    (WidgetTester tester) async {
      ...
      final Offset widget1InitialTopLeft = tester.getTopLeft(
        find.text('Page 1'),
      );
  ...
  testWidgets(
    ...
    (WidgetTester tester) async {
      ...
      TransformLayer widget1Scale = findForwardScaleTransition(
        find.text('Page 1'),
      );
      TransformLayer widget2Scale = findForwardScaleTransition(
        find.text('Page 2'),
      );
      OpacityLayer widget2Opacity = findForwardFadeTransition(
        find.text('Page 2'),
      );
  ...
  testWidgets(
    ...
    (WidgetTester tester) async {
      ...
      await expectLater(
        find.byKey(key),
        matchesGoldenFile('m2_zoom_page_transition.big.png'),
      );
    },
    variant: TargetPlatformVariant.only(TargetPlatform.android),
  ...
  testWidgets(
    ...
    (WidgetTester tester) async {
      ...
      await expectLater(
        find.byKey(key),
        matchesGoldenFile('m3_zoom_page_transition.big.png'),
      );
    },
    variant: TargetPlatformVariant.only(TargetPlatform.android),
    skip: kIsWeb, // [intended] rasterization is not used on the web.
  ...
  testWidgets(
    ...
    (WidgetTester tester) async {
      await tester.pumpWidget(
        const MaterialApp(home: Material(child: Text('Page 1'))),
      );
  ...
  testWidgets('back gesture while OS changes', (WidgetTester tester) async {
    ...
    expect(
      Theme.of(tester.element(find.text('HELLO'))).platform,
      TargetPlatform.iOS,
    );
    await tester.pumpWidget(
      MaterialApp(
  ...
  testWidgets(
    ...
    (WidgetTester tester) async {
      await tester.pumpWidget(
        const MaterialApp(home: Scaffold(body: Text('Page 1'))),
      );
  ...
  testWidgets(
    ...
    (WidgetTester tester) async {
      ...
      expect(
        tester.getTopLeft(
          find.ancestor(of: find.text('push'), matching: find.byType(Scaffold)),
        ),
        Offset.zero,
      );
  ...
  testWidgets(
    ...
    (WidgetTester tester) async {
      ...
      final Offset titleTransientTopLeft = tester.getTopLeft(
        find.text('Title'),
      );
