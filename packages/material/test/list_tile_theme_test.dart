...
void main() {
  test('ListTileThemeData copyWith, ==, hashCode, basics', () {
    ...
    expect(
      const ListTileThemeData().hashCode,
  ...
  testWidgets(
    ...
    (WidgetTester tester) async {
      ...
      expect(
        leading.text.style!.fontSize,
        leadingAndTrailingTextStyle.fontSize,
      );
      expect(leading.text.style!.color, leadingAndTrailingTextStyle.color);
      expect(
        leading.text.style!.fontStyle,
        leadingAndTrailingTextStyle.fontStyle,
      );
  ...
  testWidgets(
    ...
    (WidgetTester tester) async {
      ...
      expect(
        ...
        paints..rect(color: theme.selectedTileColor),
      );
    },
  );
  ...
  testWidgets('ListTileThemeData copyWith overrides all properties', (
    ...
    expect(
      copy.leadingAndTrailingTextStyle,
  ...
  testWidgets('ListTileTheme.merge supports all properties', (
    ...
    await tester.pumpWidget(buildFrame());
    final ListTileThemeData theme = ListTileTheme.of(
    ...
    expect(
      theme.leadingAndTrailingTextStyle,
      const TextStyle(color: Color(0x0000000E)),
    );
    ...
    Widget buildFrame({bool? isThreeLine}) {
      return MaterialApp(
        ...
        theme: isThreeLine != null
            ? ThemeData(
                listTileTheme: ListTileThemeData(isThreeLine: isThreeLine),
              )
            : null,
        home: Material(
          child: ListView(
