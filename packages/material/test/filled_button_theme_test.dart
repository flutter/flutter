...
void main() {
  ...
  testWidgets('FilledButton repsects Theme shadowColor', (
    WidgetTester tester,
  ) async {
    const ColorScheme colorScheme = ColorScheme.light();
  ...
  testWidgets(
    'FilledButton.icon respects FilledButtonTheme ButtonStyle.iconAlignment',
    (WidgetTester tester) async {
  ...
  testWidgets(
    'Filled tonal button icon respects FilledButtonTheme ButtonStyle.iconAlignment',
    (WidgetTester tester) async {
      Widget buildButton({IconAlignment? iconAlignment}) {
        return MaterialApp(
          theme: ThemeData(
