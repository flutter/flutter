...
void main() {
  testWidgets('Can nest apps', (WidgetTester tester) async {
    await tester.pumpWidget(
      const MaterialApp(home: MaterialApp(home: Text('Home sweet home'))),
    );
  ...
  testWidgets('Can show grid without losing sync', (WidgetTester tester) async {
    ...
    await tester.pumpWidget(
      const MaterialApp(debugShowMaterialGrid: true, home: StateMarker()),
    );
  ...
  testWidgets('Initial route with missing step', (WidgetTester tester) async {
    ...
    await tester.pumpWidget(
      MaterialApp(initialRoute: '/a/b/c', routes: routes),
    );
  ...
  testWidgets('MaterialApp.navigatorKey', (WidgetTester tester) async {
    ...
    await tester.pumpWidget(
      const MaterialApp(color: Color(0xFF112233), home: Placeholder()),
    );
  ...
  testWidgets('MaterialApp.navigatorKey can be updated', (
    ...
    await tester.pumpWidget(
      MaterialApp(navigatorKey: key1, home: const Placeholder()),
    );
    expect(key1.currentState, isA<NavigatorState>());
    final GlobalKey<NavigatorState> key2 = GlobalKey<NavigatorState>();
    await tester.pumpWidget(
      MaterialApp(navigatorKey: key2, home: const Placeholder()),
    );
  ...
  testWidgets(
    ...
    (WidgetTester tester) async {
      ...
      RenderClipRect renderClip = tester.allRenderObjects
          .whereType<RenderClipRect>()
          .first;
  ...
  testWidgets('Override theme animation using AnimationStyle', (
    ...
    ); // Advance animation by 50 milliseconds.
    ...
    await tester.pumpWidget(
      buildWidget(animationStyle: AnimationStyle.noAnimation),
    );
    await tester.pump();
  ...
  testWidgets(
    'AnimationStyle.noAnimation removes AnimatedTheme from the tree',
    (WidgetTester tester) async {
      await tester.pumpWidget(
        const MaterialApp(themeAnimationStyle: AnimationStyle()),
      );
      ...
      await tester.pumpWidget(
        const MaterialApp(themeAnimationStyle: AnimationStyle.noAnimation),
      );
  ...
  testWidgets('MaterialApp works in an unconstrained environment', (
    ...
    await tester.pumpWidget(
      const UnconstrainedBox(
        child: MaterialApp(home: SizedBox(width: 123, height: 456)),
      ),
    );
