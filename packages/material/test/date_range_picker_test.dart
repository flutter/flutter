...
void main() {
  ...
  testWidgets('Default layout (calendar mode)', (WidgetTester tester) async {
    await preparePicker(tester, (Future<DateTimeRange?> range) async {
      ...
      final Offset saveButtonBottomLeft = tester.getBottomLeft(
      ...
      final Offset firstDateHeaderTopLeft = tester.getTopLeft(
        firstDateHeaderText,
      );
      final Offset lastDateHeaderTopLeft = tester.getTopLeft(
        lastDateHeaderText,
      );
      expect(firstDateHeaderTopLeft.dx, 72.0);
      expect(firstDateHeaderTopLeft.dy, helpTextBottomLeft.dy + 8.0);
      final Offset firstDateHeaderTopRight = tester.getTopRight(
        firstDateHeaderText,
      );
      ...
      final Offset dayHeadersGridTopLeft = tester.getTopLeft(
        find.byType(GridView).first,
      );
      final Offset firstDateHeaderBottomLeft = tester.getBottomLeft(
        firstDateHeaderText,
      );
      ...
      final Offset calendarScrollViewTopLeft = tester.getTopLeft(
        find.byType(CustomScrollView),
      );
      final Offset dayHeadersGridBottomLeft = tester.getBottomLeft(
        find.byType(GridView).first,
      );
  ...
  group('Landscape input-only date picker headers use headlineSmall', () {
    ...
    testWidgets('portrait', (WidgetTester tester) async {
      ...
      expect(
        tester.widget<Text>(find.text('Jan 15 – Jan 25, 2016')).style?.fontSize,
        32,
      );
  ...
  testWidgets(
    'Can select a range even if the range includes non selectable days',
    (WidgetTester tester) async {
      await preparePicker(tester, (Future<DateTimeRange?> range) async {
        await tester.tap(find.text('12').first);
        await tester.tap(find.text('14').first);
  ...
  testWidgets('Cannot select a day inside bounds but not selectable', (
    WidgetTester tester,
  ) async {
    initialDateRange = DateTimeRange(
      start: DateTime(2017, DateTime.january, 13),
  ...
  testWidgets(
    'Selectable date becoming non selectable when selected start day',
    (WidgetTester tester) async {
      await preparePicker(
        tester,
        (Future<DateTimeRange?> range) async {
        ...
        selectableDayPredicate:
            (DateTime day, DateTime? selectedStart, DateTime? selectedEnd) {
  ...
  testWidgets(
    'selectableDayPredicate should be called with the selected start and end dates',
    (WidgetTester tester) async {
      initialDateRange = DateTimeRange(
        start: DateTime(2017, DateTime.january, 13),
        end: DateTime(2017, DateTime.january, 15),
  ...
  group('Input mode', () {
    ...
    testWidgets('InputDecorationTheme is honored', (WidgetTester tester) async {
      ...
      testInputDecorator(
        tester.widget(borderContainers.first),
        border,
        Colors.transparent,
      );
      ...
      testInputDecorator(
        tester.widget(borderContainers.last),
        border,
        Colors.transparent,
      );
    });
    ...
    testWidgets(
      'Text field stays visible when orientation is portrait and height is reduced',
      (WidgetTester tester) async {
        addTearDown(tester.view.reset);
        ...
        await preparePicker(tester, useMaterial3: true, (
          Future<DateTimeRange?> range,
        ) async {
          expect(find.byType(TextField), findsNWidgets(2));
  ...
  group('showDateRangePicker avoids overlapping display features', () {
    testWidgets('positioning with anchorPoint', (WidgetTester tester) async {
      ...
      expect(
        tester.getTopLeft(find.byType(DateRangePickerDialog)),
        const Offset(410.0, 0.0),
      );
      expect(
        tester.getBottomRight(find.byType(DateRangePickerDialog)),
  ...
  for (final TextInputType? keyboardType in <TextInputType?>[
    ...
    testWidgets('DateRangePicker takes keyboardType $keyboardType', (
      ...
      final DateRangePickerDialog picker = tester.widget(
  ...
  testWidgets('honors switchToInputEntryModeIcon', (WidgetTester tester) async {
    ...
    await tester.pumpWidget(
      buildApp(switchToInputEntryModeIcon: const Icon(Icons.keyboard)),
    );
    await tester.pumpAndSettle();
    await tester.tap(find.byType(ElevatedButton));
    await tester.pumpAndSettle();
  ...
  testWidgets('honors switchToCalendarEntryModeIcon', (
    ...
    await tester.pumpWidget(
      buildApp(switchToCalendarEntryModeIcon: const Icon(Icons.favorite)),
    );
    await tester.pumpAndSettle();
    await tester.tap(find.byType(ElevatedButton));
    await tester.pumpAndSettle();
  ...
  testWidgets('DateRangePicker close button shape should be square', (
    WidgetTester tester,
  ) async {
    await preparePicker(tester, (Future<DateTimeRange?> range) async {
      final ThemeData theme = ThemeData();
  ...
  group('Calendar Delegate', () {
    testWidgets('Defaults to Gregorian calendar system', (
      WidgetTester tester,
    ) async {
      await tester.pumpWidget(
        MaterialApp(
      ...
      final DateRangePickerDialog dialog = tester.widget(
        find.byType(DateRangePickerDialog),
      );
      expect(dialog.calendarDelegate, isA<GregorianCalendarDelegate>());
    });

    testWidgets('Using custom calendar delegate implementation', (
      WidgetTester tester,
    ) async {
      await tester.pumpWidget(
        MaterialApp(
    ...
    testWidgets(
      'showDateRangePicker uses gregorian calendar delegate by default',
      (WidgetTester tester) async {
        await preparePicker(tester, (Future<DateTimeRange?> range) async {
          final Finder helpText = find.text('Select range');
          final Finder firstDateHeaderText = find.text('Jan 15');
    ...
    testWidgets(
      'showDateRangePicker using custom calendar delegate implementation',
      (WidgetTester tester) async {
        await preparePicker(
          tester,
          (Future<DateTimeRange?> range) async {
    ...
    testWidgets('Displays calendar based on the calendar delegate', (
      WidgetTester tester,
    ) async {
      Finder getMonthItem() {
