...
void main() {
  ...
  testWidgets('TimePickerThemeData implements debugFillProperties', (
    ...
    const TimePickerThemeData(
      ...
      timeSelectorSeparatorColor: WidgetStatePropertyAll<Color>(
        Color(0xfffffff4),
      ),
  ...
  testWidgets('Material3 - Passing no TimePickerThemeData uses defaults', (
    ...
    expect(
      ...
      paints
        ..circle(
          color: defaultTheme.colorScheme.surfaceContainerHighest,
        ) // Dial background color.
        ..circle(
  ...
  testWidgets(
    ...
    (WidgetTester tester) async {
      ...
      final InputDecoration hourDecoration = _textField(
        tester,
        '7',
      ).decoration!;
      ...
      expect(
        ...
        OutlineInputBorder(
          borderSide: BorderSide(
            color: defaultTheme.colorScheme.error,
            width: 2,
          ),
        ),
      );
      ...
      final ButtonStyle cancelButtonStyle = _actionButtonStyle(
        tester,
        'CANCEL',
      );
      expect(
  ...
  testWidgets(
    ...
    (WidgetTester tester) async {
      final TimePickerThemeData timePickerTheme = _timePickerTheme().copyWith(
        timeSelectorSeparatorColor: const MaterialStatePropertyAll<Color>(
          Color(0xff00ff00),
        ),
      );
      final ThemeData theme = ThemeData(timePickerTheme: timePickerTheme);
  ...
  testWidgets('Time picker hour minute does not resize on error', (
    WidgetTester tester,
  ) async {
    final TimePickerThemeData timePickerTheme = _timePickerTheme(
      includeInputDecoration: true,
