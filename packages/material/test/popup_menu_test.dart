...
void main() {
  ...
  testWidgets('PopupMenu positioning', (WidgetTester tester) async {
    ...
    bool popupMenu(Widget widget) =>
        widget.runtimeType.toString() == '_PopupMenu<int?>';
  ...
  testWidgets('PopupMenuItem child height is a minimum, child is vertically centered', (
    ...
    final Type menuItemType = const PopupMenuItem<String>(
      child: Text('item'),
    ).runtimeType;
      ...
      final ConstrainedBox widget = tester.widget<ConstrainedBox>(
        find.ancestor(
          ...
          matching: find.byWidgetPredicate(
            (Widget widget) =>
                widget is ConstrainedBox && widget.child is Padding,
          ),
        ),
      );
  ...
  testWidgets(
    ...
    (WidgetTester tester) async {
      final Key popupMenuButtonKey = UniqueKey();
      final Type menuItemType = const CheckedPopupMenuItem<String>(
        child: Text('item'),
      ).runtimeType;
            ...
            body: PopupMenuButton<int>(
              ...
              itemBuilder: (BuildContext context) =>
                  Iterable<PopupMenuItem<int>>.generate(
                    20,
                    (int i) =>
                        PopupMenuItem<int>(value: i, child: Text('Item $i')),
                  ).toList(),
            ),
          ),
        ),
  ...
  testWidgets(
    ...
    (WidgetTester tester) async {
      ...
      expect(
        _labelStyle(tester, 'Item 1')!.fontWeight,
        customTextStyle.fontWeight,
      );
      expect(
        _labelStyle(tester, 'Item 1')!.fontStyle,
  ...
  testWidgets('Material3 - PopupMenuItem overrides ListTile.titleTextStyle', (
    ...
    expect(
      _labelStyle(tester, 'Item 0')!.fontWeight,
      customTextStyle.fontWeight,
    );
  ...
  testWidgets('Material2 - PopupMenuItem overrides ListTile.titleTextStyle', (
    ...
    expect(
      _labelStyle(tester, 'Item 0')!.color,
    ...
    expect(
      _labelStyle(tester, 'Item 1')!.color,
      theme.textTheme.titleMedium!.color,
    );
  ...
  testWidgets('CheckedPopupMenuItem.onTap callback is called when defined', (
    ...
    await tester.pumpAndSettle();
    await tester.tap(
      find.widgetWithText(CheckedPopupMenuItem<String>, 'Item without onTap'),
    );
    await tester.pumpAndSettle();
    expect(count, 1);
  });
  ...
  testWidgets(
    'PopupMenuButton uses root navigator if useRootNavigator is true',
    (WidgetTester tester) async {
      final MenuObserver rootObserver = MenuObserver();
      final MenuObserver nestedObserver = MenuObserver();
  ...
  testWidgets('Override Popup Menu animation using AnimationStyle', (
    ...
    await tester.pumpWidget(
      buildPopupMenu(
        animationStyle: const AnimationStyle(duration: Duration.zero),
      ),
    );
    ...
    ); // Advance the animation by 1 millisecond.
  ...
  testWidgets(
    'PopupMenuButton scrolls initial value/selected value to visible',
    (WidgetTester tester) async {
      const int length = 50;
      ...
      expect(
        initialItemBounds.bottomRight.dy,
      ...
      expect(
        selectedItemBounds.bottomRight.dy,
        lessThanOrEqualTo(windowSize.height),
      );
    },
  );
  ...
  testWidgets('PopupMenuButton properly positions a constrained-size popup', (
    ...
    final RenderBox listViewport = tester.renderObject<RenderBox>(
      findListViewport,
    );
    ...
    expect(
      listViewportBounds.bottomRight.dy,
      lessThanOrEqualTo(windowSize.height),
    );
  ...
  testWidgets('PopupMenuButton respects materialTapTargetSize', (
    WidgetTester tester,
  ) async {
    ...
    await tester.pumpWidget(
      buildPopupMenu(tapTargetSize: MaterialTapTargetSize.padded),
    );
    await tester.pumpAndSettle();
    ...
    await tester.pumpWidget(
      buildPopupMenu(tapTargetSize: MaterialTapTargetSize.shrinkWrap),
    );
    await tester.pumpAndSettle();
  ...
  testWidgets('PopupMenuDivider custom indent', (WidgetTester tester) async {
    ...
    final EdgeInsetsDirectional margin =
        container.margin! as EdgeInsetsDirectional;
  ...
  testWidgets('PopupMenuDivider custom end indent', (
    WidgetTester tester,
  ) async {
    await tester.pumpWidget(
      MaterialApp(
