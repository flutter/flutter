...
void main() {
  ...
  testWidgets('Material3 - ExpandIcon disabled', (WidgetTester tester) async {
    ...
    // Test light mode.
    await tester.pumpWidget(
      wrap(theme: theme, child: const ExpandIcon(onPressed: null)),
    );
    await tester.pumpAndSettle();
  ...
  testWidgets(
    ...
    (WidgetTester tester) async {
      ...
      final RotationTransition rotation = tester.firstWidget(
  ...
  testWidgets('Material2 - ExpandIcon has correct semantic hints', (
    WidgetTester tester,
  ) async {
  ...
  testWidgets('Material3 - ExpandIcon has correct semantic hints', (
    WidgetTester tester,
  ) async {
    final SemanticsHandle handle = tester.ensureSemantics();
    const DefaultMaterialLocalizations localizations =
    ...
    await tester.pumpWidget(
      wrap(child: ExpandIcon(isExpanded: true, onPressed: (bool _) {})),
    );
  ...
  testWidgets('ExpandIcon uses custom disabled icon color', (
    ...
    await tester.pumpWidget(
      wrap(
        child: const ExpandIcon(onPressed: null, disabledColor: Colors.cyan),
      ),
    );
    await tester.pumpAndSettle();
    iconTheme = tester.firstWidget(find.byType(IconTheme).last);
