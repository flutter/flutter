...
void main() {
  ...
  group('Ink well overlayColor resolution respects WidgetState.selected', () {
    ...
    testWidgets('when focused', (WidgetTester tester) async {
      ...
      expect(
        inkFeatures,
        paints..rect(rect: inkRect, color: selectedFocusedColor),
      );
    });
    ...
    testWidgets('when hovered', (WidgetTester tester) async {
      ...
      expect(
        inkFeatures,
        paints..rect(rect: inkRect, color: selectedHoveredColor),
      );
    });
    ...
    testWidgets('when pressed', (WidgetTester tester) async {
      ...
      expect(
        inkFeatures,
        paints..rect(rect: inkRect, color: selectedPressedColor.withAlpha(0)),
      );
      await tester.pumpAndSettle(); // Let the press highlight animation finish.
      expect(
        inkFeatures,
        paints..rect(rect: inkRect, color: selectedPressedColor),
      );
      await gesture.up();
    });
  });
