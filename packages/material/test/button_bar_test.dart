  ...
  group('alignment', () {
    ...
    testWidgets('ButtonBarTheme.alignment overrides default', (
      ...
      expect(
        tester.getRect(child).left,
        395.0,
      ); // (bar width - padding) / 2 - 10 / 2
      expect(
        tester.getRect(child).right,
        405.0,
      ); // (bar width - padding) / 2 - 10 / 2 + 10
    });
  ...
  group('button properties override ButtonTheme', () {
    testWidgets('default button properties override ButtonTheme properties', (
      ...
      expect(
        ...
        equals(ButtonBarLayoutBehavior.padded),
      );
    });
  ...
  group("ButtonBar's children wrap when they overflow horizontally", () {
    ...
    testWidgets(
      ...
      (WidgetTester tester) async {
        ...
        expect(
          containerTwoRect.bottom,
          lessThanOrEqualTo(containerOneRect.top),
        );
      },
    );
