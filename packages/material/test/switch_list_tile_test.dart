...
void main() {
  ...
  testWidgets('SwitchListTile respects thumbIcon - M3', (
    ...
    expect(
      switchWidget0.thumbIcon?.resolve(<MaterialState>{MaterialState.selected}),
      activeIcon,
    );
    expect(
      Material.of(tester.element(find.byType(Switch))),
    ...
    expect(
      switchWidget2.thumbIcon?.resolve(<MaterialState>{MaterialState.selected}),
      activeIcon,
    );
    expect(
      Material.of(tester.element(find.byType(Switch))),
  ...
  testWidgets('SwitchListTile uses ListTileTheme controlAffinity', (
    WidgetTester tester,
  ) async {
  ...
  testWidgets('SwitchListTile.adaptive isThreeLine', (
    WidgetTester tester,
  ) async {
    const double height = 300;
    const double switchTop = 130.0;
  ...
  testWidgets('Material3 - SwitchListTile activeThumbColor', (
    WidgetTester tester,
  ) async {
    await tester.pumpWidget(
      Directionality(
  ...
  testWidgets('Material3 - SwitchListTile.adaptive activeThumbColor', (
    WidgetTester tester,
  ) async {
    await tester.pumpWidget(
      Directionality(
