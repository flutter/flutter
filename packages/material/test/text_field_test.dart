...
void main() {
  ...
  testWidgets(
    'infinite multi-line text hint text is not ellipsized by default',
    (WidgetTester tester) async {
  ...
  testWidgets(
    ...
    (WidgetTester tester) async {
      ...
      final TestGesture endHandleGesture = await tester.startGesture(
        endHandlePos,
        pointer: 7,
      );
      await tester.pump();
  ...
  testWidgets('Icon is separated from input/label by 16+12', (
    ...
    expect(
      iconRight + 16.0 + 16.0,
      equals(tester.getTopLeft(find.text('label')).dx),
    );
    expect(
      iconRight + 16.0 + 16.0,
  ...
  testWidgets('Can scroll multiline input when disabled', (
    ...
    // Now the first line is scrolled up, and the fourth line is visible.
    final Offset finalFirstPos = textOffsetToPosition(
      tester,
      kMoreThanFourLines.indexOf('First'),
    );
  ...
  testWidgets('Disabled TextField statesController', (
    ...
    await tester.pumpWidget(
      MaterialApp(
        home: Material(
          child: Center(
            child: TextField(statesController: controller, enabled: false),
          ),
        ),
      ),
    );
  ...
  testWidgets('currentValueLength/maxValueLength are in the tree', (
    ...
    await tester.pumpWidget(
      MaterialApp(
        home: Material(
          child: Center(
            child: TextField(controller: controller, maxLength: 10),
          ),
        ),
      ),
    );
  ...
  testWidgets(
    ...
    (WidgetTester tester) async {
      ...
      const Color expectedSelectionHandleColor = Color.fromARGB(
        255,
        10,
        200,
        255,
    ...
    (WidgetTester tester) async {
      ...
      await tester.pumpWidget(
        MaterialApp(
          home: Material(
            child: Center(
              child: TextField(controller: controller, maxLines: 2),
            ),
          ),
        ),
      );
  ...
  testWidgets(
    'iOS selectWordEdge works correctly',
    (WidgetTester tester) async {
      final TextEditingController controller = _textEditingController(
        text: 'blah1 blah2',
      );
  ...
  testWidgets('Can double tap + drag to select word by word', (
    WidgetTester tester,
  ) async {
    final TextEditingController controller = _textEditingController();
  ...
  group('Triple tap/click', () {
    ...
    testWidgets(
      ...
      (WidgetTester tester) async {
        ...
        final Offset firstLinePos = textOffsetToPosition(tester, 5);
        final double lineHeight = findRenderEditable(
          tester,
        ).preferredLineHeight;
  ...
  testWidgets(
    ...
    (WidgetTester tester) async {
      ...
      final TestGesture gesture = await tester.startGesture(
        tester.getBottomLeft(find.byKey(key1)),
      );
      await tester.pump();
  ...
  testWidgets(
    ...
    (WidgetTester tester) async {
      ...
      final TestGesture gesture = await tester.startGesture(
        textOffsetToPosition(tester, 18),
      );
      await tester.pump(const Duration(milliseconds: 500));
  ...
  testWidgets(
    ...
    (WidgetTester tester) async {
      ...
      List<TextSelectionPoint> lastCharEndpoint = renderEditable
      ...
      final List<TextSelectionPoint> firstCharEndpoint = renderEditable
          .getEndpointsForSelection(
            const TextSelection.collapsed(
              offset: 0,
  ...
  testWidgets(
    ...
    (WidgetTester tester) async {
      ...
      final TestGesture gesture = await tester.startGesture(
        textfieldStart + const Offset(300, 5),
      );
      await tester.pump(const Duration(milliseconds: 500));
    ...
    (WidgetTester tester) async {
      ...
      await tester.pumpWidget(
        MaterialApp(
          home: Material(
            child: Center(
              child: TextField(maxLines: 2, controller: controller),
            ),
          ),
        ),
      );
  ...
  testWidgets('Mouse tap does not show handles nor toolbar', (
    WidgetTester tester,
  ) async {
    final TextEditingController controller = _textEditingController(
      text: 'abc def ghi',
  ...
  testWidgets('Mouse double tap does not show handles nor toolbar', (
    WidgetTester tester,
  ) async {
    final TextEditingController controller = _textEditingController(
      text: 'abc def ghi',
        ...
        await tester.pumpWidget(
          ...
          View(
            ...
            child: MaterialApp(
              home: Material(
                child: TextField(
                  controller: _textEditingController(text: 'one two three'),
                ),
              ),
            ),
          ),
  ...
  group('magnifier', () {
    ...
    testWidgets(
      ...
      (WidgetTester tester) async {
        ...
        final Offset initialPosition = textOffsetToPosition(
          tester,
          testValue.indexOf('e'),
        );
        ...
        await gesture.moveTo(
          textOffsetToPosition(tester, 16) + const Offset(0.0, 50.0),
        );
        await tester.pumpAndSettle();
        expect(controller.selection.isCollapsed, false);
        expect(controller.selection.baseOffset, 0);
        ...
        await gesture.moveTo(
          textOffsetToPosition(tester, 20) + const Offset(0.0, 50.0),
        );
        await tester.pumpAndSettle();
        expect(controller.selection.isCollapsed, false);
        expect(controller.selection.baseOffset, 0);
  ...
  testWidgets(
    ...
    (WidgetTester tester) async {
      ...
      await tester.pumpWidget(
        MaterialApp(
          home: Material(
            child: TextField(obscureText: true, controller: controller),
          ),
        ),
      );
  ...
  testWidgets(
    'when enabled listens to onFocus events and gains focus',
    (WidgetTester tester) async {
      final SemanticsTester semantics = SemanticsTester(tester);
      final SemanticsOwner semanticsOwner =
          tester.binding.pipelineOwner.semanticsOwner!;
  ...
  testWidgets('hintLocales is passed to EditableText', (
    WidgetTester tester,
  ) async {
