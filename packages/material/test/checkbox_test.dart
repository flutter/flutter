...
void main() {
  ...
  testWidgets('Checkbox stops hover animation when removed from the tree.', (
    ...
    final TestGesture testGesture = await tester.createGesture(
      kind: PointerDeviceKind.mouse,
    );
  ...
  testWidgets(
    ...
    (WidgetTester tester) async {
      ...
      await gesture.addPointer(
        location: tester.getCenter(find.byType(CupertinoCheckbox)),
      );
      await tester.pump();
      ...
      await tester.pumpWidget(
        buildApp(mouseCursor: const _SelectedGrabMouseCursor()),
      );
      expect(
        RendererBinding.instance.mouseTracker.debugDeviceActiveCursor(1),
        SystemMouseCursors.grab,
  ...
  testWidgets('Material2 - Checkbox respects fillColor when it is unchecked', (
    ...
    expect(
      getCheckboxRenderer(),
      paints..drrect(color: theme.unselectedWidgetColor),
    );
  ...
  testWidgets('Material3 - Checkbox respects fillColor when it is unchecked', (
    ...
    expect(
      getCheckboxRenderer(),
      paints..drrect(color: theme.colorScheme.onSurfaceVariant),
    );
    expect(getCheckboxRenderer(), paints..path(color: inactiveBackgroundColor));
