...
void main() {
  ...
  testWidgets('Material3 - Light theme SnackBar has dark background', (
    ...
    final Finder material = find
        .widgetWithText(Material, 'I am a snack bar.')
        .first;
  ...
  group('SnackBar position', () {
    ...
    testWidgets(
      ...
      (WidgetTester tester) async {
        Future<void> pumpApp({
          required FloatingActionButtonLocation fabLocation,
        }) async {
          return tester.pumpWidget(
            MaterialApp(
              home: Scaffold(
    ...
    testWidgets(
      ...
      (WidgetTester tester) async {
        ...
        const List<FloatingActionButtonLocation>
        nonTopLocations = <FloatingActionButtonLocation>[
    ...
    testWidgets(
      ...
      (WidgetTester tester) async {
        ...
        final double spaceAboveSnackBar = tester
            .getTopLeft(find.byType(SnackBar))
            .dy;
    ...
    testWidgets(
      ...
      (WidgetTester tester) async {
        ...
        await tester.pumpWidget(
          const MaterialApp(
            home: Scaffold(bottomNavigationBar: SizedBox(height: 1000)),
          ),
        );
  ...
  testWidgets('Action text button uses correct overlay color', (
    ...
    final ButtonStyle? actionButtonStyle = tester
        ...
        .style;
    expect(
      actionButtonStyle?.overlayColor?.resolve(<MaterialState>{
