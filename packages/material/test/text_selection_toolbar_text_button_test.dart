...
void main() {
  ...
  testWidgets('position in the toolbar changes width', (
    ...
    final Size middleSize = tester.getSize(
    ...
    await tester.pump();
    final Size firstSize = tester.getSize(
      find.byType(TextSelectionToolbarTextButton),
    );
    ...
    await tester.pump();
    final Size lastSize = tester.getSize(
      find.byType(TextSelectionToolbarTextButton),
    );
    ...
    await tester.pump();
    final Size onlySize = tester.getSize(
      find.byType(TextSelectionToolbarTextButton),
    );
  ...
  for (final ColorScheme colorScheme in <ColorScheme>[
    ...
    testWidgets('custom foreground color', (WidgetTester tester) async {
      ...
      await tester.pumpWidget(
        MaterialApp(
          theme: ThemeData(
            colorScheme: colorScheme.copyWith(onSurface: customForegroundColor),
          ),
          home: Scaffold(
            body: Center(
              child: TextSelectionToolbarTextButton(
