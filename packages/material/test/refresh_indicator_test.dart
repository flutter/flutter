...
void main() {
      ...
      MaterialApp(
        home: RefreshIndicator(
          ...
          child: ListView(
            ...
            children: <String>['A', 'B', 'C', 'D', 'E', 'F'].map<Widget>((
              String item,
            ) {
  ...
  testWidgets('RefreshIndicator - reverse - position', (
    WidgetTester tester,
  ) async {
    refreshCalled = false;
    await tester.pumpWidget(
  ...
  testWidgets('RefreshIndicator - drag back not far enough to cancel', (
    WidgetTester tester,
  ) async {
    refreshCalled = false;
    await tester.pumpWidget(
    ...
    await tester.sendEventToBinding(
      testPointer.move(startLocation + const Offset(0.0, 175)),
    );
    await tester.pump();
    await tester.sendEventToBinding(
      testPointer.move(startLocation + const Offset(0.0, 150)),
    );
    await tester.pump();
  ...
  testWidgets('RefreshIndicator - drag back far enough to cancel', (
    WidgetTester tester,
  ) async {
    refreshCalled = false;
    await tester.pumpWidget(
    ...
    await tester.pump();
    await tester.sendEventToBinding(
      testPointer.move(startLocation + const Offset(0.0, 149)),
    );
    await tester.pump();
    await tester.sendEventToBinding(testPointer.up());
    await tester.pump();
  ...
  testWidgets('RefreshIndicator does not force child to relayout', (
    WidgetTester tester,
  ) async {
    int layoutCount = 0;
  ...
  testWidgets('RefreshIndicator responds to strokeWidth', (
    WidgetTester tester,
  ) async {
    await tester.pumpWidget(
      MaterialApp(
  ...
  testWidgets('RefreshIndicator responds to edgeOffset', (
    WidgetTester tester,
  ) async {
    await tester.pumpWidget(
      MaterialApp(
  ...
  testWidgets('RefreshIndicator appears at edgeOffset', (
    WidgetTester tester,
  ) async {
    await tester.pumpWidget(
      MaterialApp(
    ...
    await tester.fling(
      ...
      const Offset(0.0, 2.0 * kToolbarHeight),
      1000.0,
    );
  ...
  testWidgets('RefreshIndicator.color can be updated at runtime', (
    WidgetTester tester,
  ) async {
    refreshCalled = false;
  ...
  testWidgets('RefreshIndicator - reverse - BouncingScrollPhysics', (
    WidgetTester tester,
  ) async {
    refreshCalled = false;
    await tester.pumpWidget(
      MaterialApp(
        home: RefreshIndicator(
          ...
          child: ListView(
            ...
            children: <Widget>[
              for (int i = 0; i < 4; i++)
                SizedBox(height: 200.0, child: Text('X - $i')),
            ],
          ),
        ),
      ),
  ...
  testWidgets('RefreshIndicator disallows indicator - glow', (
    WidgetTester tester,
  ) async {
    refreshCalled = false;
              ...
              return NotificationListener<ScrollNotification>(
                onNotification: (ScrollNotification notification) {
                  if (notification is OverscrollNotification &&
                    ...
                    confirmationNotification = OverscrollIndicatorNotification(
                      leading: true,
                    );
  ...
  testWidgets('RefreshIndicator disallows indicator - stretch', (
    WidgetTester tester,
  ) async {
    refreshCalled = false;
  ...
  testWidgets('RefreshIndicator manipulates value color opacity correctly', (
    ...
    Future<void> testColor(Color color) async {
      final AnimationController positionController = AnimationController(
  ...
  testWidgets(
    'RefreshIndicator passes the default elevation through correctly',
    (WidgetTester tester) async {
      final AnimationController positionController = AnimationController(
        vsync: const TestVSync(),
      );
  ...
  testWidgets(
    'RefreshIndicator passes custom elevation values through correctly',
    (WidgetTester tester) async {
