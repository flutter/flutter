...
void main() {
  ...
  test('FloatingActionButtonThemeData lerp special cases', () {
    ...
    expect(
      identical(FloatingActionButtonThemeData.lerp(data, data, 0.5), data),
      true,
    );
  });
  ...
  testWidgets(
    ...
    (WidgetTester tester) async {
      ...
      expect(
        _getRawMaterialButton(tester).fillColor,
        colorScheme.primaryContainer,
      );
      expect(
        _getRichText(tester).text.style!.color,
  ...
  testWidgets(
    ...
    (WidgetTester tester) async {
      ...
      expect(
        _getRawMaterialButton(tester).disabledElevation,
        disabledElevation,
      );
      expect(
        _getRawMaterialButton(tester).highlightElevation,
        highlightElevation,
      );
