...
void main() {
  ...
  testWidgets(
    'Can theme LinearProgressIndicator using ProgressIndicatorTheme',
  ...
  testWidgets(
    'Can theme CircularProgressIndicator using ProgressIndicatorTheme',
    (WidgetTester tester) async {
      ...
      await tester.pumpWidget(
        MaterialApp(
          theme: theme,
          home: const Scaffold(
            body: Center(child: CircularProgressIndicator(value: 0.5)),
          ),
        ),
      );
  ...
  testWidgets(
    ...
    (WidgetTester tester) async {
      ...
      await expectLater(
        find.byType(CircularProgressIndicator),
        matchesGoldenFile(
          'circular_progress_indicator_theme_opt_into_2024.png',
        ),
      );
    },
  );
  ...
  testWidgets(
    'CircularProgressIndicator.year2023 overrides ProgressIndicatorThemeData.year2023',
    (WidgetTester tester) async {
      final ThemeData theme = ThemeData(
        progressIndicatorTheme: const ProgressIndicatorThemeData(
          year2023: false,
      ...
      await tester.pumpWidget(
        MaterialApp(
          ...
          home: const Scaffold(
            body: Center(
              child: CircularProgressIndicator(year2023: true, value: 0.5),
            ),
          ),
        ),
      );
      ...
      await expectLater(
        find.byType(CircularProgressIndicator),
        matchesGoldenFile(
          'circular_progress_indicator_theme_opt_into_2024_override.png',
        ),
      );
    },
  );
  ...
  testWidgets(
    'LinearProgressIndicator.year2023 overrides ProgressIndicatorThemeData.year2023',
    (WidgetTester tester) async {
      final ThemeData theme = ThemeData(
        progressIndicatorTheme: const ProgressIndicatorThemeData(
          year2023: false,
