...
void main() {
    ...
    await tester.pumpWidget(
      boilerplate(
        child: DefaultTabController(
          ...
          child: TabBar(
            tabs: <Widget>[
              Tab(icon: Semantics(image: true, child: const SizedBox.shrink())),
            ],
          ),
        ),
      ),
  ...
  testWidgets('Tab color - normal', (WidgetTester tester) async {
    ...
    expect(
      find.byType(TabBar),
      paints..line(
        color: material3 ? theme.colorScheme.outlineVariant : Colors.blue[500],
      ),
    );
  });
  ...
  testWidgets('TabBar default selected/unselected label style (primary)', (
    ...
    expect(
      unselectedLabel.text.style!.color,
  ...
  testWidgets('TabBar default tab indicator (primary)', (
    ...
    RenderBox tabBarBox = tester.firstRenderObject<RenderBox>(
      find.byType(TabBar),
    );
    ...
    expect(
      tabBarBox,
      paints..rrect(color: theme.colorScheme.primary, rrect: rrect),
    );
  ...
  testWidgets('Scrollable TabBar tap selects tab', (WidgetTester tester) async {
    ...
    await tester.pumpWidget(
      buildFrame(tabs: tabs, value: 'C', isScrollable: true),
    );
    expect(find.text('A'), findsOneWidget);
    expect(find.text('B'), findsOneWidget);
    expect(find.text('C'), findsOneWidget);
  ...
  testWidgets('Material2 - Scrollable TabBar tap centers selected tab', (
    ...
    final TabController controller = DefaultTabController.of(
      tester.element(find.text('AAAAAA')),
    );
    expect(controller, isNotNull);
    expect(controller.index, 0);
    ...
    expect(
      tester.getCenter(find.text('FFFFFF')).dx,
  ...
  testWidgets(
    'Material2 - TabBar can be scrolled independent of the selection',
    (WidgetTester tester) async {
      final List<String> tabs = <String>[
        'AAAA',
        'BBBB',
  ...
  testWidgets(
    'Material3 - TabBar can be scrolled independent of the selection',
    (WidgetTester tester) async {
      final List<String> tabs = <String>[
        'AAAA',
        'BBBB',
  ...
  testWidgets('TabBarView maintains state', (WidgetTester tester) async {
    ...
    TestGesture gesture = await tester.startGesture(
      tester.getCenter(find.text(tabs[0])),
    );
  ...
  testWidgets('TabBarView animation can be interrupted', (
    ...
    ); // TODO(bleroux): find why this is needed.
  ...
  testWidgets(
    ...
    (WidgetTester tester) async {
      ...
      final TabIndicatorRecordingCanvas canvas = TabIndicatorRecordingCanvas(
        indicatorColor,
      );
  ...
  testWidgets('Scrollable TabBar does not have overscroll indicator', (
    ...
    await tester.pumpWidget(
      buildFrame(tabs: tabs, value: 'A', isScrollable: true),
    );
  ...
  testWidgets('TabBar accepts custom physics', (WidgetTester tester) async {
    ...
    final double position = tabBar.physics!.applyPhysicsToUserOffset(
      TabMockScrollMetrics(),
      10,
    );
  ...
  testWidgets('Scrollable TabBar with a non-zero TabController initialIndex', (
    ...
    expect(
      tester.getTopRight(find.widgetWithText(Tab, 'TAB #19')).dx,
  ...
  testWidgets(
    ...
    (WidgetTester tester) async {
      ...
      final double indicatorRight =
          130.0 + kTabLabelPadding.horizontal - padEnd;
      const double indicatorTop = padTop;
  ...
  testWidgets('correct scrolling semantics', (WidgetTester tester) async {
    ...
    const String tab0title =
        'This is a very wide tab #0${kIsWeb ? '' : '\nTab 1 of 20'}';
    const String tab10title =
        'This is a very wide tab #10${kIsWeb ? '' : '\nTab 11 of 20'}';
  ...
  testWidgets('TabBar etc with zero tabs', (WidgetTester tester) async {
    ...
    expect(
      tester.getSize(find.byType(TabBarView)),
  ...
  testWidgets('TabBar etc with one tab', (WidgetTester tester) async {
    ...
    final double tabLeft = tester
        .getTopLeft(find.widgetWithText(Tab, 'TAB'))
        .dx;
    final double tabRight = tester
        .getTopRight(find.widgetWithText(Tab, 'TAB'))
        .dx;
  ...
  test('illegal constructor combinations', () {
    ...
    expect(
      () => Tab(icon: Container(), text: 'foo', child: Container()),
  ...
  testWidgets('DefaultTabController changes does not recreate PageController', (
    ...
    TabController tabController = DefaultTabController.of(
      tester.element(find.text('Page 14')),
    );
    ...
    tabController = DefaultTabController.of(
      tester.element(find.text('Page 9')),
    );
  ...
  testWidgets('Skipping tabs with a KeepAlive child works', (
    ...
    expect(controller.index, 3);
    expect(
      find.text(TabAlwaysKeepAliveWidget.text, skipOffstage: false),
      findsOneWidget,
    );
    expect(find.text('4'), findsOneWidget);
  });
  ...
  testWidgets('TabBar.labelColor resolves material states', (
    ...
    final IconThemeData selectedTabIcon = IconTheme.of(
      tester.element(find.text(tab1)),
    );
    final IconThemeData unselectedTabIcon = IconTheme.of(
      tester.element(find.text(tab2)),
    );
  ...
  testWidgets(
    ...
    (WidgetTester tester) async {
      ...
      IconThemeData selectedTabIcon = IconTheme.of(
        tester.element(find.text(tab1)),
      );
      IconThemeData unselectedTabIcon = IconTheme.of(
        tester.element(find.text(tab2)),
      );
      ...
      selectedTextStyle = tester
          .renderObject<RenderParagraph>(find.text(tab1))
          .text
          .style!;
      unselectedTextStyle = tester
          .renderObject<RenderParagraph>(find.text(tab2))
          .text
          .style!;
                ...
                appBar: AppBar(
                  ...
                  bottom: tabTextContent.isNotEmpty
                      ? TabBar(
                          ...
                          tabs: tabTextContent
                              .map(
                                (String textContent) => Tab(text: textContent),
                              )
                              .toList(),
                        )
                      : null,
  ...
  testWidgets(
    ...
    (WidgetTester tester) async {
          ...
          home: DefaultTabController(
            ...
            child: Scaffold(
              body: TabBarView(
                ...
                children: List<Widget>.generate(
                  10,
                  (int i) => Center(child: Text('index $i')),
                ),
              ),
            ),
          ),
      ...
      final PageView pageView = tester.widget<PageView>(find.byType(PageView));
      expect(
        pageView.physics.toString().contains('ClampingScrollPhysics'),
        isFalse,
      );
    },
  );
  ...
  testWidgets('TabController.offset changes reflect labelColor', (
    ...
    Future<void> testLabelColor({
      ...
      expect(
        firstColor,
        equals(Color.lerp(selectedColor, unselectedColor, 0.6)),
      );
      expect(
        secondColor,
        equals(Color.lerp(unselectedColor, selectedColor, 0.6)),
      );
      ...
      expect(
        firstColor,
        equals(Color.lerp(selectedColor, unselectedColor, 0.4)),
      );
      expect(
        secondColor,
        equals(Color.lerp(unselectedColor, selectedColor, 0.4)),
      );
    }
              ...
              return DefaultTabController(
                ...
                child: Scaffold(
                  ...
                  body: TabBarView(
                    children: tabs
                        .map<Widget>(
                          (String tab) => Tab(text: 'Tab child $tab'),
                        )
                        .toList(),
                  ),
                ),
  ...
  testWidgets(
    ...
    (WidgetTester tester) async {
      ...
      final Padding tabOne = tester.widget<Padding>(
        find.widgetWithText(Padding, 'Tab 1').first,
      );
      final Padding tabTwo = tester.widget<Padding>(
        find.widgetWithText(Padding, 'Tab 2').first,
      );
      final Padding tabThree = tester.widget<Padding>(
        find.widgetWithText(Padding, 'Tab 3').first,
      );
  ...
  testWidgets('Test semantics of TabPageSelector', (WidgetTester tester) async {
    ...
    expect(
      semantics,
      hasSemantics(expectedSemantics, ignoreRect: true, ignoreTransform: true),
    );
  ...
  testWidgets(
    'No crash if TabBar build called before didUpdateWidget with SliverAppBar',
    (WidgetTester tester) async {
  ...
  testWidgets('Tab has correct selected/unselected hover color', (
    ...
    expect(
      inkFeatures,
      isNot(paints..rect(color: theme.colorScheme.onSurface.withOpacity(0.08))),
    );
    expect(
      inkFeatures,
      isNot(paints..rect(color: theme.colorScheme.primary.withOpacity(0.08))),
    );
  ...
  testWidgets('Tab has correct selected/unselected focus color', (
    ...
    expect(
      inkFeatures,
      isNot(paints..rect(color: theme.colorScheme.onSurface.withOpacity(0.1))),
    );
    expect(
      inkFeatures,
      isNot(paints..rect(color: theme.colorScheme.primary.withOpacity(0.1))),
    );
    ...
    expect(
      inkFeatures,
      paints..rect(color: theme.colorScheme.onSurface.withOpacity(0.1)),
    );
  ...
  testWidgets('Material3 - Default TabAlignment', (WidgetTester tester) async {
    ...
    await tester.pumpWidget(
      buildFrame(tabs: tabs, value: 'B', useMaterial3: true),
    );
  ...
  testWidgets(
    ...
    (WidgetTester tester) async {
      ...
      tabOneLeft =
          (tabBar.width / 2) - tabOneRect.width - kTabLabelPadding.right;
      expect(tabOneRect.left, equals(tabOneLeft));
      tabTwoRight =
          (tabBar.width / 2) + tabTwoRect.width + kTabLabelPadding.left;
      expect(tabTwoRect.right, equals(tabTwoRight));
  ...
  testWidgets(
    ...
    (WidgetTester tester) async {
      ...
      // horizontal offset of 52.0 pixels.
      double tabOneRight =
          tabBar.width - kTabLabelPadding.right - tabStartOffset;
  ...
  testWidgets(
    'TabBar labels use colors from labelStyle & unselectedLabelStyle',
    (WidgetTester tester) async {
      const String tab1 = 'Tab 1';
      const String tab2 = 'Tab 2';
  ...
  testWidgets(
    ...
    (WidgetTester tester) async {
      ...
      // is set to start.
      await tester.pumpWidget(
        buildTabBar(tabAlignment: TabAlignment.startOffset),
      );
      expect(tester.getSize(find.byType(TabBar)).width, 800.0);
      ...
      await tester.pumpWidget(
        buildTabBar(dividerHeight: 0.0, tabAlignment: TabAlignment.start),
      );
      ...
      await tester.pumpWidget(
        buildTabBar(dividerHeight: 0.0, tabAlignment: TabAlignment.center),
      );
      expect(tester.getSize(find.byType(TabBar)).width, 307.5);
    },
  );
  ...
  group('Material 2', () {
    ...
    testWidgets('Material2 - Default TabAlignment', (
      ...
      // Test default TabAlignment when isScrollable is false.
      await tester.pumpWidget(
        buildFrame(tabs: tabs, value: 'B', useMaterial3: false),
      );
  ...
  testWidgets('Tab indicator painter image configuration', (
    ...
    await tester.pumpWidget(
      buildTabs(textDirection: TextDirection.rtl, ratio: 2.33),
    );
  ...
  testWidgets(
    ...
    (WidgetTester tester) async {
      ...
      await tester.pumpWidget(
        buildTabs(textScaler: const TextScaler.linear(1.75)),
      );
      ...
      await tester.pumpWidget(
        buildTabs(textScaler: const TextScaler.linear(2.0)),
      );
  ...
  testWidgets('Scrollable TabBar does not jitter in the middle position', (
    ...
    final List<String> tabs = List<String>.generate(
      20,
      (int index) => 'Tab $index',
    );
    ...
    final SingleChildScrollView scrollable = tester.widget(
  ...
  testWidgets(
    ...
    (WidgetTester tester) async {
      ...
      final TestGesture gesture = await tester.startGesture(
        tester.getCenter(find.text('Page 4')),
      );
      await gesture.moveBy(const Offset(600.0, 0.0));
      await gesture.up();
      await tester.pump();
  ...
  testWidgets(
    'Scrollable TabBar with transparent divider expands to full width',
    (WidgetTester tester) async {
  ...
  testWidgets(
    ...
    (WidgetTester tester) async {
      ...
      await tester.pumpWidget(
        buildTab(indicatorAnimation: TabIndicatorAnimation.linear),
      );
      ...
      await tester.pumpWidget(
        buildTab(indicatorAnimation: TabIndicatorAnimation.elastic),
      );
      await tester.pumpAndSettle();
  ...
  testWidgets('Tabs icon respects ambient icon theme', (
    WidgetTester tester,
  ) async {
    final ThemeData theme = ThemeData(
    ...
    expect(
      iconStyle(tester, selectedIcon).color,
      equals(theme.colorScheme.primary),
    );
    // The iconTheme color is applied to the unselected icon.
    expect(
      iconStyle(tester, unselectedIcon).color,
      equals(theme.iconTheme.color),
    );
  ...
  testWidgets(
    'Elastic Tab animation does not overflow target tab in a scrollable tab bar - LTR',
    (WidgetTester tester) async {
      final List<Widget> tabs = <Widget>[
        const Tab(text: 'Short'),
        const Tab(text: 'A Bit Longer Text'),
  ...
  testWidgets(
    'Elastic Tab animation does not overflow target tab in a scrollable tab bar - RTL',
    (WidgetTester tester) async {
      final List<Widget> tabs = <Widget>[
        const Tab(text: 'Short'),
        const Tab(text: 'A Bit Longer Text'),
  ...
  testWidgets(
    'Linear Tab animation does not overflow target tab in a scrollable tab bar - LTR',
    (WidgetTester tester) async {
      final List<Widget> tabs = <Widget>[
        const Tab(text: 'Short'),
        const Tab(text: 'A Bit Longer Text'),
  ...
  testWidgets(
    'Linear Tab animation does not overflow target tab in a scrollable tab bar - RTL',
    (WidgetTester tester) async {
      final List<Widget> tabs = <Widget>[
        const Tab(text: 'Short'),
        const Tab(text: 'A Bit Longer Text'),
  ...
  testWidgets('Elastic Tab animation when skipping tabs', (
    WidgetTester tester,
  ) async {
  ...
  testWidgets('Linear Tab animation when skipping tabs', (
    WidgetTester tester,
  ) async {
    final List<Widget> tabs = List<Widget>.generate(
      10,
  ...
  testWidgets('onHover is triggered when mouse pointer is over a tab', (
    WidgetTester tester,
  ) async {
    final List<({bool hover, int index})> hoverEvents =
        <({bool hover, int index})>[];
    await tester.pumpWidget(
      MaterialApp(
        home: DefaultTabController(
          length: 3,
  ...
  testWidgets('onFocusChange is triggered when tabs gain and lose focus', (
    ...
    final List<({bool focus, int index})> focusEvents =
