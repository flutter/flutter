...
void main() {
  ...
  testWidgets(
    'Radio selected semantics - platform adaptive',
    (WidgetTester tester) async {
      ...
      await tester.pumpWidget(
        Theme(
          data: theme,
          child: Material(
            child: Radio<int>(value: 1, groupValue: 1, onChanged: (int? i) {}),
          ),
        ),
      );
  ...
  testWidgets('Radio semantics', (WidgetTester tester) async {
    ...
    await tester.pumpWidget(
      Theme(
        data: theme,
        child: Material(
          child: Radio<int>(value: 1, groupValue: 2, onChanged: (int? i) {}),
        ),
      ),
    );
    ...
    await tester.pumpWidget(
      Theme(
        data: theme,
        child: Material(
          child: Radio<int>(value: 2, groupValue: 2, onChanged: (int? i) {}),
        ),
      ),
    );
    ...
    await tester.pumpWidget(
      Theme(
        ...
        child: const Material(
          child: Radio<int>(value: 1, groupValue: 2, onChanged: null),
        ),
      ),
    );
    ...
    await tester.pumpWidget(
      Theme(
        data: theme,
        child: const Material(
          child: Radio<int>(value: 2, groupValue: 2, onChanged: null),
        ),
      ),
    );
  ...
  testWidgets('Material2 - Radio ink ripple is displayed correctly', (
    WidgetTester tester,
  ) async {
  ...
  testWidgets('Material3 - Radio ink ripple is displayed correctly', (
    WidgetTester tester,
  ) async {
    final Key painterKey = UniqueKey();
    const Key radioKey = Key('radio');
  ...
  testWidgets('Radio responds to density changes.', (
    WidgetTester tester,
  ) async {
  ...
  testWidgets('Radio changes mouse cursor when hovered', (
    WidgetTester tester,
  ) async {
  ...
  testWidgets('Material2 - Radio button default colors', (
    WidgetTester tester,
  ) async {
  ...
  testWidgets('Material3 - Radio button default colors', (
    WidgetTester tester,
  ) async {
    final ThemeData theme = ThemeData();
    Widget buildRadio({bool enabled = true, bool selected = true}) {
  ...
  testWidgets('Radio.adaptive shows the correct platform widget', (
    WidgetTester tester,
  ) async {
  ...
  testWidgets(
    ...
    (WidgetTester tester) async {
      ...
      expect(
        ...
        paints
          ..circle(
            color: theme.colorScheme.secondary.withAlpha(kRadialReactionAlpha),
          )
          ..circle(color: theme.colorScheme.secondary),
      );
