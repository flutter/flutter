...
void main() {
  ...
  final ThemeData material2Theme = ThemeData(
    useMaterial3: false,
  ...
  testWidgets(
    'Dialog background defaults to ColorScheme.surfaceContainerHigh',
  ...
  testWidgets('Custom Title Text Style', (WidgetTester tester) async {
    ...
    final RenderParagraph title = _getTextRenderObjectFromDialog(
      tester,
      titleText,
    );
  ...
  testWidgets('Dialogs removes MediaQuery padding and view insets', (
    ...
    expect(
      MediaQuery.of(outerContext).viewInsets,
      const EdgeInsets.only(left: 25.0, bottom: 75.0),
    );
    expect(
      MediaQuery.of(routeContext).viewInsets,
      const EdgeInsets.only(left: 25.0, bottom: 75.0),
    );
    ...
    await tester.pumpWidget(
      MaterialApp(
        ...
        home: const AlertDialog(
          title: Text('title'),
          content: Column(
            children: <Widget>[Text('some content'), Text('more content')],
          ),
  ...
  group('AlertDialog.scrollable: ', () {
    ...
    testWidgets('Title and content are scrollable', (
      ...
      await tester.drag(find.byKey(titleKey), const Offset(0.0, -200.0));
      expect(
        title.localToGlobal(Offset.zero),
  ...
  testWidgets('Uses closed loop focus traversal', (WidgetTester tester) async {
    ...
    Future<bool> nextFocus() async {
      final bool result =
          Actions.invoke(primaryFocus!.context!, const NextFocusIntent())!
              as bool;
      await tester.pump();
      return result;
    }
    ...
    Future<bool> previousFocus() async {
      final bool result =
          Actions.invoke(primaryFocus!.context!, const PreviousFocusIntent())!
              as bool;
      await tester.pump();
      return result;
    }
  ...
  testWidgets('Applies AnimationStyle to showAdaptiveDialog', (
    WidgetTester tester,
  ) async {
  ...
  testWidgets(
    'Setting DialogRoute.requestFocus to false does not request focus on the dialog',
    (WidgetTester tester) async {
  ...
  testWidgets('requestFocus works correctly in showDialog.', (
    WidgetTester tester,
  ) async {
  ...
  testWidgets('Dialog respects the given constraints', (
    WidgetTester tester,
  ) async {
    await tester.pumpWidget(
      _buildAppWithDialog(
