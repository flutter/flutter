...
void main() {
  ...
  group('showDatePicker Dialog', () {
    ...
    testWidgets('builder parameter', (WidgetTester tester) async {
      ...
      expect(
        tester.getBottomLeft(find.text('OK')).dx,
  ...
  group('Calendar mode', () {
    testWidgets('Default Calendar mode layout (Landscape)', (
      ...
      final Offset switchButtonBottomLeft = tester.getBottomLeft(
        switchButtonM3,
      );
      final Offset headerTextBottomLeft = tester.getBottomLeft(headerText);
      final Offset dialogBottomLeft = tester.getBottomLeft(
        find.byType(AnimatedContainer),
      );
    ...
    testWidgets('Date picker dayOverlayColor resolves hovered state', (
      WidgetTester tester,
    ) async {
      final ThemeData theme = ThemeData();
      await prepareDatePicker(
    ...
    testWidgets('Date picker dayOverlayColor resolves focused state', (
      WidgetTester tester,
    ) async {
    ...
    testWidgets(
      'Date picker dayOverlayColor resolves selected and hovered state',
      (WidgetTester tester) async {
        final ThemeData theme = ThemeData();
        await prepareDatePicker(
          tester,
        ...
        await tester.pumpAndSettle();
        final ShapeDecoration day30Decoration = findDayDecoration(
          tester,
          '30',
        )!;
    ...
    testWidgets(
      'Date picker dayOverlayColor resolves selected and focused state',
      (WidgetTester tester) async {
        FocusManager.instance.highlightStrategy =
            FocusHighlightStrategy.alwaysTraditional;
        final ThemeData theme = ThemeData();
    ...
    testWidgets(
      'Date picker dayOverlayColor resolves selected and pressed state',
      (WidgetTester tester) async {
        final ThemeData theme = ThemeData();
        await prepareDatePicker(
          tester,
    ...
    testWidgets(
      'Calendar dialog contents are visible - textScaler 0.88, 1.0, 2.0',
      (WidgetTester tester) async {
        addTearDown(tester.view.reset);
        ...
        for (final double scale in scales) {
          ...
          await expectLater(
            find.byType(Dialog),
            matchesGoldenFile(
              'date_picker.calendar.contents.visible.$scale.png',
            ),
          );
        }
      },
  ...
  group('Input mode', () {
    ...
    testWidgets(
      ...
      (WidgetTester tester) async {
        ...
        await prepareDatePicker(tester, useMaterial3: true, (
  ...
  group('Semantics', () {
    ...
    testWidgets('datepicker dialog semantics node not focusable', (
      WidgetTester tester,
    ) async {
      await tester.pumpWidget(
        MaterialApp(
      ...
      final SemanticsNode node = tester.semantics.find(
  ...
  testWidgets('DatePickerDialog with updated insetPadding', (
    WidgetTester tester,
  ) async {
    await tester.pumpWidget(
      MaterialApp(
