...
void main() {
  testWidgets('ListTile geometry (LTR)', (WidgetTester tester) async {
    ...
    await tester.pumpWidget(
      buildFrame(textScaler: const TextScaler.linear(4.0)),
    );
    testChildren();
    testHorizontalGeometry();
  ...
  testWidgets(
    'ListTile respects and combines parent IconButtonThemeData style',
    (WidgetTester tester) async {
      const Color customIconColor = Colors.green;
      const Icon leadingIcon = Icon(Icons.favorite);
      const Icon trailingIcon = Icon(Icons.close);
      const OutlinedBorder customShape = RoundedRectangleBorder(
        side: BorderSide(),
      );
      ...
      Widget buildFrame() {
        return MaterialApp(
          theme: ThemeData(
            iconButtonTheme: IconButtonThemeData(
              style: IconButton.styleFrom(shape: customShape),
            ),
          ),
          home: Scaffold(
            body: Center(
  ...
  group('Leading/Trailing exceeding list tile width throws exception', () {
    ...
    testWidgets('leading', (WidgetTester tester) async {
      ...
      await tester.pumpWidget(
        buildListTile(leading: const SizedBox(width: 61)),
      );
    ...
    testWidgets('trailing', (WidgetTester tester) async {
      ...
      FlutterError.onError = onError;
      await tester.pumpWidget(
        buildListTile(trailing: const SizedBox(width: 61)),
      );
      FlutterError.onError = oldHandler;
