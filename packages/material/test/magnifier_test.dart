  ...
  group('adaptiveMagnifierControllerBuilder', () {
    testWidgets(
      ...
      (WidgetTester tester) async {
        ...
        final Widget? builtWidget = TextMagnifier.adaptiveMagnifierConfiguration
            .magnifierBuilder(
              context,
              MagnifierController(),
              magnifierPositioner,
    ...
    group('position', () {
      ...
      testWidgets(
        ...
        (WidgetTester tester) async {
            ...
            magnifierPositioner = ValueNotifier<MagnifierInfo>(
              MagnifierInfo(
                ...
                globalGesturePosition: Offset(
                  reasonableTextField.right + gestureOutsideLine,
                  0,
                ),
              ),
            ),
          ...
          expect(
            getMagnifierPosition(tester).dx,
          ...
          await showMagnifier(
            ...
            magnifierPositioner = ValueNotifier<MagnifierInfo>(
              MagnifierInfo(
                ...
                globalGesturePosition: Offset(
                  reasonableTextField.left - gestureOutsideLine,
                  0,
                ),
              ),
            ),
      ...
      testWidgets('should position vertically at the center of the line', (
        ...
        expect(
          getMagnifierPosition(tester).dy,
      ...
      testWidgets(
        ...
        (WidgetTester tester) async {
          final Rect topOfScreenTextFieldRect = Rect.fromPoints(
            Offset.zero,
            const Offset(200, 0),
          );
    ...
    group('focal point', () {
      ...
      testWidgets(
        ...
        (WidgetTester tester) async {
          ...
          expect(
            getMagnifierAdditionalFocalPoint(tester).dx,
