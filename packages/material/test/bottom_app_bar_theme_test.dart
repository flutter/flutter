...
void main() {
  test('BottomAppBarThemeData copyWith, ==, hashCode, defaults', () {
    expect(
      ...
      const BottomAppBarThemeData().copyWith(),
    );
    expect(
  ...
  test('BottomAppBarThemeData lerp special cases', () {
    ...
    expect(
      identical(BottomAppBarThemeData.lerp(theme, theme, 0.5), theme),
      true,
    );
  });

  testWidgets('Default BottomAppBarThemeData debugFillProperties', (
    WidgetTester tester,
  ) async {
  ...
  testWidgets('BottomAppBarThemeData implements debugFillProperties', (
    WidgetTester tester,
  ) async {
    final DiagnosticPropertiesBuilder builder = DiagnosticPropertiesBuilder();
    const BottomAppBarThemeData(
  ...
  testWidgets('Local BottomAppBarTheme overrides defaults', (
    WidgetTester tester,
  ) async {
    ...
    final Padding paddingWidget = tester.widget<Padding>(
      find.descendant(
        ...
        matching: find.byType(Padding).at(1),
      ),
    );
  ...
  group('Material 2 tests', () {
    testWidgets('Material2 - BAB theme overrides color', (
      WidgetTester tester,
    ) async {
    ...
    testWidgets('Material2 - BAB color - BabTheme', (
      WidgetTester tester,
    ) async {
      const Color babThemeColor = Colors.black87;
      const BottomAppBarThemeData theme = BottomAppBarThemeData(
    ...
    testWidgets('Material2 - BAB theme customizes shape', (
      WidgetTester tester,
    ) async {
      const BottomAppBarThemeData theme = BottomAppBarThemeData(
    ...
    testWidgets('Material2 - BAB theme does not affect defaults', (
      WidgetTester tester,
    ) async {
      await tester.pumpWidget(
        MaterialApp(
  ...
  group('Material 3 tests', () {
    testWidgets('Material3 - BAB theme overrides color', (
      WidgetTester tester,
    ) async {
      const Color themedColor = Colors.black87;
      const BottomAppBarThemeData theme = BottomAppBarThemeData(
    ...
    testWidgets('Material3 - BAB color - BabTheme', (
      WidgetTester tester,
    ) async {
      const Color babThemeColor = Colors.black87;
      const BottomAppBarThemeData theme = BottomAppBarThemeData(
      ...
      await tester.pumpWidget(
        MaterialApp(
          theme: ThemeData(bottomAppBarTheme: theme),
          home: const Scaffold(
            body: BottomAppBar(surfaceTintColor: Colors.transparent),
          ),
        ),
      );
    ...
    testWidgets('Material3 - BAB theme does not affect defaults', (
      WidgetTester tester,
    ) async {
    ...
    testWidgets('Material3 - BAB theme overrides surfaceTintColor', (
      WidgetTester tester,
    ) async {
      const Color color =
          Colors.blue; // base color that the surface tint will be applied to
      ...
      expect(
        widget.color,
        ElevationOverlay.applySurfaceTint(color, babThemeSurfaceTintColor, 0),
      );
    });

    testWidgets('Material3 - BAB theme overrides shadowColor', (
      WidgetTester tester,
    ) async {
    ...
    testWidgets('Material3 - BAB surfaceTintColor - Widget', (
      WidgetTester tester,
    ) async {
      const Color color =
          Colors.white10; // base color that the surface tint will be applied to
      const Color babThemeSurfaceTintColor = Colors.black87;
      ...
      await tester.pumpWidget(
        MaterialApp(
          ...
          home: const Scaffold(
            body: BottomAppBar(
              color: color,
              surfaceTintColor: babSurfaceTintColor,
            ),
          ),
        ),
      );
      ...
      expect(
        widget.color,
        ElevationOverlay.applySurfaceTint(color, babSurfaceTintColor, 3.0),
      );
    });

    testWidgets('Material3 - BAB surfaceTintColor - BabTheme', (
      WidgetTester tester,
    ) async {
      const Color color =
          Colors.blue; // base color that the surface tint will be applied to
      ...
      expect(
        widget.color,
        ElevationOverlay.applySurfaceTint(color, babThemeColor, 3.0),
      );
    });
  });
}
