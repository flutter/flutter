...
void main() {
  ...
  testWidgets('Can close search with escape button and return null', (
    WidgetTester tester,
  ) async {
    final _TestSearchDelegate delegate = _TestSearchDelegate();
    addTearDown(() => delegate.dispose());
  ...
  testWidgets('Default autocorrect and enableSuggestions value', (
    WidgetTester tester,
  ) async {
    final _TestSearchDelegate delegate = _TestSearchDelegate();
    addTearDown(() => delegate.dispose());
  ...
  testWidgets('showSearch with maintainState on the route', (
    WidgetTester tester,
  ) async {
