...
void main() {
  ...
  testWidgets('Passes textAlignVertical to underlying TextField', (
    ...
    await tester.pumpWidget(
      MaterialApp(
        home: Material(
          child: Center(
            child: TextFormField(textAlignVertical: textAlignVertical),
          ),
        ),
      ),
    );
  ...
  testWidgets('Passes onEditingComplete to underlying TextField', (
    ...
    await tester.pumpWidget(
      MaterialApp(
        home: Material(
          child: Center(
            child: TextFormField(onEditingComplete: onEditingComplete),
          ),
        ),
      ),
    );
  ...
  testWidgets('Passes scrollController to underlying TextField', (
    ...
    await tester.pumpWidget(
      MaterialApp(
        home: Material(
          child: Center(
            child: TextFormField(scrollController: scrollController),
          ),
        ),
      ),
    );
  ...
  testWidgets('Passes dragStartBehavior to dragStartBehavior TextField', (
    ...
    await tester.pumpWidget(
      MaterialApp(
        home: Material(
          child: Center(
            child: TextFormField(dragStartBehavior: dragStartBehavior),
          ),
        ),
      ),
    );
  ...
  testWidgets('Passes onTapAlwaysCalled to onTapAlwaysCalled TextField', (
    ...
    await tester.pumpWidget(
      MaterialApp(
        home: Material(
          child: Center(child: TextFormField(onTapAlwaysCalled: true)),
        ),
      ),
    );
  ...
  testWidgets(
    'forceErrorText will override InputDecoration.error when both are provided',
    (WidgetTester tester) async {
      const String forceErrorText = 'Forcing error';
