...
void main() {
  testWidgets('The Ink widget expands when no dimensions are set', (
    WidgetTester tester,
  ) async {
  ...
  testWidgets('The Ink widget fits the specified size', (
    WidgetTester tester,
  ) async {
  ...
  testWidgets('The Ink widget expands on a unspecified dimension', (
    WidgetTester tester,
  ) async {
    const double height = 150.0;
    await tester.pumpWidget(
  ...
  testWidgets('Material2 - InkWell widget renders an ink splash', (
    WidgetTester tester,
  ) async {
  ...
  testWidgets('Material3 - InkWell widget renders an ink splash', (
    WidgetTester tester,
  ) async {
  ...
  testWidgets('Material2 - Does the Ink widget render anything', (
    WidgetTester tester,
  ) async {
    await tester.pumpWidget(
      MaterialApp(
  ...
  testWidgets('Material3 - Does the Ink widget render anything', (
    WidgetTester tester,
  ) async {
    const Key inkWellKey = Key('InkWell');
    await tester.pumpWidget(
  ...
  testWidgets(
    ...
    (WidgetTester tester) async {
      ...
      final Offset inkWellCenter =
          tester.getCenter(find.byType(InkWell)) - topLeft;
  ...
  testWidgets('The InkWell widget on OverlayPortal does not throw', (
    WidgetTester tester,
  ) async {
  ...
  testWidgets(
    'Material2 - Custom rectCallback renders an ink splash from its center',
    (WidgetTester tester) async {
      ...
      RenderBox box =
          Material.of(tester.element(find.byType(InkResponse))) as RenderBox;
  ...
  testWidgets(
    'Material3 - Custom rectCallback renders an ink splash from its center',
    (WidgetTester tester) async {
      ...
      await expectLater(
        ...
        matchesGoldenFile(
          'm3_ink_response.renders.ink_splash_from_its_center.0.png',
        ),
      );
      ...
      await expectLater(
        find.byKey(inkWResponseKey),
        matchesGoldenFile(
          'm3_ink_response.renders.ink_splash_from_its_center.1.png',
        ),
      );
    },
  );

  testWidgets('Ink with isVisible=false does not paint', (
    WidgetTester tester,
  ) async {
