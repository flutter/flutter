...
void main() {
  ...
  testWidgets(
    'FilledButton.defaultStyle produces a ButtonStyle with appropriate non-null values',
    (WidgetTester tester) async {
      ...
      expect(
        ...
        isNotNull,
        reason: 'animationDuration style',
      );
      ...
      expect(
        ...
        isNull,
        reason: 'backgroundBuilder style',
      );
      expect(
        style.foregroundBuilder,
        isNull,
        reason: 'foregroundBuilder style',
      );
    },
  );
  ...
  testWidgets(
    'FilledButton.icon produces the correct widgets if icon is null',
    (WidgetTester tester) async {
      const ColorScheme colorScheme = ColorScheme.light();
      final ThemeData theme = ThemeData.from(colorScheme: colorScheme);
      final Key iconButtonKey = UniqueKey();
  ...
  testWidgets('FilledButton.tonal, FilledButton.tonalIcon defaults', (
    ...
    await tester.pumpWidget(
      MaterialApp(
        theme: theme,
        home: const Center(
          child: FilledButton.tonal(onPressed: null, child: Text('button')),
        ),
      ),
    );
  ...
  testWidgets('Fixed size FilledButtons', (WidgetTester tester) async {
    ...
    expect(
      tester.getSize(find.widgetWithText(FilledButton, '100x100')),
      const Size(100, 100),
    );
    expect(
      tester.getSize(find.widgetWithText(FilledButton, '200xh')).width,
      200,
    );
    expect(
      tester.getSize(find.widgetWithText(FilledButton, 'wx200')).height,
      200,
    );
  });
  ...
  testWidgets('Fixed size FilledButton, same as minimumSize == maximumSize', (
    ...
    expect(
      tester.getSize(find.widgetWithText(FilledButton, '200x200')),
      const Size(200, 200),
    );
    expect(
      tester.getSize(find.widgetWithText(FilledButton, '200,200')),
      const Size(200, 200),
    );
  });
  ...
  testWidgets(
    ...
    (WidgetTester tester) async {
      ...
      bool sameStates(
        Set<MaterialState> expectedValue,
        Set<MaterialState> actualValue,
      ) {
  ...
  testWidgets('Default FilledButton icon alignment', (
    WidgetTester tester,
  ) async {
    ...
    final Offset buttonTopRight = tester.getTopRight(
  ...
  testWidgets('FilledButton icon alignment can be customized', (
    WidgetTester tester,
  ) async {
    Widget buildWidget({
  ...
  testWidgets(
    'FilledButton icon alignment respects ButtonStyle.iconAlignment',
    (WidgetTester tester) async {
      ...
      final Offset buttonTopLeft = tester.getTopLeft(
        find.byType(Material).last,
      );
      final Offset iconTopLeft = tester.getTopLeft(find.byIcon(Icons.add));
  ...
  testWidgets(
    'FilledButton tonal button icon alignment respects ButtonStyle.iconAlignment',
    (WidgetTester tester) async {
      Widget buildButton({IconAlignment? iconAlignment}) {
        return MaterialApp(
          home: Center(
  ...
  testWidgets('FilledButton.styleFrom can customize the button icon', (
    WidgetTester tester,
  ) async {
  ...
  testWidgets(
    'FilledButton icon uses provided foregroundColor over default icon color',
    (WidgetTester tester) async {
  ...
  testWidgets('FilledButton text and icon respect animation duration', (
    WidgetTester tester,
  ) async {
          ...
          child: Center(
            child: FilledButton.icon(
              style: ButtonStyle(
                ...
                iconColor: const WidgetStateProperty<Color>.fromMap(
    ...
    expect(
      iconStyle(tester, buttonIcon).color,
      hoveredColor.withValues(red: 0.5),
    );
    ...
    await tester.pumpWidget(
      buildButton(animationDuration: const Duration(seconds: 2)),
    );
    await tester.pumpAndSettle();
