...
void main() {
  ...
  testWidgets(
    ...
    (WidgetTester tester) async {
      ...
      final SegmentedButtonState<int> state = tester.state(
  ...
  testWidgets(
    ...
    (WidgetTester tester) async {
      ...
      final Finder parent = find
          ...
          .first;
      final Finder parentMaterial = find
          .ancestor(of: parent, matching: find.byType(Material))
          .first;
  ...
  testWidgets('SegmentedButton.styleFrom is applied to the SegmentedButton', (
    ...
    ButtonStyle? buttonStyle = tester
    ...
    buttonStyle = tester
        .widget<TextButton>(find.byType(TextButton).at(1))
        .style;
    expect(
      buttonStyle?.foregroundColor?.resolve(selected),
      selectedForegroundColor,
    );
    expect(
      buttonStyle?.backgroundColor?.resolve(selected),
    ...
    expect(
      buttonStyle?.foregroundColor?.resolve(disabled),
      disabledForegroundColor,
    );
    expect(
      buttonStyle?.backgroundColor?.resolve(disabled),
  ...
  testWidgets('Disabled SegmentedButton has correct states when rebuilding', (
    ...
    SegmentedButtonState<int> state = tester.state(
      find.byType(SegmentedButton<int>),
    );
  ...
  testWidgets('SegmentedButton vertical aligned children', (
        ...
        home: Scaffold(
          body: Center(
            child: SegmentedButton<int>(
              ...
              selected: const <int>{
                -1,
              }, // Prevent any of ButtonSegment to be selected
    ...
    for (int i = 0; i <= 3; i++) {
      final Rect currentChildRect = tester.getRect(
        find.widgetWithText(TextButton, 'Option $i'),
      );
      if (previewsChildRect != null) {
        ...
        expect(
          ...
          previewsChildRect.top + previewsChildRect.height,
        );
      }
  ...
  testWidgets('SegmentedButton vertical aligned golden image', (
    WidgetTester tester,
  ) async {
