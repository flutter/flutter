...
void main() {
  ...
  testWidgets('AppBar centerTitle:true centers on Android', (
    ...
    await tester.pumpWidget(
      MaterialApp(
        theme: ThemeData(platform: TargetPlatform.android),
        home: Scaffold(
          appBar: AppBar(centerTitle: true, title: const Text('X')),
        ),
      ),
    );
      ...
      Localizations(
        ...
        child: Directionality(
          ...
          child: MediaQuery(
            ...
            child: Scaffold(
              body: Column(
                children: <Widget>[AppBar(title: const Text('title'))],
              ),
            ),
          ),
        ),
  ...
  testWidgets('AppBar has default semantics order', (
    WidgetTester tester,
  ) async {
    final SemanticsTester semantics = SemanticsTester(tester);
  ...
  testWidgets('AppBar can customize sort keys for flexible space', (
    WidgetTester tester,
  ) async {
    final SemanticsTester semantics = SemanticsTester(tester);
    ...
    testWidgets(
      ...
      (WidgetTester tester) async {
        ...
        Color? leadingIconColor() =>
            _iconStyle(tester, Icons.add_circle)?.color;
        Color? actionIconColor() => _iconStyle(tester, Icons.ac_unit)?.color;
        Color? actionIconButtonColor() => _iconStyle(tester, Icons.add)?.color;
  ...
  group('MaterialStateColor scrolledUnder', () {
    ...
    testWidgets('backgroundColor animation', (WidgetTester tester) async {
      ...
      expect(
        getAppBarAnimatedBackgroundColor(tester),
        isSameColorAs(const Color(0xFF00C33C)),
      );
      await tester.pump(const Duration(milliseconds: 50));
      expect(
        getAppBarAnimatedBackgroundColor(tester),
        isSameColorAs(const Color(0xFF0039C6)),
      );
    ...
    testWidgets(
      'scrolledUnderElevation should be maintained when drawer is opened',
      (WidgetTester tester) async {
    ...
    testWidgets(
      'scrolledUnderElevation should be maintained when endDrawer is opened',
      (WidgetTester tester) async {
        final GlobalKey drawerListKey = GlobalKey();
        final GlobalKey bodyListKey = GlobalKey();
        await tester.pumpWidget(
  ...
  testWidgets(
    'The second page should have a back button even it has an end drawer',
    (WidgetTester tester) async {
      final Page<void> page1 = MaterialPage<void>(
        key: const ValueKey<String>('1'),
        child: Scaffold(
  ...
  testWidgets('AppBar.leading size with custom IconButton', (
    WidgetTester tester,
  ) async {
    final Key leadingKey = UniqueKey();
    final Key titleKey = UniqueKey();
  ...
  testWidgets('AppBar.leading size with custom BackButton', (
    WidgetTester tester,
  ) async {
    final Key leadingKey = UniqueKey();
    final Key titleKey = UniqueKey();
  ...
  testWidgets('AppBar.leading size with custom CloseButton', (
    WidgetTester tester,
  ) async {
    final Key leadingKey = UniqueKey();
    final Key titleKey = UniqueKey();
  ...
  testWidgets('AppBar.leading size with custom DrawerButton', (
    WidgetTester tester,
  ) async {
    final Key leadingKey = UniqueKey();
    final Key titleKey = UniqueKey();
  ...
  testWidgets(
    'AppBar back button navigates to previous page on tap with TooltipTriggerMode.tap',
    (WidgetTester tester) async {
      await tester.pumpWidget(
        MaterialApp(
          theme: ThemeData(
  ...
  testWidgets('AppBar actions padding can be adjusted', (
    WidgetTester tester,
  ) async {
