...
void main() {
  ...
  testWidgets('BottomNavigationBar multiple taps test', (
    ...
    final Offset originalOrigin = actions
        .elementAt(3)
  ...
  testWidgets(
    ...
    (WidgetTester tester) async {
      ...
      await tester.pumpWidget(
        buildApp(textScaler: const TextScaler.linear(4.0)),
      );
      expect(find.text(label), findsOneWidget);
      await tester.longPress(find.text(label));
  ...
  testWidgets('BottomNavigationBar limits width of tiles with long labels', (
    ...
    final String longTextA = List<String>.generate(
      100,
      (int index) => 'A',
    ).toString();
    final String longTextB = List<String>.generate(
      100,
      (int index) => 'B',
    ).toString();
  ...
  testWidgets('Material3 - BottomNavigationBar default layout', (
    ...
    final double labelHeight = (selectedFontSize * m3LineHeight)
        .floorToDouble(); // 20
