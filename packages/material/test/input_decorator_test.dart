...
double getBorderBottom(WidgetTester tester) {
  final RenderBox box = InputDecorator.containerOf(
    tester.element(findBorderPainter()),
  )!;
...
TextStyle getHintStyle(WidgetTester tester) {
  return tester
      .widget<RichText>(
        find.descendant(of: findHint(), matching: find.byType(RichText)),
      )
      .text
      .style!;
}
...
Animation<double> _getHoverAnimation(WidgetTester tester) {
  ...
  final Animation<double> animation =
      inputBorderPainter.hoverAnimation as Animation<double>;
  return animation;
}
...
void main() {
  ...
  group('Material3 - InputDecoration container', () {
    ...
    group('for filled text field', () {
      ...
      testWidgets(
        'default container height is 48dp on desktop',
        (WidgetTester tester) async {
          await tester.pumpWidget(
            buildInputDecorator(
              decoration: const InputDecoration(
      ...
      testWidgets(
        'Visual density defined at the decoration level takes precedence',
        (WidgetTester tester) async {
          await tester.pumpWidget(
            buildInputDecorator(
              theme: ThemeData(
      ...
      testWidgets(
        'Visual density defined at the input decoration theme level takes precedence',
        (WidgetTester tester) async {
          await tester.pumpWidget(
            buildInputDecorator(
              theme: ThemeData(
          ...
          paints
            ...
            ..path(
              ...
              includes: <Offset>[
                ...
                const Offset(
                  inputDecoratorWidth - borderRadiusScaled,
                  inputDecoratorHeight,
                ),
                // Top-right arc.
    ...
    testWidgets(
      ...
      (WidgetTester tester) async {
        ...
        RenderBox borderBox = InputDecorator.containerOf(
          tester.element(findBorderPainter()),
        )!;
        ...
        borderBox = InputDecorator.containerOf(
          tester.element(findBorderPainter()),
        )!;
    ...
    testWidgets(
      'OutlineBorder does not overlap with the label at the default radius',
      (WidgetTester tester) async {
        Widget buildFrame(TextDirection textDirection) {
          return MaterialApp(
            home: Scaffold(
  ...
  group('Material3 - InputDecoration label', () {
    group('for filled text field', () {
      testWidgets(
        'label and input horizontal positions are M3 compliant in LTR',
        (WidgetTester tester) async {
          await tester.pumpWidget(
            buildInputDecorator(
              decoration: const InputDecoration(
          ...
          const double labelAndInputStart =
              12.0 + 4.0; // Content left padding + default input gap.
      ...
      testWidgets(
        'label and input horizontal positions are M3 compliant in RTL',
        (WidgetTester tester) async {
          await tester.pumpWidget(
            buildInputDecorator(
              decoration: const InputDecoration(
    ...
    group('for outlined text field', () {
      ...
      testWidgets(
        'label and input horizontal positions can be adjusted in LTR',
        (WidgetTester tester) async {
          ...
          expect(getDecoratorRect(tester).size, const Size(800.0, 56.0));
          const double labelAndInputStart =
              12.0 + customGap; // Content left padding + input gap.
          expect(getLabelRect(tester).left, labelAndInputStart);
          expect(getInputRect(tester).left, labelAndInputStart);
        },
      );
      ...
      testWidgets(
        'label and input horizontal positions can be adjusted in RTL',
        (WidgetTester tester) async {
          const double customGap = 6.0;
          await tester.pumpWidget(
            buildInputDecorator(
    ...
    testWidgets('floatingLabelStyle overrides default style', (
      ...
      const TextStyle floatingLabelStyle = TextStyle(
        color: Colors.indigo,
        fontSize: 16.0,
      );
  ...
  group('Material3 - InputDecoration labelText layout', () {
    ...
    testWidgets(
      ...
      (WidgetTester tester) async {
        final String longStringA = String.fromCharCodes(
          List<int>.generate(200, (_) => 65),
        );
        final String longStringB = String.fromCharCodes(
          List<int>.generate(200, (_) => 66),
        );
  ...
  group('Material3 - InputDecoration label layout', () {
    ...
    testWidgets(
      ...
      (WidgetTester tester) async {
        ...
        final TextStyle floatingLabelStyle = style16.merge(
        ...
        await tester.pumpWidget(
          buildInputDecorator(
            ...
            decoration: const InputDecoration(
              label: Text.rich(TextSpan(text: 'label')),
            ),
          ),
        );
    ...
    testWidgets(
      ...
      (WidgetTester tester) async {
        ...
        final TextStyle labelStyle = styleDefaultSize.merge(
  ...
  group('Material3 - InputDecoration hint', () {
    group('for filled text field without label', () {
      ...
      group('when field is disabled', () {
        ...
        testWidgets('hint has correct style when visible', (
          ...
          final ThemeData theme = Theme.of(tester.element(findDecorator()));
          final Color expectedColor = theme.colorScheme.onSurface.withOpacity(
            0.38,
          );
          final TextStyle expectedStyle = theme.textTheme.bodyLarge!.copyWith(
            color: expectedColor,
    ...
    testWidgets(
      'InputDecorator throws Assertion Error when hint and hintText are provided',
      (WidgetTester tester) async {
        expect(() {
          buildInputDecorator(
            decoration: InputDecoration(
    ...
    testWidgets('InputDecorator shows hint widget', (
      WidgetTester tester,
    ) async {
      await tester.pumpWidget(
        buildInputDecorator(
          decoration: const InputDecoration(hint: Text('hint')),
        ),
      );
    ...
    testWidgets(
      'Widget height collapses from hint height when maintainHintSize is false',
      (WidgetTester tester) async {
    ...
    testWidgets('Widget height stays at hint height by default', (
      WidgetTester tester,
    ) async {
      final String hintText = 'hint' * 20;
      final InputDecoration decoration = InputDecoration(
      ...
      final double inputHeight = tester
    ...
    testWidgets(
      'hintFadeDuration applies to hint fade-in when maintainHintSize is false',
      (WidgetTester tester) async {
        ...
        await tester.pumpWidget(
          buildInputDecorator(isEmpty: true, decoration: decoration),
        );
    ...
    testWidgets(
      'hintFadeDuration applies to hint fade-out when maintainHintSize is false',
      (WidgetTester tester) async {
        const InputDecoration decoration = InputDecoration(
          hintText: hintText,
          hintMaxLines: 3,
  ...
  group('Material3 - InputDecoration helper/counter/error', () {
    ...
    const double fullHeight =
        containerHeight + helperGap + helperHeight; // 76.0
    ...
    group('for filled text field', () {
      group('when field is enabled', () {
        ...
        testWidgets('Helper and counter are correctly styled', (
          ...
          final ThemeData theme = Theme.of(tester.element(findDecorator()));
          final Color expectedColor = theme.colorScheme.onSurfaceVariant;
          final TextStyle expectedStyle = theme.textTheme.bodySmall!.copyWith(
            color: expectedColor,
          );
      ...
      group('when field is in error', () {
        ...
        testWidgets('Error and counter are correctly styled', (
          ...
          final TextStyle expectedCounterStyle = theme.textTheme.bodySmall!
              .copyWith(color: expectedCounterColor);
    ...
    group('Multiline error/helper', () {
      ...
      testWidgets(
        ...
        (WidgetTester tester) async {
          ...
          expect(
            getDecoratorRect(tester).height,
            closeTo(
              containerHeight + helperGap + errorHeight * numberOfLines,
              0.25,
            ),
          );
        },
      ...
      testWidgets(
        'InputDecorationTheme hintMaxLines behaves as default value',
        (WidgetTester tester) async {
          const int numberOfLines = 2;
          await tester.pumpWidget(
            buildInputDecorator(
              inputDecorationTheme: const InputDecorationTheme(
                hintMaxLines: numberOfLines,
              ),
          ...
          expect(
            getDecoratorRect(tester).height,
            closeTo(
              topPadding + hintHeight * numberOfLines + bottomPadding,
              0.25,
            ),
          );
        },
      ...
      testWidgets(
        'InputDecoration hintMaxLines default expands with hintText',
        (WidgetTester tester) async {
          const int numberOfLines = 3;
          await tester.pumpWidget(
            buildInputDecorator(
      ...
      testWidgets(
        ...
        (WidgetTester tester) async {
          ...
          expect(
            helperRect.height,
            closeTo(helperHeight * numberOfLines, 0.25),
          );
          expect(
            getDecoratorRect(tester).height,
            closeTo(
              containerHeight + helperGap + helperHeight * numberOfLines,
              0.25,
            ),
          );
        },
    ...
    testWidgets(
      ...
      (WidgetTester tester) async {
        ...
        expect(
          tester.renderObject<RenderBox>(find.text('COUNTER')).size,
          Size.zero,
        );
      },
    );
  ...
  group('Material3 - InputDecoration prefix/suffix', () {
    ...
    group('for filled text field', () {
      group('when field is enabled', () {
        testWidgets('prefixIcon is correctly positioned - LTR', (
          WidgetTester tester,
        ) async {
          await tester.pumpWidget(
            buildInputDecorator(
          ...
          expect(
            getPrefixIconRect(tester).center.dy,
        ...
        testWidgets('prefixIcon is correctly positioned - RTL', (
          WidgetTester tester,
        ) async {
          await tester.pumpWidget(
            buildInputDecorator(
          ...
          // The gap between the icon and the input should be 16 based on M3 specification.
          expect(
            tester.getRect(findPrefixIconInnerRichText()).left -
        ...
        testWidgets('suffixIcon is correctly positioned - LTR', (
          WidgetTester tester,
        ) async {
          await tester.pumpWidget(
            buildInputDecorator(
          ...
          expect(
            getSuffixIconRect(tester).center.dy,
            getContainerRect(tester).center.dy,
          );
          // Right padding is 12 per Material 3 spec.
          expect(
        ...
        testWidgets('suffixIcon is correctly positioned - RTL', (
          WidgetTester tester,
        ) async {
          await tester.pumpWidget(
            buildInputDecorator(
    ...
    testWidgets('Prefix ignores pointer when hidden', (
      ...
      await tester.tap(
        find.byType(Icon),
        warnIfMissed: false,
      ); // Not expected to find the target.
      await tester.pump();
  ...
  group('Material3 - InputDecoration collapsed', () {
    ...
    testWidgets(
      'Decoration height is set to input height on desktop',
      (WidgetTester tester) async {
    ...
    testWidgets('InputDecoration.collapsed accepts constraints', (
      WidgetTester tester,
    ) async {
      await tester.pumpWidget(
        buildInputDecorator(
    ...
    testWidgets('InputDecoration.collapsed accepts hintMaxLines', (
      WidgetTester tester,
    ) async {
      await tester.pumpWidget(
        buildInputDecorator(
      ...
      const double hintLineHeight =
          24.0; // font size = 16 and font height = 1.5.
      expect(
        getDecoratorRect(tester).size,
        const Size(800.0, 2 * hintLineHeight),
      );
    });
  ...
  testWidgets('InputDecorator counter text, widget, and null', (
    ...
    // generated widget.
    await tester.pumpWidget(
      buildFrame(buildCounter: buildCounter, maxLength: maxLength),
    );
  ...
  testWidgets('FloatingLabelAlignment.toString()', (WidgetTester tester) async {
    expect(
      FloatingLabelAlignment.start.toString(),
      'FloatingLabelAlignment.start',
    );
    expect(
      FloatingLabelAlignment.center.toString(),
  ...
  testWidgets('InputDecorator.debugDescribeChildren', (
    ...
    final RenderObject renderer = tester.renderObject(
    ...
    final Set<Object> nodeValues = Set<Object>.from(
      renderer.debugDescribeChildren().map<Object>(
        (DiagnosticsNode node) => node.value!,
      ),
    );
  ...
  testWidgets(
    'InputDecorationTheme.applyDefaults does not override non-null fields',
    (WidgetTester tester) async {
      const TextStyle themeStyle = TextStyle(color: Color(0xFF00FFFF));
      const Color themeColor = Color(0xFF00FF00);
      const InputBorder themeInputBorder = OutlineInputBorder(
  ...
  testWidgets('InputDecoration with WidgetStateInputBorder', (
    WidgetTester tester,
  ) async {
  ...
  testWidgets(
    ...
    (WidgetTester tester) async {
      ...
      await tester.pumpWidget(
        getLabeledInputDecorator(FloatingLabelBehavior.never),
      );

      final double labelWidth = getLabelRect(tester).width;

      await tester.pumpWidget(
        getLabeledInputDecorator(FloatingLabelBehavior.always),
      );
      await tester.pump(kTransitionDuration);
      ...
      final Widget target = getLabeledInputDecorator(
  ...
  testWidgets(
    ...
    (WidgetTester tester) async {
      ...
      final double constrainedHeight = tester
          .getSize(find.byKey(keyConstrained))
          .height;
      final double unConstrainedHeight = tester
          .getSize(find.byKey(keyUnconstrained))
          .height;
      expect(constrainedHeight, equals(unConstrainedHeight));

      await tester.pumpWidget(getInputDecorator(VisualDensity.compact));
      final double constrainedHeightCompact = tester
          .getSize(find.byKey(keyConstrained))
          .height;
      final double unConstrainedHeightCompact = tester
          .getSize(find.byKey(keyUnconstrained))
          .height;
  ...
  testWidgets(
    ...
    (WidgetTester tester) async {
      ...
      final double textFieldBottom = tester
  ...
  testWidgets(
    ...
    (WidgetTester tester) async {
                      ...
                      children: <Widget>[
                        ...
                        SizedBox(
                          ...
                          child: IntrinsicHeight(
                            child: TextField(key: intrinsicHeightKey),
                          ),
                        ),
                      ],
                    ),
      ...
      final double intrinsicHeight = tester
          .getSize(find.byKey(intrinsicHeightKey))
          .height;
  ...
  group('Intrinsic width', () {
    ...
    const InputDecoration decorationWithoutIcons = InputDecoration(
    ...
    testWidgets('with prefixIcon and suffixIcon in LTR', (
      WidgetTester tester,
    ) async {
      final Size textSizeWithoutIcon = await measureText(
        tester,
    ...
    testWidgets('with prefixIcon and suffixIcon in RTL', (
      WidgetTester tester,
    ) async {
      final Size textSizeWithoutIcon = await measureText(
        tester,
  ...
  test('InputDecorationTheme.copyWith keeps original iconColor', () async {
    ...
    final InputDecorationTheme copy1 = original.copyWith(
      fillColor: const Color(0xDEADCAFE),
    );
    expect(copy1.iconColor, const Color(0xDEADBEEF));
    expect(copy1.fillColor, const Color(0xDEADCAFE));
    final InputDecorationTheme copy2 = original.copyWith(
      iconColor: const Color(0xDEADCAFE),
    );
  ...
  test('InputDecorationTheme copyWith, ==, hashCode basics', () {
    ...
    expect(
      const InputDecorationTheme().hashCode,
      const InputDecorationTheme().copyWith().hashCode,
    );
  });

  test(
    'InputDecorationTheme copyWith correctly copies and replaces values',
    () {
      const InputDecorationTheme original = InputDecorationTheme(
  ...
  test('InputDecorationTheme merge', () {
    const InputDecorationTheme overrideTheme = InputDecorationTheme(
      ...
      focusedBorder: OutlineInputBorder(
        borderSide: BorderSide(color: Color(0x00000f16)),
      ),
      focusedErrorBorder: OutlineInputBorder(
        borderSide: BorderSide(color: Color(0x00000f17)),
      ),
      disabledBorder: OutlineInputBorder(
        borderSide: BorderSide(color: Color(0x00000f18)),
      ),
      enabledBorder: OutlineInputBorder(
        borderSide: BorderSide(color: Color(0x00000f19)),
      ),
      border: OutlineInputBorder(
        borderSide: BorderSide(color: Color(0x00000f20)),
      ),
      alignLabelWithHint: true,
    ...
    final InputDecorationTheme merged = inputDecorationTheme.merge(
      overrideTheme,
    );
    ...
    expect(
      merged.floatingLabelBehavior,
      isNot(overrideTheme.floatingLabelBehavior),
    );
    expect(
      merged.floatingLabelAlignment,
  ...
  group('Material2', () {
    ...
    testWidgets('InputDecorator input/hint layout', (
      ...
      expect(
        tester.getSize(find.text('hint')).width,
    ...
    testWidgets('InputDecorator error/helper/counter layout', (
      ...
      expect(
        tester.getTopRight(find.text('counter')),
        const Offset(788.0, 64.0),
      );
    ...
    testWidgets('InputDecoration errorMaxLines', (WidgetTester tester) async {
      ...
      expect(
        tester.getBottomLeft(find.text(kError3)),
        const Offset(12.0, 100.0),
      );
      ...
      expect(
        tester.getSize(find.byType(InputDecorator)),
        const Size(800.0, 88.0),
      );
      expect(tester.getTopLeft(find.text(kError2)), const Offset(12.0, 64.0));
      expect(
        tester.getBottomLeft(find.text(kError2)),
        const Offset(12.0, 88.0),
      );
      ...
      expect(
        tester.getBottomLeft(find.text(kError1)),
        const Offset(12.0, 76.0),
      );
    });
    ...
    testWidgets('InputDecoration helperMaxLines', (WidgetTester tester) async {
      ...
      expect(
        tester.getBottomLeft(find.text(kHelper3)),
        const Offset(12.0, 100.0),
      );
      ...
      expect(
        tester.getBottomLeft(find.text(kHelper2)),
        const Offset(12.0, 88.0),
      );
      ...
      expect(
        tester.getBottomLeft(find.text(kHelper1)),
        const Offset(12.0, 76.0),
      );
    });
    ...
    testWidgets('InputDecorator shows helper text', (
      ...
      await tester.pumpWidget(
        buildInputDecoratorM2(
          decoration: const InputDecoration(helperText: 'helperText'),
        ),
      );
    ...
    testWidgets('InputDecorator shows error text', (WidgetTester tester) async {
      await tester.pumpWidget(
        buildInputDecoratorM2(
          decoration: const InputDecoration(errorText: 'errorText'),
        ),
      );
    ...
    testWidgets('InputDecorator prefix/suffix widgets', (
      ...
      expect(
        tester.getTopRight(find.byKey(pKey)).dx,
    ...
    testWidgets('InputDecorator prefixIconConstraints/suffixIconConstraints', (
      ...
      expect(
        tester.getTopLeft(find.byIcon(Icons.satellite)).dy,
        (32.0 - 25.0) / 2,
      );
      expect(tester.getTopRight(find.byIcon(Icons.satellite)).dx, 800.0);
    });
      ...
      group('simple case', () {
        ...
        testWidgets('works with density and content padding', (
          ...
          final double childTop =
              visualDensity.baseSizeAdjustment.dy / 2.0 +
              contentPadding.top +
              childMargin;
    ...
    testWidgets('InputDecorator error/helper/counter RTL layout', (
      ...
      expect(
        tester.getTopRight(find.text('helper')),
        const Offset(788.0, 64.0),
      );
    ...
    testWidgets('InputDecorationTheme style overrides', (
      ...
      final TextStyle labelStyle = defaultStyle.merge(
        const TextStyle(color: Colors.red),
      );
      final TextStyle hintStyle = defaultStyle.merge(
        const TextStyle(color: Colors.green),
      );
      final TextStyle prefixStyle = defaultStyle.merge(
        const TextStyle(color: Colors.blue),
      );
      final TextStyle suffixStyle = defaultStyle.merge(
        const TextStyle(color: Colors.purple),
      );

      const TextStyle style12 = TextStyle(fontSize: 12.0);
      final TextStyle helperStyle = style12.merge(
        const TextStyle(color: Colors.orange),
      );
      final TextStyle counterStyle = style12.merge(
        const TextStyle(color: Colors.orange),
      );
      ...
      expect(
        tester.widget<Text>(find.text('prefix')).style!.color,
        prefixStyle.color,
      );
      expect(
        tester.widget<Text>(find.text('suffix')).style!.color,
        suffixStyle.color,
      );
      expect(
        tester.widget<Text>(find.text('helper')).style!.color,
        helperStyle.color,
      );
      expect(
        tester.widget<Text>(find.text('counter')).style!.color,
        counterStyle.color,
      );
      expect(getLabelStyle(tester).color, labelStyle.color);
    });
    ...
    testWidgets('InputDecorator draws and animates hoverColor', (
      ...
      expect(
        getContainerColor(tester),
        isSameColorAs(Color.alphaBlend(midHoverColor, fillColor)),
      );
    ...
    testWidgets('InputDecoration default border uses colorScheme', (
      ...
      final Color hoverColor = Color.alphaBlend(
        theme.hoverColor.withOpacity(0.12),
        enabledColor,
      );
      ...
      // Hovering
      await tester.pumpWidget(
        buildInputDecoratorM2(theme: theme, isHovering: true),
      );
      await tester.pumpAndSettle();
      ...
      // Focused
      await tester.pumpWidget(
        buildInputDecoratorM2(theme: theme, isFocused: true),
      );
      await tester.pumpAndSettle();
      expect(getBorderColor(tester), theme.colorScheme.primary);
    ...
    testWidgets('textAlignVertical can be updated', (
      ...
      expect(
        tester.getTopLeft(find.text(hintText)).dy,
        greaterThan(topPosition),
      );
    ...
    testWidgets('prefixIcon in RTL with asymmetric padding', (
      ...
      final Offset(dx: double decoratorRight) = tester.getTopRight(
        find.byType(InputDecorator),
      );
      final Offset(dx: double prefixRight) = tester.getTopRight(
        find.byType(Icon),
      );
