...
void main() {
  ...
  testWidgets('label position test - show disabledHint: disable', (
    WidgetTester tester,
  ) async {
    int? value;
  ...
  testWidgets('label position test - show hint: enable + empty item', (
    WidgetTester tester,
  ) async {
    int? value;
  ...
  testWidgets('DropdownButtonFormField with autovalidation test', (
    WidgetTester tester,
  ) async {
    String? value = 'one';
  ...
  testWidgets(
    ...
    (WidgetTester tester) async {
      ...
      await tester.pumpWidget(
        buildFormFrame(buttonKey: buttonKey, onChanged: onChanged),
      );
      final RenderBox buttonBox = tester.renderObject<RenderBox>(
        find.byKey(buttonKey),
      );
      ...
      // heights are not.
      final List<double> itemBoxesHeight = itemBoxes
      ...
      for (final RenderBox itemBox in itemBoxes) {
        ...
        final Offset buttonBoxCenter = buttonBox.size.center(
          buttonBox.localToGlobal(Offset.zero),
        );
        final Offset itemBoxCenter = itemBox.size.center(
  ...
  // Regression test for https://github.com/flutter/flutter/issues/159971.
  testWidgets(
    'DropdownButtonFormField with custom text style does not clip large scale text',
    (WidgetTester tester) async {
      final Key buttonKey = UniqueKey();
      const String value = 'two';
      const double scaleFactor = 3.0;
  ...
  testWidgets('DropdownButtonFormField.isDense is true by default', (
    WidgetTester tester,
  ) async {
  ...
  testWidgets('DropdownButtonFormField - custom text style', (
    WidgetTester tester,
  ) async {
  ...
  testWidgets('DropdownButtonFormField - Custom icon size and colors', (
    WidgetTester tester,
  ) async {
  ...
  testWidgets('DropdownButtonFormField - default elevation', (
    WidgetTester tester,
  ) async {
    final Key buttonKey = UniqueKey();
    ...
    final Finder customPaint = find
        .ancestor(of: find.text('one').last, matching: find.byType(CustomPaint))
        .last;
  ...
  testWidgets('DropdownButtonFormField - custom elevation', (
    WidgetTester tester,
  ) async {
    debugDisableShadows = false;
  ...
  testWidgets(
    ...
    (WidgetTester tester) async {
      final List<DropdownMenuItem<String>> itemsWithDuplicateValues =
          <String>['a', 'b', 'c', 'd'].map<DropdownMenuItem<String>>((
            String value,
          ) {
            return DropdownMenuItem<String>(value: value, child: Text(value));
          }).toList();
  ...
  testWidgets('DropdownButton onTap callback is called when defined', (
    ...
    Widget build() =>
        buildFormFrame(value: value, onChanged: onChanged, onTap: onTap);
    await tester.pumpWidget(build());
  ...
  testWidgets('DropdownButtonFormField - Custom button alignment', (
    WidgetTester tester,
  ) async {
    await tester.pumpWidget(
      buildFormFrame(
  ...
  testWidgets(
    'DropdownButtonFormField with onChanged set to null does not throw on form reset',
    (WidgetTester tester) async {
  ...
  testWidgets('Error visual logic is delegated to InputDecorator', (
    WidgetTester tester,
  ) async {
    final GlobalKey<FormState> formKey = GlobalKey<FormState>();
    ...
    final InputDecorator inputDecorator = tester.widget(
  ...
  testWidgets('Widget returned by errorBuilder is shown', (
    WidgetTester tester,
  ) async {
    await tester.pumpWidget(
      MaterialApp(
  ...
  testWidgets(
    'ButtonTheme.alignedDropdown does not affect the field content position',
    (WidgetTester tester) async {
      Widget buildFrame({
      ...
      expect(
        tester.getRect(findSelectedValue),
        contentRectForUnalignedDropdown,
      );

      await tester.pumpWidget(
        buildFrame(alignedDropdown: false, textDirection: TextDirection.rtl),
      );
  ...
  testWidgets(
    'isValid returns false when forceErrorText is set and changes error display',
    (WidgetTester tester) async {
  ...
  testWidgets(
    'forceErrorText overrides InputDecoration.error when both are provided',
    (WidgetTester tester) async {
      const String forceErrorText = 'Forcing error';
  ...
  testWidgets('dropdown closes when barrier is tapped by default', (
    WidgetTester tester,
  ) async {
    await tester.pumpWidget(
      MaterialApp(
  ...
  testWidgets('DropdownButtonFormField icon is aligned with label text', (
    ...
    expect(
      tester.getCenter(find.text(labelText)).dy,
      tester.getCenter(find.byType(Icon).last).dy,
    );
  });
}
