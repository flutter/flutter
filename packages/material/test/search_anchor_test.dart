...
void main() {
  ...
  testWidgets('SearchBar focusNode is hot swappable', (
    ...
    await tester.pumpWidget(
      const MaterialApp(home: Material(child: SearchBar())),
    );
  ...
  testWidgets('SearchBar respects textCapitalization property', (
    ...
    Widget buildSearchBar(TextCapitalization textCapitalization) {
      return MaterialApp(
        home: Center(
          child: Material(
            child: SearchBar(textCapitalization: textCapitalization),
          ),
        ),
      );
    }
  ...
  testWidgets(
    'SearchAnchor.bar respects onChanged and onSubmitted properties',
    (WidgetTester tester) async {
      final SearchController controller = SearchController();
      addTearDown(controller.dispose);
      int onChangedCalled = 0;
  ...
  testWidgets('SearchAnchor respects headerTextStyle property', (
    ...
    await tester.pumpWidget(
      MaterialApp(
        home: Material(
          child: SearchAnchor(
            headerTextStyle: theme.textTheme.bodyLarge?.copyWith(
              color: Colors.red,
            ),
            builder: (BuildContext context, SearchController controller) {
              return IconButton(
    ...
    await tester.pumpWidget(
      MaterialApp(
        home: Material(
          child: SearchAnchor(
            viewHintText: 'hint text',
            headerHintStyle: theme.textTheme.bodyLarge?.copyWith(
              color: Colors.orange,
            ),
            builder: (BuildContext context, SearchController controller) {
              return IconButton(
  ...
  testWidgets('SearchAnchor respects viewPadding property', (
    WidgetTester tester,
  ) async {
    await tester.pumpWidget(
      MaterialApp(
    ...
    final Padding padding = tester.widget<Padding>(
      find
          .descendant(of: findViewContent(), matching: find.byType(Padding))
          .first,
    );
  ...
  testWidgets('SearchAnchor respects shrinkWrap property', (
    WidgetTester tester,
  ) async {
    await tester.pumpWidget(
      MaterialApp(
    ...
    expect(
      ...
      equals(const Rect.fromLTRB(0.0, 0.0, 800.0, 56.0)),
    );
    ...
    expect(
      materialRectWithSuggestions,
      equals(const Rect.fromLTRB(0.0, 0.0, 800.0, 113.0)),
    );
  });
  ...
  testWidgets('SearchAnchor respects viewBarPadding property', (
    WidgetTester tester,
  ) async {
    await tester.pumpWidget(
      MaterialApp(
                  ...
                  child: SearchAnchor(
                    ...
                    suggestionsBuilder:
                        (BuildContext context, SearchController controller) {
                          ...
                          final Iterable<String> filterSuggestions = suggestions
                              .where(
  ...
  group('SearchAnchor text selection', () {
    testWidgets(
      'can right-click to select word',
      (WidgetTester tester) async {
        const String defaultText = 'initial text';
        final SearchController controller = SearchController();
        addTearDown(controller.dispose);
    ...
    testWidgets('can click to set position', (WidgetTester tester) async {
      ...
      final TestGesture gesture = await _pointGestureToSearchBar(tester);
      await gesture.down(
        textOffsetToPosition(tester, 2) + const Offset(0.0, -9.0),
      );
      await tester.pump();
      await gesture.up();
  ...
  testWidgets('Search view widgets can inherit local themes', (
    ...
    expect(
      searchViewMaterial.color,
      localTheme.colorScheme.surfaceContainerHigh,
    );
    ...
    expect(
      ...
      localTheme.iconButtonTheme.style?.backgroundColor?.resolve(
        <MaterialState>{},
      ),
    );
  ...
  testWidgets('Block entering text on disabled widget', (
    ...
    await tester.pumpWidget(
      MaterialApp(
        home: Material(
          child: Center(
            child: SearchBar(controller: controller, enabled: false),
          ),
        ),
      ),
    );
  ...
  testWidgets(
    'Disabled SearchBar semantics node still contains value and inputType',
    (WidgetTester tester) async {
  ...
  testWidgets('SearchBar semantics node has search input type', (
    WidgetTester tester,
  ) async {
    final SemanticsTester semantics = SemanticsTester(tester);
  ...
  testWidgets('Check SearchAnchor opacity when disabled', (
    WidgetTester tester,
  ) async {
    await tester.pumpWidget(
      MaterialApp(
    ...
    expect(opacityFinder, findsOneWidget);
    final AnimatedOpacity opacityWidget = tester.widget<AnimatedOpacity>(
      opacityFinder,
    );
    expect(opacityWidget.opacity, 0.38);
  });

  testWidgets('SearchAnchor tap failed when disabled', (
    WidgetTester tester,
  ) async {
    await tester.pumpWidget(
      MaterialApp(
  ...
  testWidgets(
    'suggestionsBuilder with Future is not called twice on layout resize',
    (WidgetTester tester) async {
  ...
  // This is a regression test for https://github.com/flutter/flutter/issues/139880.
  testWidgets(
    'suggestionsBuilder is not called when the search value does not change',
    (WidgetTester tester) async {
  ...
  testWidgets('Suggestions gets refreshed after long API call', (
    WidgetTester tester,
  ) async {
    Timer? debounceTimer;
            ...
            child: SearchAnchor(
              ...
              suggestionsBuilder:
                  (BuildContext context, SearchController controller) async {
                    ...
                    final List<Widget> suggestions = List<Widget>.generate(
                      options.length,
                      (int index) {
  ...
  testWidgets(
    'SearchAnchor.bar.scrollPadding is passed through to EditableText',
    (WidgetTester tester) async {
      const EdgeInsets scrollPadding = EdgeInsets.zero;
      await tester.pumpWidget(
        MaterialApp(
  ...
  group('contextMenuBuilder', () {
    ...
    testWidgets(
      'SearchAnchor.bar.contextMenuBuilder is passed through to EditableText',
      (WidgetTester tester) async {
  ...
  testWidgets('SearchAnchor does not dispose external SearchController', (
    ...
    await tester.pumpAndSettle();
    await tester.pumpWidget(
      const MaterialApp(home: Material(child: Text('disposed'))),
    );
  ...
  testWidgets(
    'disposing SearchAnchor during search view exit animation does not crash',
    (WidgetTester tester) async {
  ...
  testWidgets('SearchAnchor viewOnClose function test', (
    WidgetTester tester,
  ) async {
    String name = 'silva';
    await tester.pumpWidget(
  ...
  testWidgets('SearchAnchor.bar viewOnClose function test', (
    WidgetTester tester,
  ) async {
    String name = 'silva';
  ...
  testWidgets(
    'SearchAnchor viewOnOpen is called when the search view is opened',
    (WidgetTester tester) async {
  ...
  testWidgets(
    'SearchAnchor.bar onOpen is called when the search view is opened',
    (WidgetTester tester) async {
      String searchViewState = 'Idle';
      await tester.pumpWidget(
        MaterialApp(
  ...
  testWidgets(
    ...
    (WidgetTester tester) async {
      ...
      final double physicalBottomPadding =
          fakeKeyboardHeight * tester.view.devicePixelRatio;
