...
void main() {
  ...
  testWidgets(
    'TextButton.defaultStyle produces a ButtonStyle with appropriate non-null values',
  ...
  testWidgets(
    'TextButton.icon produces the correct widgets when icon is null',
    (WidgetTester tester) async {
      const ColorScheme colorScheme = ColorScheme.light();
      final ThemeData theme = ThemeData.from(colorScheme: colorScheme);
      final Key iconButtonKey = UniqueKey();
  ...
  testWidgets('TextButton icon alignment can be customized', (
    WidgetTester tester,
  ) async {
    Widget buildWidget({
  ...
  testWidgets('TextButton.styleFrom can customize the button icon', (
    WidgetTester tester,
  ) async {
  ...
  testWidgets(
    'TextButton icon uses provided foregroundColor over default icon color',
    (WidgetTester tester) async {
  ...
  testWidgets('TextButton text and icon respect animation duration', (
    WidgetTester tester,
  ) async {
