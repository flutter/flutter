...
void main() {
  ...
  testWidgets(
    'Material3 - FlexibleSpaceBarSettings provides settings to a FlexibleSpaceBar',
  ...
  testWidgets(
    'Material2 - FlexibleSpaceBarSettings provides settings to a FlexibleSpaceBar',
    (WidgetTester tester) async {
      const double minExtent = 100.0;
      const double initExtent = 200.0;
      const double maxExtent = 300.0;
  ...
  testWidgets(
    'Material3 - FlexibleSpaceBar sets width constraints for the title',
    (WidgetTester tester) async {
  ...
  // This is a regression test for https://github.com/flutter/flutter/issues/14227
  testWidgets(
    'Material2 - FlexibleSpaceBar sets width constraints for the title',
    (WidgetTester tester) async {
      const double titleFontSize = 20.0;
      const double height = 300.0;
      late double width;
  ...
  testWidgets('Material3 - FlexibleSpaceBar scaled title', (
    WidgetTester tester,
  ) async {
    const double titleFontSize = 20.0;
    const double height = 300.0;
    ...
    await expectLater(
      flexibleSpaceBar,
      matchesGoldenFile(
        'flexible_space_bar.m3.expanded_title_scale_default.collapsed.png',
      ),
    );
    ...
    await expectLater(
      flexibleSpaceBar,
      matchesGoldenFile(
        'flexible_space_bar.m3.expanded_title_scale_default.expanded.png',
      ),
    );
  });

  testWidgets('Material2 - FlexibleSpaceBar scaled title', (
    WidgetTester tester,
  ) async {
    const double titleFontSize = 20.0;
    const double height = 300.0;
    ...
    await expectLater(
      flexibleSpaceBar,
      matchesGoldenFile(
        'flexible_space_bar.m2.expanded_title_scale_default.collapsed.png',
      ),
    );
    ...
    await expectLater(
      flexibleSpaceBar,
      matchesGoldenFile(
        'flexible_space_bar.m2.expanded_title_scale_default.expanded.png',
      ),
    );
  });

  testWidgets(
    'Material3 - FlexibleSpaceBar scaled title - override expandedTitleScale',
    (WidgetTester tester) async {
      const double titleFontSize = 20.0;
      const double height = 300.0;
      const double expandedTitleScale = 3.0;
      ...
      await expectLater(
        flexibleSpaceBar,
        matchesGoldenFile(
          'flexible_space_bar.m3.expanded_title_scale_override.expanded.png',
        ),
      );
    },
  );
  ...
  testWidgets(
    'Material2 - FlexibleSpaceBar scaled title - override expandedTitleScale',
    (WidgetTester tester) async {
      const double titleFontSize = 20.0;
      const double height = 300.0;
      const double expandedTitleScale = 3.0;
      ...
      await expectLater(
        flexibleSpaceBar,
        matchesGoldenFile(
          'flexible_space_bar.m2.expanded_title_scale_override.expanded.png',
        ),
      );
    },
  );

  testWidgets('Material3 - FlexibleSpaceBar titlePadding defaults', (
    WidgetTester tester,
  ) async {
  ...
  testWidgets('Material2 - FlexibleSpaceBar titlePadding defaults', (
    WidgetTester tester,
  ) async {
    Widget buildFrame(TargetPlatform platform, bool? centerTitle) {
      return MaterialApp(
  ...
  testWidgets('Material3 - FlexibleSpaceBar titlePadding override', (
    WidgetTester tester,
  ) async {
    Widget buildFrame(TargetPlatform platform, bool? centerTitle) {
      return MaterialApp(
  ...
  testWidgets('Material2 - FlexibleSpaceBar titlePadding override', (
    WidgetTester tester,
  ) async {
    Widget buildFrame(TargetPlatform platform, bool? centerTitle) {
      return MaterialApp(
  ...
  testWidgets('FlexibleSpaceBar rebuilds when scrolling.', (
    ...
    expect(
      tester.layers.lastWhere((Layer element) => element is OpacityLayer),
      isA<OpacityLayer>().having(
        (OpacityLayer p0) => p0.alpha,
        'alpha',
        lessThan(255),
      ),
    );
          ...
          home: Material(
            child: NestedScrollView(
              ...
              body: const SingleChildScrollView(
                child: Column(
                  children: <Widget>[Placeholder(fallbackHeight: 300.0)],
                ),
              ),
            ),
          ),
  ...
  testWidgets('Material3 - Default title color', (WidgetTester tester) async {
    ...
    final DefaultTextStyle textStyle = DefaultTextStyle.of(
