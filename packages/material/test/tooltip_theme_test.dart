...
void main() {
  ...
  testWidgets('Tooltip message textStyle - ThemeData.tooltipTheme', (
    ...
    final TextStyle textStyle = tester
        .widget<Text>(find.text(tooltipText))
        .style!;
  ...
  testWidgets('Tooltip respects constraints from the ambient theme', (
    WidgetTester tester,
  ) async {
    final GlobalKey<TooltipState> tooltipKey = GlobalKey<TooltipState>();
    const BoxConstraints themeConstraints = BoxConstraints.tightFor(
      width: 300,
      height: 150,
    );
    await tester.pumpWidget(
      MaterialApp(
        theme: ThemeData(
          tooltipTheme: const TooltipThemeData(constraints: themeConstraints),
        ),
        home: Tooltip(
          key: tooltipKey,
          message: tooltipText,
    ...
    expect(
      tester.element(textAncestors.first).size,
      equals(themeConstraints.biggest),
    );
  });
}
