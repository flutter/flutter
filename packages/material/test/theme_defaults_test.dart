...
void main() {
  group('FloatingActionButton', () {
    const BoxConstraints defaultFABConstraints = BoxConstraints.tightFor(
      width: 56.0,
      height: 56.0,
    );
    ...
    testWidgets('Material2 - theme: ThemeData.light(), enabled: true', (
      WidgetTester tester,
    ) async {
    ...
    testWidgets('Material3 - theme: ThemeData.light(), enabled: true', (
      WidgetTester tester,
    ) async {
