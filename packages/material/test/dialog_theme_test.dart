...
void main() {
  test('DialogThemeData copyWith, ==, hashCode basics', () {
    ...
    expect(
      const DialogThemeData().hashCode,
      const DialogThemeData().copyWith().hashCode,
    );
  });
  ...
  testWidgets('Default DialogThemeData debugFillProperties', (
    WidgetTester tester,
  ) async {
  ...
  testWidgets('DialogThemeData implements debugFillProperties', (
    WidgetTester tester,
  ) async {
    final DiagnosticPropertiesBuilder builder = DiagnosticPropertiesBuilder();
  ...
  testWidgets('Local DialogThemeData overrides dialog defaults', (
    WidgetTester tester,
  ) async {
    ...
    await tester.pumpWidget(
      _appWithDialog(tester, dialog, dialogTheme: dialogTheme),
    );
    ...
    expect(
      _getIconRenderObject(tester, Icons.search).text.style?.color,
      themeIconColor,
    );
    expect(
      _getTextRenderObject(tester, 'Title').text.style?.color,
      themeTitleTextStyle.color,
    );
    expect(
      _getTextRenderObject(tester, 'Content').text.style?.color,
      themeContentTextStyle.color,
    );
  ...
  testWidgets('Local DialogThemeData overrides global dialogTheme', (
    WidgetTester tester,
  ) async {
    const Color themeBackgroundColor = Color(0xff123456);
    const double themeElevation = 8.0;
    ...
    const TextStyle globalContentTextStyle = TextStyle(
  ...
  testWidgets('Dialog.clipBehavior takes priority over theme', (
    WidgetTester tester,
  ) async {
  ...
  testWidgets(
    'DialogThemeData.constraints is respected if Dialog.constraints is null',
