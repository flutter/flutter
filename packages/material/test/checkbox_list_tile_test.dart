...
void main() {
  ...
  testWidgets('CheckboxListTile uses ListTileTheme controlAffinity', (
    WidgetTester tester,
  ) async {
  ...
  testWidgets('CheckboxListTile renders with default scale', (
    WidgetTester tester,
  ) async {
    await tester.pumpWidget(
      const MaterialApp(
        home: Material(child: CheckboxListTile(value: false, onChanged: null)),
      ),
    );
  ...
  testWidgets('CheckboxListTile respects checkboxScaleFactor', (
    WidgetTester tester,
  ) async {
  ...
  testWidgets('CheckboxListTile isThreeLine', (WidgetTester tester) async {
    ...
    Widget buildFrame({
      bool? themeDataIsThreeLine,
      bool? themeIsThreeLine,
      bool? isThreeLine,
    }) {
      return MaterialApp(
        key: UniqueKey(),
        theme: themeDataIsThreeLine != null
            ? ThemeData(
                listTileTheme: ListTileThemeData(
                  isThreeLine: themeDataIsThreeLine,
                ),
              )
            : null,
        home: Material(
    ...
    await tester.pumpWidget(
      buildFrame(themeDataIsThreeLine: false, themeIsThreeLine: true),
    );
    expectThreeLine();

    await tester.pumpWidget(
      buildFrame(themeDataIsThreeLine: true, themeIsThreeLine: false),
    );
    expectTwoLine();
    ...
    await tester.pumpWidget(
      buildFrame(themeIsThreeLine: true, isThreeLine: false),
    );
    expectTwoLine();

    await tester.pumpWidget(
      buildFrame(themeDataIsThreeLine: true, isThreeLine: false),
    );
    expectTwoLine();

    await tester.pumpWidget(
      buildFrame(
        themeDataIsThreeLine: true,
        themeIsThreeLine: true,
        isThreeLine: false,
      ),
    );
    expectTwoLine();
    ...
    await tester.pumpWidget(
      buildFrame(themeIsThreeLine: false, isThreeLine: true),
    );
    expectThreeLine();

    await tester.pumpWidget(
      buildFrame(themeDataIsThreeLine: false, isThreeLine: true),
    );
    expectThreeLine();

    await tester.pumpWidget(
      buildFrame(
        themeDataIsThreeLine: false,
        themeIsThreeLine: false,
        isThreeLine: true,
      ),
    );
    expectThreeLine();
  ...
  testWidgets('CheckboxListTile.adaptive isThreeLine', (
    WidgetTester tester,
  ) async {
    const double height = 300;
  ...
  testWidgets('titleAlignment position with title widget', (
    ...
    final double centerPositionCheckbox =
        (tileHeight / 2) - (checkboxHeight / 2);
    final double centerPositionSecondary =
        (tileHeight / 2) - (secondaryHeight / 2);
    ...
    expect(
      find.byWidgetPredicate((Widget widget) {
        return widget is ListTile &&
            widget.titleAlignment == ListTileTitleAlignment.threeLine;
      }),
      findsOne,
    );
    ...
    expect(
      find.byWidgetPredicate((Widget widget) {
        return widget is ListTile &&
            widget.titleAlignment == ListTileTitleAlignment.titleHeight;
      }),
      findsOne,
    );
    tileOffset = tester.getTopLeft(find.byType(ListTile));
    ...
    expect(
      checkboxOffset.dy - tileOffset.dy,
      (tileHeight - checkboxHeight) / 2,
    );
    expect(secondaryOffset.dy - tileOffset.dy, centerPositionSecondary);

    // Test [ListTileTitleAlignment.top] alignment.
    await tester.pumpWidget(
      buildFrame(titleAlignment: ListTileTitleAlignment.top),
    );
    expect(
      find.byWidgetPredicate((Widget widget) {
        return widget is ListTile &&
            widget.titleAlignment == ListTileTitleAlignment.top;
      }),
      findsOne,
    );
    tileOffset = tester.getTopLeft(find.byType(ListTile));
    ...
    expect(
      find.byWidgetPredicate((Widget widget) {
        return widget is ListTile &&
            widget.titleAlignment == ListTileTitleAlignment.center;
      }),
      findsOne,
    );
    tileOffset = tester.getTopLeft(find.byType(ListTile));
    ...
    expect(
      find.byWidgetPredicate((Widget widget) {
        return widget is ListTile &&
            widget.titleAlignment == ListTileTitleAlignment.bottom;
      }),
      findsOne,
    );
    tileOffset = tester.getTopLeft(find.byType(ListTile));
    ...
    final double bottomPositionCheckbox =
        tileHeight - minVerticalPadding - checkboxHeight;
    final double bottomPositionSecondary =
        tileHeight - minVerticalPadding - secondaryHeight;
  ...
  testWidgets('titleAlignment position with title and subtitle widgets', (
    ...
    // Leading and trailing widgets are centered vertically in the tile.
    final double centerPositionOffsetCheckbox =
        (tileHeight / 2) - (checkboxHeight / 2);
    final double centerPositionOffsetSecondary =
        (tileHeight / 2) - (secondaryHeight / 2);
    ...
    // the bottom of the subtitle widget.
    final double bottomPositionCheckbox =
        tileHeight - verticalPadding - checkboxHeight;
    final double bottomPositionSecondary =
        tileHeight - verticalPadding - secondaryHeight;
    expect(checkboxOffset.dy - tileOffset.dy, bottomPositionCheckbox);
    expect(secondaryOffset.dy - tileOffset.dy, bottomPositionSecondary);
  });
}
