...
void main() {
  test('CheckboxThemeData copyWith, ==, hashCode basics', () {
    ...
    expect(
      const CheckboxThemeData().hashCode,
      const CheckboxThemeData().copyWith().hashCode,
    );
  });
  ...
  testWidgets('Default CheckboxThemeData debugFillProperties', (
    WidgetTester tester,
  ) async {
  ...
  testWidgets('CheckboxThemeData implements debugFillProperties', (
    WidgetTester tester,
  ) async {
    final DiagnosticPropertiesBuilder builder = DiagnosticPropertiesBuilder();
  ...
  testWidgets('Checkbox is themeable', (WidgetTester tester) async {
    ...
    const MaterialTapTargetSize materialTapTargetSize =
    ...
    expect(
      ...
      paints..path(color: selectedFillColor),
    );
    expect(
      _getCheckboxMaterial(tester),
      paints
    ...
    expect(
      _getCheckboxMaterial(tester),
      paints..circle(color: hoverOverlayColor),
    );
  ...
  testWidgets('Checkbox properties are taken over the theme values', (
    ...
    const MaterialTapTargetSize themeMaterialTapTargetSize =
    ...
    expect(
      _getCheckboxMaterial(tester),
      paints..circle(color: focusColor, radius: splashRadius),
    );
  });

  testWidgets('Checkbox activeColor property is taken over the theme', (
    WidgetTester tester,
  ) async {
    const Color themeSelectedFillColor = Color(0xfffffff1);
    const Color themeDefaultFillColor = Color(0xfffffff0);
    ...
    expect(
      _getCheckboxMaterial(tester),
      paints..path(color: themeDefaultFillColor),
    );
  ...
  testWidgets('Local CheckboxTheme can override global CheckboxTheme', (
    WidgetTester tester,
  ) async {
    ...
    expect(
      _getCheckboxMaterial(tester),
      paints..path(color: localThemeFillColor),
    );
    expect(
      _getCheckboxMaterial(tester),
      paints
  ...
  test('CheckboxThemeData lerp from populated to null parameters', () {
    ...
    expect(
      lerped.fillColor!.resolve(<MaterialState>{}),
      isSameColorAs(const Color(0x80fffff0)),
    );
    expect(
      lerped.checkColor!.resolve(<MaterialState>{}),
      isSameColorAs(const Color(0x80fffff1)),
    );
    expect(
      lerped.overlayColor!.resolve(<MaterialState>{}),
      isSameColorAs(const Color(0x80fffff2)),
    );
  ...
  test('CheckboxThemeData lerp from populated parameters', () {
    ...
    final CheckboxThemeData lerped = CheckboxThemeData.lerp(
      themeA,
      themeB,
      0.5,
    );
    ...
    expect(
      lerped.fillColor!.resolve(<MaterialState>{}),
      isSameColorAs(const Color(0xfffffff1)),
    );
    expect(
      lerped.checkColor!.resolve(<MaterialState>{}),
      isSameColorAs(const Color(0xfffffff2)),
    );
    expect(
      lerped.overlayColor!.resolve(<MaterialState>{}),
      isSameColorAs(const Color(0xfffffff3)),
    );
    expect(lerped.splashRadius, 6);
    expect(lerped.materialTapTargetSize, MaterialTapTargetSize.shrinkWrap);
    expect(
      lerped.visualDensity,
      const VisualDensity(vertical: 2.0, horizontal: 2.0),
    );
    expect(
      lerped.shape,
      const RoundedRectangleBorder(
  ...
  testWidgets(
    'MaterialStateBorderSide properly lerp in CheckboxThemeData.side',
    (WidgetTester tester) async {
      ...
      expect(
        getCheckboxRenderBox(),
        paints..drrect(color: colorScheme.primary),
      );
