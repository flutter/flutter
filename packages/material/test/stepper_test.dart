...
void main() {
  ...
  testWidgets('Stepper steps can be clipped', (WidgetTester tester) async {
    ...
    await tester.pumpWidget(
      buildStepper(type: StepperType.vertical, clipBehavior: Clip.hardEdge),
    );
  ...
  testWidgets('Vertical stepper border displays correctly', (
    WidgetTester tester,
  ) async {
    int index = 0;
          ...
          body: Center(
            child: StatefulBuilder(
              builder: (BuildContext context, StateSetter setState) {
                return Stepper(
                  currentStep: index,
                  connectorColor: const WidgetStatePropertyAll<Color>(
                    connectorColor,
                  ),
