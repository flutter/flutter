...
void main() {
  ...
  test('TextTheme apply letterSpacingFactor letterSpacingDelta', () {
    ...
    expect(
      sizeTheme.titleLarge!.letterSpacing,
      baseTheme.titleLarge!.letterSpacing! * 2.0 + 5.0,
    );
    expect(
      sizeTheme.titleMedium!.letterSpacing,
      baseTheme.titleMedium!.letterSpacing! * 2.0 + 5.0,
    );
    expect(
      sizeTheme.titleSmall!.letterSpacing,
      baseTheme.titleSmall!.letterSpacing! * 2.0 + 5.0,
    );
    expect(
      sizeTheme.bodyLarge!.letterSpacing,
      baseTheme.bodyLarge!.letterSpacing! * 2.0 + 5.0,
    );
    expect(
      sizeTheme.bodyMedium!.letterSpacing,
      baseTheme.bodyMedium!.letterSpacing! * 2.0 + 5.0,
    );
    expect(
      sizeTheme.bodySmall!.letterSpacing,
      baseTheme.bodySmall!.letterSpacing! * 2.0 + 5.0,
    );
    expect(
      sizeTheme.labelLarge!.letterSpacing,
      baseTheme.labelLarge!.letterSpacing! * 2.0 + 5.0,
    );
    expect(
      sizeTheme.labelMedium!.letterSpacing,
      baseTheme.labelMedium!.letterSpacing! * 2.0 + 5.0,
    );
    expect(
      sizeTheme.labelSmall!.letterSpacing,
      baseTheme.labelSmall!.letterSpacing! * 2.0 + 5.0,
    );
  });
  ...
  test('TextTheme apply heightFactor heightDelta', () {
    ...
    final TextTheme baseTheme = Typography.englishLike2021.merge(
      typography.black,
    );
    final TextTheme sizeTheme = baseTheme.apply(
      heightFactor: 2.0,
    ...
    expect(
      sizeTheme.displayLarge!.height,
      baseTheme.displayLarge!.height! * 2.0 + 5.0,
    );
    expect(
      sizeTheme.displayMedium!.height,
      baseTheme.displayMedium!.height! * 2.0 + 5.0,
    );
    expect(
      sizeTheme.displaySmall!.height,
      baseTheme.displaySmall!.height! * 2.0 + 5.0,
    );
    expect(
      sizeTheme.headlineLarge!.height,
      baseTheme.headlineLarge!.height! * 2.0 + 5.0,
    );
    expect(
      sizeTheme.headlineMedium!.height,
      baseTheme.headlineMedium!.height! * 2.0 + 5.0,
    );
    expect(
      sizeTheme.headlineSmall!.height,
      baseTheme.headlineSmall!.height! * 2.0 + 5.0,
    );
    expect(
      sizeTheme.titleLarge!.height,
      baseTheme.titleLarge!.height! * 2.0 + 5.0,
    );
    expect(
      sizeTheme.titleMedium!.height,
      baseTheme.titleMedium!.height! * 2.0 + 5.0,
    );
    expect(
      sizeTheme.titleSmall!.height,
      baseTheme.titleSmall!.height! * 2.0 + 5.0,
    );
    expect(
      sizeTheme.bodyLarge!.height,
      baseTheme.bodyLarge!.height! * 2.0 + 5.0,
    );
    expect(
      sizeTheme.bodyMedium!.height,
      baseTheme.bodyMedium!.height! * 2.0 + 5.0,
    );
    expect(
      sizeTheme.bodySmall!.height,
      baseTheme.bodySmall!.height! * 2.0 + 5.0,
    );
    expect(
      sizeTheme.labelLarge!.height,
      baseTheme.labelLarge!.height! * 2.0 + 5.0,
    );
    expect(
      sizeTheme.labelMedium!.height,
      baseTheme.labelMedium!.height! * 2.0 + 5.0,
    );
    expect(
      sizeTheme.labelSmall!.height,
      baseTheme.labelSmall!.height! * 2.0 + 5.0,
    );
  });
  ...
  testWidgets(
    'TextTheme.of(context) is equivalent to Theme.of(context).textTheme',
  ...
  testWidgets(
    'TextTheme.primaryOf(context) is equivalent to Theme.of(context).primaryTextTheme',
    (WidgetTester tester) async {
      const Key sizedBoxKey = Key('sizedBox');
