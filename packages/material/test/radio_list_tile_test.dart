...
void main() {
  ...
  testWidgets('RadioListTile uses ListTileTheme controlAffinity', (
    WidgetTester tester,
  ) async {
  ...
  testWidgets('RadioListTile.adaptive isThreeLine', (
    WidgetTester tester,
  ) async {
    const double height = 300;
  ...
  testWidgets('titleAlignment position with title widget', (
    ...
    final double bottomPositionRadio =
        tileHeight - minVerticalPadding - radioHeight;
  ...
  testWidgets('titleAlignment position with title and subtitle widgets', (
    ...
    // Leading and trailing widgets are centered vertically in the tile.
    final double centerPositionOffsetRadio =
        (tileHeight / 2) - (radioHeight / 2);
    ...
    // the bottom of the subtitle widget.
    final double bottomPositionRadio =
        tileHeight - verticalPadding - radioHeight;
    final double bottomPositionSecondary =
