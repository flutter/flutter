...
void main() {
                ...
                TestSemantics(
                  children: <TestSemantics>[
                    TestSemantics(
                      ...
                      label: 'Scrim',
                      hintOverrides: const SemanticsHintOverrides(
      ...
      return MaterialApp(
        theme: ThemeData(
          bottomSheetTheme: BottomSheetThemeData(
            dragHandleColor: MaterialStateColor.resolveWith((
  ...
  testWidgets('Drag handle interactive area size at minimum possible size', (
    ...
    final GlobalKey<ScaffoldState> scaffoldKey = GlobalKey<ScaffoldState>();
    await tester.pumpWidget(
      buildScaffold(scaffoldKey, dragHandleSize: smallerDragHandleSize),
    );
  ...
  testWidgets('Drag handle interactive area size at given dragHandleSize', (
    ...
    final GlobalKey<ScaffoldState> scaffoldKey = GlobalKey<ScaffoldState>();
    await tester.pumpWidget(
      buildScaffold(scaffoldKey, dragHandleSize: extendedDragHandleSize),
    );
  ...
  testWidgets('showModalBottomSheet does not use root Navigator by default', (
    ...
    final double tabBarHeight = tester
        .getSize(find.byType(BottomNavigationBar))
        .height;
    expect(
  ...
  testWidgets(
    ...
    (WidgetTester tester) async {
      final GlobalKey<ScaffoldState> scaffoldKey = GlobalKey<ScaffoldState>();
      final _StatusTestAnimationController controller =
          _StatusTestAnimationController(
            vsync: const TestVSync(),
            duration: const Duration(seconds: 2),
            reverseDuration: const Duration(seconds: 2),
          );
                  ...
                  child: Column(
                    children: <Widget>[
                      ElevatedButton(
                        ...
                        onPressed: () {
                          sheetController1 = Scaffold.of(context)
                              .showBottomSheet(
                                (BuildContext context) =>
  ...
  testWidgets('requestFocus works correctly in showModalBottomSheet.', (
    WidgetTester tester,
  ) async {
    ...
    await tester.pumpAndSettle();
    expect(
      FocusScope.of(tester.element(find.text('BottomSheet'))).hasFocus,
      true,
    );
...
class _StatusTestAnimationController extends AnimationController
