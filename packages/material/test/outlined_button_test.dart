...
void main() {
  ...
  testWidgets('Does OutlinedButton work with focus', (
    ...
    expect(
      material.shape,
      StadiumBorder(side: BorderSide(color: colors.primary)),
    );
  ...
  testWidgets('Default OutlinedButton icon alignment', (
    WidgetTester tester,
  ) async {
  ...
  testWidgets('OutlinedButton icon alignment can be customized', (
    WidgetTester tester,
  ) async {
    Widget buildWidget({
  ...
  testWidgets(
    'OutlinedButton icon alignment respects ButtonStyle.iconAlignment',
    (WidgetTester tester) async {
  ...
  testWidgets("OutlinedButton.icon response doesn't hover when disabled", (
    ...
    FocusManager.instance.highlightStrategy =
        FocusHighlightStrategy.alwaysTouch;
    final FocusNode focusNode = FocusNode(
      debugLabel: 'OutlinedButton.icon Focus',
    );
    final GlobalKey childKey = GlobalKey();
    bool hovering = false;
    await tester.pumpWidget(
  ...
  testWidgets('Disabled and hovered OutlinedButton.icon responds to mouse-exit', (
    ...
    await gesture.moveTo(
      tester.getCenter(find.byKey(key)) - const Offset(1, 1),
    );
    await tester.pumpAndSettle();
    // Moving the mouse a little within the OutlinedButton doesn't change anything.
    expect(onHoverCount, 2);
  ...
  testWidgets('OutlinedButton.icon can be focused/unfocused', (
    WidgetTester tester,
  ) async {
  ...
  testWidgets('Disabled OutlinedButton.icon cannot receive focus', (
    WidgetTester tester,
  ) async {
    final FocusNode node = FocusNode(debugLabel: 'OutlinedButton.icon Focus');
    bool gotFocus = false;
  ...
  testWidgets(
    'OutlinedButton icon uses provided foregroundColor over default icon color',
    (WidgetTester tester) async {
  ...
  testWidgets("OutlinedButton's outline should be behind its child", (
    WidgetTester tester,
  ) async {
