...
void main() {
  ...
  testWidgets('IconButton with explicit splashColor and highlightColor - M2', (
    ...
    await tester.pumpWidget(
      Theme(data: ThemeData(useMaterial3: false), child: buttonWidget),
    );
  ...
  testWidgets('IconButton responds to density changes.', (
    ...
    expect(
      box.size,
      equals(material3 ? const Size(64, 64) : const Size(60, 60)),
    );
    ...
    expect(
      box.size,
      equals(material3 ? const Size(40, 36) : const Size(40, 40)),
    );
    ...
    expect(
      box.size,
      equals(material3 ? const Size(64, 36) : const Size(60, 40)),
    );
  });
  ...
  testWidgets('IconButton.fill defaults - M3', (WidgetTester tester) async {
    ...
    await tester.pumpWidget(
      MaterialApp(
        theme: themeM3,
        home: const Center(
          child: IconButton.filled(onPressed: null, icon: Icon(Icons.ac_unit)),
        ),
      ),
    );
    await tester.pumpAndSettle();
  ...
  testWidgets(
    ...
    (WidgetTester tester) async {
      ...
      await buildTest(
        iconButtonThemeVisualDensity: const VisualDensity(
          horizontal: 3.0,
          vertical: 3.0,
        ),
      );
      ...
      await buildTest(
        themeVisualDensity: const VisualDensity(horizontal: 3.0, vertical: 3.0),
      );
      await tester.pumpAndSettle();
      expect(box.size, equals(const Size(48, 48)));
    },
  ...
  testWidgets(
    'IconButton.styleFrom overlayColor overrides default overlay color',
    (WidgetTester tester) async {
  ...
  testWidgets(
    'IconButton.styleFrom highlight, hover, focus colors overrides overlayColor',
    (WidgetTester tester) async {
  ...
  testWidgets('IconButton.styleFrom with transparent overlayColor', (
    WidgetTester tester,
  ) async {
  ...
  testWidgets(
    'Tooltip is drawn when hovering within IconButton area but outside the Icon itself',
    (WidgetTester tester) async {
      const String tooltipText = 'Test tooltip';
      await tester.pumpWidget(
        MaterialApp(
  ...
  // This is a regression test for https://github.com/flutter/flutter/issues/153544.
  testWidgets(
    'Trigger Ink splash when hovering within layout bounds with tooltip',
    (WidgetTester tester) async {
      await tester.pumpWidget(
        MaterialApp(
          home: Material(
  ...
  testWidgets('Material3 - IconButton variants hovered & onLongPressed', (
    ...
    // IconButton
    await tester.pumpWidget(
      buildAllVariants(onLongPress: onLongPress, onHover: onHover),
    );
    ...
    final Finder iconButtonFilledTonal = find.widgetWithIcon(
      IconButton,
      Icons.add,
    );
    final Offset iconButtonFilledTonalOffset = tester.getCenter(
    ...
    final Finder iconButtonOutlined = find.widgetWithIcon(
      IconButton,
      Icons.add,
    );
    final Offset iconButtonOutlinedOffset = tester.getCenter(
      iconButtonOutlined,
    );
  ...
  testWidgets("IconButton's outline should be behind its child", (
    WidgetTester tester,
  ) async {
