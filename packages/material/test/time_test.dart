...
void main() {
            ...
            home: MediaQuery(
              ...
              child: Builder(
                builder: (BuildContext context) {
                  formattedValue = const TimeOfDay(
                    hour: 7,
                    minute: 0,
                  ).format(context);
                  return Container();
  ...
  testWidgets('hourOfPeriod returns correct value', (
    WidgetTester tester,
  ) async {
  ...
  group('RestorableTimeOfDay tests', () {
    ...
    testWidgets('call notifiers when value changes', (
      WidgetTester tester,
    ) async {
      await tester.pumpWidget(
        const RootRestorationScope(
  ...
  testWidgets('correctly compares to other TimeOfDays', (
    WidgetTester tester,
  ) async {
    expect(
      const TimeOfDay(
        hour: 0,
        minute: 0,
      ).compareTo(const TimeOfDay(hour: 1, minute: 0)),
      lessThan(0),
    );
    expect(
      const TimeOfDay(
        hour: 20,
        minute: 0,
      ).compareTo(const TimeOfDay(hour: 20, minute: 1)),
      lessThan(0),
    );
    expect(
      const TimeOfDay(
    ...
    expect(
      const TimeOfDay(
        hour: 20,
        minute: 1,
      ).compareTo(const TimeOfDay(hour: 20, minute: 0)),
      greaterThan(0),
    );
    ...
    expect(
      const TimeOfDay(
        hour: 0,
        minute: 0,
      ).isBefore(const TimeOfDay(hour: 1, minute: 0)),
      isTrue,
    );
    expect(
      const TimeOfDay(
        hour: 0,
        minute: 0,
      ).isBefore(const TimeOfDay(hour: 23, minute: 0)),
      isTrue,
    );
    expect(
      const TimeOfDay(
        hour: 0,
        minute: 0,
      ).isBefore(const TimeOfDay(hour: 0, minute: 10)),
      isTrue,
    );
    expect(
      const TimeOfDay(
        hour: 0,
        minute: 0,
      ).isBefore(const TimeOfDay(hour: 0, minute: 0)),
      isFalse,
    );
    expect(
      const TimeOfDay(
    ...
    expect(
      const TimeOfDay(
        hour: 0,
        minute: 0,
      ).isAfter(const TimeOfDay(hour: 1, minute: 0)),
      isFalse,
    );
    expect(
      const TimeOfDay(
        hour: 0,
        minute: 0,
      ).isAfter(const TimeOfDay(hour: 23, minute: 0)),
      isFalse,
    );
    expect(
      const TimeOfDay(
        hour: 0,
        minute: 0,
      ).isAfter(const TimeOfDay(hour: 0, minute: 10)),
      isFalse,
    );
    expect(
      const TimeOfDay(
        hour: 0,
        minute: 0,
      ).isAfter(const TimeOfDay(hour: 0, minute: 0)),
      isFalse,
    );
    expect(
      const TimeOfDay(
    ...
    expect(
      const TimeOfDay(
        hour: 0,
        minute: 0,
      ).isAtSameTimeAs(const TimeOfDay(hour: 1, minute: 0)),
      isFalse,
    );
    expect(
      const TimeOfDay(
        hour: 0,
        minute: 0,
      ).isAtSameTimeAs(const TimeOfDay(hour: 0, minute: 10)),
      isFalse,
    );
    expect(
      const TimeOfDay(
        hour: 0,
        minute: 0,
      ).isAtSameTimeAs(const TimeOfDay(hour: 0, minute: 0)),
      isTrue,
    );
    expect(
      const TimeOfDay(
