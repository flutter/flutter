...
void main() {
  ...
  testWidgets('Material3 - ElevatedButton respects Theme shadowColor', (
    WidgetTester tester,
  ) async {
    const ColorScheme colorScheme = ColorScheme.light();
  ...
  testWidgets('Material2 - ElevatedButton respects Theme shadowColor', (
    WidgetTester tester,
  ) async {
    const ColorScheme colorScheme = ColorScheme.light();
    const Color shadowColor = Color(0xff000001);
  ...
  testWidgets(
    'ElevatedButton.icon respects ElevatedButtonTheme ButtonStyle.iconAlignment',
    (WidgetTester tester) async {
