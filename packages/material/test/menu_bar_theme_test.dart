...
void main() {
  ...
  testWidgets('Constructor parameters override theme parameters', (
    ...
    expect(
      getLabelStyle(tester, TestMenu.subMenu10.label).style.color,
      equals(Colors.grey),
    );
    final ButtonStyle? textButtonStyle = tester
        ...
        .style;
    expect(
      textButtonStyle?.overlayColor?.resolve(<MaterialState>{
