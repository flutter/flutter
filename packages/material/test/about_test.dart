...
void main() {
  ...
  testWidgets('Material2 - AboutListTile control test', (
    WidgetTester tester,
  ) async {
  ...
  testWidgets('Material3 - AboutListTile control test', (
    WidgetTester tester,
  ) async {
    const FlutterLogo logo = FlutterLogo();
  ...
  testWidgets('LicensePage control test', (WidgetTester tester) async {
    ...
    await tester.pumpWidget(
      const MaterialApp(home: Center(child: LicensePage())),
    );
  ...
  testWidgets('Material2 - LicensePage respects the notch', (
    WidgetTester tester,
  ) async {
  ...
  testWidgets('Material3 - LicensePage respects the notch', (
    WidgetTester tester,
  ) async {
    const double safeareaPadding = 27.0;
  ...
  group('showAboutDialog avoids overlapping display features', () {
    testWidgets('default positioning', (WidgetTester tester) async {
      ...
      expect(
        tester.getBottomRight(find.byType(AboutDialog)),
    ...
    testWidgets('positioning using anchorPoint', (WidgetTester tester) async {
      ...
      expect(
        tester.getTopLeft(find.byType(AboutDialog)),
  ...
  testWidgets(
    ...
    (WidgetTester tester) async {
      ...
      expect(
        find.byKey(const ValueKey<ConnectionState>(ConnectionState.done)),
        findsOneWidget,
      );
  ...
  testWidgets('ListView of license entries is primary', (
    WidgetTester tester,
  ) async {
  ...
  testWidgets('LicensePage padding', (WidgetTester tester) async {
    ...
    final Finder appLegalese = find.text(
      'I am the very model of a modern major general.',
    );
  ...
  testWidgets('Material2 - Error handling test', (WidgetTester tester) async {
    ...
    await tester.runAsync(
      () => (tester.firstState(finder) as dynamic).licenses as Future<dynamic>,
    );
  ...
  testWidgets('Material3 - Error handling test', (WidgetTester tester) async {
    ...
    await tester.pumpWidget(
      const MaterialApp(home: Material(child: AboutListTile())),
    );
    await tester.tap(find.byType(ListTile));
    await tester.pump();
    await tester.pump(const Duration(seconds: 2));
  ...
  testWidgets(
    ...
    (WidgetTester tester) async {
      ...
      expect(
        renderParagraph.text.style!.color,
  ...
  testWidgets('showLicensePage inherits ambient Theme', (
    WidgetTester tester,
  ) async {
    final ThemeData theme = ThemeData(
    ...
    final ThemeData licensePageTheme = Theme.of(
      tester.element(find.text('Powered by Flutter')),
    );
