...
void main() {
  ...
  testWidgets('ChipThemeData generates correct opacities for defaults', (
    ...
    final TextStyle customStyle = ThemeData.fallback().textTheme.bodyLarge!
        .copyWith(color: customColor2);
    ...
    expect(
      lightTheme.secondarySelectedColor,
    ...
    expect(
      lightTheme.secondaryLabelStyle?.color,
    ...
    expect(
      darkTheme.secondarySelectedColor,
      equals(customColor1.withAlpha(0x3d)),
    );
    ...
    expect(
      darkTheme.secondaryLabelStyle?.color,
      equals(customColor1.withAlpha(0xde)),
    );
    ...
    expect(
      customTheme.secondarySelectedColor,
    ...
    expect(
      customTheme.secondaryLabelStyle?.color,
  ...
  testWidgets('ChipThemeData lerps correctly', (WidgetTester tester) async {
    final ChipThemeData chipThemeBlack =
        ChipThemeData.fromDefaults(
          ...
          brightness: Brightness.dark,
          labelStyle: ThemeData.fallback().textTheme.bodyLarge!.copyWith(
            color: Colors.black,
          ),
        ).copyWith(
          elevation: 1.0,
    ...
    final ChipThemeData lerp = ChipThemeData.lerp(
      chipThemeBlack,
      chipThemeWhite,
      0.5,
    )!;
    ...
    expect(
      lerp.secondarySelectedColor,
      isSameColorAs(middleGrey.withAlpha(0x3d)),
    );
    ...
    expect(
      lerp.secondaryLabelStyle?.color,
      isSameColorAs(middleGrey.withAlpha(0xde)),
    );
    ...
    final ChipThemeData lerpANull25 = ChipThemeData.lerp(
      null,
      chipThemeWhite,
      0.25,
    )!;
    expect(
      lerpANull25.backgroundColor,
      isSameColorAs(Colors.black.withAlpha(0x08)),
    );
    expect(
      lerpANull25.deleteIconColor,
      isSameColorAs(Colors.black.withAlpha(0x38)),
    );
    expect(
      lerpANull25.disabledColor,
      isSameColorAs(Colors.black.withAlpha(0x03)),
    );
    expect(
      lerpANull25.selectedColor,
      isSameColorAs(Colors.black.withAlpha(0x0f)),
    );
    expect(
      lerpANull25.secondarySelectedColor,
      isSameColorAs(Colors.white.withAlpha(0x0f)),
    );
    expect(
      lerpANull25.shadowColor,
      isSameColorAs(Colors.white.withAlpha(0x40)),
    );
    expect(
      lerpANull25.surfaceTintColor,
      isSameColorAs(Colors.white.withAlpha(0x40)),
    );
    expect(
      lerpANull25.selectedShadowColor,
      isSameColorAs(Colors.white.withAlpha(0x40)),
    );
    ...
    expect(
      lerpANull25.side!.color,
      isSameColorAs(Colors.white.withAlpha(0x3f)),
    );
    expect(lerpANull25.shape, isA<BeveledRectangleBorder>());
    expect(
      lerpANull25.labelStyle?.color,
      isSameColorAs(Colors.black.withAlpha(0x38)),
    );
    expect(
      lerpANull25.secondaryLabelStyle?.color,
      isSameColorAs(Colors.white.withAlpha(0x38)),
    );
    ...
    expect(
      lerpANull25.checkmarkColor,
      isSameColorAs(Colors.white.withAlpha(0x40)),
    );
    expect(lerpANull25.iconTheme, const IconThemeData(size: 5.5));

    final ChipThemeData lerpANull75 = ChipThemeData.lerp(
      null,
      chipThemeWhite,
      0.75,
    )!;
    expect(
      lerpANull75.backgroundColor,
      isSameColorAs(Colors.black.withAlpha(0x17)),
    );
    expect(
      lerpANull75.deleteIconColor,
      isSameColorAs(Colors.black.withAlpha(0xa7)),
    );
    expect(
      lerpANull75.disabledColor,
      isSameColorAs(Colors.black.withAlpha(0x09)),
    );
    expect(
      lerpANull75.selectedColor,
      isSameColorAs(Colors.black.withAlpha(0x2e)),
    );
    expect(
      lerpANull75.secondarySelectedColor,
      isSameColorAs(Colors.white.withAlpha(0x2e)),
    );
    expect(
      lerpANull75.shadowColor,
      isSameColorAs(Colors.white.withAlpha(0xbf)),
    );
    expect(
      lerpANull75.surfaceTintColor,
      isSameColorAs(Colors.white.withAlpha(0xbf)),
    );
    expect(
      lerpANull75.selectedShadowColor,
      isSameColorAs(Colors.white.withAlpha(0xbf)),
    );
    expect(lerpANull75.showCheckmark, equals(true));
    expect(
      lerpANull75.labelPadding,
      equals(const EdgeInsets.only(top: 6.0, bottom: 6.0)),
    );
    expect(lerpANull75.padding, equals(const EdgeInsets.all(1.5)));
    expect(
      lerpANull75.side!.color,
      isSameColorAs(Colors.white.withAlpha(0xbf)),
    );
    expect(lerpANull75.shape, isA<BeveledRectangleBorder>());
    expect(
      lerpANull75.labelStyle?.color,
      isSameColorAs(Colors.black.withAlpha(0xa7)),
    );
    expect(
      lerpANull75.secondaryLabelStyle?.color,
      isSameColorAs(Colors.white.withAlpha(0xa7)),
    );
    ...
    expect(
      lerpANull75.checkmarkColor,
      isSameColorAs(Colors.white.withAlpha(0xbf)),
    );
    expect(lerpANull75.iconTheme, const IconThemeData(size: 16.5));

    final ChipThemeData lerpBNull25 = ChipThemeData.lerp(
      chipThemeBlack,
      null,
      0.25,
    )!;
    expect(
      lerpBNull25.backgroundColor,
      isSameColorAs(Colors.white.withAlpha(0x17)),
    );
    expect(
      lerpBNull25.deleteIconColor,
      isSameColorAs(Colors.white.withAlpha(0xa7)),
    );
    expect(
      lerpBNull25.disabledColor,
      isSameColorAs(Colors.white.withAlpha(0x09)),
    );
    expect(
      lerpBNull25.selectedColor,
      isSameColorAs(Colors.white.withAlpha(0x2e)),
    );
    expect(
      lerpBNull25.secondarySelectedColor,
      isSameColorAs(Colors.black.withAlpha(0x2e)),
    );
    expect(
      lerpBNull25.shadowColor,
      isSameColorAs(Colors.black.withAlpha(0xbf)),
    );
    expect(
      lerpBNull25.surfaceTintColor,
      isSameColorAs(Colors.black.withAlpha(0xbf)),
    );
    expect(
      lerpBNull25.selectedShadowColor,
      isSameColorAs(Colors.black.withAlpha(0xbf)),
    );
    expect(lerpBNull25.showCheckmark, equals(false));
    expect(
      lerpBNull25.labelPadding,
      equals(const EdgeInsets.only(left: 6.0, right: 6.0)),
    );
    expect(lerpBNull25.padding, equals(const EdgeInsets.all(3.0)));
    expect(
      lerpBNull25.side!.color,
      isSameColorAs(Colors.black.withAlpha(0x3f)),
    );
    expect(lerpBNull25.shape, isA<StadiumBorder>());
    expect(
      lerpBNull25.labelStyle?.color,
      isSameColorAs(Colors.white.withAlpha(0xa7)),
    );
    expect(
      lerpBNull25.secondaryLabelStyle?.color,
      isSameColorAs(Colors.black.withAlpha(0xa7)),
    );
    ...
    expect(
      lerpBNull25.checkmarkColor,
      isSameColorAs(Colors.black.withAlpha(0xbf)),
    );
    expect(lerpBNull25.iconTheme, const IconThemeData(size: 19.5));

    final ChipThemeData lerpBNull75 = ChipThemeData.lerp(
      chipThemeBlack,
      null,
      0.75,
    )!;
    expect(
      lerpBNull75.backgroundColor,
      isSameColorAs(Colors.white.withAlpha(0x08)),
    );
    expect(
      lerpBNull75.deleteIconColor,
      isSameColorAs(Colors.white.withAlpha(0x38)),
    );
    expect(
      lerpBNull75.disabledColor,
      isSameColorAs(Colors.white.withAlpha(0x03)),
    );
    expect(
      lerpBNull75.selectedColor,
      isSameColorAs(Colors.white.withAlpha(0x0f)),
    );
    expect(
      lerpBNull75.secondarySelectedColor,
      isSameColorAs(Colors.black.withAlpha(0x0f)),
    );
    expect(
      lerpBNull75.shadowColor,
      isSameColorAs(Colors.black.withAlpha(0x40)),
    );
    expect(
      lerpBNull75.surfaceTintColor,
      isSameColorAs(Colors.black.withAlpha(0x40)),
    );
    expect(
      lerpBNull75.selectedShadowColor,
      isSameColorAs(Colors.black.withAlpha(0x40)),
    );
    expect(lerpBNull75.showCheckmark, equals(true));
    expect(
      lerpBNull75.labelPadding,
      equals(const EdgeInsets.only(left: 2.0, right: 2.0)),
    );
    expect(lerpBNull75.padding, equals(const EdgeInsets.all(1.0)));
    expect(
      lerpBNull75.side!.color,
      isSameColorAs(Colors.black.withAlpha(0xbf)),
    );
    expect(lerpBNull75.shape, isA<StadiumBorder>());
    expect(
      lerpBNull75.labelStyle?.color,
      isSameColorAs(Colors.white.withAlpha(0x38)),
    );
    expect(
      lerpBNull75.secondaryLabelStyle?.color,
      isSameColorAs(Colors.black.withAlpha(0x38)),
    );
  ...
  testWidgets('RawChip uses state colors from ChipTheme', (
    ...
    expect(
      getMaterialBox(tester),
      paints..rrect(color: chipTheme.disabledColor),
    );
    ...
    expect(
      getMaterialBox(tester),
      paints..rrect(color: chipTheme.selectedColor),
    );
  });
  ...
  testWidgets('RawChip respects checkmark properties from ChipTheme', (
    ...
    await tester.pumpWidget(
      buildRawChip(
        chipTheme: const ChipThemeData(checkmarkColor: Color(0xffff0000)),
      ),
    );
    ...
    expect(
      materialBox,
      paints..path(color: const Color(0xffff0000), style: PaintingStyle.stroke),
    );
    ...
    expect(
      ...
      isNot(
        paints
          ..path(color: const Color(0xffff0000), style: PaintingStyle.stroke),
      ),
    );
  });
  ...
  testWidgets(
    ...
    (WidgetTester tester) async {
      ...
      final Offset chipTopRight = tester.getTopRight(
        find.byWidget(getMaterial(tester)),
      );
      final Offset deleteIconCenter = tester.getCenter(
