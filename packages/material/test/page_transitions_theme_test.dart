...
void main() {
  ...
  testWidgets(
    ...
    (WidgetTester tester) async {
      ...
      expect(
        coloredBox.color,
        Colors.transparent,
      ); // Color is transparent during animation.
    },
    variant: TargetPlatformVariant.only(TargetPlatform.android),
  );
  ...
  testWidgets(
    ...
    (WidgetTester tester) async {
      ...
      await tester.pumpWidget(
        buildApp(const FadeForwardsPageTransitionsBuilder()),
      );
      ...
      expect(
        coloredBox.color,
        Colors.transparent,
      ); // The color is transparent during animation.

      await tester.pumpWidget(
        buildApp(const FadeUpwardsPageTransitionsBuilder()),
      );
      await tester.pumpAndSettle();
      expect(
        find.descendant(
  ...
  testWidgets(
    ...
    (WidgetTester tester) async {
      ...
      expect(
        scaffoldedRenderBox,
        paints..rect(color: themeTestSurfaceColor.withOpacity(0.122)),
      );
      ...
      final RenderBox nonScaffoldedRenderBox = tester
          .firstRenderObject<RenderBox>(find.byType(MaterialApp));
      // Expect the color to be at exactly 59.6% opacity at this time.
      expect(
        nonScaffoldedRenderBox,
        paints..rect(color: themeTestSurfaceColor.withOpacity(0.596)),
      );
  ...
  testWidgets(
    ...
    (WidgetTester tester) async {
          ...
          theme: ThemeData(
            ...
            pageTransitionsTheme: PageTransitionsTheme(
              builders: <TargetPlatform, PageTransitionsBuilder>{
                ...
                for (final TargetPlatform platform in TargetPlatform.values)
                  platform: const ZoomPageTransitionsBuilder(
                    backgroundColor: testSurfaceColor,
                  ),
              },
            ),
          ),
      ...
      expect(
        scaffoldedRenderBox,
        paints..rect(color: testSurfaceColor.withOpacity(0.122)),
      );
      ...
      expect(
        nonScaffoldedRenderBox,
        paints..rect(color: testSurfaceColor.withOpacity(0.596)),
      );
