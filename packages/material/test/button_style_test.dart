...
void main() {
  test('ButtonStyle copyWith, merge, ==, hashCode basics', () {
    ...
    expect(
      const ButtonStyle().hashCode,
      const ButtonStyle().copyWith().hashCode,
    );
  });
  ...
  test('ButtonStyle.lerp BorderSide', () {
    ...
    const BorderSide emptyBlackSide = BorderSide(
      width: 0,
    ...
    expect(
      ButtonStyle.lerp(blackStyle, blackStyle, 0)?.side?.resolve(states),
      blackSide,
    );
    expect(
      ButtonStyle.lerp(blackStyle, blackStyle, 0.5)?.side?.resolve(states),
      blackSide,
    );
    expect(
      ButtonStyle.lerp(blackStyle, blackStyle, 1)?.side?.resolve(states),
      blackSide,
    );

    expect(
      ButtonStyle.lerp(blackStyle, null, 0)?.side?.resolve(states),
      blackSide,
    );
    expect(
    ...
    expect(
      ButtonStyle.lerp(blackStyle, null, 1)?.side?.resolve(states),
      emptyBlackSide,
    );

    expect(
      ButtonStyle.lerp(null, blackStyle, 0)?.side?.resolve(states),
      emptyBlackSide,
    );
    expect(
    ...
    expect(
      ButtonStyle.lerp(null, blackStyle, 1)?.side?.resolve(states),
      blackSide,
    );

    expect(
      ButtonStyle.lerp(blackStyle, whiteStyle, 0)?.side?.resolve(states),
      blackSide,
    );
    expect(
    ...
    expect(
      ButtonStyle.lerp(blackStyle, whiteStyle, 1)?.side?.resolve(states),
      whiteSide,
    );
  });
}
