...
import '../../flutter/test/painting/mocks_for_image_cache.dart';
...
void main() {
  testWidgets('CircleAvatar with dark background color', (
    ...
    final RenderConstrainedBox box = tester.renderObject(
  ...
  testWidgets('CircleAvatar with image background', (
    WidgetTester tester,
  ) async {
    await tester.pumpWidget(
      wrap(
  ...
  testWidgets('CircleAvatar with image foreground', (
    WidgetTester tester,
  ) async {
    await tester.pumpWidget(
      wrap(
  ...
  testWidgets('Material3 - CircleAvatar default colors', (
    WidgetTester tester,
  ) async {
  ...
  testWidgets('CircleAvatar text does not expand with textScaler', (
    WidgetTester tester,
  ) async {
    final Color foregroundColor = Colors.red.shade100;
    await tester.pumpWidget(
