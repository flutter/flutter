...
void main() {
  test('SearchBarThemeData copyWith, ==, hashCode basics', () {
    ...
    expect(
      const SearchBarThemeData().hashCode,
  ...
  test('SearchBarThemeData defaults', () {
    ...
    const SearchBarTheme theme = SearchBarTheme(
  ...
  testWidgets('Default SearchBarThemeData debugFillProperties', (
    WidgetTester tester,
  ) async {
  ...
  testWidgets('SearchBarThemeData implements debugFillProperties', (
    ...
    expect(
      description[2],
      'shadowColor: WidgetStatePropertyAll(${const Color(0xfffffff2)})',
    );
    expect(
      description[3],
      'surfaceTintColor: WidgetStatePropertyAll(${const Color(0xfffffff3)})',
    );
    expect(
      description[4],
      'overlayColor: WidgetStatePropertyAll(${const Color(0xfffffff4)})',
    );
    expect(
      description[5],
  ...
  group('[Theme, SearchBarTheme, SearchBar properties overrides]', () {
    ...
    const BorderSide sideValue = BorderSide(
    ...
    const TextStyle hintStyleValue = TextStyle(
    ...
    Future<void> checkSearchBar(WidgetTester tester) async {
      ...
      expect(
        inkWell.overlayColor!.resolve(focused),
        overlayColor.resolve(focused),
      );
      expect(
        inkWell.overlayColor!.resolve(pressed),
    ...
    testWidgets('SearchBar properties overrides defaults', (
      WidgetTester tester,
    ) async {
    ...
    testWidgets('SearchBar theme data overrides defaults', (
      WidgetTester tester,
    ) async {
    ...
    testWidgets('Overall Theme SearchBar theme overrides defaults', (
      WidgetTester tester,
    ) async {
