...
void main() {
  ...
  testWidgets(
    'Semantic nodes do not throw an error after clearSemantics',
    (WidgetTester tester) async {
  ...
  testWidgets(
    'RangeSlider overlay appears correctly for specific thumb interactions',
    (WidgetTester tester) async {
      tester.binding.focusManager.highlightStrategy =
          FocusHighlightStrategy.alwaysTraditional;
      RangeValues values = const RangeValues(50, 70);
      ...
      final Offset topThumbLocation = tester.getCenter(
        find.byType(RangeSlider),
      );
      final TestGesture dragStartThumb = await tester.startGesture(
        topThumbLocation,
      );
      await tester.pump(kPressTimeout);
      ...
      final Offset bottomThumbLocation = tester
          ...
          .translate(220.0, 0.0);
      final TestGesture dragEndThumb = await tester.startGesture(
        bottomThumbLocation,
      );
      await tester.pump(kPressTimeout);
  ...
  testWidgets(
    'RangeSlider.padding can override the default RangeSlider padding',
    (WidgetTester tester) async {
  ...
  testWidgets(
    'Discrete RangeSlider does not apply thumb padding in a non-rounded track shape',
    (WidgetTester tester) async {
  ...
  testWidgets('Default RangeSlider when year2023 is false', (
    WidgetTester tester,
  ) async {
    final ThemeData theme = ThemeData();
  ...
  testWidgets('RangeSlider value indicator text when year2023 is false', (
    ...
    final ThemeData theme = ThemeData(
      sliderTheme: SliderThemeData(
        rangeValueIndicatorShape: loggingValueIndicatorShape,
      ),
    );
...
class LoggingRangeSliderValueIndicatorShape
