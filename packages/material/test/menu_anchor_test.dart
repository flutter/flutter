...
void main() {
  ...
  Finder findMnemonic(String label) {
    return find
        .descendant(
          of: find.ancestor(
            of: find.text(label),
            matching: findMenuBarItemLabels(),
          ),
  ...
  group('Menu functions', () {
    ...
    testWidgets('menu alignment and offset in LTR', (
      ...
      await tester.pumpWidget(
        buildTestApp(alignment: AlignmentDirectional.topStart),
      );
      await tester.pump();
      expect(
        tester.getRect(findMenuScope),
      ...
      await tester.pumpWidget(
        buildTestApp(alignment: AlignmentDirectional.center),
      );
      await tester.pump();
      expect(
        tester.getRect(findMenuScope),
      ...
      await tester.pumpWidget(
        buildTestApp(alignment: AlignmentDirectional.bottomEnd),
      );
      await tester.pump();
      expect(
        tester.getRect(findMenuScope),
            ...
            child: Center(
              child: MenuAnchor(
                menuChildren: const <Widget>[
                  MenuItemButton(child: Text('Button 1')),
                ],
                builder:
                    (
                      BuildContext context,
    ...
    testWidgets('select works', (WidgetTester tester) async {
      ...
      expect(
        opened,
        equals(<TestMenu>[TestMenu.mainMenu1, TestMenu.subMenu11]),
      );
      opened.clear();
      await tester.tap(find.text(TestMenu.subSubMenu110.label));
      await tester.pump();
    ...
    testWidgets('menus can be traversed multiple times', (
      WidgetTester tester,
    ) async {
    ...
    testWidgets('MenuAnchor tab traversal works', (WidgetTester tester) async {
      ...
      final FocusNode buttonFocusNode = FocusNode(
        debugLabel: TestMenu.anchorButton.label,
      );
    ...
    testWidgets('MenuAnchor LTR directional traversal works', (
      WidgetTester tester,
    ) async {
      final FocusNode buttonFocusNode = FocusNode(
        debugLabel: TestMenu.anchorButton.label,
    ...
    testWidgets('MenuAnchor RTL directional traversal works', (
      WidgetTester tester,
    ) async {
    ...
    testWidgets('scrolling does not trigger hover traversal', (
      WidgetTester tester,
    ) async {
  ...
  group('Accelerators', () {
    ...
    final Set<TargetPlatform> nonApple = TargetPlatform.values
        .toSet()
        .difference(apple);
    ...
    testWidgets('can invoke menu items', (WidgetTester tester) async {
      ...
      expect(
        closed,
        equals(<TestMenu>[TestMenu.subMenu11, TestMenu.mainMenu1]),
      );
    ...
    testWidgets(
      "Apple platforms don't react to accelerators",
      (WidgetTester tester) async {
        await tester.pumpWidget(
          MaterialApp(
            home: Material(
  ...
  group('MenuItemButton', () {
    testWidgets('Shortcut mnemonics are displayed', (
      ...
      Text mnemonic0 = tester.widget(
        findMnemonic(TestMenu.subSubMenu110.label),
      );
      Text mnemonic1 = tester.widget(
        findMnemonic(TestMenu.subSubMenu111.label),
      );
      Text mnemonic2 = tester.widget(
        findMnemonic(TestMenu.subSubMenu112.label),
      );
      Text mnemonic3 = tester.widget(
        findMnemonic(TestMenu.subSubMenu113.label),
      );
    ...
    testWidgets(
      ...
      (WidgetTester tester) async {
          ...
          MaterialApp(
            home: Material(
              child: MenuBar(
                ...
                children: createTestMenus(
                  shortcuts: <TestMenu, MenuSerializableShortcut>{
                    TestMenu.subSubMenu110: const CharacterActivator(
                      'A',
                      control: true,
                    ),
                    TestMenu.subSubMenu111: const CharacterActivator(
                      'B',
                      alt: true,
                    ),
                    TestMenu.subSubMenu112: const CharacterActivator(
                      'C',
                      meta: true,
                    ),
                  },
        ...
        final Text mnemonic0 = tester.widget(
          findMnemonic(TestMenu.subSubMenu110.label),
        );
        final Text mnemonic1 = tester.widget(
          findMnemonic(TestMenu.subSubMenu111.label),
        );
        final Text mnemonic2 = tester.widget(
          findMnemonic(TestMenu.subSubMenu112.label),
        );
    ...
    testWidgets('autofocus is used when set and widget is enabled', (
      ...
      expect(
        focusedMenu,
        equals('MenuItemButton(Text("${TestMenu.mainMenu0.label}"))'),
      );
    });
            ...
            child: MenuBar(
              ...
              children: <Widget>[
                SubmenuButton(
                  ...
                  menuChildren: <Widget>[
                    MenuItemButton(child: Text(TestMenu.subMenu00.label)),
                  ],
                  child: Text(TestMenu.mainMenu0.label),
                ),
              ],
    ...
    testWidgets('MenuItemButton does not overflow when child is long', (
      WidgetTester tester,
    ) async {
      await tester.pumpWidget(
        MaterialApp(
          home: Scaffold(
            body: SizedBox(
              ...
              child: MenuItemButton(
                ...
                onPressed: () {},
                child: const Text(
                  'MenuItem Button does not overflow when child is long',
                ),
              ),
            ),
          ),
    ...
    testWidgets('MenuItemButton layout is updated by overflowAxis', (
      WidgetTester tester,
    ) async {
      Widget buildMenuButton({
        required Axis overflowAxis,
      ...
      expect(
        tester.getSize(find.byType(MenuItemButton)),
    ...
    testWidgets(
      'MenuItemButton.styleFrom overlayColor overrides default overlay color',
      (WidgetTester tester) async {
    ...
    testWidgets('MenuItemButton can build when its child is null', (
      WidgetTester tester,
    ) async {
      await tester.pumpWidget(
        const MaterialApp(
  ...
  group('Layout', () {
    List<Rect> collectMenuItemRects() {
      ...
      final List<Element> candidates = find
          .byType(SubmenuButton)
          .evaluate()
          .toList();
    ...
    testWidgets(
      ...
      (WidgetTester tester) async {
        ...
        expect(
          collectSubmenuRects(),
          equals(const <Rect>[Rect.fromLTRB(0.0, 488.0, 122.0, 552.0)]),
        );
      },
    );
    ...
    group('LocalizedShortcutLabeler', () {
      testWidgets(
        'getShortcutLabel returns the right labels',
        (WidgetTester tester) async {
          String expectedMeta;
          String expectedCtrl;
          String expectedAlt;
          ...
          switch (defaultTargetPlatform) {
            ...
            case TargetPlatform.windows:
              expectedCtrl = 'Ctrl';
              expectedMeta = defaultTargetPlatform == TargetPlatform.windows
                  ? 'Win'
                  : 'Meta';
              expectedAlt = 'Alt';
              expectedShift = 'Shift';
    ...
    group('Semantics', () {
            ...
            child: Center(
              child: MenuItemButton(
                style: MenuItemButton.styleFrom(
                  fixedSize: const Size(88.0, 36.0),
                ),
                onPressed: () {},
      ...
      testWidgets(
        'MenuItemButton semantics respects label',
        (WidgetTester tester) async {
          final SemanticsTester semantics = SemanticsTester(tester);
          await tester.pumpWidget(
            MaterialApp(
    ...
    testWidgets('Material3 - Menu uses correct text styles', (
      ...
      final ThemeData themeData = ThemeData(
        textTheme: const TextTheme(labelLarge: menuTextStyle),
      );
      await tester.pumpWidget(
        MaterialApp(
          theme: themeData,
    ...
    testWidgets(
      'SubmenuButton.styleFrom overlayColor overrides default overlay color',
      (WidgetTester tester) async {
    ...
    testWidgets(
      ...
      (WidgetTester tester) async {
        ...
        final Iterable<Overlay> overlays = tester.widgetList<Overlay>(
          find.byType(Overlay),
        );
        ...
        expect(
          ancestorRenderTheaters(
            tester.renderObject(find.byKey(menuItemKey)),
          ).single,
    ...
    testWidgets('MenuAnchor updates isOpen state correctly', (
      WidgetTester tester,
    ) async {
      bool isOpen = false;
      int openCount = 0;
    ...
    testWidgets('SubmenuButton.submenuIcon updates default arrow icon', (
      ...
      final WidgetStateProperty<Widget?> submenuIcon =
          WidgetStateProperty.resolveWith<Widget?>((Set<WidgetState> states) {
