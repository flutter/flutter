...
void main() {
  ...
  group('Theme.brightnessOf', () {
    testWidgets('return correct brightness when just media query is given', (
      ...
      expect(
        Theme.brightnessOf(tester.element(find.byType(SizedBox))),
        equals(Brightness.dark),
      );
    });

    testWidgets(
      'return correct brightness with overriding theme brightness over media query',
    ...
    testWidgets(
      'returns Brightness.light when no theme or media query is present',
      (WidgetTester tester) async {
  ...
  group('Cupertino theme', () {
    ...
    testWidgets(
      'Cupertino widgets correctly get the right text theme in dark mode',
      (WidgetTester tester) async {
        ...
        final CupertinoThemeData cupertinoThemeData = CupertinoTheme.of(
          textFieldKey.currentContext!,
        );
        expect(
          cupertinoThemeData.textTheme.textStyle.color,
          isA<CupertinoDynamicColor>(),
        );
        ...
        expect(
          state.widget.style.color?.value,
          equals(themeTextStyleColor.darkColor.value),
        );
      },
    );
      ...
      (WidgetTester tester) async {
        ...
        await testTheme(
          ...
          ThemeData(
            ...
            cupertinoOverrideTheme: const CupertinoThemeData(
              primaryColor: cupertinoIconColor,
            ),
          ),
        );
    ...
    testWidgets('Cupertino theme override blocks derivative changes', (
      WidgetTester tester,
    ) async {
      CupertinoThemeData theme = await testTheme(
        tester,
