...
void main() {
  ...
  testWidgets('Material3 - Dial background uses correct default color', (
    ...
    RenderBox dial = tester.firstRenderObject<RenderBox>(
  ...
  for (final MaterialType materialType in MaterialType.values) {
    ...
    group('Dialog (${materialType.name})', () {
      ...
      testWidgets('text scale affects certain elements and not others', (
        ...
        final double minutesDisplayHeight = tester
            .getSize(find.text('41'))
            .height;
    ...
    group('Time picker - Input (${materialType.name})', () {
      ...
      testWidgets('TimePicker default entry icons', (
        WidgetTester tester,
      ) async {
        await tester.pumpWidget(
          MaterialApp(home: TimePickerDialog(initialTime: TimeOfDay.now())),
        );
      ...
      testWidgets('Can override TimePicker entry icons', (
        WidgetTester tester,
      ) async {
  ...
  testWidgets(
    'provides semantics information for hour/minute mode announcement',
    (WidgetTester tester) async {
      final SemanticsTester semantics = SemanticsTester(tester);
      await mediaQueryBoilerplate(tester, materialType: MaterialType.material3);
      ...
      expect(
        minuteControlInkWell,
        findsOneWidget,
        reason: 'Minute control should exist',
      );
  ...
  testWidgets('provides semantics information for the header (selected time)', (
    ...
    final String expectedLabel12Hour = localizations.formatTimeOfDay(
      initialTime,
    );
    ...
    expect(
      ...
      reason:
          'Header should have semantics label: $expectedLabel12Hour (12-hour)',
    );
  ...
  testWidgets(
    ...
    (WidgetTester tester) async {
      ...
      expect(
        tester.getTopLeft(timeControlFinder).dy -
            tester.getBottomLeft(dayPeriodControlFinder).dy,
        12,
      );
    },
  );
