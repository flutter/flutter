...
void main() {
  ...
  testWidgets('can filter and select a list of custom User options', (
    WidgetTester tester,
  ) async {
    await tester.pumpWidget(
      MaterialApp(
  ...
  testWidgets('displayStringForOption is displayed in the options', (
    WidgetTester tester,
  ) async {
    await tester.pumpWidget(
      MaterialApp(
  ...
  testWidgets(
    ...
    (WidgetTester tester) async {
      ...
      final double oneItemsHeight = await getDefaultOptionsHeight(
        tester,
        'elep',
      );
    ...
    testWidgets('default (down)', (WidgetTester tester) async {
      await tester.pumpWidget(
        MaterialApp(
          home: Scaffold(
            body: Autocomplete<String>(
              optionsBuilder: (TextEditingValue textEditingValue) => <String>[
                'a',
              ],
            ),
          ),
  ...
  testWidgets('can jump to options that are not yet built', (
    WidgetTester tester,
  ) async {
    const Color highlightColor = Color(0xFF112233);
    await tester.pumpWidget(
