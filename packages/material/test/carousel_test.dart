...
void main() {
  ...
  testWidgets('CarouselView layout (Uncontained layout)', (
    WidgetTester tester,
  ) async {
    await tester.pumpWidget(
      MaterialApp(
    ...
    final Size viewportSize = MediaQuery.sizeOf(
      tester.element(find.byType(CarouselView)),
    );
  ...
  testWidgets('CarouselView.weighted layout', (WidgetTester tester) async {
    ...
    final Size viewportSize = MediaQuery.of(
      tester.element(find.byType(CarouselView)),
    ).size;
    expect(viewportSize, const Size(800, 600));
  ...
  testWidgets(
    'The initialItem should be the first item with expanded size(max extent)',
  ...
  testWidgets('CarouselView respects itemSnapping', (
    WidgetTester tester,
  ) async {
    await tester.pumpWidget(
      MaterialApp(
  ...
  testWidgets('CarouselView.weighted respects itemSnapping', (
    WidgetTester tester,
  ) async {
    await tester.pumpWidget(
      MaterialApp(
  ...
  testWidgets('CarouselView respect itemSnapping when fling', (
    WidgetTester tester,
  ) async {
    await tester.pumpWidget(
      MaterialApp(
  ...
  testWidgets('CarouselView.weighted respect itemSnapping when fling', (
    WidgetTester tester,
  ) async {
    await tester.pumpWidget(
      MaterialApp(
  ...
  testWidgets(
    'CarouselView.weighted respects scrollingDirection: Axis.vertical',
    (WidgetTester tester) async {
      await tester.pumpWidget(
        MaterialApp(
          home: Scaffold(
  ...
  testWidgets('CarouselView.weighted respects reverse', (
    WidgetTester tester,
  ) async {
    await tester.pumpWidget(
      MaterialApp(
  ...
  testWidgets(
    'CarouselView.weighted respects reverse + vertical scroll direction',
    (WidgetTester tester) async {
      await tester.pumpWidget(
        MaterialApp(
          home: Scaffold(
      ...
      expect(
        rect0,
        const Rect.fromLTRB(0.0, 600.0 - item0Height, 800.0, 600.0),
      );
  ...
  testWidgets(
    'CarouselView.weighted respects reverse + vertical scroll direction + itemSnapping',
    (WidgetTester tester) async {
      await tester.pumpWidget(
        MaterialApp(
          home: Scaffold(
  ...
  testWidgets('CarouselView respects shrinkExtent', (
    WidgetTester tester,
  ) async {
    await tester.pumpWidget(
      MaterialApp(
  ...
  testWidgets('CarouselView.weighted respects consumeMaxWeight', (
    WidgetTester tester,
  ) async {
    await tester.pumpWidget(
      MaterialApp(
    ...
    expect(
      tester.getRect(getItem(9)),
      const Rect.fromLTRB(720.0, 0.0, 800.0, 600.0),
    );
    ...
    expect(
      tester.getRect(getItem(9)),
      const Rect.fromLTRB(240.0, 0.0, 560.0, 600.0),
    );
  });

  testWidgets('The initialItem stays when the flexWeights is updated', (
    WidgetTester tester,
  ) async {
  ...
  testWidgets(
    'The item that currently occupies max weight stays when the flexWeights is updated',
    (WidgetTester tester) async {
      final CarouselController controller = CarouselController(initialItem: 3);
      addTearDown(controller.dispose);
  ...
  testWidgets('The initialItem stays when the itemExtent is updated', (
    WidgetTester tester,
  ) async {
    final CarouselController controller = CarouselController(initialItem: 3);
    addTearDown(controller.dispose);
  ...
  testWidgets(
    ...
    (WidgetTester tester) async {
      ...
      expect(
        sum,
        lessThan(
          MediaQuery.of(tester.element(find.byType(CarouselView))).size.width,
        ),
      );
  ...
  testWidgets('Updating CarouselView does not cause exception', (
    WidgetTester tester,
  ) async {
  ...
  testWidgets(
    'CarouselView with enableSplash true - children are not directly interactive',
    (WidgetTester tester) async {
  ...
  testWidgets(
    'CarouselView with enableSplash false - children are directly interactive',
    (WidgetTester tester) async {
      bool buttonPressed = false;
      await tester.pumpWidget(
        MaterialApp(
  ...
  testWidgets('CarouselView does not crash if itemExtent is zero', (
    WidgetTester tester,
  ) async {
    await tester.pumpWidget(
      MaterialApp(
  ...
  // Regression test for https://github.com/flutter/flutter/issues/160679.
  testWidgets('Does not crash when parent size is zero', (
    WidgetTester tester,
  ) async {
    await tester.pumpWidget(
      const MaterialApp(
  ...
  testWidgets('itemExtent can be set to double.infinity', (
    WidgetTester tester,
  ) async {
    await tester.pumpWidget(
      const MaterialApp(
  ...
  testWidgets(
    'Does not crash when initial viewport dimension is zero and itemExtent is fixed',
    (WidgetTester tester) async {
  ...
  // Regression test for https://github.com/flutter/flutter/issues/163436.
  testWidgets(
    'Does not crash when initial viewport dimension is zero and itemExtent is infinite',
    (WidgetTester tester) async {
      await tester.binding.setSurfaceSize(Size.zero);
      addTearDown(() => tester.binding.setSurfaceSize(null));
  ...
  // Regression test for https://github.com/flutter/flutter/issues/167621.
  testWidgets(
    'CarouselView.weighted does not crash when initial viewport dimension is zero',
    (WidgetTester tester) async {
      await tester.binding.setSurfaceSize(Size.zero);
      addTearDown(() => tester.binding.setSurfaceSize(null));
  ...
  // Regression test for https://github.com/flutter/flutter/issues/167621.
  testWidgets(
    'CarouselView.weigted weigths are applied when viewport dimension is updated',
    (WidgetTester tester) async {
      addTearDown(() => tester.binding.setSurfaceSize(null));
  ...
  group('CarouselController.animateToItem', () {
    testWidgets(
      'CarouselView.weighted horizontal, not reversed, flexWeights [7,1]',
      (WidgetTester tester) async {
    ...
    testWidgets(
      'CarouselView.weighted horizontal, reversed, flexWeights [7,1]',
      (WidgetTester tester) async {
        await runCarouselTest(
          tester: tester,
          flexWeights: <int>[7, 1],
    ...
    testWidgets(
      'CarouselView.weighted vertical, not reversed, flexWeights [7,1]',
      (WidgetTester tester) async {
        await runCarouselTest(
          tester: tester,
          flexWeights: <int>[7, 1],
    ...
    testWidgets(
      'CarouselView.weighted horizontal, reversed, flexWeights [1,7]',
      (WidgetTester tester) async {
        await runCarouselTest(
          tester: tester,
          flexWeights: <int>[1, 7],
    ...
    testWidgets('CarouselView horizontal, not reversed', (
      WidgetTester tester,
    ) async {
      await runCarouselTest(
        tester: tester,
    ...
    testWidgets('CarouselView horizontal, reversed', (
      WidgetTester tester,
    ) async {
      await runCarouselTest(
        tester: tester,
    ...
    testWidgets('CarouselView vertical, not reversed', (
      WidgetTester tester,
    ) async {
      await runCarouselTest(
        tester: tester,
    ...
    testWidgets('CarouselView positions items correctly', (
      WidgetTester tester,
    ) async {
      ...
      final RenderBox carouselBox = tester.renderObject(
        find.byType(CarouselView),
      );
...
Future<TestGesture> hoverPointerOverCarouselItem(
  WidgetTester tester,
  Key key,
) async {
