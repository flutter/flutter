...
void main() {
  ...
  testWidgets(
    ...
    (WidgetTester tester) async {
              ...
              child: Column(
                children: <Widget>[
                  ...
                  ExpansionTile(
                    ...
                    children: <Widget>[
                      ListTile(key: tileKey, title: const Text('0')),
                    ],
                  ),
                  ExpansionTile(
                    key: collapsedKey,
      ...
      expect(
        getHeight(topKey),
        getHeight(expandedKey) - getHeight(tileKey) - 2.0,
      );
      ...
      expect(
        (expandedContainerDecoration.shape as Border).top.color,
        dividerColor,
      );
      expect(
        (expandedContainerDecoration.shape as Border).bottom.color,
        dividerColor,
      );
      ...
      expect(
        (collapsedContainerDecoration.shape as Border).top.color,
        Colors.transparent,
      );
      expect(
        (collapsedContainerDecoration.shape as Border).bottom.color,
        Colors.transparent,
      );
      ...
      expect(
        getHeight(topKey),
        getHeight(collapsedKey) - getHeight(tileKey) - 2.0,
      );
      expect(
        getHeight(topKey),
        getHeight(defaultKey) - getHeight(tileKey) - 2.0,
      );
        ...
        MaterialApp(
          theme: ThemeData(
            ...
            textTheme: const TextTheme(
              titleMedium: TextStyle(color: headerColor),
            ),
          ),
          home: Material(
            child: SingleChildScrollView(
          ...
          child: SingleChildScrollView(
            child: Column(
              children: <Widget>[
                ...
                ExpansionTile(
                  title: Text('Title 2'),
                  children: <Widget>[Text('Discarding State')],
                ),
              ],
            ),
          ),
  ...
  testWidgets('expandedCrossAxisAlignment and expandedAlignment default values', (
    ...
    expect(
      child1Rect.left - columnRect.left,
      columnRect.right - child1Rect.right,
    );
  });
  ...
  testWidgets('Expanded ExpansionTile properties can be updated with setState', (
    ...
    material = getMaterial(tester);
    iconColor = tester
        .state<TestIconState>(find.byType(TestIcon))
        .iconTheme
        .color!;
    textColor = tester
        .state<TestTextState>(find.byType(TestText))
        .textStyle
        .color!;
  ...
  testWidgets('ExpansionTile uses ListTileTheme controlAffinity', (
    WidgetTester tester,
  ) async {
      ...
      return MaterialApp(
        home: ListTileTheme(
          ...
          child: const Material(
            child: ExpansionTile(title: Text('ExpansionTile')),
          ),
        ),
      );
    }
