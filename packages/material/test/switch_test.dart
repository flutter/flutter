...
void main() {
  ...
  testWidgets('Material2 - Switch has default colors when enabled', (
    WidgetTester tester,
  ) async {
    bool value = false;
    await tester.pumpWidget(
  ...
  testWidgets('Material3 - Switch has default colors when enabled', (
    WidgetTester tester,
  ) async {
    final ThemeData theme = ThemeData();
  ...
  testWidgets('Material2 - Switch has default colors when disabled', (
    WidgetTester tester,
  ) async {
    await tester.pumpWidget(
      MaterialApp(
  ...
  testWidgets('Material2 - Switch can be set color', (
    WidgetTester tester,
  ) async {
    bool value = false;
    await tester.pumpWidget(
  ...
  testWidgets('Material3 - Switch can be set color', (
    WidgetTester tester,
  ) async {
    final ThemeData themeData = ThemeData();
    final ColorScheme colors = themeData.colorScheme;
  ...
  testWidgets('can veto switch dragging result', (WidgetTester tester) async {
    ...
    TestGesture gesture = await tester.startGesture(
      tester.getRect(find.byType(Switch)).center,
    );
  ...
  testWidgets('Switch.adaptive', (WidgetTester tester) async {
    ...
    for (final TargetPlatform platform in <TargetPlatform>[
      ...
      expect(
        adaptiveSwitch.inactiveTrackColor,
        inactiveTrackColor,
        reason: 'on ${platform.name}',
      );
      expect(
  ...
  testWidgets('Switch.adaptive default mouse cursor(Cupertino)', (
    WidgetTester tester,
  ) async {
    for (final TargetPlatform platform in <TargetPlatform>[
      TargetPlatform.iOS,
      ...
      await tester.pumpWidget(
        buildAdaptiveSwitch(platform: platform, value: false),
      );
      ...
      await gesture.removePointer(
        location: tester.getCenter(find.byType(Switch)),
      );
      await tester.pump();
    }
  });
  ...
  testWidgets('Switch.adaptive default thumb/track color and size(Cupertino)', (
    ...
    const Color activeTrackColor = Color.fromARGB(
      255,
      52,
      199,
      89,
    ...
    for (final TargetPlatform platform in <TargetPlatform>[
      ...
      expect(
        ...
        paints
          ...
          ) // Thumb border color(only cupertino)
          ..rrect(color: thumbColor, rrect: inactiveThumbRRect),
        reason:
            'Inactive enabled switch should have default track and thumb color',
      );
      ...
      expect(
        ...
        reason:
            'Active enabled switch should have default track and thumb color',
      );
      expect(find.byType(Opacity), findsOneWidget);
      expect(tester.widget<Opacity>(find.byType(Opacity)).opacity, 1.0);
      ...
      expect(
        ...
        paints
          ...
          ..rrect(color: thumbColor, rrect: inactiveThumbRRect),
        reason:
            'Inactive disabled switch should have default track and thumb color',
      );
      expect(find.byType(Opacity), findsOneWidget);
      ...
      await tester.pumpWidget(Container());
      await tester.pumpWidget(
        buildAdaptiveSwitch(platform: platform, enabled: false),
      );
      await tester.pump();
      expect(
        Material.of(tester.element(find.byType(Switch))),
        paints
          ...
          ..rrect(color: thumbColor, rrect: activeThumbRRect),
        reason:
            'Active disabled switch should have default track and thumb color',
      );
      expect(find.byType(Opacity), findsOneWidget);
      expect(tester.widget<Opacity>(find.byType(Opacity)).opacity, 0.5);
    }
  ...
  testWidgets('Default Switch.adaptive are not affected by '
    ...
    for (final TargetPlatform platform in <TargetPlatform>[
      ...
      expect(
        ...
        reason:
            'Active enabled switch should still have default track and thumb color',
      );
  ...
  testWidgets('Switch.adaptive default focus color(Cupertino)', (
    WidgetTester tester,
  ) async {
    tester.binding.focusManager.highlightStrategy =
        FocusHighlightStrategy.alwaysTraditional;
  ...
  group('Switch M3 only tests', () {
    testWidgets('M3 Switch has a 300-millisecond animation in total', (
      WidgetTester tester,
    ) async {
      final ThemeData theme = ThemeData();
      bool value = false;
    ...
    testWidgets('M3 Switch thumb bounces in the end of the animation', (
      WidgetTester tester,
    ) async {
      final ThemeData theme = ThemeData();
      bool value = false;
  ...
  testWidgets('Material2 - Switch activeThumbColor', (
    WidgetTester tester,
  ) async {
  ...
  testWidgets('Material3 - Switch activeThumbColor', (
    WidgetTester tester,
  ) async {
    const Color activeColor = Color(0xffff0000);
    const Color activeThumbColor = Color(0xff00ff00);
  ...
  testWidgets('Material2 - Switch.adaptive activeThumbColor', (
    WidgetTester tester,
  ) async {
    const Color activeColor = Color(0xffff0000);
    const Color activeThumbColor = Color(0xff00ff00);
  ...
  testWidgets('Material3 - Switch.adaptive activeThumbColor', (
    WidgetTester tester,
  ) async {
    const Color activeColor = Color(0xffff0000);
    const Color activeThumbColor = Color(0xff00ff00);
