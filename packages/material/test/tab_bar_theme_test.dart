...
void main() {
  test('TabBarThemeData copyWith, ==, hashCode, defaults', () {
    ...
    expect(
      const TabBarThemeData().hashCode,
      const TabBarThemeData().copyWith().hashCode,
    );
  ...
  testWidgets('Default TabBarThemeData debugFillProperties', (
    WidgetTester tester,
  ) async {
  ...
  testWidgets('TabBarThemeData implements debugFillProperties', (
    WidgetTester tester,
  ) async {
    final DiagnosticPropertiesBuilder builder = DiagnosticPropertiesBuilder();
  ...
  testWidgets('Local TabBarTheme overrides defaults', (
    WidgetTester tester,
  ) async {
    ...
    await tester.pumpWidget(
      buildTabBar(useMaterial3: true, localTabBarTheme: tabBarTheme),
    );
  ...
  testWidgets(
    ...
    (WidgetTester tester) async {
      ...
      expect(
        tabOneRect.right,
        equals(tabTwoRect.left - (2 * horizontalPadding)),
      );
    },
  );
  ...
  testWidgets(
    ...
    (WidgetTester tester) async {
      ...
      final IconThemeData selectedTabIcon = IconTheme.of(
        tester.element(find.text(_tab1Text)),
      );
      final IconThemeData unselectedTabIcon = IconTheme.of(
        tester.element(find.text(_tab2Text)),
      );
    ...
    (WidgetTester tester) async {
      ...
      await tester.pumpWidget(
        buildTabBar(
          theme: ThemeData(
            tabBarTheme: const TabBarThemeData(
              indicatorColor: tabBarThemeIndicatorColor,
            ),
          ),
        ),
      );
  ...
  testWidgets(
    ...
    (WidgetTester tester) async {
      ...
      Widget buildTabs({TextScaler? textScaler}) {
        return MaterialApp(
          theme: ThemeData(
            tabBarTheme: TabBarThemeData(textScaler: textScaler),
          ),
          home: MediaQuery(
  ...
  testWidgets(
    'TabBarTheme indicatorAnimation can customize tab indicator animation',
    (WidgetTester tester) async {
  ...
  testWidgets('TabBar inherits splashBorderRadius from theme', (
    WidgetTester tester,
  ) async {
