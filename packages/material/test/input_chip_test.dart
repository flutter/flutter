        ...
        builder: (BuildContext context) {
          ...
          return ChipTheme(
            data: themeColor == null
                ? chipTheme
                : chipTheme.copyWith(checkmarkColor: themeColor),
            child: chip,
          );
        },
      ),
...
void main() {
  testWidgets('InputChip.color resolves material states', (
    WidgetTester tester,
  ) async {
  ...
  testWidgets('InputChip uses provided state color properties', (
    WidgetTester tester,
  ) async {
    const Color disabledColor = Color(0xff00ff00);
    const Color backgroundColor = Color(0xff0000ff);
  ...
  testWidgets(
    ...
    (WidgetTester tester) async {
      ...
      await tester.pumpWidget(
        wrapForChip(child: const InputChip(label: label)),
      );
  ...
  testWidgets(
    'Material3 - Input chip has correct selected color when enabled',
    (WidgetTester tester) async {
      final ThemeData theme = ThemeData();
      await pumpCheckmarkChip(
        tester,
      ...
      expect(
        materialBox,
        paints..rrect(color: theme.colorScheme.secondaryContainer),
      );
    },
  );

  testWidgets(
    'Material3 - Input chip has correct selected color when disabled',
    (WidgetTester tester) async {
      final ThemeData theme = ThemeData();
      await pumpCheckmarkChip(tester, chip: selectedInputChip(), theme: theme);
  ...
  testWidgets('Delete button is visible on disabled InputChip', (
    WidgetTester tester,
  ) async {
    await tester.pumpWidget(
      wrapForChip(
  ...
  testWidgets('InputChip avatar layout constraints can be customized', (
    WidgetTester tester,
  ) async {
  ...
  testWidgets('InputChip.chipAnimationStyle is passed to RawChip', (
    WidgetTester tester,
  ) async {
