...
SerializableWaitCondition _deserialize(Map<String, String> json, {String? path}) {
  final String? conditionName = json['conditionName'];
  if (conditionName == null) {
    throw ArgumentError.notNull(path == null ? 'conditionName' : '$path.conditionName');
  }
  return switch (conditionName) {
    ...
    'CombinedCondition' => CombinedCondition.deserialize(json, path: path),
