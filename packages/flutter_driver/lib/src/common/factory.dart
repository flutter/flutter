...
mixin CommandDeserializerFactory {
...
mixin CommandHandlerFactory {
  ...
  Future<Result?> handleCommand(Command command) {
    switch(command.kind) {
      ...
      case 'get_text': return _getText(command);
      case 'request_data': return _requestData(command);
      case 'scroll': return _scroll(command);
      case 'scrollIntoView': return _scrollIntoView(command);
      ...
      case 'tap': return _tap(command);
      case 'waitFor': return _waitFor(command);
      case 'waitForAbsent': return _waitForAbsent(command);
      ...
      case 'get_semantics_id': return _getSemanticsId(command);
      case 'get_offset': return _getOffset(command);
      case 'get_diagnostics_tree': return _getDiagnosticsTree(command);
    }
