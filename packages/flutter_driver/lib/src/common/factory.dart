...
mixin CommandHandlerFactory {
  ...
  Future<Result?> handleCommand(Command command, CreateFinderFactory finderFactory) {
    switch(command.kind) {
      ...
      case 'scroll': return _scroll(command, finderFactory);
      ...
      case 'tap': return _tap(command, finderFactory);
  ...
  Future<TapResult> _tap(Command command, CreateFinderFactory finderFactory) async {
  ...
  Future<ScrollResult> _scroll(Command command, CreateFinderFactory finderFactory) async {
