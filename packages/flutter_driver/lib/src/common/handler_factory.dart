...
mixin CreateFinderFactory {
  ...
  Finder createFinder(final SerializableFinder finder) {
  ...
  Finder _createByTextFinder(final ByText arguments) {
    return find.text(arguments.text);
  }

  Finder _createByTooltipMessageFinder(final ByTooltipMessage arguments) {
    return find.byElementPredicate((final Element element) {
  ...
  Finder _createBySemanticsLabelFinder(final BySemanticsLabel arguments) {
    return find.byElementPredicate((final Element element) {
  ...
  Finder _createByValueKeyFinder(final ByValueKey arguments) {
  ...
  Finder _createByTypeFinder(final ByType arguments) {
    return find.byElementPredicate((final Element element) {
  ...
  Finder _createAncestorFinder(final Ancestor arguments) {
  ...
  Finder _createDescendantFinder(final Descendant arguments) {
...
mixin CommandHandlerFactory {
  ...
  Future<Result> handleCommand(final Command command, final WidgetController prober, final CreateFinderFactory finderFactory) {
    switch(command.kind) {
  ...
  Future<Health> _getHealth(final Command command) async => const Health(HealthStatus.ok);

  Future<LayerTree> _getLayerTree(final Command command) async {
    return LayerTree(RendererBinding.instance.renderView.debugLayer?.toStringDeep());
  }

  Future<RenderTree> _getRenderTree(final Command command) async {
    return RenderTree(RendererBinding.instance.renderView.toStringDeep());
  }

  Future<Result> _enterText(final Command command) async {
  ...
  Future<Result> _sendTextInputAction(final Command command) async {
    if (!_testTextInput.isRegistered) {
  ...
  Future<RequestDataResult> _requestData(final Command command) async {
  ...
  Future<Result> _setFrameSync(final Command command) async {
    final SetFrameSync setFrameSyncCommand = command as SetFrameSync;
    _frameSync = setFrameSyncCommand.enabled;
    return Result.empty;
  }

  Future<Result> _tap(final Command command, final WidgetController prober, final CreateFinderFactory finderFactory) async {
  ...
  Future<Result> _waitFor(final Command command, final CreateFinderFactory finderFactory) async {
    final WaitFor waitForCommand = command as WaitFor;
    await waitForElement(finderFactory.createFinder(waitForCommand.finder));
    return Result.empty;
  }

  Future<Result> _waitForAbsent(final Command command, final CreateFinderFactory finderFactory) async {
  ...
  Future<Result> _waitForTappable(final Command command, final CreateFinderFactory finderFactory) async {
  ...
  Future<Result> _waitForCondition(final Command command) async {
  ...
  Future<Result> _waitUntilNoTransientCallbacks(final Command command) async {
  ...
  Future<Result> _waitUntilNoPendingFrame(final Command command) async {
  ...
  Future<GetSemanticsIdResult> _getSemanticsId(final Command command, final CreateFinderFactory finderFactory) async {
  ...
  Future<GetOffsetResult> _getOffset(final Command command, final CreateFinderFactory finderFactory) async {
  ...
  Future<DiagnosticsTreeResult> _getDiagnosticsTree(final Command command, final CreateFinderFactory finderFactory) async {
  ...
  Future<Result> _scroll(final Command command, final WidgetController prober, final CreateFinderFactory finderFactory) async {
  ...
  Future<Result> _scrollIntoView(final Command command, final CreateFinderFactory finderFactory) async {
  ...
  Future<GetTextResult> _getText(final Command command, final CreateFinderFactory finderFactory) async {
  ...
  Future<Result> _setTextEntryEmulation(final Command command) async {
  ...
  Future<SetSemanticsResult> _setSemantics(final Command command) async {
    ...
    if (setSemanticsCommand.enabled && _semantics == null) {
      ...
      if (!semanticsWasEnabled) {
        ...
        SchedulerBinding.instance.addPostFrameCallback((final Duration d) {
          completer.complete();
        });
  ...
  Future<Result> _waitUntilFirstFrameRasterized(final Command command) async {
    await WidgetsBinding.instance.waitUntilFirstFrameRasterized;
    return Result.empty;
  }

  /// Runs `finder` repeatedly until it finds one or more [Element]s.
  Future<Finder> waitForElement(final Finder finder) async {
    if (_frameSync) {
      await _waitUntilFrame(() => SchedulerBinding.instance.transientCallbackCount == 0);
    }
  ...
  Future<Finder> waitForAbsentElement(final Finder finder) async {
    if (_frameSync) {
      await _waitUntilFrame(() => SchedulerBinding.instance.transientCallbackCount == 0);
    }
