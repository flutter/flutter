...
class GetDiagnosticsTree extends CommandWithTarget {
  ...
  GetDiagnosticsTree.deserialize(Map<String, dynamic> json)
      : subtreeDepth = json['subtreeDepth'] == 'null' ? null : int.parse(json['subtreeDepth']),
  ...
  /// of the object identified by [finder]. May be set to null to request the
  /// entire subtree starting with the object identified by [finder] as the
  /// root.
