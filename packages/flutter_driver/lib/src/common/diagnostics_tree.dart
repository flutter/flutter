...
class GetDiagnosticsTree extends CommandWithTarget {
  ...
  GetDiagnosticsTree.deserialize(Map<String, dynamic> json)
      : subtreeDepth = int.parse(json['subtreeDepth'] as String),
        includeProperties = json['includeProperties'] == 'true',
        diagnosticsType = _diagnosticsTypeIndex.lookupBySimpleName(json['diagnosticsType'] as String),
        super.deserialize(json.cast<String, String>());
