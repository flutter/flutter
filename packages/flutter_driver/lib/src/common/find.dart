...
abstract class SerializableFinder {
  ...
  static SerializableFinder deserialize(Map<String, String> json) {
    ...
    switch (finderType) {
      ...
      case 'BySemanticLabel': return BySemanticLabel.deserialize(json);
...
class BySemanticLabel extends SerializableFinder {
  /// Creates a semantic label finder given the [label].
  BySemanticLabel(this.label);

  /// The [Semantics.properties.label].
  final String label;

  @override
  final String finderType = 'BySemanticLabel';
  ...
  /// Deserializes the finder from JSON generated by [serialize].
  static BySemanticLabel deserialize(Map<String, String> json) {
    return BySemanticLabel(json['label']);
  }
}
