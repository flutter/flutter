...
abstract class CommandWithTarget extends Command {
  ...
  CommandWithTarget.deserialize(super.json, DeserializeFinderFactory finderFactory, {String? path})
    : finder = finderFactory.deserializeFinder(json, path: path),
      super.deserialize();
...
class WaitFor extends CommandWithTarget {
  ...
  /// Deserializes this command from the value generated by [serialize].
  WaitFor.deserialize(super.json, super.finderFactory, {super.path}) : super.deserialize();
...
class WaitForTappable extends CommandWithTarget {
  ...
  WaitForTappable.deserialize(super.json, super.finderFactory, {super.path}) : super.deserialize();
