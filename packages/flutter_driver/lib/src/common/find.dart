...
/// A Flutter Driver command that waits until there's no pending platform channel messages.
class WaitUntilNoPendingChannelMessages extends Command {
  /// Creates a command that waits until there's no platform channel messages in processing.
  const WaitUntilNoPendingChannelMessages({ Duration timeout }) : super(timeout: timeout);

  /// Deserializes this command from the value generated by [serialize].
  WaitUntilNoPendingChannelMessages.deserialize(Map<String, String> json)
    : super.deserialize(json);

  @override
  String get kind => 'waitUntilNoPendingChannelMessages';
}
