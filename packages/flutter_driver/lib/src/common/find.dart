...
class Descendant extends SerializableFinder {
  ...
  /// Deserializes the finder from JSON generated by [serialize].
  static Descendant deserialize(Map<String, String> serialized) {
    final Map<String, dynamic> of = json.decode(serialized['of']);
    final Map<String, dynamic> matching = json.decode(serialized['matching']);
    return Descendant(
      of: SerializableFinder.deserialize(of.cast<String, String>()),
      matching: SerializableFinder.deserialize(matching.cast<String, String>()),
      matchRoot: serialized['matchRoot'] == 'true',
    );
  }
}
...
class Ancestor extends SerializableFinder {
  ...
  /// Deserializes the finder from JSON generated by [serialize].
  static Ancestor deserialize(Map<String, String> serialized) {
    final Map<String, dynamic> of = json.decode(serialized['of']);
    final Map<String, dynamic> matching = json.decode(serialized['matching']);
    return Ancestor(
      of: SerializableFinder.deserialize(of.cast<String, String>()),
