...
class ByValueKey extends SerializableFinder {
  ...
  ByValueKey(this.keyValue, {this.skipOffstage = true})
  ...
  /// Skips offstage widgets if true.
  ...
  Map<String, String> serialize() => super.serialize()..addAll(<String, String>{
    ...
    'skipOffstage': skipOffstage.toString(),
  });
  ...
  static ByValueKey deserialize(Map<String, String> json) {
    ...
    final bool skipOffstage = json['skipOffstage'] == 'true';
    switch (keyValueType) {
      case 'int':
        return ByValueKey(int.parse(keyValueString), skipOffstage: skipOffstage);
      case 'String':
        return ByValueKey(keyValueString, skipOffstage: skipOffstage);
      default:
