...
DriverError _createInvalidKeyValueTypeError(final String invalidType) {
...
abstract class CommandWithTarget extends Command {
  ...
  CommandWithTarget.deserialize(super.json, final DeserializeFinderFactory finderFactory)
...
class ByTooltipMessage extends SerializableFinder {
  ...
  static ByTooltipMessage deserialize(final Map<String, String> json) {
...
class BySemanticsLabel extends SerializableFinder {
  ...
  /// Deserializes the finder from JSON generated by [serialize].
  static BySemanticsLabel deserialize(final Map<String, String> json) {
...
class ByText extends SerializableFinder {
  ...
  /// Deserializes the finder from JSON generated by [serialize].
  static ByText deserialize(final Map<String, String> json) {
...
class ByValueKey extends SerializableFinder {
  ...
  /// Deserializes the finder from JSON generated by [serialize].
  static ByValueKey deserialize(final Map<String, String> json) {
...
class ByType extends SerializableFinder {
  ...
  /// Deserializes the finder from JSON generated by [serialize].
  static ByType deserialize(final Map<String, String> json) {
...
class Descendant extends SerializableFinder {
  ...
  /// Deserializes the finder from JSON generated by [serialize].
  static Descendant deserialize(final Map<String, String> json, final DeserializeFinderFactory finderFactory) {
...
class Ancestor extends SerializableFinder {
  ...
  /// Deserializes the finder from JSON generated by [serialize].
  static Ancestor deserialize(final Map<String, String> json, final DeserializeFinderFactory finderFactory) {
    final Map<String, String> jsonOfMatcher =
        Map<String, String>.from(jsonDecode(json['of']!) as Map<String, dynamic>);
    final Map<String, String> jsonMatchingMatcher =
        Map<String, String>.from(jsonDecode(json['matching']!) as Map<String, dynamic>);
...
class GetSemanticsIdResult extends Result {
  ...
  static GetSemanticsIdResult fromJson(final Map<String, dynamic> json) {
