...
class WaitUntilIdle extends Command {
  /// Creates a command that waits until the app is idle.
  const WaitUntilIdle({ Duration timeout }) : super(timeout: timeout);

  /// Deserializes this command from the value generated by [serialize].
  WaitUntilIdle.deserialize(Map<String, String> json)
    : super.deserialize(json);

  @override
  String get kind => 'waitUntilIdle';
}
