...
class Tap extends CommandWithTarget {
  ...
  Tap.deserialize(Map<String, String> json, DeserializeFinderFactory finderFactory)
...
class ScrollIntoView extends CommandWithTarget {
  ...
  /// scrolled into view.
  ScrollIntoView(SerializableFinder finder, {this.alignment = 0.0, Duration? timeout})
      : super(finder, timeout: timeout);
