...
class GetText extends CommandWithTarget {
  ...
  GetText.deserialize(super.json, super.finderFactory, {super.path}) : super.deserialize();
...
class EnterText extends Command {
  ...
  /// Deserializes this command from the value generated by [serialize].
  EnterText.deserialize(super.json, {String? path}) : text = json['text']!, super.deserialize();
