...
abstract class FinderExtension {
  ...
  /// Check [Ancestor] for an example of finder, where other [Finder]s
...
abstract class CommandExtension {
  ...
  ///
  /// Use [finderFactory] to deserialize nested [Finder]s.
  /// Usually used for [CommandWithTarget]s. Check [Tap]
  /// for an example of command, where [Finder] is used as a parameter.
  ///
