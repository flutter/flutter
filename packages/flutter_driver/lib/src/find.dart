...
abstract class CommandWithTarget extends Command {
  ...
  CommandWithTarget.deserialize(Map<String, dynamic> json)
...
abstract class SerializableFinder {
  ...
  static SerializableFinder deserialize(Map<String, dynamic> json) {
...
class ByTooltipMessage extends SerializableFinder {
  ...
  static ByTooltipMessage deserialize(Map<String, dynamic> json) {
...
class ByText extends SerializableFinder {
  ...
  /// Deserializes the finder from JSON generated by [serialize].
  static ByText deserialize(Map<String, dynamic> json) {
...
class ByValueKey extends SerializableFinder {
  ...
  /// Deserializes the finder from JSON generated by [serialize].
  static ByValueKey deserialize(Map<String, dynamic> json) {
