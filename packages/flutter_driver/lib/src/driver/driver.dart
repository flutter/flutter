...
import 'package:flutter_driver/src/driver/wip_driver.dart';
...
abstract class FlutterDriver {
  ...
  static Future<FlutterDriver> connect({
    ...
    if (browser) {
      return WipFlutterDriver.connectWeb(hostUrl: dartVmServiceUrl);
    }
  ...
  /// Internal method for sending a command to the application isolate.
