...
void main() {
  group('TimelineSummary', () {
    ...
    Map<String, dynamic> vsyncCallback(int timeStamp,
            {String phase = 'B', String startTime = '2750850055428', String endTime = '2750866722095'}) =>
        <String, dynamic>{
    ...
    group('writeTimelineToFile', () {
      ...
      test('writes timeline to JSON file without summary', () async {
        ...
        final String written = await fs.file(path.join(tempDir.path, 'test.timeline.json')).readAsString();
      ...
      test('writes summary to JSON file', () async {
        ...
        final String written = await fs.file(path.join(tempDir.path, 'test.timeline_summary.json')).readAsString();
    ...
    group('RefreshRateSummarizer tests', () {
      ...
      List<Map<String, dynamic>> _populateEvents(
          {required int numberOfEvents, required int startTime, required int interval, required int margin}) {
        final List<Map<String, dynamic>> events = <Map<String, dynamic>>[];
      ...
      test('Recognize 30 hz frames.', () async {
        ...
        final List<Map<String, dynamic>> events = _populateEvents(
          numberOfEvents: 100,
