...
const Map<String, dynamic> dateSymbols = <String, dynamic>{
  ...
  'th': <String, dynamic>{
    'NAME': r'''th''',
    'ERAS': <dynamic>[r'''ก่อน ค.ศ.''', r'''ค.ศ.'''],
    'ERANAMES': <dynamic>[r'''ปีก่อนคริสตกาล''', r'''คริสต์ศักราช'''],
    'NARROWMONTHS': <dynamic>[
      r'''ม.ค.''',
      r'''ก.พ.''',
      r'''มี.ค.''',
...
const Map<String, Map<String, String>> datePatterns =
  ...
  'mn': <String, String>{
    ...
    'yMEd': r'''y.MM.dd. EEE''',
    'yMMM': r"""y 'оны' MMM""",
    'yMMMd': r"""y 'оны' MMM'ын' d""",
    'yMMMEd': r"""y 'оны' MMM'ын' d. EEE""",
    'yMMMM': r"""y 'оны' MMMM""",
    'yMMMMd': r"""y 'оны' MMMM'ын' d""",
    'yMMMMEEEEd': r"""y 'оны' MMMM'ын' d. EEEE""",
    'yQQQ': r"""y 'оны' QQQ""",
    'yQQQQ': r"""y 'оны' QQQQ""",
    'H': r"""HH 'ц'""",
    'Hm': r'''HH:mm''',
