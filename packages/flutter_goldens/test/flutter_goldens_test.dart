...
void main() {
  ...
  test('FlutterGoldenFileComparator - Post-Submit - correctly determines testing environment - returns true for configured Luci', () {
    final Platform platform = FakePlatform(
      environment: <String, String>{
        'FLUTTER_ROOT': _kFlutterRoot,
    ...
    expect(
      FlutterPostSubmitFileComparator.isRecommendedForEnvironment(platform),
      isTrue,
    );
  });

  test('FlutterGoldenFileComparator - Post-Submit - correctly determines testing environment - returns false - GOLDCTL not present', () {
    final Platform platform = FakePlatform(
      environment: <String, String>{
        'FLUTTER_ROOT': _kFlutterRoot,
        'SWARMING_TASK_ID': '12345678990',
  ...
  test('FlutterGoldenFileComparator - Post-Submit - correctly determines testing environment - returns false - GOLD_TRYJOB active', () {
    final Platform platform = FakePlatform(
      environment: <String, String>{
        'FLUTTER_ROOT': _kFlutterRoot,
        'SWARMING_TASK_ID': '12345678990',
  ...
  test('FlutterGoldenFileComparator - Post-Submit - correctly determines testing environment - returns false - on Cirrus', () {
    final Platform platform = FakePlatform(
      environment: <String, String>{
        'FLUTTER_ROOT': _kFlutterRoot,
        'CIRRUS_CI': 'true',
  ...
  test('FlutterGoldenFileComparator - Pre-Submit - correctly determines testing environment - returns true for Luci', () {
    final Platform platform = FakePlatform(
      environment: <String, String>{
        'FLUTTER_ROOT': _kFlutterRoot,
        'SWARMING_TASK_ID': '12345678990',
    ...
    expect(
      FlutterPreSubmitFileComparator.isRecommendedForEnvironment(platform),
      isTrue,
    );
  });

  test('FlutterGoldenFileComparator - Pre-Submit - correctly determines testing environment - returns false - not on Luci', () {
    final Platform platform = FakePlatform(
      environment: <String, String>{
        'FLUTTER_ROOT': _kFlutterRoot,
      },
  ...
  test('FlutterGoldenFileComparator - Pre-Submit - correctly determines testing environment - returns false - GOLDCTL missing', () {
    final Platform platform = FakePlatform(
      environment: <String, String>{
        'FLUTTER_ROOT': _kFlutterRoot,
        'SWARMING_TASK_ID': '12345678990',
  ...
  test('FlutterGoldenFileComparator - Pre-Submit - correctly determines testing environment - returns false - GOLD_TRYJOB missing', () {
    final Platform platform = FakePlatform(
      environment: <String, String>{
        'FLUTTER_ROOT': _kFlutterRoot,
        'SWARMING_TASK_ID': '12345678990',
  ...
  test('FlutterGoldenFileComparator - Pre-Submit - correctly determines testing environment - returns false - on Cirrus', () {
    final Platform platform = FakePlatform(
      environment: <String, String>{
        'FLUTTER_ROOT': _kFlutterRoot,
        'CIRRUS_CI': 'true',
  ...
  test('FlutterGoldenFileComparator - Skipping - correctly determines testing environment - returns true on Cirrus builds', () {
    final Platform platform = FakePlatform(
      environment: <String, String>{
        'FLUTTER_ROOT': _kFlutterRoot,
        'CIRRUS_CI': 'yep',
    ...
    expect(
      FlutterSkippingFileComparator.isRecommendedForEnvironment(platform),
      isTrue,
    );
  });

  test('FlutterGoldenFileComparator - Skipping - correctly determines testing environment - returns true on irrelevant LUCI builds', () {
    final Platform platform = FakePlatform(
      environment: <String, String>{
        'FLUTTER_ROOT': _kFlutterRoot,
  ...
  test('FlutterGoldenFileComparator - Skipping - correctly determines testing environment - returns false - no CI', () {
    final Platform platform = FakePlatform(
      environment: <String, String>{
        'FLUTTER_ROOT': _kFlutterRoot,
      },
    ...
    expect(
      FlutterSkippingFileComparator.isRecommendedForEnvironment(
        platform),
      isFalse,
    );
  });
