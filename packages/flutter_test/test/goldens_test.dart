...
void main() {
  ...
  group('goldenFileComparator', () {
    ...
    test(
        'image comparison should not loop over all pixels when the data is the same',
        () async {
      ...
      await GoldenFileComparator.compareLists(
          invalidImageData1, invalidImageData2);
    });
  });
  ...
  group('LocalFileComparator', () {
    ...
    group('compare', () {
      ...
      group('fails', () {
        ...
        test('and generates correct output when images are not the same size',
            () async {
    ...
    group('dispose', () {
      test('disposes diffs images', () async {
        ...
        final ui.Image image2 =
            await createTestImage(width: 15, height: 5, cache: false);
        final ui.Image image3 =
            await createTestImage(width: 5, height: 10, cache: false);
