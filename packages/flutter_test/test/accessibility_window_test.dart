...
void main() {
  testWidgets('Fails correctly with configured screen size - small', (final WidgetTester tester) async {
  ...
  testWidgets('Fails correctly with configured screen size - large', (final WidgetTester tester) async {
