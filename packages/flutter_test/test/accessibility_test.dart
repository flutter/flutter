...
void main() {
  group('text contrast guideline', () {
    ...
    testWidgets(
        'black text on white background - Text Widget - inherited style',
        (WidgetTester tester) async {
      final SemanticsHandle handle = tester.ensureSemantics();
      await tester.pumpWidget(_boilerplate(
        DefaultTextStyle(
    ...
    testWidgets(
        'white text on black background - Text Widget - inherited style',
        (WidgetTester tester) async {
      final SemanticsHandle handle = tester.ensureSemantics();
      await tester.pumpWidget(_boilerplate(
        DefaultTextStyle(
  ...
  group('custom minimum contrast guideline', () {
    ...
    testWidgets('Black icons on black background', (WidgetTester tester) async {
      ...
      await expectLater(
          ...
          doesNotMeetGuideline(
              CustomMinimumContrastGuideline(finder: findIcons)));
    });
    ...
    testWidgets('Guideline ignores widgets of other types',
      ...
      await expectLater(
          tester,
          doesNotMeetGuideline(
              CustomMinimumContrastGuideline(finder: findTexts)));
      await expectLater(
          tester,
          doesNotMeetGuideline(
  ...
  group('tap target size guideline', () {
    ...
    testWidgets('Tappable box at 47 by 48', (WidgetTester tester) async {
      ...
      await expectLater(
          tester, doesNotMeetGuideline(androidTapTargetGuideline));
      handle.dispose();
    });
