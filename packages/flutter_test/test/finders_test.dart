...
void main() {
  ...
  group('text range finders', () {
    testWidgets('basic text span test', (WidgetTester tester) async {
      ...
      expect(find.textRange.ofSubstring('substringsub'),
          findsExactly(2)); // Pattern skips overlapping matches.
      expect(
          find.textRange
              .ofSubstring('substringsub')
              .first
              .evaluate()
              .single
              .textRange,
      ...
      expect(find.textRange.ofSubstring('substringsub', skipOffstage: false),
          findsExactly(3));
    });
    ...
    testWidgets('descendentOf', (WidgetTester tester) async {
      ...
      expect(
          find.textRange
              .ofSubstring('text', descendentOf: find.text('text').first),
          findsOne);
    });

    testWidgets('finds only static text for now', (WidgetTester tester) async {
      await tester.pumpWidget(
        _boilerplate(EditableText(
  ...
  group('CommonSemanticsFinders', () {
    ...
    group('scrollable', () {
      testWidgets('can find node that can scroll up',
          (WidgetTester tester) async {
      ...
      testWidgets('can find node that can scroll down',
          (WidgetTester tester) async {
      ...
      testWidgets('can find node that can scroll left',
          (WidgetTester tester) async {
        final ScrollController controller = ScrollController();
        await tester.pumpWidget(MaterialApp(
          home: SingleChildScrollView(
      ...
      testWidgets('can find node that can scroll right',
          (WidgetTester tester) async {
        final ScrollController controller =
      ...
      testWidgets('can exclusively find node that scrolls vertically',
          (WidgetTester tester) async {
        await tester.pumpWidget(const MaterialApp(
            home: Column(
          children: <Widget>[
