...
///
/// This type is used to describe a collection of DistanceFunction<T> functions
/// which have (potentially) unrelated argument types.  Since the argument types
/// of the functions may be unrelated, the only thing that the type system can
/// statically assume about them is that they accept null (since all types in
/// Dart are nullable).
///
