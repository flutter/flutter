...
class LiveTestWidgetsFlutterBinding extends TestWidgetsFlutterBinding {
  ...
  ///
  /// Defaults to true.
  bool get showTestPointerCrosshairs => _showTestPointerCrosshairs;
  bool _showTestPointerCrosshairs = true;
  set showTestPointerCrosshairs(bool value) {
    if (_showTestPointerCrosshairs == value) {
      return;
    }
    _showTestPointerCrosshairs = value;
    if (!value) {
      for (final RenderView renderView in renderViews) {
        _renderViewToPointerIdToPointerRecord[renderView]?.clear();
      }
      _markViewsNeedPaint();
    }
  }
