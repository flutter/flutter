...
void test(
  ...
  // This is deliberately an exact type check rather than an `is` check: a
  // subclass of DefaultTestVariant may override setUp and tearDown, and so must
  // still go through the variant path below.
