...
void main() {
  ...
  testWidgetsWithLeakTracking('SegmentedControl dark mode',
      (WidgetTester tester) async {
    const Map<int, Widget> children = <int, Widget>{
      0: Text('Child 1'),
      1: Icon(IconData(1)),
  ...
  testWidgetsWithLeakTracking('Long press not-selected child interactions',
      (WidgetTester tester) async {
    const Map<int, Widget> children = <int, Widget>{
      0: Text('Child 1'),
      1: Text('Child 2'),
  ...
  testWidgetsWithLeakTracking('Insert segment while animation is running',
      (WidgetTester tester) async {
  ...
  testWidgetsWithLeakTracking('change selection programmatically when dragging',
      (WidgetTester tester) async {
    const Map<int, Widget> children = <int, Widget>{
      0: Text('A'),
      1: Text('B'),
  ...
  testWidgetsWithLeakTracking('Disallow new gesture when dragging',
      (WidgetTester tester) async {
    const Map<int, Widget> children = <int, Widget>{
      0: Text('A'),
      1: Text('B'),
  ...
  testWidgetsWithLeakTracking('gesture outlives the widget',
      (WidgetTester tester) async {
  ...
  testWidgetsWithLeakTracking('computeDryLayout is pure',
      (WidgetTester tester) async {
  ...
  testWidgetsWithLeakTracking('Has consistent size, independent of groupValue',
      (WidgetTester tester) async {
