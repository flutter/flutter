...
void main() {
  ...
  testWidgetsWithLeakTracking(
      'CupertinoSwitch can be toggled by keyboard shortcuts',
      (WidgetTester tester) async {
    bool value = true;
  ...
  testWidgetsWithLeakTracking('Switch emits light haptic vibration on tap',
      (WidgetTester tester) async {
    final Key switchKey = UniqueKey();
    bool value = false;
  ...
  testWidgetsWithLeakTracking('Haptic vibration triggers on drag',
      (WidgetTester tester) async {
    bool value = false;
    final List<MethodCall> log = <MethodCall>[];
  ...
  testWidgetsWithLeakTracking('Switch is translucent when disabled',
      (WidgetTester tester) async {
    await tester.pumpWidget(
  ...
  testWidgetsWithLeakTracking('Switch is using track color when set',
      (WidgetTester tester) async {
  ...
  testWidgetsWithLeakTracking('Switch is using default thumb color',
      (WidgetTester tester) async {
    await tester.pumpWidget(
      const Directionality(
        textDirection: TextDirection.ltr,
  ...
  testWidgetsWithLeakTracking('Switch is using thumb color when set',
      (WidgetTester tester) async {
  ...
  testWidgetsWithLeakTracking('Switch is opaque when enabled',
      (WidgetTester tester) async {
    await tester.pumpWidget(
      Directionality(
        textDirection: TextDirection.ltr,
  ...
  testWidgetsWithLeakTracking('Switch turns opaque after becoming enabled',
      (WidgetTester tester) async {
    await tester.pumpWidget(
      const Directionality(
        textDirection: TextDirection.ltr,
  ...
  testWidgetsWithLeakTracking('Switch renders correctly in dark mode',
      (WidgetTester tester) async {
    final Key switchKey = UniqueKey();
    bool value = false;
    await tester.pumpWidget(
  ...
  testWidgetsWithLeakTracking(
      'Switch can apply the ambient theme and be opted out',
      (WidgetTester tester) async {
    final Key switchKey = UniqueKey();
    bool value = false;
    await tester.pumpWidget(
  ...
  testWidgetsWithLeakTracking(
      'CupertinoSwitch is focusable and has correct focus color',
      (WidgetTester tester) async {
  ...
  testWidgetsWithLeakTracking('CupertinoSwitch.onFocusChange callback',
      (WidgetTester tester) async {
    final FocusNode focusNode = FocusNode(debugLabel: 'CupertinoSwitch');
    addTearDown(focusNode.dispose);
    bool focused = false;
