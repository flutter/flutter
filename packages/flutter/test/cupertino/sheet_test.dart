...
void main() {
  ...
  testWidgets('Sheet route does not cover the whole screen', (WidgetTester tester) async {
          ...
          child: Center(
            child: Column(
              children: <Widget>[
                ...
                CupertinoButton(
                  onPressed: () {
                    Navigator.push<void>(scaffoldKey.currentContext!, CupertinoSheetRoute<void>(
    ...
    expect(
      tester.getTopLeft(find.ancestor(of: find.text('Page 2'), matching: find.byType(CupertinoPageScaffold))).dy,
      greaterThan(0.0)
    );
  });

  testWidgets('Previous route moves slight downward when sheet route is pushed', (WidgetTester tester) async {
    final GlobalKey scaffoldKey = GlobalKey();
    ...
    expect(find.text('Page 1'), findsOneWidget);
    expect(
      tester.getTopLeft(find.ancestor(of: find.text('Page 1'), matching: find.byType(CupertinoPageScaffold))).dy,
      equals(0.0)
    );
    expect(find.text('Page 2'), findsNothing);
    ...
    expect(find.text('Page 1'), findsOneWidget);
    final Offset pageOneOffset = tester.getTopLeft(find.ancestor(of: find.text('Page 1'), matching: find.byType(CupertinoPageScaffold)));
    expect(
      pageOneOffset.dy,
      greaterThan(0.0)
    );
    ...
    expect(find.text('Page 2'), findsOneWidget);
    final double pageTwoYOffset = tester.getTopLeft(find.ancestor(of: find.text('Page 2'), matching: find.byType(CupertinoPageScaffold))).dy;
    expect(
      pageTwoYOffset,
      greaterThan(pageOneOffset.dy)
    );
  });
  ...
  testWidgets('If a sheet covers another sheet, then the previous sheet moves slightly upwards', (WidgetTester tester) async {
    ...
    expect(
      previousPageTwoDY,
      greaterThan(tester.getTopLeft(find.ancestor(of: find.text('Page 2'), matching: find.byType(CupertinoPageScaffold))).dy)
    );
  });

  testWidgets('by default showCupertinoSheet does not enable nested navigation', (WidgetTester tester) async {
    final GlobalKey scaffoldKey = GlobalKey();
    ...
    expect(
      tester.getTopLeft(find.ancestor(of: find.text('Page 3'), matching: find.byType(CupertinoPageScaffold))).dy,
      equals(0.0)
    );
  });

  testWidgets('useNestedNavigation set to true enables nested navigation', (WidgetTester tester) async {
    final GlobalKey scaffoldKey = GlobalKey();
    ...
    final double pageThreeDY = tester.getTopLeft(find.ancestor(of: find.text('Page 3'), matching: find.byType(CupertinoPageScaffold))).dy;
    expect(
      pageThreeDY,
      greaterThan(0.0)
    );
