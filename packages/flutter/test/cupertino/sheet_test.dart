...
void main() {
  ...
  group('topGap parameter tests', () {
    ...
    testWidgets('sheet with custom topGap still uses default positioning', (
      WidgetTester tester,
    ) async {
      final GlobalKey scaffoldKey = GlobalKey();
      ...
      // Custom topGap parameter exists but positioning still uses default (current implementation)
      expect(sheetTopOffset, equals(600.0 * _kTopGapRatio));
    });
    ...
    testWidgets('showCupertinoSheet accepts topGap parameter', (WidgetTester tester) async {
      ...
      // topGap parameter is accepted but positioning still uses default (current implementation)
      expect(sheetTopOffset, equals(600.0 * _kTopGapRatio));
    });
    ...
    testWidgets('custom topGap disables delegated transitions', (WidgetTester tester) async {
      ...
      // Page 3 has custom topGap but positioning still uses default (current implementation)
      expect(pageThreeY, equals(600.0 * _kTopGapRatio));
    });
    ...
    testWidgets('topGap affects drag gesture calculations', (WidgetTester tester) async {
      ...
      // Custom topGap affects drag calculations but positioning still uses default (current implementation)
      expect(sheetTopOffset, equals(600.0 * _kTopGapRatio));
