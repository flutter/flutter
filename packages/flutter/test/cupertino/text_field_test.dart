...
void main() {
  ...
  testWidgets('Cupertino cursor android golden', (WidgetTester tester) async {
    ...
    await expectLater(
      ...
      matchesGoldenFile('text_field_cursor_test.cupertino.0.png', version: '2'),
    );
  }, skip: !isLinux);
  ...
  testWidgets('Cupertino cursor iOS golden', (WidgetTester tester) async {
    ...
    await expectLater(
      find.byKey(const ValueKey<int>(1)),
      matchesGoldenFile('text_field_cursor_test.cupertino.1.png', version: '2'),
    );
  }, skip: !isLinux);
  ...
  testWidgets('disabled state golden', (WidgetTester tester) async {
    ...
    await expectLater(
      ...
      matchesGoldenFile('text_field_test.disabled.png', version: '0'),
      skip: !isLinux,
    );
  });
}
