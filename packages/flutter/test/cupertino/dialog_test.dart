...
//    expect(tester.getSize(find.byType(DecoratedBox).at(1)), equals(const Size(270.0, 560.0)));
    ...
    expect(tester.getSize(find.text('The Title')), equals(const Size(230.0, 68.0)));
    expect(tester.getTopLeft(find.text('The Title')), equals(const Offset(285.0, 60.0)));
    expect(tester.getSize(find.widgetWithText(CupertinoDialogAction, 'Cancel')), equals(const Size(270.0, 108.0)));
    expect(tester.getSize(find.widgetWithText(CupertinoDialogAction, 'OK')), equals(const Size(270.0, 108.0)));
  });
