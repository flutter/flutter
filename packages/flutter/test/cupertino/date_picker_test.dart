...
void main() {
  ...
  group('Date picker', () {
    ...
    testWidgets('picker automatically scrolls away from invalid date on month change', (WidgetTester tester) async {
      ...
      await tester.drag(find.text('March'), const Offset(0, 32.0), touchSlopY: 0);
    ...
    testWidgets('picker automatically scrolls away from invalid date on day change', (WidgetTester tester) async {
      ...
      await tester.drag(find.text('27'), const Offset(0.0, -32.0), touchSlopY: 0);
      await tester.pump();
      expect(
        date,
        DateTime(2018, 2, 28),
    ...
    testWidgets('picker persists am/pm value when scrolling hours', (WidgetTester tester) async {
      ...
      // 3:00 -> 15:00
      await tester.drag(find.text('AM'), _kRowOffset, touchSlopY: 0);
      await tester.pump();
      await tester.pump(const Duration(milliseconds: 500));
      ...
      // 15:00 -> 16:00
      await tester.drag(find.text('3'), _kRowOffset, touchSlopY: 0);
      await tester.pump();
      await tester.pump(const Duration(milliseconds: 500));
      ...
      // 16:00 -> 4:00
      await tester.drag(find.text('PM'), -_kRowOffset, touchSlopY: 0);
      await tester.pump();
      await tester.pump(const Duration(milliseconds: 500));
      ...
      // 4:00 -> 3:00
      await tester.drag(find.text('4'), -_kRowOffset, touchSlopY: 0);
      await tester.pump();
      await tester.pump(const Duration(milliseconds: 500));
    ...
    testWidgets('picker automatically scrolls the am/pm column when the hour column changes enough', (WidgetTester tester) async {
      ...
      // 11:59 -> 12:59
      await tester.drag(find.text('11'), _kRowOffset, touchSlopY: 0);
      await tester.pump();
      await tester.pump(const Duration(milliseconds: 500));
      ...
      // 12:59 -> 11:59
      await tester.drag(find.text('12'), -_kRowOffset, touchSlopY: 0);
      await tester.pump();
      await tester.pump(const Duration(milliseconds: 500));
      ...
      // 11:59 -> 9:59
      await tester.drag(find.text('11'), -_kRowOffset * 2, touchSlopY: 0);
      await tester.pump();
      await tester.pump(const Duration(milliseconds: 500));
      ...
      // 9:59 -> 15:59
      await tester.drag(find.text('9'), _kRowOffset * 6, touchSlopY: 0);
      await tester.pump();
      await tester.pump(const Duration(milliseconds: 500));
