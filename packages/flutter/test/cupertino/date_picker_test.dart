  ...
  testWidgets('showDayOfWeek is only supported in date mode',
    ...
    expect(
      () => CupertinoDatePicker(
        ...
        onDateTimeChanged: (DateTime _) {}, // Adicionando a anotação de tipo
        showDayOfWeek: true,
      ),
      returnsNormally,
    );
...
>>>>>>> 34fe9a9ded56a7d8561dce51864220eb17482f5b
  ...
  group('Date picker', () {
    ...
    testWidgets(
      ...
      await tester.drag(find.text('10'), const Offset(0.0, 32.0),
          pointer: 1, touchSlopY: 0, warnIfMissed: false); // see top of file
      await tester.pump();
      await tester.pump(const Duration(milliseconds: 500));
    ...
    testWidgets(
      ...
      await tester.drag(find.text('27'), const Offset(0.0, -32.0),
          pointer: 1, touchSlopY: 0.0, warnIfMissed: false); // see top of file
      await tester.pump();
      expect(
        date,
        DateTime(2018, 2, 28),
    ...
    testWidgets('DatePicker golden tests', (WidgetTester tester) async {
      ...
      if (!skipPerspectiveTextGoldens) {
        ...
        skip:
            impellerEnabled); // https://github.com/flutter/flutter/issues/143616
  ...
  testWidgets(
    ...
    expect(
        find.byType(CupertinoPickerDefaultSelectionOverlay), findsExactly(2));
  });
  ...
  testWidgets(
    ...
    expect(
        find.byType(CupertinoPickerDefaultSelectionOverlay), findsExactly(4));
  });
