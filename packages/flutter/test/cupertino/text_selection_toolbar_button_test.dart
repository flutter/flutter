...
void main() {
  ...
  testWidgets('background darkens when pressed', (WidgetTester tester) async {
    ...
    ColoredBox coloredBox = tester.widget(find.descendant(
    ...
    coloredBox = tester.widget(find.descendant(
      of: find.byType(CupertinoTextSelectionToolbarButton),
      matching: find.byType(ColoredBox),
    ));
    expect(coloredBox.color.value, const Color(0x10000000).value);
  ...
  testWidgets('passing null to onPressed disables the button', (WidgetTester tester) async {
    ...
    final CupertinoTextSelectionToolbarButton button = tester.widget(find.byType(CupertinoTextSelectionToolbarButton));
