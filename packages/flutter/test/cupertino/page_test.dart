...
void main() {
  testWidgets('test iOS page transition (LTR)', (final WidgetTester tester) async {
  ...
  testWidgets('test iOS page transition (RTL)', (final WidgetTester tester) async {
    await tester.pumpWidget(
      CupertinoApp(
  ...
  testWidgets('test iOS fullscreen dialog transition', (final WidgetTester tester) async {
    await tester.pumpWidget(
      const CupertinoApp(
  ...
  testWidgets('test only edge swipes work (LTR)', (final WidgetTester tester) async {
    await tester.pumpWidget(
      CupertinoApp(
        onGenerateRoute: (final RouteSettings settings) {
          return CupertinoPageRoute<void>(
  ...
  testWidgets('test edge swipes work with media query padding (LTR)', (final WidgetTester tester) async {
    await tester.pumpWidget(
      CupertinoApp(
    ...
    tester.state<NavigatorState>(find.byType(Navigator)).push(
      CupertinoPageRoute<void>(
        builder: (final BuildContext context) => const Center(child: Text('Page 1')),
      ),
    );
    ...
    tester.state<NavigatorState>(find.byType(Navigator)).push(
      CupertinoPageRoute<void>(
        builder: (final BuildContext context) => const Center(child: Text('Page 2')),
      ),
    );
    await tester.pump();
    await tester.pumpAndSettle();
  ...
  testWidgets('test edge swipes work with media query padding (RLT)', (final WidgetTester tester) async {
    await tester.pumpWidget(
      CupertinoApp(
        builder: (final BuildContext context, final Widget? navigator) {
  ...
  testWidgets('test only edge swipes work (RTL)', (final WidgetTester tester) async {
    await tester.pumpWidget(
      CupertinoApp(
        localizationsDelegates: const <LocalizationsDelegate<dynamic>>[
          RtlOverrideWidgetsDelegate(),
  ...
  testWidgets('CupertinoPage does not lose its state when transitioning out', (final WidgetTester tester) async {
  ...
  testWidgets('CupertinoPage restores its state', (final WidgetTester tester) async {
    await tester.pumpWidget(
...
class RtlOverrideWidgetsDelegate extends LocalizationsDelegate<WidgetsLocalizations> {
  ...
  @override
  Future<WidgetsLocalizations> load(final Locale locale) async => const RtlOverrideWidgetsLocalization();
  @override
  bool shouldReload(final LocalizationsDelegate<WidgetsLocalizations> oldDelegate) => false;
}
