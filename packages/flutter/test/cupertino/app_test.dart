...
void main() {
  ...
  testWidgets('CupertinoApp has correct default KeyboardDismissBehavior', (WidgetTester tester) async {
    late BuildContext capturedContext;
    await tester.pumpWidget(
      CupertinoApp(
        home: Builder(
    ...
    expect(ScrollConfiguration.of(capturedContext).getKeyboardDismissBehavior(capturedContext), ScrollViewKeyboardDismissBehavior.manual);
  });

  testWidgets('CupertinoApp can override default KeyboardDismissBehavior', (WidgetTester tester) async {
    late BuildContext capturedContext;
    await tester.pumpWidget(
      CupertinoApp(
    ...
    expect(ScrollConfiguration.of(capturedContext).getKeyboardDismissBehavior(capturedContext), ScrollViewKeyboardDismissBehavior.onDrag);
  });
