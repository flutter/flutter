...
void main() {
  ...
  group('MethodChannel', () {
    ...
    test('can invoke list method and get result', () async {
      ...
      expect(channel.invokeMethod<List<String>>('sayHello', 'hello'), throwsA(isA<CastError>()));
    ...
    test('can invoke map method and get result', () async {
      ...
      expect(channel.invokeMethod<Map<String, String>>('sayHello', 'hello'), throwsA(isA<CastError>()));
