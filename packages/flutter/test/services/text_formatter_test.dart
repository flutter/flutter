...
void main() {
  ...
  test('FilteringTextInputFormatter should filter in a selection invariant way', () {
  ...
  test('FilteringTextInputFormatter should filter in a composingRegion invariant way', () {
    final TextInputFormatter formatter = FilteringTextInputFormatter.deny('abc', replacementString: '*');
  ...
  group('FilteringTextInputFormatter skipComposingRegion strategy', () {
    const TextEditingValue oldValue = TextEditingValue();
    ...
    test('Skips the composing region', () {
      ...
      expect(
        ...
        .formatEditUpdate(
          oldValue,
          newValue.copyWith(
            selection: const TextSelection(baseOffset: 5, extentOffset: 14),
