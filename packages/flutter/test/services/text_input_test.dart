...
void main() {
  ...
  group('TextInputControl', () {
    ...
    test('both input controls receive requests', () async {
      ...
      const TextInputConfiguration multilineConfig =
      ...
      fakeTextChannel.validateOutgoingMethodCalls(<MethodCall>[
        ...
        MethodCall(
            'TextInput.setClient', <dynamic>[1, noneIsMultilineFalseJson]),
      ]);
    ...
    test('the platform input control receives isMultiline true on attach',
      ...
      fakeTextChannel.validateOutgoingMethodCalls(<MethodCall>[
        ...
        // input control receives TextInputType.none with isMultiline flag
        MethodCall(
            'TextInput.setClient', <dynamic>[1, noneIsMultilineTrueJson]),
      ]);
