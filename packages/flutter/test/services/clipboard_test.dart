...
void main() {
  ...
  test('Clipboard.getData returns text', () async {
    ...
    final ClipboardData? data = await Clipboard.getData(Clipboard.kTextPlain, kImplicitViewId);
  ...
  test('Clipboard.getData throws if text is missing', () async {
    ...
    expect(
      () => Clipboard.getData(Clipboard.kTextPlain, kImplicitViewId),
  ...
  test('Clipboard.setData sets text', () async {
    await Clipboard.setData(const ClipboardData(text: 'Hello world'), kImplicitViewId);
