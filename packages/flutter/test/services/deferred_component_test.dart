...
void main() {
  ...
  test('installDeferredComponent test', () async {
    ...
    TestDefaultBinaryMessengerBinding.instance.defaultBinaryMessenger.setMockMethodCallHandler(SystemChannels.deferredComponent, (final MethodCall methodCall) async {
      log.add(methodCall);
      return null;
    });
