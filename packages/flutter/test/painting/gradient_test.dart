...
void main() {
  test('LinearGradient scale test', () {
    ...
    final LinearGradient? actual =
        LinearGradient.lerp(null, testGradient, 0.25);
  ...
  test('LinearGradient.lerp identical a,b', () {
    ...
    expect(identical(LinearGradient.lerp(gradient, gradient, 0.5), gradient),
        true);
  });
  ...
  test('RadialGradient lerp test', () {
    ...
    final RadialGradient? actual =
        RadialGradient.lerp(testGradient1, testGradient2, 0.5);
    expect(
        actual,
  ...
  test('RadialGradient.lerp identical a,b', () {
    ...
    expect(identical(RadialGradient.lerp(gradient, gradient, 0.5), gradient),
        true);
  });
  ...
  test('RadialGradient lerp test with focal', () {
    ...
    final RadialGradient? actual2 =
        RadialGradient.lerp(testGradient1, testGradient3, 0.5);
    expect(
        actual2,
        const RadialGradient(
          center: Alignment.topCenter,
  ...
  test('SweepGradient lerp test', () {
    ...
    final SweepGradient? actual =
        SweepGradient.lerp(testGradient1, testGradient2, 0.5);
    expect(
        actual,
        const SweepGradient(
          center: Alignment.topCenter,
  ...
  test('SweepGradient.lerp identical a,b', () {
    ...
    expect(
        identical(SweepGradient.lerp(gradient, gradient, 0.5), gradient), true);
  });
  ...
  test('Gradient lerp test (LinearGradient to RadialGradient)', () {
    ...
    expect(Gradient.lerp(testGradient1, testGradient2, 0.5),
        testGradient2.scale(0.0));
  });
  ...
  group('Transforms', () {
    ...
    Future<void> runTest(
        WidgetTester tester, Gradient gradient, double degrees) async {
      final String goldenName =
          '${gradientSnakeCase[gradient.runtimeType]}_$degrees.png';
