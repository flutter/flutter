...
void main() {
  Future<void> testBorder(final WidgetTester tester, final String name, final StarBorder border,
      {final ShapeBorder? lerpTo, final ShapeBorder? lerpFrom, final double lerpAmount = 0}) async {
  ...
  testWidgets('StarBorder basic geometry', (final WidgetTester tester) async {
    await testBorder(tester, 'basic_star', const StarBorder());
    await testBorder(tester, 'basic_polygon', const StarBorder.polygon());
  });

  testWidgets('StarBorder parameters', (final WidgetTester tester) async {
  ...
  testWidgets('StarBorder.polygon parameters', (final WidgetTester tester) async {
  ...
  testWidgets("StarBorder doesn't try to scale an infinite scale matrix", (final WidgetTester tester) async {
    await tester.pumpWidget(
      Directionality(
  ...
  testWidgets('StarBorder lerped with StarBorder', (final WidgetTester tester) async {
  ...
  testWidgets('StarBorder lerped with CircleBorder', (final WidgetTester tester) async {
    const StarBorder from = StarBorder();
  ...
  testWidgets('StarBorder lerped with RoundedRectangleBorder', (final WidgetTester tester) async {
    const StarBorder from = StarBorder();
  ...
  testWidgets('StarBorder lerped with StadiumBorder', (final WidgetTester tester) async {
    const StarBorder from = StarBorder();
