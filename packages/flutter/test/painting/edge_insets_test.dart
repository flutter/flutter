...
void main() {
  ...
  test('EdgeInsetsGeometry.lerp(...)', () {
    ...
    expect(
      EdgeInsetsGeometry.lerp(const EdgeInsetsDirectional.only(bottom: 10.0), EdgeInsetsDirectional.zero, 0.5),
      const EdgeInsetsDirectional.only(bottom: 5.0),
    );
    expect(
    ...
    expect(
      EdgeInsetsGeometry.lerp(
        ...
        const EdgeInsetsDirectional.only(start: 1.0, bottom: 1.0).add(const EdgeInsets.only(right: 2.0, bottom: 0.0)),
        0.5,
      ),
    ...
    expect(
      EdgeInsetsGeometry.lerp(
        ...
        const EdgeInsetsDirectional.only(end: 1.0, bottom: 1.0).add(const EdgeInsets.only(right: 2.0, bottom: 0.0)),
        0.5,
      ),
      const EdgeInsetsDirectional.only(start: 0.0, end: 0.5).add(const EdgeInsets.only(right: 1.0, bottom: 1.0)),
    );
  });
