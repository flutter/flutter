...
void main() {
  ...
  test('BeveledRectangleBorder copyWith, ==, hashCode', () {
    expect(const BeveledRectangleBorder(),
        const BeveledRectangleBorder().copyWith());
    expect(const BeveledRectangleBorder().hashCode,
  ...
  test('BeveledRectangleBorder with StrokeAlign', () {
    ...
    const BeveledRectangleBorder inside = BeveledRectangleBorder(
        side: BorderSide(width: 10.0), borderRadius: borderRadius);
    ...
    const BeveledRectangleBorder outside = BeveledRectangleBorder(
        side:
            BorderSide(width: 10.0, strokeAlign: BorderSide.strokeAlignOutside),
        borderRadius: borderRadius);
