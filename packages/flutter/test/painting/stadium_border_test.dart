...
void main() {
  ...
  test('StadiumBorder and CircleBorder', () {
    ...
    expect(
      ...
      'StadiumBorder(BorderSide(Color(0xff000000), 0.0, BorderStyle.none, StrokeAlign.inside), 10.0% of the way to being a CircleBorder)',
    );
    expect(
      ShapeBorder.lerp(stadium, circle, 0.2).toString(),
      'StadiumBorder(BorderSide(Color(0xff000000), 0.0, BorderStyle.none, StrokeAlign.inside), 20.0% of the way to being a CircleBorder)',
    );
    expect(
      ShapeBorder.lerp(ShapeBorder.lerp(stadium, circle, 0.1), ShapeBorder.lerp(stadium, circle, 0.9), 0.9).toString(),
      'StadiumBorder(BorderSide(Color(0xff000000), 0.0, BorderStyle.none, StrokeAlign.inside), 82.0% of the way to being a CircleBorder)',
    );
  ...
  test('StadiumBorder and RoundedRectBorder', () {
    ...
    expect(
      ...
      'StadiumBorder(BorderSide(Color(0xff000000), 0.0, BorderStyle.none, StrokeAlign.inside), '
