...
void main() {
  ...
  test('CircleBorder getInnerPath and getOuterPath', () {
    ...
    const CircleBorder oval = CircleBorder(circularity: 0.0);
    expect(oval.getOuterPath(rect).getBounds(), rect);
    expect(oval.getInnerPath(rect).getBounds(), rect);

    const CircleBorder o10 = CircleBorder(side: BorderSide(width: 10.0), circularity: 0.0);
  ...
  test('CircleBorder copyWith, ==, hashCode', () {
    ...
    expect(const CircleBorder(circularity: 0.5).hashCode, const CircleBorder().copyWith(circularity: 0.5).hashCode);
