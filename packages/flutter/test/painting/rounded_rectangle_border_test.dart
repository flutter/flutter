...
void main() {
  ...
  test('RoundedRectangleBorder and StadiumBorder', () {
    final RoundedRectangleBorder r = new RoundedRectangleBorder(side: BorderSide.none, borderRadius: new BorderRadius.circular(4.0));
    const StadiumBorder s = const StadiumBorder(side: BorderSide.none);
    ...
    final Matcher looksLikeS = isPathThat(
      includes: const <Offset>[ const Offset(50.0, 10.0), ],
      excludes: const <Offset>[ const Offset(1.0, 1.0), const Offset(1.0, 4.0), const Offset(99.0, 19.0), ],
    );

    expect(r.getOuterPath(rect), looksLikeR);
    expect(s.getOuterPath(rect), looksLikeS);

    expect(ShapeBorder.lerp(r, s, 0.1).getOuterPath(rect), looksLikeR);
    expect(ShapeBorder.lerp(r, s, 0.9).getOuterPath(rect), looksLikeS);
    expect(ShapeBorder.lerp(ShapeBorder.lerp(r, s, 0.9), r, 0.1).getOuterPath(rect), looksLikeS);
    expect(ShapeBorder.lerp(ShapeBorder.lerp(r, s, 0.9), r, 0.9).getOuterPath(rect), looksLikeR);
    expect(ShapeBorder.lerp(ShapeBorder.lerp(r, s, 0.1), s, 0.1).getOuterPath(rect), looksLikeR);
    expect(ShapeBorder.lerp(ShapeBorder.lerp(r, s, 0.1), s, 0.9).getOuterPath(rect), looksLikeS);
    expect(ShapeBorder.lerp(ShapeBorder.lerp(r, s, 0.1), ShapeBorder.lerp(r, s, 0.9), 0.1).getOuterPath(rect), looksLikeR);
    expect(ShapeBorder.lerp(ShapeBorder.lerp(r, s, 0.1), ShapeBorder.lerp(r, s, 0.9), 0.9).getOuterPath(rect), looksLikeS);
    expect(ShapeBorder.lerp(r, ShapeBorder.lerp(r, s, 0.9), 0.1).getOuterPath(rect), looksLikeR);
    expect(ShapeBorder.lerp(r, ShapeBorder.lerp(r, s, 0.9), 0.9).getOuterPath(rect), looksLikeS);
    expect(ShapeBorder.lerp(s, ShapeBorder.lerp(r, s, 0.1), 0.1).getOuterPath(rect), looksLikeS);
    expect(ShapeBorder.lerp(s, ShapeBorder.lerp(r, s, 0.1), 0.9).getOuterPath(rect), looksLikeR);

    expect(ShapeBorder.lerp(r, s, 0.1).toString(),
           'StadiumBorder(BorderSide(Color(0xff000000), 0.0, BorderStyle.none), BorderRadius.circular(4.0), 90.0% of the way to being a RoundedRectangleBorder)');
    expect(ShapeBorder.lerp(r, s, 0.2).toString(),
           'StadiumBorder(BorderSide(Color(0xff000000), 0.0, BorderStyle.none), BorderRadius.circular(4.0), 80.0% of the way to being a RoundedRectangleBorder)');
    expect(ShapeBorder.lerp(ShapeBorder.lerp(r, s, 0.1), ShapeBorder.lerp(r, s, 0.9), 0.9).toString(),
           'StadiumBorder(BorderSide(Color(0xff000000), 0.0, BorderStyle.none), BorderRadius.circular(4.0), 18.0% of the way to being a RoundedRectangleBorder)');

    expect(ShapeBorder.lerp(s, r, 0.9).toString(),
           'RoundedRectangleBorder(BorderSide(Color(0xff000000), 0.0, BorderStyle.none), BorderRadius.circular(4.0), 10.0% of the way to being a StadiumBorder)');
    expect(ShapeBorder.lerp(s, r, 0.8).toString(),
           'RoundedRectangleBorder(BorderSide(Color(0xff000000), 0.0, BorderStyle.none), BorderRadius.circular(4.0), 20.0% of the way to being a StadiumBorder)');
    expect(ShapeBorder.lerp(ShapeBorder.lerp(r, s, 0.9), ShapeBorder.lerp(r, s, 0.1), 0.1).toString(),
           'StadiumBorder(BorderSide(Color(0xff000000), 0.0, BorderStyle.none), BorderRadius.circular(4.0), 18.0% of the way to being a RoundedRectangleBorder)');

    expect(ShapeBorder.lerp(r, s, 0.1), ShapeBorder.lerp(r, s, 0.1));
    expect(ShapeBorder.lerp(r, s, 0.1).hashCode, ShapeBorder.lerp(r, s, 0.1).hashCode);

    final ShapeBorder direct50 = ShapeBorder.lerp(r, s, 0.5);
    final ShapeBorder indirect50 = ShapeBorder.lerp(ShapeBorder.lerp(r, s, 0.1), ShapeBorder.lerp(r, s, 0.9), 0.5);
    expect(direct50, indirect50);
    expect(direct50.hashCode, indirect50.hashCode);
    expect(direct50.toString(), indirect50.toString());
  });
