...
void main() {
  ...
  test('RoundedRectangleBorder and CircleBorder', () {
    ...
    expect(
      ...
      'RoundedRectangleBorder(BorderSide(Color(0xff000000), 0.0, BorderStyle.none, StrokeAlign.inside), BorderRadius.circular(10.0), 10.0% of the way to being a CircleBorder)',
    );
    expect(
      ShapeBorder.lerp(r, c, 0.2).toString(),
      'RoundedRectangleBorder(BorderSide(Color(0xff000000), 0.0, BorderStyle.none, StrokeAlign.inside), BorderRadius.circular(10.0), 20.0% of the way to being a CircleBorder)',
    );
    expect(
      ShapeBorder.lerp(ShapeBorder.lerp(r, c, 0.1), ShapeBorder.lerp(r, c, 0.9), 0.9).toString(),
      'RoundedRectangleBorder(BorderSide(Color(0xff000000), 0.0, BorderStyle.none, StrokeAlign.inside), BorderRadius.circular(10.0), 82.0% of the way to being a CircleBorder)',
    );
  ...
  test('RoundedRectangleBorder.dimensions and CircleBorder.dimensions', () {
    final RoundedRectangleBorder insideRoundedRectangleBorder = RoundedRectangleBorder(side: BorderSide(width: 10));
    expect(insideRoundedRectangleBorder.dimensions, const EdgeInsets.all(10));

    final RoundedRectangleBorder centerRoundedRectangleBorder = RoundedRectangleBorder(side: BorderSide(width: 10, strokeAlign: StrokeAlign.center));
    ...
    final CircleBorder centerCircleBorder = CircleBorder(side: BorderSide(width: 10, strokeAlign: StrokeAlign.center));
    expect(centerCircleBorder.dimensions, const EdgeInsets.all(5));

    final CircleBorder outsideCircleBorder = CircleBorder(side: BorderSide(width: 10, strokeAlign: StrokeAlign.outside));
