...
void main() {
  ...
  test('ContinuousRectangleBorder copyWith, ==, hashCode', () {
    expect(const ContinuousRectangleBorder(),
        const ContinuousRectangleBorder().copyWith());
    expect(const ContinuousRectangleBorder().hashCode,
  ...
  test('ContinuousRectangleBorder BorderRadius.zero', () {
    ...
    expect(
        const ContinuousRectangleBorder().getOuterPath(rect1), looksLikeRect1);
    expect(
        const ContinuousRectangleBorder().getInnerPath(rect1), looksLikeRect1);
    ...
    expect(const ContinuousRectangleBorder(side: side).getOuterPath(rect1),
        looksLikeRect1);
    expect(const ContinuousRectangleBorder(side: side).getInnerPath(rect1),
        looksLikeInnerPath);
  });
  ...
  testWidgetsWithLeakTracking('Golden test even radii',
  ...
  testWidgetsWithLeakTracking('Golden test varying radii',
      (WidgetTester tester) async {
    await tester.pumpWidget(RepaintBoundary(
      child: Material(
  ...
  testWidgetsWithLeakTracking('Golden test topLeft radii',
      (WidgetTester tester) async {
    await tester.pumpWidget(RepaintBoundary(
      child: Material(
  ...
  testWidgetsWithLeakTracking('Golden test topRight radii',
      (WidgetTester tester) async {
    await tester.pumpWidget(RepaintBoundary(
      child: Material(
  ...
  testWidgetsWithLeakTracking('Golden test bottomLeft radii',
      (WidgetTester tester) async {
    await tester.pumpWidget(RepaintBoundary(
      child: Material(
  ...
  testWidgetsWithLeakTracking('Golden test bottomRight radii',
      (WidgetTester tester) async {
    await tester.pumpWidget(RepaintBoundary(
      child: Material(
  ...
  testWidgetsWithLeakTracking('Golden test large radii',
      (WidgetTester tester) async {
    await tester.pumpWidget(RepaintBoundary(
      child: Material(
