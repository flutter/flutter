...
void main() {
  ...
  test('debugInvertOversizedImages', () async {
    ...
    expect(PaintingBinding.instance.view.devicePixelRatio != 1.0, true);
  ...
  testWidgets('Reports Image painting', (WidgetTester tester) async {
    ...
    expect(imageSizeInfo.displaySize, const Size(200, 100) * PaintingBinding.instance.view.devicePixelRatio);
  ...
  testWidgets('Reports Image painting - change per frame', (WidgetTester tester) async {
    ...
    expect(imageSizeInfo.source, 'test.png');
    expect(imageSizeInfo.imageSize, const Size(300, 300));
    expect(imageSizeInfo.displaySize, const Size(200, 150) * PaintingBinding.instance.view.devicePixelRatio);
