...
void main() {
  test('ContinuousCornerBorder scale and lerp', () {
    final ContinuousCornerBorder c10 = ContinuousCornerBorder(side: const BorderSide(width: 10.0), borderRadius: BorderRadius.circular(100.0));
    final ContinuousCornerBorder c15 = ContinuousCornerBorder(side: const BorderSide(width: 15.0), borderRadius: BorderRadius.circular(150.0));
    final ContinuousCornerBorder c20 = ContinuousCornerBorder(side: const BorderSide(width: 20.0), borderRadius: BorderRadius.circular(200.0));
  ...
  test('ContinuousCornerBorder BorderRadius.zero', () {
    ...
    expect(const ContinuousCornerBorder().getOuterPath(rect1), looksLikeRect1);
    expect(const ContinuousCornerBorder().getInnerPath(rect1), looksLikeRect1);
    ...
    expect(const ContinuousCornerBorder(side: side).getOuterPath(rect1), looksLikeRect1);
    expect(const ContinuousCornerBorder(side: side).getInnerPath(rect1), looksLikeInnerPath);
  });

  test('ContinuousCornerBorder non-zero BorderRadius', () {
    ...
    const ContinuousCornerBorder border = ContinuousCornerBorder(
  ...
  testWidgets('Golden test varying radii', (WidgetTester tester) async {
    await tester.pumpWidget(RepaintBoundary(
      child: Material(
        ...
        shape: const ContinuousCornerBorder(
