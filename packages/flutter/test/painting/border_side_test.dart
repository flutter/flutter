...
void main() {
  ...
  test('BorderSide - lerp with strokeAlign', () {
    ...
    expect(BorderSide.lerp(side0, side1, 0.5), const BorderSide(width: 2.0, strokeAlign: StrokeAlign.center));
    ...
    expect(BorderSide.lerp(side2, side3, 0.5), const BorderSide(width: 2.0, strokeAlign: StrokeAlign.all(-0.5)));
