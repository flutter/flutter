...
void main() {
  ...
  testWidgets('Golden test even radii', (WidgetTester tester) async {
    ...
    await expectLater(
      ...
      matchesGoldenFile('continuous_rectangle_border.golden_test_even_radii.1.png'),
  ...
  testWidgets('Golden test varying radii', (WidgetTester tester) async {
    ...
    await expectLater(
      find.byType(RepaintBoundary),
      matchesGoldenFile('continuous_rectangle_border.golden_test_varying_radii.1.png'),
      skip: !Platform.isLinux,
    );
  });
  ...
  testWidgets('Golden test large radii', (WidgetTester tester) async {
    ...
    await expectLater(
      find.byType(RepaintBoundary),
      matchesGoldenFile('continuous_rectangle_border.golden_test_large_radii.1.png'),
      skip: !Platform.isLinux,
    );
  });
