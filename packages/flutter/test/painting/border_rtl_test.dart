...
void main() {
  ...
  test('BorderDirectional.some constructor', () {
    ...
    const BorderDirectional borderWithDifferentStart = BorderDirectional.some(
      start: side1,
      others: side2,
    );
    ...
    const BorderDirectional borderWithDifferentTop = BorderDirectional.some(
      top: side1,
      others: side2,
    );
    ...
    const BorderDirectional borderWithDifferentEnd = BorderDirectional.some(
      end: side1,
      others: side2,
    );
    ...
    const BorderDirectional borderWithDifferentBottom = BorderDirectional.some(
      bottom: side1,
      others: side2,
    );
    ...
    const BorderDirectional borderWithAllSidesDifferent = BorderDirectional.some(
      top: side1,
      start: side2,
      end: side3,
      bottom: side4,
    ...
    expect(borderWithAllSidesDifferent.start, same(side2));
