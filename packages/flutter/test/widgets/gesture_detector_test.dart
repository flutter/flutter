            ...
            child: Padding(
              ...
              child: Center(
                child: Builder(builder: (BuildContext context){
                  return GestureDetector(
                    onPanStart: (DragStartDetails details) {
                      dragBoundary = DragPointBoundaryProvider.of(context)!.getDragBoundary(context, details.globalPosition);
                      final bool isWithinBoundary = dragBoundary!.isWithinBoundary(details.globalPosition);
                      log.add('PanStart(${isWithinBoundary ? 'InBoundary' : 'OutBoundary'})');
                    },
                    onPanUpdate: (DragUpdateDetails details) {
                      assert(dragBoundary != null);
                      final bool isWithinBoundary = dragBoundary!.isWithinBoundary(details.globalPosition);
                      log.add('PanUpdate(${isWithinBoundary ? 'InBoundary' : 'OutBoundary'})');
                    },
                    onPanEnd: (DragEndDetails details) {
                      log.add('PanEnd');
                    },
            ...
            child: Padding(
              ...
              child: Center(
                child: Builder(builder: (BuildContext context){
                  return GestureDetector(
                    onPanStart: (DragStartDetails details) {
                      dragBoundary = DragRectBoundaryProvider.of(context)!.getDragBoundary(context, details.globalPosition);
                      final bool isWithinBoundary = dragBoundary!.isWithinBoundary(details.globalPosition);
                      log.add('PanStart(${isWithinBoundary ? 'InBoundary' : 'OutBoundary'})');
                    },
                    onPanUpdate: (DragUpdateDetails details) {
