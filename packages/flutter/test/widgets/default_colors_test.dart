  ...
  testWidgets('Default background', (WidgetTester tester) async {
    await tester.pumpWidget(
      const Align(
          ...
          child: Text(_expText,
              textDirection: TextDirection.ltr, style: TextStyle(color: Color(0xFF345678), fontSize: _crispText))),
    );
    await _expectColors(
      tester,
      find.byType(Align),
                ...
                OverlayEntry(
                  builder: (BuildContext context) => SelectableRegion(
                    ...
                    child: Align(
                      ...
                      alignment: Alignment.topLeft,
                      child:
                          const Text('Éxp', textDirection: TextDirection.ltr, style: TextStyle(fontSize: _crispText)),
                    ),
                  ),
                ),
              ],
...
Future<void> _expectColors(WidgetTester tester, Finder finder, Set<Color> allowedColors,
