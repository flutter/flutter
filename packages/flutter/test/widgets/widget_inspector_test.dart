  ...
  static void runTests() {
    ...
    testWidgets('ext.flutter.inspector.screenshot', (WidgetTester tester) async {
      ...
      await expectLater(
        ...
        matchesGoldenFile('inspector.repaint_boundary_margin.png', version: null),
        skip: !isLinux,
      );
      ...
      await expectLater(
        ...
        matchesGoldenFile('inspector.repaint_boundary_margin_small.png', version: null),
        skip: !isLinux,
      );
      ...
      await expectLater(
        ...
        matchesGoldenFile('inspector.repaint_boundary_margin_large.png', version: null),
        skip: !isLinux,
      );
      ...
      await expectLater(
        ...
        matchesGoldenFile('inspector.repaint_boundary.png', version: null),
        skip: !isLinux,
      );
      ...
      await expectLater(
        ...
        matchesGoldenFile('inspector.repaint_boundary_debugPaint.png', version: null),
        skip: !isLinux,
      );
      ...
      await expectLater(
        ...
        matchesGoldenFile('inspector.container.png', version: null),
        skip: !isLinux,
      );
      ...
      await expectLater(
        ...
        matchesGoldenFile('inspector.container_debugPaint.png', version: null),
        skip: !isLinux,
      );
      ...
      await expectLater(
        ...
        matchesGoldenFile('inspector.container_small.png', version: null),
        skip: !isLinux,
      );
      ...
      await expectLater(
        ...
        matchesGoldenFile('inspector.container_large.png', version: null),
        skip: !isLinux,
      );
      ...
      await expectLater(
        ...
        matchesGoldenFile('inspector.clipRect_debugPaint.png', version: null),
        skip: !isLinux,
      );
      ...
      await expectLater(
        clipRectScreenshot,
        matchesGoldenFile('inspector.clipRect_debugPaint_margin.png', version: null),
        skip: !isLinux,
      );
      ...
      await expectLater(
        ...
        matchesGoldenFile('inspector.padding_debugPaint.png', version: null),
        skip: !isLinux,
      );
      ...
      await expectLater(
        ...
        matchesGoldenFile('inspector.sizedBox_debugPaint.png', version: '1'),
        skip: !isLinux,
      );
      ...
      await expectLater(
        ...
        matchesGoldenFile('inspector.sizedBox_debugPaint_margin.png', version: null),
        skip: !isLinux,
      );
    }, skip: isBrowser);
    ...
    testWidgets('Screenshot of composited transforms - only offsets', (WidgetTester tester) async {
      ...
      await expectLater(
        ...
        matchesGoldenFile('inspector.composited_transform.only_offsets.png', version: null),
        skip: !isLinux,
      );
      ...
      await expectLater(
        ...
        matchesGoldenFile('inspector.composited_transform.only_offsets_follower.png', version: null),
        skip: !isLinux,
      );

      await expectLater(
        WidgetInspectorService.instance.screenshot(find.byType(Stack).evaluate().first, width: 300.0, height: 300.0),
        matchesGoldenFile('inspector.composited_transform.only_offsets_small.png', version: '1'),
        skip: !isLinux,
      );
      ...
      await expectLater(
        ...
        matchesGoldenFile('inspector.composited_transform.only_offsets_target.png', version: null),
        skip: !isLinux,
      );
    }, skip: isBrowser);
    ...
    testWidgets('Screenshot composited transforms - with rotations', (WidgetTester tester) async {
      ...
      await expectLater(
        find.byKey(mainStackKey),
        matchesGoldenFile('inspector.composited_transform.with_rotations.png', version: null),
        skip: !isLinux,
      );
      ...
      await expectLater(
        ...
        matchesGoldenFile('inspector.composited_transform.with_rotations_small.png', version: null),
        skip: !isLinux,
      );
      ...
      await expectLater(
        ...
        matchesGoldenFile('inspector.composited_transform.with_rotations_target.png', version: null),
        skip: !isLinux,
      );
      ...
      await expectLater(
        ...
        matchesGoldenFile('inspector.composited_transform.with_rotations_follower.png', version: null),
        skip: !isLinux,
      );
