...
typedef InspectorServiceExtensionCallback = FutureOr<Map<String, Object>>
...
class _TestWidgetInspectorService extends TestWidgetInspectorService {
  ...
  static void runTests() {
    ...
    testWidgets('WidgetInspector interaction test',
      ...
      expect(getInspectorState().selection.current,
          isNull); // ignore: avoid_dynamic_calls
      ...
      expect(
          paragraphText(selection.current! as RenderParagraph), equals('TOP'));
      ...
      expect(
          paragraphText(
              getInspectorState().selection.current as RenderParagraph),
          equals('TOP'));
    ...
    testWidgets('WidgetInspector scroll test', (WidgetTester tester) async {
      ...
      await tester.pump();
      expect(getInspectorState().selection.current,
          isNotNull); // ignore: avoid_dynamic_calls
    ...
    testWidgets('WidgetInspector offstage', (WidgetTester tester) async {
      ...
      // ignore: avoid_dynamic_calls
      expect(
          inspectorState.selection.current.semanticBounds.width, equals(95.0));

      // Exactly 2 out of the 3 text elements should be in the candidate list of
      // objects to select as only 2 are onstage.
      // ignore: avoid_dynamic_calls
      expect(
          inspectorState.selection.candidates
              .where((RenderObject object) => object is RenderParagraph)
              .length,
          equals(2));
    });
    ...
    testWidgets('Multiple widget inspectors', (WidgetTester tester) async {
      ...
      await tester.pump();
      expect(paragraphText(selection.current! as RenderParagraph),
          equals('Child 1'));
    ...
    testWidgets('WidgetInspectorService getParentChain',
      ...
      for (int i = 0; i < expectedChain.length; i += 1) {
        ...
        expect(service.toObject(jsonNode['objectId']! as String),
            isA<DiagnosticsNode>());
        ...
        for (int j = 0; j < childrenElements.length; j += 1) {
          ...
          expect(service.toObject(childJson['objectId']! as String),
              isA<DiagnosticsNode>());
        }
      }
    });
    ...
    test('WidgetInspectorService getProperties', () {
      ...
      for (int i = 0; i < propertiesJson.length; ++i) {
        ...
        expect(service.toObject(propertyJson['objectId']! as String),
            isA<DiagnosticsNode>());
      }
    });
    ...
    testWidgets('WidgetInspectorService setPubRootDirectories',
        (WidgetTester tester) async {
      await tester.pumpWidget(
        Directionality(
          textDirection: TextDirection.ltr,
      ...
      expect(pathSegmentsFramework.join('/'),
    ...
    test('ext.flutter.inspector.disposeGroup', () async {
      ...
      await service.testExtension(
          'disposeGroup', <String, String>{'objectGroup': group1});
      await service.testExtension(
          'disposeGroup', <String, String>{'objectGroup': group2});
      expect(service.toObject(aId), equals(a));
      await service.testExtension(
          'disposeGroup', <String, String>{'objectGroup': group3});
      expect(() => service.toObject(aId), throwsFlutterError);
    });
    ...
    test('ext.flutter.inspector.disposeId', () async {
      ...
      expect(service.toId(a, group2), equals(aId));
      await service.testExtension(
          'disposeId', <String, String>{'arg': bId, 'objectGroup': group1});
      expect(() => service.toObject(bId), throwsFlutterError);
      await service.testExtension(
          'disposeId', <String, String>{'arg': aId, 'objectGroup': group1});
      expect(service.toObject(aId), equals(a));
      await service.testExtension(
          'disposeId', <String, String>{'arg': aId, 'objectGroup': group2});
      expect(() => service.toObject(aId), throwsFlutterError);
    });
    ...
    testWidgets('ext.flutter.inspector.setSelection',
      ...
      await service.testExtension('setSelectionById', <String, String>{
    ...
    testWidgets('ext.flutter.inspector.getParentChain',
      ...
      final Object? jsonList = await service.testExtension(
          'getParentChain', <String, String>{'arg': bId, 'objectGroup': group});
      expect(jsonList, isList);
      final List<Object?> chainElements = jsonList! as List<Object?>;
      final List<Element> expectedChain =
          elementB.debugGetDiagnosticChain().reversed.toList();
    ...
    test('ext.flutter.inspector.getProperties', () async {
      ...
      final List<Object?> propertiesJson = (await service.testExtension(
          'getProperties',
          <String, String>{'arg': id, 'objectGroup': group}))! as List<Object?>;
      final List<DiagnosticsNode> properties = diagnostic.getProperties();
      expect(properties, isNotEmpty);
      expect(propertiesJson.length, equals(properties.length));
      for (int i = 0; i < propertiesJson.length; ++i) {
    ...
    testWidgets('ext.flutter.inspector.getChildrenDetailsSubtree',
      ...
      for (int i = 0; i < childrenJson.length; ++i) {
        ...
        final DiagnosticsNode diagnosticsNode = service
            .toObject(childJson['objectId']! as String)! as DiagnosticsNode;
    ...
    testWidgets('ext.flutter.inspector.getRootWidgetSummaryTree',
      ...
      Map<String, Object?> rootJson = (await service.testExtension(
          ...
          <String, String>{'objectGroup': group}))! as Map<String, Object?>;
      ...
      rootJson = (await service.testExtension('getRootWidgetSummaryTree',
          <String, String>{'objectGroup': group}))! as Map<String, Object?>;
      ...
      List<Object?> alternateChildrenJson = (await service.testExtension(
          'getChildrenSummaryTree', <String, String>{
    ...
    testWidgets('ext.flutter.inspector.getSelectedSummaryWidget',
      ...
      final Map<String, Object?> regularSelection = (await service
          .testExtension('getSelectedWidget', <String, String>{
        'objectGroup': 'my-group'
      }))! as Map<String, Object?>;
    ...
    testWidgets('ext.flutter.inspector.setPubRootDirectories',
        (WidgetTester tester) async {
      await tester.pumpWidget(
        Directionality(
          textDirection: TextDirection.ltr,
      ...
      await service.testExtension('setPubRootDirectories', <String, String>{});
      service.setSelection(elementA, 'my-group');
      Map<String, Object?> jsonObject = (await service.testExtension(
              'getSelectedWidget',
              <String, String>{'objectGroup': 'my-group'}))!
          as Map<String, Object?>;
      Map<String, Object?> creationLocation =
      ...
      expect(
          await service.testExtension(
              'getSelectedWidget', <String, String>{'objectGroup': 'my-group'}),
          contains('createdByLocalProject'));
      ...
      final String pubRootFramework =
          '/${pathSegmentsFramework.take(pathSegmentsFramework.length - 3).join('/')}';
      await service.testExtension(
          'setPubRootDirectories', <String, String>{'arg0': pubRootFramework});
      expect(
          await service.testExtension(
              'getSelectedWidget', <String, String>{'objectGroup': 'my-group'}),
          contains('createdByLocalProject'));
    ...
    testWidgets(
      ...
      await service.testExtension(
          'setPubRootDirectories', <String, String>{'isolateId': '34'});
      service.setSelection(elementA, 'my-group');
    ...
    testWidgets('ext.flutter.inspector.show', (WidgetTester tester) async {
      ...
      expect(
          await service
              .testBoolExtension('show', <String, String>{'enabled': 'true'}),
          equals('true'));
      ...
      expect(service.rebuildCount, equals(1));
      expect(await service.testBoolExtension('show', <String, String>{}),
          equals('true'));
      ...
      expect(
          await service
              .testBoolExtension('show', <String, String>{'enabled': 'false'}),
          equals('false'));
