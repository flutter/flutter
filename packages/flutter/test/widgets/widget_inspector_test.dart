...
class _TestWidgetInspectorService extends TestWidgetInspectorService {
  ...
  static void runTests() {
    ...
    group('ext.flutter.inspector.setPubRootDirectories', () {
      late final String pubRootTest; 
    ...
    group('ext.flutter.inspector.addPubRootDirectories', () {
      late final String pubRootTest; 
      ...
      testWidgets(
        ...
        (WidgetTester tester) async {
          ...
          await service.testExtension('addPubRootDirectories', <String, String>{'arg0': '/invalid/$pubRootTest'});
          expect(await service.testExtension('getSelectedWidget', <String, String>{'objectGroup': 'my-group'}), isNot(contains('createdByLocalProject')));
        },
      );
      ...
      testWidgets(
        'has createdByLocalProject if the pubRootDirectory is prefixed with file://',
          ...
          await service.testExtension('addPubRootDirectories', <String, String>{'arg0': 'file://$pubRootTest'});
          expect(await service.testExtension('getSelectedWidget', <String, String>{'objectGroup': 'my-group'}), contains('createdByLocalProject'));
        },
      );
      ...
      testWidgets(
        ...
        (WidgetTester tester) async {
          ...
          await service.testExtension('addPubRootDirectories', <String, String>{'arg0': '$pubRootTest/different'});
        expect(await service.testExtension('getSelectedWidget', <String, String>{'objectGroup': 'my-group'}), isNot(contains('createdByLocalProject')));
        },
      );
      ...
      testWidgets(
        ...
        (WidgetTester tester) async {
          ...
          final String pubRootFramework = '/${pathSegmentsFramework.take(pathSegmentsFramework.length - 3).join('/')}';
          service.resetPubRootDirectories(<String>[]);
          await service.testExtension('addPubRootDirectories', <String, String>{'arg0': pubRootFramework});
          expect(await service.testExtension('getSelectedWidget', <String, String>{'objectGroup': 'my-group'}), contains('createdByLocalProject'));
          service.setSelection(elementA, 'my-group');
          expect(await service.testExtension('getSelectedWidget', <String, String>{'objectGroup': 'my-group'}), isNot(contains('createdByLocalProject')));

          service.resetPubRootDirectories(<String>[]);
          await service.testExtension('addPubRootDirectories', <String, String>{'arg0': pubRootFramework, 'arg1': pubRootTest});
          service.setSelection(elementA, 'my-group');
          expect(await service.testExtension('getSelectedWidget', <String, String>{'objectGroup': 'my-group'}), contains('createdByLocalProject'));
          service.setSelection(richText, 'my-group');
          expect(await service.testExtension('getSelectedWidget', <String, String>{'objectGroup': 'my-group'}), contains('createdByLocalProject'));
    ...
    group('ext.flutter.inspector.removePubRootDirectories', () {
      late final String pubRootTest; 
      ...
      setUp(() async {
        ...
        testWidgets(
          ...
          (WidgetTester tester) async {
            ...
            await service.testExtension('removePubRootDirectories', <String, String>{'arg0': 'an/unknown/directory'});
            expect(await service.testExtension('getSelectedWidget', <String, String>{'objectGroup': 'my-group'}), isNot(contains('createdByLocalProject')));
          },
        );
        ...
        testWidgets(
          ...
          (WidgetTester tester) async {
            ...
            await service.testExtension('removePubRootDirectories', <String, String>{'arg0': pubRootTest});
            expect(await service.testExtension('getSelectedWidget', <String, String>{'objectGroup': 'my-group'}), isNot(contains('createdByLocalProject')));
          },
        );
        ...
        testWidgets(
          ...
          (WidgetTester tester) async {
            ...
            service.addPubRootDirectories(<String>[pubRootTest, 'file://$pubRootTest']);
            expect(await service.testExtension('getSelectedWidget', <String, String>{'objectGroup': 'my-group'}), contains('createdByLocalProject'));

            await service.testExtension('removePubRootDirectories', <String, String>{'arg0': pubRootTest, 'arg1': 'file://$pubRootTest'});
            expect(await service.testExtension('getSelectedWidget', <String, String>{'objectGroup': 'my-group'}), isNot(contains('createdByLocalProject')));
          },
        );
        ...
        testWidgets(
          ...
          (WidgetTester tester) async {
            ...
            service.addPubRootDirectories(<String>[pubRootTest, '$pubRootTest/invalid']);
            expect(await service.testExtension('getSelectedWidget', <String, String>{'objectGroup': 'my-group'}), contains('createdByLocalProject'));

            await service.testExtension('removePubRootDirectories', <String, String>{'arg0': '$pubRootTest/invalid'});
            expect(await service.testExtension('getSelectedWidget', <String, String>{'objectGroup': 'my-group'}), contains('createdByLocalProject'));
          },
        );
    }, skip: !WidgetInspectorService.instance.isWidgetCreationTracked()); // [intended] Test requires --track-widget-creation flag.
    ...
    group('ext.flutter.inspector.addPubRootDirectories', () {
      ...
      testWidgets(
        ...
        (WidgetTester tester) async {
          ...
          await service.testExtension('addPubRootDirectories', <String, String>{'arg0': pubRootTest, 'isolateId': '34'});
          expect(await service.testExtension('getSelectedWidget', <String, String>{'objectGroup': 'my-group'}), contains('createdByLocalProject'));
        },
      );
      ...
      testWidgets(
        ...
        (WidgetTester tester) async {
          ...
          await service.testExtension('addPubRootDirectories', <String, String>{'arg0': '/invalid/$pubRootTest', 'isolateId': '34'});
          expect(await service.testExtension('getSelectedWidget', <String, String>{'objectGroup': 'my-group'}), isNot(contains('createdByLocalProject')));
        },
      );
      ...
      testWidgets(
        'has createdByLocalProject if the pubRootDirectory is prefixed with file://',
          ...
          await service.testExtension('addPubRootDirectories', <String, String>{'arg0': 'file://$pubRootTest', 'isolateId': '34'});
          expect(await service.testExtension('getSelectedWidget', <String, String>{'objectGroup': 'my-group'}), contains('createdByLocalProject'));
        },
      );
      ...
      testWidgets(
        ...
        (WidgetTester tester) async {
          ...
          await service.testExtension('addPubRootDirectories', <String, String>{'arg0': '$pubRootTest/different', 'isolateId': '34'});
        expect(await service.testExtension('getSelectedWidget', <String, String>{'objectGroup': 'my-group'}), isNot(contains('createdByLocalProject')));
        },
      );
      ...
      testWidgets(
        ...
        (WidgetTester tester) async {
          ...
          final String pubRootFramework = '/${pathSegmentsFramework.take(pathSegmentsFramework.length - 3).join('/')}';
          service.resetPubRootDirectories(<String>[]);
          await service.testExtension('addPubRootDirectories', <String, String>{'arg0': pubRootFramework, 'isolateId': '34'});
          expect(await service.testExtension('getSelectedWidget', <String, String>{'objectGroup': 'my-group'}), contains('createdByLocalProject'));
          service.setSelection(elementA, 'my-group');
          expect(await service.testExtension('getSelectedWidget', <String, String>{'objectGroup': 'my-group'}), isNot(contains('createdByLocalProject')));

          service.resetPubRootDirectories(<String>[]);
          await service.testExtension('addPubRootDirectories', <String, String>{'arg0': pubRootFramework, 'arg1': pubRootTest, 'isolateId': '34'});
          service.setSelection(elementA, 'my-group');
          expect(await service.testExtension('getSelectedWidget', <String, String>{'objectGroup': 'my-group'}), contains('createdByLocalProject'));
          service.setSelection(richText, 'my-group');
          expect(await service.testExtension('getSelectedWidget', <String, String>{'objectGroup': 'my-group'}), contains('createdByLocalProject'));
      ...
      setUp(() async {
        ...
        testWidgets(
          ...
          (WidgetTester tester) async {
            ...
            await service.testExtension('removePubRootDirectories', <String, String>{'arg0': 'an/unknown/directory', 'isolateId': '34'});
            expect(await service.testExtension('getSelectedWidget', <String, String>{'objectGroup': 'my-group'}), isNot(contains('createdByLocalProject')));
          },
        );
        ...
        testWidgets(
          ...
          (WidgetTester tester) async {
            ...
            await service.testExtension('removePubRootDirectories', <String, String>{'arg0': pubRootTest, 'isolateId': '34'});
            expect(await service.testExtension('getSelectedWidget', <String, String>{'objectGroup': 'my-group'}), isNot(contains('createdByLocalProject')));
          },
        );
        ...
        testWidgets(
          ...
          (WidgetTester tester) async {
            ...
            await service.testExtension('removePubRootDirectories', <String, String>{'arg0': pubRootTest, 'arg1': 'file://$pubRootTest', 'isolateId': '34'});
            expect(await service.testExtension('getSelectedWidget', <String, String>{'objectGroup': 'my-group'}), isNot(contains('createdByLocalProject')));
          },
        );
        ...
        testWidgets(
          ...
          (WidgetTester tester) async {
            ...
            await service.testExtension('removePubRootDirectories', <String, String>{'arg0': '$pubRootTest/invalid', 'isolateId': '34'});
            expect(await service.testExtension('getSelectedWidget', <String, String>{'objectGroup': 'my-group'}), contains('createdByLocalProject'));
          },
        );
    }, skip: !WidgetInspectorService.instance.isWidgetCreationTracked()); // [intended] Test requires --track-widget-creation flag.
