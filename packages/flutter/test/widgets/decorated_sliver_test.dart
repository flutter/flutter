...
class _TestStretchDelegate extends SliverPersistentHeaderDelegate {
  _TestStretchDelegate({required this.minExtent, required this.maxExtent});
  ...
  @override
  bool shouldRebuild(_TestStretchDelegate oldDelegate) {
