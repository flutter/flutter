...
class TestOrientedBox extends SingleChildRenderObjectWidget {
  const TestOrientedBox({Key? key, Widget? child})
...
class TestNonVisitingWidget extends SingleChildRenderObjectWidget {
  const TestNonVisitingWidget({Key? key, required Widget child})
      : super(key: key, child: child);
...
void main() {
  ...
  testWidgets('RenderObjectWidget can add and remove children',
