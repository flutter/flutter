...
void main() {
  testWidgets('SliverMainAxisGroup is laid out properly',
  ...
  testWidgets('SliverMainAxisGroup skips painting invisible children',
      (WidgetTester tester) async {
    final ScrollController controller = ScrollController();
    addTearDown(controller.dispose);
  ...
  testWidgets(
      'SliverMainAxisGroup does not cause extra builds for lazy sliver children',
      (WidgetTester tester) async {
    ...
    await tester.pumpAndSettle();
    expect(buildsPerGroup[0],
        17); // First sliver filled the screen and cache extent
  ...
  testWidgets('SliverMainAxisGroup correctly handles ensureVisible',
      (WidgetTester tester) async {
    final GlobalKey key = GlobalKey();
    await tester.pumpWidget(
        _buildSliverMainAxisGroup(viewportHeight: 300, slivers: <Widget>[
