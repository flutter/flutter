...
void main() {
  ...
  test('IconThemeData lerp with first null', () {
    ...
    expect(
        lerped.shadows, const <Shadow>[Shadow(color: Color(0xFFFFFFFF), blurRadius: 0.25, offset: Offset(0.25, 0.25))]);
  });
  ...
  test('IconThemeData lerp with second null', () {
    ...
    expect(
        lerped.shadows, const <Shadow>[Shadow(color: Color(0xFFFFFFFF), blurRadius: 0.75, offset: Offset(0.75, 0.75))]);
  });
