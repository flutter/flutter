...
void main() {
  test('IconThemeData control test', () {
    ...
    expect(lerped.color, matchesColor(const Color(0xBF7F7F7F)));
  ...
  group('IconThemeData lerp', () {
    ...
    test('with first null', () {
      ...
      expect(lerped.color, matchesColor(const Color(0x40FFFFFF)));
    ...
    test('with second null', () {
      ...
      expect(lerped.color, matchesColor(const Color(0xBFFFFFFF)));
