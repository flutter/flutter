...
void main() {
  ...
  group(FocusNode, () {
    testWidgets('Can add children.', (WidgetTester tester) async {
      ...
      parentAttachment.reparent(tester.binding.focusManager.rootScope);
      child1Attachment.reparent(parent);
      expect(child1.parent, equals(parent));
      expect(parent.children.first, equals(child1));
      expect(parent.children.last, equals(child1));
      child2Attachment.reparent(parent);
      expect(child1.parent, equals(parent));
  ...
  group(FocusScopeNode, () {
    ...
    testWidgets('Removing a node removes it from scope.', (WidgetTester tester) async {
      ...
      final FocusNode child2 = FocusNode();
      final FocusAttachment child2Attachment = child2.attach(context);
      scopeAttachment.reparent(tester.binding.focusManager.rootScope);
      parentAttachment.reparent(scope);
      child1Attachment.reparent(parent);
      child2Attachment.reparent(parent);
      child1.requestFocus();
      await tester.pump();
    ...
    testWidgets('Adding a focusedChild to a scope sets scope as focusedChild in parent scope', (WidgetTester tester) async {
      ...
      final FocusNode child2 = FocusNode();
      final FocusAttachment child2Attachment = child2.attach(context);
      scope1Attachment.reparent(tester.binding.focusManager.rootScope);
      scope2Attachment.reparent(scope1);
      child1Attachment.reparent(scope1);
      child2Attachment.reparent(scope2);
      child2.requestFocus();
      await tester.pump();
    ...
    testWidgets('Can move node with focus without losing focus', (WidgetTester tester) async {
      ...
      final FocusAttachment child2Attachment = child2.attach(context);
      scopeAttachment.reparent(tester.binding.focusManager.rootScope);
      parent1Attachment.reparent(scope);
      parent2Attachment.reparent(scope);
      child1Attachment.reparent(parent1);
      child2Attachment.reparent(parent1);
      ...
      child1.requestFocus();
      await tester.pump();
      child1Attachment.reparent(parent2);
      await tester.pump();
    ...
    testWidgets('Can move node between scopes and lose scope focus', (WidgetTester tester) async {
      ...
      scope1Attachment.reparent(tester.binding.focusManager.rootScope);
      scope2Attachment.reparent(tester.binding.focusManager.rootScope);
      parent1Attachment.reparent(scope1);
      parent2Attachment.reparent(scope2);
      child1Attachment.reparent(parent1);
      child2Attachment.reparent(parent1);
      child3Attachment.reparent(parent2);
      child4Attachment.reparent(parent2);
