              ...
              child: Scrollable(
                ...
                viewportBuilder: (BuildContext context, ViewportOffset offset) {
                  return Viewport(
                    ...
                    center: centerKey,
                    slivers: <Widget>[
                      const SliverToBoxAdapter(child: Container(height: 5.0)),
                      const SliverToBoxAdapter(child: Container(height: 520.0)),
                      const SliverToBoxAdapter(child: Container(height: 520.0)),
                      const SliverToBoxAdapter(child: Container(height: 520.0)),
                      ...
                      const SliverToBoxAdapter(child: Container(height: 520.0)),
                      SliverToBoxAdapter(key: centerKey, child: const Container(height: 520.0)), // ------------------------ CENTER ------------------------
                      SliverPersistentHeader(delegate: TestSliverPersistentHeaderDelegate(150.0), pinned: true),
                      const SliverToBoxAdapter(child: Container(height: 520.0)),
                      const SliverToBoxAdapter(child: Container(height: 520.0)),
                      const SliverToBoxAdapter(child: Container(height: 520.0)),
