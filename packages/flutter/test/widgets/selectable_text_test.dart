...
void main() {
  ...
  testWidgets('SelectableText baseline alignment no-strut',
    ...
    expect(tester.getBottomLeft(find.byKey(keyA)).dy,
        moreOrLessEquals(rowBottomY - 4.0, epsilon: 1e-3));
    expect(tester.getBottomLeft(find.text('abc')).dy,
        moreOrLessEquals(rowBottomY - 2.0, epsilon: 1e-3));
  ...
  testWidgets(
      'SelectableText throws when not descended from a MediaQuery widget',
      (WidgetTester tester) async {
