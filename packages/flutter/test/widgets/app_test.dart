...
void main() {
  ...
  testWidgets('WidgetsApp.router router config works',
      (WidgetTester tester) async {
    final SimpleNavigatorRouterDelegate delegate =
        SimpleNavigatorRouterDelegate(
      builder: (BuildContext context, RouteInformation information) {
  ...
  testWidgets('WidgetsApp has correct default ScrollBehavior',
      (WidgetTester tester) async {
  ...
  testWidgets("WidgetsApp doesn't have dependency on MediaQuery",
      (WidgetTester tester) async {
  ...
  testWidgets('WidgetsApp provides meta based shortcuts for iOS and macOS',
      (WidgetTester tester) async {
