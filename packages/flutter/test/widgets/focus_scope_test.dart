...
void main() {
  group(FocusScope, () {
    ...
    testWidgets('Can move focus in and out of FocusScope', (WidgetTester tester) async {
      ...
      expect(focusManager.rootScope, hasAGoodToStringDeep);
      expect(
        focusManager.rootScope.toStringDeep(minLevel: DiagnosticLevel.info),
    ...
    testWidgets('Adding a new FocusScope attaches the child it to its parent.', (WidgetTester tester) async {
      ...
      focusManager.rootScope.setFirstFocus(FocusScope.of(keyA.currentContext));
    ...
    testWidgets('Removing a FocusScope removes its node from the tree', (WidgetTester tester) async {
      ...
      focusManager.rootScope.setFirstFocus(bScope);
      focusManager.rootScope.setFirstFocus(aScope);
      ...
      expect(focusManager.rootScope.children, isEmpty);
    });
  ...
  testWidgets('Nodes are removed when all Focuses are removed.', (WidgetTester tester) async {
    ...
    expect(focusManager.rootScope.descendants, isEmpty);
  });
