...
void main() {
  ...
  group('focusability listener', () {
    ...
    testWidgets('canRequestFocus affects child focusability',
        (WidgetTester tester) async {
      ...
      node1.focusabilityListenable
          .addListener(() => node1FocusabilityCallbackCount += 1);
    ...
    testWidgets('onFocusabilityCallback invoked on mount, if not focusable',
        (WidgetTester tester) async {
      final FocusScopeNode scopeNode1 =
          FocusScopeNode(debugLabel: 'scope1', canRequestFocus: false);
      final FocusNode node1 = FocusNode(debugLabel: 'node 1')
    ...
    testWidgets('onFocusabilityCallback is not invoked on mount, if focusable',
        (WidgetTester tester) async {
      final FocusScopeNode scopeNode1 = FocusScopeNode(debugLabel: 'scope1');
      final FocusNode node1 = FocusNode(debugLabel: 'node 1')
        ..focusabilityListenable.addListener(focusabilityCallback);
    ...
    testWidgets('onFocusabilityCallback on scope node',
        (WidgetTester tester) async {
      final FocusScopeNode scopeNode1 = FocusScopeNode(debugLabel: 'scope1');
      final FocusScopeNode scopeNode2 = FocusScopeNode(debugLabel: 'scope2')
        ..focusabilityListenable.addListener(focusabilityCallback);
