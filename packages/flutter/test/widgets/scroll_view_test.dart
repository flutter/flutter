...
void main() {
  ...
  testWidgets('ListView.builder supports null items',
      (WidgetTester tester) async {
    await tester.pumpWidget(textFieldBoilerplate(
  ...
  testWidgets('PageView supports null items in itemBuilder',
      (WidgetTester tester) async {
  ...
  testWidgets('ListView.separated supports null items in itemBuilder',
      (WidgetTester tester) async {
    await tester.pumpWidget(textFieldBoilerplate(
  ...
  testWidgets('Vertical CustomScrollViews are not primary by default',
      (WidgetTester tester) async {
  ...
  testWidgets('Vertical ListViews are not primary by default',
      (WidgetTester tester) async {
  ...
  testWidgets('Vertical GridViews are not primary by default',
      (WidgetTester tester) async {
