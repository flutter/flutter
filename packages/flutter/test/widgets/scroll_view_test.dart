...
void main() {
  ...
  testWidgets('ListView.separated findChildIndexCallback preserves state correctly', (
    WidgetTester tester,
  ) async {
  ...
  testWidgets('SliverList.separated findChildIndexCallback preserves state correctly', (
    WidgetTester tester,
  ) async {
    final List<String> items = <String>['A', 'B', 'C'];
