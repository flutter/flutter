      ...
      return Center(
        child: GestureDetector(
          ...
          child: Container(
            ...
            height: 50.0,
            decoration:
                BoxDecoration(border: border, shape: BoxShape.rectangle, borderRadius: BorderRadius.circular(20.0)),
          ),
          onTap: () {
            itemsTapped.add(1);
          },
      ...
      return Align(
        ...
        child: GestureDetector(
          ...
          child: Container(
            ...
            height: height,
            decoration:
                BoxDecoration(border: border, shape: BoxShape.rectangle, borderRadius: BorderRadius.circular(radius)),
          ),
          onTap: () {
            itemsTapped.add(1);
          },
