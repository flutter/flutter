...
void main() {
  testWidgets('PhysicalModel updates clipBehavior in updateRenderObject', (WidgetTester tester) async {
    await tester.pumpWidget(
      MaterialApp(home: const _UpdateCountedPhysicalModel()),
    );
    ...
    await tester.pumpWidget(
      MaterialApp(home: const _UpdateCountedPhysicalModel(clipBehavior: Clip.antiAlias)),
    );
  ...
  testWidgets('PhysicalShape updates clipBehavior in updateRenderObject', (WidgetTester tester) async {
    await tester.pumpWidget(
      MaterialApp(home: const _UpdateCountedPhysicalShape()),
    );
    ...
    await tester.pumpWidget(
      MaterialApp(home: const _UpdateCountedPhysicalShape(clipBehavior: Clip.antiAlias)),
    );
