...
void main() {
  Widget boilerplateWidget(final VoidCallback? onButtonPressed, {
    final DraggableScrollableController? controller,
    final int itemCount = 100,
    final double initialChildSize = .5,
    final double maxChildSize = 1.0,
    final double minChildSize = .25,
    ...
    final bool ignoreController = false,
  }) {
          ...
          children: <Widget>[
            ...
            DraggableScrollableActuator(
              child: DraggableScrollableSheet(
                ...
                builder: (final BuildContext context, final ScrollController scrollController) {
  ...
  testWidgets('Do not crash when replacing scroll position during the drag', (final WidgetTester tester) async {
              ...
              builder: (final BuildContext context, final ScrollController scrollController) {
                ...
                return ScrollConfiguration(
                  ...
                  child: ListView.separated(
                    ...
                    itemCount: 100,
                    itemBuilder: (final _, final int index) => SizedBox(
                      height: 100,
                      child: ColoredBox(
  ...
  testWidgets('Scrolls correct amount when maxChildSize < 1.0', (final WidgetTester tester) async {
  ...
  testWidgets('Invalid snap targets throw assertion errors.', (final WidgetTester tester) async {
    await tester.pumpWidget(boilerplateWidget(
      null,
      maxChildSize: .8,
      snapSizes: <double>[.9],
  ...
  group('Scroll Physics', () {
    testWidgets('Can be dragged up without covering its container', (final WidgetTester tester) async {
      int taps = 0;
    ...
    testWidgets('Can be dragged down when not full height', (final WidgetTester tester) async {
    ...
    testWidgets('Can be dragged down when list is shorter than full height', (final WidgetTester tester) async {
    ...
    testWidgets('Can be dragged up and cover its container and scroll in single motion, and then dragged back down', (final WidgetTester tester) async {
      int taps = 0;
      await tester.pumpWidget(boilerplateWidget(() => taps++));
    ...
    testWidgets('Can be flung up gently', (final WidgetTester tester) async {
      int taps = 0;
      await tester.pumpWidget(boilerplateWidget(() => taps++));
    ...
    testWidgets('Can be flung up', (final WidgetTester tester) async {
      int taps = 0;
      await tester.pumpWidget(boilerplateWidget(() => taps++));
    ...
    testWidgets('Can be flung down when not full height', (final WidgetTester tester) async {
      await tester.pumpWidget(boilerplateWidget(null));
      expect(find.text('Item 1'), findsOneWidget);
      expect(find.text('Item 21'), findsOneWidget);
      expect(find.text('Item 36'), findsNothing);
    ...
    testWidgets('Can be flung up and then back down', (final WidgetTester tester) async {
      int taps = 0;
      await tester.pumpWidget(boilerplateWidget(() => taps++));
    ...
    testWidgets('Ballistic animation on fling can be interrupted', (final WidgetTester tester) async {
      int taps = 0;
      await tester.pumpWidget(boilerplateWidget(() => taps++));
    ...
    testWidgets('Ballistic animation on fling should not leak Ticker', (final WidgetTester tester) async {
          ...
          child: MediaQuery(
            ...
            child: Align(
              ...
              child: DraggableScrollableSheet(
                ...
                maxChildSize: 0.9,
                expand: false,
                builder: (final _, final ScrollController scrollController) {
  ...
  testWidgets('Does not snap away from initial child on build', (final WidgetTester tester) async {
  ...
  for (final bool useActuator in <bool>[false, true]) {
    testWidgets('Does not snap away from initial child on ${useActuator ? 'actuator' : 'controller'}.reset()', (final WidgetTester tester) async {
      const Key containerKey = ValueKey<String>('container');
      const Key stackKey = ValueKey<String>('stack');
  ...
  for (final List<double>? snapSizes in <List<double>?>[null, <double>[]]) {
    testWidgets('Setting snapSizes to $snapSizes resolves to min and max', (final WidgetTester tester) async {
      const Key stackKey = ValueKey<String>('stack');
      const Key containerKey = ValueKey<String>('container');
      await tester.pumpWidget(boilerplateWidget(null,
        snap: true,
  ...
  testWidgets('Min and max are implicitly added to snapSizes', (final WidgetTester tester) async {
    const Key stackKey = ValueKey<String>('stack');
    const Key containerKey = ValueKey<String>('container');
    await tester.pumpWidget(boilerplateWidget(null,
      snap: true,
  ...
  testWidgets('Changes to widget parameters are propagated', (final WidgetTester tester) async {
    const Key stackKey = ValueKey<String>('stack');
    const Key containerKey = ValueKey<String>('container');
    await tester.pumpWidget(boilerplateWidget(
      null,
  ...
  testWidgets('Fling snaps in direction of momentum', (final WidgetTester tester) async {
    const Key stackKey = ValueKey<String>('stack');
    const Key containerKey = ValueKey<String>('container');
    await tester.pumpWidget(boilerplateWidget(null,
      snap: true,
  ...
  testWidgets("Changing parameters with an un-listened controller doesn't throw", (final WidgetTester tester) async {
    await tester.pumpWidget(boilerplateWidget(
      null,
      snap: true,
  ...
  testWidgets('Transitioning between scrollable children sharing a scroll controller will not throw', (final WidgetTester tester) async {
    int s = 0;
  ...
  testWidgets('ScrollNotification correctly dispatched when flung without covering its container', (final WidgetTester tester) async {
    final List<Type> notificationTypes = <Type>[];
    await tester.pumpWidget(boilerplateWidget(
      null,
      onScrollNotification: (final ScrollNotification notification) {
  ...
  testWidgets('ScrollNotification correctly dispatched when flung with contents scroll', (final WidgetTester tester) async {
    final List<Type> notificationTypes = <Type>[];
    await tester.pumpWidget(boilerplateWidget(
      null,
      onScrollNotification: (final ScrollNotification notification) {
  ...
  testWidgets('Do not crash when remove the tree during animation.', (final WidgetTester tester) async {
  ...
  for (final bool shouldAnimate in <bool>[true, false]) {
    testWidgets('Can ${shouldAnimate ? 'animate' : 'jump'} to arbitrary positions', (final WidgetTester tester) async {
      const Key stackKey = ValueKey<String>('stack');
      const Key containerKey = ValueKey<String>('container');
      final DraggableScrollableController controller = DraggableScrollableController();
      await tester.pumpWidget(boilerplateWidget(
      ...
      void goTo(final double size) => shouldAnimate
  ...
  testWidgets('Can animateTo with a nonlinear curve', (final WidgetTester tester) async {
    const Key stackKey = ValueKey<String>('stack');
    const Key containerKey = ValueKey<String>('container');
    final DraggableScrollableController controller = DraggableScrollableController();
    await tester.pumpWidget(boilerplateWidget(
  ...
  testWidgets('Can animateTo with a Curves.easeInOutBack curve begin min-size', (final WidgetTester tester) async {
    const Key stackKey = ValueKey<String>('stack');
    const Key containerKey = ValueKey<String>('container');
    final DraggableScrollableController controller = DraggableScrollableController();
    await tester.pumpWidget(boilerplateWidget(
  ...
  testWidgets('Can reuse a controller after the old controller is disposed', (final WidgetTester tester) async {
    const Key stackKey = ValueKey<String>('stack');
    const Key containerKey = ValueKey<String>('container');
    final DraggableScrollableController controller = DraggableScrollableController();
    await tester.pumpWidget(boilerplateWidget(
  ...
  testWidgets('animateTo interrupts other animations', (final WidgetTester tester) async {
    const Key stackKey = ValueKey<String>('stack');
    const Key containerKey = ValueKey<String>('container');
    final DraggableScrollableController controller = DraggableScrollableController();
  ...
  testWidgets('Other animations interrupt animateTo', (final WidgetTester tester) async {
    const Key stackKey = ValueKey<String>('stack');
    const Key containerKey = ValueKey<String>('container');
    final DraggableScrollableController controller = DraggableScrollableController();
    await tester.pumpWidget(Directionality(
  ...
  testWidgets('animateTo can be interrupted by other animateTo or jumpTo', (final WidgetTester tester) async {
    const Key stackKey = ValueKey<String>('stack');
    const Key containerKey = ValueKey<String>('container');
    final DraggableScrollableController controller = DraggableScrollableController();
    await tester.pumpWidget(Directionality(
  ...
  testWidgets('Can get size and pixels', (final WidgetTester tester) async {
    const Key stackKey = ValueKey<String>('stack');
    const Key containerKey = ValueKey<String>('container');
    final DraggableScrollableController controller = DraggableScrollableController();
    await tester.pumpWidget(boilerplateWidget(
  ...
  testWidgets('Cannot attach a controller to multiple sheets', (final WidgetTester tester) async {
    final DraggableScrollableController controller = DraggableScrollableController();
    await tester.pumpWidget(Directionality(
      textDirection: TextDirection.ltr,
      child: Stack(
  ...
  testWidgets('Can listen for changes in sheet size', (final WidgetTester tester) async {
    const Key stackKey = ValueKey<String>('stack');
    const Key containerKey = ValueKey<String>('container');
    ...
    await tester.pumpAndSettle();
    expect(loggedSizes, <double>[.4].map((final double v) => closeTo(v, precisionErrorTolerance)));
    loggedSizes.clear();

    await tester.timedDrag(find.text('Item 1'), Offset(0, -.1 * screenHeight), const Duration(seconds: 1), frequency: 2);
    await tester.pumpAndSettle();
    expect(loggedSizes, <double>[.45, .5].map((final double v) => closeTo(v, precisionErrorTolerance)));
    loggedSizes.clear();

    controller.jumpTo(.6);
    await tester.pumpAndSettle();
    expect(loggedSizes, <double>[.6].map((final double v) => closeTo(v, precisionErrorTolerance)));
    loggedSizes.clear();

    controller.animateTo(1, duration: const Duration(milliseconds: 400), curve: Curves.linear);
    await tester.pumpAndSettle();
    expect(loggedSizes, <double>[.7, .8, .9, 1].map((final double v) => closeTo(v, precisionErrorTolerance)));
    loggedSizes.clear();

    DraggableScrollableActuator.reset(tester.element(find.byKey(containerKey)));
    await tester.pumpAndSettle();
    expect(loggedSizes, <double>[.5].map((final double v) => closeTo(v, precisionErrorTolerance)));
    loggedSizes.clear();
  });

  testWidgets('Listener does not fire on parameter change and persists after change', (final WidgetTester tester) async {
    const Key stackKey = ValueKey<String>('stack');
    const Key containerKey = ValueKey<String>('container');
    final List<double> loggedSizes = <double>[];
    final DraggableScrollableController controller = DraggableScrollableController();
    ...
    await tester.drag(find.text('Item 1'), Offset(0, .1 * screenHeight), touchSlopY: 0);
    await tester.pumpAndSettle();
    expect(loggedSizes, <double>[.3].map((final double v) => closeTo(v, precisionErrorTolerance)));
    loggedSizes.clear();
  });

  testWidgets('Listener fires if a parameter change forces a change in size', (final WidgetTester tester) async {
    const Key stackKey = ValueKey<String>('stack');
    const Key containerKey = ValueKey<String>('container');
    final List<double> loggedSizes = <double>[];
    final DraggableScrollableController controller = DraggableScrollableController();
  ...
  testWidgets('Invalid controller interactions throw assertion errors', (final WidgetTester tester) async {
    final DraggableScrollableController controller = DraggableScrollableController();
  ...
  testWidgets('DraggableScrollableController must be attached before using any of its parameters', (final WidgetTester tester) async {
    final DraggableScrollableController controller = DraggableScrollableController();
    ...
    testWidgets('DraggableScrollableController.animateTo should not leak Ticker', (final WidgetTester tester) async {
  ...
  testWidgets('DraggableScrollableSheet should not reset programmatic drag on rebuild', (final WidgetTester tester) async {
  ...
  testWidgets('DraggableScrollableSheet should respect NeverScrollableScrollPhysics', (final WidgetTester tester) async {
  ...
  testWidgets('DraggableScrollableSheet should not rebuild every frame while dragging', (final WidgetTester tester) async {
    // Regression test for https://github.com/flutter/flutter/issues/67219
    int buildCount = 0;
    await tester.pumpWidget(MaterialApp(
      home: StatefulBuilder(
        builder: (final BuildContext context, final StateSetter setState) => Scaffold(
          body: DraggableScrollableSheet(
            initialChildSize: 0.25,
            snap: true,
            snapSizes: const <double>[0.25, 0.5, 1.0],
  ...
  testWidgets('DraggableScrollableSheet controller can be changed', (final WidgetTester tester) async {
    ...
    expect(loggedSizes, <double>[0.5].map((final double v) => closeTo(v, precisionErrorTolerance)));
    loggedSizes.clear();
    ...
    expect(loggedSizes, <double>[1.0].map((final double v) => closeTo(v, precisionErrorTolerance)));
  });
}
