...
void main() {
  group(WidgetOrderTraversalPolicy, () {
    ...
    testWidgetsWithLeakTracking('focus traversal should work case 1',
        (WidgetTester tester) async {
    ...
    testWidgetsWithLeakTracking('focus traversal should work case 2',
        (WidgetTester tester) async {
      final FocusNode outer1 =
          FocusNode(debugLabel: 'outer1', skipTraversal: true);
      final FocusNode outer2 =
  ...
  testWidgetsWithLeakTracking('Nested navigator does not trap focus',
      (WidgetTester tester) async {
