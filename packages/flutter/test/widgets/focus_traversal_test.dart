...
void main() {
  ...
  group(DirectionalFocusTraversalPolicyMixin, () {
    ...
    testWidgets('Horizontal list inside verical list should not prevent focus traversal', (
      WidgetTester tester,
    ) async {
      final List<FocusNode> nodes = List<FocusNode>.generate(
        3,
    ...
    testWidgets('Vertical list inside horizontal list should not prevent focus traversal', (
      WidgetTester tester,
    ) async {
      final List<FocusNode> nodes = List<FocusNode>.generate(
        3,
      ...
      final FocusNode leftNode = FocusNode(debugLabel: 'Left');
      addTearDown(leftNode.dispose);
      final FocusNode rightNode = FocusNode(debugLabel: 'Right');
      addTearDown(rightNode.dispose);
