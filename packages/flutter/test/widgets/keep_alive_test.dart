...
class Leaf extends StatefulWidget {
  const Leaf({super.key, required this.child});
  final Widget child;
  @override
...
class _LeafState extends State<Leaf> {
  ...
  Widget build(BuildContext context) {
    return KeepAlive(keepAlive: _keepAlive, child: widget.child);
  }
}
...
List<Widget> generateList(Widget child) {
  return List<Widget>.generate(
    100,
    (int index) => Leaf(key: GlobalObjectKey<_LeafState>(index), child: child),
    growable: false,
  );
}
  ...
  testWidgets('KeepAlive render tree description', (WidgetTester tester) async {
    ...
    expect(
      ...
      equalsIgnoringHashCodes(
        ...
        '                       │ constraints: SliverConstraints(AxisDirection.down, GrowthDirection.forward, ScrollDirection.idle, scrollOffset: 0.0, precedingScrollExtent: 0.0, remainingPaintExtent: 600.0, crossAxisExtent: 800.0, crossAxisDirection: AxisDirection.right, viewportMainAxisExtent: 600.0, remainingCacheExtent: 1080.0, cacheOrigin: 0.0)\n'
        '                       │ geometry: SliverGeometry(scrollExtent: 40000.0, paintExtent: 600.0, maxPaintExtent: 40000.0, hasVisualOverflow: true, cacheExtent: 1080.0)\n'
    ...
    expect(
      ...
      equalsIgnoringHashCodes(
        ...
        '                     └─center child: RenderSliverPadding#00000 relayoutBoundary=up1\n'
        '                       │ parentData: paintOffset=Offset(0.0, 0.0) (can use size)\n'
        '                       │ constraints: SliverConstraints(AxisDirection.down, GrowthDirection.forward, ScrollDirection.idle, scrollOffset: 2000.0, precedingScrollExtent: 0.0, remainingPaintExtent: 600.0, crossAxisExtent: 800.0, crossAxisDirection: AxisDirection.right, viewportMainAxisExtent: 600.0, remainingCacheExtent: 1560.0, cacheOrigin: -480.0)\n'
        '                       │ geometry: SliverGeometry(scrollExtent: 40000.0, paintExtent: 600.0, maxPaintExtent: 40000.0, hasVisualOverflow: true, cacheExtent: 1560.0)\n'
        '                       │ padding: EdgeInsets.zero\n'
        '                       │ textDirection: ltr\n'
        '                       │\n'
        '                       └─child: RenderSliverFixedExtentList#00000 relayoutBoundary=up2\n'
        ...
        '                         │ constraints: SliverConstraints(AxisDirection.down, GrowthDirection.forward, ScrollDirection.idle, scrollOffset: 2000.0, precedingScrollExtent: 0.0, remainingPaintExtent: 600.0, crossAxisExtent: 800.0, crossAxisDirection: AxisDirection.right, viewportMainAxisExtent: 600.0, remainingCacheExtent: 1560.0, cacheOrigin: -480.0)\n'
        '                         │ geometry: SliverGeometry(scrollExtent: 40000.0, paintExtent: 600.0, maxPaintExtent: 40000.0, hasVisualOverflow: true, cacheExtent: 1560.0)\n'
        '                         │ currently live children: 3 to 7\n'
        '                         │\n'
        '                         ├─child with index 3: RenderLimitedBox#00000\n'
        ...
        '                               constraints: BoxConstraints(w=800.0, h=400.0)\n'
        '                               size: Size(800.0, 400.0)\n'
        '                               painter: _PlaceholderPainter#47854()\n'
        '                               preferredSize: Size(Infinity, Infinity)\n',
      ),
    );
