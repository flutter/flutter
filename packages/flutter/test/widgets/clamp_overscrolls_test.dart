...
void main() {
  ...
  testWidgets(
      'ClampingScrollPhysics handles out of bounds ScrollPosition - initialScrollOffset',
      (WidgetTester tester) async {
  ...
  testWidgets(
      'ClampingScrollPhysics handles out of bounds ScrollPosition - jumpTo',
      (WidgetTester tester) async {
    Future<void> testOutOfBounds(
        ScrollPhysics physics, double targetOffset, double endingOffset) async {
      ...
      await tester.pump(
          const Duration(seconds: 1)); // Allow overscroll animation to settle
