  ...
  testWidgets('GlobalKey duplication 12 - all kinds of badness at once', (WidgetTester tester) async {
    ...
    expect(
      ...
      equalsIgnoringHashCodes(
        ...
        'Stack(alignment: AlignmentDirectional.topStart, textDirection: ltr, fit: loose, overflow: visible) has multiple children with key [GlobalKey#00000 problematic].'
      ),
    );
  });
  ...
  testWidgets('GlobalKey duplication 18 - subtree build duplicate key with same type', (WidgetTester tester) async {
    ...
    expect(
      ...
      equalsIgnoringHashCodes(
        ...
        'overflow: visible, renderObject: RenderStack#00000)\n'
        'A GlobalKey can only be specified on one widget at a time in the widget tree.'
      ),
    );
  });
