...
void main() {
  ...
  testWidgets('Wrap can set and update clipBehavior',
      (WidgetTester tester) async {
    ...
    await tester.pumpWidget(
        Wrap(textDirection: TextDirection.ltr, clipBehavior: Clip.antiAlias));
    expect(renderObject.clipBehavior, equals(Clip.antiAlias));
  });

  testWidgets('Horizontal wrap - IntrinsicsHeight',
      (WidgetTester tester) async {
