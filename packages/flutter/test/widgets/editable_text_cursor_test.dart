...
void main() {
  ...
  testWidgets('Cursor does not animate on non-iOS platforms',
      (WidgetTester tester) async {
    await tester.pumpWidget(
      const MaterialApp(
  ...
  testWidgets('Cursor does not show when not focused',
      (WidgetTester tester) async {
      ...
      expect(
        ...
        paints
          ..rrect(
            rrect: RRect.fromRectAndRadius(
              const Rect.fromLTWH(
                  193.83334350585938, -0.916666666666668, 3.0, 20.0),
              const Radius.circular(1.0),
            ),
            color: const Color(0xbf2196f3),
          ),
      ...
      expect(
        ...
        paints
          ..rrect(
            rrect: RRect.fromRectAndRadius(
              const Rect.fromLTWH(
                  719.3333333333333, -0.9166666666666679, 2.0, 18.0),
  ...
  testWidgets('getLocalRectForCaret with empty text',
      (WidgetTester tester) async {
    EditableText.debugDeterministicCursor = true;
    addTearDown(() {
      EditableText.debugDeterministicCursor = false;
  ...
  testWidgets(
    ...
    (WidgetTester tester) async {
      ...
      expect(
          renderEditable
              .getLineAtOffset(TextPosition(offset: text.length))
              .start,
          0);
  ...
  testWidgets('Floating cursor showing with local position',
      (WidgetTester tester) async {
    EditableText.debugDeterministicCursor = true;
    ...
    state.updateFloatingCursor(RawFloatingCursorPoint(
        state: FloatingCursorDragState.Update, offset: const Offset(51, 0)));
    await tester.pump();
    ...
    state.updateFloatingCursor(RawFloatingCursorPoint(
        state: FloatingCursorDragState.Update, offset: const Offset(100, 10)));
    await tester.pump();
