...
void main() {
  ...
  testWidgets('cursor layout has correct width', (WidgetTester tester) async {
    ...
    await expectLater(
      ...
      matchesGoldenFile('editable_text_test.0.png', version: '3'),
    );
  }, skip: !isLinux);
  ...
  testWidgets('cursor layout has correct radius', (WidgetTester tester) async {
    ...
    await expectLater(
      find.byKey(const ValueKey<int>(1)),
      matchesGoldenFile('editable_text_test.1.png', version: '3'),
    );
  }, skip: !isLinux);
  ...
  testWidgets('cursor layout iOS', (WidgetTester tester) async {
    ...
    await expectLater(
      find.byKey(const ValueKey<int>(1)),
      matchesGoldenFile('editable_text_test.2.png', version: '0'),
    );
    debugDefaultTargetPlatformOverride = null;
  }, skip: !isLinux);
