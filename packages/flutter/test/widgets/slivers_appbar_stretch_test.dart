...
void main() {
  ...
  group('SliverAppBar - Stretch, Pinned', () {
    // TODO(Piinks): Test this behavior for stretch
    testWidgets('second app bar stacks below', (WidgetTester tester) async {
    ...
    testWidgets('sticks to top as the content is scrolled down', (WidgetTester tester) async {
  ...
  group('SliverAppBar - Stretch, Floating, Pinned', () {
    ...
    testWidgets('Does not crash when there is less than minExtent remainingPaintExtent', (WidgetTester tester) async {
      ...
      final RenderSliverFloatingPinnedPersistentHeader render = tester
    ...
    testWidgets('sticks to top as the content is scroll down', (WidgetTester tester) async {
      const Key anchor = Key('drag');
      await tester.pumpWidget(
        MaterialApp(
          home: Center(
