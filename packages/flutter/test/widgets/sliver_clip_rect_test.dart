            ...
            slivers: <Widget>[
              SliverClipRect(
                ...
                sliver: SliverToBoxAdapter(
                  child: Container(height: 100, color: Colors.red, key: const Key('target')),
                ),
              ),
            ],
          ),
      ...
      await tester.pumpWidget(
        MaterialApp(
          home: Scaffold(
            body: CustomScrollView(
              slivers: <Widget>[
                const SliverAppBar(pinned: true, expandedHeight: 100, toolbarHeight: 100),
                SliverClipRect(
                  clipOverlap: false, // DISABLE OVERLAP CLIPPING
                  sliver: SliverToBoxAdapter(child: Container(height: 100, color: Colors.blue)),
                ),
                const SliverToBoxAdapter(child: SizedBox(height: 1000)),
              ],
            ),
        ...
        MaterialApp(
          home: CustomScrollView(
            ...
            slivers: <Widget>[
              SliverClipRect(
                clipper: const _HalfHeightClipper(),
                sliver: SliverToBoxAdapter(child: Container(height: 100, color: Colors.red)),
              ),
            ],
          ),
        ),
