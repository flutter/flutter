...
void main() {
  ...
  testWidgets('ConstrainedBox intrinsics - minHeight',
  ...
  testWidgets('ConstrainedBox intrinsics - maxHeight',
      (WidgetTester tester) async {
    await tester.pumpWidget(
      ConstrainedBox(
        constraints: const BoxConstraints(
  ...
  testWidgets('ConstrainedBox intrinsics - maxWidth',
      (WidgetTester tester) async {
    await tester.pumpWidget(
      ConstrainedBox(
        constraints: const BoxConstraints(
  ...
  testWidgets('ConstrainedBox intrinsics - infinite',
      (WidgetTester tester) async {
    await tester.pumpWidget(
      ConstrainedBox(
