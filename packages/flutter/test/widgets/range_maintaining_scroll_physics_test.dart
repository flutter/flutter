...
class ExpandingBox extends StatefulWidget {
  const ExpandingBox(
      {Key? key, required this.collapsedSize, required this.expandedSize})
      : super(key: key);
...
void main() {
  ...
  testWidgets('changing the size of the viewport when overscrolled',
  ...
  testWidgets('inserting and removing an item when overscrolled',
      (WidgetTester tester) async {
