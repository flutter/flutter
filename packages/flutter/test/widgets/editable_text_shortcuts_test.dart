...
void main() {
  ...
  group('Web does accept', () {
    ...
    group('macOS only', () {
      testWidgetsWithLeakTracking(
          'pageUp scrolls 80% of viewport dimension upwards',
          (WidgetTester tester) async {
      ...
      testWidgetsWithLeakTracking(
          'pageUp + shift scrolls upwards and modifies selection',
          (WidgetTester tester) async {
        const SingleActivator pageUp =
      ...
      testWidgetsWithLeakTracking(
          'pageDown scrolls 80% of viewport dimension downwards',
          (WidgetTester tester) async {
      ...
      testWidgetsWithLeakTracking(
          'pageDown + shift scrolls downwards and modifies selection',
          (WidgetTester tester) async {
        const SingleActivator pageDown =
      ...
      testWidgetsWithLeakTracking('end scrolls to the end of the text field',
          (WidgetTester tester) async {
      ...
      testWidgetsWithLeakTracking(
          'home scrolls to the beginning of the text field',
          (WidgetTester tester) async {
    ...
    group('non-macOS', () {
      testWidgetsWithLeakTracking('pageUp scrolls up and modifies selection',
          (WidgetTester tester) async {
        const SingleActivator pageUp =
            SingleActivator(LogicalKeyboardKey.pageUp);
      ...
      testWidgetsWithLeakTracking(
          'pageUp + shift scrolls up and modifies selection',
          (WidgetTester tester) async {
        const SingleActivator pageUp =
            SingleActivator(LogicalKeyboardKey.pageUp, shift: true);
      ...
      testWidgetsWithLeakTracking(
          'pageDown scrolls down and modifies selection',
          (WidgetTester tester) async {
        const SingleActivator pageDown =
            SingleActivator(LogicalKeyboardKey.pageDown);
      ...
      testWidgetsWithLeakTracking(
          'pageDown + shift scrolls down and modifies selection',
          (WidgetTester tester) async {
        const SingleActivator pageDown =
            SingleActivator(LogicalKeyboardKey.pageDown, shift: true);
      ...
      testWidgetsWithLeakTracking(
          'end moves selection to the end of the line, no scroll',
          (WidgetTester tester) async {
        const SingleActivator end = SingleActivator(LogicalKeyboardKey.end);
        const int initialSelectionOffset = 0;
