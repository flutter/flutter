...
void main() {
  ...
  testWidgets('Column with one flexible child', (final WidgetTester tester) async {
  ...
  testWidgets('Column with default main axis parameters', (final WidgetTester tester) async {
    const Key columnKey = Key('column');
    const Key child0Key = Key('child0');
    const Key child1Key = Key('child1');
    const Key child2Key = Key('child2');
  ...
  testWidgets('Column with MainAxisAlignment.center', (final WidgetTester tester) async {
    const Key columnKey = Key('column');
    const Key child0Key = Key('child0');
    const Key child1Key = Key('child1');
  ...
  testWidgets('Column with MainAxisAlignment.end', (final WidgetTester tester) async {
    const Key columnKey = Key('column');
    const Key child0Key = Key('child0');
    const Key child1Key = Key('child1');
    const Key child2Key = Key('child2');
  ...
  testWidgets('Column with MainAxisAlignment.spaceBetween', (final WidgetTester tester) async {
    const Key columnKey = Key('column');
    const Key child0Key = Key('child0');
    const Key child1Key = Key('child1');
    const Key child2Key = Key('child2');
  ...
  testWidgets('Column with MainAxisAlignment.spaceAround', (final WidgetTester tester) async {
    const Key columnKey = Key('column');
    const Key child0Key = Key('child0');
    const Key child1Key = Key('child1');
    const Key child2Key = Key('child2');
  ...
  testWidgets('Column with MainAxisAlignment.spaceEvenly', (final WidgetTester tester) async {
    const Key columnKey = Key('column');
    const Key child0Key = Key('child0');
    const Key child1Key = Key('child1');
    const Key child2Key = Key('child2');
  ...
  testWidgets('Column and MainAxisSize.min', (final WidgetTester tester) async {
  ...
  testWidgets('Column MainAxisSize.min layout at zero size', (final WidgetTester tester) async {
