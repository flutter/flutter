...
void main() {
  ...
  testWidgets('View can be used at the top of the widget tree',
      (WidgetTester tester) async {
    await tester.pumpWidget(
      wrapWithView: false,
      View(
  ...
  testWidgets('ViewCollection cannot be used inside a View',
      (WidgetTester tester) async {
    await tester.pumpWidget(
      ViewCollection(
        views: <Widget>[
  ...
  testWidgets('ViewCollection can be used as ViewAnchor.view',
      (WidgetTester tester) async {
    await tester.pumpWidget(
      ViewAnchor(
        view: ViewCollection(
  ...
  testWidgets('ViewAnchor with View can be wrapped and unwrapped',
      (WidgetTester tester) async {
  ...
  testWidgets('Moving a View keeps its semantics tree stable',
      (WidgetTester tester) async {
    final Widget view = View(
