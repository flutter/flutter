...
void main() {
  ...
  testWidgets('SliverLayoutBuilder parent geometry',
  ...
  testWidgets('SliverLayoutBuilder stateful descendants',
      (WidgetTester tester) async {
    late StateSetter setState;
    double childWidth = 10.0;
    double childHeight = 20.0;
  ...
  testWidgets('localToGlobal works with SliverLayoutBuilder',
      (WidgetTester tester) async {
    final Key childKey1 = UniqueKey();
    final Key childKey2 = UniqueKey();
  ...
  testWidgets('hitTest works within SliverLayoutBuilder',
      (WidgetTester tester) async {
    final ScrollController scrollController = ScrollController();
    addTearDown(scrollController.dispose);
  ...
  testWidgets(
      'LayoutBuilder will only invoke builder if updateShouldRebuild returns true',
      (WidgetTester tester) async {
    int buildCount = 0;
    int paintCount = 0;
...
class _SmartLayoutBuilder extends ConstrainedLayoutBuilder<BoxConstraints> {
  ...
  void updateRenderObject(
      BuildContext context, _RenderSmartLayoutBuilder renderObject) {
    renderObject
      ..offsetPercentage = offsetPercentage
      ..onChildWasPainted = onChildWasPainted;
  }
