...
Future<void> main() async {
  ...
  testWidgets('Aborted flight', (WidgetTester tester) async {
    ...
    await tester.pump(
      const Duration(
        milliseconds: FadeForwardsPageTransitionsBuilder.kTransitionMilliseconds * 2 ~/ 3,
      ),
    );
    ...
    // it's been faded out.
    await tester.pump(
      const Duration(milliseconds: FadeForwardsPageTransitionsBuilder.kTransitionMilliseconds ~/ 3),
    );
  ...
  testWidgets('popped hero uses fastOutSlowIn curve', (WidgetTester tester) async {
    ...
    await tester.pump(
      const Duration(milliseconds: FadeForwardsPageTransitionsBuilder.kTransitionMilliseconds ~/ 4),
    );
