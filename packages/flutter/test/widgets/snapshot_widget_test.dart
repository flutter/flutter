...
void main() {
  testWidgets('SnapshotWidget can rasterize child',
  ...
  testWidgets('Changing devicePixelRatio forces raster regeneration',
      (WidgetTester tester) async {
    final SnapshotController controller =
        SnapshotController(allowSnapshotting: true);
    addTearDown(controller.dispose);
  ...
  testWidgets('SnapshotWidget can update the painter type',
      (WidgetTester tester) async {
    final SnapshotController controller =
        SnapshotController(allowSnapshotting: true);
    addTearDown(controller.dispose);
  ...
  testWidgets('SnapshotWidget should have same result when enabled',
      (WidgetTester tester) async {
    ...
    await expectLater(find.byKey(repaintBoundaryKey),
      ...
      skip: kIsWeb ||
          impellerEnabled); // TODO(jonahwilliams): https://github.com/flutter/flutter/issues/106689
