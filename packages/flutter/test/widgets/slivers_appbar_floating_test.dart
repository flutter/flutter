...
void main() {
  testWidgets("Sliver appbars - floating - scroll offset doesn't change", (final WidgetTester tester) async {
  ...
  testWidgets('Sliver appbars - floating - normal behavior works', (final WidgetTester tester) async {
  ...
  testWidgets('Sliver appbars - floating - no floating behavior when animating', (final WidgetTester tester) async {
    final TestDelegate delegate = TestDelegate();
    const double bigHeight = 1000.0;
    GlobalKey key1, key2, key3;
    await tester.pumpWidget(
  ...
  testWidgets('Sliver appbars - floating - floating behavior when dragging down', (final WidgetTester tester) async {
    final TestDelegate delegate = TestDelegate();
    const double bigHeight = 1000.0;
    GlobalKey key1, key2, key3;
    await tester.pumpWidget(
  ...
  testWidgets('Sliver appbars - floating - overscroll gap is below header', (final WidgetTester tester) async {
    await tester.pumpWidget(
      Directionality(
        textDirection: TextDirection.ltr,
        child: CustomScrollView(
  ...
  group('Pointer scrolled floating', () {
    Widget buildTest(final Widget sliver) {
      return MaterialApp(
          ...
          slivers: <Widget>[
            ...
            SliverFixedExtentList(
              ...
              delegate: SliverChildBuilderDelegate(
                  (final BuildContext context, final int index) => Text('Item $index'),
                childCount: 30,
              )
            ),
          ],
    ...
    testWidgets('SliverAppBar', (final WidgetTester tester) async {
    ...
    testWidgets('SliverPersistentHeader', (final WidgetTester tester) async {
    ...
    testWidgets('and snapping SliverAppBar', (final WidgetTester tester) async {
      final GlobalKey appBarKey = GlobalKey();
      await tester.pumpWidget(buildTest(SliverAppBar(
        key: appBarKey,
        floating: true,
...
class HeaderDelegate extends SliverPersistentHeaderDelegate {
  ...
  @override
  bool shouldRebuild(final SliverPersistentHeaderDelegate oldDelegate) => false;
}
