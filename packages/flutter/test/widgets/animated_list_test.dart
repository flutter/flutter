...
// Signature for a builder that returns an animated list. Used to run tests for
// both the AnimatedList and the SliverAnimatedList
typedef _ListBuilder = Widget Function({Key key, int initialItemCount, AnimatedListItemBuilder itemBuilder});

void main() {
  group('AnimatedList', () {
    _runTests(({Key key, int initialItemCount = 0, AnimatedListItemBuilder itemBuilder}) {
      return AnimatedList(
        key: key,
...
void _runTests(_ListBuilder animatedListBuilder) {
