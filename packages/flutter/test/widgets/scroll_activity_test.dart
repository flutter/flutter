        ...
        SchedulerBinding.instance.addPostFrameCallback((_) {
          if (mounted) {
            setState(() {
              ...
              _pageController.position.beginActivity(ForceJumpActivity(
                _pageController.position as ScrollActivityDelegate,
                _currentPage * _pageController.position.viewportDimension * _pageController.viewportFraction +
