...
Future<Size> _getSize(final WidgetTester tester, final BoxConstraints constraints, final double aspectRatio) async {
...
void main() {
  testWidgets('Aspect ratio control test', (final WidgetTester tester) async {
  ...
  testWidgets('Aspect ratio infinite width', (final WidgetTester tester) async {
    final Key childKey = UniqueKey();
