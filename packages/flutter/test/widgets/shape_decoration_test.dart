...
Future<void> main() async {
  ...
  testWidgets('ShapeDecoration.image', (final WidgetTester tester) async {
  ...
  testWidgets('ShapeDecoration.color', (final WidgetTester tester) async {
    await tester.pumpWidget(
      MaterialApp(
        home: DecoratedBox(
          decoration: ShapeDecoration(
  ...
  testWidgets('TestBorder and Directionality - 1', (final WidgetTester tester) async {
  ...
  testWidgets('TestBorder and Directionality - 2', (final WidgetTester tester) async {
    final List<String> log = <String>[];
    await tester.pumpWidget(
      Directionality(
  ...
  testWidgets('Does not crash with directional gradient', (final WidgetTester tester) async {
