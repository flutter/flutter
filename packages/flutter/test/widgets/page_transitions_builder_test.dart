...
void main() {
  ...
  testWidgets('FadeUpwardsPageTransitionsBuilder test with Material PageTransitionTheme', (
    WidgetTester tester,
  ) async {
    await tester.pumpWidget(
      MaterialApp(
  ...
  testWidgets('OpenUpwardsPageTransitionsBuilder test with Material PageTransitionTheme', (
    WidgetTester tester,
  ) async {
    await tester.pumpWidget(
      MaterialApp(
