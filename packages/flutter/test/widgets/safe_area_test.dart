...
void main() {
  ...
  testWidgets('AnimatedSafeArea - basic', (WidgetTester tester) async {
    await tester.pumpWidget(
      const MediaQuery(
        data: const MediaQueryData(padding: const EdgeInsets.all(20.0)),
        child: const AnimatedSafeArea(
          left: false,
  ...
  testWidgets('AnimatedSafeArea - nested', (WidgetTester tester) async {
    await tester.pumpWidget(
      const MediaQuery(
        data: const MediaQueryData(padding: const EdgeInsets.all(20.0)),
        child: const AnimatedSafeArea(
  ...
  testWidgets('AnimatedSafeArea - changing', (WidgetTester tester) async {
    final Widget child = const AnimatedSafeArea(
      bottom: false,
      duration: const Duration(seconds: 1),
      child: const AnimatedSafeArea(
        left: false,
    ...
    expect(tester.getTopLeft(find.byType(Placeholder)), const Offset(60.0, 25.0));
    expect(tester.getBottomRight(find.byType(Placeholder)), const Offset(790.0, 600.0));
    await tester.pump(const Duration(milliseconds: 500));
    expect(tester.getTopLeft(find.byType(Placeholder)), const Offset(100.0, 30.0));
    expect(tester.getBottomRight(find.byType(Placeholder)), const Offset(800.0, 600.0));
  });
