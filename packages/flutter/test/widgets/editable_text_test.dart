...
void main() {
  ...
  testWidgets('multiline keyboard is requested when set explicitly',
    ...
    await tester.idle();
    expect(tester.testTextInput.editingState['text'], equals('test'));
    expect(tester.testTextInput.setClientArgs['inputType']['type'], equals('TextInputType.multiline'));
  ...
  testWidgets('Correct keyboard is requested when set explicitly and maxLines > 1',
    ...
    await tester.idle();
    expect(tester.testTextInput.editingState['text'], equals('test'));
    expect(tester.testTextInput.setClientArgs['inputType']['type'], equals('TextInputType.phone'));
