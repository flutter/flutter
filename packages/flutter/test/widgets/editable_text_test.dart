...
void main() {
  ...
  testWidgets('Composing text is underlined and underline is cleared when losing focus', (WidgetTester tester) async {
    ...
    expect(LayoutSpan.asType<TextSpan>(renderEditable.text.children[1]).text, 'composing');
    expect(LayoutSpan.asType<TextSpan>(renderEditable.text.children[1]).style.decoration, TextDecoration.underline);
