...
void main() {
  ...
  testWidgets('GridView.count control test', (WidgetTester tester) async {
    ...
    for (int i = 0; i < 4; ++i) expect(find.text(kStates[i]), findsNothing);
  ...
  testWidgets('GridView - change maxChildCrossAxisExtent',
      (WidgetTester tester) async {
    final List<int> log = <int>[];
  ...
  testWidgets('GridView.count respects clipBehavior',
      (WidgetTester tester) async {
    await tester.pumpWidget(
      Directionality(
        textDirection: TextDirection.ltr,
  ...
  testWidgets('GridView.extent respects clipBehavior',
      (WidgetTester tester) async {
    await tester.pumpWidget(
      Directionality(
        textDirection: TextDirection.ltr,
