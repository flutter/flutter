...
void main() {
  testWidgets(
          ...
          children: <Widget>[
            Positioned(
              ...
              child: ViewAnchor(
                ...
                child: Text(
                    string), // Text's RenderObject is the target for the ParentDataWidget above.
              ),
            ),
          ],
        ),
    ...
    expect(tester.getBottomRight(find.text('bottom-right')),
    ...
    expect(tester.getBottomRight(find.text('bottom-right-again')),
        const Offset(800, 600));
  });
}
