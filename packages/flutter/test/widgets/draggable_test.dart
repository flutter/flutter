...
void main() {
  testWidgets('Drag and drop - control test', (final WidgetTester tester) async {
    ...
    await tester.pumpWidget(MaterialApp(
      home: Column(
        children: <Widget>[
          ...
          DragTarget<int>(
            builder: (final BuildContext context, final List<int?> data, final List<dynamic> rejects) {
              return const SizedBox(height: 100.0, child: Text('Target'));
            },
            onMove: (final _) => moveCount++,
  ...
  testWidgets('Drag and drop - onLeave callback fires correctly with generic parameter', (final WidgetTester tester) async {
  ...
  testWidgets('Drag and drop - onLeave callback fires correctly', (final WidgetTester tester) async {
    final Map<String,int> leftBehind = <String,int>{
      'Target 1': 0,
      'Target 2': 0,
    };
  ...
  // Regression test for https://github.com/flutter/flutter/issues/76825
  testWidgets('Drag and drop - onMove callback fires correctly with generic parameter', (final WidgetTester tester) async {
      ...
      home: Column(
        children: <Widget>[
          ...
          DragTarget<int>(
            ...
            onMove: (final DragTargetDetails<int> details) {
  ...
  testWidgets('Drag and drop - onMove callback fires correctly', (final WidgetTester tester) async {
    final Map<String,int> targetMoveCount = <String,int>{
      'Target 1': 0,
      'Target 2': 0,
    };
      ...
      home: Column(
        children: <Widget>[
          ...
          DragTarget<int>(
            ...
            onMove: (final DragTargetDetails<dynamic> details) {
  ...
  testWidgets('Drag and drop - dragging over button', (final WidgetTester tester) async {
          ...
          Stack(
            children: <Widget>[
              ...
              DragTarget<int>(
                ...
                onAcceptWithDetails: (final DragTargetDetails<int> _) {
                  events.add('details');
                },
              ),
            ],
  ...
  testWidgets('Drag and drop - tapping button', (final WidgetTester tester) async {
    final List<String> events = <String>[];
    Offset firstLocation, secondLocation;
  ...
  testWidgets('Drag and drop - long press draggable, short press', (final WidgetTester tester) async {
    final List<String> events = <String>[];
    Offset firstLocation, secondLocation;
  ...
  testWidgets('Drag and drop - long press draggable, long press', (final WidgetTester tester) async {
    final List<String> events = <String>[];
    Offset firstLocation, secondLocation;
  ...
  testWidgets('Drag and drop - horizontal and vertical draggables in vertical block', (final WidgetTester tester) async {
    final List<String> events = <String>[];
  ...
  testWidgets('Drag and drop - horizontal and vertical draggables in horizontal block', (final WidgetTester tester) async {
    final List<String> events = <String>[];
    Offset firstLocation, secondLocation, thirdLocation;
  ...
  group('Drag and drop - Draggables with a set axis only move along that axis', () {
    ...
    testWidgets('Null axis draggable moves along all axes', (final WidgetTester tester) async {
    ...
    testWidgets('Horizontal axis draggable moves horizontally', (final WidgetTester tester) async {
      await tester.pumpWidget(build());
    ...
    testWidgets('Horizontal axis draggable does not move vertically', (final WidgetTester tester) async {
      await tester.pumpWidget(build());
      final Offset firstLocation = tester.getTopLeft(find.text('H'));
    ...
    testWidgets('Vertical axis draggable moves vertically', (final WidgetTester tester) async {
      await tester.pumpWidget(build());
    ...
    testWidgets('Vertical axis draggable does not move horizontally', (final WidgetTester tester) async {
      await tester.pumpWidget(build());
      final Offset firstLocation = tester.getTopLeft(find.text('V'));
  ...
  group('Drag and drop - onDragUpdate called if draggable moves along a set axis', () {
    ...
    testWidgets('Null axis onDragUpdate called only if draggable moves in any direction', (final WidgetTester tester) async {
      await tester.pumpWidget(build());
    ...
    testWidgets('Vertical axis onDragUpdate only called if draggable moves vertical', (final WidgetTester tester) async {
      await tester.pumpWidget(build());
    ...
    testWidgets('Horizontal axis onDragUpdate only called if draggable moves horizontal', (final WidgetTester tester) async {
      await tester.pumpWidget(build());
  ...
  testWidgets('Drag and drop - onDraggableCanceled not called if dropped on accepting target', (final WidgetTester tester) async {
    final List<int> accepted = <int>[];
    final List<DragTargetDetails<int>> acceptedDetails = <DragTargetDetails<int>>[];
      ...
      home: Column(
        children: <Widget>[
          Draggable<int>(
            data: 1,
            feedback: const Text('Dragging'),
            onDraggableCanceled: (final Velocity velocity, final Offset offset) {
  ...
  testWidgets('Drag and drop - onDraggableCanceled called if dropped on non-accepting target', (final WidgetTester tester) async {
    final List<int> accepted = <int>[];
    final List<DragTargetDetails<int>> acceptedDetails = <DragTargetDetails<int>>[];
    bool onDraggableCanceledCalled = false;
      ...
      home: Column(
        children: <Widget>[
          ...
          DragTarget<int>(
            ...
            onWillAccept: (final int? data) => false,
            onAccept: accepted.add,
            onAcceptWithDetails: acceptedDetails.add,
          ),
        ],
  ...
  testWidgets('Drag and drop - onDraggableCanceled called if dropped on non-accepting target with correct velocity', (final WidgetTester tester) async {
    final List<int> accepted = <int>[];
    final List<DragTargetDetails<int>> acceptedDetails = <DragTargetDetails<int>>[];
    bool onDraggableCanceledCalled = false;
    late Velocity onDraggableCanceledVelocity;
  ...
  testWidgets('Drag and drop - onDragEnd not called if dropped on non-accepting target', (final WidgetTester tester) async {
    final List<int> accepted = <int>[];
    final List<DragTargetDetails<int>> acceptedDetails = <DragTargetDetails<int>>[];
  ...
  testWidgets('Drag and drop - DragTarget rebuilds with and without rejected data when a rejected draggable enters and leaves', (final WidgetTester tester) async {
    await tester.pumpWidget(MaterialApp(
      home: Column(
        children: <Widget>[
          const Draggable<int>(
  ...
  testWidgets('Drag and drop - Can drag and drop over a non-accepting target multiple times', (final WidgetTester tester) async {
  ...
  testWidgets('Drag and drop - onDragCompleted not called if dropped on non-accepting target', (final WidgetTester tester) async {
    final List<int> accepted = <int>[];
    final List<DragTargetDetails<int>> acceptedDetails = <DragTargetDetails<int>>[];
  ...
  testWidgets('Drag and drop - onDragEnd called if dropped on accepting target', (final WidgetTester tester) async {
    final List<int> accepted = <int>[];
    final List<DragTargetDetails<int>> acceptedDetails = <DragTargetDetails<int>>[];
    bool onDragEndCalled = false;
    late DraggableDetails onDragEndDraggableDetails;
  ...
  testWidgets('DragTarget does not call onDragEnd when remove from the tree', (final WidgetTester tester) async {
    final List<String> events = <String>[];
    Offset firstLocation, secondLocation;
  ...
  testWidgets('Drag and drop - onDragCompleted called if dropped on accepting target', (final WidgetTester tester) async {
    final List<int> accepted = <int>[];
    final List<DragTargetDetails<int>> acceptedDetails = <DragTargetDetails<int>>[];
    bool onDragCompletedCalled = false;
  ...
  testWidgets('Drag and drop - allow pass through of unaccepted data test', (final WidgetTester tester) async {
        ...
        children: <Widget>[
          ...
          Stack(
            children: <Widget>[
              ...
              DragTarget<double>(
                builder: (final BuildContext context, final List<double?> data, final List<dynamic> rejects) {
                  return const IgnorePointer(
                    child: SizedBox(
                      height: 100.0,
                      child: Text('Target2'),
  ...
  testWidgets('Drag and drop - allow pass through of unaccepted data twice test', (final WidgetTester tester) async {
          ...
          Stack(
            children: <Widget>[
              DragTarget<DragTargetData>(
                builder: (final BuildContext context, final List<DragTargetData?> data, final List<dynamic> rejects) {
                  return const IgnorePointer(
                    child: SizedBox(
                      height: 100.0,
                      child: Text('Target1'),
              ...
              DragTarget<ExtendedDragTargetData>(
                builder: (final BuildContext context, final List<ExtendedDragTargetData?> data, final List<dynamic> rejects) {
                  return const IgnorePointer(
                    child: SizedBox(
                      height: 100.0,
                      child: Text('Target2'),
  ...
  testWidgets('Drag and drop - maxSimultaneousDrags', (final WidgetTester tester) async {
    final List<int> accepted = <int>[];
    final List<DragTargetDetails<int>> acceptedDetails = <DragTargetDetails<int>>[];

    Widget build(final int maxSimultaneousDrags) {
      return MaterialApp(
        home: Column(
          children: <Widget>[
            Draggable<int>(
  ...
  testWidgets('Draggable disposes recognizer', (final WidgetTester tester) async {
    bool didTap = false;
  ...
  testWidgets('Draggable plays nice with onTap', (final WidgetTester tester) async {
    await tester.pumpWidget(
      Directionality(
        textDirection: TextDirection.ltr,
        child: Overlay(
  ...
  testWidgets('DragTarget does not set state when remove from the tree', (final WidgetTester tester) async {
    final List<String> events = <String>[];
    Offset firstLocation, secondLocation;
  ...
  testWidgets('Drag and drop - remove draggable', (final WidgetTester tester) async {
    final List<int> accepted = <int>[];
    final List<DragTargetDetails<int>> acceptedDetails = <DragTargetDetails<int>>[];
  ...
  testWidgets('Tap above long-press draggable works', (final WidgetTester tester) async {
    final List<String> events = <String>[];
  ...
  testWidgets('long-press draggable calls onDragEnd called if dropped on accepting target', (final WidgetTester tester) async {
    final List<int> accepted = <int>[];
    final List<DragTargetDetails<int>> acceptedDetails = <DragTargetDetails<int>>[];
    bool onDragEndCalled = false;
    late DraggableDetails onDragEndDraggableDetails;
  ...
  testWidgets('long-press draggable calls onDragCompleted called if dropped on accepting target', (final WidgetTester tester) async {
    final List<int> accepted = <int>[];
    final List<DragTargetDetails<int>> acceptedDetails = <DragTargetDetails<int>>[];
    bool onDragCompletedCalled = false;
  ...
  testWidgets('long-press draggable calls onDragStartedCalled after long press', (final WidgetTester tester) async {
  ...
  testWidgets('Custom long press delay for LongPressDraggable', (final WidgetTester tester) async {
    bool onDragStartedCalled = false;
    await tester.pumpWidget(MaterialApp(
      home: LongPressDraggable<int>(
        data: 1,
  ...
  testWidgets('Default long press delay for LongPressDraggable', (final WidgetTester tester) async {
    bool onDragStartedCalled = false;
    await tester.pumpWidget(MaterialApp(
      home: LongPressDraggable<int>(
        data: 1,
  ...
  testWidgets('long-press draggable calls Haptic Feedback onStart', (final WidgetTester tester) async {
    await _testLongPressDraggableHapticFeedback(tester: tester, hapticFeedbackOnStart: true, expectedHapticFeedbackCount: 1);
  });

  testWidgets('long-press draggable can disable Haptic Feedback', (final WidgetTester tester) async {
    await _testLongPressDraggableHapticFeedback(tester: tester, hapticFeedbackOnStart: false, expectedHapticFeedbackCount: 0);
  });

  testWidgets('Drag feedback with child anchor positions correctly', (final WidgetTester tester) async {
    await _testChildAnchorFeedbackPosition(tester: tester);
  });

  testWidgets('Drag feedback with child anchor within a non-global Overlay positions correctly', (final WidgetTester tester) async {
    await _testChildAnchorFeedbackPosition(tester: tester, left: 100.0, top: 100.0);
  });

  testWidgets('Drag feedback is put on root overlay with [rootOverlay] flag', (final WidgetTester tester) async {
                ...
                onGenerateRoute: (final RouteSettings settings) {
                  if (settings.name == '/') {
                    return MaterialPageRoute<void>(
                      settings: settings,
                      builder: (final BuildContext context) => const Draggable<int>(
                        data: 1,
                        feedback: Text('Dragging'),
                        rootOverlay: true,
                        child: Text('Source'),
  ...
  testWidgets('Drag and drop - DragTarget<Object> can accept Draggable<int> data', (final WidgetTester tester) async {
    ...
    await tester.pumpWidget(MaterialApp(
      home: Column(
        children: <Widget>[
          ...
          DragTarget<Object>(
            builder: (final BuildContext context, final List<Object?> data, final List<dynamic> rejects) {
              return const SizedBox(height: 100.0, child: Text('Target'));
            },
            onAccept: accepted.add,
          ),
  ...
  testWidgets('Drag and drop - DragTarget<int> can accept Draggable<Object> data when runtime type is int', (final WidgetTester tester) async {
    final List<int> accepted = <int>[];
    await tester.pumpWidget(MaterialApp(
      home: Column(
        children: <Widget>[
  ...
  testWidgets('Drag and drop - DragTarget<int> should not accept Draggable<Object> data when runtime type null', (final WidgetTester tester) async {
    final List<int> accepted = <int>[];
  ...
  testWidgets('Drag and drop can contribute semantics', (final WidgetTester tester) async {
  ...
  testWidgets('Drag and drop - when a dragAnchorStrategy is provided it gets called', (final WidgetTester tester) async {
      ...
      home: Column(
        children: <Widget>[
          Draggable<int>(
            ...
            dragAnchorStrategy: (final Draggable<Object> widget, final BuildContext context, final Offset position) {
  ...
  testWidgets('configurable Draggable hit test behavior', (final WidgetTester tester) async {
  ...
  testWidgets('feedback respect the MouseRegion cursor configure', (final WidgetTester tester) async {
    await tester.pumpWidget(
      const MaterialApp(
        home: Column(
          children: <Widget>[
  ...
  testWidgets('configurable feedback ignore pointer behavior', (final WidgetTester tester) async {
    bool onTap = false;
    await tester.pumpWidget(
      MaterialApp(
        home: Column(
  ...
  testWidgets('configurable feedback ignore pointer behavior - LongPressDraggable', (final WidgetTester tester) async {
    bool onTap = false;
    await tester.pumpWidget(
      MaterialApp(
        home: Column(
  ...
  testWidgets('configurable DragTarget hit test behavior', (final WidgetTester tester) async {
    const HitTestBehavior hitTestBehavior = HitTestBehavior.deferToChild;
  ...
  testWidgets('LongPressDraggable.dragAnchorStrategy', (final WidgetTester tester) async {
    const Widget widget1 = Placeholder(key: ValueKey<int>(1));
    const Widget widget2 = Placeholder(key: ValueKey<int>(2));
    Offset dummyStrategy(final Draggable<Object> draggable, final BuildContext context, final Offset position) => Offset.zero;
  ...
  testWidgets('Test allowedButtonsFilter', (final WidgetTester tester) async {
    Widget build(final bool Function(int buttons)? allowedButtonsFilter) {
      return MaterialApp(
        home: Draggable<int>(
          key: UniqueKey(),
    ...
    await tester.pumpWidget(build((final int buttons) => buttons == kSecondaryButton));
    expect(find.text('Dragging'), findsNothing);
    final TestGesture gesture1 = await tester.startGesture(firstLocation, pointer: 8);
    await tester.pump();
    expect(find.text('Dragging'), findsNothing);
    ...
    await tester.pumpWidget(build((final int buttons) => buttons & kTertiaryButton != 0 || buttons & kPrimaryButton != 0));
    expect(find.text('Dragging'), findsNothing);
    ...
    await tester.pumpWidget(build((final int buttons) => false));
    expect(find.text('Dragging'), findsNothing);
...
Future<void> _testLongPressDraggableHapticFeedback({ required final WidgetTester tester, required final bool hapticFeedbackOnStart, required final int expectedHapticFeedbackCount }) async {
  bool onDragStartedCalled = false;
...
Future<void> _testChildAnchorFeedbackPosition({ required final WidgetTester tester, final double top = 0.0, final double left = 0.0 }) async {
  final List<int> accepted = <int>[];
  final List<DragTargetDetails<int>> acceptedDetails = <DragTargetDetails<int>>[];
  int dragStartedCount = 0;
