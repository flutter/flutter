...
class SemanticsTester {
  ...
  static String _flagsToSemanticsFlagExpression(dynamic flags) {
    ...
    if (flags is int) {
      list = SemanticsFlag.values.values.where((SemanticsFlag flag) => (flag.index & flags) != 0);
    } else {
  ...
  static String _actionsToSemanticsActionExpression(dynamic actions) {
    ...
    if (actions is int) {
      list = SemanticsAction.values.values.where((SemanticsAction action) => (action.index & actions) != 0);
    } else {
