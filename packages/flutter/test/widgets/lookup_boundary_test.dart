...
void main() {
  ...
  group('LookupBoundary.debugIsHidingAncestorWidgetOfExactType', () {
    ...
    testWidgets('is not hiding entity within boundary',
        (WidgetTester tester) async {
      bool? isHidden;
      await tester.pumpWidget(Container(
        padding: const EdgeInsets.all(10),
    ...
    testWidgets('is not hiding if no boundary exists',
        (WidgetTester tester) async {
      bool? isHidden;
      await tester.pumpWidget(Container(
        padding: const EdgeInsets.all(10),
    ...
    testWidgets('is not hiding if no boundary and no entity exists',
        (WidgetTester tester) async {
      bool? isHidden;
      await tester.pumpWidget(Builder(
        builder: (BuildContext context) {
