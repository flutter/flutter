...
void main() {
  ...
  setUpAll(() async {
    ...
    final RenderView view =
        RenderView(view: binding.platformDispatcher.views.single);
    ...
    testedExtensions
        .add(WidgetsServiceExtensions.didSendFirstFrameRasterizedEvent.name);
  ...
  tearDownAll(() async {
    ...
    expect(
        binding.extensions.keys
            .where((String name) => name.startsWith('inspector.')),
  ...
  test('Service extensions - debugAllowBanner', () async {
    ...
    result = await binding.testExtension(
        WidgetsServiceExtensions.debugAllowBanner.name, <String, String>{});
  ...
  test('Service extensions - debugDumpApp', () async {
    final Map<String, dynamic> result = await binding.testExtension(
        WidgetsServiceExtensions.debugDumpApp.name, <String, String>{});
  ...
  test('Service extensions - debugDumpFocusTree', () async {
    final Map<String, dynamic> result = await binding.testExtension(
        WidgetsServiceExtensions.debugDumpFocusTree.name, <String, String>{});
  ...
  test('Service extensions - debugDumpLayerTree', () async {
    await binding.doFrame();
    final Map<String, dynamic> result = await binding.testExtension(
        RenderingServiceExtensions.debugDumpLayerTree.name, <String, String>{});
  ...
  test('Service extensions - debugDumpSemanticsTreeInTraversalOrder', () async {
    ...
    expect(result, <String, Object>{
      'data': matches(r'Semantics not generated for RenderView#[0-9a-f]{5}\.\n'
  ...
  test('Service extensions - debugPaint', () async {
    ...
    result = await binding.testExtension(
        RenderingServiceExtensions.debugPaint.name, <String, String>{});
    expect(result, <String, String>{'enabled': 'false'});
    expect(debugPaintSizeEnabled, false);
  ...
  test('Service extensions - debugPaintBaselinesEnabled', () async {
    ...
    testedExtensions
        .add(RenderingServiceExtensions.debugPaintBaselinesEnabled.name);
  });
  ...
  test('Service extensions - profileWidgetBuilds', () async {
    ...
    result = await binding.testExtension(
        WidgetsServiceExtensions.profileWidgetBuilds.name, <String, String>{});
    expect(result, <String, String>{'enabled': 'false'});
    expect(debugProfileBuildsEnabled, false);
  ...
  test('Service extensions - profileRenderObjectPaints', () async {
    ...
    testedExtensions
        .add(RenderingServiceExtensions.profileRenderObjectPaints.name);
  });
  ...
  test('Service extensions - profileRenderObjectLayouts', () async {
    ...
    testedExtensions
        .add(RenderingServiceExtensions.profileRenderObjectLayouts.name);
  });
  ...
  test('Service extensions - profilePlatformChannels', () async {
    ...
    testedExtensions
        .add(ServicesServiceExtensions.profilePlatformChannels.name);
  });
  ...
  test('Service extensions - evict', () async {
    ...
    expect(data, isTrue);
    expect(completed, isFalse);
    result = await binding.testExtension(ServicesServiceExtensions.evict.name,
  ...
  test('Service extensions - exit', () async {
    ...
    expect(
        binding.extensions.containsKey(FoundationServiceExtensions.exit.name),
        !isBrowser);
  ...
  test('Service extensions - platformOverride', () async {
    ...
    result = await binding.testExtension(
        FoundationServiceExtensions.platformOverride.name, <String, String>{});
  ...
  test('Service extensions - repaintRainbow', () async {
    ...
    result = await binding.testExtension(
        RenderingServiceExtensions.repaintRainbow.name, <String, String>{});
    expect(result, <String, String>{'enabled': 'false'});
    expect(debugRepaintRainbowEnabled, false);
    expect(binding.frameScheduled, isFalse);
    pendingResult = binding.testExtension(
  ...
  test('Service extensions - debugDisableClipLayers', () async {
    ...
    testedExtensions
        .add(RenderingServiceExtensions.debugDisableClipLayers.name);
  });
  ...
  test('Service extensions - debugDisablePhysicalShapeLayers', () async {
    ...
    testedExtensions
        .add(RenderingServiceExtensions.debugDisablePhysicalShapeLayers.name);
  });
  ...
  test('Service extensions - debugDisableOpacityLayers', () async {
    ...
    testedExtensions
        .add(RenderingServiceExtensions.debugDisableOpacityLayers.name);
  });
  ...
  test('Service extensions - reassemble', () async {
    ...
    expect(binding.reassembled, 0);
    pendingResult = binding.testExtension(
        FoundationServiceExtensions.reassemble.name, <String, String>{});
    pendingResult.whenComplete(() {
      completed = true;
    });
    await binding.flushMicrotasks();
  ...
  test('Service extensions - showPerformanceOverlay', () async {
    ...
    if (kIsWeb) {
      expect(
          binding.extensions.containsKey(
              WidgetsServiceExtensions.showPerformanceOverlay.name),
          isFalse);
      testedExtensions
          .add(WidgetsServiceExtensions.showPerformanceOverlay.name);
      return;
    }
  ...
  test('Service extensions - timeDilation', () async {
    ...
    result = await binding.testExtension(
        SchedulerServiceExtensions.timeDilation.name, <String, String>{});
    expect(result, <String, String>{
      SchedulerServiceExtensions.timeDilation.name: 1.0.toString()
    });
    expect(timeDilation, 1.0);
    expect(extensionChangedEvents, isEmpty);
    result = await binding.testExtension(
        SchedulerServiceExtensions.timeDilation.name, <String, String>{
      SchedulerServiceExtensions.timeDilation.name: '100.0'
    });
    expect(result, <String, String>{
  ...
  test('Service extensions - activeDevToolsServerAddress', () async {
    ...
    testedExtensions
        .add(FoundationServiceExtensions.activeDevToolsServerAddress.name);
  });
  ...
  test('Service extensions - connectedVmServiceUri', () async {
    ...
    testedExtensions
        .add(FoundationServiceExtensions.connectedVmServiceUri.name);
  });
}
