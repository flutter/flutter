...
void main() {
  ...
  test('nested TextSpans in paragraph handle textScaleFactor correctly.', () {
    ...
    expect(boxes[0].toRect().height, moreOrLessEquals(13.0));
    expect(boxes[1].toRect().width, anyOf(27.0, 26.0));
    expect(boxes[1].toRect().height, moreOrLessEquals(26.0));
    expect(boxes[2].toRect().width, anyOf(27.0, 26.0));
    expect(boxes[2].toRect().height, moreOrLessEquals(26.0));
    expect(boxes[3].toRect().width, anyOf(14.0, 13.0));
    expect(boxes[3].toRect().height, moreOrLessEquals(13.0));
  });
