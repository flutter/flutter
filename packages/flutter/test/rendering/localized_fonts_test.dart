...
void main() {
  testWidgets(
    ...
    (WidgetTester tester) async {
      ...
      await expectLater(
        ...
        matchesGoldenFile('localized_fonts.rich_text.styled_text_span.png', version: null),
      );
    },
    skip: !isLinux,
  );
  ...
  testWidgets(
    ...
    (WidgetTester tester) async {
      ...
      await expectLater(
        find.byType(Row),
        matchesGoldenFile('localized_fonts.text_ambient_locale.chars.png', version: null),
      );
    },
    skip: !isLinux,
  );
  ...
  testWidgets(
    ...
    (WidgetTester tester) async {
      ...
      await expectLater(
        find.byType(Row),
        matchesGoldenFile('localized_fonts.text_explicit_locale.chars.png', version: null),
      );
    },
    skip: !isLinux,
  );
