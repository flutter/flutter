...
void main() {
  ...
  test('Observe layer tree composition - asserts on mutation', () {
    ...
    b1.addCompositionCallback((Layer layer) {
      ...
      expect(() => (layer as ContainerLayer).dropChild(ContainerLayer()), throwsAssertionError);
      expect(() => (layer as ContainerLayer).adoptChild(ContainerLayer()), throwsAssertionError);
