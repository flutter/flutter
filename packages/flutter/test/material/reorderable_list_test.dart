...
void main() {
  group('$ReorderableListView', () {
    ...
    group('in vertical mode', () {
      ...
      testWidgets('properly reorders with a footer',
          (WidgetTester tester) async {
      ...
      testWidgets('Vertical drag in progress golden image',
          (WidgetTester tester) async {
      ...
      testWidgets('Preserves children states when rebuilt',
          (WidgetTester tester) async {
      ...
      testWidgets('Test custom ScrollController behavior when set',
          (WidgetTester tester) async {
      ...
      testWidgets('ReorderableList auto scrolling is fast enough',
          (WidgetTester tester) async {
    ...
    group('in horizontal mode', () {
      ...
      testWidgets('Horizontal drag in progress golden image',
          (WidgetTester tester) async {
        debugDisableShadows = false;
        final Widget reorderableListView = ReorderableListView(
          scrollDirection: Axis.horizontal,
    ...
    group('Padding', () {
      testWidgets('Padding with no header & footer',
          (WidgetTester tester) async {
