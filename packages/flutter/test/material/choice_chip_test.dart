...
void main() {
  ...
  testWidgets('ChoiceChip avatar layout constraints can be customized', (WidgetTester tester) async {
    ...
    expect(tester.getSize(find.byType(ChoiceChip)).width, closeTo(234.0, 0.1));
    expect(tester.getSize(find.byType(ChoiceChip)).height, closeTo(118.0, 0.1));
    ...
    expect(tester.getSize(find.byType(ChoiceChip)).width, closeTo(152.0, 0.1));
    expect(tester.getSize(find.byType(ChoiceChip)).height, closeTo(118.0, 0.1));
