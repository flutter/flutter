...
void main() {
  testWidgets('DrawerButton control test', (final WidgetTester tester) async {
  ...
  testWidgets('DrawerButton icon', (final WidgetTester tester) async {
  ...
  testWidgets('DrawerButton color', (final WidgetTester tester) async {
    await tester.pumpWidget(
      MaterialApp(
  ...
  testWidgets('DrawerButton semantics', (final WidgetTester tester) async {
  ...
  testWidgets('EndDrawerButton control test', (final WidgetTester tester) async {
    await tester.pumpWidget(
      const MaterialApp(
        home: Scaffold(
  ...
  testWidgets('EndDrawerButton semantics', (final WidgetTester tester) async {
    final SemanticsHandle handle = tester.ensureSemantics();
    await tester.pumpWidget(
      const MaterialApp(
        home: Material(
  ...
  testWidgets('EndDrawerButton color', (final WidgetTester tester) async {
    await tester.pumpWidget(
      MaterialApp(
        theme: ThemeData(useMaterial3: true),
        home: const Material(
