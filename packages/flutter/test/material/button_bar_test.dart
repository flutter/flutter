...
void main() {
  testWidgets('ButtonBar default control smoketest', (final WidgetTester tester) async {
  ...
  group('alignment', () {
    ...
    testWidgets('default alignment is MainAxisAlignment.end', (final WidgetTester tester) async {
      await tester.pumpWidget(
        const MaterialApp(
          home: ButtonBar(
            children: <Widget>[
    ...
    testWidgets('ButtonBarTheme.alignment overrides default', (final WidgetTester tester) async {
      await tester.pumpWidget(
        const MaterialApp(
          home: ButtonBarTheme(
    ...
    testWidgets('ButtonBar.alignment overrides ButtonBarTheme.alignment and default', (final WidgetTester tester) async {
      await tester.pumpWidget(
        const MaterialApp(
          home: ButtonBarTheme(
            data: ButtonBarThemeData(
  ...
  group('mainAxisSize', () {
    ...
    testWidgets('Default mainAxisSize is MainAxisSize.max', (final WidgetTester tester) async {
    ...
    testWidgets('ButtonBarTheme.mainAxisSize overrides default', (final WidgetTester tester) async {
      const Key buttonBarKey = Key('row');
      const Key child0Key = Key('child0');
      const Key child1Key = Key('child1');
      const Key child2Key = Key('child2');
    ...
    testWidgets('ButtonBar.mainAxisSize overrides ButtonBarTheme.mainAxisSize and default', (final WidgetTester tester) async {
      const Key buttonBarKey = Key('row');
      const Key child0Key = Key('child0');
      const Key child1Key = Key('child1');
      const Key child2Key = Key('child2');
  ...
  group('button properties override ButtonTheme', () {
    ...
    testWidgets('default button properties override ButtonTheme properties', (final WidgetTester tester) async {
    ...
    testWidgets('ButtonBarTheme button properties override defaults and ButtonTheme properties', (final WidgetTester tester) async {
      late BuildContext capturedContext;
      await tester.pumpWidget(
        MaterialApp(
          home: ButtonBarTheme(
    ...
    testWidgets('ButtonBar button properties override ButtonBarTheme, defaults and ButtonTheme properties', (final WidgetTester tester) async {
      late BuildContext capturedContext;
      await tester.pumpWidget(
        MaterialApp(
          home: ButtonBarTheme(
  ...
  group('layoutBehavior', () {
    ...
    testWidgets('ButtonBar has a min height of 52 when using ButtonBarLayoutBehavior.constrained', (final WidgetTester tester) async {
      await tester.pumpWidget(
    ...
    testWidgets('ButtonBar has padding applied when using ButtonBarLayoutBehavior.padded', (final WidgetTester tester) async {
      await tester.pumpWidget(
        const SingleChildScrollView(
          child: ListBody(
            children: <Widget>[
  ...
  group("ButtonBar's children wrap when they overflow horizontally", () {
    testWidgets("ButtonBar's children wrap when buttons overflow", (final WidgetTester tester) async {
    ...
    testWidgets(
      "ButtonBar's children overflow defaults - MainAxisAlignment.end", (final WidgetTester tester) async {
        final Key keyOne = UniqueKey();
        final Key keyTwo = UniqueKey();
        await tester.pumpWidget(
          MaterialApp(
    ...
    testWidgets("ButtonBar's children overflow - MainAxisAlignment.start", (final WidgetTester tester) async {
      final Key keyOne = UniqueKey();
      final Key keyTwo = UniqueKey();
      await tester.pumpWidget(
        MaterialApp(
    ...
    testWidgets("ButtonBar's children overflow - MainAxisAlignment.center", (final WidgetTester tester) async {
      final Key keyOne = UniqueKey();
      final Key keyTwo = UniqueKey();
      await tester.pumpWidget(
        MaterialApp(
    ...
    testWidgets(
      ...
      'cases when overflowing.', (final WidgetTester tester) async {
        final Key keyOne = UniqueKey();
        final Key keyTwo = UniqueKey();
        await tester.pumpWidget(
          MaterialApp(
  ...
  testWidgets('_RenderButtonBarRow.constraints does not work before layout', (final WidgetTester tester) async {
    await tester.pumpWidget(
    ...
    final Finder buttonBar = find.byWidgetPredicate((final Widget w) => '${w.runtimeType}' == '_ButtonBarRow');
