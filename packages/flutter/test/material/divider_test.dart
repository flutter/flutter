...
void main() {
  testWidgets('Divider control test', (final WidgetTester tester) async {
  ...
  testWidgets('Divider custom thickness', (final WidgetTester tester) async {
    await tester.pumpWidget(
      const Directionality(
        textDirection: TextDirection.ltr,
        child: Center(
  ...
  testWidgets('Horizontal divider custom indentation', (final WidgetTester tester) async {
  ...
  testWidgets('Vertical Divider Test', (final WidgetTester tester) async {
    await tester.pumpWidget(
      const Directionality(
        textDirection: TextDirection.ltr,
        child: Center(
  ...
  testWidgets('Vertical Divider Test 2', (final WidgetTester tester) async {
    await tester.pumpWidget(
      const MaterialApp(
        home: Material(
          child: SizedBox(
  ...
  testWidgets('Vertical divider custom indentation', (final WidgetTester tester) async {
    const double customIndent = 10.0;
    Rect dividerRect;
    Rect lineRect;
  ...
  testWidgets('createBorderSide does not throw exception with null context', (final WidgetTester tester) async {
