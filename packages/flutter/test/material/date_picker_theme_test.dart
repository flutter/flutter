...
void main() {
  ...
  testWidgetsWithLeakTracking('DatePickerTheme.defaults M3 defaults',
  ...
  testWidgetsWithLeakTracking('DatePickerTheme.defaults M2 defaults',
      (WidgetTester tester) async {
  ...
  testWidgetsWithLeakTracking('Default DatePickerThemeData debugFillProperties',
      (WidgetTester tester) async {
  ...
  testWidgetsWithLeakTracking(
      'DatePickerDialog uses ThemeData datePicker theme (input mode)',
      (WidgetTester tester) async {
    await tester.pumpWidget(
      MaterialApp(
        theme: ThemeData(
  ...
  testWidgetsWithLeakTracking('Dividers use DatePickerThemeData.dividerColor',
      (WidgetTester tester) async {
