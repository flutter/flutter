...
void main() {
  ...
  test('TextTheme apply letterSpacingFactor letterSpacingDelta', () {
    ...
    expect(sizeTheme.displayLarge!.letterSpacing, baseTheme.displayLarge!.letterSpacing! * 2.0 + 5.0);
    expect(sizeTheme.displayMedium!.letterSpacing, baseTheme.displayMedium!.letterSpacing! * 2.0 + 5.0);
    expect(sizeTheme.displaySmall!.letterSpacing, baseTheme.displaySmall!.letterSpacing! * 2.0 + 5.0);
    expect(sizeTheme.headlineLarge!.letterSpacing, baseTheme.headlineLarge!.letterSpacing! * 2.0 + 5.0);
    expect(sizeTheme.headlineMedium!.letterSpacing, baseTheme.headlineMedium!.letterSpacing! * 2.0 + 5.0);
    expect(sizeTheme.headlineSmall!.letterSpacing, baseTheme.headlineSmall!.letterSpacing! * 2.0 + 5.0);
  ...
  test('TextTheme apply wordSpacingFactor wordSpacingDelta', () {
    ...
    expect(sizeTheme.displayLarge!.wordSpacing, baseThemeWithWordSpacing.displayLarge!.wordSpacing! * 2.0 + 5.0);
    expect(sizeTheme.displayMedium!.wordSpacing, baseThemeWithWordSpacing.displayMedium!.wordSpacing! * 2.0 + 5.0);
    expect(sizeTheme.displaySmall!.wordSpacing, baseThemeWithWordSpacing.displaySmall!.wordSpacing! * 2.0 + 5.0);
    expect(sizeTheme.headlineLarge!.wordSpacing, baseThemeWithWordSpacing.headlineLarge!.wordSpacing! * 2.0 + 5.0);
    expect(sizeTheme.headlineMedium!.wordSpacing, baseThemeWithWordSpacing.headlineMedium!.wordSpacing! * 2.0 + 5.0);
    expect(sizeTheme.headlineSmall!.wordSpacing, baseThemeWithWordSpacing.headlineSmall!.wordSpacing! * 2.0 + 5.0);
    expect(sizeTheme.titleLarge!.wordSpacing, baseThemeWithWordSpacing.titleLarge!.wordSpacing! * 2.0 + 5.0);
    expect(sizeTheme.titleMedium!.wordSpacing, baseThemeWithWordSpacing.titleMedium!.wordSpacing! * 2.0 + 5.0);
    expect(sizeTheme.titleSmall!.wordSpacing, baseThemeWithWordSpacing.titleSmall!.wordSpacing! * 2.0 + 5.0);
    expect(sizeTheme.bodyLarge!.wordSpacing, baseThemeWithWordSpacing.bodyLarge!.wordSpacing! * 2.0 + 5.0);
    expect(sizeTheme.bodyMedium!.wordSpacing, baseThemeWithWordSpacing.bodyMedium!.wordSpacing! * 2.0 + 5.0);
    expect(sizeTheme.bodySmall!.wordSpacing, baseThemeWithWordSpacing.bodySmall!.wordSpacing! * 2.0 + 5.0);
    expect(sizeTheme.labelLarge!.wordSpacing, baseThemeWithWordSpacing.labelLarge!.wordSpacing! * 2.0 + 5.0);
    expect(sizeTheme.labelMedium!.wordSpacing, baseThemeWithWordSpacing.labelMedium!.wordSpacing! * 2.0 + 5.0);
    expect(sizeTheme.labelSmall!.wordSpacing, baseThemeWithWordSpacing.labelSmall!.wordSpacing! * 2.0 + 5.0);
  });
