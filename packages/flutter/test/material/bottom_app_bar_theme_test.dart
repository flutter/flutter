...
void main() {
  group('Material 2 tests', material2);
  group('Material 3 tests', material3);
}
...
void material3() {
  ...
  testWidgets('BAB theme overrides surfaceTintColor - M3', (WidgetTester tester) async {
    ...
    const BottomAppBarTheme theme = BottomAppBarTheme(surfaceTintColor: babThemeSurfaceTintColor, elevation: 0);
  ...
  testWidgets('BAB surfaceTintColor - Widget - M3', (WidgetTester tester) async {
    ...
    await tester.pumpWidget(MaterialApp(
      ...
      home: const Scaffold(body: BottomAppBar(surfaceTintColor: babSurfaceTintColor)),
    ));
