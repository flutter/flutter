...
void main() {
  testWidgets('English translations exist for all MaterialLocalizations properties', (final WidgetTester tester) async {
  ...
  testWidgets('MaterialLocalizations.of throws', (final WidgetTester tester) async {
