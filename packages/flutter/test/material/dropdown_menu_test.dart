...
void main() {
  ...
  Finder findMenuMaterial() {
    return find.ancestor(
      of: find.byType(TextButton).first,
      matching: find.byType(Material),
    ).first;
  }
  ...
  testWidgets('The text in the menu button should be aligned with the text of '
    ...
    await tester.tap(find.byType(DropdownMenu<TestMenu>));
    await tester.pumpAndSettle();
    final Finder updatedItemText = find.text('Item 0').first;
    ...
    await tester.tap(find.byType(DropdownMenu<TestMenu>));
    await tester.pumpAndSettle();
    final Finder updatedItemText1 = find.text('Item 0').first;
  ...
  testWidgets('DropdownMenuEntry.leadingIcon default layout', (WidgetTester tester) async {
    ...
    expect(tester.getTopLeft(find.text('Item 0').first).dx, 48.0);
    ...
    expect(tester.getTopLeft(find.text('Item 1').first).dx, 48.0);
  });
  ...
  testWidgets('Focus traversal ignores non visible entries', (WidgetTester tester) async {
    final FocusNode buttonFocusNode = FocusNode(debugLabel: 'buttonFocusNode');
    final FocusNode dropdownFocusNode = FocusNode(debugLabel: 'dropdownFocusNode');
    addTearDown(buttonFocusNode.dispose);
    addTearDown(dropdownFocusNode.dispose);
    ...
    await tester.pump();
    expect(dropdownFocusNode.hasFocus, isTrue);
  ...
  group('The menu is attached at the bottom of the TextField', () {
    testWidgets('when given loose constraints and expandedInsets is set', (WidgetTester tester) async {
      ...
      final double textFieldBottom = tester.getRect(find.byType(TextField)).bottom;
