...
void main() {
  ...
  testWidgets('Entry selection in filtered entries should persist after widget rebuild', (
    WidgetTester tester,
  ) async {
    final TextEditingController controller = TextEditingController();
    addTearDown(controller.dispose);
                ...
                children: <Widget>[
                  DropdownMenu<TestMenu>(
                    ...
                    dropdownMenuEntries: <DropdownMenuEntry<TestMenu>>[
                      DropdownMenuEntry<TestMenu>(
                        value: TestMenu.mainMenu0,
                        // The use of a function is necessary to now make the list immuatable in this test.
