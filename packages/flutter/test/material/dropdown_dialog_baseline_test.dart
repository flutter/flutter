...
void main() {
  group('DropdownButton in Wrap in AlertDialog baseline test', () {
    // Regression test for: https://github.com/flutter/flutter/issues/169214
    // Tests that DropdownButtonFormField inside AlertDialog doesn't crash
    // when opened due to missing computeDryBaseline implementation in RenderAligningShiftedBox
    testWidgets('DropdownButtonFormField in Wrap in AlertDialog should not crash on tap', (
      WidgetTester tester,
    ) async {
      ...
      // Before the fix, this would throw because RenderAligningShiftedBox
      // was missing the computeDryBaseline implementation
