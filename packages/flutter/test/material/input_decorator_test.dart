...
void main() {
  ...
  testWidgets('InputDecorator.toString()', (WidgetTester tester) async {
    ...
    expect(
      child.toString(),
      "InputDecorator-[<'key'>](decoration: InputDecoration(floatingLabelBehavior: FloatingLabelBehavior.auto, prefixIconAlignment: center, suffixIconAlignment: center), baseStyle: TextStyle(<all styles inherited>), isFocused: false, isEmpty: false)",
    );
  });
