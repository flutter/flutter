...
void main() {
  ...
  testWidgets('InputDecorator has a good toStringDeep()', (WidgetTester tester) async {
    await tester.pumpWidget(
      buildInputDecorator(
        decoration: const InputDecoration(
          labelText: 'label',
    ...
    final RenderObject object = tester.firstRenderObject(
        find.byType(InputDecorator));

    expect(object, hasAGoodToStringDeep);
    expect(
      object.toStringDeep(),
      equalsIgnoringHashCodes(
          '_RenderDecoration#00000 relayoutBoundary=up1\n'
          ' │ creator: _Decorator ← InputDecorator ← Directionality ← Align ←\n'
          ' │   IconTheme ← _InheritedTheme ← Theme ← Builder ←\n'
          ' │   DefaultTextStyle ← AnimatedDefaultTextStyle ←\n'
          ' │   _InkFeatures-[GlobalKey#00000 ink renderer] ←\n'
          ' │   NotificationListener<LayoutChangedNotification> ← ⋯\n'
          ' │ parentData: offset=Offset(0.0, 0.0) (can use size)\n'
          ' │ constraints: BoxConstraints(0.0<=w<=800.0, 0.0<=h<=600.0)\n'
          ' │ size: Size(800.0, 56.0)\n'
          ' │\n'
          ' ├─input: RenderParagraph#00000 relayoutBoundary=up2\n'
          ' │ │ creator: RichText ← Text ← _Decorator ← InputDecorator ←\n'
          ' │ │   Directionality ← Align ← IconTheme ← _InheritedTheme ← Theme ←\n'
          ' │ │   Builder ← DefaultTextStyle ← AnimatedDefaultTextStyle ← ⋯\n'
          ' │ │ parentData: offset=Offset(0.0, 28.0) (can use size)\n'
          ' │ │ constraints: BoxConstraints(w=800.0, 0.0<=h<=600.0)\n'
          ' │ │ size: Size(800.0, 16.0)\n'
          ' │ │ textAlign: start\n'
          ' │ │ textDirection: ltr\n'
          ...
          ' │ ╘═╦══ text ═══\n'
          ' │   ║ TextSpan:\n'
          ' │   ║   debugLabel: ((englishLike body1).merge(blackMountainView\n'
          ' │   ║     body1)).merge(unknown)\n'
          ' │   ║   inherit: false\n'
          ...
          ' │   ║   "text"\n'
          ' │   ╚═══════════\n'
          ' ├─label: RenderTransform#00000 relayoutBoundary=up2\n'
          ' │ │ creator: Transform ← _Shaker ← _Decorator ← InputDecorator ←\n'
          ' │ │   Directionality ← Align ← IconTheme ← _InheritedTheme ← Theme ←\n'
          ' │ │   Builder ← DefaultTextStyle ← AnimatedDefaultTextStyle ← ⋯\n'
          ...
          ' │ │\n'
          ' │ └─child: RenderParagraph#00000 relayoutBoundary=up3\n'
          ' │   │ creator: RichText ← Text ← DefaultTextStyle ←\n'
          ' │   │   AnimatedDefaultTextStyle ← Transform ← _Shaker ← _Decorator ←\n'
          ' │   │   InputDecorator ← Directionality ← Align ← IconTheme ←\n'
          ' │   │   _InheritedTheme ← ⋯\n'
          ...
          ' │   ╘═╦══ text ═══\n'
          ' │     ║ TextSpan:\n'
          ' │     ║   debugLabel: ((englishLike subhead).merge(blackMountainView\n'
          ' │     ║     subhead)).copyWith\n'
          ' │     ║   inherit: false\n'
          ...
          ' │     ║   "label"\n'
          ' │     ╚═══════════\n'
          ' ├─helperError: RenderConstrainedBox#00000 relayoutBoundary=up2\n'
          ' │   creator: SizedBox ← _HelperError ← _Decorator ← InputDecorator ←\n'
          ' │     Directionality ← Align ← IconTheme ← _InheritedTheme ← Theme ←\n'
          ' │     Builder ← DefaultTextStyle ← AnimatedDefaultTextStyle ← ⋯\n'
          ' │   parentData: offset=Offset(0.0, 0.0) (can use size)\n'
          ' │   constraints: BoxConstraints(w=800.0, 0.0<=h<=600.0)\n'
          ...
          ' │\n'
          ' └─container: RenderCustomPaint#00000\n'
          '   │ creator: CustomPaint ← _BorderContainer ← _Decorator ←\n'
          '   │   InputDecorator ← Directionality ← Align ← IconTheme ←\n'
          '   │   _InheritedTheme ← Theme ← Builder ← DefaultTextStyle ←\n'
          '   │   AnimatedDefaultTextStyle ← ⋯\n'
          '   │ parentData: offset=Offset(0.0, 0.0) (can use size)\n'
          '   │ constraints: BoxConstraints(w=800.0, h=56.0)\n'
          '   │ size: Size(800.0, 56.0)\n'
          '   │\n'
          '   └─child: RenderDecoratedBox#00000\n'
          '       creator: DecoratedBox ← CustomPaint ← _BorderContainer ←\n'
          '         _Decorator ← InputDecorator ← Directionality ← Align ←\n'
          '         IconTheme ← _InheritedTheme ← Theme ← Builder ←\n'
          '         DefaultTextStyle ← ⋯\n'
          '       parentData: <none> (can use size)\n'
          '       constraints: BoxConstraints(w=800.0, h=56.0)\n'
          ...
          '         PlatformAssetBundle#00000(), devicePixelRatio: 3.0, locale:\n'
