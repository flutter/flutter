  ...
  for (final bool useMaterial3 in <bool>[true, false]) {
    ...
    testWidgets('InputDecorator tall prefix', (WidgetTester tester) async {
      ...
      expect(tester.getSize(find.byType(InputDecorator)).height,
          moreOrLessEquals(useMaterial3 ? 129.5 : 128.0, epsilon: .0001));
      ...
      expect(tester.getTopLeft(find.text('text')).dy,
          moreOrLessEquals(useMaterial3 ? 96.75 : 96, epsilon: .0001)); // 12 + 100 - 16
      expect(tester.getTopLeft(find.byKey(pKey)).dy, useMaterial3 ? 12.75 : 12.0);
    ...
    testWidgets('InputDecorator prefixIcon/suffixIcon', (WidgetTester tester) async {
      ...
      expect(
          tester.getTopRight(find.byIcon(Icons.pages)).dx, lessThanOrEqualTo(tester.getTopLeft(find.text('text')).dx));
    ...
    group('textAlignVertical position', () {
      group('simple case', () {
        ...
        testWidgets('align bottom', (WidgetTester tester) async {
          ...
          expect(
              tester.getTopLeft(find.text(text)).dy, moreOrLessEquals(useMaterial3 ? 567.25 : 568.0, epsilon: .0001));
        });
        ...
        testWidgets('align as a double', (WidgetTester tester) async {
          ...
          expect(
              tester.getTopLeft(find.text(text)).dy, moreOrLessEquals(useMaterial3 ? 497.9375 : 498.5, epsilon: .0001));
        });
      });
      ...
      group('label', () {
        ...
        testWidgets('align center', (WidgetTester tester) async {
          ...
          expect(
              tester.getTopLeft(find.text(text)).dy, moreOrLessEquals(useMaterial3 ? 297.25 : 298.0, epsilon: .0001));
        });
        ...
        buildInputDecorator(
          ...
          decoration: InputDecoration(
            contentPadding: EdgeInsetsDirectional.only(
                start: 40.0, top: useMaterial3 ? 12.75 : 12.0, bottom: useMaterial3 ? 12.75 : 12.0),
            labelText: 'label',
            hintText: 'hint',
            filled: true,
          ),
    ...
    testWidgets('InputDecorator with baseStyle', (WidgetTester tester) async {
      ...
      expect(tester.getSize(find.byType(InputDecorator)),
          Size(800.0, useMaterial3 ? 50.0 : kMinInteractiveDimension)); // 45.5 bumped up to minimum.
    ...
    testWidgets('InputDecoration default border uses colorScheme', (WidgetTester tester) async {
      ...
      final Color enabledColor =
          useMaterial3 ? theme.colorScheme.onSurfaceVariant : theme.colorScheme.onSurface.withOpacity(0.38);
    ...
    test('InputBorder hashCodes', () {
      ...
      expect(underlineInputBorder.hashCode,
          const UnderlineInputBorder(borderSide: BorderSide(color: Colors.blue)).hashCode);
