...
void main() {
  testWidgets('IconData object test', (final WidgetTester tester) async {
  ...
  testWidgets('Icons specify the material font', (final WidgetTester tester) async {
    expect(Icons.clear.fontFamily, 'MaterialIcons');
    expect(Icons.search.fontFamily, 'MaterialIcons');
  });

  testWidgets('Certain icons (and their variants) match text direction', (final WidgetTester tester) async {
  ...
  testWidgets('Adaptive icons are correct on cupertino platforms', (final WidgetTester tester) async {
  ...
  testWidgets('Adaptive icons are correct on non-cupertino platforms', (final WidgetTester tester) async {
  ...
  testWidgets('A sample of icons look as expected', (final WidgetTester tester) async {
    await _loadIconFont();
  ...
  testWidgets('Another sample of icons look as expected', (final WidgetTester tester) async {
    await _loadIconFont();
