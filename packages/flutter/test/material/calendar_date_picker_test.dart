...
void main() {
  ...
  group('CalendarDatePicker', () {
    ...
    testWidgets('Default day selection overlay', (WidgetTester tester) async {
      ...
      expect(inkFeatures, isNot(paints..circle(radius: 35.0, color: theme.colorScheme.onSurfaceVariant.withValues(alpha: 0.08))));
      ...
      expect(inkFeatures, paints..circle(radius: 35.0, color: theme.colorScheme.onSurfaceVariant.withValues(alpha: 0.08)));
