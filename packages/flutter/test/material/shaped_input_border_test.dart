...
void main() {
  test('ShapedInputBorder constructor', () {
    const ShapedInputBorder inputBorder = ShapedInputBorder(shape: RoundedRectangleBorder());
  ...
  test('ShapedInputBorder with RoundedSuperellipseBorder', () {
    const ShapedInputBorder inputBorder = ShapedInputBorder(
  ...
  test('ShapedInputBorder lerp', () {
    const ShapedInputBorder inputBorder1 = ShapedInputBorder(
      shape: RoundedSuperellipseBorder(borderRadius: BorderRadius.all(Radius.circular(4.0))),
      gapPadding: 2.0,
    );
    const ShapedInputBorder inputBorder2 = ShapedInputBorder(
      borderSide: BorderSide(width: 3.0),
      shape: RoundedSuperellipseBorder(borderRadius: BorderRadius.all(Radius.circular(12.0))),
      gapPadding: 6.0,
    );

    final ShapedInputBorder lerped =
        ShapeBorder.lerp(inputBorder1, inputBorder2, 0.5)! as ShapedInputBorder;
