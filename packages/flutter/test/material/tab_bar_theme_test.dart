...
void main() {
  ...
  testWidgets('Tab bar defaults (primary)', (WidgetTester tester) async {
    ...
    expect(tabOneRect.left, equals(kTabLabelPadding.left + horizontalOffset));
    ...
    final double tabTwoRight = horizontalOffset + kTabLabelPadding.horizontal + tabOneRect.width
