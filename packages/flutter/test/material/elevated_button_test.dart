...
void main() {
  testWidgets('ElevatedButton, ElevatedButton.icon defaults', (WidgetTester tester) async {
    ...
    expect(
        inkFeatures, paints..circle(color: colorScheme.onPrimary.withAlpha(0x3d))); // splash color is onPrimary(0.24)
  ...
  testWidgets('ElevatedButton onPressed and onLongPress callbacks are correctly called when non-null',
      (WidgetTester tester) async {
    bool wasPressed;
