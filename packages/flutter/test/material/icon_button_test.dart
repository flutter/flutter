...
void main() {
  ...
  testWidgets('test default icon buttons are sized up to 48',
  ...
  testWidgets('test small icons are sized up to 48dp',
      (WidgetTester tester) async {
    final bool material3 = theme.useMaterial3;
  ...
  testWidgets('test icons can be small when total size is >48dp',
      (WidgetTester tester) async {
    final bool material3 = theme.useMaterial3;
    await tester.pumpWidget(wrap(
      useMaterial3: material3,
  ...
  testWidgets('Small icons comply with VisualDensity requirements',
      (WidgetTester tester) async {
    final bool material3 = theme.useMaterial3;
  ...
  testWidgets('test default icon buttons are constrained',
      (WidgetTester tester) async {
    await tester.pumpWidget(
      wrap(
  ...
  testWidgets('IconButton with explicit splash radius - M2',
      (WidgetTester tester) async {
  ...
  testWidgets('IconButton Semantics (enabled) - M2',
      (WidgetTester tester) async {
  ...
  testWidgets('IconButton Semantics (disabled) - M2',
      (WidgetTester tester) async {
    final SemanticsTester semantics = SemanticsTester(tester);
  ...
  testWidgets('IconButton Semantics (selected) - M3',
      (WidgetTester tester) async {
    final SemanticsTester semantics = SemanticsTester(tester);
  ...
  testWidgets('IconButton loses focus when disabled.',
      (WidgetTester tester) async {
  ...
  group('feedback', () {
    ...
    testWidgets('IconButton with disabled feedback',
        (WidgetTester tester) async {
    ...
    testWidgets('IconButton with enabled feedback',
        (WidgetTester tester) async {
      final Widget button = Directionality(
        textDirection: TextDirection.ltr,
        child: Center(
    ...
    testWidgets('IconButton with enabled feedback by default',
        (WidgetTester tester) async {
      final Widget button = Directionality(
        textDirection: TextDirection.ltr,
        child: Center(
  ...
  testWidgets('IconButton responds to density changes.',
      (WidgetTester tester) async {
  ...
  testWidgets('IconButton.mouseCursor changes cursor on hover',
      (WidgetTester tester) async {
    // Test argument works
    await tester.pumpWidget(
      MaterialApp(
  ...
  testWidgets('disabled IconButton has basic mouse cursor',
      (WidgetTester tester) async {
    await tester.pumpWidget(
      MaterialApp(
        theme: theme,
  ...
  testWidgets('Toggleable IconButton.fill defaults - M3',
      (WidgetTester tester) async {
    final ThemeData themeM3 =
        ThemeData.from(colorScheme: colorScheme, useMaterial3: true);
  ...
  testWidgets('IconButton.filledTonal defaults - M3',
      (WidgetTester tester) async {
    final ThemeData themeM3 =
        ThemeData.from(colorScheme: colorScheme, useMaterial3: true);
  ...
  testWidgets('Toggleable IconButton.filledTonal defaults - M3',
      (WidgetTester tester) async {
    final ThemeData themeM3 =
        ThemeData.from(colorScheme: colorScheme, useMaterial3: true);
  ...
  testWidgets('Toggleable IconButton.outlined defaults - M3',
      (WidgetTester tester) async {
    final ThemeData themeM3 =
        ThemeData.from(colorScheme: colorScheme, useMaterial3: true);
  ...
  testWidgets('Does IconButton contribute semantics - M3',
      (WidgetTester tester) async {
    final SemanticsTester semantics = SemanticsTester(tester);
    await tester.pumpWidget(
      Directionality(
  ...
  testWidgets('Override IconButton default padding - M3',
      (WidgetTester tester) async {
  ...
  testWidgets('Default IconButton is not selectable - M3',
      (WidgetTester tester) async {
    await tester.pumpWidget(MaterialApp(
        theme: ThemeData.from(
            colorScheme: const ColorScheme.light(), useMaterial3: true),
  ...
  group('IconTheme tests in Material 3', () {
    testWidgets('IconTheme overrides default values in M3',
        (WidgetTester tester) async {
      // Theme's IconTheme
      await tester.pumpWidget(MaterialApp(
          theme: ThemeData.from(
    ...
    testWidgets('Material3 - IconButton memory leak',
        (WidgetTester tester) async {
