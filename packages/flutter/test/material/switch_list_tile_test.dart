...
void main() {
  ...
  testWidgetsWithLeakTracking('SwitchListTile has the right colors', (WidgetTester tester) async {
    bool value = false;
  ...
  testWidgetsWithLeakTracking('SwitchListTile respects thumbColor in active/enabled states', (WidgetTester tester) async {
  ...
  testWidgetsWithLeakTracking('SwitchListTile respects thumbColor in hovered/pressed states', (WidgetTester tester) async {
  ...
  testWidgetsWithLeakTracking('SwitchListTile respects materialTapTargetSize', (WidgetTester tester) async {
  ...
  testWidgetsWithLeakTracking('SwitchListTile.adaptive respects applyCupertinoTheme', (WidgetTester tester) async {
