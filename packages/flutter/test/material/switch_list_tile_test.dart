      ...
      children: <TestSemantics>[
        TestSemantics.rootChild(
          ...
          children: <TestSemantics>[
            TestSemantics(
              id: 2,
              rect: const Rect.fromLTRB(0.0, 0.0, 60.0, 40.0),
              transform: Matrix4.translationValues(716.0, 8.0, 0.0),
              flags: <SemanticsFlag>[
                SemanticsFlag.hasEnabledState,
                SemanticsFlag.isEnabled,
        ...
        TestSemantics.rootChild(
          ...
          children: <TestSemantics>[
            TestSemantics(
              ...
              transform: Matrix4.translationValues(736.0, 8.0, 0.0),
              flags: <SemanticsFlag>[
        ...
        TestSemantics.rootChild(
          ...
          children: <TestSemantics>[
            TestSemantics(
              id: 6,
              transform: Matrix4.translationValues(16.0, 8.0, 0.0),
              rect: const Rect.fromLTRB(0.0, 0.0, 40.0, 40.0),
              flags: <SemanticsFlag>[SemanticsFlag.hasCheckedState,
                SemanticsFlag.hasEnabledState, SemanticsFlag.isEnabled, SemanticsFlag.isInMutuallyExclusiveGroup,
                SemanticsFlag.isFocusable],
              actions: <SemanticsAction>[SemanticsAction.tap],
            ),
          ],
