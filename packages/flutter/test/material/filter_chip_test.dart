...
void main() {
  ...
  testWidgetsWithLeakTracking('FilterChip uses provided iconTheme',
      (WidgetTester tester) async {
  ...
  testWidgetsWithLeakTracking('Material3 - FilterChip supports delete button',
      (WidgetTester tester) async {
  ...
  testWidgetsWithLeakTracking('Material2 - FilterChip supports delete button',
      (WidgetTester tester) async {
  ...
  testWidgetsWithLeakTracking('Customize FilterChip delete button',
      (WidgetTester tester) async {
    final ThemeData theme = ThemeData();
    Widget buildChip({
      Widget? deleteIcon,
  ...
  testWidgetsWithLeakTracking('FilterChip delete button control test',
      (WidgetTester tester) async {
