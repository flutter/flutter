...
void main() {
  ...
  */
  ...
  testWidgets('does not paint toolbar when no options available on ios',
      (WidgetTester tester) async {
  ...
  testWidgets(
      'text field build empty toolbar when no options available android',
      (WidgetTester tester) async {
  ...
  testWidgets('Sawping controllers should update selection',
      (WidgetTester tester) async {
  ...
  group('Keyboard Tests', () {
    ...
    testWidgets('Shift test 1', (WidgetTester tester) async {
      ...
      sendKeyEventWithCode(
          21, true, true, false); // LEFT_ARROW keydown, SHIFT_ON
      expect(
