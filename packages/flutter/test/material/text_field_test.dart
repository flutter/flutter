...
void main() {
  ...
  testWidgets('text field toolbar options correctly changes options',
    ...
    expect(find.text('CUT'), findsNothing);
    expect(find.text('SELECT ALL'), findsNothing);
  }, skip: isBrowser, targetPlatforms: <TargetPlatform>[ TargetPlatform.android,  TargetPlatform.fuchsia ]);
  ...
  testWidgets('double tap selects word and first tap of double tap moves cursor and shows toolbar', (WidgetTester tester) async {
    final TextEditingController controller = TextEditingController(
      text: 'Atwater Peel Sherbrooke Bonaventure',
    );
    await tester.pumpWidget(
  ...
  testWidgets('double tap on top of cursor also selects word', (WidgetTester tester) async {
    final TextEditingController controller = TextEditingController(
      text: 'Atwater Peel Sherbrooke Bonaventure',
    );
    await tester.pumpWidget(
  ...
  testWidgets('long press selects word and shows toolbar', (WidgetTester tester) async {
    final TextEditingController controller = TextEditingController(
      text: 'Atwater Peel Sherbrooke Bonaventure',
    );
    await tester.pumpWidget(
  ...
  testWidgets('long press drag moves the cursor under the drag and shows toolbar on lift', (WidgetTester tester) async {
    final TextEditingController controller = TextEditingController(
      text: 'Atwater Peel Sherbrooke Bonaventure',
    );
    await tester.pumpWidget(
