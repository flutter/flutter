...
void main() {
  ...
  testWidgets(
    ...
    (WidgetTester tester) async {
      ...
      switch (defaultTargetPlatform) {
        case TargetPlatform.android:
          ...
          expect(
              find.byType(CupertinoDesktopTextSelectionToolbar), findsNothing);
    ...
    skip:
        isBrowser, // [intended] see https://github.com/flutter/flutter/issues/108382
  );

  testWidgets('Can build children directly as well',
      (WidgetTester tester) async {
  ...
  testWidgets(
    ...
    (WidgetTester tester) async {
      ...
      switch (defaultTargetPlatform) {
        ...
        case TargetPlatform.windows:
          expect(
              find.byType(DesktopTextSelectionToolbarButton), findsOneWidget);
        case TargetPlatform.macOS:
    ...
    (WidgetTester tester) async {
      ...
      switch (defaultTargetPlatform) {
        case TargetPlatform.android:
          ...
          expect(findMaterialOverflowNextButton(),
              findsOneWidget); // Material overflow buttons are not TextSelectionToolbarTextButton.
          ...
          expect(findMaterialOverflowBackButton(),
              findsOneWidget); // Material overflow buttons are not TextSelectionToolbarTextButton.
        ...
        case TargetPlatform.windows:
          expect(
              find.byType(DesktopTextSelectionToolbarButton), findsNWidgets(8));
          expect(find.text('Cut'), findsOneWidget);
          expect(find.text('Copy'), findsOneWidget);
          expect(find.text('Paste'), findsOneWidget);
          expect(find.text('Select all'), findsOneWidget);
    ...
    testWidgets(
      ...
      (WidgetTester tester) async {
        ...
        switch (defaultTargetPlatform) {
          ...
          case TargetPlatform.macOS:
            expect(
                buttonTypes, isNot(contains(ContextMenuButtonType.selectAll)));
        }
      ...
      (WidgetTester tester) async {
        ...
        switch (defaultTargetPlatform) {
          ...
          case TargetPlatform.android:
            expect(find.byType(TextSelectionToolbarTextButton), findsOneWidget);
            expect(
                find.byType(CupertinoTextSelectionToolbarButton), findsNothing);
            expect(
                find.byType(DesktopTextSelectionToolbarButton), findsNothing);
            expect(find.byType(CupertinoDesktopTextSelectionToolbarButton),
                findsNothing);
          case TargetPlatform.iOS:
