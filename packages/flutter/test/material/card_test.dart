...
void main() {
  testWidgets('Card can take semantic text from multiple children', (final WidgetTester tester) async {
  ...
  testWidgets('Card merges children when it is a semanticContainer', (final WidgetTester tester) async {
    final SemanticsTester semantics = SemanticsTester(tester);
  ...
  testWidgets('Card margin', (final WidgetTester tester) async {
  ...
  testWidgets('Card clipBehavior property passes through to the Material', (final WidgetTester tester) async {
  ...
  testWidgets('Card clipBehavior property defers to theme when null', (final WidgetTester tester) async {
    await tester.pumpWidget(Builder(builder: (final BuildContext context) {
  ...
  testWidgets('Card shadowColor', (final WidgetTester tester) async {
    Material getCardMaterial(final WidgetTester tester) {
    ...
    Card getCard(final WidgetTester tester) {
