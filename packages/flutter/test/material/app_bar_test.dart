...
void main() {
  ...
  testWidgets('AppBar centerLeading:true',
    ...
    final Finder leading = find.byType(BackButton);
    expect(tester.getCenter(leading), const Offset(28.0, 28.0));
  });

    testWidgets('AppBar centerLeading:false',
      (WidgetTester tester) async {
    await tester.pumpWidget(
      MaterialApp(
        theme: ThemeData(platform: TargetPlatform.android),
