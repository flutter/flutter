...
void main() {
  testWidgetsWithLeakTracking('Default dropdown golden',
  ...
  testWidgetsWithLeakTracking('Expanded dropdown golden',
      (WidgetTester tester) async {
    final Key buttonKey = UniqueKey();
    Widget build() => buildFrame(
        buttonKey: buttonKey,
  ...
  testWidgetsWithLeakTracking('Dropdown button control test',
      (WidgetTester tester) async {
    String? value = 'one';
  ...
  testWidgetsWithLeakTracking('Dropdown button with no app',
      (WidgetTester tester) async {
    String? value = 'one';
    void didChangeValue(String? newValue) {
      value = newValue;
  ...
  testWidgetsWithLeakTracking('Dropdown form field uses form field state',
      (WidgetTester tester) async {
    final Key buttonKey = UniqueKey();
  ...
  testWidgetsWithLeakTracking('Dropdown in ListView',
      (WidgetTester tester) async {
  ...
  testWidgetsWithLeakTracking('Dropdown screen edges',
      (WidgetTester tester) async {
    int? value = 4;
  ...
  for (final TextDirection textDirection in TextDirection.values) {
    testWidgetsWithLeakTracking(
        'Dropdown button aligns selected menu item ($textDirection)',
        (WidgetTester tester) async {
      final Key buttonKey = UniqueKey();
  ...
  testWidgetsWithLeakTracking(
      'Dropdown menu scrolls to first item in long lists',
      (WidgetTester tester) async {
  ...
  testWidgetsWithLeakTracking(
      'Dropdown menu scrolls to last item in long lists',
      (WidgetTester tester) async {
    final Key buttonKey = UniqueKey();
    await tester.pumpWidget(buildFrame(
      buttonKey: buttonKey,
  ...
  testWidgetsWithLeakTracking('Size of DropdownButton with null value',
      (WidgetTester tester) async {
    final Key buttonKey = UniqueKey();
    String? value;
  ...
  testWidgetsWithLeakTracking('Size of DropdownButton with no items',
      (WidgetTester tester) async {
  ...
  testWidgetsWithLeakTracking('Layout of a DropdownButton with null value',
      (WidgetTester tester) async {
    final Key buttonKey = UniqueKey();
    String? value;
  ...
  testWidgetsWithLeakTracking('Dropdown menus must fit within the screen',
      (WidgetTester tester) async {
  ...
  testWidgetsWithLeakTracking('Semantics Tree contains only selected element',
      (WidgetTester tester) async {
  ...
  testWidgetsWithLeakTracking('Dropdown button includes semantics',
      (WidgetTester tester) async {
  ...
  testWidgetsWithLeakTracking('Dropdown menu includes semantics',
      (WidgetTester tester) async {
    final SemanticsTester semantics = SemanticsTester(tester);
    const Key key = Key('test');
    await tester.pumpWidget(buildFrame(
  ...
  testWidgetsWithLeakTracking('disabledHint behavior test',
      (WidgetTester tester) async {
    Widget build(
            {List<String>? items,
            ValueChanged<String?>? onChanged,
  ...
  testWidgetsWithLeakTracking('DropdownButton selected item color test',
      (WidgetTester tester) async {
    Widget build(
        {ValueChanged<String?>? onChanged,
        String? value,
  ...
  testWidgetsWithLeakTracking('DropdownButton disabledHint is null by default',
      (WidgetTester tester) async {
    final Key buttonKey = UniqueKey();
  ...
  testWidgetsWithLeakTracking('Dropdown in middle showing middle item',
      (WidgetTester tester) async {
  ...
  testWidgetsWithLeakTracking('Dropdown in top showing bottom item',
      (WidgetTester tester) async {
    final List<DropdownMenuItem<int>> items =
        List<DropdownMenuItem<int>>.generate(
      100,
  ...
  testWidgetsWithLeakTracking('Dropdown in bottom showing top item',
      (WidgetTester tester) async {
    final List<DropdownMenuItem<int>> items =
        List<DropdownMenuItem<int>>.generate(
      100,
  ...
  testWidgetsWithLeakTracking('Dropdown in center showing bottom item',
      (WidgetTester tester) async {
    final List<DropdownMenuItem<int>> items =
        List<DropdownMenuItem<int>>.generate(
      100,
  ...
  testWidgetsWithLeakTracking('Dropdown menu respects parent size limits',
      (WidgetTester tester) async {
  ...
  testWidgetsWithLeakTracking('DropdownButton uses default color when expanded',
      (WidgetTester tester) async {
    await checkDropdownColor(tester);
  });

  testWidgetsWithLeakTracking('DropdownButton uses dropdownColor when expanded',
      (WidgetTester tester) async {
    await checkDropdownColor(tester,
  ...
  testWidgetsWithLeakTracking('Variable size and oversized menu items',
      (WidgetTester tester) async {
  ...
  testWidgetsWithLeakTracking('DropdownButton hint is selected item',
      (WidgetTester tester) async {
  ...
  testWidgetsWithLeakTracking(
      'DropdownButton can be focused, and has focusColor',
      (WidgetTester tester) async {
  ...
  testWidgetsWithLeakTracking("DropdownButton won't be focused if not enabled",
      (WidgetTester tester) async {
    final UniqueKey buttonKey = UniqueKey();
    final FocusNode focusNode = FocusNode(debugLabel: 'DropdownButton');
    addTearDown(focusNode.dispose);
  ...
  testWidgetsWithLeakTracking('DropdownButton is activated with the enter key',
      (WidgetTester tester) async {
    final FocusNode focusNode = FocusNode(debugLabel: 'DropdownButton');
    addTearDown(focusNode.dispose);
    String? value = 'one';
  ...
  testWidgetsWithLeakTracking('DropdownButton is activated with the space key',
      (WidgetTester tester) async {
    final FocusNode focusNode = FocusNode(debugLabel: 'DropdownButton');
    addTearDown(focusNode.dispose);
    String? value = 'one';
  ...
  testWidgetsWithLeakTracking('DropdownButton onTap callback can request focus',
      (WidgetTester tester) async {
    final FocusNode focusNode = FocusNode(debugLabel: 'DropdownButton')
      ..addListener(() {});
    addTearDown(focusNode.dispose);
  ...
  testWidgetsWithLeakTracking('menu position test with `menuMaxHeight`',
      (WidgetTester tester) async {
    final Key buttonKey = UniqueKey();
    await tester.pumpWidget(buildFrame(
      buttonKey: buttonKey,
  ...
  testWidgetsWithLeakTracking('Do not crash if used in very short screen',
      (WidgetTester tester) async {
  ...
  testWidgetsWithLeakTracking('Disabled item should not be focusable',
      (WidgetTester tester) async {
    await tester.pumpWidget(
      MaterialApp(
        home: Scaffold(
  ...
  group('feedback', () {
    ...
    testWidgetsWithLeakTracking('Dropdown with enabled feedback',
        (WidgetTester tester) async {
    ...
    testWidgetsWithLeakTracking('Dropdown with disabled feedback',
        (WidgetTester tester) async {
    ...
    testWidgetsWithLeakTracking('Dropdown with enabled feedback by default',
        (WidgetTester tester) async {
  ...
  testWidgetsWithLeakTracking('borderRadius property works properly',
      (WidgetTester tester) async {
  ...
  testWidgetsWithLeakTracking('Do not throw due to the double precision',
      (WidgetTester tester) async {
    const String value = 'One';
  ...
  testWidgetsWithLeakTracking('DropdownButton hint alignment',
      (WidgetTester tester) async {
  ...
  testWidgetsWithLeakTracking(
      'BorderRadius property clips dropdown button and dropdown menu',
      (WidgetTester tester) async {
    const double radius = 20.0;
  ...
  testWidgetsWithLeakTracking('Size of DropdownButton with padding',
      (WidgetTester tester) async {
