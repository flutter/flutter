...
void main() {
  ...
  test('SliderThemeData merges properly.', () {
    const SliderThemeData firstFullTheme = SliderThemeData(
      trackHeight: 1,
      activeTrackColor: Color(0x00000010),
      inactiveTrackColor: Color(0x00000011),
      disabledActiveTrackColor: Color(0x00000012),
      disabledInactiveTrackColor: Color(0x00000013),
      activeTickMarkColor: Color(0x00000014),
      inactiveTickMarkColor: Color(0x00000015),
      disabledActiveTickMarkColor: Color(0x00000016),
      disabledInactiveTickMarkColor: Color(0x00000017),
      thumbColor: Color(0x00000018),
      disabledThumbColor: Color(0x00000019),
      overlayColor: Color(0x00000020),
      valueIndicatorColor: Color(0x00000021),
    ...
    const SliderThemeData nullTheme = SliderThemeData();
    const SliderThemeData secondFullTheme = SliderThemeData(
      trackHeight: 1,
      activeTrackColor: Color(0x00000030),
      inactiveTrackColor: Color(0x00000031),
      disabledActiveTrackColor: Color(0x00000032),
      disabledInactiveTrackColor: Color(0x00000033),
      activeTickMarkColor: Color(0x00000034),
      inactiveTickMarkColor: Color(0x00000035),
      disabledActiveTickMarkColor: Color(0x00000036),
      disabledInactiveTickMarkColor: Color(0x00000037),
      thumbColor: Color(0x00000038),
      disabledThumbColor: Color(0x00000039),
      overlayColor: Color(0x00000040),
      valueIndicatorColor: Color(0x00000041),
      trackShape: RoundedRectSliderTrackShape(),
      tickMarkShape: RoundSliderTickMarkShape(tickMarkRadius: 99),
      thumbShape: RoundSliderThumbShape(enabledThumbRadius: 99),
      overlayShape: RoundSliderOverlayShape(overlayRadius: 99),
      valueIndicatorShape: PaddleSliderValueIndicatorShape(), // need a second shape
      showValueIndicator: ShowValueIndicator.never,
      valueIndicatorTextStyle: TextStyle(color: Colors.red),
    );

    // TODO(clocksmith): fill in the right values
//    SliderThemeData fullMergedWithNullTheme = firstFullTheme.merge(nullTheme);
//    expect(fullMergedWithNullTheme.trackHeight, 1);
//    expect(fullMergedWithNullTheme.activeTrackColor, isNull);
//    expect(fullMergedWithNullTheme.inactiveTrackColor, isNull);
//    expect(fullMergedWithNullTheme.disabledActiveTrackColor, isNull);
//    expect(fullMergedWithNullTheme.disabledInactiveTrackColor, isNull);
//    expect(fullMergedWithNullTheme.activeTickMarkColor, isNull);
//    expect(fullMergedWithNullTheme.inactiveTickMarkColor, isNull);
//    expect(fullMergedWithNullTheme.disabledActiveTickMarkColor, isNull);
//    expect(fullMergedWithNullTheme.disabledInactiveTickMarkColor, isNull);
//    expect(fullMergedWithNullTheme.thumbColor, Colors.green);
//    expect(fullMergedWithNullTheme.disabledThumbColor, isNull);
//    expect(fullMergedWithNullTheme.overlayColor, isNull);
//    expect(fullMergedWithNullTheme.valueIndicatorColor, isNull);
//    expect(fullMergedWithNullTheme.trackShape, isNull);
//    expect(fullMergedWithNullTheme.tickMarkShape, isNull);
//    expect(fullMergedWithNullTheme.thumbShape, isNull);
//    expect(fullMergedWithNullTheme.overlayShape, isNull);
//    expect(fullMergedWithNullTheme.valueIndicatorShape, isNull);
//    expect(fullMergedWithNullTheme.showValueIndicator, isNull);
//    expect(fullMergedWithNullTheme.valueIndicatorTextStyle, isNull);

    SliderThemeData nullMergedWithFullTheme = nullTheme.merge(firstFullTheme);
//    expect(nullMergedWithFullTheme.trackHeight, isNull);
//    expect(nullMergedWithFullTheme.activeTrackColor, isNull);
//    expect(nullMergedWithFullTheme.inactiveTrackColor, isNull);
//    expect(nullMergedWithFullTheme.disabledActiveTrackColor, isNull);
//    expect(nullMergedWithFullTheme.disabledInactiveTrackColor, isNull);
//    expect(nullMergedWithFullTheme.activeTickMarkColor, isNull);
//    expect(nullMergedWithFullTheme.inactiveTickMarkColor, isNull);
//    expect(nullMergedWithFullTheme.disabledActiveTickMarkColor, isNull);
//    expect(nullMergedWithFullTheme.disabledInactiveTickMarkColor, isNull);
//    expect(nullMergedWithFullTheme.thumbColor, isNull);
//    expect(nullMergedWithFullTheme.disabledThumbColor, isNull);
//    expect(nullMergedWithFullTheme.overlayColor, isNull);
//    expect(nullMergedWithFullTheme.valueIndicatorColor, isNull);
//    expect(nullMergedWithFullTheme.trackShape, isNull);
//    expect(nullMergedWithFullTheme.tickMarkShape, isNull);
//    expect(nullMergedWithFullTheme.thumbShape, isNull);
//    expect(nullMergedWithFullTheme.overlayShape, isNull);
//    expect(nullMergedWithFullTheme.valueIndicatorShape, isNull);
//    expect(nullMergedWithFullTheme.showValueIndicator, isNull);
//    expect(nullMergedWithFullTheme.valueIndicatorTextStyle, isNull);

    // TODO(clocksmith): fill in the right values
//    SliderThemeData firstMergedWithSecondTheme = firstFullTheme.merge(secondFullTheme);
//    expect(firstMergedWithSecondTheme.trackHeight, isNull);
//    expect(firstMergedWithSecondTheme.activeTrackColor, isNull);
//    expect(firstMergedWithSecondTheme.inactiveTrackColor, isNull);
//    expect(firstMergedWithSecondTheme.disabledActiveTrackColor, isNull);
//    expect(firstMergedWithSecondTheme.disabledInactiveTrackColor, isNull);
//    expect(firstMergedWithSecondTheme.activeTickMarkColor, isNull);
//    expect(firstMergedWithSecondTheme.inactiveTickMarkColor, isNull);
//    expect(firstMergedWithSecondTheme.disabledActiveTickMarkColor, isNull);
//    expect(firstMergedWithSecondTheme.disabledInactiveTickMarkColor, isNull);
//    expect(firstMergedWithSecondTheme.thumbColor, Colors.green);
//    expect(firstMergedWithSecondTheme.disabledThumbColor, isNull);
//    expect(firstMergedWithSecondTheme.overlayColor, isNull);
//    expect(firstMergedWithSecondTheme.valueIndicatorColor, isNull);
//    expect(firstMergedWithSecondTheme.trackShape, isNull);
//    expect(firstMergedWithSecondTheme.tickMarkShape, isNull);
//    expect(firstMergedWithSecondTheme.thumbShape, isNull);
//    expect(firstMergedWithSecondTheme.overlayShape, isNull);
//    expect(firstMergedWithSecondTheme.valueIndicatorShape, isNull);
//    expect(firstMergedWithSecondTheme.showValueIndicator, isNull);
//    expect(firstMergedWithSecondTheme.valueIndicatorTextStyle, isNull);
