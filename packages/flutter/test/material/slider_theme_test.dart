...
class RoundedRectSliderTrackShapeWithCustomAdditionalActiveTrackHeight extends RoundedRectSliderTrackShape {
  const RoundedRectSliderTrackShapeWithCustomAdditionalActiveTrackHeight({this.additionalActiveTrackHeight});
  ...
  void paint(
    ...
    additionalActiveTrackHeight = this.additionalActiveTrackHeight ?? additionalActiveTrackHeight;
