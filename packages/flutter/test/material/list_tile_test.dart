...
void main() {
  ...
  testWidgets('ListTile throws assertion when useMaterial3 and dense are true', (WidgetTester tester) async {
    ...
    expect(
      exception.message,
      'ListTile.dense cannot be true while Theme.useMaterial3 is true.',
    );
