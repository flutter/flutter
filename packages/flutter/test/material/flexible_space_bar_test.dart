...
void main() {
  ...
  testWidgetsWithLeakTracking('Material2 - FlexibleSpaceBarSettings provides settings to a FlexibleSpaceBar', (WidgetTester tester) async {
  ...
  testWidgetsWithLeakTracking('Material3 - FlexibleSpaceBarSettings provides settings to a FlexibleSpaceBar', (WidgetTester tester) async {
    const double minExtent = 100.0;
    const double initExtent = 200.0;
    const double maxExtent = 300.0;
    const double alpha = 0.5;
  ...
  testWidgetsWithLeakTracking('Material2 - Collapsed FlexibleSpaceBar has correct semantics', (WidgetTester tester) async {
  ...
  testWidgetsWithLeakTracking('Material3 - Collapsed FlexibleSpaceBar has correct semantics', (WidgetTester tester) async {
    final SemanticsTester semantics = SemanticsTester(tester);
    const double expandedHeight = 200;
    await tester.pumpWidget(
      MaterialApp(
  ...
  testWidgetsWithLeakTracking('Material2 - FlexibleSpaceBar sets width constraints for the title', (WidgetTester tester) async {
  ...
  // This is a regression test for https://github.com/flutter/flutter/issues/14227
  testWidgetsWithLeakTracking('Material3 - FlexibleSpaceBar sets width constraints for the title', (WidgetTester tester) async {
    const double titleFontSize = 20.0;
    const double height = 300.0;
    late double width;
    await tester.pumpWidget(
    ...
    // The text height is font size multiplied by line height, which is
    // then multiplied by the 1.5 scale factor.
    final double textHeight = (titleFontSize * 1.27).roundToDouble();
    expect(
      tester.getRect(find.byType(Text)),
      rectMoreOrLessEquals(Rect.fromLTRB(0, height - (textHeight * 1.5), textWidth, height), epsilon: 0.0001),
    );
  }, skip: kIsWeb && !isCanvasKit); // https://github.com/flutter/flutter/issues/99933

  testWidgetsWithLeakTracking('Material2 - FlexibleSpaceBar sets constraints for the title - override expandedTitleScale', (WidgetTester tester) async {
    const double titleFontSize = 20.0;
    const double height = 300.0;
  ...
  testWidgetsWithLeakTracking('Material3 - FlexibleSpaceBar sets constraints for the title - override expandedTitleScale', (WidgetTester tester) async {
    const double titleFontSize = 20.0;
    const double height = 300.0;
    const double expandedTitleScale = 3.0;
    await tester.pumpWidget(
    ...
    // The title is scaled and transformed to be 3 times bigger, when the
    // FlexibleSpaceBar is fully expanded, thus we expect the width to be
    // 3 times smaller than the full width.
    // The text height is font size multiplied by line height, which is
    // then multiplied by the 3.0 scale factor.
    final double textHeight = (titleFontSize * 1.27).roundToDouble();
    expect(
      tester.getRect(title),
      rectMoreOrLessEquals(Rect.fromLTRB(0, height - (textHeight * expandedTitleScale), textWidth, height), epsilon: 0.0001),
    );
  }, skip: kIsWeb && !isCanvasKit); // https://github.com/flutter/flutter/issues/99933

  testWidgetsWithLeakTracking('Material2 - FlexibleSpaceBar scaled title', (WidgetTester tester) async {
    const double titleFontSize = 20.0;
    const double height = 300.0;
    await tester.pumpWidget(
      MaterialApp(
    ...
    await expectLater(
      flexibleSpaceBar,
      matchesGoldenFile('m2.flexible_space_bar.expanded_title_scale_default.collapsed.png')
    );
    ...
    await expectLater(
      flexibleSpaceBar,
      matchesGoldenFile('m2.flexible_space_bar.expanded_title_scale_default.expanded.png')
    );
  });

  testWidgetsWithLeakTracking('Material3 - FlexibleSpaceBar scaled title', (WidgetTester tester) async {
    const double titleFontSize = 20.0;
    const double height = 300.0;
    await tester.pumpWidget(
      MaterialApp(
    ...
    await expectLater(
      flexibleSpaceBar,
      matchesGoldenFile('m3.flexible_space_bar.expanded_title_scale_default.collapsed.png')
    );
    ...
    await expectLater(
      flexibleSpaceBar,
      matchesGoldenFile('m3.flexible_space_bar.expanded_title_scale_default.expanded.png')
    );
  });

  testWidgetsWithLeakTracking('Material2 - FlexibleSpaceBar scaled title - override expandedTitleScale', (WidgetTester tester) async {
    const double titleFontSize = 20.0;
    const double height = 300.0;
    const double expandedTitleScale = 3.0;
    await tester.pumpWidget(
    ...
    await expectLater(
      flexibleSpaceBar,
      matchesGoldenFile('m2.flexible_space_bar.expanded_title_scale_override.expanded.png')
    );
  });

  testWidgetsWithLeakTracking('Material3 - FlexibleSpaceBar scaled title - override expandedTitleScale', (WidgetTester tester) async {
    const double titleFontSize = 20.0;
    const double height = 300.0;
    const double expandedTitleScale = 3.0;
    await tester.pumpWidget(
    ...
    await expectLater(
      flexibleSpaceBar,
      matchesGoldenFile('m3.flexible_space_bar.expanded_title_scale_override.expanded.png')
    );
  });

  testWidgetsWithLeakTracking('Material2 - FlexibleSpaceBar test titlePadding defaults', (WidgetTester tester) async {
  ...
  testWidgetsWithLeakTracking('Material3 - FlexibleSpaceBar test titlePadding defaults', (WidgetTester tester) async {
    Widget buildFrame(TargetPlatform platform, bool? centerTitle) {
      return MaterialApp(
        theme: ThemeData(platform: platform),
        home: Scaffold(
  ...
  testWidgetsWithLeakTracking('Material2 - FlexibleSpaceBar test titlePadding override', (WidgetTester tester) async {
    Widget buildFrame(TargetPlatform platform, bool? centerTitle) {
      return MaterialApp(
        theme: ThemeData(platform: platform, useMaterial3: false),
        home: Scaffold(
  ...
  testWidgetsWithLeakTracking('Material3 - FlexibleSpaceBar test titlePadding override', (WidgetTester tester) async {
    Widget buildFrame(TargetPlatform platform, bool? centerTitle) {
      return MaterialApp(
        theme: ThemeData(platform: platform),
        home: Scaffold(
