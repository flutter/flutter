...
void main() {
  ...
  testWidgets('MaterialApp has correct default KeyboardDismissBehavior', (WidgetTester tester) async {
    late BuildContext capturedContext;
    await tester.pumpWidget(
      MaterialApp(
        home: Builder(
  ...
  testWidgets('MaterialApp can override default KeyboardDismissBehavior', (WidgetTester tester) async {
    late BuildContext capturedContext;
    await tester.pumpWidget(
      MaterialApp(
