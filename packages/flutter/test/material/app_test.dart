...
void main() {
  ...
  testWidgets('Override theme animation using AnimationStyle', (WidgetTester tester) async {
    ...
    expect(tester.widget<Material>(find.byType(Material)).color, matchesColor(lightTheme.colorScheme.surface));
    ...
    expect(tester.widget<Material>(find.byType(Material)).color, matchesColor(const Color(0xffc3bdc5)));

    // Let the animation finish.
    await tester.pumpAndSettle();

    // Scaffold background color is fully updated to dark theme.
    expect(tester.widget<Material>(find.byType(Material)).color, matchesColor(darkTheme.colorScheme.surface));
    ...
    expect(tester.widget<Material>(find.byType(Material)).color, matchesColor(const Color(0xffe7e1e9)));
