...
void main() {
  ...
  testWidgets('ButtonStyle debugFillProperties', (WidgetTester tester) async {
    ...
    expect(description, <String>[
      ...
      'side: MaterialStateProperty.all(BorderSide(Color(0xfffffff6), 4.0, BorderStyle.solid, StrokeAlign.inside))',
      'shape: MaterialStateProperty.all(StadiumBorder(BorderSide(Color(0xff000000), 0.0, BorderStyle.none, StrokeAlign.inside)))',
