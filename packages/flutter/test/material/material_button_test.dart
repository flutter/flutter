      ...
      MaterialApp(
        home: Center(
          child: MaterialButton(
            focusNode: focusNode,
            onPressed: () {},
            child: const Container(width: 100, height: 100, color: Color(0xffff0000)),
          ),
        ),
      ),
    );
          ...
          home: Directionality(
            ...
            child: Center(
              child: MaterialButton(
                ...
                key: key,
                onPressed: () {},
                child: useText ? const Text('Text', key: childKey) : const Container(key: childKey, width: 100, height: 100, color: Color(0xffff0000)),
              ),
            ),
          ),
        ),
