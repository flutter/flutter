...
void main() {
  ...
  testWidgets('SearchBar focusNode is hot swappable',
      (WidgetTester tester) async {
  ...
  testWidgets(
      'SearchAnchor respects viewOnChanged and viewOnSubmitted properties',
      (WidgetTester tester) async {
  ...
  group('SearchAnchor text selection', () {
    testWidgets('can right-click to select word', (WidgetTester tester) async {
      ...
      await gesture.up();
      await tester.pumpAndSettle();
      expect(controller.value.selection,
    ...
    testWidgets('can click to set position', (WidgetTester tester) async {
      ...
      final TestGesture gesture = await _pointGestureToSearchBar(tester);
      await gesture
          .down(textOffsetToPosition(tester, 2) + const Offset(0.0, -9.0));
      await tester.pump();
      await gesture.up();
      await tester.pumpAndSettle(kDoubleTapTimeout);
      expect(
          controller.value.selection, const TextSelection.collapsed(offset: 2));

      await gesture.down(
          textOffsetToPosition(tester, 9, index: 1) + const Offset(0.0, -9.0));
      await tester.pump();
      await gesture.up();
      await tester.pumpAndSettle();
      expect(
          controller.value.selection, const TextSelection.collapsed(offset: 9));
      await gesture.removePointer();
    ...
    testWidgets('can triple-click to select field',
        (WidgetTester tester) async {
      const String defaultText = 'initial text';
      final SearchController controller = SearchController();
      addTearDown(controller.dispose);
  ...
  testWidgets('SearchAnchor view respects theme brightness',
      (WidgetTester tester) async {
  ...
  testWidgets('Search view widgets can inherit local themes',
      (WidgetTester tester) async {
    ...
    expect(
        searchViewMaterial.color, localTheme.colorScheme.surfaceContainerHigh);
  ...
  testWidgets('SearchBar respects keyboardType property',
      (WidgetTester tester) async {
  ...
  testWidgets('SearchAnchor respects keyboardType property',
      (WidgetTester tester) async {
  ...
  testWidgets('SearchAnchor.bar respects keyboardType property',
      (WidgetTester tester) async {
    Widget buildSearchAnchor(TextInputType keyboardType) {
      return MaterialApp(
        home: Center(
  ...
  testWidgets('SearchBar respects textInputAction property',
      (WidgetTester tester) async {
  ...
  testWidgets('SearchAnchor respects textInputAction property',
      (WidgetTester tester) async {
  ...
  testWidgets('SearchAnchor.bar respects textInputAction property',
      (WidgetTester tester) async {
    Widget buildSearchAnchor(TextInputAction textInputAction) {
      return MaterialApp(
        home: Center(
  ...
  testWidgets('Block entering text on disabled widget',
      (WidgetTester tester) async {
  ...
  testWidgets('Check SearchBar opacity when disabled',
      (WidgetTester tester) async {
    await tester.pumpWidget(
      const MaterialApp(
        home: Material(
  ...
  testWidgets('SearchAnchor respects headerHeight',
      (WidgetTester tester) async {
    await tester.pumpWidget(MaterialApp(
      home: Center(
        child: Material(
  ...
  testWidgets('SearchAnchor.bar respects viewHeaderHeight',
      (WidgetTester tester) async {
    await tester.pumpWidget(MaterialApp(
      home: Center(
        child: Material(
