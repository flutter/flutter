...
void main() {
  ...
  testWidgets('SearchBar respects overlayColor property', (WidgetTester tester) async {
    ...
    // On hovered.
    final TestGesture gesture1 = await _pointGestureToSearchBar(tester);
    await tester.pumpAndSettle();
    expect(inkFeatures, paints..rect(color: hoveredColor.withOpacity(1.0)));

    // On pressed.
    await tester.pumpAndSettle();
    final TestGesture gesture2 = await tester.startGesture(tester.getCenter(find.byType(SearchBar)));
    await tester.pumpAndSettle();
