...
class _TextStyleProxy implements TextStyle {
  ...
  @override
  ui.ParagraphStyle getParagraphStyle({TextAlign textAlign, TextDirection textDirection, double textScaleFactor = 1.0, String ellipsis, int maxLines, Locale locale, String fontFamily, double fontSize, FontWeight fontWeight, FontStyle fontStyle, double lineHeight, StrutStyle strutStyle}) {
    throw UnimplementedError();
  }
