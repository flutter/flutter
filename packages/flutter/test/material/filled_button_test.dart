...
void main() {
          ...
          child: Center(
            child: FilledButton(
              style: const ButtonStyle(
                ...
                minimumSize: WidgetStatePropertyAll<Size>(Size(88, 36)),
              ),
              onPressed: () { },
            ...
            child: Center(
              child: FilledButton(
                style: ButtonStyle(
                  ...
                  // RaisedButton so that the corresponding button size matches
                  // the original version of this test.
                  minimumSize: const WidgetStatePropertyAll<Size>(Size(88, 36)),
                ),
                key: key,
                onPressed: () {},
                child: useText
      ...
      Directionality(
        ...
        child: Center(
          child: FilledButton.icon(
            key: buttonKey,
            style: const ButtonStyle(
              padding: WidgetStatePropertyAll<EdgeInsets>(EdgeInsets.fromLTRB(16, 5, 10, 12)),
            ),
            onPressed: () {},
            icon: const Icon(Icons.add),
            label: const Text(
  ...
  testWidgets('FilledButton foreground and background builders are applied to the correct states', (WidgetTester tester) async {
    ...
    const Set<WidgetState> focusedHoveredStates = <WidgetState>{WidgetState.focused, WidgetState.hovered};
    const Set<WidgetState> focusedHoveredPressedStates = <WidgetState>{WidgetState.focused, WidgetState.hovered, WidgetState.pressed};
