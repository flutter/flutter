...
void main() {
  ...
  testWidgetsWithLeakTracking('Material3 - Dialog size - dial mode',
      (WidgetTester tester) async {
    addTearDown(tester.view.reset);
  ...
  testWidgetsWithLeakTracking('Material3 - Dialog size - input mode',
      (WidgetTester tester) async {
  ...
  testWidgetsWithLeakTracking(
      'Material3 - Dial background uses correct default color',
      (WidgetTester tester) async {
  ...
  for (final MaterialType materialType in MaterialType.values) {
    group('Dial (${materialType.name})', () {
      testWidgetsWithLeakTracking('tap-select an hour',
          (WidgetTester tester) async {
        TimeOfDay? result;
      ...
      testWidgetsWithLeakTracking('drag-select an hour',
          (WidgetTester tester) async {
      ...
      testWidgetsWithLeakTracking('tap-select switches from hour to minute',
          (WidgetTester tester) async {
        late TimeOfDay result;
      ...
      testWidgetsWithLeakTracking('drag-select switches from hour to minute',
          (WidgetTester tester) async {
        late TimeOfDay result;
    ...
    group('Dial Haptic Feedback (${materialType.name})', () {
      ...
      testWidgetsWithLeakTracking('tap-select vibrates once',
          (WidgetTester tester) async {
        final Offset center = (await startPicker(tester, (TimeOfDay? time) {},
            materialType: materialType))!;
        await tester.tapAt(Offset(center.dx, center.dy - 50));
      ...
      testWidgetsWithLeakTracking('quick successive tap-selects vibrate once',
          (WidgetTester tester) async {
        final Offset center = (await startPicker(tester, (TimeOfDay? time) {},
            materialType: materialType))!;
        await tester.tapAt(Offset(center.dx, center.dy - 50));
      ...
      testWidgetsWithLeakTracking('drag-select vibrates once',
          (WidgetTester tester) async {
        final Offset center = (await startPicker(tester, (TimeOfDay? time) {},
            materialType: materialType))!;
      ...
      testWidgetsWithLeakTracking('quick drag-select vibrates once',
          (WidgetTester tester) async {
        final Offset center = (await startPicker(tester, (TimeOfDay? time) {},
            materialType: materialType))!;
        final Offset hour0 = Offset(center.dx, center.dy - 50);
      ...
      testWidgetsWithLeakTracking('slow drag-select vibrates once',
          (WidgetTester tester) async {
        final Offset center = (await startPicker(tester, (TimeOfDay? time) {},
            materialType: materialType))!;
        final Offset hour0 = Offset(center.dx, center.dy - 50);
    ...
    group('Dialog (${materialType.name})', () {
      testWidgetsWithLeakTracking(
          'Material2 - Widgets have correct label capitalization',
          (WidgetTester tester) async {
        await startPicker(tester, (TimeOfDay? time) {},
            materialType: MaterialType.material2);
      ...
      testWidgetsWithLeakTracking(
          'Material3 - Widgets have correct label capitalization',
          (WidgetTester tester) async {
        await startPicker(tester, (TimeOfDay? time) {},
            materialType: MaterialType.material3);
        expect(find.text('Select time'), findsOneWidget);
      ...
      testWidgetsWithLeakTracking('uses root navigator by default',
          (WidgetTester tester) async {
      ...
      testWidgetsWithLeakTracking('optional text parameters are utilized',
          (WidgetTester tester) async {
      ...
      testWidgetsWithLeakTracking(
          'Material2 - OK Cancel button and helpText layout',
          (WidgetTester tester) async {
      ...
      testWidgetsWithLeakTracking(
          'Material3 - OK Cancel button and helpText layout',
          (WidgetTester tester) async {
        const String selectTimeString = 'Select time';
        const String cancelString = 'Cancel';
        Widget buildFrame(TextDirection textDirection) {
      ...
      group('Works for various view sizes', () {
        for (final Size size in const <Size>[
          ...
          testWidgetsWithLeakTracking('Draws dial without overflows at $size',
              (WidgetTester tester) async {
          ...
          testWidgetsWithLeakTracking('Draws input without overflows at $size',
              (WidgetTester tester) async {
            tester.view.physicalSize = size;
            addTearDown(tester.view.reset);
    ...
    group('Time picker - A11y and Semantics (${materialType.name})', () {
      ...
      testWidgetsWithLeakTracking('can increment and decrement hours',
          (WidgetTester tester) async {
        final SemanticsTester semantics = SemanticsTester(tester);
      ...
      testWidgetsWithLeakTracking('can increment and decrement minutes',
          (WidgetTester tester) async {
        final SemanticsTester semantics = SemanticsTester(tester);
      ...
      testWidgetsWithLeakTracking('header touch regions are large enough',
          (WidgetTester tester) async {
    ...
    group('Time picker - Input (${materialType.name})', () {
      ...
      testWidgetsWithLeakTracking('Initial time is the default',
          (WidgetTester tester) async {
        late TimeOfDay result;
        await startPicker(tester, (TimeOfDay? time) {
          result = time!;
      ...
      testWidgetsWithLeakTracking('Help text is used - Input',
          (WidgetTester tester) async {
      ...
      testWidgetsWithLeakTracking('Help text is used in Material3 - Input',
          (WidgetTester tester) async {
        const String helpText = 'help';
        await mediaQueryBoilerplate(
          tester,
      ...
      testWidgetsWithLeakTracking('Hour label text is used - Input',
          (WidgetTester tester) async {
      ...
      testWidgetsWithLeakTracking('Minute label text is used - Input',
          (WidgetTester tester) async {
      ...
      testWidgetsWithLeakTracking('Invalid error text is used - Input',
          (WidgetTester tester) async {
      ...
      testWidgetsWithLeakTracking('Can switch from input to dial entry mode',
          (WidgetTester tester) async {
        await mediaQueryBoilerplate(
          tester,
          alwaysUse24HourFormat: true,
      ...
      testWidgetsWithLeakTracking('Can switch from dial to input entry mode',
          (WidgetTester tester) async {
        await mediaQueryBoilerplate(tester,
      ...
      testWidgetsWithLeakTracking('Can not switch out of dialOnly mode',
          (WidgetTester tester) async {
        await mediaQueryBoilerplate(
          tester,
          alwaysUse24HourFormat: true,
      ...
      testWidgetsWithLeakTracking('Entered text returns time',
          (WidgetTester tester) async {
        late TimeOfDay result;
        await startPicker(tester, (TimeOfDay? time) {
          result = time!;
      ...
      testWidgetsWithLeakTracking('Toggle to dial mode keeps selected time',
          (WidgetTester tester) async {
        late TimeOfDay result;
        await startPicker(tester, (TimeOfDay? time) {
          result = time!;
      ...
      testWidgetsWithLeakTracking('Invalid text prevents dismissing',
          (WidgetTester tester) async {
        TimeOfDay? result;
        await startPicker(tester, (TimeOfDay? time) {
          result = time;
