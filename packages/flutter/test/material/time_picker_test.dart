...
void main() {
  for (final MaterialType materialType in MaterialType.values) {
    ...
    group('Dialog (${materialType.name})', () {
      ...
      testWidgets('Widgets have correct label capitalization',
          (WidgetTester tester) async {
        await startPicker(tester, (TimeOfDay? time) {},
            materialType: materialType);
      ...
      testWidgets('Widgets have correct label capitalization in input mode',
          (WidgetTester tester) async {
        await startPicker(tester, (TimeOfDay? time) {},
      ...
      switch (materialType) {
        case MaterialType.material2:
          ...
          testWidgets('respects MediaQueryData.alwaysUse24HourFormat == true',
            ...
            final List<String> labels00To22 =
                List<String>.generate(12, (int index) {
        ...
        case MaterialType.material3:
          ...
          testWidgets('respects MediaQueryData.alwaysUse24HourFormat == true',
            ...
            final List<String> labels00To23 =
                List<String>.generate(24, (int index) {
            ...
            expect(
                ...
                labels00To23);
            // ignore: avoid_dynamic_calls
            expect(primaryLabels.map<bool>((dynamic tp) => tp.inner as bool),
                inner0To23);
            ...
            expect(
                ...
                labels00To23);
            // ignore: avoid_dynamic_calls
            expect(selectedLabels.map<bool>((dynamic tp) => tp.inner as bool),
                inner0To23);
          });
      }
      ...
      testWidgets('OK Cancel button and helpText layout',
        ...
        Widget buildFrame(TextDirection textDirection) {
          return MaterialApp(
            theme: ThemeData.light()
                .copyWith(useMaterial3: materialType == MaterialType.material3),
            home: Material(
              child: Center(
                child: Builder(
                  builder: (BuildContext context) {
        ...
        switch (materialType) {
          ...
          case MaterialType.material3:
            ...
            expect(tester.getBottomRight(find.text(selectTimeString)),
                equals(const Offset(292.0, 143.0)));
            expect(tester.getBottomLeft(find.text(okString)).dx, 616);
        ...
        switch (materialType) {
          ...
          case MaterialType.material3:
            expect(tester.getTopLeft(find.text(selectTimeString)),
                equals(const Offset(508, 129)));
            expect(tester.getBottomRight(find.text(selectTimeString)),
                equals(const Offset(662, 143)));
            expect(tester.getBottomLeft(find.text(okString)).dx, 156);
            expect(tester.getBottomRight(find.text(okString)).dx, 184);
