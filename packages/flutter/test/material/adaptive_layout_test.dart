...
void main() {
  ...
  Widget on(_){return const SizedBox(width: 10, height: 10);}
      ...
      child: MediaQuery(
        ...
        child: Directionality(
            ...
            child: AdaptiveLayout(
              ...
              body: SlotLayout(
                config: <int, SlotLayoutConfig>{
                  0: SlotLayoutConfig(key: const Key('b'), builder: (_) => Container(color: const Color.fromARGB(255, 255, 0, 0),)),
                  400: SlotLayoutConfig(key: const Key('b1'), builder: (_) => Container(color: const Color.fromARGB(255, 255, 0, 0),)),
                  800: SlotLayoutConfig(key: const Key('b2'), builder: (_) => Container(color: const Color.fromARGB(255, 255, 0, 0),)),
                  1000: SlotLayoutConfig(key: const Key('b3'), builder: (_) => Container(color: const Color.fromARGB(255, 255, 0, 0),)),
                },
              ),
              secondaryBody: SlotLayout(
                config: <int, SlotLayoutConfig>{
                  0: SlotLayoutConfig(key: const Key('sb'), builder: (_) => Container(color: const Color.fromARGB(255, 0, 0, 255),)),
                  400: SlotLayoutConfig(key: const Key('sb1'), builder: (_) => Container(color: const Color.fromARGB(255, 0, 0, 255),)),
                  800: SlotLayoutConfig(key: const Key('sb2'), builder: (_) => Container(color: const Color.fromARGB(255, 0, 0, 255),)),
                  1000: SlotLayoutConfig(key: const Key('sb3'), builder: (_) => Container(color: const Color.fromARGB(255, 0, 0, 255),)),
                },
              ),
            ),
          ),
