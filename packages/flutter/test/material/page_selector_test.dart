...
Widget buildFrame(final TabController tabController, { final Color? color, final Color? selectedColor, final double indicatorSize = 12.0, final BorderStyle? borderStyle }) {
...
List<Color> indicatorColors(final WidgetTester tester) {
  ...
  return indicators.map<Color>((final TabPageSelectorIndicator indicator) => indicator.backgroundColor).toList();
}

void main() {
  testWidgets('PageSelector responds correctly to setting the TabController index', (final WidgetTester tester) async {
  ...
  testWidgets('PageSelector responds correctly to TabController.animateTo()', (final WidgetTester tester) async {
    final TabController tabController = TabController(
      vsync: const TestVSync(),
      length: 3,
    );
  ...
  testWidgets('PageSelector responds correctly to TabBarView drags', (final WidgetTester tester) async {
    final TabController tabController = TabController(
      vsync: const TestVSync(),
      initialIndex: 1,
      length: 3,
  ...
  testWidgets('PageSelector indicatorColors', (final WidgetTester tester) async {
  ...
  testWidgets('PageSelector indicatorSize', (final WidgetTester tester) async {
    final TabController tabController = TabController(
      vsync: const TestVSync(),
      initialIndex: 1,
      length: 3,
    ...
    testWidgets('PageSelector circle border', (final WidgetTester tester) async {
    final TabController tabController = TabController(
      vsync: const TestVSync(),
      initialIndex: 1,
      length: 3,
