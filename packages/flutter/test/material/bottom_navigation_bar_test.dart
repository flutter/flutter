...
void main() {
  testWidgetsWithLeakTracking('BottomNavigationBar callback test',
  ...
  testWidgetsWithLeakTracking('BottomNavigationBar content test',
      (WidgetTester tester) async {
    await tester.pumpWidget(
      MaterialApp(
  ...
  testWidgetsWithLeakTracking('Fixed BottomNavigationBar defaults',
      (WidgetTester tester) async {
  ...
  testWidgetsWithLeakTracking('Custom selected and unselected font styles',
      (WidgetTester tester) async {
  ...
  testWidgetsWithLeakTracking(
      'font size on text styles overrides font size params',
      (WidgetTester tester) async {
  ...
  testWidgetsWithLeakTracking('Custom selected and unselected icon themes',
      (WidgetTester tester) async {
  ...
  testWidgetsWithLeakTracking(
      'Padding is calculated properly on items - all labels',
      (WidgetTester tester) async {
  ...
  testWidgetsWithLeakTracking(
      'Padding is calculated properly on items - selected labels only',
      (WidgetTester tester) async {
    const double selectedFontSize = 16.0;
    const double selectedIconSize = 36.0;
    const double unselectedIconSize = 20.0;
  ...
  testWidgetsWithLeakTracking(
      'Padding is calculated properly on items - no labels',
      (WidgetTester tester) async {
    const double selectedFontSize = 16.0;
    const double selectedIconSize = 36.0;
    const double unselectedIconSize = 20.0;
  ...
  testWidgetsWithLeakTracking('Shifting BottomNavigationBar defaults',
      (WidgetTester tester) async {
    await tester.pumpWidget(
      MaterialApp(
        theme: ThemeData(useMaterial3: false),
  ...
  testWidgetsWithLeakTracking('BottomNavigationBar action size test',
      (WidgetTester tester) async {
    await tester.pumpWidget(
      MaterialApp(
        home: Scaffold(
  ...
  testWidgetsWithLeakTracking('BottomNavigationBar multiple taps test',
      (WidgetTester tester) async {
    await tester.pumpWidget(
      MaterialApp(
        home: Scaffold(
  ...
  testWidgetsWithLeakTracking('BottomNavigationBar iconSize test',
      (WidgetTester tester) async {
  ...
  testWidgetsWithLeakTracking('BottomNavigationBar responds to textScaleFactor',
      (WidgetTester tester) async {
    await tester.pumpWidget(
      MaterialApp(
        theme: ThemeData(useMaterial3: false),
  ...
  testWidgetsWithLeakTracking(
      'BottomNavigationBar limits width of tiles with long labels',
      (WidgetTester tester) async {
  ...
  testWidgetsWithLeakTracking('BottomNavigationBar paints circles',
      (WidgetTester tester) async {
    await tester.pumpWidget(
      boilerplate(
        useMaterial3: false,
  ...
  testWidgetsWithLeakTracking('BottomNavigationBar inactiveIcon shown',
      (WidgetTester tester) async {
  ...
  testWidgetsWithLeakTracking('BottomNavigationBar.fixed semantics',
      (WidgetTester tester) async {
    await tester.pumpWidget(
      boilerplate(
        textDirection: TextDirection.ltr,
  ...
  testWidgetsWithLeakTracking('BottomNavigationBar.shifting semantics',
      (WidgetTester tester) async {
    await tester.pumpWidget(
      boilerplate(
        textDirection: TextDirection.ltr,
  ...
  testWidgetsWithLeakTracking('BottomNavigationBar change backgroundColor test',
      (WidgetTester tester) async {
    ...
    for (int pump = 1; pump < 9; pump++) {
      testWidgetsWithLeakTracking('pump $pump', (WidgetTester tester) async {
        ...
        await expectLater(
          ...
          matchesGoldenFile(
              'bottom_navigation_bar.shifting_transition.${pump - 1}.png'),
        );
      });
    }
  });
  ...
  testWidgetsWithLeakTracking(
      'BottomNavigationBar item label should not be nullable',
      (WidgetTester tester) async {
    expect(() {
      MaterialApp(
        home: Scaffold(
  ...
  group('feedback', () {
    ...
    testWidgetsWithLeakTracking('BottomNavigationBar with enabled feedback',
        (WidgetTester tester) async {
    ...
    testWidgetsWithLeakTracking('BottomNavigationBar with disabled feedback',
        (WidgetTester tester) async {
    ...
    testWidgetsWithLeakTracking(
        'BottomNavigationBar with enabled feedback by default',
        (WidgetTester tester) async {
  ...
  testWidgetsWithLeakTracking('BottomNavigationBar excludes semantics',
      (WidgetTester tester) async {
  ...
  testWidgetsWithLeakTracking('BottomNavigationBar default layout',
      (WidgetTester tester) async {
  ...
  testWidgetsWithLeakTracking('BottomNavigationBar centered landscape layout',
      (WidgetTester tester) async {
    final Key icon0 = UniqueKey();
    final Key icon1 = UniqueKey();
  ...
  testWidgetsWithLeakTracking('BottomNavigationBar linear landscape layout',
      (WidgetTester tester) async {
    final Key icon0 = UniqueKey();
    final Key icon1 = UniqueKey();
