...
void main() {
  ...
  testWidgets('Default values are used when no FloatingActionButton or FloatingActionButtonThemeData properties are specified', (final WidgetTester tester) async {
  ...
  testWidgets('FloatingActionButtonThemeData values are used when no FloatingActionButton properties are specified', (final WidgetTester tester) async {
  ...
  testWidgets('FloatingActionButton values take priority over FloatingActionButtonThemeData values when both properties are specified', (final WidgetTester tester) async {
  ...
  testWidgets('FloatingActionButton uses a custom shape when specified in the theme', (final WidgetTester tester) async {
  ...
  testWidgets('FloatingActionButton.small uses custom constraints when specified in the theme', (final WidgetTester tester) async {
    const BoxConstraints constraints = BoxConstraints.tightFor(width: 100.0, height: 100.0);
  ...
  testWidgets('FloatingActionButton.large uses custom constraints when specified in the theme', (final WidgetTester tester) async {
    const BoxConstraints constraints = BoxConstraints.tightFor(width: 100.0, height: 100.0);
  ...
  testWidgets('FloatingActionButton.extended uses custom properties when specified in the theme', (final WidgetTester tester) async {
  ...
  testWidgets('FloatingActionButton.extended custom properties takes priority over FloatingActionButtonThemeData spacing', (final WidgetTester tester) async {
    const Key iconKey = Key('icon');
    const Key labelKey = Key('label');
    const double iconLabelSpacing = 33.0;
    const EdgeInsetsDirectional padding = EdgeInsetsDirectional.only(start: 5.0, end: 6.0);
  ...
  testWidgets('default FloatingActionButton debugFillProperties', (final WidgetTester tester) async {
  ...
  testWidgets('FloatingActionButton.mouseCursor uses FloatingActionButtonThemeData.mouseCursor when specified.', (final WidgetTester tester) async {
    await tester.pumpWidget(MaterialApp(
      theme: ThemeData().copyWith(
...
RawMaterialButton _getRawMaterialButton(final WidgetTester tester) {
...
RichText _getRichText(final WidgetTester tester) {
...
SizedBox _getIconSize(final WidgetTester tester) {
