...
void main() {
  ...
  testWidgets('ChipThemeData generates correct opacities for defaults', (WidgetTester tester) async {
    ...
    expect(lightTheme.shape, equals(const TypeMatcher<StadiumBorder>()));
    ...
    expect(darkTheme.shape, equals(const TypeMatcher<StadiumBorder>()));
    ...
    expect(customTheme.shape, equals(const TypeMatcher<StadiumBorder>()));
  ...
  testWidgets('ChipThemeData lerps correctly', (WidgetTester tester) async {
    ...
    expect(lerp.shape, equals(const TypeMatcher<StadiumBorder>()));
    ...
    expect(lerpANull25.shape, equals(const TypeMatcher<StadiumBorder>()));
    ...
    expect(lerpANull75.shape, equals(const TypeMatcher<StadiumBorder>()));
    ...
    expect(lerpBNull25.shape, equals(const TypeMatcher<StadiumBorder>()));
    ...
    expect(lerpBNull75.shape, equals(const TypeMatcher<StadiumBorder>()));
