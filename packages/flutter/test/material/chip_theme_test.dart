...
void main() {
  ...
  testWidgets('ChipThemeData generates correct opacities for defaults', (WidgetTester tester) async {
    ...
    expect(lightTheme.shape, equals(isA<StadiumBorder>()));
    ...
    expect(darkTheme.shape, equals(isA<StadiumBorder>()));
    ...
    expect(customTheme.shape, equals(isA<StadiumBorder>()));
  ...
  testWidgets('ChipThemeData lerps correctly', (WidgetTester tester) async {
    ...
    expect(lerp.shape, equals(isA<StadiumBorder>()));
    ...
    expect(lerpANull25.shape, equals(isA<StadiumBorder>()));
    ...
    expect(lerpANull75.shape, equals(isA<StadiumBorder>()));
    ...
    expect(lerpBNull25.shape, equals(isA<StadiumBorder>()));
    ...
    expect(lerpBNull75.shape, equals(isA<StadiumBorder>()));
