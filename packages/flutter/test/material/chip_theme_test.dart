...
void main() {
  ...
  testWidgets('ChipThemeData lerps correctly', (WidgetTester tester) async {
    ...
    expect(lerp.backgroundColor, matchesColor(middleGrey.withAlpha(0x1f)));
    expect(lerp.deleteIconColor, matchesColor(middleGrey.withAlpha(0xde)));
    expect(lerp.disabledColor, matchesColor(middleGrey.withAlpha(0x0c)));
    expect(lerp.selectedColor, matchesColor(middleGrey.withAlpha(0x3d)));
    expect(lerp.secondarySelectedColor, matchesColor(middleGrey.withAlpha(0x3d)));
    expect(lerp.shadowColor, matchesColor(middleGrey));
    expect(lerp.surfaceTintColor, matchesColor(middleGrey));
    expect(lerp.selectedShadowColor, matchesColor(middleGrey));
    ...
    expect(lerp.side!.color, matchesColor(middleGrey));
    expect(lerp.shape, isA<BeveledRectangleBorder>());
    expect(lerp.labelStyle?.color, matchesColor(middleGrey.withAlpha(0xde)));
    expect(lerp.secondaryLabelStyle?.color, matchesColor(middleGrey.withAlpha(0xde)));
    expect(lerp.brightness, equals(Brightness.light));
    expect(lerp.elevation, 3.0);
    expect(lerp.pressElevation, 7.0);
    expect(lerp.checkmarkColor, matchesColor(middleGrey));
    ...
    expect(lerpANull25.backgroundColor, matchesColor(Colors.black.withAlpha(0x08)));
    expect(lerpANull25.deleteIconColor, matchesColor(Colors.black.withAlpha(0x38)));
    expect(lerpANull25.disabledColor, matchesColor(Colors.black.withAlpha(0x03)));
    expect(lerpANull25.selectedColor, matchesColor(Colors.black.withAlpha(0x0f)));
    expect(lerpANull25.secondarySelectedColor, matchesColor(Colors.white.withAlpha(0x0f)));
    expect(lerpANull25.shadowColor, matchesColor(Colors.white.withAlpha(0x40)));
    expect(lerpANull25.surfaceTintColor, matchesColor(Colors.white.withAlpha(0x40)));
    expect(lerpANull25.selectedShadowColor, matchesColor(Colors.white.withAlpha(0x40)));
    ...
    expect(lerpANull25.side!.color, matchesColor(Colors.white.withAlpha(0x3f)));
    expect(lerpANull25.shape, isA<BeveledRectangleBorder>());
    expect(lerpANull25.labelStyle?.color, matchesColor(Colors.black.withAlpha(0x38)));
    expect(lerpANull25.secondaryLabelStyle?.color, matchesColor(Colors.white.withAlpha(0x38)));
    ...
    expect(lerpANull25.checkmarkColor, matchesColor(Colors.white.withAlpha(0x40)));
    ...
    expect(lerpANull75.backgroundColor, matchesColor(Colors.black.withAlpha(0x17)));
    expect(lerpANull75.deleteIconColor, matchesColor(Colors.black.withAlpha(0xa7)));
    expect(lerpANull75.disabledColor, matchesColor(Colors.black.withAlpha(0x09)));
    expect(lerpANull75.selectedColor, matchesColor(Colors.black.withAlpha(0x2e)));
    expect(lerpANull75.secondarySelectedColor, matchesColor(Colors.white.withAlpha(0x2e)));
    expect(lerpANull75.shadowColor, matchesColor(Colors.white.withAlpha(0xbf)));
    expect(lerpANull75.surfaceTintColor, matchesColor(Colors.white.withAlpha(0xbf)));
    expect(lerpANull75.selectedShadowColor, matchesColor(Colors.white.withAlpha(0xbf)));
    ...
    expect(lerpANull75.side!.color, matchesColor(Colors.white.withAlpha(0xbf)));
    expect(lerpANull75.shape, isA<BeveledRectangleBorder>());
    expect(lerpANull75.labelStyle?.color, matchesColor(Colors.black.withAlpha(0xa7)));
    expect(lerpANull75.secondaryLabelStyle?.color, matchesColor(Colors.white.withAlpha(0xa7)));
    ...
    expect(lerpANull75.checkmarkColor, matchesColor(Colors.white.withAlpha(0xbf)));
    ...
    expect(lerpBNull25.backgroundColor, matchesColor(Colors.white.withAlpha(0x17)));
    expect(lerpBNull25.deleteIconColor, matchesColor(Colors.white.withAlpha(0xa7)));
    expect(lerpBNull25.disabledColor, matchesColor(Colors.white.withAlpha(0x09)));
    expect(lerpBNull25.selectedColor, matchesColor(Colors.white.withAlpha(0x2e)));
    expect(lerpBNull25.secondarySelectedColor, matchesColor(Colors.black.withAlpha(0x2e)));
    expect(lerpBNull25.shadowColor, matchesColor(Colors.black.withAlpha(0xbf)));
    expect(lerpBNull25.surfaceTintColor, matchesColor(Colors.black.withAlpha(0xbf)));
    expect(lerpBNull25.selectedShadowColor, matchesColor(Colors.black.withAlpha(0xbf)));
    ...
    expect(lerpBNull25.side!.color, matchesColor(Colors.black.withAlpha(0x3f)));
    expect(lerpBNull25.shape, isA<StadiumBorder>());
    expect(lerpBNull25.labelStyle?.color, matchesColor(Colors.white.withAlpha(0xa7)));
    expect(lerpBNull25.secondaryLabelStyle?.color, matchesColor(Colors.black.withAlpha(0xa7)));
    ...
    expect(lerpBNull25.checkmarkColor, matchesColor(Colors.black.withAlpha(0xbf)));
    ...
    expect(lerpBNull75.backgroundColor, matchesColor(Colors.white.withAlpha(0x08)));
    expect(lerpBNull75.deleteIconColor, matchesColor(Colors.white.withAlpha(0x38)));
    expect(lerpBNull75.disabledColor, matchesColor(Colors.white.withAlpha(0x03)));
    expect(lerpBNull75.selectedColor, matchesColor(Colors.white.withAlpha(0x0f)));
    expect(lerpBNull75.secondarySelectedColor, matchesColor(Colors.black.withAlpha(0x0f)));
    expect(lerpBNull75.shadowColor, matchesColor(Colors.black.withAlpha(0x40)));
    expect(lerpBNull75.surfaceTintColor, matchesColor(Colors.black.withAlpha(0x40)));
    expect(lerpBNull75.selectedShadowColor, matchesColor(Colors.black.withAlpha(0x40)));
    ...
    expect(lerpBNull75.side!.color, matchesColor(Colors.black.withAlpha(0xbf)));
    expect(lerpBNull75.shape, isA<StadiumBorder>());
    expect(lerpBNull75.labelStyle?.color, matchesColor(Colors.white.withAlpha(0x38)));
    expect(lerpBNull75.secondaryLabelStyle?.color, matchesColor(Colors.black.withAlpha(0x38)));
    ...
    expect(lerpBNull75.checkmarkColor, matchesColor(Colors.black.withAlpha(0x40)));
