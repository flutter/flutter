...
void main() {
  ...
  testWidgets('ChipTheme.fromDefaults', (WidgetTester tester) async {
    ...
    expect(
        chipTheme.secondarySelectedColor, equals(Colors.red.withAlpha(0x3d)));
    ...
    expect(chipTheme.secondarySelectedColor,
        equals(Colors.tealAccent[200]!.withAlpha(0x3d)));
  ...
  testWidgets('ChipThemeData generates correct opacities for defaults',
    ...
    final TextStyle customStyle =
        ThemeData.fallback().textTheme.bodyText1!.copyWith(color: customColor2);
  ...
  testWidgets('Chip uses stateful border side from resolveWith pattern',
      (WidgetTester tester) async {
  ...
  testWidgets('Chip uses stateful border side from chip theme',
      (WidgetTester tester) async {
    const Color selectedColor = Color(0x00000001);
    const Color defaultColor = Color(0x00000002);
  ...
  testWidgets('Chip uses stateful shape from chip theme',
      (WidgetTester tester) async {
