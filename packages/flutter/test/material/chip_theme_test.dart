...
void main() {
  ...
  testWidgetsWithLeakTracking('Material3 - Chip uses ThemeData chip theme',
      (WidgetTester tester) async {
  ...
  testWidgetsWithLeakTracking('Material2 - Chip uses ThemeData chip theme',
      (WidgetTester tester) async {
    const ChipThemeData chipTheme = ChipThemeData(
      backgroundColor: Color(0xff112233),
      elevation: 4,
  ...
  testWidgetsWithLeakTracking('Material3 - Chip uses local ChipTheme',
      (WidgetTester tester) async {
    const ChipThemeData chipTheme = ChipThemeData(
      backgroundColor: Color(0xff112233),
      elevation: 4,
    ...
    final ThemeData theme =
        ThemeData(chipTheme: const ChipThemeData(), useMaterial3: true);
  ...
  testWidgetsWithLeakTracking('Material2 - Chip uses local ChipTheme',
      (WidgetTester tester) async {
    const ChipThemeData chipTheme = ChipThemeData(
      backgroundColor: Color(0xff112233),
      elevation: 4,
  ...
  testWidgetsWithLeakTracking('Chip properties overrides ChipTheme',
      (WidgetTester tester) async {
    const ChipThemeData chipTheme = ChipThemeData(
      backgroundColor: Color(0xff112233),
      elevation: 4,
  ...
  testWidgetsWithLeakTracking('Material3 - Chip uses constructor parameters',
      (WidgetTester tester) async {
  ...
  testWidgetsWithLeakTracking('Material2 - Chip uses constructor parameters',
      (WidgetTester tester) async {
    const Color backgroundColor = Color(0xff332211);
    const double elevation = 3;
    const double fontSize = 32;
  ...
  testWidgetsWithLeakTracking(
    ...
    Widget buildChip({IconThemeData? iconTheme}) {
      return MaterialApp(
        theme: ThemeData(
            useMaterial3: true, chipTheme: ChipThemeData(iconTheme: iconTheme)),
        home: Directionality(
          textDirection: TextDirection.ltr,
          child: Material(
            child: Center(
