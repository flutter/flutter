...
void main() {
  ...
  testWidgets('Disabled field hides helper and counter in M2',
      (WidgetTester tester) async {
  ...
  testWidgets('onTapOutside is called upon tap outside',
      (WidgetTester tester) async {
  ...
  testWidgets(
      'onTapOutside is not called upon tap outside when field is not focused',
      (WidgetTester tester) async {
    int tapOutsideCount = 0;
    await tester.pumpWidget(
      MaterialApp(
  ...
  testWidgets('TextFormField respects hintTextDirection',
      (WidgetTester tester) async {
  ...
  testWidgets('Passes scrollController to underlying TextField',
      (WidgetTester tester) async {
  ...
  testWidgets('TextFormField changes mouse cursor when hovered',
      (WidgetTester tester) async {
    await tester.pumpWidget(
      MaterialApp(
        home: Material(
  ...
  testWidgets('magnifierConfiguration passes through to EditableText',
      (WidgetTester tester) async {
  ...
  testWidgets('Passes undoController to undoController TextField',
      (WidgetTester tester) async {
  ...
  testWidgets('Passes clipBehavior to clipBehavior TextField',
      (WidgetTester tester) async {
  ...
  testWidgets('Passes scribbleEnabled to scribbleEnabled TextField',
      (WidgetTester tester) async {
  ...
  testWidgets('Passes canRequestFocus to canRequestFocus TextField',
      (WidgetTester tester) async {
  ...
  testWidgets('Error color for cursor while validating',
      (WidgetTester tester) async {
