...
void main() {
  ...
  testWidgets('A Focused text-field will lose focus when clicking outside of its hitbox', (WidgetTester tester) async {
    ...
    final TestGesture down2 = await tester.startGesture(tester.getCenter(find.byType(TextField).first), kind: PointerDeviceKind.mouse);
    await tester.pump();
    await tester.pumpAndSettle();
    await down2.up();
