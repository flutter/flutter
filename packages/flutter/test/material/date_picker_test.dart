...
void main() {
  ...
  testWidgets('Invocation assertions', (WidgetTester tester) async {
    initialDate = new DateTime(2017, DateTime.JANUARY, 9);
    firstDate = new DateTime(2017, DateTime.JANUARY, 10);
    lastDate = new DateTime(2017, DateTime.JANUARY, 20);
    expect(preparePicker(tester, (Future<DateTime> date) async { await date; }), throws);
    // try {
    //   await preparePicker(tester, (Future<DateTime> date) async { await date; });
    // } catch (_) { print('hi'); }
    // try {
    //   await preparePicker(tester, (Future<DateTime> date) {});
    //   fail('Expected exception');
    // } on AssertionError catch (_) { }

    // initialDate = new DateTime(2017, DateTime.JANUARY, 21);
    // firstDate = new DateTime(2017, DateTime.JANUARY, 10);
    // lastDate = new DateTime(2017, DateTime.JANUARY, 20);
    // try {
    //   await preparePicker(tester, (Future<DateTime> date) {});
    ...
    // } on AssertionError catch (_) { }
    //
    // initialDate = new DateTime(2017, DateTime.JANUARY, 10);
    // firstDate = new DateTime(2017, DateTime.JANUARY, 10);
    // lastDate = new DateTime(2017, DateTime.JANUARY, 8);
    // try {
    //   await preparePicker(tester, (Future<DateTime> date) {});
    //   fail('Expected exception');
    // } on AssertionError catch (_) { }
