...
import 'dart:ui' show window, SemanticsFlag, DisplayFeature, DisplayFeatureType, DisplayFeatureState;
...
void main() {
  ...
  testWidgets('PopupMenu positioning around display features', (WidgetTester tester) async {
    ...
    // Since the display feature splits the display into 2 "virtual screens",
    // Popup menu should be positioned to fit in the first virtual screen,
    // where the originating button is.
