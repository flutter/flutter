...
void main() {
  ...
  testWidgets('Open/close animations', (WidgetTester tester) async {
    ...
    ); // 16.0 material gap, plus 16.0 top and bottom margins added to the header
    ...
    expect(
      ...
      Rect.fromLTWH(
        0.0,
        rect1.bottom + 16.0 + 56.0,
        800.0,
        0.0,
      ),
    ); // the 16.0 comes from the MaterialGap being introduced, the 56.0 is the header height.
