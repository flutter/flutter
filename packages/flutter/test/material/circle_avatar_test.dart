...
void main() {
  ...
  testWidgetsWithLeakTracking('Material3 - CircleAvatar default colors',
      (WidgetTester tester) async {
  ...
  group('Material 2', () {
    ...
    testWidgetsWithLeakTracking(
        'Material2 - CircleAvatar default colors with light theme',
        (WidgetTester tester) async {
    ...
    testWidgetsWithLeakTracking(
        'Material2 - CircleAvatar default colors with dark theme',
        (WidgetTester tester) async {
      final ThemeData theme =
