...
void main() {
  ...
  testWidgets(
    'Min minThumbSeparation has same width as surrounding box, values still bounded (ltr)',
  ...
  testWidgets(
    'Min minThumbSeparation has same width as surrounding box, values still bounded (rtl)',
    (WidgetTester tester) async {
      const boundingBoxSize = 200.0;
      var values = const RangeValues(0.0, 1.0);
