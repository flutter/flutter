...
void main() {
  ...
  testWidgets('ExpansionTile initial state', (final WidgetTester tester) async {
    ...
    double getHeight(final Key key) => tester.getSize(find.byKey(key)).height;
    Container getContainer(final Key key) => tester.firstWidget(find.descendant(
      of: find.byKey(key),
  ...
  testWidgets('ExpansionTile Theme dependencies', (final WidgetTester tester) async {
  ...
  testWidgets('ExpansionTile subtitle', (final WidgetTester tester) async {
    await tester.pumpWidget(
      const MaterialApp(
        home: Scaffold(
          body: ExpansionTile(
  ...
  testWidgets('ExpansionTile maintainState', (final WidgetTester tester) async {
    await tester.pumpWidget(
      MaterialApp(
        theme: ThemeData(
  ...
  testWidgets('ExpansionTile padding test', (final WidgetTester tester) async {
  ...
  testWidgets('ExpansionTile expandedAlignment test', (final WidgetTester tester) async {
    await tester.pumpWidget(const MaterialApp(
      home: Material(
        child: Center(
          child: ExpansionTile(
  ...
  testWidgets('ExpansionTile expandedCrossAxisAlignment test', (final WidgetTester tester) async {
  ...
  testWidgets('CrossAxisAlignment.baseline is not allowed', (final WidgetTester tester) async {
    expect(
      () {
        MaterialApp(
          home: Material(
      ...
      throwsA(isA<AssertionError>().having((final AssertionError error) => error.toString(), '.toString()', contains(
  ...
  testWidgets('expandedCrossAxisAlignment and expandedAlignment default values', (final WidgetTester tester) async {
    const Key child1Key = Key('child1');
  ...
  testWidgets('childrenPadding default value', (final WidgetTester tester) async {
    await tester.pumpWidget(
      const MaterialApp(
        home: Material(
          child: Center(
  ...
  testWidgets('ExpansionTile childrenPadding test', (final WidgetTester tester) async {
    await tester.pumpWidget(
      const MaterialApp(
        home: Material(
          child: Center(
  ...
  testWidgets('ExpansionTile.collapsedBackgroundColor', (final WidgetTester tester) async {
  ...
  testWidgets('ExpansionTile default iconColor, textColor', (final WidgetTester tester) async {
  ...
  testWidgets('ExpansionTile iconColor, textColor', (final WidgetTester tester) async {
  ...
  testWidgets('ExpansionTile Border', (final WidgetTester tester) async {
  ...
  testWidgets('ExpansionTile platform controlAffinity test', (final WidgetTester tester) async {
    await tester.pumpWidget(const MaterialApp(
      home: Material(
        child: ExpansionTile(
          title: Text('Title'),
  ...
  testWidgets('ExpansionTile trailing controlAffinity test', (final WidgetTester tester) async {
    await tester.pumpWidget(const MaterialApp(
      home: Material(
        child: ExpansionTile(
          title: Text('Title'),
  ...
  testWidgets('ExpansionTile leading controlAffinity test', (final WidgetTester tester) async {
    await tester.pumpWidget(const MaterialApp(
      home: Material(
        child: ExpansionTile(
          title: Text('Title'),
  ...
  testWidgets('ExpansionTile override rotating icon test', (final WidgetTester tester) async {
    await tester.pumpWidget(const MaterialApp(
      home: Material(
        child: ExpansionTile(
          title: Text('Title'),
  ...
  testWidgets('Nested ListTile Semantics', (final WidgetTester tester) async {
  ...
  testWidgets('ExpansionTile Semantics announcement', (final WidgetTester tester) async {
    final SemanticsHandle handle = tester.ensureSemantics();
  ...
  testWidgets('Semantics with the onTapHint is an ancestor of ListTile', (final WidgetTester tester) async {
  ...
  testWidgets('Semantics hint for iOS and macOS', (final WidgetTester tester) async {
    final SemanticsHandle handle = tester.ensureSemantics();
    const DefaultMaterialLocalizations localizations = DefaultMaterialLocalizations();
  ...
  testWidgets('ExpansionTileController isExpanded, expand() and collapse()', (final WidgetTester tester) async {
  ...
  testWidgets('Calling ExpansionTileController.expand/collapsed has no effect if it is already expanded/collapsed', (final WidgetTester tester) async {
    final ExpansionTileController controller = ExpansionTileController();
  ...
  testWidgets('Call to ExpansionTileController.of()', (final WidgetTester tester) async {
  ...
  testWidgets('Call to ExpansionTile.maybeOf()', (final WidgetTester tester) async {
    final GlobalKey titleKey = GlobalKey();
