...
void main() {
  ...
  testWidgets('ExpansionTile initial state', (WidgetTester tester) async {
    ...
    expect((collapsingContainerDecoration.shape as Border).top.color, matchesColor(const Color(0x15222222)));
    expect((collapsingContainerDecoration.shape as Border).bottom.color, matchesColor(const Color(0x15222222)));
