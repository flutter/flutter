...
void main() {
  ...
  const Color _secondaryColor = Colors.blueAccent;
  ...
  testWidgets('ListTileTheme', (WidgetTester tester) async {
    ...
    expect(textColor(expandedTitleKey), _secondaryColor);
    expect(textColor(collapsedTitleKey), _headerColor);
    expect(iconColor(expandedIconKey), _secondaryColor);
    ...
    expect(textColor(collapsedTitleKey), _secondaryColor);
    expect(iconColor(expandedIconKey), _unselectedWidgetColor);
    expect(iconColor(collapsedIconKey), _secondaryColor);
  }, variant: const TargetPlatformVariant(<TargetPlatform>{ TargetPlatform.iOS,  TargetPlatform.macOS }));
