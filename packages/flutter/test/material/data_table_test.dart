...
void main() {
  ...
  testWidgets('DataRow renders checkbox with colors from CheckboxTheme', (WidgetTester tester) async {
    ...
    final ThemeData themeData = ThemeData(
      checkboxTheme: const CheckboxThemeData(
        fillColor: WidgetStatePropertyAll<Color?>(fillColor),
        checkColor: WidgetStatePropertyAll<Color?>(checkColor),
      ),
    );
    Widget buildTable() {
      return MaterialApp(
  ...
  testWidgets('Heading cell cursor resolves WidgetStateMouseCursor correctly', (WidgetTester tester) async {
    await tester.pumpWidget(
      MaterialApp(
        home: Scaffold(
          body: DataTable(
  ...
  testWidgets('DataRow cursor resolves WidgetStateMouseCursor correctly', (WidgetTester tester) async {
    await tester.pumpWidget(
      MaterialApp(
        home: Scaffold(
          body: DataTable(
        ...
        home: Scaffold(
          body: DataTable(
            ...
            rows: <DataRow>[
              DataRow(
                onSelectChanged: (bool? selected) {},
                mouseCursor: const WidgetStatePropertyAll<MouseCursor>(SystemMouseCursors.copy),
                cells: const <DataCell>[
                  DataCell(Text('Data')),
                  DataCell(Text('Data 2')),
                ],
