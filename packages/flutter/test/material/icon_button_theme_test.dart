...
void main() {
  ...
  testWidgets('IconButtonTheme.select only rebuilds when the selected property changes', (
    WidgetTester tester,
  ) async {
    int buildCount = 0;
    ...
    final ButtonStyle style1 = IconButton.styleFrom(backgroundColor: Colors.red);
    final ButtonStyle style2 = IconButton.styleFrom(backgroundColor: Colors.blue);

    final Widget singletonThemeSubtree = Builder(
      builder: (BuildContext context) {
        buildCount++;
        // Select the style property.
        style = IconButtonTheme.select(context, (IconButtonThemeData theme) => theme.style);
    ...
    await tester.pumpWidget(
      MaterialApp(
        home: IconButtonTheme(
          data: IconButtonThemeData(style: style1),
    ...
    await tester.pumpWidget(
      MaterialApp(
        home: IconButtonTheme(
          data: IconButtonThemeData(style: style1), // Same style object
          child: singletonThemeSubtree,
        ),
      ),
    );
    ...
    await tester.pumpWidget(
      MaterialApp(
        home: IconButtonTheme(
          data: IconButtonThemeData(style: style2), // Different style object
          child: singletonThemeSubtree,
        ),
      ),
    );
