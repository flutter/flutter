...
void main() {
  group('CircularNotchComputer', () {
    test('host and guest must intersect', () {
      const CircularNotchComputer notchComputer = const CircularNotchComputer();
      ...
      expect(() {notchComputer.compute(host, guest, start, end);}, throwsFlutterError);
    });
    ...
    test('notch no margin', () {
      const CircularNotchComputer notchComputer = const CircularNotchComputer(notchMargin: 0.0);
      final Rect host = new Rect.fromLTRB(0.0, 100.0, 300.0, 300.0);
      final Rect guest = new Rect.fromLTRB(190.0, 90.0, 210.0, 110.0);
      const Offset start = const Offset(180.0, 100.0);
      const Offset end = const Offset(220.0, 100.0);

      final Path actualNotch = notchComputer.compute(host, guest, start, end);
    ...
    test('notch with margin', () {
      const CircularNotchComputer notchComputer = const CircularNotchComputer(notchMargin: 4.0);
      final Rect host = new Rect.fromLTRB(0.0, 100.0, 300.0, 300.0);
      final Rect guest = new Rect.fromLTRB(190.0, 90.0, 210.0, 110.0);
      const Offset start = const Offset(180.0, 100.0);
      const Offset end = const Offset(220.0, 100.0);
