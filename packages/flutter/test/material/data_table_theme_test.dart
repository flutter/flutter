...
void main() {
  ...
  testWidgets('DataTableThemeData implements debugFillProperties',
    ...
    expect(
        description[3], 'dataTextStyle: TextStyle(inherit: true, size: 12.0)');
  ...
  testWidgets('DataTable properties are taken over the theme values',
    ...
    final MaterialStateProperty<Color> themeDataRowColor =
        MaterialStateProperty.all<Color>(const Color(0xfffffff0));
    const double themeDataRowHeight = 50.0;
    const TextStyle themeDataTextStyle = TextStyle(fontSize: 11.5);
    final MaterialStateProperty<Color> themeHeadingRowColor =
        MaterialStateProperty.all<Color>(const Color(0xfffffff1));
