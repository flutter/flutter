...
void main() {
  ...
  testWidgets('Local DataTableTheme can override global DataTableTheme', (WidgetTester tester) async {
    ...
    expect(
        _tableRowBoxDecoration(tester: tester, index: 0).color, localThemeHeadingRowColor.resolve(<MaterialState>{}));
    ...
    expect(
        tester.getTopLeft(find.text('Data 2')).dx - tester.getTopRight(find.text('Data')).dx, localThemeColumnSpacing);
  });
}
