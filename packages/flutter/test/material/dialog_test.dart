...
void main() {
  ...
  testWidgetsWithLeakTracking('Material2 - Dialog Defaults',
      (WidgetTester tester) async {
    const AlertDialog dialog = AlertDialog(
      title: Text('Title'),
      content: Text('Y'),
  ...
  testWidgetsWithLeakTracking('Material3 - Dialog Defaults',
      (WidgetTester tester) async {
    const AlertDialog dialog = AlertDialog(
      title: Text('Title'),
      content: Text('Y'),
  ...
  testWidgetsWithLeakTracking('Material2 - Dialog.fullscreen Defaults',
      (WidgetTester tester) async {
  ...
  testWidgetsWithLeakTracking('Material3 - Dialog.fullscreen Defaults',
      (WidgetTester tester) async {
  ...
  testWidgetsWithLeakTracking('Material2 - AlertDialog.buttonPadding defaults',
      (WidgetTester tester) async {
  ...
  testWidgetsWithLeakTracking('Material3 - AlertDialog.buttonPadding defaults',
      (WidgetTester tester) async {
    final GlobalKey key1 = GlobalKey();
    final GlobalKey key2 = GlobalKey();
