  ...
  testWidgets('CheckBox color rendering', (WidgetTester tester) async {
    ...
    expect(
        ...
        paints
          ...
          ..path(color: checkColor)); // paints's color is 0xFFFFFFFF (default color)
    ...
    await tester.pumpWidget(
      buildFrame(themeData: themeData),
    );
    await tester.pumpAndSettle();
  ...
  testWidgets('Checkbox can be hovered and has correct hover color', (WidgetTester tester) async {
    ...
    expect(
      ...
      paints
        ..path(color: const Color(0xff2196f3))
        ..path(
            color: material3 ? theme.colorScheme.onPrimary : const Color(0xffffffff),
    ...
    expect(
      ...
      paints
        ...
        ..path(
            color: material3 ? theme.colorScheme.surface : const Color(0xffffffff),
            style: PaintingStyle.stroke,
            strokeWidth: 2.0),
    );
  });
  ...
  testWidgets('Checkbox default overlay color in active/pressed/focused/hovered states', (WidgetTester tester) async {
    ...
    expect(
      ...
      material3
          ...
          : (paints
            ..circle(
              color: colors.secondary.withAlpha(kRadialReactionAlpha),
            )),
