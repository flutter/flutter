...
void main() {
  ...
  testWidgets('Material2 - Checkbox color rendering',
      (WidgetTester tester) async {
  ...
  testWidgets('Material3 - Checkbox color rendering',
      (WidgetTester tester) async {
  ...
  testWidgets('Material3 - Checkbox has correct default shape',
      (WidgetTester tester) async {
    final ThemeData themeData = ThemeData(useMaterial3: true);
  ...
  testWidgets('Checkbox.adaptive shows the correct platform widget',
      (WidgetTester tester) async {
