...
void main() {
  ...
  testWidgets('Material3 - Checkbox visual density cannot be overriden by ThemeData.visualDensity', (WidgetTester tester) async {
  ...
  testWidgets('Material3 - Checkbox with MaterialTapTargetSize.padded meets Material Guidelines on desktop', (WidgetTester tester) async {
    const Key key = Key('test');
    Widget buldCheckbox() {
      return MaterialApp(
        theme: theme,
