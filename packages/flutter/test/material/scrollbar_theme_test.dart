...
void main() {
  ...
  testWidgets('ScrollbarTheme can disable gestures',
      (WidgetTester tester) async {
    final ScrollController scrollController = ScrollController();
    await tester.pumpWidget(MaterialApp(
      theme: ThemeData(
        ...
        MaterialApp(
          theme: ThemeData().copyWith(
            scrollbarTheme: _scrollbarTheme(
              trackVisibility:
                  MaterialStateProperty.resolveWith(_getTrackVisibility),
            ),
          ),
          home: ScrollConfiguration(
            behavior: const NoScrollbarBehavior(),
  ...
  testWidgets('Default ScrollbarTheme debugFillProperties',
      (WidgetTester tester) async {
  ...
  testWidgets('ScrollbarTheme implements debugFillProperties',
      (WidgetTester tester) async {
    final DiagnosticPropertiesBuilder builder = DiagnosticPropertiesBuilder();
    ScrollbarThemeData(
...
Color? _getThumbColor(Set<MaterialState> states) {
  if (states.contains(MaterialState.dragged)) return Colors.red;
