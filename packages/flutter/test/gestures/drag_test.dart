...
void main() {
  ...
  group('Recognizers listening on different buttons do not form competition:', () {
    ...
    testGesture('A primary pan recognizer does not form competition with a secondary tap recognizer',
  ...
  testGesture('Should recognize pan gestures from platform', (GestureTester tester) {
    ...
    tester.route(pointer.panZoomUpdate(const Offset(10.0, 10.0),
        pan: const Offset(20.0, 20.0))); // moved 20 horizontally and 20 vertically which is 28 total
    expect(didStartPan, isFalse); // 28 < 36
    tester.route(pointer.panZoomUpdate(const Offset(10.0, 10.0),
        pan: const Offset(30.0, 30.0))); // moved 30 horizontally and 30 vertically which is 42 total
