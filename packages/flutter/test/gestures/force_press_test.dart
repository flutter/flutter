...
void main() {
  ...
  testGesture('A force press can be recognized', (GestureTester tester) {
    ...
    tester.route(const PointerMoveEvent(
        ...
        pressureMax: pressureMax));
    tester.route(const PointerMoveEvent(
        pointer: pointerValue, position: Offset(10.0, 10.0), pressureMin: pressureMin, pressureMax: pressureMax));
  ...
  testWidgets('ForecePressGestureRecognizer asserts when kind and supportedDevices are both set',
