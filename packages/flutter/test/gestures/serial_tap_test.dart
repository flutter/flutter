...
void main() {
  ...
  setUp(() {
    ...
    serial = SerialTapGestureRecognizer()
      ..onSerialTapDown = (final SerialTapDownDetails details) {
        events.add('down#${details.count}');
      }
      ..onSerialTapCancel = (final SerialTapCancelDetails details) {
        events.add('cancel#${details.count}');
      }
      ..onSerialTapUp = (final SerialTapUpDetails details) {
  ...
  testGesture('Recognizes serial taps', (final GestureTester tester) {
  ...
  testGesture('Wins over tap gesture below it in the tree', (final GestureTester tester) {
  ...
  testGesture('Wins over tap gesture above it in the tree', (final GestureTester tester) {
    bool recognizedSingleTap = false;
    bool canceledSingleTap = false;
    final TapGestureRecognizer singleTap = TapGestureRecognizer()
      ..onTap = () {
  ...
  testGesture('Loses to release gesture below it in the tree', (final GestureTester tester) {
  ...
  testGesture('Wins over release gesture above it in the tree', (final GestureTester tester) {
    bool recognizedRelease = false;
    final ReleaseGestureRecognizer release = ReleaseGestureRecognizer()
      ..onRelease = () {
        recognizedRelease = true;
  ...
  testGesture('Fires cancel if competing recognizer declares victory', (final GestureTester tester) {
  ...
  testGesture('Wins over double-tap recognizer below it in the tree', (final GestureTester tester) {
  ...
  testGesture('Wins over double-tap recognizer above it in the tree', (final GestureTester tester) {
    bool recognizedDoubleTap = false;
    final DoubleTapGestureRecognizer doubleTap = DoubleTapGestureRecognizer()
      ..onDoubleTap = () {
        recognizedDoubleTap = true;
  ...
  testGesture('Fires cancel and resets when pointer dragged past slop tolerance', (final GestureTester tester) {
  ...
  testGesture('Serial taps with different buttons will start a new tap sequence', (final GestureTester tester) {
    serial.addPointer(down1);
    tester.closeArena(1);
    tester.route(down1);
    tester.route(up1);
  ...
  testGesture('Interleaving taps cancel first sequence and start second sequence', (final GestureTester tester) {
    serial.addPointer(down1);
    tester.closeArena(1);
    tester.route(down1);
  ...
  testGesture('Is no-op if no callbacks are specified', (final GestureTester tester) {
    serial = SerialTapGestureRecognizer();
    serial.addPointer(down1);
    tester.closeArena(1);
    tester.route(down1);
  ...
  testGesture('Works for non-primary button', (final GestureTester tester) {
    serial.addPointer(down6);
    tester.closeArena(6);
    tester.route(down6);
    tester.route(up6);
