...
void main() {
  ...
  testWidgets('Velocity tracker gives expected results',
  ...
  testWidgets(
      'Assume zero velocity when there are no recent samples - base VelocityTracker',
      (WidgetTester tester) async {
    final VelocityTracker tracker =
        VelocityTracker.withKind(PointerDeviceKind.touch);
    Offset position = Offset.zero;
  ...
  testWidgets('Assume zero velocity when there are no recent samples - MacOS',
      (WidgetTester tester) async {
    final MacOSScrollViewFlingVelocityTracker tracker =
