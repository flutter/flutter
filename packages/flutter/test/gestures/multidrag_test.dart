...
void main() {
  ...
  test('allowedButtonsFilter should work the same when null or not specified',
    ...
    final ImmediateMultiDragGestureRecognizer recognizer1 =
        ImmediateMultiDragGestureRecognizer();
    // ignore: avoid_redundant_argument_values
    final ImmediateMultiDragGestureRecognizer recognizer2 =
        ImmediateMultiDragGestureRecognizer(allowedButtonsFilter: null);

    // We want to test _allowedButtonsFilter, which is called in this method.
    const PointerDownEvent allowedPointer =
    ...
    const PointerDownEvent rejectedPointer = PointerDownEvent(
        timeStamp: Duration(days: 10), buttons: kMiddleMouseButton);
    // ignore: invalid_use_of_protected_member
