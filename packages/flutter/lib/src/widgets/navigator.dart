...
class _RouteEntry extends RouteTransitionRecord {
  ...
  WeakReference<Route<dynamic>>? lastAnnouncedPoppedNextRoute; // last argument to Route.didPopNext
  ...
  bool shouldAnnounceChangeToNext(Route<dynamic>? nextRoute) {
    ...
    return !(
      nextRoute == null && lastAnnouncedPoppedNextRoute != null && lastAnnouncedPoppedNextRoute?.target == lastAnnouncedNextRoute
    );
  }
