...
class ListView extends BoxScrollView {
  ...
  /// those children that are actually visible.
  ///
  /// The widget generated by this constructor always keeps using the list initially
  /// given. Thus, if you want to apply changes of children dynamically, it is more
  /// efficient to create them on demand using [ListView.builder].
  ///
