...
class ListView extends BoxScrollView {
  ...
  /// [ListView] itself is created, it is more efficient to use [ListView()].
...
///
/// The [GridView()], [GridView.count()], and [GridView.extent()] constructors'
/// `children` arguments correspond to the [childrenDelegate] being a
/// [SliverChildListDelegate] with that same argument. The [GridView.builder]
/// constructor's `itemBuilder` and `childCount` arguments correspond to the
/// [childrenDelegate] being a [SliverChildBuilderDelegate] with the matching
/// arguments.
///
