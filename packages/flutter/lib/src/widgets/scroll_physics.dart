...
abstract class ScrollPhysics {
  ...
  ///
  /// Called by [ScrollIndependentPosition.applyBoundaryConditions], which is
  /// called by [ScrollIndependentPosition.setPixels] just before the
  /// [ScrollPosition.pixels] value is updated, to determine how much of the
  /// offset is to be clamped off and sent to
  /// [ScrollIndependentPosition.reportOverscroll].
  ///
