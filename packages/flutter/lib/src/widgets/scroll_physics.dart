...
class ScrollPhysics {
  ...
  bool recommendDeferredLoading(double velocity, ScrollMetrics metrics, BuildContext context) {
    ...
    assert(context != null);
    if (parent == null) {
      final double maxPhysicalPixels = WidgetsBinding.instance.view.physicalSize.longestSide;
  ...
  static final Tolerance _kDefaultTolerance = Tolerance(
    ...
    velocity: 1.0 / (0.050 * WidgetsBinding.instance.view.devicePixelRatio), // logical pixels per second
    distance: 1.0 / WidgetsBinding.instance.view.devicePixelRatio, // logical pixels
  );
