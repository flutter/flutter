...
class Matrix4Tween extends Tween<Matrix4> {
  ...
  static final Vector3 _beginTranslation = Vector3.zero();
  static final Vector3 _endTranslation = Vector3.zero();
  static final Quaternion _beginRotation = Quaternion.identity();
  static final Quaternion _endRotation = Quaternion.identity();
  static final Vector3 _beginScale = Vector3.zero();
  static final Vector3 _endScale = Vector3.zero();
