...
class DefaultSelectionStyle extends InheritedTheme {
  ...
  /// The [ui.BoxHeightStyle] to use for selection highlights.
  ///
  /// If non-null, [Text] and [RichText] widgets in this subtree will use this
  /// style when computing the bounding boxes for selection highlights.
  ///
  /// Defaults to null, meaning the default [ui.BoxHeightStyle.tight] will be
  /// used by [RenderParagraph].
  final ui.BoxHeightStyle? selectionHeightStyle;

  /// The [ui.BoxWidthStyle] to use for selection highlights.
  ///
  /// If non-null, [Text] and [RichText] widgets in this subtree will use this
  /// style when computing the bounding boxes for selection highlights.
  ///
  /// Defaults to null, meaning the default [ui.BoxWidthStyle.tight] will be
  /// used by [RenderParagraph].
