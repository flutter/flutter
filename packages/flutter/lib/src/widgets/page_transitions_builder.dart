...
class _ZoomPageTransition extends StatelessWidget {
  ...
  @override
  Widget build(BuildContext context) {
    final Color enterTransitionBackgroundColor = backgroundColor;
...
class FadeForwardsPageTransitionsBuilder extends PageTransitionsBuilder {
  ...
  static Widget _delegatedTransition(
    ...
    return ColoredBox(
      color: secondaryAnimation.isAnimating ? backgroundColor : const Color(0x00000000),
      child: builder,
    );
  }
...
class _ZoomEnterTransitionNoCache extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return AnimatedBuilder(
      animation: animation,
      builder: (BuildContext context, Widget? child) {
        return ColoredBox(color: const Color(0xFF000000).withOpacity(opacity), child: child);
      },
      child: FadeTransition(
