...
class Image extends StatefulWidget {
  ...
  Image.network(
    ...
    NetworkImageHeaderResolutionCallback? headerResolver,
    int? cacheWidth,
    int? cacheHeight,
  }) : image = ResizeImage.resizeIfNeeded(cacheWidth, cacheHeight, NetworkImage(src, scale: scale, headers: headers, headerResolver: headerResolver)),
       assert(alignment != null),
       assert(repeat != null),
       assert(matchTextDirection != null),
