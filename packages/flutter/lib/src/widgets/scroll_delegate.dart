...
abstract class SliverChildDelegate {
  ...
  /// Applies [RepaintBoundary], [IndexedSemantics], [AutomaticKeepAlive], and
  /// a [KeyedSubtree] based on the configuration of the delegate properties.
  Widget wrapChildForIndex(Widget child, int index) {
...
class SliverChildBuilderDelegate extends SliverChildDelegate {
  ...
  Widget? build(BuildContext context, int index) {
    ...
    return wrapChildForIndex(child, index);
  }
...
class SliverChildListDelegate extends SliverChildDelegate {
  ...
  Widget? build(BuildContext context, int index) {
    ...
    return wrapChildForIndex(children[index], index);
  }
