...
@optionalTypeArgs
mixin RawToggleableStateMixin<S extends StatefulWidget> on TickerProviderStateMixin<S> {
  ...
  Widget buildRawToggleable({
    ...
    return FocusableActionDetector(
      ...
      child: GestureDetector(
        ...
        onTapUp: isInteractive ? handleTapEnd : null,
        onTapCancel: isInteractive ? handleTapEnd : null,
        child: Semantics(
          enabled: isInteractive,
          child: CustomPaint(
            size: size,
...
/// the Toggleable.
abstract class RawToggleablePainter extends ChangeNotifier implements CustomPainter {
