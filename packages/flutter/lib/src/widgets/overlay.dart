...
/// [markNeedsBuild] on the overlay entry to cause it to rebuild. If its build,
...
/// overlay created by the [NavigatorState] in a [WidgetsApp] or a [MaterialApp]. The
...
class Overlay extends StatefulWidget {
  ...
  /// created by the [NavigatorState] in a [WidgetsApp] or a [MaterialApp] for the application.
  const Overlay({
    Key key,
...
class OverlayState extends State<Overlay> with TickerProviderStateMixin {
  ...
  void insert(OverlayEntry entry, { OverlayEntry below, OverlayEntry above }) {
    _assertEntriesInsertedPosition(above, below);
  ...
  void _assertEntriesInsertedPosition(OverlayEntry above, OverlayEntry below,
    ...
    if (newEntries == null) {
      ...
      assert(
        above == null || (above._overlay == this && _entries.contains(above) && newEntries.contains(above)),
        'The entry used for `above` must be in the Overlay and in the `newEntriesList`.'
      );
      assert(
        below == null || (below._overlay == this && _entries.contains(below) && newEntries.contains(below)),
  ...
  void rearrange(Iterable<OverlayEntry> newEntries, { OverlayEntry below, OverlayEntry above }) {
    ...
    _assertEntriesInsertedPosition(above, below, newEntries: newEntriesList);
    assert(
