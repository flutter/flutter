...
class DefaultTextEditingShortcuts extends StatelessWidget {
  ...
  static final Map<ShortcutActivator, Intent> _macShortcuts = <ShortcutActivator, Intent>{
    ...
    const SingleActivator(LogicalKeyboardKey.arrowUp, shift: true, alt: true): const ExtendSelectionVerticallyToAdjacentParagraphIntent(forward: false, collapseSelection: false),
    const SingleActivator(LogicalKeyboardKey.arrowDown, shift: true, alt: true): const ExtendSelectionVerticallyToAdjacentParagraphIntent(forward: true, collapseSelection: false),
...
Intent? intentForMacOSSelector(String selectorName) {
  const Map<String, Intent> selectorToIntent = <String, Intent>{
    ...
    'moveParagraphBackwardAndModifySelection:': ExtendSelectionVerticallyToAdjacentParagraphIntent(forward: false, collapseSelection: false),
    'moveParagraphForwardAndModifySelection:': ExtendSelectionVerticallyToAdjacentParagraphIntent(forward: true, collapseSelection: false),
