...
class DefaultTextEditingShortcuts extends Shortcuts {
  ...
  static final Map<ShortcutActivator, Intent> _webShortcuts = <ShortcutActivator, Intent>{
    const SingleActivator(LogicalKeyboardKey.backspace): DoNothingAndStopPropagationIntent(),
    const SingleActivator(LogicalKeyboardKey.delete): DoNothingAndStopPropagationIntent(),
    const SingleActivator(LogicalKeyboardKey.backspace, alt: true): DoNothingAndStopPropagationIntent(),
    const SingleActivator(LogicalKeyboardKey.delete, alt: true): DoNothingAndStopPropagationIntent(),
    const SingleActivator(LogicalKeyboardKey.backspace, control: true): DoNothingAndStopPropagationIntent(),
    const SingleActivator(LogicalKeyboardKey.delete, control: true): DoNothingAndStopPropagationIntent(),
    const SingleActivator(LogicalKeyboardKey.backspace, meta: true): DoNothingAndStopPropagationIntent(),
    const SingleActivator(LogicalKeyboardKey.delete, meta: true): DoNothingAndStopPropagationIntent(),
    const SingleActivator(LogicalKeyboardKey.arrowDown, alt: true): DoNothingAndStopPropagationIntent(),
    const SingleActivator(LogicalKeyboardKey.arrowLeft, alt: true): DoNothingAndStopPropagationIntent(),
    const SingleActivator(LogicalKeyboardKey.arrowRight, alt: true): DoNothingAndStopPropagationIntent(),
    const SingleActivator(LogicalKeyboardKey.arrowUp, alt: true): DoNothingAndStopPropagationIntent(),
    const SingleActivator(LogicalKeyboardKey.arrowDown, shift: true, alt: true): DoNothingAndStopPropagationIntent(),
    const SingleActivator(LogicalKeyboardKey.arrowLeft, shift: true, alt: true): DoNothingAndStopPropagationIntent(),
    const SingleActivator(LogicalKeyboardKey.arrowRight, shift: true, alt: true): DoNothingAndStopPropagationIntent(),
    const SingleActivator(LogicalKeyboardKey.arrowUp, shift: true, alt: true): DoNothingAndStopPropagationIntent(),
    ...
    const SingleActivator(LogicalKeyboardKey.arrowLeft, control: true): DoNothingAndStopPropagationIntent(),
    const SingleActivator(LogicalKeyboardKey.arrowRight, control: true): DoNothingAndStopPropagationIntent(),
    const SingleActivator(LogicalKeyboardKey.arrowLeft, shift: true, control: true): DoNothingAndStopPropagationIntent(),
    const SingleActivator(LogicalKeyboardKey.arrowRight, shift: true, control: true): DoNothingAndStopPropagationIntent(),
    const SingleActivator(LogicalKeyboardKey.end): DoNothingAndStopPropagationIntent(),
    const SingleActivator(LogicalKeyboardKey.home): DoNothingAndStopPropagationIntent(),
    const SingleActivator(LogicalKeyboardKey.arrowDown, meta: true): DoNothingAndStopPropagationIntent(),
    const SingleActivator(LogicalKeyboardKey.arrowLeft, meta: true): DoNothingAndStopPropagationIntent(),
    const SingleActivator(LogicalKeyboardKey.arrowRight, meta: true): DoNothingAndStopPropagationIntent(),
    const SingleActivator(LogicalKeyboardKey.arrowUp, meta: true): DoNothingAndStopPropagationIntent(),
    const SingleActivator(LogicalKeyboardKey.arrowDown, shift: true, meta: true): DoNothingAndStopPropagationIntent(),
    const SingleActivator(LogicalKeyboardKey.arrowLeft, shift: true, meta: true): DoNothingAndStopPropagationIntent(),
    const SingleActivator(LogicalKeyboardKey.arrowRight, shift: true, meta: true): DoNothingAndStopPropagationIntent(),
    const SingleActivator(LogicalKeyboardKey.arrowUp, shift: true, meta: true): DoNothingAndStopPropagationIntent(),
    const SingleActivator(LogicalKeyboardKey.arrowDown, shift: true): DoNothingAndStopPropagationIntent(),
    const SingleActivator(LogicalKeyboardKey.arrowLeft, shift: true): DoNothingAndStopPropagationIntent(),
    const SingleActivator(LogicalKeyboardKey.arrowRight, shift: true): DoNothingAndStopPropagationIntent(),
    const SingleActivator(LogicalKeyboardKey.arrowUp, shift: true): DoNothingAndStopPropagationIntent(),
    const SingleActivator(LogicalKeyboardKey.end, shift: true): DoNothingAndStopPropagationIntent(),
    const SingleActivator(LogicalKeyboardKey.home, shift: true): DoNothingAndStopPropagationIntent(),
    const SingleActivator(LogicalKeyboardKey.space): DoNothingAndStopPropagationIntent(),
    const SingleActivator(LogicalKeyboardKey.keyX, control: true): DoNothingAndStopPropagationIntent(),
    const SingleActivator(LogicalKeyboardKey.keyX, meta: true): DoNothingAndStopPropagationIntent(),
    const SingleActivator(LogicalKeyboardKey.keyC, control: true): DoNothingAndStopPropagationIntent(),
    const SingleActivator(LogicalKeyboardKey.keyC, meta: true): DoNothingAndStopPropagationIntent(),
    const SingleActivator(LogicalKeyboardKey.keyV, control: true): DoNothingAndStopPropagationIntent(),
    const SingleActivator(LogicalKeyboardKey.keyV, meta: true): DoNothingAndStopPropagationIntent(),
    const SingleActivator(LogicalKeyboardKey.keyA, control: true): DoNothingAndStopPropagationIntent(),
    const SingleActivator(LogicalKeyboardKey.keyA, meta: true): DoNothingAndStopPropagationIntent(),
  };
