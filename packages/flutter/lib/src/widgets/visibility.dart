...
class IndexedStack extends StatelessWidget {
  ...
  ///
  /// See the [Clip] enum for details of all possible options and their common
  /// use cases.
  ///
  ...
  Widget build(BuildContext context) {
    ...
    // [ExcludeFocus] (so non-selected children can't receive focus). Both of
    // these wrappers are inherited widgets and do not introduce any
    // [RenderObject]s between the child and the enclosing [RenderIndexedStack].
    // This allows [ParentDataWidget]s such as [Positioned] to correctly apply
    // their [StackParentData] to the indexed stack's render object.
