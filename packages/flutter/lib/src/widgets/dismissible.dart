...
class TriggerDismissDetails {
  ...
  /// The amount of drag in logical pixels.
  final double dragExtent;

  /// Whether the gesture is considered a fling.
  final bool isFling;

  /// The absolute fling velocity in logical pixels per second.
