...
mixin WidgetInspectorService {
  ...
  List<Object>  _getProperties(String? diagnosticsOrDiagnosticableId, String groupName) {
    final DiagnosticsNode? node = idToDiagnosticsNode(diagnosticsOrDiagnosticableId);
    if (node == null) {
      return const <Object>[];
    }
  ...
  @visibleForTesting
  DiagnosticsNode? idToDiagnosticsNode(String? diagnosticsOrDiagnosticableId) {
  ...
  Map<String, Object?>? _getDetailsSubtree(
    ...
    final DiagnosticsNode? root = idToDiagnosticsNode(diagnosticsOrDiagnosticableId);
    if (root == null) {
      return null;
    }
    return _nodeToJson(
