...
mixin WidgetInspectorService {
  ...
  @visibleForTesting
  @protected
  List<String>? get pubRootDirectories =>
      _pubRootDirectories == null ? const <String>[] : List<String>.from(_pubRootDirectories!);
...
bool debugIsWidgetLocalCreation(Widget widget) {
  ...
  return location != null && WidgetInspectorService.instance._isLocalCreationLocation(location.file);
}
