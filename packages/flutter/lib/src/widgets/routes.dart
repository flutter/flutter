...
abstract class TransitionRoute<T> extends OverlayRoute<T> {
  ...
  String get debugLabel => '${objectRuntimeType(this, 'OverlayRoute')}';

  @override
  String toString() => '${objectRuntimeType(this, 'OverlayRoute')}(animation: $_controller)';
}
...
abstract class ModalRoute<T> extends TransitionRoute<T> with LocalHistoryRoute<T> {
  ...
  @override
  String toString() => '${objectRuntimeType(this, 'LocalHistoryEntry')}($settings, animation: $_animation)';
}
