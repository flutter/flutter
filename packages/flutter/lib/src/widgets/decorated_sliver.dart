...
///
/// Clipping behaviour is dictated by parent widget, which is often a
/// scrollable view such as [CustomScrollView]
/// where [clipBehavior] is set [Clip.hardEdge] by default.
/// This can result in features
/// like shadows, which render outside the widget's boundaries,
/// appear clipped. To prevent this,
/// consider setting [clipBehavior] to [Clip.none] to ensure
/// they render correctly outside the widgets's bounds. To clip a child to the shape of a
