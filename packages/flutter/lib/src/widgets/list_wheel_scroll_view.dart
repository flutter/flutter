...
class ListWheelChildListDelegate extends ListWheelChildDelegate {
  ...
  Widget build(BuildContext context, int index) {
    if (index < 0 || index >= children.length)
      return null;
    return new IndexedChildSemantics(child: children[index], index: index);
  }
...
class ListWheelChildLoopingListDelegate extends ListWheelChildDelegate {
  ...
  Widget build(BuildContext context, int index) {
    if (children.isEmpty)
      return null;
    return new IndexedChildSemantics(child: children[index % children.length], index: index);
  }
...
class ListWheelChildBuilderDelegate extends ListWheelChildDelegate {
  ...
  Widget build(BuildContext context, int index) {
    if (childCount == null)
      return new IndexedChildSemantics(child: builder(context, index), index: index);
