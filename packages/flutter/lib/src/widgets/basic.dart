...
/// A platonic (simple) widget that provides a specific [BuildContext] object to its child
/// widget.
///
...
///          onPressed: () {
///            // This will fail because the context is from our build method
///            // and not the RaisedButton
...
/// show the [SnackBar]. Since the context variable here is the context of our
/// build method and not the [RaisedButton] itself, a call to Scaffold.of(context)
/// will look for an ancestor in the wrong place.
///
/// To resolve this problem, we use the [Builder] to properly access the
/// [ScaffoldState] and get a context that is a child of the [Scaffold].
///
...
///       child: Builder(
///         builder: (BuildContext context) {
///           // We now have a context that belongs to the child[ren] returned
///           // from the Builder.
///           return RaisedButton(
///             child: Text('Show a SnackBar'),
///             onPressed: () {
///               // We are now able to properly access the ScaffoldState context
