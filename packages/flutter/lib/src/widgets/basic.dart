...
///
///   * (0.2 * width of [Container], 0.6 * height of [container]) = (8.0, 24.0)
...
///
/// The [Align] widget positions the [Container] such that the two points are on
/// top of each other. In this example, the top left of the [Container] will
