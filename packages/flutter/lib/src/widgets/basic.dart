...
/// Describes the navigation mode to be set by a [NavigationModality] widget
///
...
class NavigationModality extends InheritedWidget {
  ...
  /// encloses the given context is [NavigationMode.directional].
  ///
  /// If there is no [NavigationModality] ancestor widget in the tree at the given
  /// context, then this will return false.
  ///
  /// Typical usage is as follows:
  ///
  /// ```dart
  ...
  /// The navigation mode from the closest instance of this class that encloses
  /// the given context.
  ///
  /// If there is no [NavigationModality] ancestor widget in the tree at the given
  /// context, then this will return [NavigationMode.traditional].
  ///
  /// Typical usage is as follows:
  ///
  /// ```dart
  /// NavigationMode navigationMode = NavigationModality.of(context);
  /// ```
  static NavigationMode of(BuildContext context) {
    final NavigationModality widget = context.dependOnInheritedWidgetOfExactType<NavigationModality>();
    return widget?.navigationMode ?? NavigationMode.traditional;
  }

  @override
  bool updateShouldNotify(NavigationModality oldWidget) => navigationMode != oldWidget.navigationMode;

  @override
  void debugFillProperties(DiagnosticPropertiesBuilder properties) {
    super.debugFillProperties(properties);
    properties.add(EnumProperty<NavigationMode>('navigationMode', navigationMode));
  }
}
