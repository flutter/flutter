...
class FractionalOffset extends Alignment {
  ...
  static FractionalOffset? lerp(FractionalOffset? a, FractionalOffset? b, double t) {
    ...
    if (a == null) return FractionalOffset(ui.lerpDouble(0.5, b!.dx, t)!, ui.lerpDouble(0.5, b.dy, t)!);
    if (b == null) return FractionalOffset(ui.lerpDouble(a.dx, 0.5, t)!, ui.lerpDouble(a.dy, 0.5, t)!);
