...
class InlineSpanSemanticsInformation {
  ...
  const InlineSpanSemanticsInformation(
    ...
    this.recognizer,
          ...
          || (text == Unicode.objReplacementCharString && semanticsLabel == null && recognizer == null)),
       requiresOwnNode = isPlaceholder || recognizer != null;

  /// The text info for a [PlaceholderSpan].
  static const InlineSpanSemanticsInformation placeholder =
      InlineSpanSemanticsInformation(Unicode.objReplacementCharString, isPlaceholder: true);
...
abstract class InlineSpan extends DiagnosticableTree {
  ...
  /// represented as an 'object replacement character' (Unicode.objReplacementChar).
