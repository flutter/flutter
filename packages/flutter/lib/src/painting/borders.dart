...
/// Utilities for manipulating [RRect]s used by border implementations.
///
/// This mixin provides helpers to inflate or deflate an [RRect] by asymmetric
/// [EdgeInsets] while proportionally adjusting each corner's radii along the x/y
/// axes to preserve visual appearance.
///
/// ## Use case
/// When painting or computing layout for borders with non-uniform insets,
/// callers can expand or shrink an [RRect] and update its corner radii in one
/// step.
///
...
///
/// See also:
///  * [BoxBorder], which can use these utilities when painting box borders.
///  * [TableBorder], which can use these utilities when painting table cells.
///  * [RRect], the rounded rectangle data structure.
abstract final class RRectUtils {
  ...
  /// radius by the corresponding per-axis inset amounts (clamped at zero).ㄴ
