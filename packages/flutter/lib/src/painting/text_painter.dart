...
class TextPainter {
  ...
  bool get _debugAssertLayoutValid {
    if (_paragraph == null) {
      throw FlutterError.fromParts(<DiagnosticsNode>[
        ErrorSummary('Text layout not available'),
        if (_debugMarkNeedsLayoutCallStack != null) DiagnosticsStackTrace('The calls that first invalidated the text layout was', _debugMarkNeedsLayoutCallStack)
  ...
  Offset get _emptyOffset {
    assert(_debugAssertLayoutValid); // implies textDirection is non-null
    assert(textAlign != null);
    switch (textAlign) {
      case TextAlign.left:
        return Offset.zero;
