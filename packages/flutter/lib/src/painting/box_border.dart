...
class BorderDirectional extends BoxBorder {
  ...
  void paint(
    ...
    assert(_strokeAlignIsUniform && top.strokeAlign == BorderSide.strokeAlignInside,
        'A Border can only draw strokeAlign different than strokeAlignInside on uniform borders.');
