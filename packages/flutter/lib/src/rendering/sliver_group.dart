  ...
  void performLayout() {
    ...
    while (child != null) {
      ...
      final double paintCorrection =
          childLayoutGeometry.paintExtent > remainingExtent ? childLayoutGeometry.paintExtent - remainingExtent : 0.0;
...
bool _assertOutOfExtent(double extent) {
  if (extent <= 0.0) {
    throw FlutterError.fromParts(<DiagnosticsNode>[
      ...
      ErrorDescription('SliverCrossAxisGroup lays out any slivers with a constrained cross '
      ...
      ErrorHint('Make sure that the total amount of extent allocated by constrained '
