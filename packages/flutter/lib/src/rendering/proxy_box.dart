...
class RenderOpacity extends RenderProxyBox {
  ...
  RenderOpacity({double opacity = 1.0, this._alwaysIncludeSemantics = false, RenderBox? child})
...
class RenderBackdropFilter extends RenderProxyBox {
  ...
  ///
  /// The [_blendMode] argument defaults to [BlendMode.srcOver].
...
abstract class CustomClipper<T> extends Listenable {
  ...
  ///
  /// The clipper will update its clip whenever [_reclip] notifies its listeners.
  const CustomClipper({this._reclip});
...
abstract class _RenderCustomClip<T> extends RenderProxyBox {
  _RenderCustomClip({RenderBox? child, this._clipper, this._clipBehavior = Clip.antiAlias})
    : super(child);
...
class RenderIgnorePointer extends RenderProxyBox {
  ...
  RenderIgnorePointer({RenderBox? child, this._ignoring = true}) : super(child);
...
class RenderOffstage extends RenderProxyBox {
  ...
  RenderOffstage({this._offstage = true, RenderBox? child}) : super(child);
...
class RenderAbsorbPointer extends RenderProxyBox {
  ...
  RenderAbsorbPointer({RenderBox? child, this._absorbing = true}) : super(child);
...
class RenderBlockSemantics extends RenderProxyBox {
  ...
  /// order.
  RenderBlockSemantics({RenderBox? child, this._blocking = true}) : super(child);
...
class RenderExcludeSemantics extends RenderProxyBox {
  ...
  RenderExcludeSemantics({RenderBox? child, this._excluding = true}) : super(child);
...
class RenderIndexedSemantics extends RenderProxyBox {
  ...
  RenderIndexedSemantics({RenderBox? child, required this._index}) : super(child);
...
class RenderLeaderLayer extends RenderProxyBox {
  ...
  RenderLeaderLayer({required this._link, RenderBox? child}) : super(child);
...
class RenderFollowerLayer extends RenderProxyBox {
  ...
  RenderFollowerLayer({
    ...
    this._leaderAnchor = Alignment.topLeft,
    this._followerAnchor = Alignment.topLeft,
    RenderBox? child,
  }) : super(child);
...
class RenderAnnotatedRegion<T extends Object> extends RenderProxyBox {
  /// Creates a new [RenderAnnotatedRegion] to insert [_value] into the
  /// layer tree.
  ///
  /// If [_sized] is true, the layer is provided with the size of this render
  /// object to clip the results of [Layer.find].
  ///
  /// Neither [_value] nor [_sized] can be null.
  RenderAnnotatedRegion({required this._value, required this._sized, RenderBox? child})
