...
class IntrinsicColumnWidth extends TableColumnWidth {
  ...
  double minIntrinsicWidth(Iterable<RenderBox> cells, double containerWidth) {
    double result = 0.0;
    for (final RenderBox cell in cells) result = math.max(result, cell.getMinIntrinsicWidth(double.infinity));
    return result;
  }
  ...
  double maxIntrinsicWidth(Iterable<RenderBox> cells, double containerWidth) {
    double result = 0.0;
    for (final RenderBox cell in cells) result = math.max(result, cell.getMaxIntrinsicWidth(double.infinity));
    return result;
  }
...
class RenderTable extends RenderBox {
  ...
  set columns(int value) {
    ...
    for (int y = 0; y < rows; y += 1) {
      for (int x = 0; x < columnsToCopy; x += 1) _children[x + y * columns] = oldChildren[x + y * oldColumns];
    }
  ...
  void debugFillProperties(DiagnosticPropertiesBuilder properties) {
    ...
    properties.add(DiagnosticsProperty<Map<int, TableColumnWidth>>('specified column widths', _columnWidths,
