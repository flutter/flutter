...
class RenderSliverGrid extends RenderSliverMultiBoxAdaptor {
  ...
  void setupParentData(RenderObject child) {
    if (child.parentData is! SliverGridParentData) child.parentData = SliverGridParentData();
  }
  ...
  set gridDelegate(SliverGridDelegate value) {
    ...
    if (value.runtimeType != _gridDelegate.runtimeType || value.shouldRelayout(_gridDelegate)) markNeedsLayout();
    _gridDelegate = value;
  }
  ...
  void performLayout() {
    ...
    final int? targetLastIndex =
        targetEndScrollOffset.isFinite ? layout.getMaxChildIndexForScrollOffset(targetEndScrollOffset) : null;
