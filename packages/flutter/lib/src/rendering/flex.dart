...
class RenderFlex extends RenderBox with ContainerRenderObjectMixin<RenderBox, FlexParentData>,
  ...
  void performLayout() {
    ...
    final double spaceToFill = maxMainSize == double.infinity ? minMainSize : maxMainSize;
    ...
    if (totalFlex > 0 || crossAxisAlignment == CrossAxisAlignment.baseline) {
      final double spacePerFlex = totalFlex > 0 ? (freeSpace / totalFlex) : double.nan;
      child = firstChild;
      ...
      while (child != null) {
        final int flex = _getFlex(child);
        if (flex > 0) {
          assert(!spacePerFlex.isNaN);
          double maxChildExtent = child == lastFlexChild ? (freeSpace - allocatedFlexSpace) : spacePerFlex * flex;
          ...
          switch (_getFit(child)) {
            ...
            case FlexFit.loose:
              minChildExtent = 0.0;
              maxChildExtent = maxMainSize < double.infinity ? maxChildExtent : double.infinity;
              break;
          }
    ...
    final double idealSize = mainAxisSize == MainAxisSize.max && maxMainSize < double.infinity ? maxMainSize : allocatedSize;
