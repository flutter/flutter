...
abstract class LayerHitTestTarget<T> {
  // This class is intended to be used as an interface with the implements
  // keyword, and should not be extended directly.
  factory LayerHitTestTarget._() => null;

  /// TODOC
  T get value;
}

/// Data collected during a hit test about a specific [LayerHitTestTarget].
///
/// Subclass this object to pass additional information from the hit test phase
/// to the event propagation phase.
class LayerHitTestEntry<T> {
  /// Creates a hit test entry.
  LayerHitTestEntry(this.target);

  /// The [HitTestTarget] encountered during the hit test.
  final LayerHitTestTarget<T> target;
