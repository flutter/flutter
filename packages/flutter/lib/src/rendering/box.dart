...
/// same, that axis is _tightly_ constrained. See: [BoxConstraints.tightFor],
/// [BoxConstraints.tightForFinite], [tighten], [hasTightWidth],
/// [hasTightHeight], [isTight].
///
...
class BoxConstraints extends Constraints {
  ...
  /// See also:
  ///
  ///  * [BoxConstraints.tightFor], which is similar but instead of being tight
  ///    if the value is not infinite, is tight if the value is non-null.
