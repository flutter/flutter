...
abstract class RenderBox extends RenderObject {
  ...
  static Map<RenderBox, Map<_IntrinsicDimensionsCacheEntry, double>>? _debugCachedIntrinsicDimensionsForChecks;
  ...
  void debugMarkDirtyForAssertDoesMeetConstraints() {
    ...
    super.debugMarkDirtyForAssertDoesMeetConstraints();
  }
  ...
  double _computeIntrinsicDimension(_IntrinsicDimension dimension, double argument, double computer(double argument)) {
    ...
    assert(() {
      if (RenderObject.debugCheckingIntrinsics) {
        _debugCachedIntrinsicDimensionsForChecks ??= <RenderBox, Map<_IntrinsicDimensionsCacheEntry, double>>{};
