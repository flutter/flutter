...
class BoxHitTestEntry extends HitTestEntry<RenderBox> {
  ...
  BoxHitTestEntry(super.target, this.localPosition) : assert(localPosition != null);
...
abstract class RenderBox extends RenderObject {
  ...
  void layout(Constraints constraints, {bool parentUsesSize = false}) {
    if (hasSize && constraints != this.constraints && _cachedBaselines != null && _cachedBaselines!.isNotEmpty) {
