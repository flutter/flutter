...
///  * [PlatformViewsService] which is a service for controlling platform views.
class RenderGtkView extends RenderBox {
  ...
  ///
  /// Typically generated by [PlatformViewsRegistry.getNextPlatformViewId], the UIView
  /// must have been created by calling [PlatformViewsService.initGtkView].
  GtkViewController get viewController => _viewController;
  GtkViewController _viewController;
  set viewController(GtkViewController viewController) {
    assert(viewController != null);
    final bool needsSemanticsUpdate = _viewController.id != viewController.id;
    _viewController = viewController;
    markNeedsPaint();
  ...
  void updateGestureRecognizers(
    ...
    _gestureRecognizer?.dispose();
    _gestureRecognizer =
        _GtkViewGestureRecognizer(viewController, gestureRecognizers);
  }
  ...
  _GtkViewGestureRecognizer? _gestureRecognizer;
...
class _GtkViewGestureRecognizer extends OneSequenceGestureRecognizer {
