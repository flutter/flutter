...
abstract class RenderSliverFixedExtentBoxAdaptor
  ...
  void performLayout() {
    ...
    final int firstIndex =
        getMinChildIndexForScrollOffset(scrollOffset, itemFixedExtent);
    final int? targetLastIndex = targetEndScrollOffset.isFinite
        ? getMaxChildIndexForScrollOffset(
            targetEndScrollOffset, itemFixedExtent)
        : null;
    ...
    if (firstChild == null) {
      if (!addInitialChild(
          index: firstIndex,
          layoutOffset: indexToLayoutOffset(itemFixedExtent, firstIndex))) {
      ...
      if (child == null) {
        ...
        geometry = SliverGeometry(
            scrollOffsetCorrection:
                indexToLayoutOffset(itemFixedExtent, index));
        return;
      }
    ...
    if (trailingChildWithLayout == null) {
      ...
      childParentData.layoutOffset =
          indexToLayoutOffset(itemFixedExtent, firstIndex);
    ...
    for (int index = indexOf(trailingChildWithLayout!) + 1;
      ...
      assert(childParentData.index == index);
      childParentData.layoutOffset =
          indexToLayoutOffset(itemFixedExtent, childParentData.index!);
    }
    ...
    final double trailingScrollOffset =
        indexToLayoutOffset(itemFixedExtent, lastIndex + 1);
    ...
    final int? targetLastIndexForPaint = targetEndScrollOffsetForPaint.isFinite
        ? getMaxChildIndexForScrollOffset(
            targetEndScrollOffsetForPaint, itemFixedExtent)
        : null;
