...
@Deprecated(
  'Use timelineArgumentsIndicatingLandmarkEvent instead. '
  'This feature was deprecated after 1.20.0-1.0.pre.'
)
const Map<String, String> timelineWhitelistArguments = timelineArgumentsIndicatingLandmarkEvent;
