...
class FragmentShaderManager {
  ...
  static Future<FragmentShaderManager> inkSparkle() async {
    ...
    await manager._loadSpirv();
    await manager.compile();
    return manager;
  }

  Future<void> _loadSpirv() async {
    _spirvByteData = await rootBundle.load('ink_sparkle.spv');
  }
  ...
  static late ByteData _spirvByteData;
  ...
  ByteBuffer get spirvByteBuffer => _spirvByteData.buffer;
}
