...
class FilledButton extends ButtonStyleButton {
  ...
  static ButtonStyle styleFrom({
    ...
    final WidgetStateProperty<MouseCursor?> mouseCursor = _FilledButtonDefaultMouseCursor(enabledMouseCursor, disabledMouseCursor);
...
@immutable
class _FilledButtonDefaultColor extends WidgetStateProperty<Color?> with Diagnosticable {
...
@immutable
class _FilledButtonDefaultOverlay extends WidgetStateProperty<Color?> with Diagnosticable {
...
@immutable
class _FilledButtonDefaultMouseCursor extends WidgetStateProperty<MouseCursor?> with Diagnosticable {
