...
class SliderThemeData with Diagnosticable {
  ...
  ///
  /// Defaults to [ColorScheme.primary] with an opacity of 0.54.
  final Color? secondaryActiveTrackColor;

  /// The color of the [Slider] track between the [Slider.min] position and the
  /// current thumb position when the [Slider] is disabled.
  ///
  /// Defaults to [ColorScheme.onSurface] with an opacity of 0.38.
  ...
  ///
  /// Defaults to [ColorScheme.onSurface] with an opacity of 0.12.
  ...
  ///
  /// Defaults to [ColorScheme.onSecondaryContainer].
  final Color? inactiveTickMarkColor;

  /// The color of the track's tick marks that are drawn between the [Slider.min]
  /// position and the current thumb position when the [Slider] is disabled.
  ///
  /// Defaults to [ColorScheme.onInverseSurface].
  ...
  ///
  /// Defaults to [ColorScheme.inverseSurface].
  ...
  ///
  /// The default value is [RoundSliderTickMarkShape] with a tick mark radius of 2.0.
  ///
  /// See also:
  ///
  ...
  ///
  /// The default value is [HandleThumbShape].
  ///
  /// See also:
  ///
  ...
  /// slider is discrete.
  ///
  /// The default value is [GappedSliderTrackShape].
  ///
  /// See also:
  ///
  ...
  ///
  /// Defaults to [TextTheme.labelLarge] with a [ColorScheme.onInverseSurface] color.
  ...
  /// defaults to [RoundedRectSliderTrackShape] and the [trackGap] is ignored.
