...
class SliderThemeData with Diagnosticable {
  ...
  ///
  /// If [SliderThemeData.use2024SliderShapes] is set to true or [SliderThemeData.trackShape]
  /// is set to [GappedSliderTrackShape], the track height uses 16 pixels. Otherwise,
  /// the default track height is 4 pixels.
  ...
  ///
  /// If [SliderThemeData.use2024SliderShapes] is set to true, the thumb shape
  /// will be [BarSliderThumbShape]. Otherwise, defaults to [RoundSliderThumbShape].
  ///
  /// See also:
  ///
  ...
  /// slider is discrete.
  ///
  /// If [SliderThemeData.use2024SliderShapes] is set to true, the track shape
  /// will be [GappedSliderTrackShape]. Otherwise, the default
  /// the value is [RoundedRectSliderTrackShape].
  ///
  /// See also:
  ///
  ...
  /// indicator.
  ///
  /// If [SliderThemeData.use2024SliderShapes] is set to true, the value indicator
  /// shape will be [RoundedRectSliderValueIndicatorShape]. Otherwise, defaults to
  /// [DropSliderValueIndicatorShape]. If [ThemeData.useMaterial3] is set to false,
  /// the value indicator shape will be [RectangularSliderValueIndicatorShape].
  ///
  /// See also:
  ///
  ...
  /// The size of the gap between the active and inactive track of [GappedSliderTrackShape].
  ///
  /// If [SliderThemeData.trackShape] is [GappedSliderTrackShape], this
  ...
  SliderThemeData copyWith({
    ...
    return SliderThemeData(
      ...
      use2024SliderShapes: use2024SliderShapes ?? this.use2024SliderShapes,
    );
  }
  ...
  static SliderThemeData lerp(SliderThemeData a, SliderThemeData b, double t) {
    ...
    return SliderThemeData(
      ...
      use2024SliderShapes: t < 0.5 ? a.use2024SliderShapes : b.use2024SliderShapes,
    );
  }
  ...
  bool operator ==(Object other) {
    ...
    return other is SliderThemeData
        ...
        && other.use2024SliderShapes == use2024SliderShapes;
  }
  ...
  void debugFillProperties(DiagnosticPropertiesBuilder properties) {
    ...
    properties.add(DiagnosticsProperty<MaterialStateProperty<Size?>>('barThumbSize', barThumbSize, defaultValue: null));
    properties.add(DoubleProperty('trackGapSize', trackGapSize, defaultValue: defaultData.trackGapSize));
    properties.add(FlagProperty('use2024SliderShapes', value: use2024SliderShapes, ifTrue: 'true', ifFalse: 'false', showName: true));
  }
}
