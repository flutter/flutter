...
//    print(textScaleFactor);
    ...
    _pathPainter.paint(parentBox, canvas, center, scale, labelPainter, canvasWidth, Colors.grey[600], Colors.white);
  }
}
...
//    final double textScaleFactor = labelPainter.height / _labelTextDesignSize;
  ...
  double getHorizontalShift({
    ...
    final double overflowLeft = math.max(0, scaledRectangleWidth / 2 - center.dx + edgePadding);
    final double overflowRight = math.max(0, scaledRectangleWidth / 2 - (canvasWidth - center.dx - edgePadding));
  ...
  void paint(
    ...
    print(scale);
    print(labelPainter.height);
    final Rect upperRect = Rect.fromLTWH(
      -rectangleWidth / 2 + horizontalShift,
      0,
      rectangleWidth,
      labelPainter.height / scale + _labelPadding,
    );
