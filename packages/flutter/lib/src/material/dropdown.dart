...
class _DropdownButtonState<T> extends State<DropdownButton<T>> with WidgetsBindingObserver {
  ...
  Color get _downArrowColor {
    ...
    if (_enabled)
      return Theme.of(context).brightness == Brightness.light ? Colors.grey.shade700 : Colors.white70;
    else
      return Theme.of(context).brightness == Brightness.light ? Colors.grey.shade400 : Colors.white10;
  }
