      ...
      switch (widget.scrollDirection) {
        case Axis.horizontal:
          if (widget.reverse) {
            ...
            listPadding = EdgeInsets.fromLTRB(widget.footer != null ? 0 : padding.left, padding.top,
                widget.header != null ? 0 : padding.right, padding.bottom);
            ...
            listPadding = EdgeInsets.fromLTRB(widget.header != null ? 0 : padding.left, padding.top,
                widget.footer != null ? 0 : padding.right, padding.bottom);
        ...
        case Axis.vertical:
          if (widget.reverse) {
            ...
            listPadding = EdgeInsets.fromLTRB(padding.left, widget.footer != null ? 0 : padding.top, padding.right,
            ...
            listPadding = EdgeInsets.fromLTRB(padding.left, widget.header != null ? 0 : padding.top, padding.right,
