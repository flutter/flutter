...
class TokenFilledAutocomplete {
  ...
  /// md.comp.filled-autocomplete.text-field.disabled.container.opacity
  ...
  /// md.comp.filled-autocomplete.menu.cascading-menu-indicator.icon.size
  ...
  static const double textFieldLabelTextTypeFontSize = 16.00;

  /// md.comp.filled-autocomplete.text-field.label-text.type
  static const double textFieldLabelTextTypeFontWeight = 400;

  /// md.comp.filled-autocomplete.text-field.label-text.type
  static const double textFieldLabelTextTypeLineHeight = 24.00;

  /// md.comp.filled-autocomplete.text-field.label-text.type
  static const double textFieldLabelTextTypeLetterSpacing = 0.00;

  /// md.comp.filled-autocomplete.text-field.label-text.type
  static const String textFieldLabelTextTypeFontFamily = 'Roboto Flex';
  ...
  static const String textFieldInputTextFont = 'Roboto Flex';
  ...
  static const TokenColorRole textFieldErrorFocusCaretColor =
      TokenColorRole.error;

  /// md.comp.filled-autocomplete.text-field.label-text.font
  static const String textFieldLabelTextFont = 'Roboto Flex';
  ...
  static const double textFieldInputTextTypeFontSize = 16.00;

  /// md.comp.filled-autocomplete.text-field.input-text.type
  static const double textFieldInputTextTypeFontWeight = 400;

  /// md.comp.filled-autocomplete.text-field.input-text.type
  static const double textFieldInputTextTypeLineHeight = 24.00;

  /// md.comp.filled-autocomplete.text-field.input-text.type
  static const double textFieldInputTextTypeLetterSpacing = 0.00;

  /// md.comp.filled-autocomplete.text-field.input-text.type
  static const String textFieldInputTextTypeFontFamily = 'Roboto Flex';

  /// md.comp.filled-autocomplete.text-field.caret.color
  static const TokenColorRole textFieldCaretColor = TokenColorRole.primary;
  ...
  static const double textFieldSupportingTextTypeFontSize = 12.00;

  /// md.comp.filled-autocomplete.text-field.supporting-text.type
  static const double textFieldSupportingTextTypeFontWeight = 400;

  /// md.comp.filled-autocomplete.text-field.supporting-text.type
  static const double textFieldSupportingTextTypeLineHeight = 16.00;

  /// md.comp.filled-autocomplete.text-field.supporting-text.type
  static const double textFieldSupportingTextTypeLetterSpacing = 0.00;

  /// md.comp.filled-autocomplete.text-field.supporting-text.type
  static const String textFieldSupportingTextTypeFontFamily = 'Roboto Flex';
  ...
  /// md.comp.filled-autocomplete.text-field.disabled.input-text.opacity
  ...
  static const String textFieldSupportingTextFont = 'Roboto Flex';
  ...
  static const double textFieldLeadingIconSize = 20.00;
