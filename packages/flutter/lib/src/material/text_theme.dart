...
class TextTheme with Diagnosticable {
  ...
  TextTheme apply({
    ...
    List<String>? bodyFontFamilyFallback,
    String? package,
    ...
    return TextTheme(
      displayLarge: displayLarge?.apply(
        ...
        fontFamilyFallback: displayFontFamilyFallback ?? fontFamilyFallback,
      ...
      headlineSmall: headlineSmall?.apply(
        ...
        fontFamilyFallback: bodyFontFamilyFallback ?? fontFamilyFallback,
        fontSizeFactor: fontSizeFactor,
        fontSizeDelta: fontSizeDelta,
        package: package,
      ),
