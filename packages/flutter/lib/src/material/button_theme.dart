...
class ButtonThemeData with Diagnosticable {
  ...
  Color? getFillColor(MaterialButton button) {
    ...
    if (button is FlatButton || button.runtimeType == MaterialButton) return null;
  ...
  Color getTextColor(MaterialButton button) {
    ...
    switch (getTextTheme(button)) {
      ...
      case ButtonTextTheme.primary:
        ...
        if (button is FlatButton) return colorScheme!.primary;
        return Colors.black;
    }
  }
  ...
  Color getSplashColor(MaterialButton button) {
    ...
    if (_splashColor != null && button is RaisedButton) return _splashColor!;
  ...
  EdgeInsetsGeometry getPadding(MaterialButton button) {
    ...
    if (button is MaterialButtonWithIconMixin) return const EdgeInsetsDirectional.only(start: 12.0, end: 16.0);
  ...
  void debugFillProperties(DiagnosticPropertiesBuilder properties) {
    ...
    properties
        .add(DiagnosticsProperty<ColorScheme>('colorScheme', colorScheme, defaultValue: defaultTheme.colorScheme));
    properties.add(DiagnosticsProperty<MaterialTapTargetSize>('materialTapTargetSize', _materialTapTargetSize,
        defaultValue: null));
  }
}
