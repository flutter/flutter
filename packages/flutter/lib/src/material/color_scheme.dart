...
class ColorScheme with Diagnosticable {
  ...
  ColorScheme.highContrastLight({
    ...
    Color? surfaceVariant,
  }) : primary = _lightSystemPalette?.canvas.value ?? primary ?? const Color(0xff0000ba),
       onPrimary = _lightSystemPalette?.canvasText.value ?? onPrimary ?? Colors.white,
       _primaryContainer = primaryContainer,
       _onPrimaryContainer = onPrimaryContainer,
       _primaryFixed = primaryFixed,
       _primaryFixedDim = primaryFixedDim,
       _onPrimaryFixed = onPrimaryFixed,
       _onPrimaryFixedVariant = onPrimaryFixedVariant,
       secondary = _lightSystemPalette?.accentColor.value ?? secondary ?? const Color(0xff66fff9),
       onSecondary = _lightSystemPalette?.accentColorText.value ?? onSecondary ?? Colors.black,
       _secondaryContainer = secondaryContainer,
       _onSecondaryContainer = onSecondaryContainer,
       _secondaryFixed = secondaryFixed,
       _secondaryFixedDim = secondaryFixedDim,
  ...
  ColorScheme.highContrastDark({
    ...
    Color? surfaceVariant,
  }) : primary = _darkSystemPalette?.canvas.value ?? primary ?? const Color(0xffefb7ff),
       onPrimary = _darkSystemPalette?.canvasText.value ?? onPrimary ?? Colors.black,
       _primaryContainer = primaryContainer,
       _onPrimaryContainer = onPrimaryContainer,
       _primaryFixed = primaryFixed,
       _primaryFixedDim = primaryFixedDim,
       _onPrimaryFixed = onPrimaryFixed,
       _onPrimaryFixedVariant = onPrimaryFixedVariant,
       secondary = _darkSystemPalette?.accentColor.value ?? secondary ?? const Color(0xff66fff9),
       onSecondary = _darkSystemPalette?.accentColorText.value ?? onSecondary ?? Colors.black,
       _secondaryContainer = secondaryContainer,
       _onSecondaryContainer = onSecondaryContainer,
       _secondaryFixed = secondaryFixed,
       _secondaryFixedDim = secondaryFixedDim,
