...
class _Defaults extends NavigationBarThemeData {
  ...
  MaterialStateProperty<TextStyle?>? get labelTextStyle =>
      MaterialStateProperty.all(_theme.textTheme.overline!.copyWith(color: _colors.onSurface));
}
...
class _TokenDefaultsM3 extends NavigationBarThemeData {
  ...
  @override
  Color? get backgroundColor => ElevationOverlay.colorWithOverlay(_colors.surface, _colors.primary, 3.0);
