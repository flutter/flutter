...
class _SliderState extends State<Slider> with TickerProviderStateMixin {
  ...
  Widget _buildMaterialSlider(BuildContext context) {
    ...
    final SliderTickMarkShape _defaultTickMarkShape = RoundSliderTickMarkShape();
    const SliderComponentShape _defaultOverlayShape = RoundSliderOverlayShape();
    final SliderComponentShape _defaultThumbShape = RoundSliderThumbShape();
    final SliderComponentShape _defaultValueIndicatorShape = const RectangularSliderValueIndicatorShape();
