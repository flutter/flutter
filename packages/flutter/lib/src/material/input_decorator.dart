...
class InputDecorationTheme extends Diagnosticable {
  ...
  void debugFillProperties(DiagnosticPropertiesBuilder properties) {
    ...
    properties.add(ColorDiagnosticsProperty('fillColor', fillColor, defaultValue: defaultTheme.fillColor));
    properties.add(ColorDiagnosticsProperty('focusColor', focusColor, defaultValue: defaultTheme.focusColor));
    properties.add(ColorDiagnosticsProperty('hoverColor', hoverColor, defaultValue: defaultTheme.hoverColor));
