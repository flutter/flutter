...
class Dialog extends StatelessWidget {
  ...
  ///
  /// If null, then [DialogTheme.backgroundColor] is used. If that is also
  /// null, defaults to [ColorScheme.surfaceContainerHigh]. If
  /// [ThemeData.useMaterial3] is false, defaults to [Colors.grey][800] in dark
  /// theme and [Colors.white] in light theme.
  ///
