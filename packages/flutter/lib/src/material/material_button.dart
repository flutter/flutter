...
class MaterialButton extends StatelessWidget {
  ...
  void debugFillProperties(DiagnosticPropertiesBuilder properties) {
    ...
    properties.add(ColorDiagnosticsProperty('textColor', textColor, defaultValue: null));
    properties.add(ColorDiagnosticsProperty('disabledTextColor', disabledTextColor, defaultValue: null));
