...
class ThemeData extends Diagnosticable {
  ...
  void debugFillProperties(DiagnosticPropertiesBuilder properties) {
    ...
    properties.add(ColorDiagnosticsProperty('primaryColor', primaryColor, defaultValue: defaultData.primaryColor));
    ...
    properties.add(ColorDiagnosticsProperty('accentColor', accentColor, defaultValue: defaultData.accentColor));
    ...
    properties.add(ColorDiagnosticsProperty('canvasColor', canvasColor, defaultValue: defaultData.canvasColor));
    properties.add(ColorDiagnosticsProperty('scaffoldBackgroundColor', scaffoldBackgroundColor, defaultValue: defaultData.scaffoldBackgroundColor));
    properties.add(ColorDiagnosticsProperty('bottomAppBarColor', bottomAppBarColor, defaultValue: defaultData.bottomAppBarColor));
    properties.add(ColorDiagnosticsProperty('cardColor', cardColor, defaultValue: defaultData.cardColor));
    properties.add(ColorDiagnosticsProperty('dividerColor', dividerColor, defaultValue: defaultData.dividerColor));
    properties.add(ColorDiagnosticsProperty('focusColor', focusColor, defaultValue: defaultData.focusColor));
    properties.add(ColorDiagnosticsProperty('hoverColor', hoverColor, defaultValue: defaultData.hoverColor));
    properties.add(ColorDiagnosticsProperty('highlightColor', highlightColor, defaultValue: defaultData.highlightColor));
    properties.add(ColorDiagnosticsProperty('splashColor', splashColor, defaultValue: defaultData.splashColor));
    properties.add(ColorDiagnosticsProperty('selectedRowColor', selectedRowColor, defaultValue: defaultData.selectedRowColor));
    properties.add(ColorDiagnosticsProperty('unselectedWidgetColor', unselectedWidgetColor, defaultValue: defaultData.unselectedWidgetColor));
    properties.add(ColorDiagnosticsProperty('disabledColor', disabledColor, defaultValue: defaultData.disabledColor));
    properties.add(ColorDiagnosticsProperty('buttonColor', buttonColor, defaultValue: defaultData.buttonColor));
    properties.add(ColorDiagnosticsProperty('secondaryHeaderColor', secondaryHeaderColor, defaultValue: defaultData.secondaryHeaderColor));
    properties.add(ColorDiagnosticsProperty('textSelectionColor', textSelectionColor, defaultValue: defaultData.textSelectionColor));
    properties.add(ColorDiagnosticsProperty('cursorColor', cursorColor, defaultValue: defaultData.cursorColor));
    properties.add(ColorDiagnosticsProperty('textSelectionHandleColor', textSelectionHandleColor, defaultValue: defaultData.textSelectionHandleColor));
    properties.add(ColorDiagnosticsProperty('backgroundColor', backgroundColor, defaultValue: defaultData.backgroundColor));
    properties.add(ColorDiagnosticsProperty('dialogBackgroundColor', dialogBackgroundColor, defaultValue: defaultData.dialogBackgroundColor));
    properties.add(ColorDiagnosticsProperty('indicatorColor', indicatorColor, defaultValue: defaultData.indicatorColor));
    properties.add(ColorDiagnosticsProperty('hintColor', hintColor, defaultValue: defaultData.hintColor));
    properties.add(ColorDiagnosticsProperty('errorColor', errorColor, defaultValue: defaultData.errorColor));
    properties.add(ColorDiagnosticsProperty('toggleableActiveColor', toggleableActiveColor, defaultValue: defaultData.toggleableActiveColor));
