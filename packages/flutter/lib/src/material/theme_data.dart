...
class ThemeData extends Diagnosticable {
  ...
  /// The primary color palette for the UI. It defines the colors of [primaryColor], [primaryColorLight], and [primaryColorDark].
  ...
  ThemeData copyWith({
    ...
    cupertinoOverrideTheme = cupertinoOverrideTheme?.noDefault();
    if (primarySwatch !=null && primaryColor == null)
  ...
  static ThemeData lerp(ThemeData a, ThemeData b, double t) {
    ...
    return ThemeData.raw(
      ...
      primarySwatch: t < 0.5 ? a.primarySwatch : b.primarySwatch,
