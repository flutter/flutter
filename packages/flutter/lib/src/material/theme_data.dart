...
class ThemeData with Diagnosticable {
  ...
  static ThemeData lerp(ThemeData a, ThemeData b, double t) {
    return ThemeData.raw(
      ...
      scaffoldTheme:
          ScaffoldThemeData.lerp(a.scaffoldTheme, b.scaffoldTheme, t),
      scrollbarTheme:
  ...
  void debugFillProperties(DiagnosticPropertiesBuilder properties) {
    ...
    properties.add(DiagnosticsProperty<ScaffoldThemeData>(
        'scaffoldTheme', scaffoldTheme,
        defaultValue: defaultData.scaffoldTheme, level: DiagnosticLevel.debug));
