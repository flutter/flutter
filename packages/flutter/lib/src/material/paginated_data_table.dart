...
class PaginatedDataTableState extends State<PaginatedDataTable> {
  ...
  Widget build(BuildContext context) {
    ...
    final TextStyle effectiveDataTextStyle = dataTableTheme.dataTextStyle ??
        themeData.dataTableTheme.dataTextStyle ??
        themeData.textTheme.bodyMedium!;
    final TextStyle loadingTextTheme = effectiveDataTextStyle.copyWith(
        color: effectiveDataTextStyle.color?.withOpacity(0.3));
    // CARD
    return Card(
                  ...
                  children: <Widget>[
                    ConstrainedBox(
                      ...
                      child: DataTable(
                        ...
                        dataTextStyle: needProgressIndicator
                            ? loadingTextTheme
                            : null,
