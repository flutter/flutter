...
const Map<String, Map<String, String>> localizations = const <String, Map<String, String>> {
  ...
  "de": const <String, String>{
    ...
    "selectedRowCountTitleZero": r"Keine Objekte ausgewält",
    "selectedRowCountTitleOne": r"1 Objekt ausgewält",
    "selectedRowCountTitleOther": r"$selectedRowCount Objekte ausgewält",
