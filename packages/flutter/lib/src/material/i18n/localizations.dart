...
const Map<String, Map<String, String>> localizations = const <String, Map<String, String>> {
  "ar": const <String, String>{
    ...
    "licensesPagePoweredByTitle": r"بويرد بي Flutter",
  ...
  "en": const <String, String>{
    ...
    "licensesPagePoweredByTitle": r"Powered by Flutter",
  ...
  "es": const <String, String>{
    ...
    "licensesPagePoweredByTitle": r" Flutter",
  ...
  "fa": const <String, String>{
    ...
    "licensesPagePoweredByTitle": r"توسط Flutter طراحی شده است",
  ...
  "fr": const <String, String>{
    ...
    "licensesPagePoweredByTitle": r"Propulsé par Flutter",
  ...
  "he": const <String, String>{
    ...
    "licensesPagePoweredByTitle": r"מופעל על ידי Flutter",
  ...
  "it": const <String, String>{
    ...
    "licensesPagePoweredByTitle": r"Offerto da Flutter",
  ...
  "ja": const <String, String>{
    ...
    "licensesPagePoweredByTitle": r"搭載Flutter",
  ...
  "ps": const <String, String>{
    ...
    "licensesPagePoweredByTitle": r"د Flutter لخوا اداره کول",
  ...
  "pt": const <String, String>{
    ...
    "licensesPagePoweredByTitle": r"Distribuído por Flutter",
  ...
  "ru": const <String, String>{
    ...
    "licensesPagePoweredByTitle": r"Питаться от Flutter",
  ...
  "sd": const <String, String>{
    ...
    "licensesPagePoweredByTitle": r"وي طرفان Flutter",
  ...
  "ur": const <String, String>{
    ...
    "licensesPagePoweredByTitle": r"Flutter کے ذریعہ",
    "licensesPageTitle": r"لائسنس",
  ...
  "zh": const <String, String>{
    ...
    "licensesPagePoweredByTitle": r"由Flutter提供支持",
