...
const Map<String, Map<String, String>> localizations = const <String, Map<String, String>> {
  ...
  "fr": const <String, String>{
    ...
    "selectedRowCountTitleOther": r"$selectedRowCount articles sélectionnés",
  ...
  "zh": const <String, String>{
    ...
    "pageRowsInfoTitle": r"$firstRow–$lastRow 的 $rowCount",
    "pageRowsInfoTitleApproximate": r"$firstRow–$lastRow 约 $rowCount",
    "rowsPerPageTitle": r"每页行数：",
    "selectedRowCountTitleOther": r"$selectedRowCount 所选项目",
  ...
  "de": const <String, String>{
    ...
    "selectedRowCountTitleOther": r"$selectedRowCount Artikel ausgewählt",
  ...
  "ja": const <String, String>{
    ...
    "pageRowsInfoTitle": r"$firstRow–$lastRow の $rowCount",
    "pageRowsInfoTitleApproximate": r"$firstRow–$lastRow の約 $rowCount",
    "rowsPerPageTitle": r"1ページあたりの行数：",
    "selectedRowCountTitleOther": r"$selectedRowCount 選択されたアイテム",
