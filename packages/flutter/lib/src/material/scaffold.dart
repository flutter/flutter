...
class Scaffold extends StatefulWidget {
  ...
  /// child do not extend into the keyboard region. The extended decoration does
  /// not change the sheet's layout constraints or interactive area.
  ///
  /// See also:
  ///
...
// During dismissal the logical sheet moves below the keyboard edge. Clip its
// contents at that edge while allowing the Material to continue underneath it.
class _BottomSheetContentClipper extends CustomClipper<Rect> {
  _BottomSheetContentClipper(this.animation, this.curve) : super(reclip: animation);
  ...
  Rect getClip(Size size) =>
      Rect.fromLTWH(0.0, 0.0, size.width, size.height * curve().transform(animation.value));
  ...
  bool shouldReclip(_BottomSheetContentClipper oldClipper) =>
      animation != oldClipper.animation || curve != oldClipper.curve;
}
    ...
    return AnimatedBuilder(
      ...
      child: Semantics(
        ...
        child: NotificationListener<DraggableScrollableNotification>(
          ...
          child: BottomSheet._persistent(
            contentClipper: _BottomSheetContentClipper(
...
class BottomSheet extends StatefulWidget {
  ...
  const BottomSheet({
    ...
    required this.builder,
       ...
       _contentClipper = null,
       assert(elevation == null || elevation >= 0.0);

  // Scaffold alone supplies the extent of its persistent sheet's decoration.
  const BottomSheet._persistent({
    this.animationController,
    this.enableDrag = true,
    this.showDragHandle,
    this.onDragStart,
    ...
    required CustomClipper<Rect> contentClipper,
    required this.onClosing,
    required this.builder,
  }) : _bottomInset = bottomInset,
       _contentClipper = contentClipper,
  ...
  final CustomClipper<Rect>? _contentClipper;
...
class _BottomSheetState extends State<BottomSheet> {
  ...
  Widget build(BuildContext context) {
    ...
    final double keyboardInset = widget._bottomInset;
    final BoxConstraints? constraints =
    ...
    Widget content = NotificationListener<DraggableScrollableNotification>(
      onNotification: extentChanged,
    ...
    if (widget._contentClipper != null) {
      content = ClipRect(
        clipBehavior: keyboardInset > 0.0 ? Clip.hardEdge : Clip.none,
        clipper: widget._contentClipper,
...
class _RenderBottomSheetSurface extends RenderProxyBox {
  ...
  @override
  Rect? describeSemanticsClip(RenderBox? child) =>
      _bottom > 0.0 ? Offset.zero & size : super.describeSemanticsClip(child);
}
