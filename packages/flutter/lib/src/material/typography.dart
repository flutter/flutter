...
class Typography extends Diagnosticable {
  ...
  static const TextTheme englishLike2018 = TextTheme(
    ...
    body2      : TextStyle(debugLabel: 'englishLike body2 2018',    fontSize: 16.0, fontWeight: FontWeight.w400, textBaseline: TextBaseline.alphabetic, letterSpacing: 0.5),
    body1      : TextStyle(debugLabel: 'englishLike body1 2018',    fontSize: 14.0, fontWeight: FontWeight.w400, textBaseline: TextBaseline.alphabetic, letterSpacing: 0.25),
