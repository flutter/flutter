...
class Typography with Diagnosticable {
  ...
  static const TextTheme whiteCupertino = TextTheme(
    ...
    titleSmall   : TextStyle(debugLabel: 'whiteCupertino titleSmall',   fontFamily: '.SF UI Text', color: Colors.white70, decoration: TextDecoration.none),
    ...
    bodySmall    : TextStyle(debugLabel: 'whiteCupertino bodySmall',    fontFamily: '.SF UI Text', color: Colors.white,   decoration: TextDecoration.none),
  ...
  static const TextTheme whiteRedwoodCity = TextTheme(
    ...
    titleSmall   : TextStyle(debugLabel: 'whiteRedwoodCity titleSmall',   fontFamily: '.AppleSystemUIFont', color: Colors.white70, decoration: TextDecoration.none),
    ...
    bodySmall    : TextStyle(debugLabel: 'whiteRedwoodCity bodySmall',    fontFamily: '.AppleSystemUIFont', color: Colors.white,   decoration: TextDecoration.none),
  ...
  static const TextTheme englishLike2018 = TextTheme(
    ...
    bodySmall    : TextStyle(debugLabel: 'englishLike bodySmall 2018',    fontSize: 14.0, fontWeight: FontWeight.w500, textBaseline: TextBaseline.alphabetic, letterSpacing: 1.25),
    labelLarge   : TextStyle(debugLabel: 'englishLike labelLarge 2018',   fontSize: 12.0, fontWeight: FontWeight.w400, textBaseline: TextBaseline.alphabetic, letterSpacing: 0.4),
  ...
  static const TextTheme dense2018 = TextTheme(
    ...
    bodySmall    : TextStyle(debugLabel: 'dense bodySmall 2018',    fontSize: 15.0, fontWeight: FontWeight.w500, textBaseline: TextBaseline.ideographic),
    labelLarge   : TextStyle(debugLabel: 'dense labelLarge 2018',   fontSize: 13.0, fontWeight: FontWeight.w400, textBaseline: TextBaseline.ideographic),
  ...
  static const TextTheme tall2018 = TextTheme(
    ...
    bodySmall    : TextStyle(debugLabel: 'tall bodySmall 2018',    fontSize: 15.0, fontWeight: FontWeight.w700, textBaseline: TextBaseline.alphabetic),
    labelLarge   : TextStyle(debugLabel: 'tall labelLarge 2018',   fontSize: 13.0, fontWeight: FontWeight.w400, textBaseline: TextBaseline.alphabetic),
