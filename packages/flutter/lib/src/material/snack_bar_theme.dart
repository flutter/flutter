...
class SnackBarThemeData extends Diagnosticable {
  ...
  void debugFillProperties(DiagnosticPropertiesBuilder properties) {
    ...
    properties.add(ColorDiagnosticsProperty('actionTextColor', actionTextColor, defaultValue: null));
    properties.add(ColorDiagnosticsProperty('disabledActionTextColor', disabledActionTextColor, defaultValue: null));
