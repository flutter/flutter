...
class _RangeSliderState extends State<RangeSlider> with TickerProviderStateMixin {
  ...
  Widget build(BuildContext context) {
    ...
    if (valueIndicatorShape is RectangularRangeSliderValueIndicatorShape) {
      valueIndicatorColor = sliderTheme.valueIndicatorColor ?? Color.alphaBlend(theme.colorScheme.onSurface.withValues(alpha: 0.60), theme.colorScheme.surface.withValues(alpha: 0.90));
    } else {
    ...
    sliderTheme = sliderTheme.copyWith(
      ...
      disabledThumbColor: sliderTheme.disabledThumbColor ?? Color.alphaBlend(theme.colorScheme.onSurface.withValues(alpha: .38), theme.colorScheme.surface),
