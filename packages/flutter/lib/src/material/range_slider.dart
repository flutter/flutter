...
class _RangeSliderState extends State<RangeSlider> with TickerProviderStateMixin {
  ...
  Widget build(BuildContext context) {
    ...
    final double _defaultTrackHeight = 4;
    final RangeSliderTrackShape _defaultTrackShape = RoundedRectRangeSliderTrackShape();
    final RangeSliderTickMarkShape _defaultTickMarkShape = RoundRangeSliderTickMarkShape();
    const SliderComponentShape _defaultOverlayShape = RoundSliderOverlayShape();
    final RangeSliderThumbShape _defaultThumbShape = RoundRangeSliderThumbShape();
    final RangeSliderValueIndicatorShape _defaultValueIndicatorShape = const RectangularRangeSliderValueIndicatorShape();
