...
/// Deserializes [ui.PointerData] from a json String or a json object.
///
/// See [serializePointerData].
ui.PointerData pointerDataFromJson(dynamic value) {
  assert(value is Map<String, dynamic> || value is String);
  final Map<String, dynamic> jsonObject = value is String
    ? json.decode(value) as Map<String, dynamic>
    : value as Map<String, dynamic>;
  return deserializePointerData(jsonObject);
}

/// Deserializes [ui.PointerData] from a json object.
///
/// See [serializePointerData].
ui.PointerData deserializePointerData(Map<String, dynamic> jsonObject) {
