...
import 'package:flutter/services.dart' as test_services show HardwareKeyboard, LogicalKeyboardKey;
...
class TapDragDownDetails with Diagnosticable {
  ...
  final Set<test_services.LogicalKeyboardKey> keysPressedOnDown;
  ...
  void debugFillProperties(DiagnosticPropertiesBuilder properties) {
    ...
    properties.add(DiagnosticsProperty<Set<test_services.LogicalKeyboardKey>>('keysPressedOnDown', keysPressedOnDown));
  }
}
...
mixin _TapStatusTrackerMixin on OneSequenceGestureRecognizer {
  ...
  Set<test_services.LogicalKeyboardKey> get keysPressedOnDown => _keysPressedOnDown ?? <test_services.LogicalKeyboardKey>{};
  ...
  Set<test_services.LogicalKeyboardKey>? _keysPressedOnDown;
  ...
  void _trackTap(PointerDownEvent event) {
    _down = event;
    _keysPressedOnDown = test_services.HardwareKeyboard.instance.logicalKeysPressed;
