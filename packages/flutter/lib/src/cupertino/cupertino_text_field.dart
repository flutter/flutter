...
//  }
  ...
  void didUpdateWidget(CupertinoTextField oldWidget) {
    ...
    if (widget.controller == null && oldWidget.controller != null)
      ...
      _controller = null;
    final bool isEnabled = widget.enabled ?? true; // widget.enabled ?? widget.decoration?.enabled ?? true;
    final bool wasEnabled = oldWidget.enabled ?? true; // oldWidget.enabled ?? oldWidget.decoration?.enabled ?? true;
...
//  }
  ...
  @override
  bool get wantKeepAlive => true; // _splashes != null && _splashes.isNotEmpty;
...
//    final ThemeData themeData = Theme.of(context);
    final TextStyle style = widget.style ?? const TextStyle(); // themeData.textTheme.subhead;
    final Brightness keyboardAppearance = widget.keyboardAppearance ?? Brightness.dark; // themeData.primaryColorBrightness;
      ...
      child: Row(
        children: <Widget>[
          ...
          new EditableText(
            ...
            selectionColor: CupertinoColors.black, // themeData.textSelectionColor,
...
//            : materialTextSelectionControls,
            ...
            cursorColor: widget.cursorColor ?? CupertinoColors.activeBlue, // Theme.of(context).cursorColor,
...
//    }
    ...
    return new Semantics(
      ...
      child: new IgnorePointer(
        ignoring: !(widget.enabled ?? true), // !(widget.enabled ?? widget.decoration?.enabled ?? true),
