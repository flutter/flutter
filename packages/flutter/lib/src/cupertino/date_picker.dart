...
const Color _kTextColor = CupertinoColors.black;
...
TextStyle _themeTextStyle(BuildContext context, { bool isValid = true, Color textColor }) {
  final TextStyle style = CupertinoTheme
      .of(context)
      .textTheme
      .dateTimePickerTextStyle
      .copyWith(color: textColor);
  return isValid ? style : style.copyWith(color: CupertinoDynamicColor.resolve(
...
class _DatePickerLayoutDelegate extends MultiChildLayoutDelegate {
  ...
  void performLayout(Size size) {
    ...
    for (int i = 0; i < columnWidths.length; i++) {
      final int index = textDirectionFactor == 1 ? i : columnWidths.length - i -
          1;
...
class CupertinoDatePicker extends StatefulWidget {
  ...
  CupertinoDatePicker({
    ...
    assert(
    mode != CupertinoDatePickerMode.date || maximumYear == null ||
        this.initialDateTime.year <= maximumYear,
    'initial year is not smaller than maximum year',
    );
    assert(
    mode != CupertinoDatePickerMode.date || minimumDate == null ||
        !minimumDate.isAfter(this.initialDateTime),
    'initial date ${this
        .initialDateTime} is not greater than or euqal to minimumDate $minimumDate',
    );
    assert(
    mode != CupertinoDatePickerMode.date || maximumDate == null ||
        !maximumDate.isBefore(this.initialDateTime),
    'initial date ${this
        .initialDateTime} is not less than or euqal to maximumDate $maximumDate',
    );
    assert(
...
class _CupertinoDatePickerDateTimeState extends State<CupertinoDatePicker> {
  ...
  DateTime _getDateTime() {
    ...
    return DateTime(
      ...
      date.month,
      date.day,
      widget.use24hFormat ? selectedHour : selectedHour % 12 +
          selectedAmPm * 12,
      selectedMinute,
    );
  }
  ...
  Widget _buildMediumDatePicker(double offAxisFraction,
    ...
    return CupertinoPicker.builder(
      scrollController: FixedExtentScrollController(
          initialItem: selectedDayFromInitial),
...
class _CupertinoDatePickerDateState extends State<CupertinoDatePicker> {
  ...
  Widget _buildDayPicker(double offAxisFraction,
      TransitionBuilder itemPositioningBuilder) {
    final int daysInCurrentMonth = _lastDayInMonth(selectedYear, selectedMonth)
        .day;
          ...
          return itemPositioningBuilder(
            ...
            Text(
              ...
              style: _themeTextStyle(
                  context, isValid: day <= daysInCurrentMonth, textColor: textColor),
            ),
          );
        }),
        looping: true,
    ...
    return NotificationListener<ScrollNotification>(
      ...
      child: CupertinoPicker(
        ...
        children: List<Widget>.generate(12, (int index) {
          ...
          final bool isInvalidMonth = (widget?.minimumDate?.year ==
              selectedYear && widget.minimumDate.month > month)
          ...
          return itemPositioningBuilder(
            ...
            Text(
              ...
              style: _themeTextStyle(context, isValid: !isInvalidMonth, textColor: textColor),
            ),
          );
        }),
        looping: true,
        ...
        itemBuilder: (BuildContext context, int year) {
          ...
          return itemPositioningBuilder(
            ...
            Text(
              ...
              style: _themeTextStyle(context, isValid: isValidYear, textColor: textColor),
            ),
          );
        },
      ),
  ...
  void _pickerDidStopScrolling() {
    ...
    if (minCheck || maxCheck) {
      ...
      final DateTime targetDate = minCheck ? widget.minimumDate : widget
          .maximumDate;
  ...
  Widget build(BuildContext context) {
    ...
    switch (localizations.datePickerDateOrder) {
      case DatePickerDateOrder.mdy:
        pickerBuilders =
        <_ColumnBuilder>[_buildMonthPicker, _buildDayPicker, _buildYearPicker];
        columnWidths = <double>[
          estimatedColumnWidths[_PickerColumnType.month.index],
          estimatedColumnWidths[_PickerColumnType.dayOfMonth.index],
          estimatedColumnWidths[_PickerColumnType.year.index]];
      ...
      case DatePickerDateOrder.dmy:
        pickerBuilders =
        <_ColumnBuilder>[_buildDayPicker, _buildMonthPicker, _buildYearPicker];
        columnWidths = <double>[
          estimatedColumnWidths[_PickerColumnType.dayOfMonth.index],
          estimatedColumnWidths[_PickerColumnType.month.index],
          estimatedColumnWidths[_PickerColumnType.year.index]];
      ...
      case DatePickerDateOrder.ymd:
        pickerBuilders =
        <_ColumnBuilder>[_buildYearPicker, _buildMonthPicker, _buildDayPicker];
        columnWidths = <double>[
          estimatedColumnWidths[_PickerColumnType.year.index],
          estimatedColumnWidths[_PickerColumnType.month.index],
          estimatedColumnWidths[_PickerColumnType.dayOfMonth.index]];
      ...
      case DatePickerDateOrder.ydm:
        pickerBuilders =
        <_ColumnBuilder>[_buildYearPicker, _buildDayPicker, _buildMonthPicker];
        columnWidths = <double>[
          estimatedColumnWidths[_PickerColumnType.year.index],
          estimatedColumnWidths[_PickerColumnType.dayOfMonth.index],
          estimatedColumnWidths[_PickerColumnType.month.index]];
    ...
    switch (widget.mode) {
      ...
      case CupertinoTimerPickerMode.hms:
        ...
        totalWidth = _kTimerPickerColumnIntrinsicWidth * 3 +
            4 * _kTimerPickerHalfColumnPadding + paddingValue;
        columns = <Widget>[
          _buildHourColumn(const EdgeInsetsDirectional.only(
              start: paddingValue / 2, end: _kTimerPickerHalfColumnPadding)),
          _buildMinuteColumn(const EdgeInsetsDirectional.only(
        ...
        child: Align(
          ...
          child: Container(
            ...
            child: DefaultTextStyle(
              ...
              child: Row(children: columns.map((Widget child) =>
                  Expanded(child: child)).toList(growable: false)),
            ),
          ),
        ),
      ),
