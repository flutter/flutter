...
class _DatePickerLayoutDelegate extends MultiChildLayoutDelegate {
  ...
  void performLayout(Size size) {
    ...
    for (int i = 0; i < columnWidths.length; i++) {
      ...
      double childWidth = columnWidths[index] + _kDatePickerPadSize * 2.5;
...
class CupertinoDatePicker extends StatefulWidget {
  ...
  ///
  /// [alignMonth] determines position of moth [Alignment] in date mode.
  CupertinoDatePicker({
    Key? key,
  ...
  //used for align month in scrollable
  final Alignment? alignMonth;
    ...
    switch (mode) {
      ...
      case CupertinoDatePickerMode.date:
        return _CupertinoDatePickerDateState(
            dateOrder: dateOrder, alignMonth: alignMonth);
    }
  }
...
class _CupertinoDatePickerDateState extends State<CupertinoDatePicker> {
  _CupertinoDatePickerDateState(
      {required this.dateOrder, this.alignMonth = null});
