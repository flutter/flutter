...
class CupertinoSheetRoute<T> extends PageRoute<T> with _CupertinoSheetRouteTransitionMixin<T> {
  ...
  CupertinoSheetRoute({super.settings, this.builder, this.enableDrag = true, double? topGap})
    : assert(
  ...
  /// provided by [scrollableBuilder], the sheet will trigger either scrolling or
  /// the drag to dismiss gesture based on the state of the widget.
  ///
  ...
  @override
  bool get enableScroll => _sheetMode == _CupertinoSheetMode.scrollable;
  ...
  WidgetBuilder get _effectiveBuilder =>
      builder ??
      (BuildContext context) => _CupertinoDraggableScrollableSheet<T>(
