...
class CupertinoIcons {
  ...
  /// A collection of envelopes (or folders), which store collections of files. This icon is not filled in.
  ///
  /// See also:
  ///
  ...
  /// A collection of envelopes (or folders), which store collections of files. This icon is filled in.
  ///
  /// See also:
  ///
  ...
  /// A single envelope (or folder), which stores multiple files. This icon is not filled in.
  ///
  /// See also:
  ///
  ...
  /// A single envelope (or folder), which stores multiple files. This icon is filled in.
  ///
  /// See also:
  ///
  ...
  /// A single envelope that indicates being opened. A folder like this typically stores multiple files.
  ///
  /// See also:
  ///
  ...
  /// See also:
  ///
  ///  * [create_simple], which has less detail and looks like a pencil.
  static const IconData create = IconData(0xf2bf, fontFamily: iconFont, fontPackage: iconFontPackage);

  /// A pencil for composing.
  ///
  /// See also:
  ///
  ///  * [create], which has more detail and looks like a pen.
  ...
  ///  * [clear_thin], which uses a thinner cross and is the iOS 7 equivalent of this icon.
  ...
  ///  * [clear_thin_circled_solid], which is similar, but uses a thinner cross.
  static const IconData clear_circled = IconData(0xf36e, fontFamily: iconFont, fontPackage: iconFontPackage);

  /// A cross of two diagonal lines from edge to edge crossing in an angle of 90 degrees, which is used for dismissal.
  ///
  /// See also:
  ///
  ///  * [clear_thin_circled], which consists of this cross and a circle surrounding it.
  ...
  /// See also:
  ///
  ///  * [clear_thin_circled_solid], which is similar, but filled in.
  ///  * [clear_thin], which is the standalone cross of this icon.
  static const IconData clear_thin_circled = IconData(0xf405, fontFamily: iconFont, fontPackage: iconFontPackage);
  ...
  /// See also:
  ///
  ///  * [clear_thin_circled], which is similar, but not filled in.
  static const IconData clear_thin_circled_solid = IconData(0xf406, fontFamily: iconFont, fontPackage: iconFontPackage);
}
