...
class CupertinoIcons {
  ...
  static const IconData clear = const IconData(0xf2d7, fontFamily: iconFont, fontPackage: iconFontPackage);

  /// Thinner (iOS 7) version of [clear]
  static const IconData clear_thin = const IconData(0xf404, fontFamily: iconFont, fontPackage: iconFontPackage);
