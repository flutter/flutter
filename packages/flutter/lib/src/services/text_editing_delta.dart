...
abstract class TextEditingDelta {
  ...
  factory TextEditingDelta.fromJSON(Map<String, dynamic> encoded) {
    ...
    final String newText = _replace(
        oldText, replacementSource, TextRange(start: replacementDestinationStart, end: replacementDestinationEnd));
...
class TextEditingDeltaInsertion extends TextEditingDelta {
  ...
  TextEditingValue apply(TextEditingValue value) {
    ...
    assert(_debugTextRangeIsValid(TextRange.collapsed(insertionOffset), newText),
