...
class LogicalKeyboardKey extends KeyboardKey {
  ...
  ///
  /// Avoid using this constructor. Instead, use [LogicalKeyboardKey.forId], which
  /// guarantees to return the same object for the same ID.
  ///
  /// The `debugName` will overwrite the computed value from [debugName] if not
  /// null. This property will be deprecated soon. To save executable size, it is
  /// recommended that the [debugName] be null in release mode. You can do this
  /// by using the [kReleaseMode] constant.
  ///
  /// ```dart
  /// const LogicalKeyboardKey(0x0010000000a, debugName: kReleaseMode ? null : 'Special Key')
  /// ```
  @Deprecated('123')
  const LogicalKeyboardKey(this.keyId, {String? debugName})
  ...
  factory LogicalKeyboardKey.forId(int keyId) {
    return findKeyByKeyId(keyId) ??
      _additionalKeyPool.putIfAbsent(keyId, () => LogicalKeyboardKey(keyId));
  }
...
class PhysicalKeyboardKey extends KeyboardKey {
  ...
  ///
  /// Avoid using this constructor. Instead, use [PhysicalKeyboardKey.forId], which
  /// guarantees to return the same object for the same ID.
  ...
  /// in the identical instance. It looks up an object from the predefined values
  /// if possible, or construct a new one and cache it.
  factory PhysicalKeyboardKey.forId(int usbHidUsage) {
    return findKeyByCode(usbHidUsage) ??
      _additionalKeyPool.putIfAbsent(usbHidUsage, () => PhysicalKeyboardKey(usbHidUsage));
  }
