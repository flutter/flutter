...
class LogicalKeyboardKey extends KeyboardKey {
  ...
  ///
  /// This value is useful for describing mnemonic keyboard shortcuts, such
  /// as describing a shortcut combination. Do not use this value to match keys;
  /// compare [keyId] instead.
  ///
