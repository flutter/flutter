...
class RawKeyEventDataWindows extends RawKeyEventData {
  ...
  int _separateLetterKeys(int source) {
    if (source >= LogicalKeyboardKey.upperA.keyId &&
        source <= LogicalKeyboardKey.upperZ.keyId) {
      ...
      final bool isUpperCase = shiftPressed != capsLockPressed;
      return (isUpperCase ? LogicalKeyboardKey.upperA : LogicalKeyboardKey.lowerA).keyId +
        (source - LogicalKeyboardKey.upperA.keyId);
    }
    return source;
  }
  ...
  LogicalKeyboardKey get logicalKey {
    ...
    if (keyLabel.isNotEmpty && !LogicalKeyboardKey.isControlCharacter(keyLabel)) {
      ...
      keyId = _separateLetterKeys(keyId);
