...
import '_network_asset_bundle_io.dart'
  if (dart.library.html) '_network_asset_bundle_web.dart' as network_asset_bundle;
...
abstract class NetworkAssetBundle extends AssetBundle {
  /// Creates an network asset bundle that resolves asset keys as URLs relative
  /// to the given base URL.
  factory NetworkAssetBundle(Uri baseUrl) = network_asset_bundle.NetworkAssetBundle;
}
