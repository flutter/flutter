...
abstract class MouseCursor with Diagnosticable {
  ...
  String toString({DiagnosticLevel minLevel = DiagnosticLevel.info}) {
    ...
    if (minLevel.index >= DiagnosticLevel.info.index && debugDescription != null) return debugDescription;
...
class _NoopMouseCursorSession extends MouseCursorSession {
  _NoopMouseCursorSession(_NoopMouseCursor cursor, int device) : super(cursor, device);
...
class _SystemMouseCursorSession extends MouseCursorSession {
  _SystemMouseCursorSession(SystemMouseCursor cursor, int device) : super(cursor, device);
