  ...
  factory RawKeyEvent.fromMessage(Map<String, dynamic> message) {
    ...
    switch (keymap) {
      ...
      default:
        ...
        // messages.
        throw FlutterError(<DiagnosticsNode>[ErrorSummary('Unknown keymap for key events: $keymap')]);
    }
    ...
    switch (type) {
      ...
      default:
        throw FlutterError(<DiagnosticsNode>[ErrorSummary('Unknown key event type: $type')]);
    }
  }
