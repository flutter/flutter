  ...
  factory RawKeyEvent.fromMessage(Map<String, dynamic> message) {
    ...
    switch (keymap) {
      ...
      default:
        ...
        // messages.
        throw FlutterError.fromParts(<DiagnosticsNode>[ErrorSummary('Unknown keymap for key events: $keymap')]);
    }
    ...
    switch (type) {
      ...
      default:
        throw FlutterError.fromParts(<DiagnosticsNode>[ErrorSummary('Unknown key event type: $type')]);
    }
  }
