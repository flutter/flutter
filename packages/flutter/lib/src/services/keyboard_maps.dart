...
const Map<String, LogicalKeyboardKey> kWebToLogicalKey = <String, LogicalKeyboardKey>{
  ...
  'LowerA': LogicalKeyboardKey.lowerA,
  'LowerB': LogicalKeyboardKey.lowerB,
  'LowerC': LogicalKeyboardKey.lowerC,
  'LowerD': LogicalKeyboardKey.lowerD,
  'LowerE': LogicalKeyboardKey.lowerE,
  'LowerF': LogicalKeyboardKey.lowerF,
  'LowerG': LogicalKeyboardKey.lowerG,
  'LowerH': LogicalKeyboardKey.lowerH,
  'LowerI': LogicalKeyboardKey.lowerI,
  'LowerJ': LogicalKeyboardKey.lowerJ,
  'LowerK': LogicalKeyboardKey.lowerK,
  'LowerL': LogicalKeyboardKey.lowerL,
  'LowerM': LogicalKeyboardKey.lowerM,
  'LowerN': LogicalKeyboardKey.lowerN,
  'LowerO': LogicalKeyboardKey.lowerO,
  'LowerP': LogicalKeyboardKey.lowerP,
  'LowerQ': LogicalKeyboardKey.lowerQ,
  'LowerR': LogicalKeyboardKey.lowerR,
  'LowerS': LogicalKeyboardKey.lowerS,
  'LowerT': LogicalKeyboardKey.lowerT,
  'LowerU': LogicalKeyboardKey.lowerU,
  'LowerV': LogicalKeyboardKey.lowerV,
  'LowerW': LogicalKeyboardKey.lowerW,
  'LowerX': LogicalKeyboardKey.lowerX,
  'LowerY': LogicalKeyboardKey.lowerY,
  'LowerZ': LogicalKeyboardKey.lowerZ,
  ...
  'UpperA': LogicalKeyboardKey.upperA,
  'UpperB': LogicalKeyboardKey.upperB,
  'UpperC': LogicalKeyboardKey.upperC,
  'UpperD': LogicalKeyboardKey.upperD,
  'UpperE': LogicalKeyboardKey.upperE,
  'UpperF': LogicalKeyboardKey.upperF,
  'UpperG': LogicalKeyboardKey.upperG,
  'UpperH': LogicalKeyboardKey.upperH,
  'UpperI': LogicalKeyboardKey.upperI,
  'UpperJ': LogicalKeyboardKey.upperJ,
  'UpperK': LogicalKeyboardKey.upperK,
  'UpperL': LogicalKeyboardKey.upperL,
  'UpperM': LogicalKeyboardKey.upperM,
  'UpperN': LogicalKeyboardKey.upperN,
  'UpperO': LogicalKeyboardKey.upperO,
  'UpperP': LogicalKeyboardKey.upperP,
  'UpperQ': LogicalKeyboardKey.upperQ,
  'UpperR': LogicalKeyboardKey.upperR,
  'UpperS': LogicalKeyboardKey.upperS,
  'UpperT': LogicalKeyboardKey.upperT,
  'UpperU': LogicalKeyboardKey.upperU,
  'UpperV': LogicalKeyboardKey.upperV,
  'UpperW': LogicalKeyboardKey.upperW,
  'UpperX': LogicalKeyboardKey.upperX,
  'UpperY': LogicalKeyboardKey.upperY,
  'UpperZ': LogicalKeyboardKey.upperZ,
...
const Map<int, LogicalKeyboardKey> kWindowsToLogicalKey = <int, LogicalKeyboardKey>{
  ...
  65: LogicalKeyboardKey.upperA,
  66: LogicalKeyboardKey.upperB,
  67: LogicalKeyboardKey.upperC,
  68: LogicalKeyboardKey.upperD,
  69: LogicalKeyboardKey.upperE,
  70: LogicalKeyboardKey.upperF,
  71: LogicalKeyboardKey.upperG,
  72: LogicalKeyboardKey.upperH,
  73: LogicalKeyboardKey.upperI,
  74: LogicalKeyboardKey.upperJ,
  75: LogicalKeyboardKey.upperK,
  76: LogicalKeyboardKey.upperL,
  77: LogicalKeyboardKey.upperM,
  78: LogicalKeyboardKey.upperN,
  79: LogicalKeyboardKey.upperO,
  80: LogicalKeyboardKey.upperP,
  81: LogicalKeyboardKey.upperQ,
  82: LogicalKeyboardKey.upperR,
  83: LogicalKeyboardKey.upperS,
  84: LogicalKeyboardKey.upperT,
  85: LogicalKeyboardKey.upperU,
  86: LogicalKeyboardKey.upperV,
  87: LogicalKeyboardKey.upperW,
  88: LogicalKeyboardKey.upperX,
  89: LogicalKeyboardKey.upperY,
  90: LogicalKeyboardKey.upperZ,
