...
class RawKeyEventDataFuchsia extends RawKeyEventData {
  ...
  LogicalKeyboardKey get logicalKey {
    // First, look to see if the keyCode is one we know about and have a mapping
    // for.
    LogicalKeyboardKey newKey = kFuchsiaToLogicalKey[hidUsage];
    if (newKey != null) {
      return newKey;
    }
    ...
    // If we don't have a mapping for it, but it has a non-control character
    // codePoint, then construct a new Unicode-based key from it.
    ...
    newKey ??= LogicalKeyboardKey(
      ...
      debugName: releaseMode ? null : 'Ephemeral Fuchsia key code $hidUsage',
    );
    return newKey;
  }
