...
class SemanticsData extends Diagnosticable {
  ...
  @override
  String toStringShort() => '${objectRuntimeType(this, 'CustomSemanticsAction')}';
...
class SemanticsProperties extends DiagnosticableTree {
  ...
  @override
  String toStringShort() => '${objectRuntimeType(this, '_SemanticsDiagnosticableNode')}'; // the hashCode isn't important since we're immutable
}
