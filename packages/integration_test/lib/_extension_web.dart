...
void registerWebServiceExtension(final Future<Map<String, dynamic>> Function(Map<String, String>) callback) {
  ...
  js_util.setProperty(html.window, r'$flutterDriver', allowInterop((final dynamic message) async {
    try {
