...
void main() {
  ...
  testWidgets('success', (final WidgetTester tester) async {
    expect(1 + 1, 2); // This should pass
  });

  testWidgets('failure 1', (final WidgetTester tester) async {
  ...
  testWidgets('failure 2', (final WidgetTester tester) async {
