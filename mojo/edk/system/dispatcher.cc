...
// |MOJO_SYSTEM_RESULT_INVALID_ARGUMENT| regardless of the value of |is_closed_|
// (these methods are only needed for wait set dispatchers), we don't need to
// lock |mutex_| and check |is_closed_|.
