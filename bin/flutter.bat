...
IF NOT EXIST "%flutter_root%\.git" (
  ...
  ECHO Error: The flutter tool requires Git in order to operate properly;
  ECHO Error: to set up Flutter, run the following command:
  ECHO Error: git clone -b beta https://github.com/flutter/flutter.git
  EXIT /B 1
)
