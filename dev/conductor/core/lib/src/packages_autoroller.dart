...
''';
  ...
  late final Future<String> featureBranchName = (() async {
    ...
    int x = 1;
    String name(final int index) => 'packages-autoroller-branch-$index';
  ...
  String _redactToken(final String message) => message.replaceAll(token, '[GitHub TOKEN]');
  ...
  Future<void> createPr({
    required final io.Directory repository,
    final String title = 'Roll pub packages',
    final String body = 'This PR was generated by `flutter update-packages --force-upgrade`.',
    final String base = FrameworkRepository.defaultBranch,
  ...
  Future<void> help([final List<String>? args]) {
    return cli(<String>[
      'help',
      ...?args,
    ]);
