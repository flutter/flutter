...
[Pub packages autoroller](https://github.com/flutter/flutter/blob/main/dev/conductor/core/bin/packages_autoroller.dart).''';
  ...
  Future<void> roll() async {
    try {
      ...
      await generateGradleLockfiles(framework);
      await pushBranch();
  ...
  @visibleForTesting
  Future<void> generateGradleLockfiles(FrameworkRepository framework) async {
    final Future<Directory> frameworkDir = framework.checkoutDirectory;
    final Iterable<FileSystemEntity> androidDirectories = (await frameworkDir)
      .absolute
