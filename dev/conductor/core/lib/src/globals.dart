...
String getNewPrLink({
  ...
  final (RepositoryState repoState, String repoLabel) = switch (repoName) {
  ...
  final String candidateBranch = repoState.candidateBranch;
  final String workingBranch = repoState.workingBranch;
