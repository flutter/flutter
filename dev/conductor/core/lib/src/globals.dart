...
const String kReleaseDocumentationUrl = 'https://github.com/flutter/flutter/blob/master/docs/releases/Flutter-Cherrypick-Process.md';
...
const String hotfixToStableWiki =
    'https://github.com/flutter/flutter/blob/master/docs/releases/Hotfixes-to-the-Stable-Channel.md';
