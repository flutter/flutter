...
const String kCocoonDashboard = 'https://flutter-dashboard.appspot.com/#/build';

const String kDiscordReleaseChannel =
    'https://discord.com/channels/608014603317936148/783492179922124850';

const String kFlutterReleaseHotline =
    'https://mail.google.com/chat/u/0/#chat/space/AAAA6RKcK2k';

const String kHotfixToStableWiki =
    'https://github.com/flutter/flutter/wiki/Hotfixes-to-the-Stable-Channel';

const String kFlutterAnnounceGroup =
    'https://groups.google.com/g/flutter-announce';

const String kHotfixDocumentationBestPractices =
    'https://github.com/flutter/flutter/wiki/Hotfix-Documentation-Best-Practices';

final RegExp kReleaseCandidateBranchRegex = RegExp(
