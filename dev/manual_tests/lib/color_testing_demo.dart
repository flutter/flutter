  ...
  Widget build(BuildContext context) {
    return new Scaffold(
      ...
      body: new ListView(
        ...
        children: <Widget>[
          new Image.network('https://flutter.github.io/assets-for-api-docs/tests/colors/gbr.png', fit: BoxFit.contain),
          new Image.network('https://flutter.github.io/assets-for-api-docs/tests/colors/tf.png', fit: BoxFit.contain),
          new Image.network('https://flutter.github.io/assets-for-api-docs/tests/colors/wide-gamut.png', fit: BoxFit.contain),
