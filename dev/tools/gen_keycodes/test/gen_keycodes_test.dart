...
final String dataRoot = path.join(Directory.current.absolute.path, 'test', 'test_data');
...
void main() {
  ...
  test('Generate Keycodes for macOS', () {
    ...
    expect(output, contains('kPlatformMask'));
  ...
  test('Generate Keycodes for Linux', () {
    ...
    expect(output, contains('initialize_xkb_to_physical_key'));
    expect(output, contains('initialize_gtk_keyval_to_logical_key'));
