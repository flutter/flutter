...
Future<void> main() async {
  ...
  final String body = (await response.cast<List<int>>().transform<String>(utf8.decoder).toList())
      .join();
  final subtagRegistry = File('../language_subtag_registry.dart');
  final subtagRegistryFlutterTools = File(
