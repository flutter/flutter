...
const String kCodegenComment =
  ...
  '// This file was generated by aatool.\n';
...
void printUsage(ArgParser parser) {
  print('Usage: aatool --asset-name=<asset_name> --output=<output_path> <frames_list>');
  print('\nExample: aatool --asset-name=_\$menu_arrow --output=lib/data/menu_arrow.g.dart assets/svg/menu_arrow/*.svg\n');
  print(parser.usage);
}
