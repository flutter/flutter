...
Future<void> main(List<String> args) async {
  ...
  ButtonTemplate('md.comp.text-button', 'TextButton',
      ...
      .updateFile();
  CardTemplate(
          'md.comp.elevated-card', 'Card', '$materialLib/card.dart', tokens)
      .updateFile();
  CardTemplate(
          'md.comp.filled-card', 'FilledCard', '$materialLib/card.dart', tokens)
      .updateFile();
  CardTemplate('md.comp.outlined-card', 'OutlinedCard',
          '$materialLib/card.dart', tokens)
      .updateFile();
