...
TextStyle? _m3StateInputStyle(BuildContext context) {
  final Color? color = ${textStyle("md.comp.filled-text-field.label-text")}!.color;
...
TextStyle _m3CounterErrorStyle(BuildContext context) {
  return ${textStyle("md.comp.filled-text-field.supporting-text")}!.copyWith(color: ${componentColor('md.comp.filled-text-field.error.supporting-text')});
}
''';
}
