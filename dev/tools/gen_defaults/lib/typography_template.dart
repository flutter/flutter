...
class TypographyTemplate extends TokenTemplate {
  const TypographyTemplate(String fileName, Map<String, dynamic> tokens)
...
''';
  ...
  String _fontWeight(String textStyleTokenName) {
    final String weightValue =
        tokens[tokens['$textStyleTokenName.weight']!]!.toString();
  ...
  String _fontHeight(String textStyleTokenName) {
    ...
    final double lineHeight =
        tokens['$textStyleTokenName.line-height']! as double;
