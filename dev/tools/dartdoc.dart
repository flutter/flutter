...
Future<void> main(List<String> arguments) async {
  ...
  createSearchMetadata(
      '$kDocsRoot/lib/opensearch.xml', '$kDocsRoot/doc/opensearch.xml');
  cleanOutSnippets();
  ...
  print(
      'Executing: (cd $kDocsRoot ; $dartExecutable ${dartdocArgs.map<String>(quote).join(' ')})');
...
void sanityCheckDocs() {
  ...
  final File sampleExample =
      File('$kPublishRoot/api/widgets/showGeneralDialog.html');
  ...
  final File snippetExample =
      File('$kPublishRoot/api/widgets/ModalRoute/barrierColor.html');
  ...
  final File dartpadExample =
      File('$kPublishRoot/api/widgets/PhysicalShape-class.html');
