    ...
    if (benchmarkOptions.useDdc) {
      ...
      flutterRunProcess = await startFlutter(
        ...
        options: <String>[
          ...
          '--web-browser-flag=--disable-features=GCM',
          '--web-browser-flag=--gcm-checkin-url=http://127.0.0.1',
          '--web-browser-flag=--gcm-registration-url=http://127.0.0.1',
          '--web-browser-flag=--gcm-mcs-endpoint=127.0.0.1:0',
