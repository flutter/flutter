...
void main() {
  ...
  group('runGradleLockFilesCheck', () {
    ...
    test('throws Exception for gradle changes when there are lockfile modifications', () async {
          ...
          await expectLater(
            ...
            throwsA(
              isA<ProcessException>()
                  ...
                  .having((ProcessException e) => e.arguments, 'arguments', <String>[
                    'stash',
                    'pop',
                  ])
                  .having(
      ...
      test(
        ...
        () async {
          ...
          expect(mockExec.calls, <MockCall>[
            ...
            MockCall('git', const <String>['restore', '.'], true, flutterDirectory.path),
          ]);
          expect(mockEval.lastExecutable, 'git');
          expect(mockEval.lastArguments, <String>[
            'status',
