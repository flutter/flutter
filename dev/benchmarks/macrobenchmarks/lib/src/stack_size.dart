...
final GetStackPointerCallback getStackPointer = () {
  ...
  if (!io.Platform.isAndroid) throw 'This benchmark test can only be run on Android arm devices.';
  final io.ProcessResult result = io.Process.runSync('getprop', <String>['ro.product.cpu.abi']);
  if (result.exitCode != 0) throw 'Failed to retrieve CPU information.';
