...
class _SettingsIconPainter extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    ...
    Path path;
    path = _pathFromString(_path1).transform(scale.storage)
      ..fillType = PathFillType.evenOdd;
    canvas.drawPath(path, Paint()..color = const Color(0x60F84F39));

    path = _pathFromString(_path2).transform(scale.storage)
      ..fillType = PathFillType.evenOdd;
    canvas.drawPath(path, Paint()..color = const Color(0xFFF84F39));

    path = _pathFromString(_path3).transform(scale.storage)
      ..fillType = PathFillType.evenOdd;
    canvas.drawPath(path, Paint()..color = const Color(0xFFF84F39));
  }

  static const String _path1 =
