...
class PictureCacheComplexityScoringPage extends StatelessWidget {
  ...
  Widget _buildComplexityScoringWidgets(final String name) {
    return Column(children: <Widget>[
      Slider(value: 50, label: 'Slider 1', onChanged: (final double _) {}, max: 100, divisions: 10,),
      Slider(value: 50, label: 'Slider 2', onChanged: (final double _) {}, max: 100, divisions: 10,),
      Slider(value: 50, label: 'Slider 3', onChanged: (final double _) {}, max: 100, divisions: 10,),
    ]);
  }
}
