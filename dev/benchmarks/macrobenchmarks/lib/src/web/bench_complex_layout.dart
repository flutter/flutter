...
/// Measures how expensive it is to construct deep tree of widgets.
class BenchBuildComplexLayout extends WidgetRecorder {
  BenchBuildComplexLayout() : super(name: benchmarkName);

  static const String benchmarkName = 'build_complex_layout';

  static bool _isChecked;

  @override
  Widget createWidget() => ComplexLayoutApp();
}
...
class ComplexLayoutState extends State<ComplexLayout> {
  ComplexLayoutState(this.scrollController);
