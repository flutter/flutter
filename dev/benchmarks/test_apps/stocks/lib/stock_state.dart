...
class StockStateProvider extends InheritedNotifier<StockState> {
  const StockStateProvider({
    Key key,
    StockState state,
    Widget child,
  ...
  static StockState of(BuildContext context) {
    return context.dependOnInheritedWidgetOfExactType<StockStateProvider>().notifier;
  }
}
