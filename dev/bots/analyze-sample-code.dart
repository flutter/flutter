...
''');
    ...
    for (String error in errors) {
      ...
      if (start >= 0 && end >= 0) {
        ...
        final int lineNumber = int.tryParse(line, radix: 10) ?? throw 'failed to parse error message: $error';
        final int columnNumber = int.tryParse(column, radix: 10) ?? throw 'failed to parse error message: $error';
