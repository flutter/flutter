...
Future<void> run(List<String> arguments) async {
  ...
  verifyMaterialFilesAreUpToDateWithTemplateFiles(flutterRoot);
...
Future<void> verifyMaterialFilesAreUpToDateWithTemplateFiles(String workingDirectory) async {
  final List<String> errors = <String>[];
  ...
  await runCommand(dart,
    <String>['--enable-asserts', path.join(flutterRoot, 'dev', 'tools', 'gen_defaults', 'bin', 'gen_defaults.dart')],
    workingDirectory: flutterRoot,
  );
