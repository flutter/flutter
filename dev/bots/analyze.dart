    ...
    if (!specialBeta && (major > 1 || (major == 1 && minor >= 20))) {
      if (!hasBuild) {
        _addErrorWithLineInfo(
          versionLiteral,
          error:
              'Deprecation notice does not accurately indicate a beta branch version number; please see https://docs.flutter.dev/development/tools/sdk/releases to find the latest beta build version number.',
        );
        return;
      }
    }
