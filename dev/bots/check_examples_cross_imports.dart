...
class ExamplesCrossImportChecker {
  ...
  static final Set<String> knownExamplesCrossImports = <String>{
    ...
    'examples/api/lib/widgets/selection_container/selection_container.0.dart',
    'examples/api/lib/widgets/selection_container/selection_container_disabled.0.dart',
    'examples/api/lib/widgets/platform_menu_bar/platform_menu_bar.0.dart',
    'examples/api/lib/widgets/context_menu/editable_text_toolbar_builder.1.dart',
    'examples/api/lib/widgets/context_menu/context_menu_controller.0.dart',
    'examples/api/lib/widgets/context_menu/editable_text_toolbar_builder.0.dart',
    'examples/api/lib/widgets/selectable_region/selectable_region.0.dart',
