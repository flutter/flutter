...
List<String> binariesWithEntitlements(String flutterRoot) {
  final List<String> binaries = <String>[
    ...
    'dart-sdk/bin/snapshots/dart_mcp_server_aot.dart.snapshot',
    ...
    'dart-sdk/bin/snapshots/dartdevc.dart.snapshot',
    ...
    'dart-sdk/bin/snapshots/kernel-service.dart.snapshot',
