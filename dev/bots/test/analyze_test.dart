...
void main() {
  ...
  test('analyze.dart - verifyDeprecations', () async {
    ...
    final String lines = <String>[
      ...
      .map((String line) {
        return line
          ...
          .replaceAll('STYLE_GUIDE_URL', 'https://github.com/flutter/flutter/blob/master/docs/contributing/Style-guide-for-Flutter-repo.md')
    ...
    expect(result,
      '╔═╡ERROR #1╞════════════════════════════════════════════════════════════════════\n'
      '$lines\n'
      '║ See: https://github.com/flutter/flutter/blob/master/docs/contributing/Tree-hygiene.md#handling-breaking-changes\n'
      '╚═══════════════════════════════════════════════════════════════════════════════\n'
    );
  });
  ...
  test('analyze.dart - verifyGoldenTags', () async {
    ...
    expect(result[result.length - 3], '║ See: https://github.com/flutter/flutter/blob/master/docs/contributing/testing/Writing-a-golden-file-test-for-package-flutter.md');
  ...
  test('analyze.dart - verifyNoBinaries - positive', () async {
    ...
    if (!Platform.isWindows) {
      expect(result,
        ...
        '║ https://github.com/flutter/flutter/blob/master/docs/tool/Managing-template-image-assets.md\n'
        '╚═══════════════════════════════════════════════════════════════════════════════\n'
      );
    }
  });
