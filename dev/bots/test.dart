...
Future<void> main(List<String> args) async {
  ...
  try {
    ...
    await selectShard(const <String, ShardRunner>{
      ...
      'web_tests16': _runWebUnitTests,
      'web_tests17': _runWebUnitTests,
      'web_tests18': _runWebUnitTests,
      'web_tests19': _runWebUnitTests,
      'web_tests20': _runWebUnitTests,
      'web_tests21': _runWebUnitTests,
      'web_tests22': _runWebUnitTests,
      'web_tests23': _runWebUnitTests,
      'web_tests24': _runWebUnitTests,
      'web_tests25': _runWebUnitTests,
      'web_tests26': _runWebUnitTests,
      'web_tests27': _runWebUnitTests,
      'web_tests28': _runWebUnitTests,
      'web_tests29': _runWebUnitTests,
      'web_tests30': _runWebUnitTests,
