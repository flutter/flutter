...
//
// TODO(yjbanov): we're getting rid of this blocklist as part of https://github.com/flutter/flutter/projects/60
const List<String> kWebTestFileBlocklist = <String>[
...
Future<void> _runWebUnitTests() async {
  ...
  final List<String> allTests = flutterPackageTestDirectory
    ...
    .where((String filePath) => !kWebTestFileBlocklist.contains(filePath))
    .toList()
