...
class MainActivity : FlutterActivity() {
    companion object {
        ...
        const val CHANNEL_NAME = "com.example.androidhardwaresmoketest/test_channel"
        private const val METHOD_CHANNEL_NAME = "com.example.androidhardwaresmoketest/native_support"
    ...
    override fun configureFlutterEngine(flutterEngine: FlutterEngine) {
        ...
        if (flutterEngine != lastConfiguredEngine?.get()) {
            flutterEngine
                ...
                .registry
                .registerViewFactory(
                    "com.example.androidhardwaresmoketest/native_text_view",
