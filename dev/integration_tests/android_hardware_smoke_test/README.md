...
## 1. Overview & Purpose
The primary objective of the `android_hardware_smoke_test`
...
* **Native UI rendering and timing**:
  ...
  ([`NativeTextView.kt`](android/app/src/main/kotlin/com/example/android_hardware_smoke_test/NativeTextView.kt)).
...
* **Crop coordinates and test-script-driven screenshot capture**:
  ...
  * **Instrumented Mode:** The JUnit test runner takes a full-screen screenshot
    ...
    in [`FlutterActivityTest.kt: captureAndSendScreenshot`](android/app/src/androidTest/java/com/example/android_hardware_smoke_test/FlutterActivityTest.kt).
