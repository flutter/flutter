...
class _ExampleState extends State<Example> {
  ...
  void _benchBuffer() async {
  var sw = Stopwatch()..start();
    await Future.wait([for (var asset in assets) rootBundle.loadBuffer(asset)
    ]);
    sw.stop();
  ...
  void _bench() async {
  var sw = Stopwatch()..start();
    await Future.wait([for (var asset in assets) rootBundle.load(asset).then((data) {
