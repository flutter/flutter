...
Future<void> main() async {
  testWidgets('Expansion panel demo: radio tile selection changes on tap', (final WidgetTester tester) async {
...
Finder get _radioFinder =>
    find.byWidgetPredicate((final Widget w) => w is Radio<Location>);

List<RadioListTile<Location>> get _radioListTiles =>
    List<RadioListTile<Location>>.from(
        _radioListTilesFinder.evaluate().map<Widget>((final Element e) => e.widget));

Finder get _radioListTilesFinder =>
    find.byWidgetPredicate((final Widget w) => w is RadioListTile<Location>);
