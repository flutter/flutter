...
void main() async {
  ...
  test('tapping blue box on the right at physical coordinates does not mirror to red platform view on the left', () async {
    ...
    expect(
      redTapped,
      'false',
      reason: 'Physical tap on the right (blue box) should NOT have triggered the left box (red platform view) tap handler.',
    );
