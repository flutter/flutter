...
/// UPDATE_GOLDENS=1 flutter drive lib/hcpp/platform_view_transform_rotation_main.dart
///
/// # Make your changes.
///
/// # Run the test against baseline.
/// flutter drive lib/hcpp/platform_view_transform_rotation_main.dart
/// ```
///
  ...
  test(
    'should rotate in a circle',
      ...
      await expectLater(
        ...
        matchesGoldenFile('$goldenPrefix.no_rotation.png'),
      );
      await flutterDriver.tap(find.byValueKey('IncrementAngle'));
      await expectLater(
        nativeDriver.screenshot(),
