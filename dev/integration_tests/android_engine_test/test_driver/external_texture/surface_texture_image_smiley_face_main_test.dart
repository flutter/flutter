...
/// UPDATE_GOLDENS=1 flutter drive lib/external_texture/surface_texture_image_smiley_face_main.dart
///
/// # Make your changes.
///
...
void main() async {
  ...
  test('should screenshot and match a smiley face texture using the trampoline', () async {
    await expectLater(
      ...
      matchesGoldenFile('external_texture_surface_texture_image_smiley_face.png'),
    );
