...
void main() {
  ...
  test('Image painting events', () async {
    String extensionKind;
    String extensionData;
    vmService.onExtensionEvent.listen((Event event) {
      extensionKind = event.extensionKind;
      extensionData = jsonEncode(event.extensionData.data);
    });
    ...
    expect(extensionKind, 'Flutter.ImageSizesForFrame');
    expect(extensionData, '{"test.png":{"source":"test.png","displaySize":{"width":200.0,"height":100.0},"imageSize":{"width":300.0,"height":300.0},"displaySizeInBytes":106666,"decodedSizeInBytes":480000}}');
