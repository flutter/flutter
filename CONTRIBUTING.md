...
`flutter test` runs tests inside the flutter shell. To debug tests in the observatory, start the test with the `--start-paused` option to prevent the test from completing immediately.
