 ...
 * Copyright (C) 2003, 2005, 2006, 2007, 2008, 2009, 2010 Apple Inc.
 * All rights reserved.
...
enum EOverflow { OVISIBLE, OHIDDEN, OAUTO, OOVERLAY, OPAGEDX, OPAGEDY };
...
enum EFillAttachment { LocalBackgroundAttachment, FixedBackgroundAttachment };

enum EFillBox { BorderFillBox, PaddingFillBox, ContentFillBox };
