...
#ifndef SKY_ENGINE_PLATFORM_GRAPHICS_FILTERS_FEOFFSET_H_
#define SKY_ENGINE_PLATFORM_GRAPHICS_FILTERS_FEOFFSET_H_
...
#endif  // SKY_ENGINE_PLATFORM_GRAPHICS_FILTERS_FEOFFSET_H_
