...
- (void)setUp {
  ...
  self.plugin = [[FlutterSpellCheckPlugin alloc] initWithMethodChannel:self.mockMethodChannel];
...
- (void)testFindAllSpellCheckSuggestionsForText {
  ...
  XCTAssertEqualObjects(capturedResult.firstObject[@"location"], @0);
  XCTAssertEqualObjects(capturedResult.firstObject[@"length"], @5);
  XCTAssertEqualObjects(capturedResult.firstObject[@"suggestions"], suggestions1);
  XCTAssertEqualObjects(capturedResult[1][@"location"], @5);
  XCTAssertEqualObjects(capturedResult[1][@"length"], @5);
  XCTAssertEqualObjects(capturedResult[1][@"suggestions"], suggestions2);
...
- (void)testStopFindingMoreWhenTheLastWordIsMisspelled {
  ...
  XCTAssertEqualObjects(capturedResult.firstObject[@"length"], @5);
  XCTAssertEqualObjects(capturedResult.firstObject[@"suggestions"], suggestions1);
  XCTAssertEqualObjects(capturedResult[1][@"location"], @6);
  XCTAssertEqualObjects(capturedResult[1][@"length"], @4);
  XCTAssertEqualObjects(capturedResult[1][@"suggestions"], suggestions2);
  [self.mockTextChecker reset];
  [textCheckerClassMock stopMocking];
}
