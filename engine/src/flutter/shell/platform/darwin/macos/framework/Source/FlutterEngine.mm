...
- (void)updateWindowMetricsForViewController:(FlutterViewController*)viewController {
  ...
  const FlutterWindowMetricsEvent windowMetricsEvent = {
      ...
      .min_width = static_cast<size_t>(minimumContentSize.width),
      .min_height = static_cast<size_t>(minimumContentSize.height),
      .max_width = static_cast<size_t>(maximumContentSize.width),
      .max_height = static_cast<size_t>(maximumContentSize.height),
  };
