...
class HandleResult extends _Result {
  ...
  @pragma('vm:entry-point')
  const HandleResult(int status, [this._handle]) : super(status);
  @override
...
class HandlePairResult extends _Result {
  ...
  @pragma('vm:entry-point')
  const HandlePairResult(int status, [this._first, this._second]) : super(status);
  @override
...
class ReadResult extends _Result {
  ...
  @pragma('vm:entry-point')
  const ReadResult(int status, [this._bytes, this._numBytes, this._handles]) : super(status);
...
class ReadEtcResult extends _Result {
  ...
  @pragma('vm:entry-point')
  const ReadEtcResult(int status, [this._bytes, this._numBytes, this._handleInfos]) : super(status);
...
class WriteResult extends _Result {
  ...
  @pragma('vm:entry-point')
  const WriteResult(int status, [this._numBytes]) : super(status);
  @override
...
class GetSizeResult extends _Result {
  ...
  @pragma('vm:entry-point')
  const GetSizeResult(int status, [this._size]) : super(status);
  @override
...
class FromFileResult extends _Result {
  ...
  @pragma('vm:entry-point')
  const FromFileResult(int status, [this._handle, this._numBytes]) : super(status);
  @override
...
class MapResult extends _Result {
  ...
  @pragma('vm:entry-point')
  const MapResult(int status, [this._data]) : super(status);
  @override
