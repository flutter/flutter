...
class EmbedderTestTaskRunner {
 public:
  ...
  EmbedderTestTaskRunner(
      ...
      FlutterThreadPrioritySetterWithUserData
          thread_priority_setter_with_user_data = nullptr)
    ...
    task_runner_description_.thread_priority_setter_with_user_data =
  ...
  fml::RefPtr<fml::TaskRunner> GetRealTaskRunner() const {
    return real_task_runner_;
  }
...
class EmbedderTestTaskRunnerBuilder {
 public:
  ...
  EmbedderTestTaskRunnerBuilder& SetThreadPrioritySetterWithUserData(
      FlutterThreadPrioritySetterWithUserData setter) {
    thread_priority_setter_with_user_data_ = setter;
    return *this;
  }
  ...
  EmbedderTestTaskRunner Build() {
    return EmbedderTestTaskRunner(
        ...
        thread_priority_setter_, thread_priority_setter_with_user_data_);
  }
 ...
 private:
  ...
  FlutterThreadPrioritySetterWithUserData
      thread_priority_setter_with_user_data_ = nullptr;
};
