...
TEST(EmbedderProcTable, CallScreenshotProcs) {
  ...
  FlutterEngineScreenshotInfo valid_screenshot = {};
  valid_screenshot.struct_size = sizeof(FlutterEngineScreenshotInfo);
  EXPECT_EQ(procs.FreeScreenshot(&valid_screenshot), kSuccess);
}
