...
public final class FlutterEngineManifestFlags {
    ...
    public static final Flag ENABLE_SURFACE_CONTROL =
        new Flag("EnableSurfaceControl", true);
    public static final Flag ENABLE_FLUTTER_GPU =
        new Flag("EnableFlutterGPU", true);
