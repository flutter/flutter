...
public class FlutterEngine implements ViewUtils.DisplayUpdater {
   ...
   * io.flutter.embedding.engine.flags.FlutterEngineFlags} for all available flags) when creating
   * the VM, manually set the initialization arguments by calling {@link
