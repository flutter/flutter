...
public class PlatformViewsControllerController implements PlatformViewsAccessibilityDelegate {
    ...
    public PlatformViewsControllerController(PlatformViewsController platformViewsController, PlatformViewsController2 platformViewsController2) {
    ...
    public View getPlatformViewById(int viewId) {
        return platformViewsController2.getPlatformViewById(viewId) != null ? platformViewsController2.getPlatformViewById(viewId) : platformViewsController.getPlatformViewById(viewId);
    }

    @Override
    public boolean usesVirtualDisplay(int id) {
        return platformViewsController2.getPlatformViewById(id) != null ? platformViewsController2.usesVirtualDisplay(id) : platformViewsController.usesVirtualDisplay(id);
    }
