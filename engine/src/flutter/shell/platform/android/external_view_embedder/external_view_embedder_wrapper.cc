...
AndroidExternalViewEmbedderWrapper::AndroidExternalViewEmbedderWrapper(
  ...
  const SurfaceFrameLayer::CreateSurfaceFrameLayerCallback& create_surface_frame_layer_callback)
    : ExternalViewEmbedder(),
      ...
      create_surface_frame_layer_callback_(create_surface_frame_layer_callback) {}
...
void AndroidExternalViewEmbedderWrapper::EnsureInitialized() {
  ...
  if (meets_hcpp_criteria_ &&
    ...
    non_hcpp_view_embedder_ = std::make_unique<AndroidExternalViewEmbedder>(
        android_context_, jni_facade_, surface_factory_, task_runners_, create_surface_frame_layer_callback_);
  }
}
