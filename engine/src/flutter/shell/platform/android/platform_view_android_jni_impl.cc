...
static void SetViewportMetrics(JNIEnv* env,
                               ...
                               jint physicalWidth,
                               jint physicalHeight,
                               jint minWidthConstraint,
                               jint maxWidthConstraint,
                               jint minHeightConstraint,
                               jint maxHeightConstraint,
  ...
  const flutter::ViewportMetrics metrics{
      ...
      static_cast<double>(minWidthConstraint),
      static_cast<double>(maxWidthConstraint),
      static_cast<double>(minHeightConstraint),
      static_cast<double>(maxHeightConstraint),
