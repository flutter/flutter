...
public class AccessibilityBridgeTest {
  ...
  public void itSetsCheckedStateBasedOnFlagsCorrectly() {
    ...
    AccessibilityNodeInfo nodeInfo = accessibilityBridge.createAccessibilityNodeInfo(0);
    assertEquals(AccessibilityNodeInfo.CHECKED_STATE_UNDEFINED, nodeInfo.getCheckedState());
    ...
    nodeInfo = accessibilityBridge.createAccessibilityNodeInfo(0);
    assertEquals(AccessibilityNodeInfo.CHECKED_STATE_TRUE, nodeInfo.getCheckedState());
