...
public class FlutterShellArgsTest {
    ...
    public void allFlags_containsAllFlags() {
        ...
        assertEquals("If you are adding a new Flag to FlutterShellArgs, please make sure it is added to ALL_FLAGS as well. Otherwise, the flag will be silently ignored when specified.", 
                     declaredFlagsCount, 
    ...
    public void containsCommandLineArgument_returnsFalseWhenInvalidArgSpecified() {
        assertFalse("Should return false for an invalid command line argument",
    ...
    public void getFlagByMetaDataKey_returnsExpectedFlagWhenValidKeySpecified() {
        FlutterShellArgs.Flag flag = FlutterShellArgs.getFlagByMetaDataKey("io.flutter.embedding.android.EnableSoftwareRendering");
        assertNotNull(flag);
        assertEquals(
    ...
    public void getFlagByMetaDataKey_returnsNullWhenInvalidKeySpecified() {
        FlutterShellArgs.Flag flag = FlutterShellArgs.getFlagByMetaDataKey("io.flutter.embedding.android.InvalidMetaDataKey");
