...
#ifndef FLUTTER_SHELL_PLATFORM_WINDOWS_FLUTTER_WINDOWS_DISPLAY_MONITOR_H_
#define FLUTTER_SHELL_PLATFORM_WINDOWS_FLUTTER_WINDOWS_DISPLAY_MONITOR_H_
...
class FlutterWindowsDisplayMonitor {
 public:
  FlutterWindowsDisplayMonitor(
      FlutterWindowsEngine* engine,
      std::shared_ptr<WindowsProcTable> windows_proc_table);
  virtual ~FlutterWindowsDisplayMonitor();
...
#endif  // FLUTTER_SHELL_PLATFORM_WINDOWS_FLUTTER_WINDOWS_DISPLAY_MONITOR_H_
