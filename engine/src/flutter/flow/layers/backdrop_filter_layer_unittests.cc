...
TEST_F(BackdropFilterLayerTest, EmptyFilter) {
  ...
  /* (ClipRect)parent::Paint */ {
    ...
    {
      expected_builder.ClipRect(child_bounds, ClipOp::kIntersect, false);
...
TEST_F(BackdropFilterLayerTest, MultipleChildren) {
  ...
  /* (ClipRect)parent::Paint */ {
    expected_builder.Save();
    {
      expected_builder.ClipRect(children_bounds, ClipOp::kIntersect, false);
      /* (BackdropFilter)layer::Paint */ {
        expected_builder.Save();
        {
...
TEST_F(BackdropFilterLayerTest, OpacityInheritance) {
  ...
  /* ClipRectLayer::Paint */ {
    expected_builder.Save();
    {
      expected_builder.ClipRect(clip_rect, ClipOp::kIntersect, false);
      /* OpacityLayer::Paint */ {
