...
// This shader was created based on or with reference to the implementation
// found at:
...
float compute_streched_effect(float in_pos,
                              float overscroll,
                              float u_stretch_affected_dist,
                              float u_inverse_stretch_affected_dist,
                              float distance_stretched,
...
void main() {
  ...
  out_u_norm =
      isVertical
          ? in_u_norm
          : compute_streched_effect(
                in_u_norm, overscroll, norm_stretch_affected_dist,
                norm_inverse_stretch_affected_dist, norm_distance_stretched,
                norm_dist_diff, u_interpolation_strength, norm_viewport);

  out_v_norm =
      isVertical
          ? compute_streched_effect(
                in_v_norm, overscroll, norm_stretch_affected_dist,
                norm_inverse_stretch_affected_dist, norm_distance_stretched,
                norm_dist_diff, u_interpolation_strength, norm_viewport)
          : in_v_norm;
