...
#include "impeller/entity/rsuperellipse_blur.vert.h"
...
using RSuperellipseBlurPipeline = RenderPipelineHandle<RsuperellipseBlurVertexShader, RsuperellipseBlurFragmentShader>;
