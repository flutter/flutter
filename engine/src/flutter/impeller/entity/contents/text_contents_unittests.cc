...
// This file is commented out because all of the tests assume the old way
// of handling TextFrames and the tests do not necessarily translate or
// apply to the new system. For now, they are commented out, but they
// need to be replaced with new tests before theses changes are merged.
// clang-format off
