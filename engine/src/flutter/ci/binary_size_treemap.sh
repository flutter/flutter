...
ADDR2LINE="flutter/third_party/android_tools/sdk/ndk/28.2.13676358/toolchains/llvm/prebuilt/$NDK_PLATFORM/bin/llvm-addr2line"
NM="flutter/third_party/android_tools/sdk/ndk/28.2.13676358/toolchains/llvm/prebuilt/$NDK_PLATFORM/bin/llvm-nm"
