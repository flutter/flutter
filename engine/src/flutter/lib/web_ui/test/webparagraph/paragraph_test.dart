...
Future<void> testMain() async {
  ...
  test('Draw WebParagraph LTR text 1 line', () async {
    ...
    paragraph.paint(canvas as engine.CanvasKitCanvas, const Offset(0, 100));
  ...
  test('Draw WebParagraph LTR text with multiple lines', () async {
    ...
    paragraph.paint(canvas as engine.CanvasKitCanvas, Offset.zero);
    await drawPictureUsingCurrentRenderer(recorder.endRecording());
  ...
  test('Draw WebParagraph multiple shadows text', () async {
    ...
    paragraph.paint(canvas as engine.CanvasKitCanvas, const Offset(50, 50));
    await drawPictureUsingCurrentRenderer(recorder.endRecording());
  ...
  test('Draw WebParagraph with fontVariations', () async {
    ...
    //final WebParagraph paragraph = builder.build();
    //paragraph.layout(const ParagraphConstraints(width: 250));
    //paragraph.paint(canvas as engine.CanvasKitCanvas, const Offset(0, 0));
    await drawPictureUsingCurrentRenderer(recorder.endRecording());
