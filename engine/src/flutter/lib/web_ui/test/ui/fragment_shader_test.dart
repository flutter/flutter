...
Future<void> testMain() async {
  ...
  setUp(() {
    ...
    assetScope.setAsset('json_iplr_shader', ByteData.sublistView(utf8.encode(kJsonIPLR)));
    assetScope.setAsset(
      'json_iplr_array_shader',
      ByteData.sublistView(utf8.encode(kJsonArrayIPLR)),
    );
  });
  ...
  test('getUniformVec2', () async {
    final ui.FragmentProgram program = await renderer.createFragmentProgram(
      'json_iplr_array_shader',
    );
    final ui.FragmentShader shader = program.fragmentShader();
    shader.getUniformVec2('uSize').set(6.0, 7.0);
  });
  test('getUniformVec3', () async {
    final ui.FragmentProgram program = await renderer.createFragmentProgram(
      'json_iplr_array_shader',
    );
    final ui.FragmentShader shader = program.fragmentShader();
  ...
  test('getUniformVec4', () async {
    final ui.FragmentProgram program = await renderer.createFragmentProgram('json_iplr_shader');
    final ui.FragmentShader shader = program.fragmentShader();
    shader.getUniformVec4('u_color').set(0.8, 0.1, 0.3, 1.0);
  });

  test('getUniformFloatArray', () async {
    final ui.FragmentProgram program = await renderer.createFragmentProgram(
      'json_iplr_array_shader',
    );
    final ui.FragmentShader shader = program.fragmentShader();
  ...
  group('Uniform by-name accessors throw errors with incorrect datatypes.', () {
    ...
    test('getUniformVec2Array', () {
      expect(
        () => shader.getUniformVec2Array('uLoneVector'),
        throwsA(
          isA<ArgumentError>().having(
            (e) => e.message,
            'message',
