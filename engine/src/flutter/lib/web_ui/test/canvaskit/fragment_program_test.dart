...
void testMain() {
  ...
  group('Uniform by-name accessors happy path.', () {
    ...
    test('getUniformFloatArray', () {
      shader.getUniformFloatArray('uFloats')[0].set(0.8);
    });

    test('getUniformVec2', () {
      shader.getUniformVec2Array('uVectors')[0].set(0.6, 0.7);
    });
  });
  ...
  group('Uniform by-name accessors throw errors with incorrect datatypes.', () {
    ...
    test('getUniformVec2Array', () {
      expect(
        () => shader.getUniformVec4('uLoneVector'),
        throwsA(
          isA<ArgumentError>().having(
            (e) => e.message,
            'message',
            'Uniform size (3) for "uLoneVector" is not a multiple of 2.',
          ),
        ),
      );
    });
