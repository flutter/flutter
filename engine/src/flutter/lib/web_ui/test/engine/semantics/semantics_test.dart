  ...
  test('renders validation result', () {
    ...
    tester.updateNode(
      ...
      children: <SemanticsNodeUpdate>[
        ...
        // This node has a grammatical error. aria-invalid should be "grammar".
        tester.updateNode(id: 4, validationResult: ui.SemanticsValidationResult.grammar),
        // This node has a spelling error. aria-invalid should be "spelling".
        tester.updateNode(id: 5, validationResult: ui.SemanticsValidationResult.spelling),
      ],
    );
    tester.apply();
  ...
  <sem-c>
    ...
    tester.updateNode(
      ...
      children: <SemanticsNodeUpdate>[
        ...
        // This node has a grammatical error. aria-invalid should be "grammar".
        tester.updateNode(id: 3, validationResult: ui.SemanticsValidationResult.grammar),
        // This node has a spelling error. aria-invalid should be "spelling".
        tester.updateNode(id: 4, validationResult: ui.SemanticsValidationResult.spelling),
        // This node does not validate its contents and should not have an
        // aria-invalid attribute at all.
