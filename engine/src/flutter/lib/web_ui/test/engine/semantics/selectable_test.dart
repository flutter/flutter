...
Future<void> testMain() async {
  ...
  test('Selectable behavior adds/removes aria-selected based on isSelectable flag', () async {
    semantics()
    ...
    // Should now have aria-selected="false"
    expectSemanticsTree(owner(), '<sem role="img" aria-selected="false"></sem>');
    expect(owner().semanticsHost.querySelector('[aria-selected]'), isNotNull);
    ...
    expectSemanticsTree(owner(), '<sem role="img" aria-selected="true"></sem>');
