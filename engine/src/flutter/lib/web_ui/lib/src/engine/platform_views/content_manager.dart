  ...
  void _setupTouchBoundaryDetection(DomElement content, DomElement wrapper) {
    ...
    content.addEventListener(
      ...
      createDomEventListener((DomEvent event) {
        ...
        if (touches.isNotEmpty) {
          ...
          print(
            '[TOUCH] touchstart: y=${touches.first.clientY}, scrollTop=$scrollTop, maxScroll=$maxScroll, atBoundary=$isAtBoundaryAtStart',
          );
        }
      }),
    ...
    content.addEventListener(
      ...
      createDomEventListener((DomEvent event) {
        ...
        print(
          '[TOUCH] touchmove: deltaY=$deltaY, scrollTop=$scrollTop, maxScroll=$maxScroll, atTop=$atTop, atBottom=$atBottom, cancelable=${event.cancelable}, browserOwns=$browserOwnsScroll',
        );
