...
class MeasureVisitor extends LayerVisitor {
  ...
  void visitClipPath(ClipPathEngineLayer clipPath) {
    ...
    measuringCanvas.clipPath(clipPath.clipPath.builtPath as CkPath, clipPath.clipBehavior != ui.Clip.hardEdge);
...
class PaintVisitor extends LayerVisitor {
  ...
  void visitClipPath(ClipPathEngineLayer clipPath) {
    ...
    nWayCanvas.save();
    nWayCanvas.clipPath(clipPath.clipPath.builtPath as CkPath, clipPath.clipBehavior != ui.Clip.hardEdge);
