...
abstract class PlatformDispatcher {
  ...
  void sendPortPlatformMessage(String name, ByteData? data, int identifier,
      Object port);
...
class FrameTiming {
  ...
  static final int _dataLength = FramePhase.values.length +
      _FrameTimingInfo.values.length;
  ...
  final List<
      int> _data; // some elements in microseconds, some in bytes, some are counts
...
class Locale {
  ...
  // This map is generated by //flutter/tools/gen_locale.dart
  // Mappings generated for language subtag registry as of 2019-02-27.
  static const Map<String, String> _deprecatedRegionSubtagMap = <String,
      String>{
