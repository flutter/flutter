...
def main():
    ...
    parser.add_argument(
        "--aapt2-bin", type=str, required=True, help="The path to the aapt2 binary."
    )
    parser.add_argument(
    ...
    parser.add_argument(
        "--output-path", type=str, required=True, help="The path to the output apk."
    )
    parser.add_argument(
    ...
    parser.add_argument(
        ...
        type=str,
        required=True,
        help="The path to the debug keystore to sign the apk.",
    )
    parser.add_argument(
