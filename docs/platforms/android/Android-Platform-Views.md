...
- **SurfaceView Compatibility**: Opting in is currently not recommended if your application contains a platform view which is or contains a native `SurfaceView` (often used by video players or map plugins).
