There are many ways to write a render speed test for Flutter. In this article,
...
Once all steps above are done, one should be able to run
...
1. Locally test the devicelab task by running
