...
class _GeoCodingProMasterState extends State<GeoCodingProMaster> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('GeoDigital Pro (Standardized)'),
  ...
  Widget _buildSearchList() {
    if (searchResults.isEmpty) {
      return const Center(child: Text('Start typing to search global database...'));
    }
    return ListView.builder(
      itemCount: searchResults.length,
      itemBuilder: (context, index) {
        final GeoEntity item = searchResults[index];
        return ListTile(
